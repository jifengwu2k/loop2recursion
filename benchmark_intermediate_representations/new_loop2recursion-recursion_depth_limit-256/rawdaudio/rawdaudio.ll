; ModuleID = './benchmark_intermediate_representations/new_loop2recursion-recursion_depth_limit-256/rawdaudio/rawdaudio.ll.temp'
...
define void @"main$0"(i32 %arg, i16 %arg1) {
"main$0_exiting$1":
...
"main$0_recursively_call_function":               ; preds = %"main$0_increment_depth_counter"
  call void @"main$0"(i32 %call, i16 %i)
  ret void
