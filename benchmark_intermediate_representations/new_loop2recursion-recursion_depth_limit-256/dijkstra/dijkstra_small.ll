; ModuleID = './benchmark_intermediate_representations/new_loop2recursion-recursion_depth_limit-256/dijkstra/dijkstra_small.ll.temp'
...
@"enqueue$0_recursion_state_struct" = dso_local global %1 zeroinitializer
@"dijkstra$2_recursion_state_struct" = dso_local global %2 zeroinitializer
@"dijkstra$1_return_value_struct" = dso_local global %3 zeroinitializer
@"dijkstra$1_recursion_state_struct" = dso_local global %4 zeroinitializer
@"dijkstra$0_return_value_struct" = dso_local global %5 zeroinitializer
@"dijkstra$0_recursion_state_struct" = dso_local global %6 zeroinitializer
@"main$1_recursion_state_struct" = dso_local global %7 zeroinitializer
...
@"main$0_recursion_state_struct" = dso_local global %8 zeroinitializer
@"dijkstra$0$0_return_value_struct" = dso_local global %9 zeroinitializer
@"dijkstra$0$0_recursion_state_struct" = dso_local global %10 zeroinitializer
...
@"main$1$0_recursion_state_struct" = dso_local global %11 zeroinitializer
@"./benchmark_intermediate_representations/baseline/dijkstra/dijkstra_small.ll_invariant_variable$4" = dso_local global i64 0
@"dijkstra$0$0$0_return_value_struct" = dso_local global %12 zeroinitializer
@"dijkstra$0$0$0_recursion_state_struct" = dso_local global %13 zeroinitializer
...
"enqueue$0_call_recursive_function":              ; preds = %"enqueue$0_extract_next_values", %"enqueue$0_initialize_context"
  %i6 = phi %struct._QITEM* [ %i, %"enqueue$0_initialize_context" ], [ %i10, %"enqueue$0_extract_next_values" ]
  call void @"enqueue$0"(%struct._QITEM* %i6, i16 0)
  %i7 = getelementptr %1, %1* @"enqueue$0_recursion_state_struct", i32 0, i32 1
  %i8 = load i1, i1* %i7, align 1
  br i1 %i8, label %"enqueue$0_extract_return_values$0", label %"enqueue$0_extract_next_values"

"enqueue$0_extract_next_values":                  ; preds = %"enqueue$0_call_recursive_function"
  %i9 = getelementptr %1, %1* @"enqueue$0_recursion_state_struct", i32 0, i32 0
  %i10 = load %struct._QITEM*, %struct._QITEM** %i9, align 8
  br label %"enqueue$0_call_recursive_function"

"enqueue$0_extract_return_values$0":              ; preds = %"enqueue$0_call_recursive_function"
  %i11 = getelementptr %0, %0* @"enqueue$0_return_value_struct", i32 0, i32 0
...
while.end:                                        ; preds = %"enqueue$0_extract_return_values$0"
  %i13 = bitcast %struct._QITEM** %i12 to i8**
  store i8* %call, i8** %i13, align 8, !tbaa !12
  br label %if.end11

if.end11:                                         ; preds = %while.end, %if.then6
  %i14 = load i32, i32* @g_qCount, align 4, !tbaa !13
...
"dijkstra$2_call_recursive_function":             ; preds = %"dijkstra$2_extract_next_values", %"dijkstra$2_initialize_context"
  %i = phi i64 [ 0, %"dijkstra$2_initialize_context" ], [ %i4, %"dijkstra$2_extract_next_values" ]
  call void @"dijkstra$2"(i64 %i, i16 0)
  %i1 = getelementptr %2, %2* @"dijkstra$2_recursion_state_struct", i32 0, i32 1
  %i2 = load i1, i1* %i1, align 1
  br i1 %i2, label %for.end, label %"dijkstra$2_extract_next_values"

"dijkstra$2_extract_next_values":                 ; preds = %"dijkstra$2_call_recursive_function"
  %i3 = getelementptr %2, %2* @"dijkstra$2_recursion_state_struct", i32 0, i32 0
...
if.else:                                          ; preds = %for.end
  ...
  %i5 = load %struct._QITEM*, %struct._QITEM** @qHead, align 8, !tbaa !6
  %tobool.i = icmp eq i8* %call.i, null
  br i1 %tobool.i, label %if.then.i, label %if.end.i

if.then.i:                                        ; preds = %if.else
  %i6 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !6
  %i7 = tail call i64 @fwrite(i8* nonnull getelementptr inbounds ([16 x i8], [16 x i8]* @.str.1, i64 0, i64 0), i64 15, i64 1, %struct._IO_FILE* %i6) #10
  tail call void @exit(i32 1) #9
  unreachable
...
if.end.i:                                         ; preds = %if.else
  ...
  %i8 = bitcast i8* %iDist3.i to i32*
  store i32 0, i32* %i8, align 4, !tbaa !10
  %iPrev4.i = getelementptr inbounds i8, i8* %call.i, i64 8
  %i9 = bitcast i8* %iPrev4.i to i32*
  store i32 9999, i32* %i9, align 8, !tbaa !11
  %qNext.i = getelementptr inbounds i8, i8* %call.i, i64 16
  %i10 = bitcast i8* %qNext.i to %struct._QITEM**
  store %struct._QITEM* null, %struct._QITEM** %i10, align 8, !tbaa !12
  %tobool5.i = icmp eq %struct._QITEM* %i5, null
...
"dijkstra$1_call_recursive_function":             ; preds = %"dijkstra$1_extract_next_values", %"dijkstra$1_initialize_context"
  %i11 = phi %struct._QITEM* [ %i5, %"dijkstra$1_initialize_context" ], [ %i15, %"dijkstra$1_extract_next_values" ]
  call void @"dijkstra$1"(%struct._QITEM* %i11, i16 0)
  %i12 = getelementptr %4, %4* @"dijkstra$1_recursion_state_struct", i32 0, i32 1
  %i13 = load i1, i1* %i12, align 1
  br i1 %i13, label %"dijkstra$1_extract_return_values$0", label %"dijkstra$1_extract_next_values"

"dijkstra$1_extract_next_values":                 ; preds = %"dijkstra$1_call_recursive_function"
  %i14 = getelementptr %4, %4* @"dijkstra$1_recursion_state_struct", i32 0, i32 0
  %i15 = load %struct._QITEM*, %struct._QITEM** %i14, align 8
  br label %"dijkstra$1_call_recursive_function"

"dijkstra$1_extract_return_values$0":             ; preds = %"dijkstra$1_call_recursive_function"
  %i16 = getelementptr %3, %3* @"dijkstra$1_return_value_struct", i32 0, i32 0
  %i17 = load %struct._QITEM**, %struct._QITEM*** %i16, align 8
...
while.end.i:                                      ; preds = %"dijkstra$1_extract_return_values$0"
  %i18 = bitcast %struct._QITEM** %i17 to i8**
  store i8* %call.i, i8** %i18, align 8, !tbaa !12
  br label %enqueue.exit

enqueue.exit:                                     ; preds = %while.end.i, %if.then6.i
  %i19 = load i32, i32* @g_qCount, align 4, !tbaa !13
  %inc.i = add nsw i32 %i19, 1
  store i32 %inc.i, i32* @g_qCount, align 4, !tbaa !13
  %cmp1178 = icmp sgt i32 %i19, -1
...
"dijkstra$0_call_recursive_function":             ; preds = %"dijkstra$0_extract_next_values", %"dijkstra$0_initialize_context"
  %i20 = phi i32 [ %inc.i, %"dijkstra$0_initialize_context" ], [ %i24, %"dijkstra$0_extract_next_values" ]
  call void @"dijkstra$0"(i32 %i20, i16 0)
  %i21 = getelementptr %6, %6* @"dijkstra$0_recursion_state_struct", i32 0, i32 1
  %i22 = load i1, i1* %i21, align 1
  br i1 %i22, label %"dijkstra$0_branch_to_exit", label %"dijkstra$0_extract_next_values"

"dijkstra$0_extract_next_values":                 ; preds = %"dijkstra$0_call_recursive_function"
  %i23 = getelementptr %6, %6* @"dijkstra$0_recursion_state_struct", i32 0, i32 0
  %i24 = load i32, i32* %i23, align 4
  br label %"dijkstra$0_call_recursive_function"

"dijkstra$0_branch_to_exit":                      ; preds = %"dijkstra$0_call_recursive_function"
  %i25 = getelementptr %5, %5* @"dijkstra$0_return_value_struct", i32 0, i32 0
  %i26 = load i8, i8* %i25, align 1
  switch i8 %i26, label %while.end.loopexit [
    i8 1, label %while.end.loopexit
    i8 0, label %if.then.i62
  ]

if.then.i62:                                      ; preds = %"dijkstra$0_branch_to_exit"
  %i27 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !6
  %i28 = tail call i64 @fwrite(i8* nonnull getelementptr inbounds ([16 x i8], [16 x i8]* @.str.1, i64 0, i64 0), i64 15, i64 1, %struct._IO_FILE* %i27) #10
  tail call void @exit(i32 1) #9
  unreachable
...
while.end:                                        ; preds = %while.end.loopexit, %enqueue.exit
  ...
  %i29 = load i32, i32* %iDist44, align 8, !tbaa !14
  %call45 = tail call i32 (i8*, ...) @printf(i8* nonnull getelementptr inbounds ([30 x i8], [30 x i8]* @.str.3, i64 0, i64 0), i32 %i29)
...
"main$1_call_recursive_function":                 ; preds = %"main$1_extract_next_values", %"main$1_initialize_context"
  %i6 = phi i64 [ 0, %"main$1_initialize_context" ], [ %i10, %"main$1_extract_next_values" ]
  call void @"main$1"(i64 %i6, i16 0)
  %i7 = getelementptr %7, %7* @"main$1_recursion_state_struct", i32 0, i32 1
  %i8 = load i1, i1* %i7, align 1
  br i1 %i8, label %for.body16.preheader, label %"main$1_extract_next_values"

"main$1_extract_next_values":                     ; preds = %"main$1_call_recursive_function"
  %i9 = getelementptr %7, %7* @"main$1_recursion_state_struct", i32 0, i32 0
...
"main$0_call_recursive_function":                 ; preds = %"main$0_extract_next_values", %"main$0_initialize_context"
  %i11 = phi i32 [ 50, %"main$0_initialize_context" ], [ %i16, %"main$0_extract_next_values" ]
  %i12 = phi i32 [ 0, %"main$0_initialize_context" ], [ %i18, %"main$0_extract_next_values" ]
  call void @"main$0"(i32 %i11, i32 %i12, i16 0)
  %i13 = getelementptr %8, %8* @"main$0_recursion_state_struct", i32 0, i32 2
  %i14 = load i1, i1* %i13, align 1
  br i1 %i14, label %for.end21, label %"main$0_extract_next_values"

"main$0_extract_next_values":                     ; preds = %"main$0_call_recursive_function"
  %i15 = getelementptr %8, %8* @"main$0_recursion_state_struct", i32 0, i32 0
  %i16 = load i32, i32* %i15, align 4
  %i17 = getelementptr %8, %8* @"main$0_recursion_state_struct", i32 0, i32 1
...
define void @"enqueue$0"(%struct._QITEM* %arg, i16 %arg1) {
"enqueue$0_latch$0":
...
"enqueue$0_increment_depth_counter":              ; preds = %"enqueue$0_latch$0"
  %i2 = add i16 %arg1, 1
  %i3 = icmp ult i16 %i2, 256
  br i1 %i3, label %"enqueue$0_recursively_call_function", label %"enqueue$0_save_recursive_state_and_return"

"enqueue$0_recursively_call_function":            ; preds = %"enqueue$0_increment_depth_counter"
  call void @"enqueue$0"(%struct._QITEM* %i, i16 %i2)
  ret void

"enqueue$0_save_recursive_state_and_return":      ; preds = %"enqueue$0_increment_depth_counter"
  %i4 = getelementptr %1, %1* @"enqueue$0_recursion_state_struct", i32 0, i32 0
  store %struct._QITEM* %i, %struct._QITEM** %i4, align 8
  %i5 = getelementptr %1, %1* @"enqueue$0_recursion_state_struct", i32 0, i32 1
...
"enqueue$0_return_from_recursive_function$0":     ; preds = %"enqueue$0_latch$0"
  ...
  store %struct._QITEM** %qNext7, %struct._QITEM*** %i6, align 8
  %i7 = getelementptr %1, %1* @"enqueue$0_recursion_state_struct", i32 0, i32 1
  store i1 true, i1* %i7, align 1
  ret void
}

define void @"dijkstra$2"(i64 %arg, i16 %arg1) {
"dijkstra$2_latch$0":
...
"dijkstra$2_increment_depth_counter":             ; preds = %"dijkstra$2_latch$0"
  %i = add i16 %arg1, 1
  %i2 = icmp ult i16 %i, 256
  br i1 %i2, label %"dijkstra$2_recursively_call_function", label %"dijkstra$2_save_recursive_state_and_return"

"dijkstra$2_recursively_call_function":           ; preds = %"dijkstra$2_increment_depth_counter"
  call void @"dijkstra$2"(i64 %indvars.iv.next.4, i16 %i)
  ret void

"dijkstra$2_save_recursive_state_and_return":     ; preds = %"dijkstra$2_increment_depth_counter"
  %i3 = getelementptr %2, %2* @"dijkstra$2_recursion_state_struct", i32 0, i32 0
  store i64 %indvars.iv.next.4, i64* %i3, align 8
  %i4 = getelementptr %2, %2* @"dijkstra$2_recursion_state_struct", i32 0, i32 1
  store i1 false, i1* %i4, align 1
  ret void

"dijkstra$2_return_from_recursive_function$0":    ; preds = %"dijkstra$2_latch$0"
  %i5 = getelementptr %2, %2* @"dijkstra$2_recursion_state_struct", i32 0, i32 1
  store i1 true, i1* %i5, align 1
  ret void
}

define void @"dijkstra$1"(%struct._QITEM* %arg, i16 %arg1) {
"dijkstra$1_latch$0":
...
"dijkstra$1_increment_depth_counter":             ; preds = %"dijkstra$1_latch$0"
  %i2 = add i16 %arg1, 1
  %i3 = icmp ult i16 %i2, 256
  br i1 %i3, label %"dijkstra$1_recursively_call_function", label %"dijkstra$1_save_recursive_state_and_return"

"dijkstra$1_recursively_call_function":           ; preds = %"dijkstra$1_increment_depth_counter"
  call void @"dijkstra$1"(%struct._QITEM* %i, i16 %i2)
  ret void

"dijkstra$1_save_recursive_state_and_return":     ; preds = %"dijkstra$1_increment_depth_counter"
  %i4 = getelementptr %4, %4* @"dijkstra$1_recursion_state_struct", i32 0, i32 0
  store %struct._QITEM* %i, %struct._QITEM** %i4, align 8
  %i5 = getelementptr %4, %4* @"dijkstra$1_recursion_state_struct", i32 0, i32 1
  store i1 false, i1* %i5, align 1
  ret void

"dijkstra$1_return_from_recursive_function$0":    ; preds = %"dijkstra$1_latch$0"
  %i6 = getelementptr %3, %3* @"dijkstra$1_return_value_struct", i32 0, i32 0
  store %struct._QITEM** %qNext7.i, %struct._QITEM*** %i6, align 8
  %i7 = getelementptr %4, %4* @"dijkstra$1_recursion_state_struct", i32 0, i32 1
  store i1 true, i1* %i7, align 1
  ret void
}

define void @"dijkstra$0"(i32 %arg, i16 %arg1) {
"dijkstra$0_header":
  %i = load %struct._QITEM*, %struct._QITEM** @qHead, align 8, !tbaa !6
...
for.cond12.preheader:                             ; preds = %if.then.i58, %"dijkstra$0_header"
  %i8 = phi i32 [ %arg, %"dijkstra$0_header" ], [ %dec.i, %if.then.i58 ]
...
"dijkstra$0$0_call_recursive_function":           ; preds = %"dijkstra$0$0_extract_next_values", %"dijkstra$0$0_initialize_context"
  %i9 = phi i32 [ 0, %"dijkstra$0$0_initialize_context" ], [ %i14, %"dijkstra$0$0_extract_next_values" ]
  %i10 = phi i32 [ %i8, %"dijkstra$0$0_initialize_context" ], [ %i16, %"dijkstra$0$0_extract_next_values" ]
  call void @"dijkstra$0$0"(i32 %i9, i32 %i10, i16 0)
  %i11 = getelementptr %10, %10* @"dijkstra$0$0_recursion_state_struct", i32 0, i32 2
  %i12 = load i1, i1* %i11, align 1
  br i1 %i12, label %"dijkstra$0$0_branch_to_exit", label %"dijkstra$0$0_extract_next_values"

"dijkstra$0$0_extract_next_values":               ; preds = %"dijkstra$0$0_call_recursive_function"
  %i13 = getelementptr %10, %10* @"dijkstra$0$0_recursion_state_struct", i32 0, i32 0
  %i14 = load i32, i32* %i13, align 4
  %i15 = getelementptr %10, %10* @"dijkstra$0$0_recursion_state_struct", i32 0, i32 1
  %i16 = load i32, i32* %i15, align 4
  br label %"dijkstra$0$0_call_recursive_function"

"dijkstra$0$0_branch_to_exit":                    ; preds = %"dijkstra$0$0_call_recursive_function"
  %i17 = getelementptr %9, %9* @"dijkstra$0$0_return_value_struct", i32 0, i32 1
  %i18 = load i8, i8* %i17, align 1
  switch i8 %i18, label %"dijkstra$0$0_extract_return_values$0" [
...
"dijkstra$0$0_extract_return_values$0":           ; preds = %"dijkstra$0$0_branch_to_exit", %"dijkstra$0$0_branch_to_exit"
  %i19 = getelementptr %9, %9* @"dijkstra$0$0_return_value_struct", i32 0, i32 0
...
"dijkstra$0_increment_depth_counter":             ; preds = %"dijkstra$0_latch$0"
  ...
  br i1 %i22, label %"dijkstra$0_recursively_call_function", label %"dijkstra$0_save_recursive_state_and_return"

"dijkstra$0_recursively_call_function":           ; preds = %"dijkstra$0_increment_depth_counter"
  call void @"dijkstra$0"(i32 %i20, i16 %i21)
  ret void

"dijkstra$0_save_recursive_state_and_return":     ; preds = %"dijkstra$0_increment_depth_counter"
  %i23 = getelementptr %6, %6* @"dijkstra$0_recursion_state_struct", i32 0, i32 0
  store i32 %i20, i32* %i23, align 4
  %i24 = getelementptr %6, %6* @"dijkstra$0_recursion_state_struct", i32 0, i32 1
...
"dijkstra$0_return_from_recursive_function$0":    ; preds = %"dijkstra$0_latch$0"
  ...
  %i26 = getelementptr %6, %6* @"dijkstra$0_recursion_state_struct", i32 0, i32 1
  store i1 true, i1* %i26, align 1
  ret void

"dijkstra$0_return_from_recursive_function$1":    ; preds = %"dijkstra$0$0_extract_return_values$1"
  %i27 = getelementptr %5, %5* @"dijkstra$0_return_value_struct", i32 0, i32 0
  store i8 0, i8* %i27, align 1
  %i28 = getelementptr %6, %6* @"dijkstra$0_recursion_state_struct", i32 0, i32 1
  store i1 true, i1* %i28, align 1
  ret void
}

define void @"main$1"(i64 %arg, i16 %arg1) {
"main$1_header":
  br label %"main$1$0_initialize_context"

"main$1$0_initialize_context":                    ; preds = %"main$1_header"
  store i64 %arg, i64* @"./benchmark_intermediate_representations/baseline/dijkstra/dijkstra_small.ll_invariant_variable$4", align 8
...
"main$1$0_call_recursive_function":               ; preds = %"main$1$0_extract_next_values", %"main$1$0_initialize_context"
  %i = phi i64 [ 0, %"main$1$0_initialize_context" ], [ %i5, %"main$1$0_extract_next_values" ]
  call void @"main$1$0"(i64 %i, i16 0)
  %i2 = getelementptr %11, %11* @"main$1$0_recursion_state_struct", i32 0, i32 1
  %i3 = load i1, i1* %i2, align 1
  br i1 %i3, label %"main$1_latch$0", label %"main$1$0_extract_next_values"

"main$1$0_extract_next_values":                   ; preds = %"main$1$0_call_recursive_function"
  %i4 = getelementptr %11, %11* @"main$1$0_recursion_state_struct", i32 0, i32 0
...
"main$1_increment_depth_counter":                 ; preds = %"main$1_latch$0"
  ...
  br i1 %i7, label %"main$1_recursively_call_function", label %"main$1_save_recursive_state_and_return"

"main$1_recursively_call_function":               ; preds = %"main$1_increment_depth_counter"
  call void @"main$1"(i64 %indvars.iv.next38, i16 %i6)
  ret void

"main$1_save_recursive_state_and_return":         ; preds = %"main$1_increment_depth_counter"
  %i8 = getelementptr %7, %7* @"main$1_recursion_state_struct", i32 0, i32 0
  store i64 %indvars.iv.next38, i64* %i8, align 8
  %i9 = getelementptr %7, %7* @"main$1_recursion_state_struct", i32 0, i32 1
  store i1 false, i1* %i9, align 1
  ret void

"main$1_return_from_recursive_function$0":        ; preds = %"main$1_latch$0"
  %i10 = getelementptr %7, %7* @"main$1_recursion_state_struct", i32 0, i32 1
  store i1 true, i1* %i10, align 1
  ret void
}

define void @"main$0"(i32 %arg, i32 %arg1, i16 %arg2) {
"main$0_latch$0":
...
"main$0_recursively_call_function":               ; preds = %"main$0_increment_depth_counter"
  call void @"main$0"(i32 %inc20, i32 %inc19, i16 %i)
  ret void

"main$0_save_recursive_state_and_return":         ; preds = %"main$0_increment_depth_counter"
  %i4 = getelementptr %8, %8* @"main$0_recursion_state_struct", i32 0, i32 0
  store i32 %inc20, i32* %i4, align 4
  %i5 = getelementptr %8, %8* @"main$0_recursion_state_struct", i32 0, i32 1
  store i32 %inc19, i32* %i5, align 4
  %i6 = getelementptr %8, %8* @"main$0_recursion_state_struct", i32 0, i32 2
  store i1 false, i1* %i6, align 1
  ret void

"main$0_return_from_recursive_function$0":        ; preds = %"main$0_latch$0"
  %i7 = getelementptr %8, %8* @"main$0_recursion_state_struct", i32 0, i32 2
  store i1 true, i1* %i7, align 1
  ret void
}

define void @"dijkstra$0$0"(i32 %arg, i32 %arg1, i16 %arg2) {
"dijkstra$0$0_header":
  %idxprom15 = sext i32 %arg to i64
  %i = load i64, i64* @"./benchmark_intermediate_representations/baseline/dijkstra/dijkstra_small.ll_invariant_variable$3", align 8
  %arrayidx18 = getelementptr inbounds [100 x [100 x i32]], [100 x [100 x i32]]* @AdjMatrix, i64 0, i64 %i, i64 %idxprom15
  %i3 = load i32, i32* %arrayidx18, align 4, !tbaa !13
  store i32 %i3, i32* @iCost, align 4, !tbaa !13
  %cmp19 = icmp eq i32 %i3, 9999
...
if.then20:                                        ; preds = %"dijkstra$0$0_header"
  ...
  %i4 = load i32, i32* %iDist23, align 8, !tbaa !14
  %cmp24 = icmp eq i32 %i4, 9999
  %.pre81 = load i32, i32* @iDist, align 4, !tbaa !13
  %add = add nsw i32 %.pre81, %i3
  %cmp28 = icmp sgt i32 %i4, %add
...
"dijkstra$0$0_exiting$1":                         ; preds = %if.then20
  ...
  %i5 = load i32, i32* @"./benchmark_intermediate_representations/baseline/dijkstra/dijkstra_small.ll_invariant_variable$2", align 4
  store i32 %i5, i32* %iPrev36, align 4, !tbaa !1
...
if.end.i68:                                       ; preds = %"dijkstra$0$0_exiting$1"
  ...
  %i7 = bitcast i8* %iDist3.i64 to i32*
  store i32 %add30, i32* %i7, align 4, !tbaa !10
  %iPrev4.i65 = getelementptr inbounds i8, i8* %call.i60, i64 8
  %i8 = bitcast i8* %iPrev4.i65 to i32*
  %i9 = load i32, i32* @"./benchmark_intermediate_representations/baseline/dijkstra/dijkstra_small.ll_invariant_variable$2", align 4
  store i32 %i9, i32* %i8, align 8, !tbaa !11
  %qNext.i66 = getelementptr inbounds i8, i8* %call.i60, i64 16
  %i10 = bitcast i8* %qNext.i66 to %struct._QITEM**
  store %struct._QITEM* null, %struct._QITEM** %i10, align 8, !tbaa !12
  %tobool5.i67 = icmp eq %struct._QITEM* %i6, null
...
"dijkstra$0$0$0_call_recursive_function":         ; preds = %"dijkstra$0$0$0_extract_next_values", %"dijkstra$0$0$0_initialize_context"
  %i11 = phi %struct._QITEM* [ %i6, %"dijkstra$0$0$0_initialize_context" ], [ %i15, %"dijkstra$0$0$0_extract_next_values" ]
  call void @"dijkstra$0$0$0"(%struct._QITEM* %i11, i16 0)
  %i12 = getelementptr %13, %13* @"dijkstra$0$0$0_recursion_state_struct", i32 0, i32 1
  %i13 = load i1, i1* %i12, align 1
  br i1 %i13, label %"dijkstra$0$0$0_extract_return_values$0", label %"dijkstra$0$0$0_extract_next_values"

"dijkstra$0$0$0_extract_next_values":             ; preds = %"dijkstra$0$0$0_call_recursive_function"
  %i14 = getelementptr %13, %13* @"dijkstra$0$0$0_recursion_state_struct", i32 0, i32 0
  %i15 = load %struct._QITEM*, %struct._QITEM** %i14, align 8
  br label %"dijkstra$0$0$0_call_recursive_function"

"dijkstra$0$0$0_extract_return_values$0":         ; preds = %"dijkstra$0$0$0_call_recursive_function"
  %i16 = getelementptr %12, %12* @"dijkstra$0$0$0_return_value_struct", i32 0, i32 0
  %i17 = load %struct._QITEM**, %struct._QITEM*** %i16, align 8
  br label %while.end.i74

while.end.i74:                                    ; preds = %"dijkstra$0$0$0_extract_return_values$0"
  %i18 = bitcast %struct._QITEM** %i17 to i8**
  store i8* %call.i60, i8** %i18, align 8, !tbaa !12
...
"dijkstra$0$0_increment_depth_counter":           ; preds = %"dijkstra$0$0_latch$0"
  ...
  br i1 %i20, label %"dijkstra$0$0_recursively_call_function", label %"dijkstra$0$0_save_recursive_state_and_return"

"dijkstra$0$0_recursively_call_function":         ; preds = %"dijkstra$0$0_increment_depth_counter"
  call void @"dijkstra$0$0"(i32 %inc40, i32 %.pr, i16 %i19)
  ret void

"dijkstra$0$0_save_recursive_state_and_return":   ; preds = %"dijkstra$0$0_increment_depth_counter"
  %i21 = getelementptr %10, %10* @"dijkstra$0$0_recursion_state_struct", i32 0, i32 0
  store i32 %inc40, i32* %i21, align 4
  %i22 = getelementptr %10, %10* @"dijkstra$0$0_recursion_state_struct", i32 0, i32 1
  store i32 %.pr, i32* %i22, align 4
  %i23 = getelementptr %10, %10* @"dijkstra$0$0_recursion_state_struct", i32 0, i32 2
  store i1 false, i1* %i23, align 1
  ret void

"dijkstra$0$0_return_from_recursive_function$0":  ; preds = %"dijkstra$0$0_latch$0"
  %i24 = getelementptr %9, %9* @"dijkstra$0$0_return_value_struct", i32 0, i32 0
  store i32 %.pr, i32* %i24, align 4
  %i25 = getelementptr %9, %9* @"dijkstra$0$0_return_value_struct", i32 0, i32 1
  store i8 1, i8* %i25, align 1
  %i26 = getelementptr %10, %10* @"dijkstra$0$0_recursion_state_struct", i32 0, i32 2
  store i1 true, i1* %i26, align 1
  ret void

"dijkstra$0$0_return_from_recursive_function$1":  ; preds = %"dijkstra$0$0_exiting$1"
  %i27 = getelementptr %9, %9* @"dijkstra$0$0_return_value_struct", i32 0, i32 1
  store i8 0, i8* %i27, align 1
  %i28 = getelementptr %10, %10* @"dijkstra$0$0_recursion_state_struct", i32 0, i32 2
  store i1 true, i1* %i28, align 1
  ret void
}

define void @"main$1$0"(i64 %arg, i16 %arg1) {
"main$1$0_latch$0":
  %i = load i32*, i32** @"./benchmark_intermediate_representations/baseline/dijkstra/dijkstra_small.ll_invariant_variable$0", align 8
  %i2 = load %struct._IO_FILE*, %struct._IO_FILE** @"./benchmark_intermediate_representations/baseline/dijkstra/dijkstra_small.ll_invariant_variable$1", align 8
  %call7 = call i32 (%struct._IO_FILE*, i8*, ...) @__isoc99_fscanf(%struct._IO_FILE* %i2, i8* nonnull getelementptr inbounds ([3 x i8], [3 x i8]* @.str.9, i64 0, i64 0), i32* nonnull %i) #6
  %i3 = load i32*, i32** @"./benchmark_intermediate_representations/baseline/dijkstra/dijkstra_small.ll_invariant_variable$0", align 8
  %i4 = load i32, i32* %i3, align 4, !tbaa !13
  %i5 = load i64, i64* @"./benchmark_intermediate_representations/baseline/dijkstra/dijkstra_small.ll_invariant_variable$4", align 8
  %arrayidx10 = getelementptr inbounds [100 x [100 x i32]], [100 x [100 x i32]]* @AdjMatrix, i64 0, i64 %i5, i64 %arg
  store i32 %i4, i32* %arrayidx10, align 4, !tbaa !13
  %indvars.iv.next = add nuw nsw i64 %arg, 1
...
"main$1$0_recursively_call_function":             ; preds = %"main$1$0_increment_depth_counter"
  call void @"main$1$0"(i64 %indvars.iv.next, i16 %i6)
  ret void

"main$1$0_save_recursive_state_and_return":       ; preds = %"main$1$0_increment_depth_counter"
  %i8 = getelementptr %11, %11* @"main$1$0_recursion_state_struct", i32 0, i32 0
  store i64 %indvars.iv.next, i64* %i8, align 8
  %i9 = getelementptr %11, %11* @"main$1$0_recursion_state_struct", i32 0, i32 1
  store i1 false, i1* %i9, align 1
  ret void

"main$1$0_return_from_recursive_function$0":      ; preds = %"main$1$0_latch$0"
  %i10 = getelementptr %11, %11* @"main$1$0_recursion_state_struct", i32 0, i32 1
  store i1 true, i1* %i10, align 1
  ret void
}

define void @"dijkstra$0$0$0"(%struct._QITEM* %arg, i16 %arg1) {
...
"dijkstra$0$0$0_increment_depth_counter":         ; preds = %"dijkstra$0$0$0_latch$0"
  %i2 = add i16 %arg1, 1
  %i3 = icmp ult i16 %i2, 256
  br i1 %i3, label %"dijkstra$0$0$0_recursively_call_function", label %"dijkstra$0$0$0_save_recursive_state_and_return"

"dijkstra$0$0$0_recursively_call_function":       ; preds = %"dijkstra$0$0$0_increment_depth_counter"
  call void @"dijkstra$0$0$0"(%struct._QITEM* %i, i16 %i2)
  ret void

"dijkstra$0$0$0_save_recursive_state_and_return": ; preds = %"dijkstra$0$0$0_increment_depth_counter"
  %i4 = getelementptr %13, %13* @"dijkstra$0$0$0_recursion_state_struct", i32 0, i32 0
  store %struct._QITEM* %i, %struct._QITEM** %i4, align 8
  %i5 = getelementptr %13, %13* @"dijkstra$0$0$0_recursion_state_struct", i32 0, i32 1
  store i1 false, i1* %i5, align 1
  ret void

"dijkstra$0$0$0_return_from_recursive_function$0": ; preds = %"dijkstra$0$0$0_latch$0"
  %i6 = getelementptr %12, %12* @"dijkstra$0$0$0_return_value_struct", i32 0, i32 0
  store %struct._QITEM** %qNext7.i71, %struct._QITEM*** %i6, align 8
  %i7 = getelementptr %13, %13* @"dijkstra$0$0$0_recursion_state_struct", i32 0, i32 1
  store i1 true, i1* %i7, align 1
  ret void
}
