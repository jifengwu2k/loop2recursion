; ModuleID = './benchmark_intermediate_representations/new_loop2recursion-recursion_depth_limit-256/sha/sha.ll.temp'
...
"sha_update$0_call_recursive_function":           ; preds = %"sha_update$0_extract_next_values", %"sha_update$0_initialize_context"
  ...
  call void @"sha_update$0"(i8* %i10, i32 %i11, i16 0)
...
"sha_transform$4_call_recursive_function":        ; preds = %"sha_transform$4_extract_next_values", %"sha_transform$4_initialize_context"
  ...
  call void @"sha_transform$4"(i64 %i1, i16 0)
...
"sha_transform$3_call_recursive_function":        ; preds = %"sha_transform$3_extract_next_values", %"sha_transform$3_initialize_context"
  ...
  call void @"sha_transform$3"(i64 %i11, i64 %i12, i64 %i13, i64 %i14, i64 %i15, i64 %i16, i16 0)
...
"sha_transform$2_call_recursive_function":        ; preds = %"sha_transform$2_extract_next_values", %"sha_transform$2_initialize_context"
  ...
  call void @"sha_transform$2"(i64 %i41, i64 %i42, i64 %i43, i64 %i44, i64 %i45, i64 %i46, i16 0)
...
"sha_transform$1_call_recursive_function":        ; preds = %"sha_transform$1_extract_next_values", %"sha_transform$1_initialize_context"
  ...
  call void @"sha_transform$1"(i64 %i71, i64 %i72, i64 %i73, i64 %i74, i64 %i75, i64 %i76, i16 0)
...
"sha_transform$0_call_recursive_function":        ; preds = %"sha_transform$0_extract_next_values", %"sha_transform$0_initialize_context"
  ...
  call void @"sha_transform$0"(i64 %i101, i64 %i102, i64 %i103, i64 %i104, i64 %i105, i64 %i106, i16 0)
...
"sha_stream$0_call_recursive_function":           ; preds = %"sha_stream$0_extract_next_values", %"sha_stream$0_initialize_context"
  ...
  call void @"sha_stream$0"(i32 %i4, i16 0)
...
define void @"sha_update$0"(i8* %arg, i32 %arg1, i16 %arg2) {
...
"sha_update$0_recursively_call_function":         ; preds = %"sha_update$0_increment_depth_counter"
  call void @"sha_update$0"(i8* %add.ptr, i32 %sub, i16 %i100)
  ret void
...
define void @"sha_transform$4"(i64 %arg, i16 %arg1) {
...
"sha_transform$4_recursively_call_function":      ; preds = %"sha_transform$4_increment_depth_counter"
  call void @"sha_transform$4"(i64 %indvars.iv.next253.1, i16 %i27)
  ret void
...
define void @"sha_transform$3"(i64 %arg, i64 %arg1, i64 %arg2, i64 %arg3, i64 %arg4, i64 %arg5, i16 %arg6) {
...
"sha_transform$3_recursively_call_function":      ; preds = %"sha_transform$3_increment_depth_counter"
  call void @"sha_transform$3"(i64 %add42, i64 %arg, i64 %or45, i64 %arg2, i64 %indvars.iv.next250, i64 %arg3, i16 %i8)
  ret void
...
define void @"sha_transform$2"(i64 %arg, i64 %arg1, i64 %arg2, i64 %arg3, i64 %arg4, i64 %arg5, i16 %arg6) {
...
"sha_transform$2_recursively_call_function":      ; preds = %"sha_transform$2_increment_depth_counter"
  call void @"sha_transform$2"(i64 %add62, i64 %arg, i64 %or65, i64 %arg2, i64 %indvars.iv.next247, i64 %arg3, i16 %i8)
  ret void
...
define void @"sha_transform$1"(i64 %arg, i64 %arg1, i64 %arg2, i64 %arg3, i64 %arg4, i64 %arg5, i16 %arg6) {
...
"sha_transform$1_recursively_call_function":      ; preds = %"sha_transform$1_increment_depth_counter"
  call void @"sha_transform$1"(i64 %add85, i64 %arg, i64 %or88, i64 %arg2, i64 %indvars.iv.next244, i64 %arg3, i16 %i8)
  ret void
...
define void @"sha_transform$0"(i64 %arg, i64 %arg1, i64 %arg2, i64 %arg3, i64 %arg4, i64 %arg5, i16 %arg6) {
...
"sha_transform$0_recursively_call_function":      ; preds = %"sha_transform$0_increment_depth_counter"
  call void @"sha_transform$0"(i64 %add105, i64 %arg, i64 %arg3, i64 %or108, i64 %indvars.iv.next, i64 %arg2, i16 %i8)
  ret void
...
define void @"sha_stream$0"(i32 %arg, i16 %arg1) {
...
"sha_stream$0_recursively_call_function":         ; preds = %"sha_stream$0_increment_depth_counter"
  call void @"sha_stream$0"(i32 %conv, i16 %i5)
  ret void
