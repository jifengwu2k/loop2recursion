; ModuleID = './benchmark_intermediate_representations/new_loop2recursion-recursion_depth_limit-256/bitcnts/bitcnt_1.ll.temp'
...
"bit_count$0_call_recursive_function":            ; preds = %"bit_count$0_extract_next_values", %"bit_count$0_initialize_context"
  ...
  call void @"bit_count$0"(i32 %i, i64 %i1, i16 0)
...
define void @"bit_count$0"(i32 %arg, i64 %arg1, i16 %arg2) {
"bit_count$0_latch$0":
...
"bit_count$0_recursively_call_function":          ; preds = %"bit_count$0_increment_depth_counter"
  call void @"bit_count$0"(i32 %inc, i64 %and, i16 %i)
  ret void
