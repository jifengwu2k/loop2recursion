; ModuleID = './benchmark_intermediate_representations/new_loop2recursion-recursion_depth_limit-256/bitcnts/bitstrng.ll.temp'
...
"bitstring$0_call_recursive_function":            ; preds = %"bitstring$0_extract_next_values", %"bitstring$0_initialize_context"
  ...
  call void @"bitstring$0"(i8* %i6, i64 %i7, i16 0)
...
define void @"bitstring$0"(i8* %arg, i64 %arg1, i16 %arg2) {
"bitstring$0_header":
...
"bitstring$0_recursively_call_function":          ; preds = %"bitstring$0_increment_depth_counter"
  call void @"bitstring$0"(i8* %str.addr.1.be, i64 %indvars.iv.next, i16 %i4)
  ret void
