; ModuleID = './benchmark_intermediate_representations/new_loop2recursion-recursion_depth_limit-256/bitcnts/bitcnts.ll.temp'
...
"main$0_call_recursive_function":                 ; preds = %"main$0_extract_next_values", %"main$0_initialize_context"
  ...
  call void @"main$0"(double %i3, i32 %i4, i64 %i5, i32 %i6, double %i7, i16 0)
...
"bit_shifter$0_call_recursive_function":          ; preds = %"bit_shifter$0_extract_next_values", %"bit_shifter$0_initialize_context"
  ...
  call void @"bit_shifter$0"(i64 %i, i32 %i1, i32 %i2, i16 0)
...
define void @"main$0"(double %arg, i32 %arg1, i64 %arg2, i32 %arg3, double %arg4, i16 %arg5) {
"main$0_header":
...
"main$0$0_call_recursive_function":               ; preds = %"main$0$0_extract_next_values", %"main$0$0_initialize_context"
  ...
  call void @"main$0$0"(i64 %i7, i64 %i8, i64 %i9, i16 0)
...
"main$0_recursively_call_function":               ; preds = %"main$0_increment_depth_counter"
  call void @"main$0"(double %cmax.1, i32 %cmaxix.1, i64 %indvars.iv.next, i32 %cminix.1, double %cmin.1, i16 %i22)
  ret void
...
define void @"bit_shifter$0"(i64 %arg, i32 %arg1, i32 %arg2, i16 %arg3) {
...
"bit_shifter$0_recursively_call_function":        ; preds = %"bit_shifter$0_increment_depth_counter"
  call void @"bit_shifter$0"(i64 %shr, i32 %add, i32 %inc, i16 %i)
  ret void
...
define void @"main$0$0"(i64 %arg, i64 %arg1, i64 %arg2, i16 %arg3) {
"main$0$0_latch$0":
...
"main$0$0_recursively_call_function":             ; preds = %"main$0$0_increment_depth_counter"
  call void @"main$0$0"(i64 %inc, i64 %add14, i64 %add, i16 %i5)
  ret void
