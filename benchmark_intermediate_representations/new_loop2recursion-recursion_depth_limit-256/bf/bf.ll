; ModuleID = './benchmark_intermediate_representations/new_loop2recursion-recursion_depth_limit-256/bf/bf.ll.temp'
...
"main$1_call_recursive_function":                 ; preds = %"main$1_extract_next_values", %"main$1_initialize_context"
  ...
  call void @"main$1"(i8* %i9, i32 %i10, i32 %i11, i16 0)
...
define void @"main$1"(i8* %arg, i32 %arg1, i32 %arg2, i16 %arg3) {
"main$1_exiting$1":
...
"main$1_recursively_call_function":               ; preds = %"main$1_increment_depth_counter"
  call void @"main$1"(i8* %incdec.ptr, i32 %sub, i32 %inc, i16 %i7)
  ret void
...
"main$0$1_call_recursive_function":               ; preds = %"main$0$1_extract_next_values", %"main$0$1_initialize_context"
  ...
  call void @"main$0$1"(i64 %i7, i16 0)
...
"main$0$0_call_recursive_function":               ; preds = %"main$0$0_extract_next_values", %"main$0$0_initialize_context"
  ...
  call void @"main$0$0"(i64 %i21, i16 0)
...
"main$0$1_recursively_call_function":             ; preds = %"main$0$1_increment_depth_counter"
  call void @"main$0$1"(i64 %indvars.iv.next, i16 %i5)
  ret void
...
define void @"main$0$0"(i64 %arg, i16 %arg1) {
"main$0$0_latch$0":
...
"main$0$0_recursively_call_function":             ; preds = %"main$0$0_increment_depth_counter"
  call void @"main$0$0"(i64 %indvars.iv.next159, i16 %i5)
  ret void
