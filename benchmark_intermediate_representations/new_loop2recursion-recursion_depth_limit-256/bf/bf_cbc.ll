; ModuleID = './benchmark_intermediate_representations/new_loop2recursion-recursion_depth_limit-256/bf/bf_cbc.ll.temp'
...
"BF_cbc_encrypt$1_call_recursive_function":       ; preds = %"BF_cbc_encrypt$1_extract_next_values", %"BF_cbc_encrypt$1_initialize_context"
  ...
  call void @"BF_cbc_encrypt$1"(<2 x i64> %i31, i8* %i32, i64 %i33, i8* %i34, i16 0)
...
"BF_cbc_encrypt$0_call_recursive_function":       ; preds = %"BF_cbc_encrypt$0_extract_next_values", %"BF_cbc_encrypt$0_initialize_context"
  ...
  call void @"BF_cbc_encrypt$0"(i8* %i51, i64 %i52, i8* %i53, i64 %i54, i64 %i55, i16 0)
...
define void @"BF_cbc_encrypt$1"(<2 x i64> %arg, i8* %arg1, i64 %arg2, i8* %arg3, i16 %arg4) {
...
"BF_cbc_encrypt$1_recursively_call_function":     ; preds = %"BF_cbc_encrypt$1_increment_depth_counter"
  call void @"BF_cbc_encrypt$1"(<2 x i64> %i35, i8* %incdec.ptr85, i64 %l.0, i8* %incdec.ptr51, i16 %i38)
  ret void
...
define void @"BF_cbc_encrypt$0"(i8* %arg, i64 %arg1, i8* %arg2, i64 %arg3, i64 %arg4, i16 %arg5) {
...
"BF_cbc_encrypt$0_recursively_call_function":     ; preds = %"BF_cbc_encrypt$0_increment_depth_counter"
  call void @"BF_cbc_encrypt$0"(i8* %incdec.ptr253, i64 %l.1, i8* %incdec.ptr292, i64 %i38, i64 %i39, i16 %i40)
  ret void
