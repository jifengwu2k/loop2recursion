; ModuleID = './benchmark_intermediate_representations/new_loop2recursion-recursion_depth_limit-256/bf/bf_ofb64.ll.temp'
...
@"./benchmark_intermediate_representations/baseline/bf/bf_ofb64.ll_invariant_variable$0" = dso_local global i8* null
@"./benchmark_intermediate_representations/baseline/bf/bf_ofb64.ll_invariant_variable$1" = dso_local global i8* null
@"./benchmark_intermediate_representations/baseline/bf/bf_ofb64.ll_invariant_variable$2" = dso_local global i64* null
...
@"./benchmark_intermediate_representations/baseline/bf/bf_ofb64.ll_invariant_variable$5" = dso_local global i64* null
@"./benchmark_intermediate_representations/baseline/bf/bf_ofb64.ll_invariant_variable$6" = dso_local global i8* null
@"./benchmark_intermediate_representations/baseline/bf/bf_ofb64.ll_invariant_variable$7" = dso_local global [8 x i8]* null
...
"BF_ofb64_encrypt$0_initialize_context":          ; preds = %while.body.preheader
  store i8* %incdec.ptr46, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_ofb64.ll_invariant_variable$0", align 8
  store i8* %incdec.ptr38, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_ofb64.ll_invariant_variable$1", align 8
  store i64* %arrayidx25, i64** @"./benchmark_intermediate_representations/baseline/bf/bf_ofb64.ll_invariant_variable$2", align 8
  store i8* %incdec.ptr42, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_ofb64.ll_invariant_variable$3", align 8
  ...
  store i64* %arrayidx, i64** @"./benchmark_intermediate_representations/baseline/bf/bf_ofb64.ll_invariant_variable$5", align 8
  store i8* %incdec.ptr35, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_ofb64.ll_invariant_variable$6", align 8
  store [8 x i8]* %d, [8 x i8]** @"./benchmark_intermediate_representations/baseline/bf/bf_ofb64.ll_invariant_variable$7", align 8
  store i8* %i1, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_ofb64.ll_invariant_variable$8", align 8
...
"BF_ofb64_encrypt$0_call_recursive_function":     ; preds = %"BF_ofb64_encrypt$0_extract_next_values", %"BF_ofb64_encrypt$0_initialize_context"
  ...
  call void @"BF_ofb64_encrypt$0"(i8* %i29, i8* %i30, i32 %i31, i64 %i32, i32 %i33, i16 0)
...
define void @"BF_ofb64_encrypt$0"(i8* %arg, i8* %arg1, i32 %arg2, i64 %arg3, i32 %arg4, i16 %arg5) {
...
if.then:                                          ; preds = %"BF_ofb64_encrypt$0_header"
  ...
  %i6 = load i64*, i64** @"./benchmark_intermediate_representations/baseline/bf/bf_ofb64.ll_invariant_variable$5", align 8
  call void @BF_encrypt(i64* %i6, %struct.bf_key_st* %i, i32 1) #3
  %i7 = load i64*, i64** @"./benchmark_intermediate_representations/baseline/bf/bf_ofb64.ll_invariant_variable$5", align 8
  %i8 = load i64, i64* %i7, align 16, !tbaa !6
  %shr58 = lshr i64 %i8, 24
  %conv60 = trunc i64 %shr58 to i8
  %i9 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_ofb64.ll_invariant_variable$8", align 8
  store i8 %conv60, i8* %i9, align 1, !tbaa !5
  %shr62 = lshr i64 %i8, 16
  %conv64 = trunc i64 %shr62 to i8
  %i10 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_ofb64.ll_invariant_variable$9", align 8
  store i8 %conv64, i8* %i10, align 1, !tbaa !5
  %shr66 = lshr i64 %i8, 8
  %conv68 = trunc i64 %shr66 to i8
  %i11 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_ofb64.ll_invariant_variable$11", align 8
  store i8 %conv68, i8* %i11, align 1, !tbaa !5
  %conv71 = trunc i64 %i8 to i8
  %i12 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_ofb64.ll_invariant_variable$6", align 8
  store i8 %conv71, i8* %i12, align 1, !tbaa !5
  %i13 = load i64*, i64** @"./benchmark_intermediate_representations/baseline/bf/bf_ofb64.ll_invariant_variable$2", align 8
  %i14 = load i64, i64* %i13, align 8, !tbaa !6
  %shr74 = lshr i64 %i14, 24
  %conv76 = trunc i64 %shr74 to i8
  %i15 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_ofb64.ll_invariant_variable$1", align 8
  store i8 %conv76, i8* %i15, align 1, !tbaa !5
  %shr78 = lshr i64 %i14, 16
  %conv80 = trunc i64 %shr78 to i8
  %i16 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_ofb64.ll_invariant_variable$3", align 8
  store i8 %conv80, i8* %i16, align 1, !tbaa !5
  %shr82 = lshr i64 %i14, 8
  %conv84 = trunc i64 %shr82 to i8
  %i17 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_ofb64.ll_invariant_variable$0", align 8
  store i8 %conv84, i8* %i17, align 1, !tbaa !5
  %conv87 = trunc i64 %i14 to i8
  %i18 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_ofb64.ll_invariant_variable$10", align 8
...
"BF_ofb64_encrypt$0_latch$0":                     ; preds = %if.then, %"BF_ofb64_encrypt$0_header"
  ...
  %i20 = load [8 x i8]*, [8 x i8]** @"./benchmark_intermediate_representations/baseline/bf/bf_ofb64.ll_invariant_variable$7", align 8
...
"BF_ofb64_encrypt$0_recursively_call_function":   ; preds = %"BF_ofb64_encrypt$0_increment_depth_counter"
  call void @"BF_ofb64_encrypt$0"(i8* %incdec.ptr94, i8* %incdec.ptr89, i32 %and95, i64 %dec213, i32 %save.1, i16 %i22)
  ret void
