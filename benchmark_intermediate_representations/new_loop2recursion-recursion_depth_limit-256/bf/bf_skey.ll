; ModuleID = './benchmark_intermediate_representations/new_loop2recursion-recursion_depth_limit-256/bf/bf_skey.ll.temp'
...
"BF_set_key$1_call_recursive_function":           ; preds = %"BF_set_key$1_extract_next_values", %"BF_set_key$1_initialize_context"
  ...
  call void @"BF_set_key$1"(i8* %i2, i64 %i3, i64 %i4, i16 0)
...
"BF_set_key$0_call_recursive_function":           ; preds = %"BF_set_key$0_extract_next_values", %"BF_set_key$0_initialize_context"
  ...
  call void @"BF_set_key$0"(i64 %i32, i16 0)
...
define void @"BF_set_key$1"(i8* %arg, i64 %arg1, i64 %arg2, i16 %arg3) {
...
"BF_set_key$1_recursively_call_function":         ; preds = %"BF_set_key$1_increment_depth_counter"
  call void @"BF_set_key$1"(i8* %d.4, i64 %.pre, i64 %indvars.iv.next116, i16 %i17)
  ret void
...
define void @"BF_set_key$0"(i64 %arg, i16 %arg1) {
...
"BF_set_key$0_recursively_call_function":         ; preds = %"BF_set_key$0_increment_depth_counter"
  call void @"BF_set_key$0"(i64 %indvars.iv.next, i16 %i7)
  ret void
