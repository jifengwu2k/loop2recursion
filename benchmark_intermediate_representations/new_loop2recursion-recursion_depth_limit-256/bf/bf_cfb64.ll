; ModuleID = './benchmark_intermediate_representations/new_loop2recursion-recursion_depth_limit-256/bf/bf_cfb64.ll.temp'
...
"BF_cfb64_encrypt$1_call_recursive_function":     ; preds = %"BF_cfb64_encrypt$1_extract_next_values", %"BF_cfb64_encrypt$1_initialize_context"
  %i2 = phi i8* [ %out, %"BF_cfb64_encrypt$1_initialize_context" ], [ %i9, %"BF_cfb64_encrypt$1_extract_next_values" ]
  %i3 = phi i8* [ %in, %"BF_cfb64_encrypt$1_initialize_context" ], [ %i11, %"BF_cfb64_encrypt$1_extract_next_values" ]
  %i4 = phi i64 [ %dec68247, %"BF_cfb64_encrypt$1_initialize_context" ], [ %i13, %"BF_cfb64_encrypt$1_extract_next_values" ]
  %i5 = phi i32 [ %i, %"BF_cfb64_encrypt$1_initialize_context" ], [ %i15, %"BF_cfb64_encrypt$1_extract_next_values" ]
  call void @"BF_cfb64_encrypt$1"(i8* %i2, i8* %i3, i64 %i4, i32 %i5, i16 0)
  %i6 = getelementptr %1, %1* @"BF_cfb64_encrypt$1_recursion_state_struct", i32 0, i32 4
  %i7 = load i1, i1* %i6, align 1
  br i1 %i7, label %"BF_cfb64_encrypt$1_extract_return_values$0", label %"BF_cfb64_encrypt$1_extract_next_values"

"BF_cfb64_encrypt$1_extract_next_values":         ; preds = %"BF_cfb64_encrypt$1_call_recursive_function"
  %i8 = getelementptr %1, %1* @"BF_cfb64_encrypt$1_recursion_state_struct", i32 0, i32 0
  %i9 = load i8*, i8** %i8, align 8
  %i10 = getelementptr %1, %1* @"BF_cfb64_encrypt$1_recursion_state_struct", i32 0, i32 1
  %i11 = load i8*, i8** %i10, align 8
  %i12 = getelementptr %1, %1* @"BF_cfb64_encrypt$1_recursion_state_struct", i32 0, i32 2
  %i13 = load i64, i64* %i12, align 8
  %i14 = getelementptr %1, %1* @"BF_cfb64_encrypt$1_recursion_state_struct", i32 0, i32 3
  %i15 = load i32, i32* %i14, align 4
  br label %"BF_cfb64_encrypt$1_call_recursive_function"

"BF_cfb64_encrypt$1_extract_return_values$0":     ; preds = %"BF_cfb64_encrypt$1_call_recursive_function"
  %i16 = getelementptr %0, %0* @"BF_cfb64_encrypt$1_return_value_struct", i32 0, i32 0
...
"BF_cfb64_encrypt$0_call_recursive_function":     ; preds = %"BF_cfb64_encrypt$0_extract_next_values", %"BF_cfb64_encrypt$0_initialize_context"
  %i18 = phi i8* [ %in, %"BF_cfb64_encrypt$0_initialize_context" ], [ %i25, %"BF_cfb64_encrypt$0_extract_next_values" ]
  %i19 = phi i64 [ %dec68247, %"BF_cfb64_encrypt$0_initialize_context" ], [ %i27, %"BF_cfb64_encrypt$0_extract_next_values" ]
  %i20 = phi i8* [ %out, %"BF_cfb64_encrypt$0_initialize_context" ], [ %i29, %"BF_cfb64_encrypt$0_extract_next_values" ]
  %i21 = phi i32 [ %i, %"BF_cfb64_encrypt$0_initialize_context" ], [ %i31, %"BF_cfb64_encrypt$0_extract_next_values" ]
  call void @"BF_cfb64_encrypt$0"(i8* %i18, i64 %i19, i8* %i20, i32 %i21, i16 0)
  %i22 = getelementptr %3, %3* @"BF_cfb64_encrypt$0_recursion_state_struct", i32 0, i32 4
  %i23 = load i1, i1* %i22, align 1
  br i1 %i23, label %"BF_cfb64_encrypt$0_extract_return_values$0", label %"BF_cfb64_encrypt$0_extract_next_values"

"BF_cfb64_encrypt$0_extract_next_values":         ; preds = %"BF_cfb64_encrypt$0_call_recursive_function"
  %i24 = getelementptr %3, %3* @"BF_cfb64_encrypt$0_recursion_state_struct", i32 0, i32 0
  %i25 = load i8*, i8** %i24, align 8
  %i26 = getelementptr %3, %3* @"BF_cfb64_encrypt$0_recursion_state_struct", i32 0, i32 1
  %i27 = load i64, i64* %i26, align 8
  %i28 = getelementptr %3, %3* @"BF_cfb64_encrypt$0_recursion_state_struct", i32 0, i32 2
  %i29 = load i8*, i8** %i28, align 8
  %i30 = getelementptr %3, %3* @"BF_cfb64_encrypt$0_recursion_state_struct", i32 0, i32 3
  %i31 = load i32, i32* %i30, align 4
  br label %"BF_cfb64_encrypt$0_call_recursive_function"

"BF_cfb64_encrypt$0_extract_return_values$0":     ; preds = %"BF_cfb64_encrypt$0_call_recursive_function"
  %i32 = getelementptr %2, %2* @"BF_cfb64_encrypt$0_return_value_struct", i32 0, i32 0
...
if.end151:                                        ; preds = %if.end151.loopexit263, %if.end151.loopexit, %while.cond67.preheader, %while.cond.preheader
  %n.2 = phi i32 [ %i, %while.cond67.preheader ], [ %i, %while.cond.preheader ], [ %i33, %if.end151.loopexit ], [ %i17, %if.end151.loopexit263 ]
...
define void @"BF_cfb64_encrypt$1"(i8* %arg, i8* %arg1, i64 %arg2, i32 %arg3, i16 %arg4) {
...
if.then2:                                         ; preds = %"BF_cfb64_encrypt$1_header"
  %i = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$8", align 8
  %i5 = load i8, i8* %i, align 1, !tbaa !5
  %i6 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$6", align 8
  %i7 = load i8, i8* %i6, align 1, !tbaa !5
  %i8 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$9", align 8
  %i9 = load i8, i8* %i8, align 1, !tbaa !5
  %i10 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$11", align 8
  %i11 = load i8, i8* %i10, align 1, !tbaa !5
  %i12 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$7", align 8
  ...
  %i18 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$10", align 8
  %i19 = load i8, i8* %i18, align 1, !tbaa !5
  %i20 = insertelement <2 x i8> undef, i8 %i7, i32 0
  %i21 = insertelement <2 x i8> %i20, i8 %i19, i32 1
  %i22 = zext <2 x i8> %i21 to <2 x i64>
  %i23 = shl nuw nsw <2 x i64> %i22, <i64 16, i64 16>
  %i24 = or <2 x i64> %i23, %i17
  %i25 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$5", align 8
  %i26 = load i8, i8* %i25, align 1, !tbaa !5
  %i27 = insertelement <2 x i8> undef, i8 %i9, i32 0
  %i28 = insertelement <2 x i8> %i27, i8 %i26, i32 1
  %i29 = zext <2 x i8> %i28 to <2 x i64>
  %i30 = shl nuw nsw <2 x i64> %i29, <i64 8, i64 8>
  %i31 = or <2 x i64> %i24, %i30
  %i32 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$4", align 8
  %i33 = load i8, i8* %i32, align 1, !tbaa !5
  %i34 = insertelement <2 x i8> undef, i8 %i11, i32 0
  %i35 = insertelement <2 x i8> %i34, i8 %i33, i32 1
  %i36 = zext <2 x i8> %i35 to <2 x i64>
  %i37 = or <2 x i64> %i31, %i36
  %i38 = load <2 x i64>*, <2 x i64>** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$3", align 8
  store <2 x i64> %i37, <2 x i64>* %i38, align 16, !tbaa !6
  %i39 = load %struct.bf_key_st*, %struct.bf_key_st** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$1", align 8
  %i40 = load i64*, i64** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$2", align 8
  call void @BF_encrypt(i64* %i40, %struct.bf_key_st* %i39, i32 1) #3
  %i41 = load i64*, i64** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$2", align 8
  %i42 = load i64, i64* %i41, align 16, !tbaa !6
  %shr = lshr i64 %i42, 24
  %conv29 = trunc i64 %shr to i8
  %i43 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$8", align 8
  store i8 %conv29, i8* %i43, align 1, !tbaa !5
  %shr31 = lshr i64 %i42, 16
  %conv33 = trunc i64 %shr31 to i8
  %i44 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$6", align 8
  store i8 %conv33, i8* %i44, align 1, !tbaa !5
  ...
  store i8 %conv37, i8* %i45, align 1, !tbaa !5
  %conv40 = trunc i64 %i42 to i8
  %i46 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$11", align 8
  store i8 %conv40, i8* %i46, align 1, !tbaa !5
  %i47 = load i64*, i64** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$0", align 8
  %i48 = load i64, i64* %i47, align 8, !tbaa !6
  %shr43 = lshr i64 %i48, 24
  %conv45 = trunc i64 %shr43 to i8
  %i49 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$7", align 8
  store i8 %conv45, i8* %i49, align 1, !tbaa !5
  %shr47 = lshr i64 %i48, 16
  %conv49 = trunc i64 %shr47 to i8
  %i50 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$10", align 8
  store i8 %conv49, i8* %i50, align 1, !tbaa !5
  %shr51 = lshr i64 %i48, 8
  %conv53 = trunc i64 %shr51 to i8
  %i51 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$5", align 8
  store i8 %conv53, i8* %i51, align 1, !tbaa !5
  %conv56 = trunc i64 %i48 to i8
  %i52 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$4", align 8
  store i8 %conv56, i8* %i52, align 1, !tbaa !5
...
"BF_cfb64_encrypt$1_latch$0":                     ; preds = %if.then2, %"BF_cfb64_encrypt$1_header"
  ...
  %i53 = load i8, i8* %arg1, align 1, !tbaa !5
  %idxprom = sext i32 %arg3 to i64
  %i54 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$8", align 8
  %arrayidx60 = getelementptr inbounds i8, i8* %i54, i64 %idxprom
  %i55 = load i8, i8* %arrayidx60, align 1, !tbaa !5
  %xor245 = xor i8 %i55, %i53
  ...
  %and66 = and i32 %add, 7
  %dec = add nsw i64 %arg2, -1
  %tobool1 = icmp eq i64 %arg2, 0
...
"BF_cfb64_encrypt$1_increment_depth_counter":     ; preds = %"BF_cfb64_encrypt$1_latch$0"
  %i56 = add i16 %arg4, 1
  %i57 = icmp ult i16 %i56, 256
  br i1 %i57, label %"BF_cfb64_encrypt$1_recursively_call_function", label %"BF_cfb64_encrypt$1_save_recursive_state_and_return"

"BF_cfb64_encrypt$1_recursively_call_function":   ; preds = %"BF_cfb64_encrypt$1_increment_depth_counter"
  call void @"BF_cfb64_encrypt$1"(i8* %incdec.ptr63, i8* %incdec.ptr58, i64 %dec, i32 %and66, i16 %i56)
  ret void

"BF_cfb64_encrypt$1_save_recursive_state_and_return": ; preds = %"BF_cfb64_encrypt$1_increment_depth_counter"
  %i58 = getelementptr %1, %1* @"BF_cfb64_encrypt$1_recursion_state_struct", i32 0, i32 0
  store i8* %incdec.ptr63, i8** %i58, align 8
  %i59 = getelementptr %1, %1* @"BF_cfb64_encrypt$1_recursion_state_struct", i32 0, i32 1
  store i8* %incdec.ptr58, i8** %i59, align 8
  %i60 = getelementptr %1, %1* @"BF_cfb64_encrypt$1_recursion_state_struct", i32 0, i32 2
  store i64 %dec, i64* %i60, align 8
  %i61 = getelementptr %1, %1* @"BF_cfb64_encrypt$1_recursion_state_struct", i32 0, i32 3
  store i32 %and66, i32* %i61, align 4
  %i62 = getelementptr %1, %1* @"BF_cfb64_encrypt$1_recursion_state_struct", i32 0, i32 4
  store i1 false, i1* %i62, align 1
  ret void

"BF_cfb64_encrypt$1_return_from_recursive_function$0": ; preds = %"BF_cfb64_encrypt$1_latch$0"
  %i63 = getelementptr %0, %0* @"BF_cfb64_encrypt$1_return_value_struct", i32 0, i32 0
  store i32 %and66, i32* %i63, align 4
  %i64 = getelementptr %1, %1* @"BF_cfb64_encrypt$1_recursion_state_struct", i32 0, i32 4
  store i1 true, i1* %i64, align 1
  ret void
}

define void @"BF_cfb64_encrypt$0"(i8* %arg, i64 %arg1, i8* %arg2, i32 %arg3, i16 %arg4) {
"BF_cfb64_encrypt$0_header":
  %cmp71 = icmp eq i32 %arg3, 0
  br i1 %cmp71, label %if.then73, label %"BF_cfb64_encrypt$0_latch$0"

if.then73:                                        ; preds = %"BF_cfb64_encrypt$0_header"
  %i = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$8", align 8
  %i5 = load i8, i8* %i, align 1, !tbaa !5
  %i6 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$16", align 8
  %i7 = load i8, i8* %i6, align 1, !tbaa !5
  %i8 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$17", align 8
  %i9 = load i8, i8* %i8, align 1, !tbaa !5
  %i10 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$18", align 8
  %i11 = load i8, i8* %i10, align 1, !tbaa !5
  %i12 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$19", align 8
  %i13 = load i8, i8* %i12, align 1, !tbaa !5
  %i14 = insertelement <2 x i8> undef, i8 %i5, i32 0
  %i15 = insertelement <2 x i8> %i14, i8 %i13, i32 1
  %i16 = zext <2 x i8> %i15 to <2 x i64>
  %i17 = shl nuw nsw <2 x i64> %i16, <i64 24, i64 24>
  %i18 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$20", align 8
  %i19 = load i8, i8* %i18, align 1, !tbaa !5
  %i20 = insertelement <2 x i8> undef, i8 %i7, i32 0
  %i21 = insertelement <2 x i8> %i20, i8 %i19, i32 1
  %i22 = zext <2 x i8> %i21 to <2 x i64>
  %i23 = shl nuw nsw <2 x i64> %i22, <i64 16, i64 16>
  %i24 = or <2 x i64> %i23, %i17
  %i25 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$14", align 8
  %i26 = load i8, i8* %i25, align 1, !tbaa !5
  %i27 = insertelement <2 x i8> undef, i8 %i9, i32 0
  %i28 = insertelement <2 x i8> %i27, i8 %i26, i32 1
  %i29 = zext <2 x i8> %i28 to <2 x i64>
  %i30 = shl nuw nsw <2 x i64> %i29, <i64 8, i64 8>
  %i31 = or <2 x i64> %i24, %i30
  %i32 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$13", align 8
  %i33 = load i8, i8* %i32, align 1, !tbaa !5
  %i34 = insertelement <2 x i8> undef, i8 %i11, i32 0
  %i35 = insertelement <2 x i8> %i34, i8 %i33, i32 1
  %i36 = zext <2 x i8> %i35 to <2 x i64>
  ...
  store <2 x i64> %i37, <2 x i64>* %i38, align 16, !tbaa !6
  %i39 = load %struct.bf_key_st*, %struct.bf_key_st** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$1", align 8
  %i40 = load i64*, i64** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$15", align 8
  call void @BF_encrypt(i64* %i40, %struct.bf_key_st* %i39, i32 1) #3
  %i41 = load i64*, i64** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$15", align 8
  %i42 = load i64, i64* %i41, align 16, !tbaa !6
  %shr106 = lshr i64 %i42, 24
  %conv108 = trunc i64 %shr106 to i8
  %i43 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$8", align 8
  store i8 %conv108, i8* %i43, align 1, !tbaa !5
  %shr110 = lshr i64 %i42, 16
  %conv112 = trunc i64 %shr110 to i8
  %i44 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$16", align 8
  store i8 %conv112, i8* %i44, align 1, !tbaa !5
  %shr114 = lshr i64 %i42, 8
  %conv116 = trunc i64 %shr114 to i8
  %i45 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$17", align 8
  store i8 %conv116, i8* %i45, align 1, !tbaa !5
  %conv119 = trunc i64 %i42 to i8
  %i46 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$18", align 8
  store i8 %conv119, i8* %i46, align 1, !tbaa !5
  %i47 = load i64*, i64** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$12", align 8
  %i48 = load i64, i64* %i47, align 8, !tbaa !6
  %shr122 = lshr i64 %i48, 24
  %conv124 = trunc i64 %shr122 to i8
  %i49 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$19", align 8
  store i8 %conv124, i8* %i49, align 1, !tbaa !5
  %shr126 = lshr i64 %i48, 16
  %conv128 = trunc i64 %shr126 to i8
  %i50 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$20", align 8
  store i8 %conv128, i8* %i50, align 1, !tbaa !5
  %shr130 = lshr i64 %i48, 8
  %conv132 = trunc i64 %shr130 to i8
  %i51 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$14", align 8
  store i8 %conv132, i8* %i51, align 1, !tbaa !5
  %conv135 = trunc i64 %i48 to i8
  %i52 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$13", align 8
  store i8 %conv135, i8* %i52, align 1, !tbaa !5
  br label %"BF_cfb64_encrypt$0_latch$0"

"BF_cfb64_encrypt$0_latch$0":                     ; preds = %if.then73, %"BF_cfb64_encrypt$0_header"
  %incdec.ptr138 = getelementptr inbounds i8, i8* %arg, i64 1
  %i53 = load i8, i8* %arg, align 1, !tbaa !5
  %idxprom139 = sext i32 %arg3 to i64
  %i54 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$8", align 8
  %arrayidx140 = getelementptr inbounds i8, i8* %i54, i64 %idxprom139
  %i55 = load i8, i8* %arrayidx140, align 1, !tbaa !5
  store i8 %i53, i8* %arrayidx140, align 1, !tbaa !5
  %xor145244 = xor i8 %i55, %i53
  %incdec.ptr147 = getelementptr inbounds i8, i8* %arg2, i64 1
  store i8 %xor145244, i8* %arg2, align 1, !tbaa !5
  %add148 = add nsw i32 %arg3, 1
  %and149 = and i32 %add148, 7
  %dec68 = add nsw i64 %arg1, -1
  %tobool69 = icmp eq i64 %arg1, 0
...
"BF_cfb64_encrypt$0_increment_depth_counter":     ; preds = %"BF_cfb64_encrypt$0_latch$0"
  %i56 = add i16 %arg4, 1
  %i57 = icmp ult i16 %i56, 256
  br i1 %i57, label %"BF_cfb64_encrypt$0_recursively_call_function", label %"BF_cfb64_encrypt$0_save_recursive_state_and_return"

"BF_cfb64_encrypt$0_recursively_call_function":   ; preds = %"BF_cfb64_encrypt$0_increment_depth_counter"
  call void @"BF_cfb64_encrypt$0"(i8* %incdec.ptr138, i64 %dec68, i8* %incdec.ptr147, i32 %and149, i16 %i56)
  ret void

"BF_cfb64_encrypt$0_save_recursive_state_and_return": ; preds = %"BF_cfb64_encrypt$0_increment_depth_counter"
  %i58 = getelementptr %3, %3* @"BF_cfb64_encrypt$0_recursion_state_struct", i32 0, i32 0
  store i8* %incdec.ptr138, i8** %i58, align 8
  %i59 = getelementptr %3, %3* @"BF_cfb64_encrypt$0_recursion_state_struct", i32 0, i32 1
  store i64 %dec68, i64* %i59, align 8
  %i60 = getelementptr %3, %3* @"BF_cfb64_encrypt$0_recursion_state_struct", i32 0, i32 2
  store i8* %incdec.ptr147, i8** %i60, align 8
  %i61 = getelementptr %3, %3* @"BF_cfb64_encrypt$0_recursion_state_struct", i32 0, i32 3
  store i32 %and149, i32* %i61, align 4
  %i62 = getelementptr %3, %3* @"BF_cfb64_encrypt$0_recursion_state_struct", i32 0, i32 4
  store i1 false, i1* %i62, align 1
  ret void

"BF_cfb64_encrypt$0_return_from_recursive_function$0": ; preds = %"BF_cfb64_encrypt$0_latch$0"
  %i63 = getelementptr %2, %2* @"BF_cfb64_encrypt$0_return_value_struct", i32 0, i32 0
  store i32 %and149, i32* %i63, align 4
  %i64 = getelementptr %3, %3* @"BF_cfb64_encrypt$0_recursion_state_struct", i32 0, i32 4
  store i1 true, i1* %i64, align 1
  ret void
}
