; ModuleID = './benchmark_intermediate_representations/new_loop2recursion-recursion_depth_limit-256/patricia/patricia.ll.temp'
...
"pat_insert$3_call_recursive_function":           ; preds = %"pat_insert$3_extract_next_values", %"pat_insert$3_initialize_context"
  ...
  call void @"pat_insert$3"(%struct.ptree* %i4, i8 %i5, i16 0)
...
"pat_insert$2_call_recursive_function":           ; preds = %"pat_insert$2_extract_next_values", %"pat_insert$2_initialize_context"
  ...
  call void @"pat_insert$2"(i32 %i16, i16 0)
...
"pat_insert$1_call_recursive_function":           ; preds = %"pat_insert$1_extract_next_values", %"pat_insert$1_initialize_context"
  ...
  call void @"pat_insert$1"(i64 %i27, i16 0)
...
"pat_insert$0_call_recursive_function":           ; preds = %"pat_insert$0_extract_next_values", %"pat_insert$0_initialize_context"
  ...
  call void @"pat_insert$0"(%struct.ptree_mask* %i42, i32 %i43, %struct.ptree_mask* %i44, i32 %i45, i16 0)
...
"pat_search$0_call_recursive_function":           ; preds = %"pat_search$0_extract_next_values", %"pat_search$0_initialize_context"
  ...
  call void @"pat_search$0"(%struct.ptree* %i, i8 %i1, %struct.ptree* %i2, i16 0)
...
define void @"pat_insert$3"(%struct.ptree* %arg, i8 %arg1, i16 %arg2) {
...
"pat_insert$3_recursively_call_function":         ; preds = %"pat_insert$3_increment_depth_counter"
  call void @"pat_insert$3"(%struct.ptree* %cond, i8 %i3, i16 %i4)
  ret void
...
define void @"pat_insert$1"(i64 %arg, i16 %arg1) {
...
"pat_insert$1_recursively_call_function":         ; preds = %"pat_insert$1_increment_depth_counter"
  call void @"pat_insert$1"(i64 %indvars.iv.next, i16 %i5)
  ret void
...
define void @"pat_insert$0"(%struct.ptree_mask* %arg, i32 %arg1, %struct.ptree_mask* %arg2, i32 %arg3, i16 %arg4) {
"pat_insert$0_header":
...
"pat_insert$0_recursively_call_function":         ; preds = %"pat_insert$0_increment_depth_counter"
  call void @"pat_insert$0"(%struct.ptree_mask* %incdec.ptr, i32 %i.2, %struct.ptree_mask* %.pre200, i32 %copied.1, i16 %i17)
  ret void
...
define void @"pat_insert$2"(i32 %arg, i16 %arg1) {
...
"pat_insert$2_recursively_call_function":         ; preds = %"pat_insert$2_increment_depth_counter"
  call void @"pat_insert$2"(i32 %inc82, i16 %i3)
  ret void
...
define void @"pat_search$0"(%struct.ptree* %arg, i8 %arg1, %struct.ptree* %arg2, i16 %arg3) {
...
"pat_search$0_recursively_call_function":         ; preds = %"pat_search$0_increment_depth_counter"
  call void @"pat_search$0"(%struct.ptree* %cond, i8 %i8, %struct.ptree* %t.0.p.0, i16 %i9)
  ret void
