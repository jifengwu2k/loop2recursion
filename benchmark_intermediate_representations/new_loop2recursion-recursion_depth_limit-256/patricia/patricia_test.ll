; ModuleID = './benchmark_intermediate_representations/new_loop2recursion-recursion_depth_limit-256/patricia/patricia_test.ll.temp'
...
@"./benchmark_intermediate_representations/baseline/patricia/patricia_test.ll_invariant_variable$0" = dso_local global %struct._IO_FILE* null
@"./benchmark_intermediate_representations/baseline/patricia/patricia_test.ll_invariant_variable$1" = dso_local global %struct.ptree* null
@"./benchmark_intermediate_representations/baseline/patricia/patricia_test.ll_invariant_variable$2" = dso_local global i32* null
@"./benchmark_intermediate_representations/baseline/patricia/patricia_test.ll_invariant_variable$3" = dso_local global i8* null
@"./benchmark_intermediate_representations/baseline/patricia/patricia_test.ll_invariant_variable$4" = dso_local global float* null
...
"main$0_initialize_context":                      ; preds = %while.body.lr.ph
  store %struct._IO_FILE* %call2, %struct._IO_FILE** @"./benchmark_intermediate_representations/baseline/patricia/patricia_test.ll_invariant_variable$0", align 8
  store %struct.ptree* %i6, %struct.ptree** @"./benchmark_intermediate_representations/baseline/patricia/patricia_test.ll_invariant_variable$1", align 8
  store i32* %i13, i32** @"./benchmark_intermediate_representations/baseline/patricia/patricia_test.ll_invariant_variable$2", align 8
  store i8* %i, i8** @"./benchmark_intermediate_representations/baseline/patricia/patricia_test.ll_invariant_variable$3", align 8
  store float* %time, float** @"./benchmark_intermediate_representations/baseline/patricia/patricia_test.ll_invariant_variable$4", align 8
...
"main$0_call_recursive_function":                 ; preds = %"main$0_extract_next_values", %"main$0_initialize_context"
  call void @"main$0"(i16 0)
  %i14 = getelementptr %1, %1* @"main$0_recursion_state_struct", i32 0, i32 0
  %i15 = load i1, i1* %i14, align 1
  br i1 %i15, label %"main$0_branch_to_exit", label %"main$0_extract_next_values"
...
"main$0_branch_to_exit":                          ; preds = %"main$0_call_recursive_function"
  %i16 = getelementptr %0, %0* @"main$0_return_value_struct", i32 0, i32 0
  %i17 = load i8, i8* %i16, align 1
  switch i8 %i17, label %while.end.loopexit [
...
if.then66:                                        ; preds = %"main$0_branch_to_exit"
  %i18 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !1
  %i19 = call i64 @fwrite(i8* nonnull getelementptr inbounds ([22 x i8], [22 x i8]* @.str.9, i64 0, i64 0), i64 21, i64 1, %struct._IO_FILE* %i18) #8
  call void @exit(i32 0) #7
  unreachable
...
define void @"main$0"(i16 %arg) {
"main$0_exiting$3":
  %i = load i32*, i32** @"./benchmark_intermediate_representations/baseline/patricia/patricia_test.ll_invariant_variable$2", align 8
  %i1 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/patricia/patricia_test.ll_invariant_variable$3", align 8
  %i2 = load float*, float** @"./benchmark_intermediate_representations/baseline/patricia/patricia_test.ll_invariant_variable$4", align 8
  %call27 = call i32 (i8*, i8*, ...) @__isoc99_sscanf(i8* %i1, i8* nonnull getelementptr inbounds ([6 x i8], [6 x i8]* @.str.6, i64 0, i64 0), float* nonnull %i2, i32* %i) #4
  %call28 = call noalias i8* @malloc(i64 40) #4
  %i3 = bitcast i8* %call28 to %struct.ptree*
...
"main$0_exiting$4":                               ; preds = %"main$0_exiting$3"
  ...
  %i4 = bitcast i8* %p_m33 to i8**
  store i8* %call32, i8** %i4, align 8, !tbaa !5
...
"main$0_exiting$2":                               ; preds = %"main$0_exiting$4"
  %i5 = bitcast i8* %call32 to i64*
  store i64 0, i64* %i5, align 8
  %call40 = call noalias i8* @malloc(i64 16) #4
  %pm_data41 = getelementptr inbounds i8, i8* %call32, i64 8
  %i6 = bitcast i8* %pm_data41 to i8**
  store i8* %call40, i8** %i6, align 8, !tbaa !8
...
if.end45:                                         ; preds = %"main$0_exiting$2"
  ...
  %i7 = load i32*, i32** @"./benchmark_intermediate_representations/baseline/patricia/patricia_test.ll_invariant_variable$2", align 8
  %i8 = load i32, i32* %i7, align 4, !tbaa !13
  %conv = zext i32 %i8 to i64
  %p_key = bitcast i8* %call28 to i64*
  store i64 %conv, i64* %p_key, align 8, !tbaa !16
  %i9 = call i32 asm "bswap $0", "=r,0,~{dirflag},~{fpsr},~{flags}"(i32 -1) #9, !srcloc !17
  %conv48 = zext i32 %i9 to i64
  %pm_mask = bitcast i8* %call32 to i64*
  store i64 %conv48, i64* %pm_mask, align 8, !tbaa !18
  %i10 = load %struct.ptree*, %struct.ptree** @"./benchmark_intermediate_representations/baseline/patricia/patricia_test.ll_invariant_variable$1", align 8
  %call52 = call %struct.ptree* @pat_search(i64 %conv, %struct.ptree* %i10) #4
  %p_key53 = getelementptr inbounds %struct.ptree, %struct.ptree* %call52, i64 0, i32 0
  %i11 = load i64, i64* %p_key53, align 8, !tbaa !16
  %i12 = load i32*, i32** @"./benchmark_intermediate_representations/baseline/patricia/patricia_test.ll_invariant_variable$2", align 8
  %i13 = load i32, i32* %i12, align 4, !tbaa !13
  %conv55 = zext i32 %i13 to i64
  %cmp56 = icmp eq i64 %i11, %conv55
  br i1 %cmp56, label %if.end64.thread, label %"main$0_exiting$1"

"main$0_exiting$1":                               ; preds = %if.end45
  %i14 = load %struct.ptree*, %struct.ptree** @"./benchmark_intermediate_representations/baseline/patricia/patricia_test.ll_invariant_variable$1", align 8
  %call63 = call %struct.ptree* @pat_insert(%struct.ptree* nonnull %i3, %struct.ptree* %i14) #4
...
if.end64.thread:                                  ; preds = %if.end45
  %i15 = load float*, float** @"./benchmark_intermediate_representations/baseline/patricia/patricia_test.ll_invariant_variable$4", align 8
  %i16 = load float, float* %i15, align 4, !tbaa !19
  %conv59 = fpext float %i16 to double
  %call61 = call i32 (i8*, ...) @printf(i8* nonnull getelementptr inbounds ([10 x i8], [10 x i8]* @.str.7, i64 0, i64 0), double %conv59, i32 %i13)
...
"main$0_latch$0":                                 ; preds = %if.end64.thread, %"main$0_exiting$1"
  %i17 = load %struct._IO_FILE*, %struct._IO_FILE** @"./benchmark_intermediate_representations/baseline/patricia/patricia_test.ll_invariant_variable$0", align 8
  %i18 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/patricia/patricia_test.ll_invariant_variable$3", align 8
  %call24 = call i8* @fgets(i8* %i18, i32 128, %struct._IO_FILE* nonnull %i17)
...
"main$0_increment_depth_counter":                 ; preds = %"main$0_latch$0"
  ...
  br i1 %i20, label %"main$0_recursively_call_function", label %"main$0_save_recursive_state_and_return"

"main$0_recursively_call_function":               ; preds = %"main$0_increment_depth_counter"
  call void @"main$0"(i16 %i19)
  ret void

"main$0_save_recursive_state_and_return":         ; preds = %"main$0_increment_depth_counter"
  %i21 = getelementptr %1, %1* @"main$0_recursion_state_struct", i32 0, i32 0
  store i1 false, i1* %i21, align 1
  ret void

"main$0_return_from_recursive_function$0":        ; preds = %"main$0_latch$0"
  %i22 = getelementptr %0, %0* @"main$0_return_value_struct", i32 0, i32 0
  store i8 4, i8* %i22, align 1
  %i23 = getelementptr %1, %1* @"main$0_recursion_state_struct", i32 0, i32 0
  store i1 true, i1* %i23, align 1
  ret void

"main$0_return_from_recursive_function$1":        ; preds = %"main$0_exiting$1"
  %i24 = getelementptr %0, %0* @"main$0_return_value_struct", i32 0, i32 0
  store i8 3, i8* %i24, align 1
  %i25 = getelementptr %1, %1* @"main$0_recursion_state_struct", i32 0, i32 0
  store i1 true, i1* %i25, align 1
  ret void

"main$0_return_from_recursive_function$2":        ; preds = %"main$0_exiting$2"
  %i26 = getelementptr %0, %0* @"main$0_return_value_struct", i32 0, i32 0
  store i8 2, i8* %i26, align 1
  %i27 = getelementptr %1, %1* @"main$0_recursion_state_struct", i32 0, i32 0
  store i1 true, i1* %i27, align 1
  ret void

"main$0_return_from_recursive_function$3":        ; preds = %"main$0_exiting$3"
  %i28 = getelementptr %0, %0* @"main$0_return_value_struct", i32 0, i32 0
  store i8 0, i8* %i28, align 1
  %i29 = getelementptr %1, %1* @"main$0_recursion_state_struct", i32 0, i32 0
...
"main$0_return_from_recursive_function$4":        ; preds = %"main$0_exiting$4"
  ...
  %i31 = getelementptr %1, %1* @"main$0_recursion_state_struct", i32 0, i32 0
