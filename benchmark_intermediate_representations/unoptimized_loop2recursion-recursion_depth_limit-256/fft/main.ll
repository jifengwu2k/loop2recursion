; ModuleID = './benchmark_intermediate_representations/unoptimized_loop2recursion-recursion_depth_limit-256/fft/main.ll.temp'
...
"main$3_call_recursive_function":                 ; preds = %"main$3_extract_next_values", %"main$3_initialize_context"
  ...
  call void @"main$3"(i64 %i10, i32 %conv.i171, float* %i7, float* %i8, %0* %i9, i16 0)
...
"main$2_call_recursive_function":                 ; preds = %"main$2_extract_next_values", %"main$2_initialize_context"
  ...
  call void @"main$2"(i64 %i16, i32 %conv.i, i1 %cmp28180, float* %i3, float* %i4, float* %i7, float* %i8, i32 %conv.i171, %1* %i15, i16 0)
...
"main$1_call_recursive_function":                 ; preds = %"main$1_extract_next_values", %"main$1_initialize_context"
  ...
  call void @"main$1"(i64 %i22, i32 %conv.i, float* %i5, %2* %i21, i16 0)
...
"main$0_call_recursive_function":                 ; preds = %"main$0_extract_next_values", %"main$0_initialize_context"
  ...
  call void @"main$0"(i64 %i28, i32 %conv.i, float* %i6, %3* %i27, i16 0)
...
define void @"main$0"(i64 %arg, i32 %arg1, float* %arg2, %3* %arg3, i16 %arg4) {
"main$0_latch$0":
...
"main$0_recursively_call_function":               ; preds = %"main$0_increment_depth_counter"
  call void @"main$0"(i64 %indvars.iv.next, i32 %arg1, float* %arg2, %3* %arg3, i16 %i5)
  ret void
...
define void @"main$1"(i64 %arg, i32 %arg1, float* %arg2, %2* %arg3, i16 %arg4) {
"main$1_latch$0":
...
"main$1_recursively_call_function":               ; preds = %"main$1_increment_depth_counter"
  call void @"main$1"(i64 %indvars.iv.next183, i32 %arg1, float* %arg2, %2* %arg3, i16 %i5)
  ret void
...
define void @"main$2"(i64 %arg, i32 %arg1, i1 %arg2, float* %arg3, float* %arg4, float* %arg5, float* %arg6, i32 %arg7, %1* %arg8, i16 %arg9) {
"main$2_header":
...
"main$2$0_call_recursive_function":               ; preds = %"main$2$0_extract_next_values", %"main$2$0_initialize_context"
  ...
  call void @"main$2$0"(i64 %i11, i32 %arg7, float* %arrayidx84, float* %arrayidx43, float %conv57, float* %arg5, float* %arg6, %4* %i10, i16 0)
...
"main$2_recursively_call_function":               ; preds = %"main$2_increment_depth_counter"
  call void @"main$2"(i64 %indvars.iv.next191, i32 %arg1, i1 %arg2, float* %arg3, float* %arg4, float* %arg5, float* %arg6, i32 %arg7, %1* %arg8, i16 %i16)
  ret void
...
define void @"main$3"(i64 %arg, i32 %arg1, float* %arg2, float* %arg3, %0* %arg4, i16 %arg5) {
"main$3_latch$0":
...
"main$3_recursively_call_function":               ; preds = %"main$3_increment_depth_counter"
  call void @"main$3"(i64 %indvars.iv.next195, i32 %arg1, float* %arg2, float* %arg3, %0* %arg4, i16 %i)
  ret void
...
define void @"main$2$0"(i64 %arg, i32 %arg1, float* %arg2, float* %arg3, float %arg4, float* %arg5, float* %arg6, %4* %arg7, i16 %arg8) {
"main$2$0_header":
...
"main$2$0_recursively_call_function":             ; preds = %"main$2$0_increment_depth_counter"
  call void @"main$2$0"(i64 %indvars.iv.next187, i32 %arg1, float* %arg2, float* %arg3, float %arg4, float* %arg5, float* %arg6, %4* %arg7, i16 %i12)
  ret void
