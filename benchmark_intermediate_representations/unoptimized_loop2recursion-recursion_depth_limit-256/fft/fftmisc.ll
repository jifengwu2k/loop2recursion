; ModuleID = './benchmark_intermediate_representations/unoptimized_loop2recursion-recursion_depth_limit-256/fft/fftmisc.ll.temp'
...
"NumberOfBitsNeeded$0_call_recursive_function":   ; preds = %"NumberOfBitsNeeded$0_extract_next_values", %"NumberOfBitsNeeded$0_initialize_context"
  ...
  call void @"NumberOfBitsNeeded$0"(%0* %i, i32 %i2, i32 %PowerOfTwo, %1* %i1, i16 0)
...
"ReverseBits$1_call_recursive_function":          ; preds = %"ReverseBits$1_extract_next_values", %"ReverseBits$1_initialize_context"
  ...
  call void @"ReverseBits$1"(%2* %i1, i32 %i3, i32 %i4, i32 %i5, i32 %i6, %3* %i2, i16 0)
...
"ReverseBits$0_call_recursive_function":          ; preds = %"ReverseBits$0_extract_next_values", %"ReverseBits$0_initialize_context"
  ...
  call void @"ReverseBits$0"(%4* %i24, i32 %i26, i32 %i27, i32 %i28, i32 %NumBits, %5* %i25, i16 0)
...
define void @"NumberOfBitsNeeded$0"(%0* %arg, i32 %arg1, i32 %arg2, %1* %arg3, i16 %arg4) {
...
"NumberOfBitsNeeded$0_recursively_call_function": ; preds = %"NumberOfBitsNeeded$0_increment_depth_counter"
  call void @"NumberOfBitsNeeded$0"(%0* %arg, i32 %inc, i32 %arg2, %1* %arg3, i16 %i)
  ret void
...
define void @"ReverseBits$0"(%4* %arg, i32 %arg1, i32 %arg2, i32 %arg3, i32 %arg4, %5* %arg5, i16 %arg6) {
...
"ReverseBits$0_recursively_call_function":        ; preds = %"ReverseBits$0_increment_depth_counter"
  call void @"ReverseBits$0"(%4* %arg, i32 %shr.3, i32 %or.3, i32 %inc.3, i32 %arg4, %5* %arg5, i16 %i)
  ret void
...
define void @"ReverseBits$1"(%2* %arg, i32 %arg1, i32 %arg2, i32 %arg3, i32 %arg4, %3* %arg5, i16 %arg6) {
...
"ReverseBits$1_recursively_call_function":        ; preds = %"ReverseBits$1_increment_depth_counter"
  call void @"ReverseBits$1"(%2* %arg, i32 %shr.prol, i32 %or.prol, i32 %prol.iter.sub, i32 %inc.prol, %3* %arg5, i16 %i)
  ret void
