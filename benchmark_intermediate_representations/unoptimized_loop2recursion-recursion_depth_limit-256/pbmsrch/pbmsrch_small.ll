; ModuleID = './benchmark_intermediate_representations/unoptimized_loop2recursion-recursion_depth_limit-256/pbmsrch/pbmsrch_small.ll.temp'
...
"init_search$2_call_recursive_function":          ; preds = %"init_search$2_extract_next_values", %"init_search$2_initialize_context"
  ...
  call void @"init_search$2"(i64 %i1, <2 x i64> %broadcast.splat24, %0* %i, i16 0)
...
"init_search$1_call_recursive_function":          ; preds = %"init_search$1_extract_next_values", %"init_search$1_initialize_context"
  ...
  call void @"init_search$1"(%1* %i7, i64 %i9, i64 %i10, i8* %string, i64 %call, %2* %i8, i16 0)
...
"init_search$0_call_recursive_function":          ; preds = %"init_search$0_extract_next_values", %"init_search$0_initialize_context"
  ...
  call void @"init_search$0"(i64 %i21, i8* %string, i64 %call, %3* %i20, i16 0)
...
"strsearch$0_call_recursive_function":            ; preds = %"strsearch$0_extract_next_values", %"strsearch$0_initialize_context"
  ...
  call void @"strsearch$0"(%4* %i2, i64 %i4, i64 %i5, i8* %i1, i64 %i, i64 %call, i8* %string, %5* %i3, i16 0)
...
"main$0_call_recursive_function":                 ; preds = %"main$0_extract_next_values", %"main$0_initialize_context"
  ...
  call void @"main$0"(i64 %i1, %6* %i, i16 0)
...
define void @"init_search$0"(i64 %arg, i8* %arg1, i64 %arg2, %3* %arg3, i16 %arg4) {
...
"init_search$0_recursively_call_function":        ; preds = %"init_search$0_increment_depth_counter"
  call void @"init_search$0"(i64 %inc8.3, i8* %arg1, i64 %arg2, %3* %arg3, i16 %i8)
  ret void
...
define void @"init_search$1"(%1* %arg, i64 %arg1, i64 %arg2, i8* %arg3, i64 %arg4, %2* %arg5, i16 %arg6) {
...
"init_search$1_recursively_call_function":        ; preds = %"init_search$1_increment_depth_counter"
  call void @"init_search$1"(%1* %arg, i64 %prol.iter.sub, i64 %inc8.prol, i8* %arg3, i64 %arg4, %2* %arg5, i16 %i7)
  ret void
...
define void @"init_search$2"(i64 %arg, <2 x i64> %arg1, %0* %arg2, i16 %arg3) {
...
"init_search$2_recursively_call_function":        ; preds = %"init_search$2_increment_depth_counter"
  call void @"init_search$2"(i64 %index.next.7, <2 x i64> %arg1, %0* %arg2, i16 %i36)
  ret void
...
define void @"strsearch$0"(%4* %arg, i64 %arg1, i64 %arg2, i8* %arg3, i64 %arg4, i64 %arg5, i8* %arg6, %5* %arg7, i16 %arg8) {
"strsearch$0_header":
...
"strsearch$0$0_call_recursive_function":          ; preds = %"strsearch$0$0_extract_next_values", %"strsearch$0$0_initialize_context"
  ...
  call void @"strsearch$0$0"(%7* %i, i64 %i10, i64 %arg5, i8* %arg6, %8* %i9, i16 0)
...
"strsearch$0_recursively_call_function":          ; preds = %"strsearch$0_increment_depth_counter"
  call void @"strsearch$0"(%4* %arg, i64 %pos.0.be, i64 %shift.0.be, i8* %arg3, i64 %arg4, i64 %arg5, i8* %arg6, %5* %arg7, i16 %i23)
  ret void
...
define void @"main$0"(i64 %arg, %6* %arg1, i16 %arg2) {
"main$0_header":
...
"main$0$3_call_recursive_function":               ; preds = %"main$0$3_extract_next_values", %"main$0$3_initialize_context"
  ...
  call void @"main$0$3"(i64 %i4, <2 x i64> %broadcast.splat48, %9* %i3, i16 0)
...
"main$0$2_call_recursive_function":               ; preds = %"main$0$2_extract_next_values", %"main$0$2_initialize_context"
  ...
  call void @"main$0$2"(%10* %i10, i64 %i12, i64 %i13, i8* %i, i64 %call.i, %11* %i11, i16 0)
...
"main$0$1_call_recursive_function":               ; preds = %"main$0$1_extract_next_values", %"main$0$1_initialize_context"
  ...
  call void @"main$0$1"(i64 %i24, i8* %i, i64 %call.i, %12* %i23, i16 0)
...
"main$0$0_call_recursive_function":               ; preds = %"main$0$0_extract_next_values", %"main$0$0_initialize_context"
  ...
  call void @"main$0$0"(%13* %i30, i64 %i32, i64 %i33, i8* %i, i64 %call.i, i64 %call.i24, i8* %i29, %14* %i31, i16 0)
...
"main$0_recursively_call_function":               ; preds = %"main$0_increment_depth_counter"
  call void @"main$0"(i64 %indvars.iv.next, %6* %arg1, i16 %i45)
  ret void
...
define void @"strsearch$0$0"(%7* %arg, i64 %arg1, i64 %arg2, i8* %arg3, %8* %arg4, i16 %arg5) {
...
"strsearch$0$0_recursively_call_function":        ; preds = %"strsearch$0$0_increment_depth_counter"
  call void @"strsearch$0$0"(%7* %arg, i64 %add, i64 %arg2, i8* %arg3, %8* %arg4, i16 %i7)
  ret void
...
define void @"main$0$0"(%13* %arg, i64 %arg1, i64 %arg2, i8* %arg3, i64 %arg4, i64 %arg5, i8* %arg6, %14* %arg7, i16 %arg8) {
"main$0$0_header":
...
"main$0$0$0_call_recursive_function":             ; preds = %"main$0$0$0_extract_next_values", %"main$0$0$0_initialize_context"
  ...
  call void @"main$0$0$0"(%15* %i, i64 %i10, i64 %arg5, i8* %arg6, %16* %i9, i16 0)
...
"main$0$0_recursively_call_function":             ; preds = %"main$0$0_increment_depth_counter"
  call void @"main$0$0"(%13* %arg, i64 %pos.0.be.i, i64 %shift.0.be.i, i8* %arg3, i64 %arg4, i64 %arg5, i8* %arg6, %14* %arg7, i16 %i23)
  ret void
...
define void @"main$0$1"(i64 %arg, i8* %arg1, i64 %arg2, %12* %arg3, i16 %arg4) {
"main$0$1_latch$0":
  %sub.i = xor i64 %arg, -1
...
"main$0$1_recursively_call_function":             ; preds = %"main$0$1_increment_depth_counter"
  call void @"main$0$1"(i64 %inc8.i.3, i8* %arg1, i64 %arg2, %12* %arg3, i16 %i8)
  ret void
...
define void @"main$0$2"(%10* %arg, i64 %arg1, i64 %arg2, i8* %arg3, i64 %arg4, %11* %arg5, i16 %arg6) {
"main$0$2_latch$0":
...
"main$0$2_recursively_call_function":             ; preds = %"main$0$2_increment_depth_counter"
  call void @"main$0$2"(%10* %arg, i64 %prol.iter.sub, i64 %inc8.i.prol, i8* %arg3, i64 %arg4, %11* %arg5, i16 %i7)
  ret void
...
define void @"main$0$3"(i64 %arg, <2 x i64> %arg1, %9* %arg2, i16 %arg3) {
"main$0$3_latch$0":
  %i = getelementptr inbounds [256 x i64], [256 x i64]* @table, i64 0, i64 %arg
  %i4 = bitcast i64* %i to <2 x i64>*
  store <2 x i64> %arg1, <2 x i64>* %i4, align 16, !tbaa !1
...
"main$0$3_recursively_call_function":             ; preds = %"main$0$3_increment_depth_counter"
  call void @"main$0$3"(i64 %index.next.7, <2 x i64> %arg1, %9* %arg2, i16 %i36)
  ret void
...
define void @"main$0$0$0"(%15* %arg, i64 %arg1, i64 %arg2, i8* %arg3, %16* %arg4, i16 %arg5) {
...
"main$0$0$0_recursively_call_function":           ; preds = %"main$0$0$0_increment_depth_counter"
  call void @"main$0$0$0"(%15* %arg, i64 %add.i, i64 %arg2, i8* %arg3, %16* %arg4, i16 %i7)
  ret void
