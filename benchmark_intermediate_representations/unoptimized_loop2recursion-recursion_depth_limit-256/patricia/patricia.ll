; ModuleID = './benchmark_intermediate_representations/unoptimized_loop2recursion-recursion_depth_limit-256/patricia/patricia.ll.temp'
...
"pat_insert$3_call_recursive_function":           ; preds = %"pat_insert$3_extract_next_values", %"pat_insert$3_initialize_context"
  ...
  call void @"pat_insert$3"(%0* %i4, %struct.ptree* %i6, i8 %i7, i64 %and, %1* %i5, i16 0)
...
"pat_insert$2_call_recursive_function":           ; preds = %"pat_insert$2_extract_next_values", %"pat_insert$2_initialize_context"
  ...
  call void @"pat_insert$2"(%2* %i18, i32 %i20, i64 %i17, %3* %i19, i16 0)
...
"pat_insert$1_call_recursive_function":           ; preds = %"pat_insert$1_extract_next_values", %"pat_insert$1_initialize_context"
  ...
  call void @"pat_insert$1"(%4* %i31, i64 %i33, i64 %i30, %struct.ptree_mask* %i29, i64 %i28, %5* %i32, i16 0)
...
"pat_insert$0_call_recursive_function":           ; preds = %"pat_insert$0_extract_next_values", %"pat_insert$0_initialize_context"
  ...
  call void @"pat_insert$0"(%6* %i48, %struct.ptree_mask* %i50, i32 %i51, %struct.ptree_mask* %i52, i32 %i53, %struct.ptree_mask** %p_m47, i8* %p_mlen, %struct.ptree_mask** %p_m, %7* %i49, i16 0)
...
"pat_search$0_call_recursive_function":           ; preds = %"pat_search$0_extract_next_values", %"pat_search$0_initialize_context"
  ...
  call void @"pat_search$0"(%8* %i, %struct.ptree* %i2, i8 %i3, %struct.ptree* %i4, i64 %key, %9* %i1, i16 0)
...
define void @"pat_insert$0"(%6* %arg, %struct.ptree_mask* %arg1, i32 %arg2, %struct.ptree_mask* %arg3, i32 %arg4, %struct.ptree_mask** %arg5, i8* %arg6, %struct.ptree_mask** %arg7, %7* %arg8, i16 %arg9) {
"pat_insert$0_header":
...
"pat_insert$0_recursively_call_function":         ; preds = %"pat_insert$0_increment_depth_counter"
  call void @"pat_insert$0"(%6* %arg, %struct.ptree_mask* %incdec.ptr, i32 %i.2, %struct.ptree_mask* %.pre200, i32 %copied.1, %struct.ptree_mask** %arg5, i8* %arg6, %struct.ptree_mask** %arg7, %7* %arg8, i16 %i18)
  ret void
...
define void @"pat_insert$1"(%4* %arg, i64 %arg1, i64 %arg2, %struct.ptree_mask* %arg3, i64 %arg4, %5* %arg5, i16 %arg6) {
...
"pat_insert$1_recursively_call_function":         ; preds = %"pat_insert$1_increment_depth_counter"
  call void @"pat_insert$1"(%4* %arg, i64 %indvars.iv.next, i64 %arg2, %struct.ptree_mask* %arg3, i64 %arg4, %5* %arg5, i16 %i7)
  ret void
...
define void @"pat_insert$2"(%2* %arg, i32 %arg1, i64 %arg2, %3* %arg3, i16 %arg4) {
...
"pat_insert$2_recursively_call_function":         ; preds = %"pat_insert$2_increment_depth_counter"
  call void @"pat_insert$2"(%2* %arg, i32 %inc82, i64 %arg2, %3* %arg3, i16 %i5)
  ret void
...
define void @"pat_insert$3"(%0* %arg, %struct.ptree* %arg1, i8 %arg2, i64 %arg3, %1* %arg4, i16 %arg5) {
...
"pat_insert$3_recursively_call_function":         ; preds = %"pat_insert$3_increment_depth_counter"
  call void @"pat_insert$3"(%0* %arg, %struct.ptree* %cond, i8 %i, i64 %arg3, %1* %arg4, i16 %i6)
  ret void
...
define void @"pat_search$0"(%8* %arg, %struct.ptree* %arg1, i8 %arg2, %struct.ptree* %arg3, i64 %arg4, %9* %arg5, i16 %arg6) {
...
"pat_search$0_recursively_call_function":         ; preds = %"pat_search$0_increment_depth_counter"
  call void @"pat_search$0"(%8* %arg, %struct.ptree* %cond, i8 %i9, %struct.ptree* %t.0.p.0, i64 %arg4, %9* %arg5, i16 %i10)
  ret void
