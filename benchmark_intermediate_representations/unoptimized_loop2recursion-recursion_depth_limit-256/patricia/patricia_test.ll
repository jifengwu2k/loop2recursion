; ModuleID = './benchmark_intermediate_representations/unoptimized_loop2recursion-recursion_depth_limit-256/patricia/patricia_test.ll.temp'
...
"main$0_call_recursive_function":                 ; preds = %"main$0_extract_next_values", %"main$0_initialize_context"
  call void @"main$0"(%0* %i14, %struct.ptree* %i6, i32* %i13, i8* %i, %struct._IO_FILE* %call2, float* %time, %1* %i15, i16 0)
...
define void @"main$0"(%0* %arg, %struct.ptree* %arg1, i32* %arg2, i8* %arg3, %struct._IO_FILE* %arg4, float* %arg5, %1* %arg6, i16 %arg7) {
"main$0_exiting$3":
...
"main$0_recursively_call_function":               ; preds = %"main$0_increment_depth_counter"
  call void @"main$0"(%0* %arg, %struct.ptree* %arg1, i32* %arg2, i8* %arg3, %struct._IO_FILE* %arg4, float* %arg5, %1* %arg6, i16 %i16)
  ret void
