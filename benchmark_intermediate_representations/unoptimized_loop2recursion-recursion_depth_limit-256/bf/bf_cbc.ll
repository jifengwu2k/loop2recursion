; ModuleID = './benchmark_intermediate_representations/unoptimized_loop2recursion-recursion_depth_limit-256/bf/bf_cbc.ll.temp'
...
"BF_cbc_encrypt$1_call_recursive_function":       ; preds = %"BF_cbc_encrypt$1_extract_next_values", %"BF_cbc_encrypt$1_initialize_context"
  ...
  call void @"BF_cbc_encrypt$1"(%0* %i31, <2 x i64> %i33, i8* %i34, i64 %i35, i8* %i36, %struct.bf_key_st* %ks, <2 x i64>* %tin, i64* %arrayidx, %1* %i32, i16 0)
...
"BF_cbc_encrypt$0_call_recursive_function":       ; preds = %"BF_cbc_encrypt$0_extract_next_values", %"BF_cbc_encrypt$0_initialize_context"
  ...
  call void @"BF_cbc_encrypt$0"(%2* %i53, i8* %i55, i64 %i56, i8* %i57, i64 %i58, i64 %i59, i64* %arrayidx257, %struct.bf_key_st* %ks, <2 x i64>* %tin, i64* %arrayidx256, %3* %i54, i16 0)
...
define void @"BF_cbc_encrypt$0"(%2* %arg, i8* %arg1, i64 %arg2, i8* %arg3, i64 %arg4, i64 %arg5, i64* %arg6, %struct.bf_key_st* %arg7, <2 x i64>* %arg8, i64* %arg9, %3* %arg10, i16 %arg11) {
...
"BF_cbc_encrypt$0_recursively_call_function":     ; preds = %"BF_cbc_encrypt$0_increment_depth_counter"
  call void @"BF_cbc_encrypt$0"(%2* %arg, i8* %incdec.ptr253, i64 %l.1, i8* %incdec.ptr292, i64 %i39, i64 %i40, i64* %arg6, %struct.bf_key_st* %arg7, <2 x i64>* %arg8, i64* %arg9, %3* %arg10, i16 %i41)
  ret void
...
define void @"BF_cbc_encrypt$1"(%0* %arg, <2 x i64> %arg1, i8* %arg2, i64 %arg3, i8* %arg4, %struct.bf_key_st* %arg5, <2 x i64>* %arg6, i64* %arg7, %1* %arg8, i16 %arg9) {
...
"BF_cbc_encrypt$1_recursively_call_function":     ; preds = %"BF_cbc_encrypt$1_increment_depth_counter"
  call void @"BF_cbc_encrypt$1"(%0* %arg, <2 x i64> %i36, i8* %incdec.ptr85, i64 %l.0, i8* %incdec.ptr51, %struct.bf_key_st* %arg5, <2 x i64>* %arg6, i64* %arg7, %1* %arg8, i16 %i39)
  ret void
