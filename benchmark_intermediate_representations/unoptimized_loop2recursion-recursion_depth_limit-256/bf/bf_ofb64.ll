; ModuleID = './benchmark_intermediate_representations/unoptimized_loop2recursion-recursion_depth_limit-256/bf/bf_ofb64.ll.temp'
...
"BF_ofb64_encrypt$0_call_recursive_function":     ; preds = %"BF_ofb64_encrypt$0_extract_next_values", %"BF_ofb64_encrypt$0_initialize_context"
  ...
  call void @"BF_ofb64_encrypt$0"(%0* %i29, i8* %i31, i8* %i32, i32 %i33, i64 %i34, i32 %i35, i8* %incdec.ptr46, i8* %incdec.ptr38, i64* %arrayidx25, i8* %incdec.ptr42, %struct.bf_key_st* %schedule, i64* %arrayidx, i8* %incdec.ptr35, [8 x i8]* %d, i8* %i1, i8* %incdec.ptr27, i8* %incdec.ptr50, i8* %incdec.ptr31, %1* %i30, i16 0)
...
define void @"BF_ofb64_encrypt$0"(%0* %arg, i8* %arg1, i8* %arg2, i32 %arg3, i64 %arg4, i32 %arg5, i8* %arg6, i8* %arg7, i64* %arg8, i8* %arg9, %struct.bf_key_st* %arg10, i64* %arg11, i8* %arg12, [8 x i8]* %arg13, i8* %arg14, i8* %arg15, i8* %arg16, i8* %arg17, %1* %arg18, i16 %arg19) {
...
"BF_ofb64_encrypt$0_recursively_call_function":   ; preds = %"BF_ofb64_encrypt$0_increment_depth_counter"
  call void @"BF_ofb64_encrypt$0"(%0* %arg, i8* %incdec.ptr94, i8* %incdec.ptr89, i32 %and95, i64 %dec213, i32 %save.1, i8* %arg6, i8* %arg7, i64* %arg8, i8* %arg9, %struct.bf_key_st* %arg10, i64* %arg11, i8* %arg12, [8 x i8]* %arg13, i8* %arg14, i8* %arg15, i8* %arg16, i8* %arg17, %1* %arg18, i16 %i23)
  ret void
