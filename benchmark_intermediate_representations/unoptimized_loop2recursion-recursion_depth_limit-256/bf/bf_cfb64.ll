; ModuleID = './benchmark_intermediate_representations/unoptimized_loop2recursion-recursion_depth_limit-256/bf/bf_cfb64.ll.temp'
...
"BF_cfb64_encrypt$1_call_recursive_function":     ; preds = %"BF_cfb64_encrypt$1_extract_next_values", %"BF_cfb64_encrypt$1_initialize_context"
  ...
  call void @"BF_cfb64_encrypt$1"(%0* %i2, i8* %i4, i8* %i5, i64 %i6, i32 %i7, i64* %arrayidx27, %struct.bf_key_st* %schedule, i64* %arrayidx, <2 x i64>* %ti, i8* %incdec.ptr20, i8* %incdec.ptr16, i8* %incdec.ptr, i8* %incdec.ptr10, i8* %ivec, i8* %incdec.ptr3, i8* %incdec.ptr13, i8* %incdec.ptr6, %1* %i3, i16 0)
...
"BF_cfb64_encrypt$0_call_recursive_function":     ; preds = %"BF_cfb64_encrypt$0_extract_next_values", %"BF_cfb64_encrypt$0_initialize_context"
  ...
  call void @"BF_cfb64_encrypt$0"(%2* %i20, i8* %i22, i64 %i23, i8* %i24, i32 %i25, i64* %arrayidx103, <2 x i64>* %ti, i8* %incdec.ptr96, i8* %incdec.ptr92, %struct.bf_key_st* %schedule, i64* %arrayidx88, i8* %incdec.ptr74, i8* %ivec, i8* %incdec.ptr77, i8* %incdec.ptr81, i8* %incdec.ptr85, i8* %incdec.ptr89, %3* %i21, i16 0)
...
define void @"BF_cfb64_encrypt$0"(%2* %arg, i8* %arg1, i64 %arg2, i8* %arg3, i32 %arg4, i64* %arg5, <2 x i64>* %arg6, i8* %arg7, i8* %arg8, %struct.bf_key_st* %arg9, i64* %arg10, i8* %arg11, i8* %arg12, i8* %arg13, i8* %arg14, i8* %arg15, i8* %arg16, %3* %arg17, i16 %arg18) {
...
"BF_cfb64_encrypt$0_recursively_call_function":   ; preds = %"BF_cfb64_encrypt$0_increment_depth_counter"
  call void @"BF_cfb64_encrypt$0"(%2* %arg, i8* %incdec.ptr138, i64 %dec68, i8* %incdec.ptr147, i32 %and149, i64* %arg5, <2 x i64>* %arg6, i8* %arg7, i8* %arg8, %struct.bf_key_st* %arg9, i64* %arg10, i8* %arg11, i8* %arg12, i8* %arg13, i8* %arg14, i8* %arg15, i8* %arg16, %3* %arg17, i16 %i48)
  ret void
...
define void @"BF_cfb64_encrypt$1"(%0* %arg, i8* %arg1, i8* %arg2, i64 %arg3, i32 %arg4, i64* %arg5, %struct.bf_key_st* %arg6, i64* %arg7, <2 x i64>* %arg8, i8* %arg9, i8* %arg10, i8* %arg11, i8* %arg12, i8* %arg13, i8* %arg14, i8* %arg15, i8* %arg16, %1* %arg17, i16 %arg18) {
...
"BF_cfb64_encrypt$1_recursively_call_function":   ; preds = %"BF_cfb64_encrypt$1_increment_depth_counter"
  call void @"BF_cfb64_encrypt$1"(%0* %arg, i8* %incdec.ptr63, i8* %incdec.ptr58, i64 %dec, i32 %and66, i64* %arg5, %struct.bf_key_st* %arg6, i64* %arg7, <2 x i64>* %arg8, i8* %arg9, i8* %arg10, i8* %arg11, i8* %arg12, i8* %arg13, i8* %arg14, i8* %arg15, i8* %arg16, %1* %arg17, i16 %i48)
  ret void
