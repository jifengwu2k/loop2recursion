; ModuleID = './benchmark_intermediate_representations/unoptimized_loop2recursion-recursion_depth_limit-256/bf/bf.ll.temp'
...
"main$1_call_recursive_function":                 ; preds = %"main$1_extract_next_values", %"main$1_initialize_context"
  ...
  call void @"main$1"(%0* %i9, i8* %i11, i32 %i12, i32 %i13, [8 x i8]* %ukey, %1* %i10, i16 0)
...
"main$0_call_recursive_function":                 ; preds = %"main$0_extract_next_values", %"main$0_initialize_context"
  call void @"main$0"([40 x i8]* %outdata, [40 x i8]* %indata, i32 %encordec.0, i8* %i2, %struct._IO_FILE* %call67, i8* %i3, %struct.bf_key_st* %key, %struct._IO_FILE* %call74, i8* %i4, i32* %num, %2* %i29, i16 0)
...
define void @"main$0"([40 x i8]* %arg, [40 x i8]* %arg1, i32 %arg2, i8* %arg3, %struct._IO_FILE* %arg4, i8* %arg5, %struct.bf_key_st* %arg6, %struct._IO_FILE* %arg7, i8* %arg8, i32* %arg9, %2* %arg10, i16 %arg11) {
"main$0_header":
...
"main$0$1_call_recursive_function":               ; preds = %"main$0$1_extract_next_values", %"main$0$1_initialize_context"
  ...
  call void @"main$0$1"(%3* %i, i64 %i13, [40 x i8]* %arg1, %struct._IO_FILE* %arg4, %4* %i12, i16 0)
...
"main$0$0_call_recursive_function":               ; preds = %"main$0$0_extract_next_values", %"main$0$0_initialize_context"
  ...
  call void @"main$0$0"(i64 %i22, i32 %i20, [40 x i8]* %arg, %struct._IO_FILE* %arg7, %5* %i21, i16 0)
...
"main$0_recursively_call_function":               ; preds = %"main$0_increment_depth_counter"
  call void @"main$0"([40 x i8]* %arg, [40 x i8]* %arg1, i32 %arg2, i8* %arg3, %struct._IO_FILE* %arg4, i8* %arg5, %struct.bf_key_st* %arg6, %struct._IO_FILE* %arg7, i8* %arg8, i32* %arg9, %2* %arg10, i16 %i27)
  ret void
...
define void @"main$1"(%0* %arg, i8* %arg1, i32 %arg2, i32 %arg3, [8 x i8]* %arg4, %1* %arg5, i16 %arg6) {
"main$1_exiting$1":
...
"main$1_recursively_call_function":               ; preds = %"main$1_increment_depth_counter"
  call void @"main$1"(%0* %arg, i8* %incdec.ptr, i32 %sub, i32 %inc, [8 x i8]* %arg4, %1* %arg5, i16 %i9)
  ret void
...
define void @"main$0$0"(i64 %arg, i32 %arg1, [40 x i8]* %arg2, %struct._IO_FILE* %arg3, %5* %arg4, i16 %arg5) {
"main$0$0_latch$0":
...
"main$0$0_recursively_call_function":             ; preds = %"main$0$0_increment_depth_counter"
  call void @"main$0$0"(i64 %indvars.iv.next159, i32 %arg1, [40 x i8]* %arg2, %struct._IO_FILE* %arg3, %5* %arg4, i16 %i6)
  ret void
...
define void @"main$0$1"(%3* %arg, i64 %arg1, [40 x i8]* %arg2, %struct._IO_FILE* %arg3, %4* %arg4, i16 %arg5) {
"main$0$1_latch$0":
...
"main$0$1_recursively_call_function":             ; preds = %"main$0$1_increment_depth_counter"
  call void @"main$0$1"(%3* %arg, i64 %indvars.iv.next, [40 x i8]* %arg2, %struct._IO_FILE* %arg3, %4* %arg4, i16 %i6)
  ret void
