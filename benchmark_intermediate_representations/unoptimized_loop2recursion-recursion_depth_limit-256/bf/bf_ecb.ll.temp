; ModuleID = './benchmark_intermediate_representations/baseline/bf/bf_ecb.ll'
...
entry:
  ...
  %1 = load i8, i8* %in, align 1, !tbaa !1
  ...
  %10 = load i8, i8* %incdec.ptr11, align 1, !tbaa !1
  ...
  %16 = load i8, i8* %incdec.ptr14, align 1, !tbaa !1
  ...
  %21 = or <2 x i64> %15, %20
  %22 = load i8, i8* %incdec.ptr18, align 1, !tbaa !1
  ...
  %conv54 = trunc i64 %28 to i8
  store i8 %conv54, i8* %incdec.ptr52, align 1, !tbaa !1
  call void @llvm.lifetime.end.p0i8(i64 16, i8* %0) #4
  ret void
}
