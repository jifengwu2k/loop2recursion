; ModuleID = './benchmark_intermediate_representations/unoptimized_loop2recursion-recursion_depth_limit-256/rawcaudio/rawcaudio.ll.temp'
...
"main$0_call_recursive_function":                 ; preds = %"main$0_extract_next_values", %"main$0_initialize_context"
  %i2 = phi i32 [ %call11, %"main$0_initialize_context" ], [ %i6, %"main$0_extract_next_values" ]
  call void @"main$0"(%0* %i, i32 %i2, %1* %i1, i16 0)
  %i3 = getelementptr %1, %1* %i1, i32 0, i32 1
  %i4 = load i1, i1* %i3, align 1
  br i1 %i4, label %"main$0_branch_to_exit", label %"main$0_extract_next_values"
...
"main$0_branch_to_exit":                          ; preds = %"main$0_call_recursive_function"
  ...
  switch i8 %i8, label %if.then.loopexit [
...
while.end:                                        ; preds = %"main$0_branch_to_exit"
  ...
  %i10 = load i16, i16* getelementptr inbounds (%struct.adpcm_state, %struct.adpcm_state* @state, i64 0, i32 0), align 2, !tbaa !5
  %conv = sext i16 %i10 to i32
  %i11 = load i8, i8* getelementptr inbounds (%struct.adpcm_state, %struct.adpcm_state* @state, i64 0, i32 1), align 2, !tbaa !8
  %conv6 = sext i8 %i11 to i32
  %call7 = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %i9, i8* nonnull getelementptr inbounds ([28 x i8], [28 x i8]* @.str.1, i64 0, i64 0), i32 %conv, i32 %conv6) #5
...
define void @"main$0"(%0* %arg, i32 %arg1, %1* %arg2, i16 %arg3) {
"main$0_exiting$1":
...
"main$0_recursively_call_function":               ; preds = %"main$0_increment_depth_counter"
  call void @"main$0"(%0* %arg, i32 %call, %1* %arg2, i16 %i)
  ret void

"main$0_save_recursive_state_and_return":         ; preds = %"main$0_increment_depth_counter"
  %i5 = getelementptr %1, %1* %arg2, i32 0, i32 0
  store i32 %call, i32* %i5, align 4
  %i6 = getelementptr %1, %1* %arg2, i32 0, i32 1
...
"main$0_return_from_recursive_function$0":        ; preds = %"main$0_latch$0"
  ...
  %i8 = getelementptr %1, %1* %arg2, i32 0, i32 1
...
"main$0_return_from_recursive_function$1":        ; preds = %"main$0_exiting$1"
  ...
  %i10 = getelementptr %1, %1* %arg2, i32 0, i32 1
