; ModuleID = './benchmark_intermediate_representations/unoptimized_loop2recursion-recursion_depth_limit-256/rawcaudio/adpcm.ll.temp'
...
"adpcm_coder$0_call_recursive_function":          ; preds = %"adpcm_coder$0_extract_next_values", %"adpcm_coder$0_initialize_context"
  ...
  call void @"adpcm_coder$0"(%0* %i3, i32 %i5, i32 %i6, i32 %i7, i32 %i8, i16* %i9, i32 %i10, i8* %i11, i32 %i12, %1* %i4, i16 0)
...
"adpcm_decoder$0_call_recursive_function":        ; preds = %"adpcm_decoder$0_extract_next_values", %"adpcm_decoder$0_initialize_context"
  ...
  call void @"adpcm_decoder$0"(%2* %i3, i8* %i5, i32 %i6, i32 %i7, i32 %i8, i32 %i9, i32 %i10, i16* %i11, i32 %i12, %3* %i4, i16 0)
...
define void @"adpcm_coder$0"(%0* %arg, i32 %arg1, i32 %arg2, i32 %arg3, i32 %arg4, i16* %arg5, i32 %arg6, i8* %arg7, i32 %arg8, %1* %arg9, i16 %arg10) {
...
"adpcm_coder$0_recursively_call_function":        ; preds = %"adpcm_coder$0_increment_depth_counter"
  call void @"adpcm_coder$0"(%0* %arg, i32 %lnot.ext, i32 %..add44, i32 %outputbuffer.1, i32 %valpred.2, i16* %incdec.ptr, i32 %i16, i8* %outp.1, i32 %dec, %1* %arg9, i16 %i18)
  ret void
...
define void @"adpcm_decoder$0"(%2* %arg, i8* %arg1, i32 %arg2, i32 %arg3, i32 %arg4, i32 %arg5, i32 %arg6, i16* %arg7, i32 %arg8, %3* %arg9, i16 %arg10) {
...
"adpcm_decoder$0_recursively_call_function":      ; preds = %"adpcm_decoder$0_increment_depth_counter"
  call void @"adpcm_decoder$0"(%2* %arg, i8* %inp.1, i32 %dec, i32 %inputbuffer.1, i32 %lnot.ext, i32 %..add, i32 %valpred.2, i16* %incdec.ptr54, i32 %i14, %3* %arg9, i16 %i15)
  ret void
