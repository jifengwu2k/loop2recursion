; ModuleID = './benchmark_intermediate_representations/unoptimized_loop2recursion-recursion_depth_limit-256/bitcnts/bstr_i.ll.temp'
...
"bstr_i$0_call_recursive_function":               ; preds = %"bstr_i$0_extract_next_values", %"bstr_i$0_initialize_context"
  ...
  call void @"bstr_i$0"(%0* %i1, i32 %i3, i8 %i4, i8* %i5, %1* %i2, i16 0)
...
define void @"bstr_i$0"(%0* %arg, i32 %arg1, i8 %arg2, i8* %arg3, %1* %arg4, i16 %arg5) {
"bstr_i$0_exiting$1":
...
"bstr_i$0_recursively_call_function":             ; preds = %"bstr_i$0_increment_depth_counter"
  call void @"bstr_i$0"(%0* %arg, i32 %or, i8 %i8, i8* %incdec.ptr, %1* %arg4, i16 %i9)
  ret void
