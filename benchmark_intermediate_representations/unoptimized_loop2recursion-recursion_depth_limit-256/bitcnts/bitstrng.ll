; ModuleID = './benchmark_intermediate_representations/unoptimized_loop2recursion-recursion_depth_limit-256/bitcnts/bitstrng.ll.temp'
...
"bitstring$0_call_recursive_function":            ; preds = %"bitstring$0_extract_next_values", %"bitstring$0_initialize_context"
  ...
  call void @"bitstring$0"(%0* %i6, i8* %i8, i64 %i9, i64 %byze, %1* %i7, i16 0)
...
define void @"bitstring$0"(%0* %arg, i8* %arg1, i64 %arg2, i64 %arg3, %1* %arg4, i16 %arg5) {
"bitstring$0_header":
...
"bitstring$0_recursively_call_function":          ; preds = %"bitstring$0_increment_depth_counter"
  call void @"bitstring$0"(%0* %arg, i8* %str.addr.1.be, i64 %indvars.iv.next, i64 %arg3, %1* %arg4, i16 %i6)
  ret void
