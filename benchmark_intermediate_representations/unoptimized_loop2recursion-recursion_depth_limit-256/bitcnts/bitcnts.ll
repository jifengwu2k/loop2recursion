; ModuleID = './benchmark_intermediate_representations/unoptimized_loop2recursion-recursion_depth_limit-256/bitcnts/bitcnts.ll.temp'
...
"main$0_call_recursive_function":                 ; preds = %"main$0_extract_next_values", %"main$0_initialize_context"
  ...
  call void @"main$0"(%0* %i3, double %i5, i32 %i6, i64 %i7, i32 %i8, double %i9, i64 %conv7, i1 %cmp861, %1* %i4, i16 0)
...
"bit_shifter$0_call_recursive_function":          ; preds = %"bit_shifter$0_extract_next_values", %"bit_shifter$0_initialize_context"
  ...
  call void @"bit_shifter$0"(%2* %i, i64 %i2, i32 %i3, i32 %i4, %3* %i1, i16 0)
...
define void @"main$0"(%0* %arg, double %arg1, i32 %arg2, i64 %arg3, i32 %arg4, double %arg5, i64 %arg6, i1 %arg7, %1* %arg8, i16 %arg9) {
"main$0_header":
...
"main$0$0_call_recursive_function":               ; preds = %"main$0$0_extract_next_values", %"main$0$0_initialize_context"
  ...
  call void @"main$0$0"(%4* %i10, i64 %i12, i64 %i13, i64 %i14, i64 %arg6, i32 (i64)* %i, %5* %i11, i16 0)
...
"main$0_recursively_call_function":               ; preds = %"main$0_increment_depth_counter"
  call void @"main$0"(%0* %arg, double %cmax.1, i32 %cmaxix.1, i64 %indvars.iv.next, i32 %cminix.1, double %cmin.1, i64 %arg6, i1 %arg7, %1* %arg8, i16 %i27)
  ret void
...
define void @"bit_shifter$0"(%2* %arg, i64 %arg1, i32 %arg2, i32 %arg3, %3* %arg4, i16 %arg5) {
...
"bit_shifter$0_recursively_call_function":        ; preds = %"bit_shifter$0_increment_depth_counter"
  call void @"bit_shifter$0"(%2* %arg, i64 %shr, i32 %add, i32 %inc, %3* %arg4, i16 %i)
  ret void
...
define void @"main$0$0"(%4* %arg, i64 %arg1, i64 %arg2, i64 %arg3, i64 %arg4, i32 (i64)* %arg5, %5* %arg6, i16 %arg7) {
"main$0$0_latch$0":
...
"main$0$0_recursively_call_function":             ; preds = %"main$0$0_increment_depth_counter"
  call void @"main$0$0"(%4* %arg, i64 %inc, i64 %add14, i64 %add, i64 %arg4, i32 (i64)* %arg5, %5* %arg6, i16 %i)
  ret void
