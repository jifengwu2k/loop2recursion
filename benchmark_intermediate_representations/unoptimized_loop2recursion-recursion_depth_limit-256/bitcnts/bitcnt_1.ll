; ModuleID = './benchmark_intermediate_representations/unoptimized_loop2recursion-recursion_depth_limit-256/bitcnts/bitcnt_1.ll.temp'
...
"bit_count$0_call_recursive_function":            ; preds = %"bit_count$0_extract_next_values", %"bit_count$0_initialize_context"
  ...
  call void @"bit_count$0"(%0* %i, i32 %i2, i64 %i3, %1* %i1, i16 0)
...
define void @"bit_count$0"(%0* %arg, i32 %arg1, i64 %arg2, %1* %arg3, i16 %arg4) {
"bit_count$0_latch$0":
...
"bit_count$0_recursively_call_function":          ; preds = %"bit_count$0_increment_depth_counter"
  call void @"bit_count$0"(%0* %arg, i32 %inc, i64 %and, %1* %arg3, i16 %i)
  ret void
