; ModuleID = './benchmark_intermediate_representations/unoptimized_loop2recursion-recursion_depth_limit-256/qsort/qsort_small.ll.temp'
...
"main$1_call_recursive_function":                 ; preds = %"main$1_extract_next_values", %"main$1_initialize_context"
  ...
  call void @"main$1"(%0* %i4, i64 %i6, %struct._IO_FILE* %call1, [60000 x %struct.myStringStruct]* %array, %1* %i5, i16 0)
  %i7 = getelementptr %1, %1* %i5, i32 0, i32 1
  %i8 = load i1, i1* %i7, align 1
  br i1 %i8, label %"main$1_extract_return_values$0", label %"main$1_extract_next_values"

"main$1_extract_next_values":                     ; preds = %"main$1_call_recursive_function"
  %i9 = getelementptr %1, %1* %i5, i32 0, i32 0
  %i10 = load i64, i64* %i9, align 8
  br label %"main$1_call_recursive_function"

"main$1_extract_return_values$0":                 ; preds = %"main$1_call_recursive_function"
  %i11 = getelementptr %0, %0* %i4, i32 0, i32 0
  %i12 = load i64, i64* %i11, align 8
  br label %if.end

if.end:                                           ; preds = %"main$1_extract_return_values$0"
  %i13 = trunc i64 %i12 to i32
  %call6 = call i32 (i8*, ...) @printf(i8* nonnull getelementptr inbounds ([24 x i8], [24 x i8]* @.str.3, i64 0, i64 0), i32 %i13)
  call void @qsort(i8* %i, i64 %i12, i64 128, i32 (i8*, i8*)* nonnull @compare) #6
  %cmp724 = icmp sgt i32 %i13, 0
...
"main$0_call_recursive_function":                 ; preds = %"main$0_extract_next_values", %"main$0_initialize_context"
  %i15 = phi i64 [ 0, %"main$0_initialize_context" ], [ %i19, %"main$0_extract_next_values" ]
  call void @"main$0"(i64 %i15, i32 %i13, [60000 x %struct.myStringStruct]* %array, %2* %i14, i16 0)
  %i16 = getelementptr %2, %2* %i14, i32 0, i32 1
  %i17 = load i1, i1* %i16, align 1
  br i1 %i17, label %for.end.loopexit, label %"main$0_extract_next_values"

"main$0_extract_next_values":                     ; preds = %"main$0_call_recursive_function"
  %i18 = getelementptr %2, %2* %i14, i32 0, i32 0
...
define void @"main$0"(i64 %arg, i32 %arg1, [60000 x %struct.myStringStruct]* %arg2, %2* %arg3, i16 %arg4) {
"main$0_latch$0":
...
"main$0_recursively_call_function":               ; preds = %"main$0_increment_depth_counter"
  call void @"main$0"(i64 %indvars.iv.next, i32 %arg1, [60000 x %struct.myStringStruct]* %arg2, %2* %arg3, i16 %i)
  ret void

"main$0_save_recursive_state_and_return":         ; preds = %"main$0_increment_depth_counter"
  %i6 = getelementptr %2, %2* %arg3, i32 0, i32 0
  store i64 %indvars.iv.next, i64* %i6, align 8
  %i7 = getelementptr %2, %2* %arg3, i32 0, i32 1
...
define void @"main$1"(%0* %arg, i64 %arg1, %struct._IO_FILE* %arg2, [60000 x %struct.myStringStruct]* %arg3, %1* %arg4, i16 %arg5) {
"main$1_latch$0":
...
"main$1_recursively_call_function":               ; preds = %"main$1_increment_depth_counter"
  call void @"main$1"(%0* %arg, i64 %indvars.iv.next27, %struct._IO_FILE* %arg2, [60000 x %struct.myStringStruct]* %arg3, %1* %arg4, i16 %i6)
  ret void

"main$1_save_recursive_state_and_return":         ; preds = %"main$1_increment_depth_counter"
  %i8 = getelementptr %1, %1* %arg4, i32 0, i32 0
  store i64 %indvars.iv.next27, i64* %i8, align 8
...
"main$1_return_from_recursive_function$0":        ; preds = %"main$1_latch$0"
  ...
  %i11 = getelementptr %1, %1* %arg4, i32 0, i32 1
