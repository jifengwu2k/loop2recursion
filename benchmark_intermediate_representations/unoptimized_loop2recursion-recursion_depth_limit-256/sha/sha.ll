; ModuleID = './benchmark_intermediate_representations/unoptimized_loop2recursion-recursion_depth_limit-256/sha/sha.ll.temp'
...
"sha_transform$4_call_recursive_function":        ; preds = %"sha_transform$4_extract_next_values", %"sha_transform$4_initialize_context"
  ...
  call void @"sha_transform$4"(i64 %i2, [80 x i64]* %W, %1* %i1, i16 0)
...
"sha_transform$3_call_recursive_function":        ; preds = %"sha_transform$3_extract_next_values", %"sha_transform$3_initialize_context"
  ...
  call void @"sha_transform$3"(%2* %i12, i64 %i14, i64 %i15, i64 %i16, i64 %i17, i64 %i18, i64 %i19, [80 x i64]* %W, %3* %i13, i16 0)
...
"sha_transform$2_call_recursive_function":        ; preds = %"sha_transform$2_extract_next_values", %"sha_transform$2_initialize_context"
  ...
  call void @"sha_transform$2"(%4* %i44, i64 %i46, i64 %i47, i64 %i48, i64 %i49, i64 %i50, i64 %i51, [80 x i64]* %W, %5* %i45, i16 0)
...
"sha_transform$1_call_recursive_function":        ; preds = %"sha_transform$1_extract_next_values", %"sha_transform$1_initialize_context"
  ...
  call void @"sha_transform$1"(%6* %i76, i64 %i78, i64 %i79, i64 %i80, i64 %i81, i64 %i82, i64 %i83, [80 x i64]* %W, %7* %i77, i16 0)
...
"sha_transform$0_call_recursive_function":        ; preds = %"sha_transform$0_extract_next_values", %"sha_transform$0_initialize_context"
  ...
  call void @"sha_transform$0"(%8* %i108, i64 %i110, i64 %i111, i64 %i112, i64 %i113, i64 %i114, i64 %i115, [80 x i64]* %W, %9* %i109, i16 0)
...
"sha_stream$0_call_recursive_function":           ; preds = %"sha_stream$0_extract_next_values", %"sha_stream$0_initialize_context"
  ...
  call void @"sha_stream$0"(i32 %i5, %struct._IO_FILE* %fin, %struct.SHA_INFO* %sha_info, i8* %i, %10* %i4, i16 0)
...
"sha_update$0_recursively_call_function":         ; preds = %"sha_update$0_increment_depth_counter"
  call void @"sha_update$0"(i8* %add.ptr, i32 %sub, %struct.SHA_INFO* %arg2, i8* %arg3, i8* %arg4, i8* %arg5, i8* %arg6, i8* %arg7, i8* %arg8, i8* %arg9, i8* %arg10, i8* %arg11, i8* %arg12, i8* %arg13, i8* %arg14, i8* %arg15, i8* %arg16, i8* %arg17, i8* %arg18, i8* %arg19, i8* %arg20, i8* %arg21, i8* %arg22, i8* %arg23, i8* %arg24, i8* %arg25, i8* %arg26, i8* %arg27, i8* %arg28, i8* %arg29, i8* %arg30, i8* %arg31, i8* %arg32, i8* %arg33, i8* %arg34, %0* %arg35, i16 %i68)
  ret void
...
define void @"sha_transform$0"(%8* %arg, i64 %arg1, i64 %arg2, i64 %arg3, i64 %arg4, i64 %arg5, i64 %arg6, [80 x i64]* %arg7, %9* %arg8, i16 %arg9) {
...
"sha_transform$0_recursively_call_function":      ; preds = %"sha_transform$0_increment_depth_counter"
  call void @"sha_transform$0"(%8* %arg, i64 %add105, i64 %arg1, i64 %arg4, i64 %or108, i64 %indvars.iv.next, i64 %arg3, [80 x i64]* %arg7, %9* %arg8, i16 %i10)
  ret void
...
define void @"sha_transform$1"(%6* %arg, i64 %arg1, i64 %arg2, i64 %arg3, i64 %arg4, i64 %arg5, i64 %arg6, [80 x i64]* %arg7, %7* %arg8, i16 %arg9) {
...
"sha_transform$1_recursively_call_function":      ; preds = %"sha_transform$1_increment_depth_counter"
  call void @"sha_transform$1"(%6* %arg, i64 %add85, i64 %arg1, i64 %or88, i64 %arg3, i64 %indvars.iv.next244, i64 %arg4, [80 x i64]* %arg7, %7* %arg8, i16 %i10)
  ret void
...
define void @"sha_transform$2"(%4* %arg, i64 %arg1, i64 %arg2, i64 %arg3, i64 %arg4, i64 %arg5, i64 %arg6, [80 x i64]* %arg7, %5* %arg8, i16 %arg9) {
...
"sha_transform$2_recursively_call_function":      ; preds = %"sha_transform$2_increment_depth_counter"
  call void @"sha_transform$2"(%4* %arg, i64 %add62, i64 %arg1, i64 %or65, i64 %arg3, i64 %indvars.iv.next247, i64 %arg4, [80 x i64]* %arg7, %5* %arg8, i16 %i10)
  ret void
...
define void @"sha_transform$3"(%2* %arg, i64 %arg1, i64 %arg2, i64 %arg3, i64 %arg4, i64 %arg5, i64 %arg6, [80 x i64]* %arg7, %3* %arg8, i16 %arg9) {
...
"sha_transform$3_recursively_call_function":      ; preds = %"sha_transform$3_increment_depth_counter"
  call void @"sha_transform$3"(%2* %arg, i64 %add42, i64 %arg1, i64 %or45, i64 %arg3, i64 %indvars.iv.next250, i64 %arg4, [80 x i64]* %arg7, %3* %arg8, i16 %i10)
  ret void
...
define void @"sha_transform$4"(i64 %arg, [80 x i64]* %arg1, %1* %arg2, i16 %arg3) {
...
"sha_transform$4_recursively_call_function":      ; preds = %"sha_transform$4_increment_depth_counter"
  call void @"sha_transform$4"(i64 %indvars.iv.next253.1, [80 x i64]* %arg1, %1* %arg2, i16 %i19)
  ret void
...
define void @"sha_stream$0"(i32 %arg, %struct._IO_FILE* %arg1, %struct.SHA_INFO* %arg2, i8* %arg3, %10* %arg4, i16 %arg5) {
...
"sha_stream$0_recursively_call_function":         ; preds = %"sha_stream$0_increment_depth_counter"
  call void @"sha_stream$0"(i32 %conv, %struct._IO_FILE* %arg1, %struct.SHA_INFO* %arg2, i8* %arg3, %10* %arg4, i16 %i)
  ret void
