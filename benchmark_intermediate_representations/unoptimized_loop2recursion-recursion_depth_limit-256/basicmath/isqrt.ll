; ModuleID = './benchmark_intermediate_representations/unoptimized_loop2recursion-recursion_depth_limit-256/basicmath/isqrt.ll.temp'
...
"usqrt$0_call_recursive_function":                ; preds = %"usqrt$0_extract_next_values", %"usqrt$0_initialize_context"
  ...
  call void @"usqrt$0"(%0* %i, i64 %i2, i64 %i3, i32 %i4, i64 %i5, %1* %i1, i16 0)
...
define void @"usqrt$0"(%0* %arg, i64 %arg1, i64 %arg2, i32 %arg3, i64 %arg4, %1* %arg5, i16 %arg6) {
"usqrt$0_latch$0":
  %shl = shl i64 %arg4, 2
...
"usqrt$0_recursively_call_function":              ; preds = %"usqrt$0_increment_depth_counter"
  call void @"usqrt$0"(%0* %arg, i64 %shl1, i64 %a.1, i32 %inc6, i64 %r.1, %1* %arg5, i16 %i8)
  ret void
