; ModuleID = './benchmark_intermediate_representations/unoptimized_loop2recursion-recursion_depth_limit-256/basicmath/basicmath_small.ll.temp'
...
"main$7_call_recursive_function":                 ; preds = %"main$7_extract_next_values", %"main$7_initialize_context"
  ...
  call void @"main$7"(i64 %i5, i32* %solutions, [3 x double]* %x, %0* %i4, i16 0)
...
"main$6_call_recursive_function":                 ; preds = %"main$6_extract_next_values", %"main$6_initialize_context"
  ...
  call void @"main$6"(i64 %i12, i32* %solutions, [3 x double]* %x, %1* %i11, i16 0)
...
"main$5_call_recursive_function":                 ; preds = %"main$5_extract_next_values", %"main$5_initialize_context"
  ...
  call void @"main$5"(i64 %i19, i32* %solutions, [3 x double]* %x, %2* %i18, i16 0)
...
"main$4_call_recursive_function":                 ; preds = %"main$4_extract_next_values", %"main$4_initialize_context"
  ...
  call void @"main$4"(i64 %i26, i32* %solutions, [3 x double]* %x, %3* %i25, i16 0)
...
"main$3_call_recursive_function":                 ; preds = %"main$3_extract_next_values", %"main$3_initialize_context"
  ...
  call void @"main$3"(i32 %i32, [3 x double]* %x, i32* %solutions, double* %arraydecay, %4* %i31, i16 0)
...
"main$2_call_recursive_function":                 ; preds = %"main$2_extract_next_values", %"main$2_initialize_context"
  ...
  call void @"main$2"(i64 %i38, i32* %sqrt, %struct.int_sqrt* %q, %5* %i37, i16 0)
...
"main$1_call_recursive_function":                 ; preds = %"main$1_extract_next_values", %"main$1_initialize_context"
  ...
  call void @"main$1"(i32 %i45, %6* %i44, i16 0)
...
"main$0_call_recursive_function":                 ; preds = %"main$0_extract_next_values", %"main$0_initialize_context"
  ...
  call void @"main$0"(double %i51, %7* %i50, i16 0)
...
define void @"main$0"(double %arg, %7* %arg1, i16 %arg2) {
"main$0_latch$0":
...
"main$0_recursively_call_function":               ; preds = %"main$0_increment_depth_counter"
  call void @"main$0"(double %add113, %7* %arg1, i16 %i)
  ret void
...
define void @"main$1"(i32 %arg, %6* %arg1, i16 %arg2) {
"main$1_latch$0":
...
"main$1_recursively_call_function":               ; preds = %"main$1_increment_depth_counter"
  call void @"main$1"(i32 %add93.int, %6* %arg1, i16 %i)
  ret void
...
define void @"main$2"(i64 %arg, i32* %arg1, %struct.int_sqrt* %arg2, %5* %arg3, i16 %arg4) {
"main$2_latch$0":
...
"main$2_recursively_call_function":               ; preds = %"main$2_increment_depth_counter"
  call void @"main$2"(i64 %indvars.iv.next, i32* %arg1, %struct.int_sqrt* %arg2, %5* %arg3, i16 %i6)
  ret void
...
define void @"main$3"(i32 %arg, [3 x double]* %arg1, i32* %arg2, double* %arg3, %4* %arg4, i16 %arg5) {
"main$3_header":
...
"main$3$0_call_recursive_function":               ; preds = %"main$3$0_extract_next_values", %"main$3$0_initialize_context"
  ...
  call void @"main$3$0"(i32 %i6, [3 x double]* %arg1, double* %arg3, double %indvar.conv205, i32* %arg2, %8* %i, i16 0)
...
"main$3_recursively_call_function":               ; preds = %"main$3_increment_depth_counter"
  call void @"main$3"(i32 %inc72.int, [3 x double]* %arg1, i32* %arg2, double* %arg3, %4* %arg4, i16 %i11)
  ret void
...
define void @"main$4"(i64 %arg, i32* %arg1, [3 x double]* %arg2, %3* %arg3, i16 %arg4) {
"main$4_latch$0":
...
"main$4_recursively_call_function":               ; preds = %"main$4_increment_depth_counter"
  call void @"main$4"(i64 %indvars.iv.next208, i32* %arg1, [3 x double]* %arg2, %3* %arg3, i16 %i7)
  ret void
...
define void @"main$5"(i64 %arg, i32* %arg1, [3 x double]* %arg2, %2* %arg3, i16 %arg4) {
"main$5_latch$0":
...
"main$5_recursively_call_function":               ; preds = %"main$5_increment_depth_counter"
  call void @"main$5"(i64 %indvars.iv.next210, i32* %arg1, [3 x double]* %arg2, %2* %arg3, i16 %i7)
  ret void
...
define void @"main$6"(i64 %arg, i32* %arg1, [3 x double]* %arg2, %1* %arg3, i16 %arg4) {
"main$6_latch$0":
...
"main$6_recursively_call_function":               ; preds = %"main$6_increment_depth_counter"
  call void @"main$6"(i64 %indvars.iv.next212, i32* %arg1, [3 x double]* %arg2, %1* %arg3, i16 %i7)
  ret void
...
define void @"main$7"(i64 %arg, i32* %arg1, [3 x double]* %arg2, %0* %arg3, i16 %arg4) {
"main$7_latch$0":
...
"main$7_recursively_call_function":               ; preds = %"main$7_increment_depth_counter"
  call void @"main$7"(i64 %indvars.iv.next214, i32* %arg1, [3 x double]* %arg2, %0* %arg3, i16 %i7)
  ret void
...
define void @"main$3$0"(i32 %arg, [3 x double]* %arg1, double* %arg2, double %arg3, i32* %arg4, %8* %arg5, i16 %arg6) {
"main$3$0_header":
...
"main$3$0$0_call_recursive_function":             ; preds = %"main$3$0$0_extract_next_values", %"main$3$0$0_initialize_context"
  ...
  call void @"main$3$0$0"(double %i7, [3 x double]* %arg1, i32* %arg4, double %arg3, double* %arg2, double %indvar.conv203, %9* %i, i16 0)
...
"main$3$0_recursively_call_function":             ; preds = %"main$3$0_increment_depth_counter"
  call void @"main$3$0"(i32 %dec69.int, [3 x double]* %arg1, double* %arg2, double %arg3, i32* %arg4, %8* %arg5, i16 %i12)
  ret void
...
define void @"main$3$0$0"(double %arg, [3 x double]* %arg1, i32* %arg2, double %arg3, double* %arg4, double %arg5, %9* %arg6, i16 %arg7) {
"main$3$0$0_header":
...
"main$3$0$0$0_call_recursive_function":           ; preds = %"main$3$0$0$0_extract_next_values", %"main$3$0$0$0_initialize_context"
  ...
  call void @"main$3$0$0$0"(i32 %i8, [3 x double]* %arg1, double* %arg4, i32* %arg2, double %arg, double %arg3, double %arg5, %10* %i, i16 0)
...
"main$3$0$0_recursively_call_function":           ; preds = %"main$3$0$0_increment_depth_counter"
  call void @"main$3$0$0"(double %add, [3 x double]* %arg1, i32* %arg2, double %arg3, double* %arg4, double %arg5, %9* %arg6, i16 %i13)
  ret void
...
define void @"main$3$0$0$0"(i32 %arg, [3 x double]* %arg1, double* %arg2, i32* %arg3, double %arg4, double %arg5, double %arg6, %10* %arg7, i16 %arg8) {
"main$3$0$0$0_header":
...
"main$3$0$0$0$0_call_recursive_function":         ; preds = %"main$3$0$0$0$0_extract_next_values", %"main$3$0$0$0$0_initialize_context"
  ...
  call void @"main$3$0$0$0$0"(i64 %i10, i32* %arg3, [3 x double]* %arg1, %11* %i9, i16 0)
...
"main$3$0$0$0_recursively_call_function":         ; preds = %"main$3$0$0$0_increment_depth_counter"
  call void @"main$3$0$0$0"(i32 %dec.int, [3 x double]* %arg1, double* %arg2, i32* %arg3, double %arg4, double %arg5, double %arg6, %10* %arg7, i16 %i15)
  ret void
...
define void @"main$3$0$0$0$0"(i64 %arg, i32* %arg1, [3 x double]* %arg2, %11* %arg3, i16 %arg4) {
...
"main$3$0$0$0$0_recursively_call_function":       ; preds = %"main$3$0$0$0$0_increment_depth_counter"
  call void @"main$3$0$0$0$0"(i64 %indvars.iv.next199, i32* %arg1, [3 x double]* %arg2, %11* %arg3, i16 %i7)
  ret void
