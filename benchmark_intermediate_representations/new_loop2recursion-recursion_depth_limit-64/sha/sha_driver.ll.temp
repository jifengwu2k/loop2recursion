; ModuleID = './benchmark_intermediate_representations/baseline/sha/sha_driver.ll'
...
entry:
  ...
  call void @llvm.lifetime.start.p0i8(i64 184, i8* %0) #4
...
"main$0_call_recursive_function":                 ; preds = %"main$0_extract_next_values", %"main$0_initialize_context"
  %1 = phi i8** [ %argv, %"main$0_initialize_context" ], [ %6, %"main$0_extract_next_values" ]
  %2 = phi i32 [ %dec13, %"main$0_initialize_context" ], [ %8, %"main$0_extract_next_values" ]
  call void @"main$0"(i8** %1, i32 %2, i8 0)
  %3 = getelementptr %0, %0* @"main$0_recursion_state_struct", i32 0, i32 2
  %4 = load i1, i1* %3, align 1
  br i1 %4, label %if.end6.loopexit, label %"main$0_extract_next_values"

"main$0_extract_next_values":                     ; preds = %"main$0_call_recursive_function"
  %5 = getelementptr %0, %0* @"main$0_recursion_state_struct", i32 0, i32 0
  %6 = load i8**, i8*** %5, align 8
  %7 = getelementptr %0, %0* @"main$0_recursion_state_struct", i32 0, i32 1
  %8 = load i32, i32* %7, align 4
  br label %"main$0_call_recursive_function"

if.then:                                          ; preds = %entry
  %9 = load %struct._IO_FILE*, %struct._IO_FILE** @stdin, align 8, !tbaa !1
  call void @sha_stream(%struct.SHA_INFO* nonnull %sha_info, %struct._IO_FILE* %9) #4
...
if.end6:                                          ; preds = %if.end6.loopexit, %if.then, %while.cond.preheader
  call void @llvm.lifetime.end.p0i8(i64 184, i8* %0) #4
  ret i32 0
}
...
define void @"main$0"(i8** %0, i32 %1, i8 %2) {
"main$0_header":
  %incdec.ptr = getelementptr inbounds i8*, i8** %0, i64 1
  %3 = load i8*, i8** %incdec.ptr, align 8, !tbaa !1
  %call = call %struct._IO_FILE* @fopen(i8* %3, i8* nonnull getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0))
  %cmp1 = icmp eq %struct._IO_FILE* %call, null
  br i1 %cmp1, label %if.then2, label %if.else4

if.else4:                                         ; preds = %"main$0_header"
  %4 = load %struct.SHA_INFO*, %struct.SHA_INFO** @"./benchmark_intermediate_representations/baseline/sha/sha_driver.ll_invariant_variable$0", align 8
  call void @sha_stream(%struct.SHA_INFO* nonnull %4, %struct._IO_FILE* nonnull %call) #4
  %5 = load %struct.SHA_INFO*, %struct.SHA_INFO** @"./benchmark_intermediate_representations/baseline/sha/sha_driver.ll_invariant_variable$0", align 8
  call void @sha_print(%struct.SHA_INFO* nonnull %5) #4
  %call5 = call i32 @fclose(%struct._IO_FILE* nonnull %call)
  br label %"main$0_latch$0"

if.then2:                                         ; preds = %"main$0_header"
  %6 = load i8*, i8** %incdec.ptr, align 8, !tbaa !1
  %call3 = call i32 (i8*, ...) @printf(i8* nonnull getelementptr inbounds ([30 x i8], [30 x i8]* @.str.1, i64 0, i64 0), i8* %6)
  br label %"main$0_latch$0"

"main$0_latch$0":                                 ; preds = %if.else4, %if.then2
  %dec = add nsw i32 %1, -1
...
"main$0_increment_depth_counter":                 ; preds = %"main$0_latch$0"
  %7 = add i8 %2, 1
  %8 = icmp ult i8 %7, 64
  br i1 %8, label %"main$0_recursively_call_function", label %"main$0_save_recursive_state_and_return"

"main$0_recursively_call_function":               ; preds = %"main$0_increment_depth_counter"
  call void @"main$0"(i8** %incdec.ptr, i32 %dec, i8 %7)
  ret void

"main$0_save_recursive_state_and_return":         ; preds = %"main$0_increment_depth_counter"
  %9 = getelementptr %0, %0* @"main$0_recursion_state_struct", i32 0, i32 0
  store i8** %incdec.ptr, i8*** %9, align 8
  %10 = getelementptr %0, %0* @"main$0_recursion_state_struct", i32 0, i32 1
  store i32 %dec, i32* %10, align 4
  %11 = getelementptr %0, %0* @"main$0_recursion_state_struct", i32 0, i32 2
  store i1 false, i1* %11, align 1
  ret void

"main$0_return_from_recursive_function$0":        ; preds = %"main$0_latch$0"
  %12 = getelementptr %0, %0* @"main$0_recursion_state_struct", i32 0, i32 2
