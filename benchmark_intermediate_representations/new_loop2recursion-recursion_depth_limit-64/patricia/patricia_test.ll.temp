; ModuleID = './benchmark_intermediate_representations/baseline/patricia/patricia_test.ll'
...
"main$0_initialize_context":                      ; preds = %while.body.lr.ph
  ...
  store %struct.ptree* %6, %struct.ptree** @"./benchmark_intermediate_representations/baseline/patricia/patricia_test.ll_invariant_variable$1", align 8
  store i32* %13, i32** @"./benchmark_intermediate_representations/baseline/patricia/patricia_test.ll_invariant_variable$2", align 8
  store i8* %0, i8** @"./benchmark_intermediate_representations/baseline/patricia/patricia_test.ll_invariant_variable$3", align 8
...
"main$0_call_recursive_function":                 ; preds = %"main$0_extract_next_values", %"main$0_initialize_context"
  ...
  %14 = getelementptr %1, %1* @"main$0_recursion_state_struct", i32 0, i32 0
  %15 = load i1, i1* %14, align 1
  br i1 %15, label %"main$0_branch_to_exit", label %"main$0_extract_next_values"
...
"main$0_branch_to_exit":                          ; preds = %"main$0_call_recursive_function"
  %16 = getelementptr %0, %0* @"main$0_return_value_struct", i32 0, i32 0
  %17 = load i8, i8* %16, align 1
  switch i8 %17, label %while.end.loopexit [
...
if.then66:                                        ; preds = %"main$0_branch_to_exit"
  ...
  %19 = call i64 @fwrite(i8* nonnull getelementptr inbounds ([22 x i8], [22 x i8]* @.str.9, i64 0, i64 0), i64 21, i64 1, %struct._IO_FILE* %18) #8
  call void @exit(i32 0) #7
  unreachable
...
"main$0_exiting$3":
  %1 = load i32*, i32** @"./benchmark_intermediate_representations/baseline/patricia/patricia_test.ll_invariant_variable$2", align 8
  %2 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/patricia/patricia_test.ll_invariant_variable$3", align 8
  %3 = load float*, float** @"./benchmark_intermediate_representations/baseline/patricia/patricia_test.ll_invariant_variable$4", align 8
  %call27 = call i32 (i8*, i8*, ...) @__isoc99_sscanf(i8* %2, i8* nonnull getelementptr inbounds ([6 x i8], [6 x i8]* @.str.6, i64 0, i64 0), float* nonnull %3, i32* %1) #4
  %call28 = call noalias i8* @malloc(i64 40) #4
  %4 = bitcast i8* %call28 to %struct.ptree*
...
"main$0_exiting$4":                               ; preds = %"main$0_exiting$3"
  ...
  %5 = bitcast i8* %p_m33 to i8**
  store i8* %call32, i8** %5, align 8, !tbaa !5
...
if.end45:                                         ; preds = %"main$0_exiting$2"
  ...
  %8 = load i32*, i32** @"./benchmark_intermediate_representations/baseline/patricia/patricia_test.ll_invariant_variable$2", align 8
  %9 = load i32, i32* %8, align 4, !tbaa !13
  %conv = zext i32 %9 to i64
  %p_key = bitcast i8* %call28 to i64*
  store i64 %conv, i64* %p_key, align 8, !tbaa !16
  %10 = call i32 asm "bswap $0", "=r,0,~{dirflag},~{fpsr},~{flags}"(i32 -1) #9, !srcloc !17
  %conv48 = zext i32 %10 to i64
  %pm_mask = bitcast i8* %call32 to i64*
  store i64 %conv48, i64* %pm_mask, align 8, !tbaa !18
  %11 = load %struct.ptree*, %struct.ptree** @"./benchmark_intermediate_representations/baseline/patricia/patricia_test.ll_invariant_variable$1", align 8
  %call52 = call %struct.ptree* @pat_search(i64 %conv, %struct.ptree* %11) #4
  %p_key53 = getelementptr inbounds %struct.ptree, %struct.ptree* %call52, i64 0, i32 0
  %12 = load i64, i64* %p_key53, align 8, !tbaa !16
  %13 = load i32*, i32** @"./benchmark_intermediate_representations/baseline/patricia/patricia_test.ll_invariant_variable$2", align 8
  %14 = load i32, i32* %13, align 4, !tbaa !13
  %conv55 = zext i32 %14 to i64
  %cmp56 = icmp eq i64 %12, %conv55
  br i1 %cmp56, label %if.end64.thread, label %"main$0_exiting$1"

"main$0_exiting$1":                               ; preds = %if.end45
  %15 = load %struct.ptree*, %struct.ptree** @"./benchmark_intermediate_representations/baseline/patricia/patricia_test.ll_invariant_variable$1", align 8
  %call63 = call %struct.ptree* @pat_insert(%struct.ptree* nonnull %4, %struct.ptree* %15) #4
...
if.end64.thread:                                  ; preds = %if.end45
  %16 = load float*, float** @"./benchmark_intermediate_representations/baseline/patricia/patricia_test.ll_invariant_variable$4", align 8
  %17 = load float, float* %16, align 4, !tbaa !19
  %conv59 = fpext float %17 to double
  %call61 = call i32 (i8*, ...) @printf(i8* nonnull getelementptr inbounds ([10 x i8], [10 x i8]* @.str.7, i64 0, i64 0), double %conv59, i32 %14)
  %puts = call i32 @puts(i8* nonnull getelementptr inbounds ([7 x i8], [7 x i8]* @str, i64 0, i64 0))
  br label %"main$0_latch$0"

"main$0_latch$0":                                 ; preds = %"main$0_exiting$1", %if.end64.thread
  %18 = load %struct._IO_FILE*, %struct._IO_FILE** @"./benchmark_intermediate_representations/baseline/patricia/patricia_test.ll_invariant_variable$0", align 8
  %19 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/patricia/patricia_test.ll_invariant_variable$3", align 8
  %call24 = call i8* @fgets(i8* %19, i32 128, %struct._IO_FILE* nonnull %18)
...
"main$0_increment_depth_counter":                 ; preds = %"main$0_latch$0"
  ...
  br i1 %21, label %"main$0_recursively_call_function", label %"main$0_save_recursive_state_and_return"

"main$0_recursively_call_function":               ; preds = %"main$0_increment_depth_counter"
  call void @"main$0"(i8 %20)
  ret void

"main$0_save_recursive_state_and_return":         ; preds = %"main$0_increment_depth_counter"
  %22 = getelementptr %1, %1* @"main$0_recursion_state_struct", i32 0, i32 0
  store i1 false, i1* %22, align 1
  ret void

"main$0_return_from_recursive_function$0":        ; preds = %"main$0_latch$0"
  %23 = getelementptr %0, %0* @"main$0_return_value_struct", i32 0, i32 0
  store i8 4, i8* %23, align 1
  %24 = getelementptr %1, %1* @"main$0_recursion_state_struct", i32 0, i32 0
  store i1 true, i1* %24, align 1
  ret void

"main$0_return_from_recursive_function$1":        ; preds = %"main$0_exiting$1"
  %25 = getelementptr %0, %0* @"main$0_return_value_struct", i32 0, i32 0
  store i8 3, i8* %25, align 1
  %26 = getelementptr %1, %1* @"main$0_recursion_state_struct", i32 0, i32 0
  store i1 true, i1* %26, align 1
  ret void

"main$0_return_from_recursive_function$2":        ; preds = %"main$0_exiting$2"
  %27 = getelementptr %0, %0* @"main$0_return_value_struct", i32 0, i32 0
  store i8 2, i8* %27, align 1
  %28 = getelementptr %1, %1* @"main$0_recursion_state_struct", i32 0, i32 0
  store i1 true, i1* %28, align 1
  ret void

"main$0_return_from_recursive_function$3":        ; preds = %"main$0_exiting$3"
  %29 = getelementptr %0, %0* @"main$0_return_value_struct", i32 0, i32 0
  store i8 0, i8* %29, align 1
  %30 = getelementptr %1, %1* @"main$0_recursion_state_struct", i32 0, i32 0
  store i1 true, i1* %30, align 1
  ret void

"main$0_return_from_recursive_function$4":        ; preds = %"main$0_exiting$4"
  %31 = getelementptr %0, %0* @"main$0_return_value_struct", i32 0, i32 0
  store i8 1, i8* %31, align 1
  %32 = getelementptr %1, %1* @"main$0_recursion_state_struct", i32 0, i32 0
