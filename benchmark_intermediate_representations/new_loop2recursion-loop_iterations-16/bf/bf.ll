; ModuleID = './benchmark_intermediate_representations/new_loop2recursion-loop_iterations-16/bf/bf.ll.temp'
...
@"main$0$0_return_value_struct" = dso_local global %1 zeroinitializer
...
"main$1_preheader_in_recursion":
  br label %"main$1_exiting$1"

"main$1_exiting$1":                               ; preds = %"main$1_increment_loop_counter$0", %"main$1_preheader_in_recursion"
  %loop_counter = phi i8 [ 0, %"main$1_preheader_in_recursion" ], [ %i6, %"main$1_increment_loop_counter$0" ]
  %by.0157 = phi i32 [ %arg1, %"main$1_preheader_in_recursion" ], [ %sub, %"main$1_increment_loop_counter$0" ]
  %i.0156 = phi i32 [ %arg2, %"main$1_preheader_in_recursion" ], [ %inc, %"main$1_increment_loop_counter$0" ]
  %cp.0155 = phi i8* [ %arg, %"main$1_preheader_in_recursion" ], [ %incdec.ptr, %"main$1_increment_loop_counter$0" ]
  %i = load i8, i8* %cp.0155, align 1, !tbaa !5
...
"main$1_latch$0":                                 ; preds = %if.then56, %if.end54
  ...
  br i1 %cmp23, label %"main$1_increment_loop_counter$0", label %"main$1_return_from_recursive_function$1"

"main$1_increment_loop_counter$0":                ; preds = %"main$1_latch$0"
  %i6 = add i8 %loop_counter, 1
  %i7 = icmp ult i8 %i6, 16
  br i1 %i7, label %"main$1_exiting$1", label %"main$1_increment_depth_counter"

"main$1_increment_depth_counter":                 ; preds = %"main$1_increment_loop_counter$0"
  %sub.lcssa = phi i32 [ %sub, %"main$1_increment_loop_counter$0" ]
  %inc.lcssa = phi i32 [ %inc, %"main$1_increment_loop_counter$0" ]
  %incdec.ptr.lcssa1 = phi i8* [ %incdec.ptr, %"main$1_increment_loop_counter$0" ]
  br label %"main$1_recursively_call_function"

"main$1_recursively_call_function":               ; preds = %"main$1_increment_depth_counter"
  call void @"main$1"(i8* %incdec.ptr.lcssa1, i32 %sub.lcssa, i32 %inc.lcssa)
  ret void

"main$1_return_from_recursive_function$0":        ; preds = %"main$1_exiting$2"
  %i8 = getelementptr %0, %0* @"main$1_return_value_struct", i32 0, i32 1
  store i8 1, i8* %i8, align 1
  ret void

"main$1_return_from_recursive_function$1":        ; preds = %"main$1_latch$0", %"main$1_exiting$1"
  %i9 = phi i8* [ %cp.0155, %"main$1_exiting$1" ], [ %incdec.ptr, %"main$1_latch$0" ]
  %i10 = getelementptr %0, %0* @"main$1_return_value_struct", i32 0, i32 0
  store i8* %i9, i8** %i10, align 8
  %i11 = getelementptr %0, %0* @"main$1_return_value_struct", i32 0, i32 1
  store i8 2, i8* %i11, align 1
  ret void
}
...
"main$0_header":                                  ; preds = %"main$0_increment_loop_counter$0", %"main$0_preheader_in_recursion"
  %loop_counter = phi i8 [ 0, %"main$0_preheader_in_recursion" ], [ %i17, %"main$0_increment_loop_counter$0" ]
...
"main$0$0_initialize_context":                    ; preds = %while.body91.preheader
...
"main$0$0_extract_return_values$0":               ; preds = %"main$0$0_call_recursive_function"
  %i7 = getelementptr %1, %1* @"main$0$0_return_value_struct", i32 0, i32 0
  %i8 = load i64, i64* %i7, align 8
  br label %while.end97

while.end97:                                      ; preds = %"main$0$0_extract_return_values$0"
...
for.body.preheader:                               ; preds = %while.end97
  br label %"main$0$0_initialize_context1"

"main$0$0_initialize_context1":                   ; preds = %for.body.preheader
  store i32 %i9, i32* @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$11", align 4
  br label %"main$0$0_call_recursive_function2"

"main$0$0_call_recursive_function2":              ; preds = %"main$0$0_initialize_context1"
  call void @"main$0$0.1"(i64 0)
  br label %while.cond80.loopexit.loopexit

while.cond80.loopexit.loopexit:                   ; preds = %"main$0$0_call_recursive_function2"
  br label %"main$0_latch$0"
...
"main$0_latch$0":                                 ; preds = %while.cond80.loopexit.loopexit, %while.end97, %while.end97.thread
  ...
  br i1 %lnot, label %"main$0_increment_loop_counter$0", label %"main$0_return_from_recursive_function$0", !llvm.loop !6

"main$0_increment_loop_counter$0":                ; preds = %"main$0_latch$0"
  %i17 = add i8 %loop_counter, 1
  %i18 = icmp ult i8 %i17, 16
  br i1 %i18, label %"main$0_header", label %"main$0_increment_depth_counter"
...
"main$0$0_latch$0":                               ; preds = %"main$0$0_increment_loop_counter$0", %"main$0$0_preheader_in_recursion"
  ...
  %indvars.iv = phi i64 [ %indvars.iv.next, %"main$0$0_increment_loop_counter$0" ], [ %arg, %"main$0$0_preheader_in_recursion" ]
  %i = load %struct._IO_FILE*, %struct._IO_FILE** @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$5", align 8
  ...
  %arrayidx96 = getelementptr inbounds [40 x i8], [40 x i8]* %i1, i64 0, i64 %indvars.iv
  ...
  br i1 %i3, label %"main$0$0_increment_loop_counter$0", label %"main$0$0_return_from_recursive_function$0"
...
"main$0$0_increment_depth_counter":               ; preds = %"main$0$0_increment_loop_counter$0"
  %indvars.iv.next.lcssa1 = phi i64 [ %indvars.iv.next, %"main$0$0_increment_loop_counter$0" ]
  br label %"main$0$0_recursively_call_function"

"main$0$0_recursively_call_function":             ; preds = %"main$0$0_increment_depth_counter"
  call void @"main$0$0"(i64 %indvars.iv.next.lcssa1)
  ret void

"main$0$0_return_from_recursive_function$0":      ; preds = %"main$0$0_latch$0"
  %indvars.iv.next.lcssa = phi i64 [ %indvars.iv.next, %"main$0$0_latch$0" ]
  %i6 = getelementptr %1, %1* @"main$0$0_return_value_struct", i32 0, i32 0
  store i64 %indvars.iv.next.lcssa, i64* %i6, align 8
  ret void
}

define void @"main$0$0.1"(i64 %arg) {
"main$0$0_preheader_in_recursion":
  br label %"main$0$0_latch$0"

"main$0$0_latch$0":                               ; preds = %"main$0$0_increment_loop_counter$0", %"main$0$0_preheader_in_recursion"
  %loop_counter = phi i8 [ 0, %"main$0$0_preheader_in_recursion" ], [ %i4, %"main$0$0_increment_loop_counter$0" ]
  %indvars.iv158 = phi i64 [ %indvars.iv.next159, %"main$0$0_increment_loop_counter$0" ], [ %arg, %"main$0$0_preheader_in_recursion" ]
  %i = load [40 x i8]*, [40 x i8]** @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$1", align 8
  %arrayidx105 = getelementptr inbounds [40 x i8], [40 x i8]* %i, i64 0, i64 %indvars.iv158
  ...
  br i1 %exitcond, label %"main$0$0_return_from_recursive_function$0", label %"main$0$0_increment_loop_counter$0"
...
"main$0$0_increment_depth_counter":               ; preds = %"main$0$0_increment_loop_counter$0"
  %indvars.iv.next159.lcssa1 = phi i64 [ %indvars.iv.next159, %"main$0$0_increment_loop_counter$0" ]
  br label %"main$0$0_recursively_call_function"

"main$0$0_recursively_call_function":             ; preds = %"main$0$0_increment_depth_counter"
  call void @"main$0$0.1"(i64 %indvars.iv.next159.lcssa1)
  ret void
