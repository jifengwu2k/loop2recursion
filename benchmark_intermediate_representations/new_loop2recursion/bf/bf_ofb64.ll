; ModuleID = './benchmark_intermediate_representations/new_loop2recursion/bf/bf_ofb64.ll.temp'
...
"BF_ofb64_encrypt$0_initialize_context":          ; preds = %while.body.preheader
  ...
  store i8* %i1, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_ofb64.ll_invariant_variable$5", align 8
...
if.then:                                          ; preds = %"BF_ofb64_encrypt$0_header"
  ...
  %i5 = load i64*, i64** @"./benchmark_intermediate_representations/baseline/bf/bf_ofb64.ll_invariant_variable$7", align 8
  call void @BF_encrypt(i64* %i5, %struct.bf_key_st* %i, i32 1) #3
  %i6 = load i64*, i64** @"./benchmark_intermediate_representations/baseline/bf/bf_ofb64.ll_invariant_variable$7", align 8
  %i7 = load i64, i64* %i6, align 16, !tbaa !6
  %shr58 = lshr i64 %i7, 24
  %conv60 = trunc i64 %shr58 to i8
  %i8 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_ofb64.ll_invariant_variable$5", align 8
  store i8 %conv60, i8* %i8, align 1, !tbaa !5
  %shr62 = lshr i64 %i7, 16
  %conv64 = trunc i64 %shr62 to i8
  %i9 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_ofb64.ll_invariant_variable$9", align 8
  ...
  %i11 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_ofb64.ll_invariant_variable$8", align 8
  ...
  %i15 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_ofb64.ll_invariant_variable$6", align 8
  ...
  %i17 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_ofb64.ll_invariant_variable$10", align 8
...
"BF_ofb64_encrypt$0_latch$0":                     ; preds = %if.then, %"BF_ofb64_encrypt$0_header"
  ...
  %i18 = load i8, i8* %arg1, align 1, !tbaa !5
...
"BF_ofb64_encrypt$0_recursively_call_function":   ; preds = %"BF_ofb64_encrypt$0_increment_depth_counter"
  call void @"BF_ofb64_encrypt$0"(i8* %incdec.ptr94, i8* %incdec.ptr89, i32 %and95, i64 %dec213, i32 %save.1)
  ret void

"BF_ofb64_encrypt$0_return_from_recursive_function$0": ; preds = %"BF_ofb64_encrypt$0_latch$0"
  %i21 = getelementptr %0, %0* @"BF_ofb64_encrypt$0_return_value_struct", i32 0, i32 0
  store i32 %save.1, i32* %i21, align 4
  %i22 = getelementptr %0, %0* @"BF_ofb64_encrypt$0_return_value_struct", i32 0, i32 1
