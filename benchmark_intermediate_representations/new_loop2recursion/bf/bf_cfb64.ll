; ModuleID = './benchmark_intermediate_representations/new_loop2recursion/bf/bf_cfb64.ll.temp'
...
if.then2:                                         ; preds = %"BF_cfb64_encrypt$1_header"
  %i = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$10", align 8
  %i4 = load i8, i8* %i, align 1, !tbaa !5
  %i5 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$6", align 8
  %i6 = load i8, i8* %i5, align 1, !tbaa !5
  %i7 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$8", align 8
  %i8 = load i8, i8* %i7, align 1, !tbaa !5
  %i9 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$7", align 8
  ...
  %i17 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$9", align 8
  ...
  %i24 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$5", align 8
  ...
  %i31 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$4", align 8
  ...
  %i37 = load <2 x i64>*, <2 x i64>** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$3", align 8
  store <2 x i64> %i36, <2 x i64>* %i37, align 16, !tbaa !6
  %i38 = load %struct.bf_key_st*, %struct.bf_key_st** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$1", align 8
  %i39 = load i64*, i64** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$2", align 8
  ...
  %i42 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$10", align 8
  ...
  %i44 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$8", align 8
  ...
  %i49 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$9", align 8
  store i8 %conv49, i8* %i49, align 1, !tbaa !5
  %shr51 = lshr i64 %i47, 8
  %conv53 = trunc i64 %shr51 to i8
  %i50 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$5", align 8
...
"BF_cfb64_encrypt$1_latch$0":                     ; preds = %if.then2, %"BF_cfb64_encrypt$1_header"
  ...
  %i52 = load i8, i8* %arg1, align 1, !tbaa !5
  %idxprom = sext i32 %arg3 to i64
  %i53 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$10", align 8
...
"BF_cfb64_encrypt$1_recursively_call_function":   ; preds = %"BF_cfb64_encrypt$1_increment_depth_counter"
  call void @"BF_cfb64_encrypt$1"(i8* %incdec.ptr63, i8* %incdec.ptr58, i64 %dec, i32 %and66)
  ret void

"BF_cfb64_encrypt$1_return_from_recursive_function$0": ; preds = %"BF_cfb64_encrypt$1_latch$0"
  %i55 = getelementptr %0, %0* @"BF_cfb64_encrypt$1_return_value_struct", i32 0, i32 0
...
if.then73:                                        ; preds = %"BF_cfb64_encrypt$0_header"
  ...
  %i6 = load i8, i8* %i5, align 1, !tbaa !5
  %i7 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$18", align 8
  %i8 = load i8, i8* %i7, align 1, !tbaa !5
  %i9 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$17", align 8
  %i10 = load i8, i8* %i9, align 1, !tbaa !5
  ...
  %i22 = shl nuw nsw <2 x i64> %i21, <i64 16, i64 16>
  %i23 = or <2 x i64> %i22, %i16
  %i24 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$16", align 8
  %i25 = load i8, i8* %i24, align 1, !tbaa !5
  %i26 = insertelement <2 x i8> undef, i8 %i8, i32 0
  %i27 = insertelement <2 x i8> %i26, i8 %i25, i32 1
  %i28 = zext <2 x i8> %i27 to <2 x i64>
  %i29 = shl nuw nsw <2 x i64> %i28, <i64 8, i64 8>
  %i30 = or <2 x i64> %i23, %i29
  %i31 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$13", align 8
  %i32 = load i8, i8* %i31, align 1, !tbaa !5
  %i33 = insertelement <2 x i8> undef, i8 %i10, i32 0
  %i34 = insertelement <2 x i8> %i33, i8 %i32, i32 1
  %i35 = zext <2 x i8> %i34 to <2 x i64>
  ...
  %i44 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$18", align 8
  ...
  %i46 = load i64*, i64** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$12", align 8
  %i47 = load i64, i64* %i46, align 8, !tbaa !6
  ...
  %i50 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$16", align 8
...
"BF_cfb64_encrypt$0_latch$0":                     ; preds = %if.then73, %"BF_cfb64_encrypt$0_header"
  ...
  %i52 = load i8, i8* %arg, align 1, !tbaa !5
...
"BF_cfb64_encrypt$0_recursively_call_function":   ; preds = %"BF_cfb64_encrypt$0_increment_depth_counter"
  call void @"BF_cfb64_encrypt$0"(i8* %incdec.ptr138, i64 %dec68, i8* %incdec.ptr147, i32 %and149)
  ret void

"BF_cfb64_encrypt$0_return_from_recursive_function$0": ; preds = %"BF_cfb64_encrypt$0_latch$0"
  %i55 = getelementptr %1, %1* @"BF_cfb64_encrypt$0_return_value_struct", i32 0, i32 0
