; ModuleID = './benchmark_intermediate_representations/new_loop2recursion/bf/bf_skey.ll.temp'
...
"BF_set_key$1_exiting$0":
  ...
  %i3 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_skey.ll_invariant_variable$1", align 8
  %cmp2 = icmp ult i8* %incdec.ptr, %i3
  %i4 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_skey.ll_invariant_variable$2", align 8
  %incdec.ptr.data = select i1 %cmp2, i8* %incdec.ptr, i8* %i4
  %shl = shl nuw nsw i64 %conv, 8
  %incdec.ptr6 = getelementptr inbounds i8, i8* %incdec.ptr.data, i64 1
  %i5 = load i8, i8* %incdec.ptr.data, align 1, !tbaa !5
  %conv7 = zext i8 %i5 to i64
  %or = or i64 %shl, %conv7
  %i6 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_skey.ll_invariant_variable$1", align 8
  %cmp8 = icmp ult i8* %incdec.ptr6, %i6
  %i7 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_skey.ll_invariant_variable$2", align 8
  %d.2 = select i1 %cmp8, i8* %incdec.ptr6, i8* %i7
  %shl12 = shl nuw nsw i64 %or, 8
  %incdec.ptr13 = getelementptr inbounds i8, i8* %d.2, i64 1
  %i8 = load i8, i8* %d.2, align 1, !tbaa !5
  %conv14 = zext i8 %i8 to i64
  %or15 = or i64 %shl12, %conv14
  %i9 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_skey.ll_invariant_variable$1", align 8
  %cmp16 = icmp ult i8* %incdec.ptr13, %i9
  %i10 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_skey.ll_invariant_variable$2", align 8
  %incdec.ptr13.data = select i1 %cmp16, i8* %incdec.ptr13, i8* %i10
  %shl20 = shl nuw nsw i64 %or15, 8
  %incdec.ptr21 = getelementptr inbounds i8, i8* %incdec.ptr13.data, i64 1
  %i11 = load i8, i8* %incdec.ptr13.data, align 1, !tbaa !5
  %conv22 = zext i8 %i11 to i64
  %or23 = or i64 %shl20, %conv22
  %i12 = load %struct.bf_key_st*, %struct.bf_key_st** @"./benchmark_intermediate_representations/baseline/bf/bf_skey.ll_invariant_variable$0", align 8
  %arrayidx29 = getelementptr inbounds %struct.bf_key_st, %struct.bf_key_st* %i12, i64 0, i32 0, i64 %arg2
...
"BF_set_key$1_latch$0":                           ; preds = %"BF_set_key$1_exiting$0"
  %i13 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_skey.ll_invariant_variable$1", align 8
  %cmp24 = icmp ult i8* %incdec.ptr21, %i13
  %i14 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_skey.ll_invariant_variable$2", align 8
  %d.4 = select i1 %cmp24, i8* %incdec.ptr21, i8* %i14
  %i15 = load %struct.bf_key_st*, %struct.bf_key_st** @"./benchmark_intermediate_representations/baseline/bf/bf_skey.ll_invariant_variable$0", align 8
  %arrayidx29.phi.trans.insert = getelementptr inbounds %struct.bf_key_st, %struct.bf_key_st* %i15, i64 0, i32 0, i64 %indvars.iv.next116
...
"BF_set_key$1_recursively_call_function":         ; preds = %"BF_set_key$1_increment_depth_counter"
  call void @"BF_set_key$1"(i8* %d.4, i64 %.pre, i64 %indvars.iv.next116)
  ret void
...
"BF_set_key$0_latch$0":
  ...
  %arrayidx54 = getelementptr inbounds %struct.bf_key_st, %struct.bf_key_st* %i2, i64 0, i32 1, i64 %arg
