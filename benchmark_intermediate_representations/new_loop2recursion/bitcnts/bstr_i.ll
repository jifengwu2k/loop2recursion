; ModuleID = './benchmark_intermediate_representations/new_loop2recursion/bitcnts/bstr_i.ll.temp'
...
"bstr_i$0_recursively_call_function":             ; preds = %"bstr_i$0_increment_depth_counter"
  call void @"bstr_i$0"(i32 %or, i8 %i5, i8* %incdec.ptr)
  ret void

"bstr_i$0_return_from_recursive_function$0":      ; preds = %"bstr_i$0_latch$0", %"bstr_i$0_exiting$1"
  %i6 = phi i32 [ %or, %"bstr_i$0_latch$0" ], [ %arg, %"bstr_i$0_exiting$1" ]
  %i7 = getelementptr %0, %0* @"bstr_i$0_return_value_struct", i32 0, i32 0
