; ModuleID = './benchmark_intermediate_representations/new_loop2recursion/bitcnts/bitstrng.ll.temp'
...
"bitstring$0_return_from_recursive_function$0":   ; preds = %"bitstring$0_latch$0"
  %i3 = getelementptr %0, %0* @"bitstring$0_return_value_struct", i32 0, i32 0
  store i8* %str.addr.1.be, i8** %i3, align 8
  ret void
}
