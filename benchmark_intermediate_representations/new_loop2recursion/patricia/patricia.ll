; ModuleID = './benchmark_intermediate_representations/new_loop2recursion/patricia/patricia.ll.temp'
...
"pat_insert$3_latch$0":
  ...
  %i2 = load i8, i8* %p_b9, align 1, !tbaa !10
  %cmp = icmp slt i8 %arg1, %i2
...
"pat_insert$3_recursively_call_function":         ; preds = %"pat_insert$3_increment_depth_counter"
  call void @"pat_insert$3"(%struct.ptree* %cond, i8 %i2)
  ret void

"pat_insert$3_return_from_recursive_function$0":  ; preds = %"pat_insert$3_latch$0"
  %i3 = getelementptr %0, %0* @"pat_insert$3_return_value_struct", i32 0, i32 0
  store %struct.ptree* %cond, %struct.ptree** %i3, align 8
  ret void
}
...
"pat_insert$1_return_from_recursive_function$0":  ; preds = %"pat_insert$1_latch$0"
  %i4 = getelementptr %1, %1* @"pat_insert$1_return_value_struct", i32 0, i32 1
  store i8 1, i8* %i4, align 1
  ret void

"pat_insert$1_return_from_recursive_function$1":  ; preds = %"pat_insert$1_exiting$1"
  %i5 = getelementptr %1, %1* @"pat_insert$1_return_value_struct", i32 0, i32 0
  store i64 %arg, i64* %i5, align 8
...
"pat_insert$0_header":
  ...
  %i4 = load %struct.ptree_mask**, %struct.ptree_mask*** @"./benchmark_intermediate_representations/baseline/patricia/patricia.ll_invariant_variable$4", align 8
  %i5 = load %struct.ptree_mask*, %struct.ptree_mask** %i4, align 8, !tbaa !1
  %arrayidx48 = getelementptr inbounds %struct.ptree_mask, %struct.ptree_mask* %i5, i64 %idxprom46
  %pm_mask49 = getelementptr inbounds %struct.ptree_mask, %struct.ptree_mask* %arrayidx48, i64 0, i32 0
  %i6 = load i64, i64* %pm_mask49, align 8, !tbaa !7
  %cmp50 = icmp ugt i64 %i, %i6
  br i1 %cmp50, label %if.then52, label %if.else

if.else:                                          ; preds = %"pat_insert$0_header"
  %i7 = bitcast %struct.ptree_mask* %arg2 to i8*
  %i8 = bitcast %struct.ptree_mask* %arg to i8*
  tail call void @bcopy(i8* %i7, i8* %i8, i64 16) #4
  %i9 = load %struct.ptree_mask**, %struct.ptree_mask*** @"./benchmark_intermediate_representations/baseline/patricia/patricia.ll_invariant_variable$6", align 8
  %i10 = load %struct.ptree_mask*, %struct.ptree_mask** %i9, align 8, !tbaa !1
  %pm_mask57 = getelementptr inbounds %struct.ptree_mask, %struct.ptree_mask* %i10, i64 0, i32 0
  store i64 4294967295, i64* %pm_mask57, align 8, !tbaa !7
  br label %"pat_insert$0_exiting$0"

if.then52:                                        ; preds = %"pat_insert$0_header"
  %i11 = bitcast %struct.ptree_mask* %arrayidx48 to i8*
  %i12 = bitcast %struct.ptree_mask* %arg to i8*
  tail call void @bcopy(i8* %i11, i8* %i12, i64 16) #4
...
"pat_insert$0_exiting$0":                         ; preds = %if.then52, %if.else
  ...
  %i13 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/patricia/patricia.ll_invariant_variable$5", align 8
  %i14 = load i8, i8* %i13, align 8, !tbaa !11
  %conv40 = zext i8 %i14 to i32
...
"pat_insert$0_latch$0":                           ; preds = %"pat_insert$0_exiting$0"
  %i15 = load %struct.ptree_mask**, %struct.ptree_mask*** @"./benchmark_intermediate_representations/baseline/patricia/patricia.ll_invariant_variable$6", align 8
  %.pre200 = load %struct.ptree_mask*, %struct.ptree_mask** %i15, align 8, !tbaa !1
...
"pat_insert$0_recursively_call_function":         ; preds = %"pat_insert$0_increment_depth_counter"
  call void @"pat_insert$0"(%struct.ptree_mask* %incdec.ptr, i32 %i.2, %struct.ptree_mask* %.pre200, i32 %copied.1)
  ret void

"pat_insert$0_return_from_recursive_function$0":  ; preds = %"pat_insert$0_exiting$0"
  %i16 = getelementptr %2, %2* @"pat_insert$0_return_value_struct", i32 0, i32 0
  store i32 %copied.1, i32* %i16, align 4
  %i17 = getelementptr %2, %2* @"pat_insert$0_return_value_struct", i32 0, i32 1
...
"pat_insert$2_return_from_recursive_function$0":  ; preds = %"pat_insert$2_latch$0", %"pat_insert$2_exiting$1"
  %i2 = phi i32 [ %inc82, %"pat_insert$2_latch$0" ], [ %arg, %"pat_insert$2_exiting$1" ]
  %i3 = getelementptr %3, %3* @"pat_insert$2_return_value_struct", i32 0, i32 0
  store i32 %i2, i32* %i3, align 4
  ret void
}
...
"pat_search$0_latch$0":
  ...
  %i3 = load %struct.ptree_mask*, %struct.ptree_mask** %p_m, align 8, !tbaa !1
  %pm_mask = getelementptr inbounds %struct.ptree_mask, %struct.ptree_mask* %i3, i64 0, i32 0
  %i4 = load i64, i64* %pm_mask, align 8, !tbaa !7
  %i5 = load i64, i64* @"./benchmark_intermediate_representations/baseline/patricia/patricia.ll_invariant_variable$8", align 8
  %and = and i64 %i4, %i5
...
"pat_search$0_recursively_call_function":         ; preds = %"pat_search$0_increment_depth_counter"
  call void @"pat_search$0"(%struct.ptree* %cond, i8 %i7, %struct.ptree* %t.0.p.0)
  ret void

"pat_search$0_return_from_recursive_function$0":  ; preds = %"pat_search$0_latch$0"
  %i8 = getelementptr %4, %4* @"pat_search$0_return_value_struct", i32 0, i32 0
  store %struct.ptree* %t.0.p.0, %struct.ptree** %i8, align 8
  %i9 = getelementptr %4, %4* @"pat_search$0_return_value_struct", i32 0, i32 1
