; ModuleID = './benchmark_intermediate_representations/new_loop2recursion/fft/fftmisc.ll.temp'
...
"NumberOfBitsNeeded$0_return_from_recursive_function$0": ; preds = %"NumberOfBitsNeeded$0_latch$0"
  %i1 = getelementptr %0, %0* @"NumberOfBitsNeeded$0_return_value_struct", i32 0, i32 0
...
"ReverseBits$1_recursively_call_function":        ; preds = %"ReverseBits$1_increment_depth_counter"
  call void @"ReverseBits$1"(i32 %shr.prol, i32 %or.prol, i32 %prol.iter.sub, i32 %inc.prol)
  ret void

"ReverseBits$1_return_from_recursive_function$0": ; preds = %"ReverseBits$1_latch$0"
  %i = getelementptr %1, %1* @"ReverseBits$1_return_value_struct", i32 0, i32 0
  store i32 %or.prol, i32* %i, align 4
  %i4 = getelementptr %1, %1* @"ReverseBits$1_return_value_struct", i32 0, i32 1
  store i32 %inc.prol, i32* %i4, align 4
  %i5 = getelementptr %1, %1* @"ReverseBits$1_return_value_struct", i32 0, i32 2
  store i32 %shr.prol, i32* %i5, align 4
  ret void
}
...
"ReverseBits$0_recursively_call_function":        ; preds = %"ReverseBits$0_increment_depth_counter"
  call void @"ReverseBits$0"(i32 %shr.3, i32 %or.3, i32 %inc.3)
  ret void

"ReverseBits$0_return_from_recursive_function$0": ; preds = %"ReverseBits$0_latch$0"
  %i3 = getelementptr %2, %2* @"ReverseBits$0_return_value_struct", i32 0, i32 0
  store i32 %or.3, i32* %i3, align 4
  ret void
}
