; ModuleID = './benchmark_intermediate_representations/new_loop2recursion/fft/main.ll.temp'
...
"main$3_latch$0":
  ...
  %arrayidx37 = getelementptr inbounds float, float* %i1, i64 %arg
...
for.body47.lr.ph:                                 ; preds = %"main$2_header"
  ...
  %arrayidx84 = getelementptr inbounds float, float* %i3, i64 %arg
...
"main$2$0_header":
  ...
  %arrayidx56 = getelementptr inbounds float, float* %i2, i64 %arg
