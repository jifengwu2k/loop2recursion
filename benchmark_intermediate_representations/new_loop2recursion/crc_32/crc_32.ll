; ModuleID = './benchmark_intermediate_representations/new_loop2recursion/crc_32/crc_32.ll.temp'
...
"crc32file$0_return_from_recursive_function$0":   ; preds = %"crc32file$0_latch$0"
  %i6 = getelementptr %0, %0* @"crc32file$0_return_value_struct", i32 0, i32 0
...
"crc32buf$0_recursively_call_function":           ; preds = %"crc32buf$0_increment_depth_counter"
  call void @"crc32buf$0"(i8* %incdec.ptr.1, i64 %xor1.1, i64 %dec.1)
  ret void

"crc32buf$0_return_from_recursive_function$0":    ; preds = %"crc32buf$0_latch$0"
  %i6 = getelementptr %1, %1* @"crc32buf$0_return_value_struct", i32 0, i32 0
  store i64 %xor1.1, i64* %i6, align 8
  ret void
}
...
"main$0_recursively_call_function":               ; preds = %"main$0_increment_depth_counter"
  call void @"main$0"(i32 %dec, i32 %or, i8** %incdec.ptr)
  ret void

"main$0_return_from_recursive_function$0":        ; preds = %"main$0_latch$0"
  %i10 = getelementptr %2, %2* @"main$0_return_value_struct", i32 0, i32 0
  store i32 %or, i32* %i10, align 4
  ret void
}
