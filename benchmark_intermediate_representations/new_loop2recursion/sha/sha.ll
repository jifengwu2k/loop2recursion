; ModuleID = './benchmark_intermediate_representations/new_loop2recursion/sha/sha.ll.temp'
...
"sha_transform$4_latch$0":
  ...
  %arrayidx20 = getelementptr inbounds [80 x i64], [80 x i64]* %i12, i64 0, i64 %arg
  store i64 %xor18, i64* %arrayidx20, align 16, !tbaa !1
  %indvars.iv.next253 = or i64 %arg, 1
  %i13 = add nsw i64 %arg, -2
...
"sha_transform$3_recursively_call_function":      ; preds = %"sha_transform$3_increment_depth_counter"
  call void @"sha_transform$3"(i64 %add42, i64 %arg, i64 %or45, i64 %arg2, i64 %indvars.iv.next250, i64 %arg3)
  ret void

"sha_transform$3_return_from_recursive_function$0": ; preds = %"sha_transform$3_latch$0"
  %i7 = getelementptr %0, %0* @"sha_transform$3_return_value_struct", i32 0, i32 0
  store i64 %arg3, i64* %i7, align 8
  %i8 = getelementptr %0, %0* @"sha_transform$3_return_value_struct", i32 0, i32 1
  store i64 %arg2, i64* %i8, align 8
  %i9 = getelementptr %0, %0* @"sha_transform$3_return_value_struct", i32 0, i32 2
  store i64 %arg, i64* %i9, align 8
  %i10 = getelementptr %0, %0* @"sha_transform$3_return_value_struct", i32 0, i32 3
  store i64 %or45, i64* %i10, align 8
  %i11 = getelementptr %0, %0* @"sha_transform$3_return_value_struct", i32 0, i32 4
  store i64 %add42, i64* %i11, align 8
  ret void
}
...
"sha_transform$2_recursively_call_function":      ; preds = %"sha_transform$2_increment_depth_counter"
  call void @"sha_transform$2"(i64 %add62, i64 %arg, i64 %or65, i64 %arg2, i64 %indvars.iv.next247, i64 %arg3)
  ret void

"sha_transform$2_return_from_recursive_function$0": ; preds = %"sha_transform$2_latch$0"
  %i7 = getelementptr %1, %1* @"sha_transform$2_return_value_struct", i32 0, i32 0
  store i64 %arg3, i64* %i7, align 8
  %i8 = getelementptr %1, %1* @"sha_transform$2_return_value_struct", i32 0, i32 1
  store i64 %arg2, i64* %i8, align 8
  %i9 = getelementptr %1, %1* @"sha_transform$2_return_value_struct", i32 0, i32 2
  store i64 %arg, i64* %i9, align 8
  %i10 = getelementptr %1, %1* @"sha_transform$2_return_value_struct", i32 0, i32 3
  store i64 %or65, i64* %i10, align 8
  %i11 = getelementptr %1, %1* @"sha_transform$2_return_value_struct", i32 0, i32 4
  store i64 %add62, i64* %i11, align 8
  ret void
}
...
"sha_transform$1_recursively_call_function":      ; preds = %"sha_transform$1_increment_depth_counter"
  call void @"sha_transform$1"(i64 %add85, i64 %arg, i64 %or88, i64 %arg2, i64 %indvars.iv.next244, i64 %arg3)
  ret void

"sha_transform$1_return_from_recursive_function$0": ; preds = %"sha_transform$1_latch$0"
  %i7 = getelementptr %2, %2* @"sha_transform$1_return_value_struct", i32 0, i32 0
  store i64 %arg3, i64* %i7, align 8
  %i8 = getelementptr %2, %2* @"sha_transform$1_return_value_struct", i32 0, i32 1
  store i64 %arg2, i64* %i8, align 8
  %i9 = getelementptr %2, %2* @"sha_transform$1_return_value_struct", i32 0, i32 2
  store i64 %arg, i64* %i9, align 8
  %i10 = getelementptr %2, %2* @"sha_transform$1_return_value_struct", i32 0, i32 3
  store i64 %or88, i64* %i10, align 8
  %i11 = getelementptr %2, %2* @"sha_transform$1_return_value_struct", i32 0, i32 4
  store i64 %add85, i64* %i11, align 8
  ret void
}
...
"sha_transform$0_recursively_call_function":      ; preds = %"sha_transform$0_increment_depth_counter"
  call void @"sha_transform$0"(i64 %add105, i64 %arg, i64 %arg3, i64 %or108, i64 %indvars.iv.next, i64 %arg2)
  ret void

"sha_transform$0_return_from_recursive_function$0": ; preds = %"sha_transform$0_latch$0"
  %i7 = getelementptr %3, %3* @"sha_transform$0_return_value_struct", i32 0, i32 0
  store i64 %arg2, i64* %i7, align 8
  %i8 = getelementptr %3, %3* @"sha_transform$0_return_value_struct", i32 0, i32 1
  store i64 %arg3, i64* %i8, align 8
  %i9 = getelementptr %3, %3* @"sha_transform$0_return_value_struct", i32 0, i32 2
  store i64 %arg, i64* %i9, align 8
  %i10 = getelementptr %3, %3* @"sha_transform$0_return_value_struct", i32 0, i32 3
  store i64 %or108, i64* %i10, align 8
  %i11 = getelementptr %3, %3* @"sha_transform$0_return_value_struct", i32 0, i32 4
  store i64 %add105, i64* %i11, align 8
  ret void
}
...
"sha_stream$0_latch$0":
  ...
  call void @sha_update(%struct.SHA_INFO* %i, i8* %i1, i32 %arg)
