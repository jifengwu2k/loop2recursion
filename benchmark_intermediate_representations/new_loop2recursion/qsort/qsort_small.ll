; ModuleID = './benchmark_intermediate_representations/new_loop2recursion/qsort/qsort_small.ll.temp'
...
"main$1_latch$0":
  ...
  br i1 %i2, label %"main$1_increment_depth_counter", label %"main$1_return_from_recursive_function$0"
...
"main$1_return_from_recursive_function$0":        ; preds = %"main$1_latch$0"
  %i3 = getelementptr %0, %0* @"main$1_return_value_struct", i32 0, i32 0
  store i64 %arg, i64* %i3, align 8
  ret void
}
