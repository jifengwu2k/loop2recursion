; ModuleID = './benchmark_intermediate_representations/new_loop2recursion/dijkstra/dijkstra_small.ll.temp'
...
"enqueue$0_return_from_recursive_function$0":     ; preds = %"enqueue$0_latch$0"
  %i1 = getelementptr %0, %0* @"enqueue$0_return_value_struct", i32 0, i32 0
  store %struct._QITEM** %qNext7, %struct._QITEM*** %i1, align 8
  ret void
}
...
"dijkstra$1_return_from_recursive_function$0":    ; preds = %"dijkstra$1_latch$0"
  %i1 = getelementptr %1, %1* @"dijkstra$1_return_value_struct", i32 0, i32 0
  store %struct._QITEM** %qNext7.i, %struct._QITEM*** %i1, align 8
  ret void
}
...
"dijkstra$0$0_call_recursive_function":           ; preds = %"dijkstra$0$0_initialize_context"
  call void @"dijkstra$0$0"(i32 0, i32 %i7)
  br label %"dijkstra$0$0_branch_to_exit"

"dijkstra$0$0_branch_to_exit":                    ; preds = %"dijkstra$0$0_call_recursive_function"
  %i8 = getelementptr %3, %3* @"dijkstra$0$0_return_value_struct", i32 0, i32 1
  %i9 = load i8, i8* %i8, align 1
  switch i8 %i9, label %"dijkstra$0$0_extract_return_values$0" [
...
"dijkstra$0$0_extract_return_values$0":           ; preds = %"dijkstra$0$0_branch_to_exit", %"dijkstra$0$0_branch_to_exit"
  %i10 = getelementptr %3, %3* @"dijkstra$0$0_return_value_struct", i32 0, i32 0
...
"dijkstra$0$0_header":
  ...
  %i2 = load i32, i32* %arrayidx18, align 4, !tbaa !13
  store i32 %i2, i32* @iCost, align 4, !tbaa !13
  %cmp19 = icmp eq i32 %i2, 9999
...
if.then20:                                        ; preds = %"dijkstra$0$0_header"
  ...
  %i3 = load i32, i32* %iDist23, align 8, !tbaa !14
  %cmp24 = icmp eq i32 %i3, 9999
  %.pre81 = load i32, i32* @iDist, align 4, !tbaa !13
  %add = add nsw i32 %.pre81, %i2
  %cmp28 = icmp sgt i32 %i3, %add
...
"dijkstra$0$0_exiting$1":                         ; preds = %if.then20
  ...
  %i4 = load i32, i32* @"./benchmark_intermediate_representations/baseline/dijkstra/dijkstra_small.ll_invariant_variable$2", align 4
  store i32 %i4, i32* %iPrev36, align 4, !tbaa !1
...
if.end.i68:                                       ; preds = %"dijkstra$0$0_exiting$1"
  ...
  %i6 = bitcast i8* %iDist3.i64 to i32*
  store i32 %add30, i32* %i6, align 4, !tbaa !10
  %iPrev4.i65 = getelementptr inbounds i8, i8* %call.i60, i64 8
  %i7 = bitcast i8* %iPrev4.i65 to i32*
  %i8 = load i32, i32* @"./benchmark_intermediate_representations/baseline/dijkstra/dijkstra_small.ll_invariant_variable$2", align 4
  store i32 %i8, i32* %i7, align 8, !tbaa !11
  ...
  %tobool5.i67 = icmp eq %struct._QITEM* %i5, null
...
"dijkstra$0$0$0_call_recursive_function":         ; preds = %"dijkstra$0$0$0_initialize_context"
  call void @"dijkstra$0$0$0"(%struct._QITEM* %i5)
...
"dijkstra$0$0$0_extract_return_values$0":         ; preds = %"dijkstra$0$0$0_call_recursive_function"
  %i10 = getelementptr %4, %4* @"dijkstra$0$0$0_return_value_struct", i32 0, i32 0
  %i11 = load %struct._QITEM**, %struct._QITEM*** %i10, align 8
  br label %while.end.i74

while.end.i74:                                    ; preds = %"dijkstra$0$0$0_extract_return_values$0"
  %i12 = bitcast %struct._QITEM** %i11 to i8**
  store i8* %call.i60, i8** %i12, align 8, !tbaa !12
...
"dijkstra$0$0_return_from_recursive_function$0":  ; preds = %"dijkstra$0$0_latch$0"
  %i13 = getelementptr %3, %3* @"dijkstra$0$0_return_value_struct", i32 0, i32 0
  store i32 %.pr, i32* %i13, align 4
  %i14 = getelementptr %3, %3* @"dijkstra$0$0_return_value_struct", i32 0, i32 1
  store i8 1, i8* %i14, align 1
  ret void

"dijkstra$0$0_return_from_recursive_function$1":  ; preds = %"dijkstra$0$0_exiting$1"
  %i15 = getelementptr %3, %3* @"dijkstra$0$0_return_value_struct", i32 0, i32 1
...
"main$1$0_latch$0":
  ...
  %arrayidx10 = getelementptr inbounds [100 x [100 x i32]], [100 x [100 x i32]]* @AdjMatrix, i64 0, i64 %i4, i64 %arg
...
"dijkstra$0$0$0_recursively_call_function":       ; preds = %"dijkstra$0$0$0_increment_depth_counter"
  call void @"dijkstra$0$0$0"(%struct._QITEM* %i)
  ret void

"dijkstra$0$0$0_return_from_recursive_function$0": ; preds = %"dijkstra$0$0$0_latch$0"
  %i1 = getelementptr %4, %4* @"dijkstra$0$0$0_return_value_struct", i32 0, i32 0
  store %struct._QITEM** %qNext7.i71, %struct._QITEM*** %i1, align 8
  ret void
}
