; ModuleID = './benchmark_intermediate_representations/new_loop2recursion/rawcaudio/adpcm.ll.temp'
...
"adpcm_coder$0_recursively_call_function":        ; preds = %"adpcm_coder$0_increment_depth_counter"
  call void @"adpcm_coder$0"(i32 %lnot.ext, i32 %..add44, i32 %outputbuffer.1, i32 %valpred.2, i16* %incdec.ptr, i32 %i13, i8* %outp.1, i32 %dec)
  ret void

"adpcm_coder$0_return_from_recursive_function$0": ; preds = %"adpcm_coder$0_latch$0"
  %i15 = getelementptr %0, %0* @"adpcm_coder$0_return_value_struct", i32 0, i32 0
  store i32 %valpred.2, i32* %i15, align 4
  %i16 = getelementptr %0, %0* @"adpcm_coder$0_return_value_struct", i32 0, i32 1
  store i1 %tobool55, i1* %i16, align 1
  %i17 = getelementptr %0, %0* @"adpcm_coder$0_return_value_struct", i32 0, i32 2
  store i32 %..add44, i32* %i17, align 4
  %i18 = getelementptr %0, %0* @"adpcm_coder$0_return_value_struct", i32 0, i32 3
  store i32 %outputbuffer.1, i32* %i18, align 4
  %i19 = getelementptr %0, %0* @"adpcm_coder$0_return_value_struct", i32 0, i32 4
  store i8* %outp.1, i8** %i19, align 8
  ret void
}
...
"adpcm_decoder$0_recursively_call_function":      ; preds = %"adpcm_decoder$0_increment_depth_counter"
  call void @"adpcm_decoder$0"(i8* %inp.1, i32 %dec, i32 %inputbuffer.1, i32 %lnot.ext, i32 %..add, i32 %valpred.2, i16* %incdec.ptr54, i32 %i11)
  ret void

"adpcm_decoder$0_return_from_recursive_function$0": ; preds = %"adpcm_decoder$0_latch$0"
  %i12 = getelementptr %1, %1* @"adpcm_decoder$0_return_value_struct", i32 0, i32 0
  store i32 %..add, i32* %i12, align 4
  %i13 = getelementptr %1, %1* @"adpcm_decoder$0_return_value_struct", i32 0, i32 1
  store i32 %valpred.2, i32* %i13, align 4
  ret void
}
