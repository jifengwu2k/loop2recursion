; ModuleID = './benchmark_intermediate_representations/new_loop2recursion/pbmsrch/bmhasrch.ll.temp'
...
"bmha_search$0$0_branch_to_exit":                 ; preds = %"bmha_search$0$0_call_recursive_function"
  %i8 = getelementptr %2, %2* @"bmha_search$0$0_return_value_struct", i32 0, i32 0
  %i9 = load i8, i8* %i8, align 1
  switch i8 %i9, label %"bmha_search$0_exiting$1" [
...
"bmha_search$0_exiting$1":                        ; preds = %"bmha_search$0$0_branch_to_exit", %"bmha_search$0$0_branch_to_exit"
  %i10 = load i32, i32* @"./benchmark_intermediate_representations/baseline/pbmsrch/bmhasrch.ll_invariant_variable$5", align 4
  %add33 = add nsw i32 %i10, %sub9
...
"bmha_search$0_return_from_recursive_function$0": ; preds = %"bmha_search$0$0_branch_to_exit"
  %i11 = getelementptr %0, %0* @"bmha_search$0_return_value_struct", i32 0, i32 0
  store i8* %add.ptr13, i8** %i11, align 8
  %i12 = getelementptr %0, %0* @"bmha_search$0_return_value_struct", i32 0, i32 1
...
"bmha_search$0_return_from_recursive_function$1": ; preds = %"bmha_search$0_exiting$1", %"bmha_search$0_exiting$0"
  %i13 = getelementptr %0, %0* @"bmha_search$0_return_value_struct", i32 0, i32 1
...
"bmha_init$1$0_return_from_recursive_function$0": ; preds = %"bmha_init$1$0_latch$0"
  %i6 = getelementptr %1, %1* @"bmha_init$1$0_return_value_struct", i32 0, i32 1
  store i64 %arg1, i64* %i6, align 8
  %i7 = getelementptr %1, %1* @"bmha_init$1$0_return_value_struct", i32 0, i32 2
  store i8 1, i8* %i7, align 1
  ret void

"bmha_init$1$0_return_from_recursive_function$1": ; preds = %"bmha_init$1$0_exiting$1"
  %i8 = getelementptr %1, %1* @"bmha_init$1$0_return_value_struct", i32 0, i32 0
...
"bmha_search$0$0_return_from_recursive_function$0": ; preds = %"bmha_search$0$0_latch$0"
  %i7 = getelementptr %2, %2* @"bmha_search$0$0_return_value_struct", i32 0, i32 0
  store i8 1, i8* %i7, align 1
  ret void
