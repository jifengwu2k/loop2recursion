; ModuleID = './benchmark_intermediate_representations/new_loop2recursion/pbmsrch/pbmsrch_small.ll.temp'
...
"init_search$2_latch$0":
  ...
  br i1 %i48, label %"init_search$2_return_from_recursive_function$0", label %"init_search$2_increment_depth_counter", !llvm.loop !7
...
"init_search$1_latch$0":
  ...
  %arrayidx5.prol = getelementptr inbounds i8, i8* %i2, i64 %arg1
...
"init_search$1_return_from_recursive_function$0": ; preds = %"init_search$1_latch$0"
  %i4 = getelementptr %0, %0* @"init_search$1_return_value_struct", i32 0, i32 0
  store i64 %inc8.prol, i64* %i4, align 8
  ret void
}
...
"init_search$0_latch$0":
  ...
  %arrayidx5 = getelementptr inbounds i8, i8* %i1, i64 %arg
...
"strsearch$0_exiting$1":                          ; preds = %if.then.loopexit, %while.end
  %pos.134 = phi i64 [ %arg, %while.end ], [ %i9, %if.then.loopexit ]
...
"strsearch$0_latch$0":                            ; preds = %"strsearch$0_exiting$1", %while.cond.backedge.loopexit, %while.end
  %pos.0.be = phi i64 [ %arg, %while.end ], [ %sub7, %"strsearch$0_exiting$1" ], [ %i7, %while.cond.backedge.loopexit ]
  %shift.0.be = phi i64 [ %arg1, %while.end ], [ 0, %"strsearch$0_exiting$1" ], [ %i5, %while.cond.backedge.loopexit ]
...
"strsearch$0_return_from_recursive_function$0":   ; preds = %"strsearch$0_latch$0", %"strsearch$0_exiting$1"
  ...
  %i16 = getelementptr %1, %1* @"strsearch$0_return_value_struct", i32 0, i32 0
...
"main$0$2_extract_return_values$0":               ; preds = %"main$0$2_call_recursive_function"
  %i2 = getelementptr %3, %3* @"main$0$2_return_value_struct", i32 0, i32 0
...
"main$0$0_branch_to_exit":                        ; preds = %"main$0$0_call_recursive_function"
  %i6 = getelementptr %4, %4* @"main$0$0_return_value_struct", i32 0, i32 1
  %i7 = load i8, i8* %i6, align 1
  switch i8 %i7, label %"main$0$0_extract_return_values$0" [
...
"main$0$0_extract_return_values$1":               ; preds = %"main$0$0_branch_to_exit"
  %i8 = getelementptr %4, %4* @"main$0$0_return_value_struct", i32 0, i32 0
...
"strsearch$0$0_return_from_recursive_function$0": ; preds = %"strsearch$0$0_latch$0"
  %i4 = getelementptr %2, %2* @"strsearch$0$0_return_value_struct", i32 0, i32 2
  store i64 %i2, i64* %i4, align 8
  %i5 = getelementptr %2, %2* @"strsearch$0$0_return_value_struct", i32 0, i32 1
  store i64 %add, i64* %i5, align 8
  %i6 = getelementptr %2, %2* @"strsearch$0$0_return_value_struct", i32 0, i32 3
  store i8 1, i8* %i6, align 1
  ret void

"strsearch$0$0_return_from_recursive_function$1": ; preds = %"strsearch$0$0_exiting$1"
  %i7 = getelementptr %2, %2* @"strsearch$0$0_return_value_struct", i32 0, i32 0
  store i64 %arg, i64* %i7, align 8
...
"main$0$3_latch$0":
  ...
  %index.next.7 = add nsw i64 %arg, 32
  %i48 = icmp eq i64 %index.next.7, 256
  br i1 %i48, label %"main$0$3_return_from_recursive_function$0", label %"main$0$3_increment_depth_counter", !llvm.loop !13
...
"main$0$2_latch$0":
  ...
  %arrayidx5.i.prol = getelementptr inbounds i8, i8* %i2, i64 %arg1
...
"main$0$2_return_from_recursive_function$0":      ; preds = %"main$0$2_latch$0"
  %i4 = getelementptr %3, %3* @"main$0$2_return_value_struct", i32 0, i32 0
  store i64 %inc8.i.prol, i64* %i4, align 8
  ret void
}
...
"main$0$1_latch$0":
  ...
  %arrayidx5.i = getelementptr inbounds i8, i8* %i1, i64 %arg
...
"main$0$0$0_branch_to_exit":                      ; preds = %"main$0$0$0_call_recursive_function"
  %i2 = getelementptr %5, %5* @"main$0$0$0_return_value_struct", i32 0, i32 3
  %i3 = load i8, i8* %i2, align 1
  switch i8 %i3, label %"main$0$0$0_extract_return_values$0" [
...
"main$0$0$0_extract_return_values$0":             ; preds = %"main$0$0$0_branch_to_exit", %"main$0$0$0_branch_to_exit"
  %i4 = getelementptr %5, %5* @"main$0$0$0_return_value_struct", i32 0, i32 2
  %i5 = load i64, i64* %i4, align 8
  %i6 = getelementptr %5, %5* @"main$0$0$0_return_value_struct", i32 0, i32 0
  %i7 = load i64, i64* %i6, align 8
  br label %while.cond.backedge.i.loopexit

"main$0$0$0_extract_return_values$1":             ; preds = %"main$0$0$0_branch_to_exit"
  %i8 = getelementptr %5, %5* @"main$0$0$0_return_value_struct", i32 0, i32 1
  %i9 = load i64, i64* %i8, align 8
...
"main$0$0_exiting$1":                             ; preds = %if.then.i.loopexit, %while.end.i
  %pos.134.i = phi i64 [ %arg, %while.end.i ], [ %i9, %if.then.i.loopexit ]
...
"main$0$0_latch$0":                               ; preds = %"main$0$0_exiting$1", %while.cond.backedge.i.loopexit, %while.end.i
  %pos.0.be.i = phi i64 [ %arg, %while.end.i ], [ %sub7.i, %"main$0$0_exiting$1" ], [ %i7, %while.cond.backedge.i.loopexit ]
  %shift.0.be.i = phi i64 [ %arg1, %while.end.i ], [ 0, %"main$0$0_exiting$1" ], [ %i5, %while.cond.backedge.i.loopexit ]
...
"main$0$0_return_from_recursive_function$0":      ; preds = %"main$0$0_latch$0"
  %i15 = getelementptr %4, %4* @"main$0$0_return_value_struct", i32 0, i32 1
  store i8 1, i8* %i15, align 1
  ret void

"main$0$0_return_from_recursive_function$1":      ; preds = %"main$0$0_exiting$1"
  %i16 = getelementptr %4, %4* @"main$0$0_return_value_struct", i32 0, i32 0
  store i8* %arrayidx9.i, i8** %i16, align 8
  %i17 = getelementptr %4, %4* @"main$0$0_return_value_struct", i32 0, i32 1
...
"main$0$0$0_return_from_recursive_function$0":    ; preds = %"main$0$0$0_latch$0"
  %i4 = getelementptr %5, %5* @"main$0$0$0_return_value_struct", i32 0, i32 2
  store i64 %i2, i64* %i4, align 8
  %i5 = getelementptr %5, %5* @"main$0$0$0_return_value_struct", i32 0, i32 0
  store i64 %add.i, i64* %i5, align 8
  %i6 = getelementptr %5, %5* @"main$0$0$0_return_value_struct", i32 0, i32 3
  store i8 1, i8* %i6, align 1
  ret void

"main$0$0$0_return_from_recursive_function$1":    ; preds = %"main$0$0$0_exiting$1"
  %i7 = getelementptr %5, %5* @"main$0$0$0_return_value_struct", i32 0, i32 1
  store i64 %arg, i64* %i7, align 8
  %i8 = getelementptr %5, %5* @"main$0$0$0_return_value_struct", i32 0, i32 3
  store i8 0, i8* %i8, align 1
  ret void
}
