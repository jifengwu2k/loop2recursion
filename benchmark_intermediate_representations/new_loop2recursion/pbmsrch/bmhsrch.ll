; ModuleID = './benchmark_intermediate_representations/new_loop2recursion/pbmsrch/bmhsrch.ll.temp'
...
"bmh_init$2_latch$0":
  ...
  %arrayidx8.prol = getelementptr inbounds i8, i8* %i4, i64 %arg1
...
"bmh_init$2_return_from_recursive_function$0":    ; preds = %"bmh_init$2_latch$0"
  %i6 = getelementptr %0, %0* @"bmh_init$2_return_value_struct", i32 0, i32 0
  store i64 %indvars.iv.next57.prol, i64* %i6, align 8
  ret void
}
...
"bmh_init$1_latch$0":
  ...
  %arrayidx8 = getelementptr inbounds i8, i8* %i3, i64 %arg
...
"bmh_search$0$0_branch_to_exit":                  ; preds = %"bmh_search$0$0_call_recursive_function"
  ...
  switch i8 %i9, label %"bmh_search$0_exiting$0" [
...
"bmh_search$0_exiting$0":                         ; preds = %"bmh_search$0$0_branch_to_exit", %"bmh_search$0$0_branch_to_exit"
  %i10 = load i32, i32* @"./benchmark_intermediate_representations/baseline/pbmsrch/bmhsrch.ll_invariant_variable$5", align 4
  %add29 = add nsw i32 %i10, %sub9
...
"bmh_search$0_return_from_recursive_function$0":  ; preds = %"bmh_search$0$0_branch_to_exit"
  %i11 = getelementptr %1, %1* @"bmh_search$0_return_value_struct", i32 0, i32 0
  store i8* %add.ptr13, i8** %i11, align 8
  %i12 = getelementptr %1, %1* @"bmh_search$0_return_value_struct", i32 0, i32 1
...
"bmh_search$0_return_from_recursive_function$1":  ; preds = %"bmh_search$0_exiting$0", %"bmh_search$0_exiting$1"
  %i13 = getelementptr %1, %1* @"bmh_search$0_return_value_struct", i32 0, i32 1
...
"bmh_search$0$0_return_from_recursive_function$0": ; preds = %"bmh_search$0$0_latch$0"
  %i5 = getelementptr %2, %2* @"bmh_search$0$0_return_value_struct", i32 0, i32 0
  store i8 1, i8* %i5, align 1
  ret void

"bmh_search$0$0_return_from_recursive_function$1": ; preds = %"bmh_search$0$0_exiting$1"
  %i6 = getelementptr %2, %2* @"bmh_search$0$0_return_value_struct", i32 0, i32 0
