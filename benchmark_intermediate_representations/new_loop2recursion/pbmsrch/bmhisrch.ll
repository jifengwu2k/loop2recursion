; ModuleID = './benchmark_intermediate_representations/new_loop2recursion/pbmsrch/bmhisrch.ll.temp'
...
"bmhi_init$1_initialize_context":                 ; preds = %for.body24.lr.ph
  store i64 %i11, i64* @"./benchmark_intermediate_representations/baseline/pbmsrch/bmhisrch.ll_invariant_variable$4", align 8
  store i32* %i10, i32** @"./benchmark_intermediate_representations/baseline/pbmsrch/bmhisrch.ll_invariant_variable$5", align 8
...
"bmhi_init$3_latch$0":
  ...
  %arrayidx11.prol = getelementptr inbounds i8, i8* %i6, i64 %arg1
...
"bmhi_init$3_return_from_recursive_function$0":   ; preds = %"bmhi_init$3_latch$0"
  %i7 = getelementptr %0, %0* @"bmhi_init$3_return_value_struct", i32 0, i32 0
  store i64 %indvars.iv.next117.prol, i64* %i7, align 8
  ret void
}
...
"bmhi_init$2_latch$0":
  ...
  %arrayidx11 = getelementptr inbounds i8, i8* %i5, i64 %arg
...
"bmhi_init$1_latch$0":
  ...
  %arrayidx28 = getelementptr inbounds i8, i8* %i3, i64 %arg1
  ...
  %i5 = load i32*, i32** @"./benchmark_intermediate_representations/baseline/pbmsrch/bmhisrch.ll_invariant_variable$5", align 8
  ...
  %i7 = load i64, i64* @"./benchmark_intermediate_representations/baseline/pbmsrch/bmhisrch.ll_invariant_variable$4", align 8
...
"bmhi_init$1_recursively_call_function":          ; preds = %"bmhi_init$1_increment_depth_counter"
  call void @"bmhi_init$1"(i32 %inc45, i64 %indvars.iv.next112, i32 %i.2.neg)
  ret void
...
if.then69:                                        ; preds = %"bmhi_init$0_header"
  %i3 = xor i64 %arg, 4294967295
  %i4 = trunc i64 %i3 to i32
  %i5 = load i32, i32* @"./benchmark_intermediate_representations/baseline/pbmsrch/bmhisrch.ll_invariant_variable$6", align 4
  %sub71 = add i32 %i5, %i4
...
"bmhi_search$0$0_branch_to_exit":                 ; preds = %"bmhi_search$0$0_call_recursive_function"
  %i8 = getelementptr %2, %2* @"bmhi_search$0$0_return_value_struct", i32 0, i32 0
  %i9 = load i8, i8* %i8, align 1
  switch i8 %i9, label %"bmhi_search$0_exiting$0" [
...
"bmhi_search$0_exiting$0":                        ; preds = %"bmhi_search$0$0_branch_to_exit", %"bmhi_search$0$0_branch_to_exit"
  %i10 = load i32, i32* @"./benchmark_intermediate_representations/baseline/pbmsrch/bmhisrch.ll_invariant_variable$11", align 4
  %add31 = add nsw i32 %i10, %sub9
...
"bmhi_search$0_return_from_recursive_function$0": ; preds = %"bmhi_search$0$0_branch_to_exit"
  %i11 = getelementptr %1, %1* @"bmhi_search$0_return_value_struct", i32 0, i32 0
  store i8* %add.ptr13, i8** %i11, align 8
  %i12 = getelementptr %1, %1* @"bmhi_search$0_return_value_struct", i32 0, i32 1
...
"bmhi_search$0_return_from_recursive_function$1": ; preds = %"bmhi_search$0_exiting$0", %"bmhi_search$0_exiting$1"
  %i13 = getelementptr %1, %1* @"bmhi_search$0_return_value_struct", i32 0, i32 1
...
"bmhi_search$0$0_return_from_recursive_function$0": ; preds = %"bmhi_search$0$0_latch$0"
  %i7 = getelementptr %2, %2* @"bmhi_search$0$0_return_value_struct", i32 0, i32 0
