; ModuleID = './benchmark_intermediate_representations/new_loop2recursion-recursion_depth_limit-8/bf/bf_cfb64.ll.temp'
...
if.then2:                                         ; preds = %"BF_cfb64_encrypt$1_header"
  ...
  %i6 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$5", align 8
  %i7 = load i8, i8* %i6, align 1, !tbaa !5
  %i8 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$7", align 8
  %i9 = load i8, i8* %i8, align 1, !tbaa !5
  %i10 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$9", align 8
  %i11 = load i8, i8* %i10, align 1, !tbaa !5
  %i12 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$11", align 8
  ...
  %i18 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$8", align 8
  ...
  %i25 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$4", align 8
  ...
  %i32 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$3", align 8
  ...
  %i38 = load <2 x i64>*, <2 x i64>** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$2", align 8
  store <2 x i64> %i37, <2 x i64>* %i38, align 16, !tbaa !6
  %i39 = load i64*, i64** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$1", align 8
  %i40 = load %struct.bf_key_st*, %struct.bf_key_st** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$10", align 8
  call void @BF_encrypt(i64* %i39, %struct.bf_key_st* %i40, i32 1) #3
  %i41 = load i64*, i64** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$1", align 8
  %i42 = load i64, i64* %i41, align 16, !tbaa !6
  %shr = lshr i64 %i42, 24
  %conv29 = trunc i64 %shr to i8
  %i43 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$6", align 8
  store i8 %conv29, i8* %i43, align 1, !tbaa !5
  %shr31 = lshr i64 %i42, 16
  %conv33 = trunc i64 %shr31 to i8
  %i44 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$5", align 8
  store i8 %conv33, i8* %i44, align 1, !tbaa !5
  %shr35 = lshr i64 %i42, 8
  %conv37 = trunc i64 %shr35 to i8
  %i45 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$7", align 8
  store i8 %conv37, i8* %i45, align 1, !tbaa !5
  %conv40 = trunc i64 %i42 to i8
  %i46 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$9", align 8
  ...
  %i49 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$11", align 8
  store i8 %conv45, i8* %i49, align 1, !tbaa !5
  %shr47 = lshr i64 %i48, 16
  %conv49 = trunc i64 %shr47 to i8
  %i50 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$8", align 8
  store i8 %conv49, i8* %i50, align 1, !tbaa !5
  %shr51 = lshr i64 %i48, 8
  %conv53 = trunc i64 %shr51 to i8
  %i51 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$4", align 8
  store i8 %conv53, i8* %i51, align 1, !tbaa !5
  %conv56 = trunc i64 %i48 to i8
  %i52 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$3", align 8
...
"BF_cfb64_encrypt$1_latch$0":                     ; preds = %if.then2, %"BF_cfb64_encrypt$1_header"
  ...
  %i54 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$6", align 8
...
if.then73:                                        ; preds = %"BF_cfb64_encrypt$0_header"
  %i = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$6", align 8
  %i5 = load i8, i8* %i, align 1, !tbaa !5
  %i6 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$15", align 8
  %i7 = load i8, i8* %i6, align 1, !tbaa !5
  ...
  %i23 = shl nuw nsw <2 x i64> %i22, <i64 16, i64 16>
  %i24 = or <2 x i64> %i23, %i17
  %i25 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$13", align 8
  %i26 = load i8, i8* %i25, align 1, !tbaa !5
  %i27 = insertelement <2 x i8> undef, i8 %i9, i32 0
  %i28 = insertelement <2 x i8> %i27, i8 %i26, i32 1
  %i29 = zext <2 x i8> %i28 to <2 x i64>
  %i30 = shl nuw nsw <2 x i64> %i29, <i64 8, i64 8>
  %i31 = or <2 x i64> %i24, %i30
  %i32 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$12", align 8
  %i33 = load i8, i8* %i32, align 1, !tbaa !5
  %i34 = insertelement <2 x i8> undef, i8 %i11, i32 0
  %i35 = insertelement <2 x i8> %i34, i8 %i33, i32 1
  %i36 = zext <2 x i8> %i35 to <2 x i64>
  ...
  %i41 = load i64*, i64** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$14", align 8
  %i42 = load i64, i64* %i41, align 16, !tbaa !6
  ...
  %i44 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$15", align 8
  ...
  %i47 = load i64*, i64** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$16", align 8
  %i48 = load i64, i64* %i47, align 8, !tbaa !6
  ...
  %i51 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$13", align 8
  store i8 %conv132, i8* %i51, align 1, !tbaa !5
  %conv135 = trunc i64 %i48 to i8
  %i52 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_cfb64.ll_invariant_variable$12", align 8
