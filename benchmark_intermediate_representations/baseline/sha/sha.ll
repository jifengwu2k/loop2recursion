...
while.body:                                       ; preds = %while.body.lr.ph, %while.body
  %count.addr.032 = phi i32 [ %count, %while.body.lr.ph ], [ %sub, %while.body ]
  %buffer.addr.031 = phi i8* [ %buffer, %while.body.lr.ph ], [ %add.ptr, %while.body ]
  tail call void @llvm.memcpy.p0i8.p0i8.i64(i8* %3, i8* %buffer.addr.031, i64 64, i32 1, i1 false)
  %10 = load i8, i8* %3, align 1, !tbaa !8
  %11 = load i8, i8* %arrayidx4.i, align 1, !tbaa !8
  %12 = load i8, i8* %arrayidx6.i, align 1, !tbaa !8
  %13 = load i8, i8* %arrayidx8.i, align 1, !tbaa !8
  store i8 %13, i8* %3, align 1, !tbaa !8
  store i8 %12, i8* %arrayidx4.i, align 1, !tbaa !8
  store i8 %11, i8* %arrayidx6.i, align 1, !tbaa !8
  store i8 %10, i8* %arrayidx8.i, align 1, !tbaa !8
  %14 = load i8, i8* %add.ptr.i, align 1, !tbaa !8
  %15 = load i8, i8* %arrayidx4.1.i, align 1, !tbaa !8
  %16 = load i8, i8* %arrayidx6.1.i, align 1, !tbaa !8
  %17 = load i8, i8* %arrayidx8.1.i, align 1, !tbaa !8
  store i8 %17, i8* %add.ptr.i, align 1, !tbaa !8
  store i8 %16, i8* %arrayidx4.1.i, align 1, !tbaa !8
  store i8 %15, i8* %arrayidx6.1.i, align 1, !tbaa !8
  store i8 %14, i8* %arrayidx8.1.i, align 1, !tbaa !8
  %18 = load i8, i8* %add.ptr.1.i, align 1, !tbaa !8
  %19 = load i8, i8* %arrayidx4.2.i, align 1, !tbaa !8
  %20 = load i8, i8* %arrayidx6.2.i, align 1, !tbaa !8
  %21 = load i8, i8* %arrayidx8.2.i, align 1, !tbaa !8
  store i8 %21, i8* %add.ptr.1.i, align 1, !tbaa !8
  store i8 %20, i8* %arrayidx4.2.i, align 1, !tbaa !8
  store i8 %19, i8* %arrayidx6.2.i, align 1, !tbaa !8
  store i8 %18, i8* %arrayidx8.2.i, align 1, !tbaa !8
  %22 = load i8, i8* %add.ptr.2.i, align 1, !tbaa !8
  %23 = load i8, i8* %arrayidx4.3.i, align 1, !tbaa !8
  %24 = load i8, i8* %arrayidx6.3.i, align 1, !tbaa !8
  %25 = load i8, i8* %arrayidx8.3.i, align 1, !tbaa !8
  store i8 %25, i8* %add.ptr.2.i, align 1, !tbaa !8
  store i8 %24, i8* %arrayidx4.3.i, align 1, !tbaa !8
  store i8 %23, i8* %arrayidx6.3.i, align 1, !tbaa !8
  store i8 %22, i8* %arrayidx8.3.i, align 1, !tbaa !8
  %26 = load i8, i8* %add.ptr.3.i, align 1, !tbaa !8
  %27 = load i8, i8* %arrayidx4.4.i, align 1, !tbaa !8
  %28 = load i8, i8* %arrayidx6.4.i, align 1, !tbaa !8
  %29 = load i8, i8* %arrayidx8.4.i, align 1, !tbaa !8
  store i8 %29, i8* %add.ptr.3.i, align 1, !tbaa !8
  store i8 %28, i8* %arrayidx4.4.i, align 1, !tbaa !8
  store i8 %27, i8* %arrayidx6.4.i, align 1, !tbaa !8
  store i8 %26, i8* %arrayidx8.4.i, align 1, !tbaa !8
  %30 = load i8, i8* %add.ptr.4.i, align 1, !tbaa !8
  %31 = load i8, i8* %arrayidx4.5.i, align 1, !tbaa !8
  %32 = load i8, i8* %arrayidx6.5.i, align 1, !tbaa !8
  %33 = load i8, i8* %arrayidx8.5.i, align 1, !tbaa !8
  store i8 %33, i8* %add.ptr.4.i, align 1, !tbaa !8
  store i8 %32, i8* %arrayidx4.5.i, align 1, !tbaa !8
  store i8 %31, i8* %arrayidx6.5.i, align 1, !tbaa !8
  store i8 %30, i8* %arrayidx8.5.i, align 1, !tbaa !8
  %34 = load i8, i8* %add.ptr.5.i, align 1, !tbaa !8
  %35 = load i8, i8* %arrayidx4.6.i, align 1, !tbaa !8
  %36 = load i8, i8* %arrayidx6.6.i, align 1, !tbaa !8
  %37 = load i8, i8* %arrayidx8.6.i, align 1, !tbaa !8
  store i8 %37, i8* %add.ptr.5.i, align 1, !tbaa !8
  store i8 %36, i8* %arrayidx4.6.i, align 1, !tbaa !8
  store i8 %35, i8* %arrayidx6.6.i, align 1, !tbaa !8
  store i8 %34, i8* %arrayidx8.6.i, align 1, !tbaa !8
  %38 = load i8, i8* %add.ptr.6.i, align 1, !tbaa !8
  %39 = load i8, i8* %arrayidx4.7.i, align 1, !tbaa !8
  %40 = load i8, i8* %arrayidx6.7.i, align 1, !tbaa !8
  %41 = load i8, i8* %arrayidx8.7.i, align 1, !tbaa !8
  store i8 %41, i8* %add.ptr.6.i, align 1, !tbaa !8
  store i8 %40, i8* %arrayidx4.7.i, align 1, !tbaa !8
  store i8 %39, i8* %arrayidx6.7.i, align 1, !tbaa !8
  store i8 %38, i8* %arrayidx8.7.i, align 1, !tbaa !8
  ...
  br i1 %cmp10, label %while.body, label %while.end.loopexit, !llvm.loop !9
...
while.end:                                        ; preds = %while.end.loopexit, %if.end
  %count.addr.0.lcssa = phi i32 [ %count, %if.end ], [ %42, %while.end.loopexit ]
  %buffer.addr.0.lcssa = phi i8* [ %buffer, %if.end ], [ %scevgep, %while.end.loopexit ]
  %conv16 = sext i32 %count.addr.0.lcssa to i64
  tail call void @llvm.memcpy.p0i8.p0i8.i64(i8* %3, i8* %buffer.addr.0.lcssa, i64 %conv16, i32 1, i1 false)
  ret void
}
...
entry:
  ...
  call void @llvm.lifetime.start(i64 640, i8* %0) #4
  %scevgep = getelementptr %struct.SHA_INFO, %struct.SHA_INFO* %sha_info, i64 0, i32 3, i64 0
  %scevgep262 = bitcast i64* %scevgep to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %0, i8* %scevgep262, i64 128, i32 8, i1 false)
  br label %for.body5
...
for.end111:                                       ; preds = %for.body94
  ...
  call void @llvm.lifetime.end(i64 640, i8* nonnull %0) #4
  ret void
}
...
if.then:                                          ; preds = %entry
  ...
  tail call void @llvm.memset.p0i8.i64(i8* %add.ptr, i8 0, i64 %conv337, i32 1, i1 false)
  ...
  tail call fastcc void @sha_transform(%struct.SHA_INFO* nonnull %sha_info)
  tail call void @llvm.memset.p0i8.i64(i8* %2, i8 0, i64 56, i32 8, i1 false)
  br label %if.end

if.else:                                          ; preds = %entry
  %sub10 = sub nsw i32 55, %conv
  %conv11 = sext i32 %sub10 to i64
  tail call void @llvm.memset.p0i8.i64(i8* %add.ptr, i8 0, i64 %conv11, i32 1, i1 false)
...
define void @sha_stream(%struct.SHA_INFO* nocapture %sha_info, %struct._IO_FILE* nocapture %fin) #2 {
entry:
  %data = alloca [8192 x i8], align 16
  %0 = getelementptr inbounds [8192 x i8], [8192 x i8]* %data, i64 0, i64 0
  call void @llvm.lifetime.start(i64 8192, i8* %0) #4
...
while.body:                                       ; preds = %while.body.preheader, %while.body
  %conv8 = phi i32 [ %conv, %while.body ], [ %conv6, %while.body.preheader ]
  call void @sha_update(%struct.SHA_INFO* %sha_info, i8* %0, i32 %conv8)
  %call = call i64 @fread(i8* %0, i64 1, i64 8192, %struct._IO_FILE* %fin)
  %conv = trunc i64 %call to i32
  %cmp = icmp sgt i32 %conv, 0
  br i1 %cmp, label %while.body, label %while.end.loopexit, !llvm.loop !9
...
while.end:                                        ; preds = %while.end.loopexit, %entry
  ...
  call void @llvm.lifetime.end(i64 8192, i8* %0) #4
  ret void
}
...
; Function Attrs: nounwind uwtable
define void @sha_print(%struct.SHA_INFO* nocapture readonly %sha_info) #2 {
entry:
