...
while.body:                                       ; preds = %while.body.preheader, %while.body
  %call125 = phi i32 [ %call1, %while.body ], [ %call122, %while.body.preheader ]
  %oldcrc32.024 = phi i64 [ %xor4, %while.body ], [ 4294967295, %while.body.preheader ]
  %0 = load i64, i64* %charcnt, align 8, !tbaa !1
  %inc = add nsw i64 %0, 1
  store i64 %inc, i64* %charcnt, align 8, !tbaa !1
  ...
  %xor4 = xor i64 %1, %shr
  %call1 = tail call i32 @_IO_getc(%struct._IO_FILE* nonnull %call)
  %cmp2 = icmp eq i32 %call1, -1
  br i1 %cmp2, label %while.end.loopexit, label %while.body

while.end.loopexit:                               ; preds = %while.body
  %xor4.lcssa = phi i64 [ %xor4, %while.body ]
  %phitmp = xor i64 %xor4.lcssa, -1
  br label %while.end
...
if.end7:                                          ; preds = %while.end, %if.then6
...
define i64 @crc32buf(i8* nocapture readonly %buf, i64 %len) #5 {
entry:
...
while.body:                                       ; preds = %while.body.preheader, %while.body
  %errors.09 = phi i32 [ %or, %while.body ], [ 0, %while.body.preheader ]
  %argv.addr.08 = phi i8** [ %incdec.ptr, %while.body ], [ %argv, %while.body.preheader ]
  %argc.addr.07 = phi i32 [ %dec, %while.body ], [ %argc, %while.body.preheader ]
  %dec = add nsw i32 %argc.addr.07, -1
  %incdec.ptr = getelementptr inbounds i8*, i8** %argv.addr.08, i64 1
  %2 = load i8*, i8** %incdec.ptr, align 8, !tbaa !6
  %call = call i32 @crc32file(i8* %2, i64* nonnull %crc, i64* nonnull %charcnt)
  %or = or i32 %call, %errors.09
  %3 = load i64, i64* %crc, align 8, !tbaa !1
  %4 = load i64, i64* %charcnt, align 8, !tbaa !1
  %5 = load i8*, i8** %incdec.ptr, align 8, !tbaa !6
  %call1 = tail call i32 (i8*, ...) @printf(i8* nonnull getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1, i64 0, i64 0), i64 %3, i64 %4, i8* %5)
  %cmp = icmp sgt i32 %dec, 1
  br i1 %cmp, label %while.body, label %while.end.loopexit

while.end.loopexit:                               ; preds = %while.body
  %or.lcssa = phi i32 [ %or, %while.body ]
  %phitmp = icmp ne i32 %or.lcssa, 0
  br label %while.end
