; ModuleID = './benchmark_intermediate_representations/unoptimized_loop2recursion-recursion_depth_limit-32/fft/fourierf.ll.temp'
...
"fft_float$3_call_recursive_function":            ; preds = %"fft_float$3_extract_next_values", %"fft_float$3_initialize_context"
  ...
  call void @"fft_float$3"(i64 %i5, i32 %NumSamples, float* %RealIn, float* %ImagOut, float* %RealOut, i1 %cmp9, i32 %call5, float* %ImagIn, %0* %i4, i8 0)
...
"fft_float$2_call_recursive_function":            ; preds = %"fft_float$2_extract_next_values", %"fft_float$2_initialize_context"
  ...
  call void @"fft_float$2"(i32 %i11, i32 %i12, i32 %NumSamples, float* %ImagOut, float* %RealOut, double %., i1 %cmp249, %1* %i10, i8 0)
...
"fft_float$1_call_recursive_function":            ; preds = %"fft_float$1_extract_next_values", %"fft_float$1_initialize_context"
  ...
  call void @"fft_float$1"(i64 %i25, i64 %n.vec, float* %ImagOut, float* %RealOut, <2 x double> %broadcast.splat265, %2* %i24, i8 0)
...
"fft_float$0_call_recursive_function":            ; preds = %"fft_float$0_extract_next_values", %"fft_float$0_initialize_context"
  ...
  call void @"fft_float$0"(i64 %i31, i32 %NumSamples, float* %ImagOut, float* %RealOut, double %conv115, %3* %i30, i8 0)
...
define void @"fft_float$0"(i64 %arg, i32 %arg1, float* %arg2, float* %arg3, double %arg4, %3* %arg5, i8 %arg6) {
"fft_float$0_latch$0":
...
"fft_float$0_recursively_call_function":          ; preds = %"fft_float$0_increment_depth_counter"
  call void @"fft_float$0"(i64 %indvars.iv.next, i32 %arg1, float* %arg2, float* %arg3, double %arg4, %3* %arg5, i8 %i8)
  ret void
...
define void @"fft_float$1"(i64 %arg, i64 %arg1, float* %arg2, float* %arg3, <2 x double> %arg4, %2* %arg5, i8 %arg6) {
"fft_float$1_latch$0":
...
"fft_float$1_recursively_call_function":          ; preds = %"fft_float$1_increment_depth_counter"
  call void @"fft_float$1"(i64 %index.next, i64 %arg1, float* %arg2, float* %arg3, <2 x double> %arg4, %2* %arg5, i8 %i19)
  ret void
...
define void @"fft_float$2"(i32 %arg, i32 %arg1, i32 %arg2, float* %arg3, float* %arg4, double %arg5, i1 %arg6, %1* %arg7, i8 %arg8) {
"fft_float$2_header":
...
"fft_float$2$0_call_recursive_function":          ; preds = %"fft_float$2$0_extract_next_values", %"fft_float$2$0_initialize_context"
  ...
  call void @"fft_float$2$0"(i32 %i9, i32 %i10, i32 %arg2, i32 %arg1, float* %arg3, i32 %arg, double %call22, i1 %cmp37236, double %call20, double %mul27, float* %arg4, double %cos, double %call24, %4* %i, i8 0)
...
"fft_float$2_recursively_call_function":          ; preds = %"fft_float$2_increment_depth_counter"
  call void @"fft_float$2"(i32 %arg1, i32 %shl, i32 %arg2, float* %arg3, float* %arg4, double %arg5, i1 %arg6, %1* %arg7, i8 %i17)
  ret void
...
define void @"fft_float$3"(i64 %arg, i32 %arg1, float* %arg2, float* %arg3, float* %arg4, i1 %arg5, i32 %arg6, float* %arg7, %0* %arg8, i8 %arg9) {
"fft_float$3_header":
...
"fft_float$3_recursively_call_function":          ; preds = %"fft_float$3_increment_depth_counter"
  call void @"fft_float$3"(i64 %indvars.iv.next255, i32 %arg1, float* %arg2, float* %arg3, float* %arg4, i1 %arg5, i32 %arg6, float* %arg7, %0* %arg8, i8 %i14)
  ret void
...
define void @"fft_float$2$0"(i32 %arg, i32 %arg1, i32 %arg2, i32 %arg3, float* %arg4, i32 %arg5, double %arg6, i1 %arg7, double %arg8, double %arg9, float* %arg10, double %arg11, double %arg12, %4* %arg13, i8 %arg14) {
...
"fft_float$2$0$0_call_recursive_function":        ; preds = %"fft_float$2$0$0_extract_next_values", %"fft_float$2$0$0_initialize_context"
  ...
  call void @"fft_float$2$0$0"(double %i15, double %i16, i32 %i17, double %i18, double %i19, i32 %arg1, float* %arg4, float* %arg10, double %arg9, i32 %arg5, %5* %i, i8 0)
...
"fft_float$2$0_recursively_call_function":        ; preds = %"fft_float$2$0_increment_depth_counter"
  call void @"fft_float$2$0"(i32 %add109, i32 %indvars.iv.next252, i32 %arg2, i32 %arg3, float* %arg4, i32 %arg5, double %arg6, i1 %arg7, double %arg8, double %arg9, float* %arg10, double %arg11, double %arg12, %4* %arg13, i8 %i32)
  ret void
...
define void @"fft_float$2$0$0"(double %arg, double %arg1, i32 %arg2, double %arg3, double %arg4, i32 %arg5, float* %arg6, float* %arg7, double %arg8, i32 %arg9, %5* %arg10, i8 %arg11) {
...
"fft_float$2$0$0_recursively_call_function":      ; preds = %"fft_float$2$0$0_increment_depth_counter"
  call void @"fft_float$2$0$0"(double %arg1, double %sub43, i32 %inc105, double %arg4, double %sub52, i32 %arg5, float* %arg6, float* %arg7, double %arg8, i32 %arg9, %5* %arg10, i8 %i17)
  ret void
