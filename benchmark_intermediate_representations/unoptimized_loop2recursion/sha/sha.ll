; ModuleID = './benchmark_intermediate_representations/unoptimized_loop2recursion/sha/sha.ll.temp'
...
"sha_update$0_call_recursive_function":           ; preds = %while.body.lr.ph
  call void @"sha_update$0"(i8* %buffer, i32 %count, %struct.SHA_INFO* %sha_info, i8* %arrayidx6.7.i, i8* %add.ptr.6.i, i8* %arrayidx4.6.i, i8* %arrayidx8.5.i, i8* %arrayidx6.5.i, i8* %add.ptr.4.i, i8* %arrayidx8.4.i, i8* %arrayidx6.4.i, i8* %add.ptr.1.i, i8* %arrayidx8.i, i8* %arrayidx4.7.i, i8* %arrayidx8.1.i, i8* %arrayidx6.i, i8* %arrayidx6.1.i, i8* %arrayidx4.4.i, i8* %i3, i8* %add.ptr.5.i, i8* %add.ptr.2.i, i8* %add.ptr.3.i, i8* %arrayidx4.1.i, i8* %arrayidx8.7.i, i8* %arrayidx4.2.i, i8* %arrayidx4.5.i, i8* %add.ptr.i, i8* %arrayidx4.i, i8* %arrayidx6.2.i, i8* %arrayidx8.2.i, i8* %arrayidx6.6.i, i8* %arrayidx4.3.i, i8* %arrayidx8.6.i, i8* %arrayidx6.3.i, i8* %arrayidx8.3.i)
...
"sha_transform$4_call_recursive_function":        ; preds = %entry
  call void @"sha_transform$4"(i64 16, [80 x i64]* %W)
  br label %for.end23
...
"sha_transform$3_call_recursive_function":        ; preds = %"sha_transform$3_initialize_context"
  call void @"sha_transform$3"(%0* %i6, i64 %i1, i64 %i2, i64 %i3, i64 %i4, i64 0, i64 %i5, [80 x i64]* %W)
...
"sha_transform$3_extract_return_values$0":        ; preds = %"sha_transform$3_call_recursive_function"
  %i7 = getelementptr %0, %0* %i6, i32 0, i32 0
  %i8 = load i64, i64* %i7, align 8
  %i9 = getelementptr %0, %0* %i6, i32 0, i32 1
  %i10 = load i64, i64* %i9, align 8
  %i11 = getelementptr %0, %0* %i6, i32 0, i32 2
  %i12 = load i64, i64* %i11, align 8
  %i13 = getelementptr %0, %0* %i6, i32 0, i32 3
  %i14 = load i64, i64* %i13, align 8
  %i15 = getelementptr %0, %0* %i6, i32 0, i32 4
...
"sha_transform$2_call_recursive_function":        ; preds = %"sha_transform$2_initialize_context"
  call void @"sha_transform$2"(%1* %i17, i64 %i16, i64 %i12, i64 %i14, i64 %i10, i64 20, i64 %i8, [80 x i64]* %W)
...
"sha_transform$2_extract_return_values$0":        ; preds = %"sha_transform$2_call_recursive_function"
  %i18 = getelementptr %1, %1* %i17, i32 0, i32 0
  %i19 = load i64, i64* %i18, align 8
  %i20 = getelementptr %1, %1* %i17, i32 0, i32 1
  %i21 = load i64, i64* %i20, align 8
  %i22 = getelementptr %1, %1* %i17, i32 0, i32 2
  %i23 = load i64, i64* %i22, align 8
  %i24 = getelementptr %1, %1* %i17, i32 0, i32 3
  %i25 = load i64, i64* %i24, align 8
  %i26 = getelementptr %1, %1* %i17, i32 0, i32 4
...
"sha_transform$1_call_recursive_function":        ; preds = %"sha_transform$1_initialize_context"
  call void @"sha_transform$1"(%2* %i28, i64 %i27, i64 %i23, i64 %i25, i64 %i21, i64 40, i64 %i19, [80 x i64]* %W)
...
"sha_transform$1_extract_return_values$0":        ; preds = %"sha_transform$1_call_recursive_function"
  %i29 = getelementptr %2, %2* %i28, i32 0, i32 0
  %i30 = load i64, i64* %i29, align 8
  %i31 = getelementptr %2, %2* %i28, i32 0, i32 1
  %i32 = load i64, i64* %i31, align 8
  %i33 = getelementptr %2, %2* %i28, i32 0, i32 2
  %i34 = load i64, i64* %i33, align 8
  %i35 = getelementptr %2, %2* %i28, i32 0, i32 3
  %i36 = load i64, i64* %i35, align 8
  %i37 = getelementptr %2, %2* %i28, i32 0, i32 4
...
"sha_transform$0_call_recursive_function":        ; preds = %"sha_transform$0_initialize_context"
  call void @"sha_transform$0"(%3* %i39, i64 %i38, i64 %i34, i64 %i32, i64 %i36, i64 60, i64 %i30, [80 x i64]* %W)
...
"sha_stream$0_call_recursive_function":           ; preds = %while.body.preheader
  call void @"sha_stream$0"(i32 %conv6, %struct._IO_FILE* %fin, %struct.SHA_INFO* %sha_info, i8* %i)
  br label %while.end.loopexit
...
"sha_update$0_latch$0":
  ...
  %i35 = load i8, i8* %arg27, align 1, !tbaa !8
  %i36 = load i8, i8* %arg15, align 1, !tbaa !8
  %i37 = load i8, i8* %arg12, align 1, !tbaa !8
  store i8 %i37, i8* %arg18, align 1, !tbaa !8
  store i8 %i36, i8* %arg27, align 1, !tbaa !8
  store i8 %i35, i8* %arg15, align 1, !tbaa !8
  store i8 %i, i8* %arg12, align 1, !tbaa !8
  %i38 = load i8, i8* %arg26, align 1, !tbaa !8
  %i39 = load i8, i8* %arg22, align 1, !tbaa !8
  %i40 = load i8, i8* %arg16, align 1, !tbaa !8
  %i41 = load i8, i8* %arg14, align 1, !tbaa !8
  store i8 %i41, i8* %arg26, align 1, !tbaa !8
  store i8 %i40, i8* %arg22, align 1, !tbaa !8
  store i8 %i39, i8* %arg16, align 1, !tbaa !8
  store i8 %i38, i8* %arg14, align 1, !tbaa !8
  %i42 = load i8, i8* %arg11, align 1, !tbaa !8
  %i43 = load i8, i8* %arg24, align 1, !tbaa !8
  %i44 = load i8, i8* %arg28, align 1, !tbaa !8
  %i45 = load i8, i8* %arg29, align 1, !tbaa !8
  store i8 %i45, i8* %arg11, align 1, !tbaa !8
  store i8 %i44, i8* %arg24, align 1, !tbaa !8
  store i8 %i43, i8* %arg28, align 1, !tbaa !8
  store i8 %i42, i8* %arg29, align 1, !tbaa !8
  %i46 = load i8, i8* %arg20, align 1, !tbaa !8
  %i47 = load i8, i8* %arg31, align 1, !tbaa !8
  %i48 = load i8, i8* %arg33, align 1, !tbaa !8
  %i49 = load i8, i8* %arg34, align 1, !tbaa !8
  store i8 %i49, i8* %arg20, align 1, !tbaa !8
  store i8 %i48, i8* %arg31, align 1, !tbaa !8
  store i8 %i47, i8* %arg33, align 1, !tbaa !8
  store i8 %i46, i8* %arg34, align 1, !tbaa !8
  %i50 = load i8, i8* %arg21, align 1, !tbaa !8
  %i51 = load i8, i8* %arg17, align 1, !tbaa !8
  %i52 = load i8, i8* %arg10, align 1, !tbaa !8
  %i53 = load i8, i8* %arg9, align 1, !tbaa !8
  store i8 %i53, i8* %arg21, align 1, !tbaa !8
  store i8 %i52, i8* %arg17, align 1, !tbaa !8
  store i8 %i51, i8* %arg10, align 1, !tbaa !8
  store i8 %i50, i8* %arg9, align 1, !tbaa !8
  %i54 = load i8, i8* %arg8, align 1, !tbaa !8
  %i55 = load i8, i8* %arg25, align 1, !tbaa !8
  %i56 = load i8, i8* %arg7, align 1, !tbaa !8
  %i57 = load i8, i8* %arg6, align 1, !tbaa !8
  store i8 %i57, i8* %arg8, align 1, !tbaa !8
  store i8 %i56, i8* %arg25, align 1, !tbaa !8
  store i8 %i55, i8* %arg7, align 1, !tbaa !8
  store i8 %i54, i8* %arg6, align 1, !tbaa !8
  %i58 = load i8, i8* %arg19, align 1, !tbaa !8
  %i59 = load i8, i8* %arg5, align 1, !tbaa !8
  %i60 = load i8, i8* %arg30, align 1, !tbaa !8
  %i61 = load i8, i8* %arg32, align 1, !tbaa !8
  store i8 %i61, i8* %arg19, align 1, !tbaa !8
  store i8 %i60, i8* %arg5, align 1, !tbaa !8
  store i8 %i59, i8* %arg30, align 1, !tbaa !8
  store i8 %i58, i8* %arg32, align 1, !tbaa !8
  %i62 = load i8, i8* %arg4, align 1, !tbaa !8
  %i63 = load i8, i8* %arg13, align 1, !tbaa !8
  %i64 = load i8, i8* %arg3, align 1, !tbaa !8
  %i65 = load i8, i8* %arg23, align 1, !tbaa !8
  store i8 %i65, i8* %arg4, align 1, !tbaa !8
  store i8 %i64, i8* %arg13, align 1, !tbaa !8
  store i8 %i63, i8* %arg3, align 1, !tbaa !8
  store i8 %i62, i8* %arg23, align 1, !tbaa !8
...
define void @"sha_transform$0"(%3* %arg, i64 %arg1, i64 %arg2, i64 %arg3, i64 %arg4, i64 %arg5, i64 %arg6, [80 x i64]* %arg7) {
...
"sha_transform$0_recursively_call_function":      ; preds = %"sha_transform$0_increment_depth_counter"
  call void @"sha_transform$0"(%3* %arg, i64 %add105, i64 %arg1, i64 %arg4, i64 %or108, i64 %indvars.iv.next, i64 %arg3, [80 x i64]* %arg7)
  ret void

"sha_transform$0_return_from_recursive_function$0": ; preds = %"sha_transform$0_latch$0"
  %i8 = getelementptr %3, %3* %arg, i32 0, i32 0
  store i64 %arg3, i64* %i8, align 8
  %i9 = getelementptr %3, %3* %arg, i32 0, i32 1
  store i64 %arg4, i64* %i9, align 8
  %i10 = getelementptr %3, %3* %arg, i32 0, i32 2
  store i64 %arg1, i64* %i10, align 8
  %i11 = getelementptr %3, %3* %arg, i32 0, i32 3
  store i64 %or108, i64* %i11, align 8
  %i12 = getelementptr %3, %3* %arg, i32 0, i32 4
  store i64 %add105, i64* %i12, align 8
  ret void
}

define void @"sha_transform$1"(%2* %arg, i64 %arg1, i64 %arg2, i64 %arg3, i64 %arg4, i64 %arg5, i64 %arg6, [80 x i64]* %arg7) {
...
"sha_transform$1_recursively_call_function":      ; preds = %"sha_transform$1_increment_depth_counter"
  call void @"sha_transform$1"(%2* %arg, i64 %add85, i64 %arg1, i64 %or88, i64 %arg3, i64 %indvars.iv.next244, i64 %arg4, [80 x i64]* %arg7)
  ret void

"sha_transform$1_return_from_recursive_function$0": ; preds = %"sha_transform$1_latch$0"
  %i8 = getelementptr %2, %2* %arg, i32 0, i32 0
  store i64 %arg4, i64* %i8, align 8
  %i9 = getelementptr %2, %2* %arg, i32 0, i32 1
  store i64 %arg3, i64* %i9, align 8
  %i10 = getelementptr %2, %2* %arg, i32 0, i32 2
  store i64 %arg1, i64* %i10, align 8
  %i11 = getelementptr %2, %2* %arg, i32 0, i32 3
  store i64 %or88, i64* %i11, align 8
  %i12 = getelementptr %2, %2* %arg, i32 0, i32 4
  store i64 %add85, i64* %i12, align 8
  ret void
}

define void @"sha_transform$2"(%1* %arg, i64 %arg1, i64 %arg2, i64 %arg3, i64 %arg4, i64 %arg5, i64 %arg6, [80 x i64]* %arg7) {
...
"sha_transform$2_recursively_call_function":      ; preds = %"sha_transform$2_increment_depth_counter"
  call void @"sha_transform$2"(%1* %arg, i64 %add62, i64 %arg1, i64 %or65, i64 %arg3, i64 %indvars.iv.next247, i64 %arg4, [80 x i64]* %arg7)
  ret void

"sha_transform$2_return_from_recursive_function$0": ; preds = %"sha_transform$2_latch$0"
  %i8 = getelementptr %1, %1* %arg, i32 0, i32 0
  store i64 %arg4, i64* %i8, align 8
  %i9 = getelementptr %1, %1* %arg, i32 0, i32 1
  store i64 %arg3, i64* %i9, align 8
  %i10 = getelementptr %1, %1* %arg, i32 0, i32 2
  store i64 %arg1, i64* %i10, align 8
  %i11 = getelementptr %1, %1* %arg, i32 0, i32 3
  store i64 %or65, i64* %i11, align 8
  %i12 = getelementptr %1, %1* %arg, i32 0, i32 4
  store i64 %add62, i64* %i12, align 8
  ret void
}

define void @"sha_transform$3"(%0* %arg, i64 %arg1, i64 %arg2, i64 %arg3, i64 %arg4, i64 %arg5, i64 %arg6, [80 x i64]* %arg7) {
...
"sha_transform$3_recursively_call_function":      ; preds = %"sha_transform$3_increment_depth_counter"
  call void @"sha_transform$3"(%0* %arg, i64 %add42, i64 %arg1, i64 %or45, i64 %arg3, i64 %indvars.iv.next250, i64 %arg4, [80 x i64]* %arg7)
  ret void

"sha_transform$3_return_from_recursive_function$0": ; preds = %"sha_transform$3_latch$0"
  %i8 = getelementptr %0, %0* %arg, i32 0, i32 0
  store i64 %arg4, i64* %i8, align 8
  %i9 = getelementptr %0, %0* %arg, i32 0, i32 1
  store i64 %arg3, i64* %i9, align 8
  %i10 = getelementptr %0, %0* %arg, i32 0, i32 2
  store i64 %arg1, i64* %i10, align 8
  %i11 = getelementptr %0, %0* %arg, i32 0, i32 3
  store i64 %or45, i64* %i11, align 8
  %i12 = getelementptr %0, %0* %arg, i32 0, i32 4
  store i64 %add42, i64* %i12, align 8
  ret void
}

define void @"sha_transform$4"(i64 %arg, [80 x i64]* %arg1) {
"sha_transform$4_latch$0":
  ...
  %i3 = add nsw i64 %arg, -8
  %arrayidx10 = getelementptr inbounds [80 x i64], [80 x i64]* %arg1, i64 0, i64 %i3
  %i4 = load i64, i64* %arrayidx10, align 16, !tbaa !1
  %xor = xor i64 %i4, %i2
  %i5 = add nsw i64 %arg, -14
  %arrayidx13 = getelementptr inbounds [80 x i64], [80 x i64]* %arg1, i64 0, i64 %i5
  %i6 = load i64, i64* %arrayidx13, align 16, !tbaa !1
  %xor14 = xor i64 %xor, %i6
  %i7 = add nsw i64 %arg, -16
  %arrayidx17 = getelementptr inbounds [80 x i64], [80 x i64]* %arg1, i64 0, i64 %i7
  %i8 = load i64, i64* %arrayidx17, align 16, !tbaa !1
  %xor18 = xor i64 %xor14, %i8
  ...
  %i9 = add nsw i64 %arg, -2
  %arrayidx7.1 = getelementptr inbounds [80 x i64], [80 x i64]* %arg1, i64 0, i64 %i9
  %i10 = load i64, i64* %arrayidx7.1, align 16, !tbaa !1
  %i11 = add nsw i64 %arg, -7
  %arrayidx10.1 = getelementptr inbounds [80 x i64], [80 x i64]* %arg1, i64 0, i64 %i11
  %i12 = load i64, i64* %arrayidx10.1, align 8, !tbaa !1
  %xor.1 = xor i64 %i12, %i10
  %i13 = add nsw i64 %arg, -13
  %arrayidx13.1 = getelementptr inbounds [80 x i64], [80 x i64]* %arg1, i64 0, i64 %i13
  %i14 = load i64, i64* %arrayidx13.1, align 8, !tbaa !1
  %xor14.1 = xor i64 %xor.1, %i14
  %i15 = add nsw i64 %arg, -15
  %arrayidx17.1 = getelementptr inbounds [80 x i64], [80 x i64]* %arg1, i64 0, i64 %i15
  %i16 = load i64, i64* %arrayidx17.1, align 8, !tbaa !1
  %xor18.1 = xor i64 %xor14.1, %i16
...
"sha_transform$4_recursively_call_function":      ; preds = %"sha_transform$4_increment_depth_counter"
  call void @"sha_transform$4"(i64 %indvars.iv.next253.1, [80 x i64]* %arg1)
  ret void
...
define void @"sha_stream$0"(i32 %arg, %struct._IO_FILE* %arg1, %struct.SHA_INFO* %arg2, i8* %arg3) {
...
"sha_stream$0_recursively_call_function":         ; preds = %"sha_stream$0_increment_depth_counter"
  call void @"sha_stream$0"(i32 %conv, %struct._IO_FILE* %arg1, %struct.SHA_INFO* %arg2, i8* %arg3)
  ret void
