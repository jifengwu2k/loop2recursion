; ModuleID = './benchmark_intermediate_representations/unoptimized_loop2recursion/sha/sha_driver.ll.temp'
...
"main$0_call_recursive_function":                 ; preds = %while.body.preheader
  call void @"main$0"(i8** %argv, i32 %dec13, %struct.SHA_INFO* %sha_info)
...
define void @"main$0"(i8** %arg, i32 %arg1, %struct.SHA_INFO* %arg2) {
"main$0_header":
...
if.then2:                                         ; preds = %"main$0_header"
  %i3 = load i8*, i8** %incdec.ptr, align 8, !tbaa !1
  %call3 = call i32 (i8*, ...) @printf(i8* nonnull getelementptr inbounds ([30 x i8], [30 x i8]* @.str.1, i64 0, i64 0), i8* %i3)
  br label %"main$0_latch$0"
...
"main$0_recursively_call_function":               ; preds = %"main$0_increment_depth_counter"
  call void @"main$0"(i8** %incdec.ptr, i32 %dec, %struct.SHA_INFO* %arg2)
  ret void
