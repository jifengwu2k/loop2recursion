; ModuleID = './benchmark_intermediate_representations/unoptimized_loop2recursion/pbmsrch/bmhasrch.ll.temp'
...
"bmha_init$1_call_recursive_function":            ; preds = %entry
  call void @"bmha_init$1"(i64 0, i8* %pattern, i32 %conv, i64 %i)
  br label %for.end33
...
"bmha_init$0_call_recursive_function":            ; preds = %for.body38.lr.ph
  call void @"bmha_init$0"(i64 0, i64 %i1, i32 %conv, i8* %pattern, i8 %.pre91)
...
"bmha_search$0_call_recursive_function":          ; preds = %"bmha_search$0_initialize_context"
  call void @"bmha_search$0"(%0* %i4, i32 %sub1, i32 %i2, i8* %i1, i64 %i3, i32 %sub10, i8* %add.ptr, i32 %sub5)
  br label %"bmha_search$0_branch_to_exit"

"bmha_search$0_branch_to_exit":                   ; preds = %"bmha_search$0_call_recursive_function"
  %i5 = getelementptr %0, %0* %i4, i32 0, i32 1
  %i6 = load i8, i8* %i5, align 1
  switch i8 %i6, label %"bmha_search$0_extract_return_values$0" [
...
"bmha_search$0_extract_return_values$0":          ; preds = %"bmha_search$0_branch_to_exit", %"bmha_search$0_branch_to_exit"
  %i7 = getelementptr %0, %0* %i4, i32 0, i32 0
...
cleanup:                                          ; preds = %cleanup.loopexit63, %cleanup.loopexit, %entry
  %retval.0 = phi i8* [ null, %entry ], [ %i8, %cleanup.loopexit ], [ null, %cleanup.loopexit63 ]
  ret i8* %retval.0
}

define void @"bmha_init$0"(i64 %arg, i64 %arg1, i32 %arg2, i8* %arg3, i8 %arg4) {
"bmha_init$0_header":
  ...
  %i5 = load i8, i8* %arrayidx42, align 1, !tbaa !7
  %cmp50 = icmp eq i8 %i5, %arg4
  br i1 %cmp50, label %if.then52, label %"bmha_init$0_latch$0"

if.then52:                                        ; preds = %"bmha_init$0_header"
  %i6 = xor i64 %arg, 4294967295
  %i7 = trunc i64 %i6 to i32
  %sub54 = add i32 %arg2, %i7
...
"bmha_init$0_recursively_call_function":          ; preds = %"bmha_init$0_increment_depth_counter"
  call void @"bmha_init$0"(i64 %indvars.iv.next, i64 %arg1, i32 %arg2, i8* %arg3, i8 %arg4)
  ret void
...
define void @"bmha_init$1"(i64 %arg, i8* %arg1, i32 %arg2, i64 %arg3) {
"bmha_init$1_header":
...
"bmha_init$1$0_call_recursive_function":          ; preds = %"bmha_init$1$0_initialize_context"
  call void @"bmha_init$1$0"(%1* %i, i32 %arg2, i64 %arg3, i8* %arg1, i8* %arrayidx8)
  br label %"bmha_init$1$0_branch_to_exit"

"bmha_init$1$0_branch_to_exit":                   ; preds = %"bmha_init$1$0_call_recursive_function"
  %i4 = getelementptr %1, %1* %i, i32 0, i32 2
  %i5 = load i8, i8* %i4, align 1
  switch i8 %i5, label %"bmha_init$1$0_extract_return_values$0" [
...
if.end24:                                         ; preds = %if.then19, %if.end24.loopexit
  %j.0.in85 = phi i32 [ %i10, %if.end24.loopexit ], [ %i11, %if.then19 ]
...
"bmha_init$1_recursively_call_function":          ; preds = %"bmha_init$1_increment_depth_counter"
  call void @"bmha_init$1"(i64 %indvars.iv.next90, i8* %arg1, i32 %arg2, i64 %arg3)
  ret void
...
define void @"bmha_search$0"(%0* %arg, i32 %arg1, i32 %arg2, i8* %arg3, i64 %arg4, i32 %arg5, i8* %arg6, i32 %arg7) {
...
"bmha_search$0$0_call_recursive_function":        ; preds = %"bmha_search$0$0_initialize_context"
  call void @"bmha_search$0$0"(%2* %i9, i32 %arg5, i64 %arg4, i8* %arg3, i8* %add.ptr13)
...
"bmha_search$0$0_branch_to_exit":                 ; preds = %"bmha_search$0$0_call_recursive_function"
  ...
  switch i8 %i11, label %"bmha_search$0_exiting$1" [
...
"bmha_search$0_recursively_call_function":        ; preds = %"bmha_search$0_increment_depth_counter"
  call void @"bmha_search$0"(%0* %arg, i32 %i.0.be, i32 %arg2, i8* %arg3, i64 %arg4, i32 %arg5, i8* %arg6, i32 %arg7)
  ret void

"bmha_search$0_return_from_recursive_function$0": ; preds = %"bmha_search$0$0_branch_to_exit"
  %i12 = getelementptr %0, %0* %arg, i32 0, i32 0
...
"bmha_search$0_return_from_recursive_function$1": ; preds = %"bmha_search$0_exiting$1", %"bmha_search$0_exiting$0"
  %i14 = getelementptr %0, %0* %arg, i32 0, i32 1
  store i8 2, i8* %i14, align 1
  ret void
}

define void @"bmha_init$1$0"(%1* %arg, i32 %arg1, i64 %arg2, i8* %arg3, i8* %arg4) {
...
"bmha_init$1$0_recursively_call_function":        ; preds = %"bmha_init$1$0_increment_depth_counter"
  call void @"bmha_init$1$0"(%1* %arg, i32 %j.0, i64 %indvars.iv.next88, i8* %arg3, i8* %arg4)
  ret void

"bmha_init$1$0_return_from_recursive_function$0": ; preds = %"bmha_init$1$0_latch$0"
  %i7 = getelementptr %1, %1* %arg, i32 0, i32 1
  store i64 %arg2, i64* %i7, align 8
  %i8 = getelementptr %1, %1* %arg, i32 0, i32 2
  store i8 1, i8* %i8, align 1
  ret void

"bmha_init$1$0_return_from_recursive_function$1": ; preds = %"bmha_init$1$0_exiting$1"
  %i9 = getelementptr %1, %1* %arg, i32 0, i32 0
  store i64 %arg2, i64* %i9, align 8
  %i10 = getelementptr %1, %1* %arg, i32 0, i32 2
  store i8 0, i8* %i10, align 1
  ret void
}

define void @"bmha_search$0$0"(%2* %arg, i32 %arg1, i64 %arg2, i8* %arg3, i8* %arg4) {
...
"bmha_search$0$0_recursively_call_function":      ; preds = %"bmha_search$0$0_increment_depth_counter"
  call void @"bmha_search$0$0"(%2* %arg, i32 %dec, i64 %indvars.iv.next, i8* %arg3, i8* %arg4)
  ret void
