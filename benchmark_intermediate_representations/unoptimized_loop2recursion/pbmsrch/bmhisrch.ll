; ModuleID = './benchmark_intermediate_representations/unoptimized_loop2recursion/pbmsrch/bmhisrch.ll.temp'
...
"bmhi_init$3_call_recursive_function":            ; preds = %"bmhi_init$3_initialize_context"
  call void @"bmhi_init$3"(%0* %i7, i64 %xtraiter, i64 0, i8* %i3, i8* %pattern, i32** %call7)
...
"bmhi_init$3_extract_return_values$0":            ; preds = %"bmhi_init$3_call_recursive_function"
  %i8 = getelementptr %0, %0* %i7, i32 0, i32 0
...
for.body.lr.ph.split:                             ; preds = %for.body.lr.ph.split.loopexit, %for.body.lr.ph
  %indvars.iv116.unr = phi i64 [ 0, %for.body.lr.ph ], [ %i9, %for.body.lr.ph.split.loopexit ]
  %i10 = icmp ult i64 %i6, 3
  br i1 %i10, label %vector.ph.loopexit, label %for.body.lr.ph.split.split

for.body.lr.ph.split.split:                       ; preds = %for.body.lr.ph.split
  br label %"bmhi_init$2_call_recursive_function"

"bmhi_init$2_call_recursive_function":            ; preds = %for.body.lr.ph.split.split
  call void @"bmhi_init$2"(i64 %indvars.iv116.unr, i64 %i4, i8* %i3, i8* %pattern, i32** %call7)
...
for.body24.lr.ph:                                 ; preds = %vector.body
  ...
  %i11 = load i32*, i32** %call39, align 8
  %i12 = sext i32 %sub103 to i64
  br label %"bmhi_init$1_call_recursive_function"

"bmhi_init$1_call_recursive_function":            ; preds = %for.body24.lr.ph
  call void @"bmhi_init$1"(i32 0, i64 0, i32 0, i64 %i12, i32* %i11, i32 %i1, i8* %i2)
...
for.end46:                                        ; preds = %for.end46.loopexit, %for.cond21.preheader.for.end46_crit_edge
  %idxprom48.pre-phi = phi i64 [ %.pre118, %for.cond21.preheader.for.end46_crit_edge ], [ %i12, %for.end46.loopexit ]
  %arrayidx49 = getelementptr inbounds i8, i8* %i2, i64 %idxprom48.pre-phi
  %i13 = load i8, i8* %arrayidx49, align 1, !tbaa !7
  %conv50 = zext i8 %i13 to i32
  %idxprom51 = zext i8 %i13 to i64
  ...
  %i14 = icmp ult i32 %__c.off.i, 384
  br i1 %i14, label %cond.true.i, label %tolower.exit

cond.true.i:                                      ; preds = %for.end46
  %call.i = tail call i32** @__ctype_tolower_loc() #9
  %i15 = load i32*, i32** %call.i, align 8, !tbaa !5
  %arrayidx.i = getelementptr inbounds i32, i32* %i15, i64 %idxprom51
  %i16 = load i32, i32* %arrayidx.i, align 4, !tbaa !1
  br label %tolower.exit

tolower.exit:                                     ; preds = %cond.true.i, %for.end46
  %cond.i = phi i32 [ %i16, %cond.true.i ], [ %conv50, %for.end46 ]
...
"bmhi_init$0_call_recursive_function":            ; preds = %for.body63.preheader
  call void @"bmhi_init$0"(i64 0, i64 %idxprom48.pre-phi, i32 %i1, i8* %i2, i8 %i13)
...
"bmhi_search$0_call_recursive_function":          ; preds = %"bmhi_search$0_initialize_context"
  call void @"bmhi_search$0"(%1* %i4, i32 %sub1, i32 %i2, i8* %i1, i64 %i3, i32 %sub10, i8* %add.ptr, i32 %sub5)
...
"bmhi_search$0_branch_to_exit":                   ; preds = %"bmhi_search$0_call_recursive_function"
  ...
  switch i8 %i6, label %"bmhi_search$0_extract_return_values$0" [
...
cleanup:                                          ; preds = %cleanup.loopexit62, %cleanup.loopexit, %entry
  %retval.0 = phi i8* [ null, %entry ], [ %i8, %cleanup.loopexit ], [ null, %cleanup.loopexit62 ]
  ret i8* %retval.0
}
...
define void @"bmhi_init$0"(i64 %arg, i64 %arg1, i32 %arg2, i8* %arg3, i8 %arg4) {
"bmhi_init$0_header":
...
"bmhi_init$0_recursively_call_function":          ; preds = %"bmhi_init$0_increment_depth_counter"
  call void @"bmhi_init$0"(i64 %indvars.iv.next, i64 %arg1, i32 %arg2, i8* %arg3, i8 %arg4)
  ret void
...
define void @"bmhi_init$1"(i32 %arg, i64 %arg1, i32 %arg2, i64 %arg3, i32* %arg4, i32 %arg5, i8* %arg6) {
"bmhi_init$1_latch$0":
...
"bmhi_init$1_recursively_call_function":          ; preds = %"bmhi_init$1_increment_depth_counter"
  call void @"bmhi_init$1"(i32 %inc45, i64 %indvars.iv.next112, i32 %i.2.neg, i64 %arg3, i32* %arg4, i32 %arg5, i8* %arg6)
  ret void
...
define void @"bmhi_init$2"(i64 %arg, i64 %arg1, i8* %arg2, i8* %arg3, i32** %arg4) {
"bmhi_init$2_latch$0":
  %arrayidx = getelementptr inbounds i8, i8* %arg3, i64 %arg
  %i = load i8, i8* %arrayidx, align 1, !tbaa !7
  %idxprom6 = sext i8 %i to i64
  %i5 = load i32*, i32** %arg4, align 8, !tbaa !5
  %arrayidx8 = getelementptr inbounds i32, i32* %i5, i64 %idxprom6
  %i6 = load i32, i32* %arrayidx8, align 4, !tbaa !1
  %conv9 = trunc i32 %i6 to i8
  ...
  %i8 = load i32*, i32** %arg4, align 8, !tbaa !5
  %arrayidx8.1 = getelementptr inbounds i32, i32* %i8, i64 %idxprom6.1
  %i9 = load i32, i32* %arrayidx8.1, align 4, !tbaa !1
  %conv9.1 = trunc i32 %i9 to i8
  ...
  %i10 = load i8, i8* %arrayidx.2, align 1, !tbaa !7
  %idxprom6.2 = sext i8 %i10 to i64
  %i11 = load i32*, i32** %arg4, align 8, !tbaa !5
  %arrayidx8.2 = getelementptr inbounds i32, i32* %i11, i64 %idxprom6.2
  %i12 = load i32, i32* %arrayidx8.2, align 4, !tbaa !1
  %conv9.2 = trunc i32 %i12 to i8
  ...
  %i13 = load i8, i8* %arrayidx.3, align 1, !tbaa !7
  %idxprom6.3 = sext i8 %i13 to i64
  %i14 = load i32*, i32** %arg4, align 8, !tbaa !5
  %arrayidx8.3 = getelementptr inbounds i32, i32* %i14, i64 %idxprom6.3
  %i15 = load i32, i32* %arrayidx8.3, align 4, !tbaa !1
  %conv9.3 = trunc i32 %i15 to i8
...
"bmhi_init$2_recursively_call_function":          ; preds = %"bmhi_init$2_increment_depth_counter"
  call void @"bmhi_init$2"(i64 %indvars.iv.next117.3, i64 %arg1, i8* %arg2, i8* %arg3, i32** %arg4)
  ret void
...
define void @"bmhi_init$3"(%0* %arg, i64 %arg1, i64 %arg2, i8* %arg3, i8* %arg4, i32** %arg5) {
"bmhi_init$3_latch$0":
  ...
  %i6 = load i32*, i32** %arg5, align 8, !tbaa !5
  %arrayidx8.prol = getelementptr inbounds i32, i32* %i6, i64 %idxprom6.prol
  %i7 = load i32, i32* %arrayidx8.prol, align 4, !tbaa !1
  %conv9.prol = trunc i32 %i7 to i8
...
"bmhi_init$3_recursively_call_function":          ; preds = %"bmhi_init$3_increment_depth_counter"
  call void @"bmhi_init$3"(%0* %arg, i64 %prol.iter.sub, i64 %indvars.iv.next117.prol, i8* %arg3, i8* %arg4, i32** %arg5)
  ret void

"bmhi_init$3_return_from_recursive_function$0":   ; preds = %"bmhi_init$3_latch$0"
  %i8 = getelementptr %0, %0* %arg, i32 0, i32 0
  store i64 %indvars.iv.next117.prol, i64* %i8, align 8
  ret void
}

define void @"bmhi_search$0"(%1* %arg, i32 %arg1, i32 %arg2, i8* %arg3, i64 %arg4, i32 %arg5, i8* %arg6, i32 %arg7) {
"bmhi_search$0_header":
  ...
  %i8 = load i32, i32* %arrayidx3, align 4, !tbaa !1
...
"bmhi_search$0$0_call_recursive_function":        ; preds = %"bmhi_search$0$0_initialize_context"
  call void @"bmhi_search$0$0"(%2* %i9, i32 %arg5, i64 %arg4, i8* %arg3, i8* %add.ptr13)
...
"bmhi_search$0$0_branch_to_exit":                 ; preds = %"bmhi_search$0$0_call_recursive_function"
  ...
  switch i8 %i11, label %"bmhi_search$0_exiting$0" [
...
"bmhi_search$0_recursively_call_function":        ; preds = %"bmhi_search$0_increment_depth_counter"
  call void @"bmhi_search$0"(%1* %arg, i32 %i.0.be, i32 %arg2, i8* %arg3, i64 %arg4, i32 %arg5, i8* %arg6, i32 %arg7)
  ret void
...
define void @"bmhi_search$0$0"(%2* %arg, i32 %arg1, i64 %arg2, i8* %arg3, i8* %arg4) {
...
"bmhi_search$0$0_latch$0":                        ; preds = %"bmhi_search$0$0_exiting$1"
  ...
  %i5 = load i32*, i32** %call, align 8, !tbaa !5
  %arrayidx19 = getelementptr inbounds i32, i32* %i5, i64 %idxprom18
  %i6 = load i32, i32* %arrayidx19, align 4, !tbaa !1
...
"bmhi_search$0$0_recursively_call_function":      ; preds = %"bmhi_search$0$0_increment_depth_counter"
  call void @"bmhi_search$0$0"(%2* %arg, i32 %dec, i64 %indvars.iv.next, i8* %arg3, i8* %arg4)
  ret void
...
"bmhi_search$0$0_return_from_recursive_function$1": ; preds = %"bmhi_search$0$0_exiting$1"
  %i9 = getelementptr %2, %2* %arg, i32 0, i32 0
