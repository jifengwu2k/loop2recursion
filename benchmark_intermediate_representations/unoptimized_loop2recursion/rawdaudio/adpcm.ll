; ModuleID = './benchmark_intermediate_representations/unoptimized_loop2recursion/rawdaudio/adpcm.ll.temp'
...
"adpcm_coder$0_call_recursive_function":          ; preds = %"adpcm_coder$0_initialize_context"
  call void @"adpcm_coder$0"(%0* %i3, i32 1, i32 %conv2, i32 undef, i32 %conv, i16* %indata, i32 %i2, i8* %outdata, i32 %len)
...
"adpcm_coder$0_extract_return_values$0":          ; preds = %"adpcm_coder$0_call_recursive_function"
  ...
  %i6 = getelementptr %0, %0* %i3, i32 0, i32 1
  %i7 = load i1, i1* %i6, align 1
  %i8 = getelementptr %0, %0* %i3, i32 0, i32 2
  %i9 = load i32, i32* %i8, align 4
  %i10 = getelementptr %0, %0* %i3, i32 0, i32 3
  %i11 = load i32, i32* %i10, align 4
  %i12 = getelementptr %0, %0* %i3, i32 0, i32 4
  %i13 = load i8*, i8** %i12, align 8
  br label %for.end

for.end:                                          ; preds = %"adpcm_coder$0_extract_return_values$0"
  br i1 %i7, label %if.then65, label %if.end68

if.then65:                                        ; preds = %for.end
  %conv66 = trunc i32 %i11 to i8
  store i8 %conv66, i8* %i13, align 1, !tbaa !9
  br label %if.end68

if.end68:                                         ; preds = %if.then65, %for.end, %entry
  %valpred.0.lcssa141 = phi i32 [ %i5, %for.end ], [ %i5, %if.then65 ], [ %conv, %entry ]
  %index.0.lcssa140 = phi i32 [ %i9, %for.end ], [ %i9, %if.then65 ], [ %conv2, %entry ]
...
"adpcm_decoder$0_call_recursive_function":        ; preds = %"adpcm_decoder$0_initialize_context"
  call void @"adpcm_decoder$0"(%1* %i3, i8* %indata, i32 %len, i32 undef, i32 0, i32 %conv2, i32 %conv, i16* %outdata, i32 %i2)
...
"adpcm_decoder$0_extract_return_values$0":        ; preds = %"adpcm_decoder$0_call_recursive_function"
  %i4 = getelementptr %1, %1* %i3, i32 0, i32 0
  %i5 = load i32, i32* %i4, align 4
  %i6 = getelementptr %1, %1* %i3, i32 0, i32 1
...
for.end:                                          ; preds = %for.end.loopexit, %entry
  %index.0.lcssa = phi i32 [ %conv2, %entry ], [ %i5, %for.end.loopexit ]
  %valpred.0.lcssa = phi i32 [ %conv, %entry ], [ %i7, %for.end.loopexit ]
...
define void @"adpcm_coder$0"(%0* %arg, i32 %arg1, i32 %arg2, i32 %arg3, i32 %arg4, i16* %arg5, i32 %arg6, i8* %arg7, i32 %arg8) {
...
"adpcm_coder$0_recursively_call_function":        ; preds = %"adpcm_coder$0_increment_depth_counter"
  call void @"adpcm_coder$0"(%0* %arg, i32 %lnot.ext, i32 %..add44, i32 %outputbuffer.1, i32 %valpred.2, i16* %incdec.ptr, i32 %i14, i8* %outp.1, i32 %dec)
  ret void

"adpcm_coder$0_return_from_recursive_function$0": ; preds = %"adpcm_coder$0_latch$0"
  %i16 = getelementptr %0, %0* %arg, i32 0, i32 0
  store i32 %valpred.2, i32* %i16, align 4
  %i17 = getelementptr %0, %0* %arg, i32 0, i32 1
  store i1 %tobool55, i1* %i17, align 1
  %i18 = getelementptr %0, %0* %arg, i32 0, i32 2
  store i32 %..add44, i32* %i18, align 4
  %i19 = getelementptr %0, %0* %arg, i32 0, i32 3
  store i32 %outputbuffer.1, i32* %i19, align 4
  %i20 = getelementptr %0, %0* %arg, i32 0, i32 4
  store i8* %outp.1, i8** %i20, align 8
  ret void
}

define void @"adpcm_decoder$0"(%1* %arg, i8* %arg1, i32 %arg2, i32 %arg3, i32 %arg4, i32 %arg5, i32 %arg6, i16* %arg7, i32 %arg8) {
...
"adpcm_decoder$0_recursively_call_function":      ; preds = %"adpcm_decoder$0_increment_depth_counter"
  call void @"adpcm_decoder$0"(%1* %arg, i8* %inp.1, i32 %dec, i32 %inputbuffer.1, i32 %lnot.ext, i32 %..add, i32 %valpred.2, i16* %incdec.ptr54, i32 %i12)
  ret void

"adpcm_decoder$0_return_from_recursive_function$0": ; preds = %"adpcm_decoder$0_latch$0"
  %i13 = getelementptr %1, %1* %arg, i32 0, i32 0
  store i32 %..add, i32* %i13, align 4
  %i14 = getelementptr %1, %1* %arg, i32 0, i32 1
  store i32 %valpred.2, i32* %i14, align 4
  ret void
}
