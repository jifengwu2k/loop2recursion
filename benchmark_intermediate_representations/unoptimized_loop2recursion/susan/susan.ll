; ModuleID = './benchmark_intermediate_representations/unoptimized_loop2recursion/susan/susan.ll.temp'
...
"getint$1_call_recursive_function":               ; preds = %"getint$1_initialize_context"
  call void @"getint$1"(%0* %i1, i32 %call, %struct._IO_FILE* %fd, i8* %i)
  br label %"getint$1_branch_to_exit"

"getint$1_branch_to_exit":                        ; preds = %"getint$1_call_recursive_function"
  %i2 = getelementptr %0, %0* %i1, i32 0, i32 1
  %i3 = load i8, i8* %i2, align 1
  switch i8 %i3, label %"getint$1_extract_return_values$0" [
...
"getint$1_extract_return_values$0":               ; preds = %"getint$1_branch_to_exit", %"getint$1_branch_to_exit"
  %i4 = getelementptr %0, %0* %i1, i32 0, i32 0
...
if.then3:                                         ; preds = %"getint$1_extract_return_values$1"
  %i6 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !1
  %call4 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %i6, i8* nonnull getelementptr inbounds ([26 x i8], [26 x i8]* @.str.13, i64 0, i64 0), i8* nonnull getelementptr inbounds ([3 x i8], [3 x i8]* @.str.14, i64 0, i64 0)) #11
...
"int_to_uchar$2_call_recursive_function":         ; preds = %"int_to_uchar$2_initialize_context"
  call void @"int_to_uchar$2"(%2* %i24, <4 x i32> %vec.phi74.unr, <4 x i32> %vec.phi73.unr, <4 x i32> %vec.phi72.unr, i64 %index.unr, <4 x i32> %vec.phi.unr, i64 %n.vec, i32* %r)
...
"int_to_uchar$2_extract_return_values$0":         ; preds = %"int_to_uchar$2_call_recursive_function"
  %i25 = getelementptr %2, %2* %i24, i32 0, i32 0
  %i26 = load <4 x i32>, <4 x i32>* %i25, align 16
  %i27 = getelementptr %2, %2* %i24, i32 0, i32 1
  %i28 = load <4 x i32>, <4 x i32>* %i27, align 16
  %i29 = getelementptr %2, %2* %i24, i32 0, i32 2
  %i30 = load <4 x i32>, <4 x i32>* %i29, align 16
  %i31 = getelementptr %2, %2* %i24, i32 0, i32 3
...
middle.block:                                     ; preds = %middle.block.unr-lcssa, %vector.body.preheader.split
  %.lcssa98 = phi <4 x i32> [ %.lcssa98.unr, %vector.body.preheader.split ], [ %i30, %middle.block.unr-lcssa ]
  %.lcssa97 = phi <4 x i32> [ %.lcssa97.unr, %vector.body.preheader.split ], [ %i32, %middle.block.unr-lcssa ]
  %.lcssa96 = phi <4 x i32> [ %.lcssa96.unr, %vector.body.preheader.split ], [ %i28, %middle.block.unr-lcssa ]
  %.lcssa = phi <4 x i32> [ %.lcssa.unr, %vector.body.preheader.split ], [ %i26, %middle.block.unr-lcssa ]
  ...
  %i33 = select i1 %rdx.minmax.cmp91.elt, i32 %rdx.minmax.select89.elt, i32 %rdx.shuf90.elt
  ...
  %i34 = select i1 %rdx.minmax.cmp81.elt, i32 %rdx.minmax.select79.elt, i32 %rdx.shuf80.elt
...
for.body.for.body_crit_edge.preheader:            ; preds = %middle.block, %min.iters.checked, %for.body.for.body_crit_edge.lr.ph
  ...
  %min_r.168.ph = phi i32 [ %i, %min.iters.checked ], [ %i, %for.body.for.body_crit_edge.lr.ph ], [ %i34, %middle.block ]
  %.max_r.067.ph = phi i32 [ %i, %min.iters.checked ], [ %i, %for.body.for.body_crit_edge.lr.ph ], [ %i33, %middle.block ]
  br label %"int_to_uchar$1_initialize_context"

"int_to_uchar$1_initialize_context":              ; preds = %for.body.for.body_crit_edge.preheader
  %i35 = alloca %3, align 8
...
"int_to_uchar$1_call_recursive_function":         ; preds = %"int_to_uchar$1_initialize_context"
  call void @"int_to_uchar$1"(%3* %i35, i32 %.max_r.067.ph, i64 %indvars.iv.next5569.ph, i32 %min_r.168.ph, i32 %size, i32* %r)
...
"int_to_uchar$1_extract_return_values$0":         ; preds = %"int_to_uchar$1_call_recursive_function"
  %i36 = getelementptr %3, %3* %i35, i32 0, i32 0
  %i37 = load i32, i32* %i36, align 4
  %i38 = getelementptr %3, %3* %i35, i32 0, i32 1
...
for.end:                                          ; preds = %for.end.loopexit, %middle.block, %for.body.preheader
  %min_r.1.lcssa = phi i32 [ %i, %for.body.preheader ], [ %i34, %middle.block ], [ %i39, %for.end.loopexit ]
  %.max_r.0.lcssa = phi i32 [ %i, %for.body.preheader ], [ %i33, %middle.block ], [ %i37, %for.end.loopexit ]
...
for.body15.for.body15_crit_edge.preheader.split:  ; preds = %for.body15.for.body15_crit_edge.prol, %for.body15.for.body15_crit_edge.preheader
  ...
  %i41 = icmp eq i32 %size, 2
  br i1 %i41, label %for.end23.loopexit, label %for.body15.for.body15_crit_edge.preheader.split.split
...
"int_to_uchar$0_call_recursive_function":         ; preds = %for.body15.for.body15_crit_edge.preheader.split.split
  call void @"int_to_uchar$0"(i64 %indvars.iv.next65.unr, i8* %in, i32 %sub, i32* %r, i32 %size, i32 %min_r.1.lcssa)
...
"setup_brightness_lut$0_call_recursive_function": ; preds = %entry
  call void @"setup_brightness_lut$0"(i64 -256, float %conv1, i8** %bp, i1 %cmp2)
  br label %for.end
...
"susan_principle$0_call_recursive_function":      ; preds = %for.cond3.preheader.lr.ph
  call void @"susan_principle$0"(i64 3, i32 %sub, i32 %sub4, i32* %r, i32 %max_no, i64 %idx.ext124, i1 %cmp5429, i8* %in, i8* %bp, i64 %idx.ext36, i64 %i1, i64 %idx.ext73)
...
"susan_principle_small$0_call_recursive_function": ; preds = %for.cond3.preheader.lr.ph
  call void @"susan_principle_small$0"(i64 1, i32 %sub, i32 %sub4, i64 %i1, i64 %idx.ext36, i1 %cmp5133, i8* %in, i8* %bp, i32* %r)
...
"enlarge$2_call_recursive_function":              ; preds = %for.body.lr.ph
  call void @"enlarge$2"(i32 0, i32* %y_size, i32* %x_size, i32 %mul, i8* %tmp_image, i32 %border, i64 %idx.ext3, i8** %in)
...
"enlarge$1_call_recursive_function":              ; preds = %for.body11.lr.ph
  call void @"enlarge$1"(i32 0, i32 0, i32 %border, i32* %x_size, i32* %y_size, i64 %idx.ext18, i32 %sub, i32 %mul13, i8* %tmp_image, i8** %in)
...
"enlarge$0_call_recursive_function":              ; preds = %for.cond46.preheader.lr.ph
  call void @"enlarge$0"(i32 0, i32 %.pre, i32 0, i8* %tmp_image, i32 %border, i32* %y_size, i32 %mul47, i32* %x_size)
...
"susan_smoothing$2_call_recursive_function":      ; preds = %for.cond144.preheader.preheader
  call void @"susan_smoothing$2"(i32 1, i8* %in, i32 %i, i32 %.pre, i32* %y_size.addr, i32* %x_size.addr, i8** %in.addr, i8* %bp)
...
"susan_smoothing$1_call_recursive_function":      ; preds = %for.body55.lr.ph.preheader
  call void @"susan_smoothing$1"(i32 %sub48, i8* %call45, i32 %mask_size.0, i32 %sub48, float %sub47)
...
"susan_smoothing$0_call_recursive_function":      ; preds = %for.cond73.preheader.lr.ph
  call void @"susan_smoothing$0"(i32 %i2, i32 %mask_size.0, i8* %in, i32* %y_size.addr, i64 %idx.ext114, i32 %sub48, i8* %call45, i64 %idx.neg, i32* %x_size.addr, i64 %idx.ext82, i8** %in.addr, i32 %mask_size.0, i8* %bp, i1 %cmp49470)
...
"edge_draw$1_call_recursive_function":            ; preds = %for.body.lr.ph
  call void @"edge_draw$1"(i32 0, i8* %mid, i32 %mul, i64 %idx.ext8, i64 %sub.ptr.rhs.cast, i64 %idx.neg, i8* %in)
...
"edge_draw$0_call_recursive_function":            ; preds = %for.body23.lr.ph.split.split
  call void @"edge_draw$0"(i32 %i.168.unr, i8* %midp.169.unr, i32 %mul, i64 %sub.ptr.rhs.cast29, i8* %in)
...
"susan_thin$0_call_recursive_function":           ; preds = %for.cond1.preheader.lr.ph
  call void @"susan_thin$0"(i32 undef, i32 4, i32 undef, i32 %sub, i32 %x_size, i1 %cmp31202, i64 %idx.ext29, i8* %mid, i32* %r, i32 %sub2)
...
"susan_edges$1_call_recursive_function":          ; preds = %for.cond3.preheader.lr.ph
  call void @"susan_edges$1"(i64 3, i32 %sub, i32 %sub4, i32* %r, i32 %max_no, i64 %idx.ext124, i64 %i1, i1 %cmp52042, i64 %idx.ext36, i8* %in, i8* %bp, i64 %idx.ext73)
...
"susan_edges$0_call_recursive_function":          ; preds = %for.cond293.preheader.lr.ph
  call void @"susan_edges$0"(i64 4, i32 %sub294, i8* %mid, i32 %sub289, i32 %x_size, i64 %idx.ext407, i64 %idx.ext355, i64 %idx.ext474, i8* %in, i1 %cmp2952036, i32* %r, i64 %i2, i32 %max_no, i8* %bp)
...
"susan_edges_small$1_call_recursive_function":    ; preds = %for.cond3.preheader.lr.ph
  call void @"susan_edges_small$1"(i64 1, i32 %sub, i32 %sub4, i64 %i1, i1 %cmp5642, i64 %idx.ext36, i8* %bp, i8* %in, i32* %r)
...
"susan_edges_small$0_call_recursive_function":    ; preds = %for.cond89.preheader.lr.ph
  call void @"susan_edges_small$0"(i64 2, i32 %sub90, i8* %mid, i32 %x_size, i1 %cmp91636, i32 %sub85, i32* %r, i64 %idx.ext148, i8* %in, i64 %i2, i8* %bp)
...
"corner_draw$0_call_recursive_function":          ; preds = %while.body.lr.ph
  call void @"corner_draw$0"(%struct.anon* %corner_list, i64 0, i64 %idx.ext11, i8* %in, i32 %x_size, %struct.anon* %corner_list, i1 %cmp1)
...
"susan_corners$1_call_recursive_function":        ; preds = %for.cond10.preheader.lr.ph
  call void @"susan_corners$1"(i64 5, i32 %sub, i32* %i2, i32 %x_size, i32 %sub11, i32 %max_no, i64 %idx.ext131, i64 %i3, i8* %in, i32* %r, i64 %idx.ext80, i8* %bp, i32* %i1, i1 %cmp122173, i64 %idx.ext43)
...
"susan_corners$0_call_recursive_function":        ; preds = %"susan_corners$0_initialize_context"
  call void @"susan_corners$0"(%4* %i7, i32 0, i64 5, i64 %i6, i64 %i4, i8* %in, i64 %i5, i1 %cmp9182165, i32* %r, i32* %i2, %struct.anon* %corner_list, i32* %i1)
...
"susan_corners$0_branch_to_exit":                 ; preds = %"susan_corners$0_call_recursive_function"
  ...
  switch i8 %i9, label %"susan_corners$0_extract_return_values$0" [
...
if.then1377:                                      ; preds = %"susan_corners$0_extract_return_values$1"
  ...
  %i13 = tail call i64 @fwrite(i8* nonnull getelementptr inbounds ([19 x i8], [19 x i8]* @.str.29, i64 0, i64 0), i64 18, i64 1, %struct._IO_FILE* %i12) #11
...
for.end1387:                                      ; preds = %for.end1387.loopexit, %for.cond911.preheader, %entry
  %n.0.lcssa = phi i32 [ 0, %for.cond911.preheader ], [ 0, %entry ], [ %i11, %for.end1387.loopexit ]
...
"susan_corners_quick$1_call_recursive_function":  ; preds = %for.cond3.preheader.lr.ph
  call void @"susan_corners_quick$1"(i64 7, i32 %sub, i32* %r, i32 %sub4, i64 %idx.ext124, i64 %i1, i64 %idx.ext36, i1 %cmp52051, i8* %in, i8* %bp, i32 %max_no, i64 %idx.ext73)
...
"susan_corners_quick$0_call_recursive_function":  ; preds = %"susan_corners_quick$0_initialize_context"
  call void @"susan_corners_quick$0"(%5* %i5, i32 0, i64 7, i64 %i3, i1 %cmp3672043, i8* %in, i64 %i2, i32* %r, i64 %i4, %struct.anon* %corner_list)
...
"susan_corners_quick$0_branch_to_exit":           ; preds = %"susan_corners_quick$0_call_recursive_function"
  %i6 = getelementptr %5, %5* %i5, i32 0, i32 1
  %i7 = load i8, i8* %i6, align 1
  switch i8 %i7, label %"susan_corners_quick$0_extract_return_values$0" [
...
"susan_corners_quick$0_extract_return_values$0":  ; preds = %"susan_corners_quick$0_branch_to_exit", %"susan_corners_quick$0_branch_to_exit"
  %i8 = getelementptr %5, %5* %i5, i32 0, i32 0
  %i9 = load i32, i32* %i8, align 4
...
if.then1316:                                      ; preds = %"susan_corners_quick$0_extract_return_values$1"
  ...
  %i11 = tail call i64 @fwrite(i8* nonnull getelementptr inbounds ([19 x i8], [19 x i8]* @.str.29, i64 0, i64 0), i64 18, i64 1, %struct._IO_FILE* %i10) #11
  tail call void @exit(i32 1) #10
  unreachable
...
for.end1325:                                      ; preds = %for.end1325.loopexit, %for.cond360.preheader, %entry
  %n.0.lcssa = phi i32 [ 0, %for.cond360.preheader ], [ 0, %entry ], [ %i9, %for.end1325.loopexit ]
...
"main$12_call_recursive_function":                ; preds = %"main$12_initialize_context"
  call void @"main$12"(%6* %i5, i32 0, i32 0, i32 20, i32 0, i32 3, i32 0, i32 0, float 4.000000e+00, i32 1, i32 %argc, i8** %argv)
  br label %"main$12_branch_to_exit"

"main$12_branch_to_exit":                         ; preds = %"main$12_call_recursive_function"
  %i6 = getelementptr %6, %6* %i5, i32 0, i32 8
  %i7 = load i8, i8* %i6, align 1
  switch i8 %i7, label %"main$12_extract_return_values$0" [
...
"main$12_extract_return_values$0":                ; preds = %"main$12_branch_to_exit", %"main$12_branch_to_exit"
  %i8 = getelementptr %6, %6* %i5, i32 0, i32 0
  %i9 = load i32, i32* %i8, align 4
  %i10 = getelementptr %6, %6* %i5, i32 0, i32 1
  %i11 = load i32, i32* %i10, align 4
  %i12 = getelementptr %6, %6* %i5, i32 0, i32 2
  %i13 = load float, float* %i12, align 4
  %i14 = getelementptr %6, %6* %i5, i32 0, i32 3
  %i15 = load i32, i32* %i14, align 4
  %i16 = getelementptr %6, %6* %i5, i32 0, i32 4
  %i17 = load i32, i32* %i16, align 4
  %i18 = getelementptr %6, %6* %i5, i32 0, i32 5
  %i19 = load i32, i32* %i18, align 4
  %i20 = getelementptr %6, %6* %i5, i32 0, i32 6
  %i21 = load i32, i32* %i20, align 4
  %i22 = getelementptr %6, %6* %i5, i32 0, i32 7
...
while.end:                                        ; preds = %while.end.loopexit, %if.end
  %mode.0.lcssa = phi i32 [ 0, %if.end ], [ %i17, %while.end.loopexit ]
  %dt.0.lcssa = phi float [ 4.000000e+00, %if.end ], [ %i13, %while.end.loopexit ]
  %susan_quick.0.lcssa = phi i32 [ 0, %if.end ], [ %i19, %while.end.loopexit ]
  %drawing_mode.0.lcssa = phi i32 [ 0, %if.end ], [ %i21, %while.end.loopexit ]
  %three_by_three.0.lcssa = phi i32 [ 0, %if.end ], [ %i23, %while.end.loopexit ]
  %thin_post_proc.0.lcssa = phi i32 [ 1, %if.end ], [ %i15, %while.end.loopexit ]
  %principle.0.lcssa = phi i32 [ 0, %if.end ], [ %i9, %while.end.loopexit ]
  %bt.0.lcssa = phi i32 [ 20, %if.end ], [ %i11, %while.end.loopexit ]
...
"main$0_call_recursive_function":                 ; preds = %sw.bb47
  call void @"main$0"(i64 -256, i8* %add.ptr.i, float %conv1.i)
  br label %setup_brightness_lut.exit

setup_brightness_lut.exit:                        ; preds = %"main$0_call_recursive_function"
  %i24 = load i8*, i8** %in, align 8, !tbaa !1
  %conv48 = fpext float %dt.0.lcssa to double
  %i25 = load i32, i32* %x_size, align 4, !tbaa !5
  %i26 = load i32, i32* %y_size, align 4, !tbaa !5
  tail call void @susan_smoothing(i32 %three_by_three.0.lcssa, i8* %i24, double %conv48, i32 %i25, i32 %i26, i8* nonnull %add.ptr.i)
  br label %sw.epilog101

sw.bb49:                                          ; preds = %while.end
  %i27 = load i32, i32* %x_size, align 4, !tbaa !5
  %i28 = load i32, i32* %y_size, align 4, !tbaa !5
  %mul = mul i32 %i28, %i27
...
"main$6_call_recursive_function":                 ; preds = %sw.bb49
  call void @"main$6"(i64 -256, i8* %add.ptr.i160, float %conv1.i161)
  br label %setup_brightness_lut.exit178

setup_brightness_lut.exit178:                     ; preds = %"main$6_call_recursive_function"
  %i29 = bitcast i8* %call52 to i32*
...
if.then53:                                        ; preds = %setup_brightness_lut.exit178
  ...
  %i30 = load i8*, i8** %in, align 8, !tbaa !1
  br i1 %tobool54, label %if.else57, label %if.then55

if.then55:                                        ; preds = %if.then53
  %call56 = tail call i32 @susan_principle_small(i8* %i30, i32* %i29, i8* nonnull %add.ptr.i160, i32 undef, i32 %i27, i32 %i28)
  br label %if.end59

if.else57:                                        ; preds = %if.then53
  %call58 = tail call i32 @susan_principle(i8* %i30, i32* %i29, i8* nonnull %add.ptr.i160, i32 2650, i32 %i27, i32 %i28)
  br label %if.end59

if.end59:                                         ; preds = %if.else57, %if.then55
  %i31 = load i32, i32* %i29, align 4, !tbaa !5
...
for.body.for.body_crit_edge.i.preheader:          ; preds = %for.body.i179.preheader
  ...
  %i35 = add nuw nsw i64 %i34, 1
  %min.iters.check385 = icmp ult i64 %i35, 8
...
vector.body382.preheader:                         ; preds = %min.iters.checked386
  ...
  %i39 = add nuw nsw i64 %i38, 1
  %i40 = and i64 %i39, 8589934584
  %i41 = add nsw i64 %i40, -8
  %i42 = lshr exact i64 %i41, 3
  %i43 = and i64 %i42, 1
  %lcmp.mod450 = icmp eq i64 %i43, 0
...
vector.body382.prol:                              ; preds = %vector.body382.preheader
  %i44 = getelementptr inbounds i8, i8* %call52, i64 4
  %i45 = bitcast i8* %i44 to <4 x i32>*
  %wide.load405.prol = load <4 x i32>, <4 x i32>* %i45, align 4, !tbaa !5
  %i46 = getelementptr i8, i8* %call52, i64 20
  %i47 = bitcast i8* %i46 to <4 x i32>*
  %wide.load406.prol = load <4 x i32>, <4 x i32>* %i47, align 4, !tbaa !5
  %i48 = icmp sgt <4 x i32> %wide.load405.prol, %minmax.ident.splat421
  %i49 = icmp sgt <4 x i32> %wide.load406.prol, %minmax.ident.splat421
  %i50 = select <4 x i1> %i48, <4 x i32> %wide.load405.prol, <4 x i32> %minmax.ident.splat421
  %i51 = select <4 x i1> %i49, <4 x i32> %wide.load406.prol, <4 x i32> %minmax.ident.splat421
  %i52 = icmp slt <4 x i32> %wide.load405.prol, %minmax.ident.splat410
  %i53 = icmp slt <4 x i32> %wide.load406.prol, %minmax.ident.splat410
  %i54 = select <4 x i1> %i52, <4 x i32> %wide.load405.prol, <4 x i32> %minmax.ident.splat410
  %i55 = select <4 x i1> %i53, <4 x i32> %wide.load406.prol, <4 x i32> %minmax.ident.splat410
  br label %vector.body382.preheader.split

vector.body382.preheader.split:                   ; preds = %vector.body382.prol, %vector.body382.preheader
  %.lcssa440.unr = phi <4 x i32> [ undef, %vector.body382.preheader ], [ %i55, %vector.body382.prol ]
  %.lcssa439.unr = phi <4 x i32> [ undef, %vector.body382.preheader ], [ %i54, %vector.body382.prol ]
  %.lcssa438.unr = phi <4 x i32> [ undef, %vector.body382.preheader ], [ %i51, %vector.body382.prol ]
  %.lcssa.unr = phi <4 x i32> [ undef, %vector.body382.preheader ], [ %i50, %vector.body382.prol ]
  %index391.unr = phi i64 [ 0, %vector.body382.preheader ], [ 8, %vector.body382.prol ]
  %vec.phi401.unr = phi <4 x i32> [ %minmax.ident.splat410, %vector.body382.preheader ], [ %i54, %vector.body382.prol ]
  %vec.phi402.unr = phi <4 x i32> [ %minmax.ident.splat410, %vector.body382.preheader ], [ %i55, %vector.body382.prol ]
  %vec.phi403.unr = phi <4 x i32> [ %minmax.ident.splat421, %vector.body382.preheader ], [ %i50, %vector.body382.prol ]
  %vec.phi404.unr = phi <4 x i32> [ %minmax.ident.splat421, %vector.body382.preheader ], [ %i51, %vector.body382.prol ]
  %i56 = icmp eq i64 %i42, 0
  br i1 %i56, label %middle.block383, label %vector.body382.preheader.split.split
...
"main$5_initialize_context":                      ; preds = %vector.body382.preheader.split.split
  %i57 = alloca %7, align 16
  br label %"main$5_call_recursive_function"

"main$5_call_recursive_function":                 ; preds = %"main$5_initialize_context"
  call void @"main$5"(%7* %i57, i64 %index391.unr, <4 x i32> %vec.phi404.unr, <4 x i32> %vec.phi403.unr, <4 x i32> %vec.phi402.unr, <4 x i32> %vec.phi401.unr, i64 %n.vec388, i32* %i29)
  br label %"main$5_extract_return_values$0"

"main$5_extract_return_values$0":                 ; preds = %"main$5_call_recursive_function"
  %i58 = getelementptr %7, %7* %i57, i32 0, i32 0
  %i59 = load <4 x i32>, <4 x i32>* %i58, align 16
  %i60 = getelementptr %7, %7* %i57, i32 0, i32 1
  %i61 = load <4 x i32>, <4 x i32>* %i60, align 16
  %i62 = getelementptr %7, %7* %i57, i32 0, i32 2
  %i63 = load <4 x i32>, <4 x i32>* %i62, align 16
  %i64 = getelementptr %7, %7* %i57, i32 0, i32 3
  %i65 = load <4 x i32>, <4 x i32>* %i64, align 16
...
middle.block383:                                  ; preds = %middle.block383.unr-lcssa, %vector.body382.preheader.split
  %.lcssa440 = phi <4 x i32> [ %.lcssa440.unr, %vector.body382.preheader.split ], [ %i63, %middle.block383.unr-lcssa ]
  %.lcssa439 = phi <4 x i32> [ %.lcssa439.unr, %vector.body382.preheader.split ], [ %i65, %middle.block383.unr-lcssa ]
  %.lcssa438 = phi <4 x i32> [ %.lcssa438.unr, %vector.body382.preheader.split ], [ %i59, %middle.block383.unr-lcssa ]
  %.lcssa = phi <4 x i32> [ %.lcssa.unr, %vector.body382.preheader.split ], [ %i61, %middle.block383.unr-lcssa ]
  ...
  %i66 = select i1 %rdx.minmax.cmp428.elt, i32 %rdx.minmax.select426.elt, i32 %rdx.shuf427.elt
  ...
  %i67 = select i1 %rdx.minmax.cmp417.elt, i32 %rdx.minmax.select415.elt, i32 %rdx.shuf416.elt
  %cmp.n395 = icmp eq i64 %i35, %n.vec388
...
for.body.for.body_crit_edge.i.preheader432:       ; preds = %middle.block383, %min.iters.checked386, %for.body.for.body_crit_edge.i.preheader
  ...
  %min_r.1.i295.ph = phi i32 [ %i31, %min.iters.checked386 ], [ %i31, %for.body.for.body_crit_edge.i.preheader ], [ %i67, %middle.block383 ]
  %.max_r.0.i294.ph = phi i32 [ %i31, %min.iters.checked386 ], [ %i31, %for.body.for.body_crit_edge.i.preheader ], [ %i66, %middle.block383 ]
  br label %"main$4_initialize_context"

"main$4_initialize_context":                      ; preds = %for.body.for.body_crit_edge.i.preheader432
  %i68 = alloca %8, align 8
  br label %"main$4_call_recursive_function"

"main$4_call_recursive_function":                 ; preds = %"main$4_initialize_context"
  call void @"main$4"(%8* %i68, i32 %.max_r.0.i294.ph, i64 %indvars.iv.next55.i296.ph, i32 %min_r.1.i295.ph, i32 %mul, i32* %i29)
  br label %"main$4_extract_return_values$0"

"main$4_extract_return_values$0":                 ; preds = %"main$4_call_recursive_function"
  %i69 = getelementptr %8, %8* %i68, i32 0, i32 0
  %i70 = load i32, i32* %i69, align 4
  %i71 = getelementptr %8, %8* %i68, i32 0, i32 1
  %i72 = load i32, i32* %i71, align 4
...
for.body15.i.preheader:                           ; preds = %for.body15.i.preheader.loopexit, %middle.block383
  %min_r.1.i.lcssa = phi i32 [ %i67, %middle.block383 ], [ %i72, %for.body15.i.preheader.loopexit ]
  %.max_r.0.i.lcssa = phi i32 [ %i66, %middle.block383 ], [ %i70, %for.body15.i.preheader.loopexit ]
  %sub.i180 = sub nsw i32 %.max_r.0.i.lcssa, %min_r.1.i.lcssa
  %sub18.i287 = sub nsw i32 %i31, %min_r.1.i.lcssa
  %mul.i182288 = mul nsw i32 %sub18.i287, 255
  %div.i183289 = sdiv i32 %mul.i182288, %sub.i180
  %conv.i184290 = trunc i32 %div.i183289 to i8
  store i8 %conv.i184290, i8* %i30, align 1, !tbaa !7
...
for.body15.for.body15_crit_edge.i.prol:           ; preds = %for.body15.for.body15_crit_edge.i.preheader
  ...
  %i75 = bitcast i8* %arrayidx17.phi.trans.insert.i.prol to i32*
  %.pre58.i.prol = load i32, i32* %i75, align 4, !tbaa !5
  ...
  %arrayidx20.i.prol = getelementptr inbounds i8, i8* %i30, i64 1
...
for.body15.for.body15_crit_edge.i.preheader.split: ; preds = %for.body15.for.body15_crit_edge.i.prol, %for.body15.for.body15_crit_edge.i.preheader
  ...
  %i76 = icmp eq i32 %i73, 2
  br i1 %i76, label %sw.epilog101.loopexit431, label %for.body15.for.body15_crit_edge.i.preheader.split.split
...
"main$3_call_recursive_function":                 ; preds = %for.body15.for.body15_crit_edge.i.preheader.split.split
  call void @"main$3"(i64 %indvars.iv.next.i185292.unr, i32 %mul, i32 %sub.i180, i8* %i30, i32* %i29, i32 %min_r.1.i.lcssa)
...
if.else62:                                        ; preds = %setup_brightness_lut.exit178
  ...
  %i77 = load i8*, i8** %in, align 8, !tbaa !1
  br i1 %tobool68, label %if.else71, label %if.then69

if.then69:                                        ; preds = %if.else62
  %call70 = tail call i32 @susan_edges_small(i8* %i77, i32* %i29, i8* %call65, i8* nonnull %add.ptr.i160, i32 undef, i32 %i27, i32 %i28)
  br label %if.end73

if.else71:                                        ; preds = %if.else62
  %call72 = tail call i32 @susan_edges(i8* %i77, i32* %i29, i8* %call65, i8* nonnull %add.ptr.i160, i32 2650, i32 %i27, i32 %i28)
  br label %if.end73
...
if.then75:                                        ; preds = %if.end73
  %call76 = tail call i32 @susan_thin(i32* %i29, i8* %call65, i32 %i27, i32 %i28)
  br label %if.end77
...
for.body.lr.ph.i:                                 ; preds = %for.cond.preheader.i
  ...
  %idx.ext.i = sext i32 %i27 to i64
  %idx.neg.i = sub nsw i64 0, %idx.ext.i
  %sub.i188 = add nsw i32 %i27, -2
  %idx.ext8.i = sext i32 %sub.i188 to i64
  br label %"main$2_call_recursive_function"

"main$2_call_recursive_function":                 ; preds = %for.body.lr.ph.i
  call void @"main$2"(i32 0, i8* %call65, i64 %idx.ext8.i, i32 %mul, i64 %sub.ptr.rhs.cast.i, i64 %idx.neg.i, i8* %i77)
...
for.body23.lr.ph.i.split:                         ; preds = %if.end32.i.prol, %for.body23.lr.ph.i
  ...
  %i80 = icmp eq i32 %i78, 1
  br i1 %i80, label %sw.epilog101.loopexit, label %for.body23.lr.ph.i.split.split

for.body23.lr.ph.i.split.split:                   ; preds = %for.body23.lr.ph.i.split
  br label %"main$1_call_recursive_function"

"main$1_call_recursive_function":                 ; preds = %for.body23.lr.ph.i.split.split
  call void @"main$1"(i32 %i.168.i.unr, i8* %midp.169.i.unr, i32 %mul, i64 %sub.ptr.rhs.cast29.i, i8* %i77)
  br label %sw.epilog101.loopexit.unr-lcssa

sw.bb80:                                          ; preds = %while.end
  %i81 = load i32, i32* %x_size, align 4, !tbaa !5
  %i82 = load i32, i32* %y_size, align 4, !tbaa !5
  %mul81 = mul i32 %i82, %i81
...
"main$11_call_recursive_function":                ; preds = %sw.bb80
  call void @"main$11"(i64 -256, i8* %add.ptr.i193, float %conv1.i194)
  br label %setup_brightness_lut.exit212

setup_brightness_lut.exit212:                     ; preds = %"main$11_call_recursive_function"
  %i83 = bitcast i8* %call84 to i32*
...
if.then86:                                        ; preds = %setup_brightness_lut.exit212
  %i84 = load i8*, i8** %in, align 8, !tbaa !1
  %call87 = tail call i32 @susan_principle(i8* %i84, i32* %i83, i8* nonnull %add.ptr.i193, i32 1850, i32 %i81, i32 %i82)
  %i85 = load i32, i32* %i83, align 4, !tbaa !5
...
for.body.for.body_crit_edge.i227.preheader:       ; preds = %for.body.i224.preheader
  %i86 = mul i32 %i82, %i81
  %i87 = add i32 %i86, -2
  %i88 = zext i32 %i87 to i64
  %i89 = add nuw nsw i64 %i88, 1
  %min.iters.check = icmp ult i64 %i89, 8
...
min.iters.checked:                                ; preds = %for.body.for.body_crit_edge.i227.preheader
  %n.vec = and i64 %i89, 8589934584
  %cmp.zero = icmp eq i64 %n.vec, 0
  %ind.end = or i64 %n.vec, 1
  %minmax.ident.splatinsert = insertelement <4 x i32> undef, i32 %i85, i32 0
  %minmax.ident.splat = shufflevector <4 x i32> %minmax.ident.splatinsert, <4 x i32> undef, <4 x i32> zeroinitializer
  %minmax.ident.splatinsert371 = insertelement <4 x i32> undef, i32 %i85, i32 0
...
vector.body.preheader:                            ; preds = %min.iters.checked
  %i90 = mul i32 %i82, %i81
  %i91 = add i32 %i90, -2
  %i92 = zext i32 %i91 to i64
  %i93 = add nuw nsw i64 %i92, 1
  %i94 = and i64 %i93, 8589934584
  %i95 = add nsw i64 %i94, -8
  %i96 = lshr exact i64 %i95, 3
  %i97 = and i64 %i96, 1
  %lcmp.mod454 = icmp eq i64 %i97, 0
  br i1 %lcmp.mod454, label %vector.body.prol, label %vector.body.preheader.split

vector.body.prol:                                 ; preds = %vector.body.preheader
  %i98 = getelementptr inbounds i8, i8* %call84, i64 4
  %i99 = bitcast i8* %i98 to <4 x i32>*
  %wide.load.prol = load <4 x i32>, <4 x i32>* %i99, align 4, !tbaa !5
  %i100 = getelementptr i8, i8* %call84, i64 20
  %i101 = bitcast i8* %i100 to <4 x i32>*
  %wide.load363.prol = load <4 x i32>, <4 x i32>* %i101, align 4, !tbaa !5
  %i102 = icmp sgt <4 x i32> %wide.load.prol, %minmax.ident.splat372
  %i103 = icmp sgt <4 x i32> %wide.load363.prol, %minmax.ident.splat372
  %i104 = select <4 x i1> %i102, <4 x i32> %wide.load.prol, <4 x i32> %minmax.ident.splat372
  %i105 = select <4 x i1> %i103, <4 x i32> %wide.load363.prol, <4 x i32> %minmax.ident.splat372
  %i106 = icmp slt <4 x i32> %wide.load.prol, %minmax.ident.splat
  %i107 = icmp slt <4 x i32> %wide.load363.prol, %minmax.ident.splat
  %i108 = select <4 x i1> %i106, <4 x i32> %wide.load.prol, <4 x i32> %minmax.ident.splat
  %i109 = select <4 x i1> %i107, <4 x i32> %wide.load363.prol, <4 x i32> %minmax.ident.splat
  br label %vector.body.preheader.split

vector.body.preheader.split:                      ; preds = %vector.body.prol, %vector.body.preheader
  %.lcssa446.unr = phi <4 x i32> [ undef, %vector.body.preheader ], [ %i109, %vector.body.prol ]
  %.lcssa445.unr = phi <4 x i32> [ undef, %vector.body.preheader ], [ %i108, %vector.body.prol ]
  %.lcssa444.unr = phi <4 x i32> [ undef, %vector.body.preheader ], [ %i105, %vector.body.prol ]
  %.lcssa443.unr = phi <4 x i32> [ undef, %vector.body.preheader ], [ %i104, %vector.body.prol ]
  %index.unr = phi i64 [ 0, %vector.body.preheader ], [ 8, %vector.body.prol ]
  %vec.phi.unr = phi <4 x i32> [ %minmax.ident.splat, %vector.body.preheader ], [ %i108, %vector.body.prol ]
  %vec.phi360.unr = phi <4 x i32> [ %minmax.ident.splat, %vector.body.preheader ], [ %i109, %vector.body.prol ]
  %vec.phi361.unr = phi <4 x i32> [ %minmax.ident.splat372, %vector.body.preheader ], [ %i104, %vector.body.prol ]
  %vec.phi362.unr = phi <4 x i32> [ %minmax.ident.splat372, %vector.body.preheader ], [ %i105, %vector.body.prol ]
  %i110 = icmp eq i64 %i96, 0
  br i1 %i110, label %middle.block, label %vector.body.preheader.split.split

vector.body.preheader.split.split:                ; preds = %vector.body.preheader.split
  br label %"main$10_initialize_context"

"main$10_initialize_context":                     ; preds = %vector.body.preheader.split.split
  %i111 = alloca %9, align 16
  br label %"main$10_call_recursive_function"

"main$10_call_recursive_function":                ; preds = %"main$10_initialize_context"
  call void @"main$10"(%9* %i111, <4 x i32> %vec.phi362.unr, <4 x i32> %vec.phi361.unr, <4 x i32> %vec.phi360.unr, i64 %index.unr, <4 x i32> %vec.phi.unr, i64 %n.vec, i32* %i83)
  br label %"main$10_extract_return_values$0"

"main$10_extract_return_values$0":                ; preds = %"main$10_call_recursive_function"
  %i112 = getelementptr %9, %9* %i111, i32 0, i32 0
  %i113 = load <4 x i32>, <4 x i32>* %i112, align 16
  %i114 = getelementptr %9, %9* %i111, i32 0, i32 1
  %i115 = load <4 x i32>, <4 x i32>* %i114, align 16
  %i116 = getelementptr %9, %9* %i111, i32 0, i32 2
  %i117 = load <4 x i32>, <4 x i32>* %i116, align 16
  %i118 = getelementptr %9, %9* %i111, i32 0, i32 3
...
middle.block:                                     ; preds = %middle.block.unr-lcssa, %vector.body.preheader.split
  %.lcssa446 = phi <4 x i32> [ %.lcssa446.unr, %vector.body.preheader.split ], [ %i117, %middle.block.unr-lcssa ]
  %.lcssa445 = phi <4 x i32> [ %.lcssa445.unr, %vector.body.preheader.split ], [ %i119, %middle.block.unr-lcssa ]
  %.lcssa444 = phi <4 x i32> [ %.lcssa444.unr, %vector.body.preheader.split ], [ %i115, %middle.block.unr-lcssa ]
  %.lcssa443 = phi <4 x i32> [ %.lcssa443.unr, %vector.body.preheader.split ], [ %i113, %middle.block.unr-lcssa ]
  ...
  %i120 = select i1 %rdx.minmax.cmp379.elt, i32 %rdx.minmax.select377.elt, i32 %rdx.shuf378.elt
  ...
  %i121 = select i1 %rdx.minmax.cmp369.elt, i32 %rdx.minmax.select367.elt, i32 %rdx.shuf368.elt
  %cmp.n = icmp eq i64 %i89, %n.vec
...
for.body.for.body_crit_edge.i227.preheader435:    ; preds = %middle.block, %min.iters.checked, %for.body.for.body_crit_edge.i227.preheader
  ...
  %min_r.1.i220306.ph = phi i32 [ %i85, %min.iters.checked ], [ %i85, %for.body.for.body_crit_edge.i227.preheader ], [ %i121, %middle.block ]
  %.max_r.0.i218305.ph = phi i32 [ %i85, %min.iters.checked ], [ %i85, %for.body.for.body_crit_edge.i227.preheader ], [ %i120, %middle.block ]
  br label %"main$9_initialize_context"

"main$9_initialize_context":                      ; preds = %for.body.for.body_crit_edge.i227.preheader435
  %i122 = alloca %10, align 8
  br label %"main$9_call_recursive_function"

"main$9_call_recursive_function":                 ; preds = %"main$9_initialize_context"
  call void @"main$9"(%10* %i122, i32 %.max_r.0.i218305.ph, i64 %indvars.iv.next55.i221307.ph, i32 %min_r.1.i220306.ph, i32 %mul81, i32* %i83)
  br label %"main$9_extract_return_values$0"

"main$9_extract_return_values$0":                 ; preds = %"main$9_call_recursive_function"
  %i123 = getelementptr %10, %10* %i122, i32 0, i32 0
  %i124 = load i32, i32* %i123, align 4
  %i125 = getelementptr %10, %10* %i122, i32 0, i32 1
  %i126 = load i32, i32* %i125, align 4
...
for.body15.i239.preheader:                        ; preds = %for.body15.i239.preheader.loopexit, %middle.block
  %min_r.1.i220.lcssa = phi i32 [ %i121, %middle.block ], [ %i126, %for.body15.i239.preheader.loopexit ]
  %.max_r.0.i218.lcssa = phi i32 [ %i120, %middle.block ], [ %i124, %for.body15.i239.preheader.loopexit ]
  %sub.i228 = sub nsw i32 %.max_r.0.i218.lcssa, %min_r.1.i220.lcssa
  %sub18.i231298 = sub nsw i32 %i85, %min_r.1.i220.lcssa
  ...
  store i8 %conv.i234301, i8* %i84, align 1, !tbaa !7
...
for.body15.for.body15_crit_edge.i242.preheader:   ; preds = %for.body15.i239.preheader
  %i127 = mul i32 %i82, %i81
  %i128 = and i32 %i127, 1
  %lcmp.mod452 = icmp eq i32 %i128, 0
...
for.body15.for.body15_crit_edge.i242.prol:        ; preds = %for.body15.for.body15_crit_edge.i242.preheader
  ...
  %i129 = bitcast i8* %arrayidx17.phi.trans.insert.i240.prol to i32*
  %.pre58.i241.prol = load i32, i32* %i129, align 4, !tbaa !5
  ...
  %arrayidx20.i235.prol = getelementptr inbounds i8, i8* %i84, i64 1
...
for.body15.for.body15_crit_edge.i242.preheader.split: ; preds = %for.body15.for.body15_crit_edge.i242.prol, %for.body15.for.body15_crit_edge.i242.preheader
  ...
  %i130 = icmp eq i32 %i127, 2
  br i1 %i130, label %sw.epilog101.loopexit434, label %for.body15.for.body15_crit_edge.i242.preheader.split.split
...
"main$8_call_recursive_function":                 ; preds = %for.body15.for.body15_crit_edge.i242.preheader.split.split
  call void @"main$8"(i64 %indvars.iv.next.i236303.unr, i32 %mul81, i8* %i84, i32 %sub.i228, i32* %i83, i32 %min_r.1.i220.lcssa)
...
if.else90:                                        ; preds = %setup_brightness_lut.exit212
  ...
  %i131 = load i8*, i8** %in, align 8, !tbaa !1
...
if.then92:                                        ; preds = %if.else90
  %call93 = call i32 @susan_corners_quick(i8* %i131, i32* %i83, i8* nonnull %add.ptr.i193, i32 1850, %struct.anon* %arraydecay, i32 %i81, i32 %i82)
  br label %if.end97

if.else94:                                        ; preds = %if.else90
  %call96 = call i32 @susan_corners(i8* %i131, i32* %i83, i8* nonnull %add.ptr.i193, i32 1850, %struct.anon* %arraydecay, i32 %i81, i32 %i82)
  br label %if.end97
...
if.end97:                                         ; preds = %if.else94, %if.then92
  ...
  %i132 = load i32, i32* %info56.i, align 8, !tbaa !8
  %cmp57.i = icmp eq i32 %i132, 7
...
while.body.lr.ph.i:                               ; preds = %if.end97
  ...
  %sub10.i = add nsw i32 %i81, -2
  %idx.ext11.i = sext i32 %sub10.i to i64
  br label %"main$7_call_recursive_function"

"main$7_call_recursive_function":                 ; preds = %while.body.lr.ph.i
  call void @"main$7"(i64 0, i64 %idx.ext11.i, i32 %i81, i8* %i131, [15000 x %struct.anon]* %corner_list, i1 %cmp1.i)
...
sw.epilog101:                                     ; preds = %sw.epilog101.loopexit434, %sw.epilog101.loopexit433, %sw.epilog101.loopexit431, %sw.epilog101.loopexit, %if.end97, %for.body15.i239.preheader, %for.body.i224.preheader, %if.then86, %for.cond19.preheader.i, %for.cond.preheader.i, %for.body15.i.preheader, %for.body.i179.preheader, %if.end59, %setup_brightness_lut.exit, %while.end.sw.epilog101_crit_edge
  %i133 = phi i32 [ %.pre342, %while.end.sw.epilog101_crit_edge ], [ %i82, %for.body15.i239.preheader ], [ %i28, %for.body15.i.preheader ], [ %i82, %if.end97 ], [ %i82, %if.then86 ], [ %i28, %for.cond19.preheader.i ], [ %i28, %for.cond.preheader.i ], [ %i28, %if.end59 ], [ %i26, %setup_brightness_lut.exit ], [ %i28, %for.body.i179.preheader ], [ %i82, %for.body.i224.preheader ], [ %i28, %sw.epilog101.loopexit ], [ %i28, %sw.epilog101.loopexit431 ], [ %i82, %sw.epilog101.loopexit433 ], [ %i82, %sw.epilog101.loopexit434 ]
  %i134 = phi i32 [ %.pre341, %while.end.sw.epilog101_crit_edge ], [ %i81, %for.body15.i239.preheader ], [ %i27, %for.body15.i.preheader ], [ %i81, %if.end97 ], [ %i81, %if.then86 ], [ %i27, %for.cond19.preheader.i ], [ %i27, %for.cond.preheader.i ], [ %i27, %if.end59 ], [ %i25, %setup_brightness_lut.exit ], [ %i27, %for.body.i179.preheader ], [ %i81, %for.body.i224.preheader ], [ %i27, %sw.epilog101.loopexit ], [ %i27, %sw.epilog101.loopexit431 ], [ %i81, %sw.epilog101.loopexit433 ], [ %i81, %sw.epilog101.loopexit434 ]
  %i135 = phi i8* [ %.pre, %while.end.sw.epilog101_crit_edge ], [ %i84, %for.body15.i239.preheader ], [ %i30, %for.body15.i.preheader ], [ %i131, %if.end97 ], [ %i84, %if.then86 ], [ %i77, %for.cond19.preheader.i ], [ %i77, %for.cond.preheader.i ], [ %i30, %if.end59 ], [ %i24, %setup_brightness_lut.exit ], [ %i30, %for.body.i179.preheader ], [ %i84, %for.body.i224.preheader ], [ %i77, %sw.epilog101.loopexit ], [ %i30, %sw.epilog101.loopexit431 ], [ %i131, %sw.epilog101.loopexit433 ], [ %i84, %sw.epilog101.loopexit434 ]
  %arrayidx102 = getelementptr inbounds i8*, i8** %argv, i64 2
  %i136 = load i8*, i8** %arrayidx102, align 8, !tbaa !1
  %call103 = tail call i32 @put_image(i8* %i136, i8* %i135, i32 %i134, i32 %i133)
...
define void @"getint$0"(%1* %arg, i32 %arg1, i32 %arg2, %struct._IO_FILE* %arg3) {
"getint$0_latch$0":
...
"getint$0_recursively_call_function":             ; preds = %"getint$0_increment_depth_counter"
  call void @"getint$0"(%1* %arg, i32 %add, i32 %call13, %struct._IO_FILE* %arg3)
  ret void

"getint$0_return_from_recursive_function$0":      ; preds = %"getint$0_latch$0"
  %i4 = getelementptr %1, %1* %arg, i32 0, i32 0
  store i32 %add, i32* %i4, align 4
  ret void
}

define void @"getint$1"(%0* %arg, i32 %arg1, %struct._IO_FILE* %arg2, i8* %arg3) {
"getint$1_exiting$1":
...
"getint$1_recursively_call_function":             ; preds = %"getint$1_increment_depth_counter"
  call void @"getint$1"(%0* %arg, i32 %call10, %struct._IO_FILE* %arg2, i8* %arg3)
  ret void
...
"getint$1_return_from_recursive_function$0":      ; preds = %"getint$1_exiting$0"
  ...
  %i5 = getelementptr %0, %0* %arg, i32 0, i32 1
  store i8 1, i8* %i5, align 1
  ret void

"getint$1_return_from_recursive_function$1":      ; preds = %"getint$1_exiting$1"
  %i6 = getelementptr %0, %0* %arg, i32 0, i32 1
  store i8 0, i8* %i6, align 1
  ret void
}

define void @"int_to_uchar$0"(i64 %arg, i8* %arg1, i32 %arg2, i32* %arg3, i32 %arg4, i32 %arg5) {
...
"int_to_uchar$0_recursively_call_function":       ; preds = %"int_to_uchar$0_increment_depth_counter"
  call void @"int_to_uchar$0"(i64 %indvars.iv.next.1, i8* %arg1, i32 %arg2, i32* %arg3, i32 %arg4, i32 %arg5)
  ret void
...
define void @"int_to_uchar$1"(%3* %arg, i32 %arg1, i64 %arg2, i32 %arg3, i32 %arg4, i32* %arg5) {
...
"int_to_uchar$1_recursively_call_function":       ; preds = %"int_to_uchar$1_increment_depth_counter"
  call void @"int_to_uchar$1"(%3* %arg, i32 %.max_r.0, i64 %indvars.iv.next55, i32 %min_r.1, i32 %arg4, i32* %arg5)
  ret void

"int_to_uchar$1_return_from_recursive_function$0": ; preds = %"int_to_uchar$1_latch$0"
  %i = getelementptr %3, %3* %arg, i32 0, i32 0
  store i32 %.max_r.0, i32* %i, align 4
  %i6 = getelementptr %3, %3* %arg, i32 0, i32 1
  store i32 %min_r.1, i32* %i6, align 4
  ret void
}

define void @"int_to_uchar$2"(%2* %arg, <4 x i32> %arg1, <4 x i32> %arg2, <4 x i32> %arg3, i64 %arg4, <4 x i32> %arg5, i64 %arg6, i32* %arg7) {
"int_to_uchar$2_latch$0":
  %offset.idx = or i64 %arg4, 1
  %i = getelementptr inbounds i32, i32* %arg7, i64 %offset.idx
  %i8 = bitcast i32* %i to <4 x i32>*
  %wide.load = load <4 x i32>, <4 x i32>* %i8, align 4, !tbaa !5
  %i9 = getelementptr i32, i32* %i, i64 4
  %i10 = bitcast i32* %i9 to <4 x i32>*
  %wide.load75 = load <4 x i32>, <4 x i32>* %i10, align 4, !tbaa !5
  %i11 = icmp sgt <4 x i32> %wide.load, %arg2
  %i12 = icmp sgt <4 x i32> %wide.load75, %arg1
  %i13 = select <4 x i1> %i11, <4 x i32> %wide.load, <4 x i32> %arg2
  %i14 = select <4 x i1> %i12, <4 x i32> %wide.load75, <4 x i32> %arg1
  %i15 = icmp slt <4 x i32> %wide.load, %arg5
  %i16 = icmp slt <4 x i32> %wide.load75, %arg3
  %i17 = select <4 x i1> %i15, <4 x i32> %wide.load, <4 x i32> %arg5
  %i18 = select <4 x i1> %i16, <4 x i32> %wide.load75, <4 x i32> %arg3
  %index.next = add i64 %arg4, 8
  %offset.idx.1 = or i64 %index.next, 1
  %i19 = getelementptr inbounds i32, i32* %arg7, i64 %offset.idx.1
  ...
  %i23 = icmp sgt <4 x i32> %wide.load.1, %i13
  %i24 = icmp sgt <4 x i32> %wide.load75.1, %i14
  %i25 = select <4 x i1> %i23, <4 x i32> %wide.load.1, <4 x i32> %i13
  %i26 = select <4 x i1> %i24, <4 x i32> %wide.load75.1, <4 x i32> %i14
  %i27 = icmp slt <4 x i32> %wide.load.1, %i17
  %i28 = icmp slt <4 x i32> %wide.load75.1, %i18
  %i29 = select <4 x i1> %i27, <4 x i32> %wide.load.1, <4 x i32> %i17
  %i30 = select <4 x i1> %i28, <4 x i32> %wide.load75.1, <4 x i32> %i18
  %index.next.1 = add i64 %arg4, 16
  %i31 = icmp eq i64 %index.next.1, %arg6
  br i1 %i31, label %"int_to_uchar$2_return_from_recursive_function$0", label %"int_to_uchar$2_increment_depth_counter", !llvm.loop !14
...
"int_to_uchar$2_recursively_call_function":       ; preds = %"int_to_uchar$2_increment_depth_counter"
  call void @"int_to_uchar$2"(%2* %arg, <4 x i32> %i26, <4 x i32> %i25, <4 x i32> %i30, i64 %index.next.1, <4 x i32> %i29, i64 %arg6, i32* %arg7)
  ret void

"int_to_uchar$2_return_from_recursive_function$0": ; preds = %"int_to_uchar$2_latch$0"
  %i32 = getelementptr %2, %2* %arg, i32 0, i32 0
  store <4 x i32> %i25, <4 x i32>* %i32, align 16
  %i33 = getelementptr %2, %2* %arg, i32 0, i32 1
  store <4 x i32> %i26, <4 x i32>* %i33, align 16
  %i34 = getelementptr %2, %2* %arg, i32 0, i32 2
  store <4 x i32> %i30, <4 x i32>* %i34, align 16
  %i35 = getelementptr %2, %2* %arg, i32 0, i32 3
  store <4 x i32> %i29, <4 x i32>* %i35, align 16
  ret void
}

define void @"setup_brightness_lut$0"(i64 %arg, float %arg1, i8** %arg2, i1 %arg3) {
"setup_brightness_lut$0_latch$0":
  ...
  %i4 = load i8*, i8** %arg2, align 8, !tbaa !1
...
"setup_brightness_lut$0_recursively_call_function": ; preds = %"setup_brightness_lut$0_increment_depth_counter"
  call void @"setup_brightness_lut$0"(i64 %indvars.iv.next, float %arg1, i8** %arg2, i1 %arg3)
  ret void
...
define void @"susan_principle$0"(i64 %arg, i32 %arg1, i32 %arg2, i32* %arg3, i32 %arg4, i64 %arg5, i1 %arg6, i8* %arg7, i8* %arg8, i64 %arg9, i64 %arg10, i64 %arg11) {
...
for.body7.lr.ph:                                  ; preds = %"susan_principle$0_header"
  %i = add nsw i64 %arg, -3
  %i12 = mul nsw i64 %i, %arg10
  %add.ptr = getelementptr inbounds i8, i8* %arg7, i64 %i12
  %i13 = mul nsw i64 %arg, %arg10
  %i14 = trunc i64 %i13 to i32
  br label %"susan_principle$0$0_call_recursive_function"

"susan_principle$0$0_call_recursive_function":    ; preds = %for.body7.lr.ph
  call void @"susan_principle$0$0"(i32 3, i64 3, i32 %arg2, i32* %arg3, i64 %arg5, i32 %i14, i8* %arg7, i32 %arg4, i8* %add.ptr, i8* %arg8, i64 %arg9, i64 %arg11)
...
"susan_principle$0_recursively_call_function":    ; preds = %"susan_principle$0_increment_depth_counter"
  call void @"susan_principle$0"(i64 %indvars.iv.next435, i32 %arg1, i32 %arg2, i32* %arg3, i32 %arg4, i64 %arg5, i1 %arg6, i8* %arg7, i8* %arg8, i64 %arg9, i64 %arg10, i64 %arg11)
  ret void
...
define void @"susan_principle_small$0"(i64 %arg, i32 %arg1, i32 %arg2, i64 %arg3, i64 %arg4, i1 %arg5, i8* %arg6, i8* %arg7, i32* %arg8) {
...
for.body7.lr.ph:                                  ; preds = %"susan_principle_small$0_header"
  %i = add nsw i64 %arg, -1
  %i9 = mul nsw i64 %i, %arg3
  %add.ptr = getelementptr inbounds i8, i8* %arg6, i64 %i9
  %i10 = mul nsw i64 %arg, %arg3
  %i11 = trunc i64 %i10 to i32
  br label %"susan_principle_small$0$0_call_recursive_function"

"susan_principle_small$0$0_call_recursive_function": ; preds = %for.body7.lr.ph
  call void @"susan_principle_small$0$0"(i32 1, i64 1, i32 %arg2, i32 %i11, i32* %arg8, i8* %add.ptr, i8* %arg6, i8* %arg7, i64 %arg4)
...
"susan_principle_small$0_recursively_call_function": ; preds = %"susan_principle_small$0_increment_depth_counter"
  call void @"susan_principle_small$0"(i64 %indvars.iv.next139, i32 %arg1, i32 %arg2, i64 %arg3, i64 %arg4, i1 %arg5, i8* %arg6, i8* %arg7, i32* %arg8)
  ret void
...
define void @"enlarge$0"(i32 %arg, i32 %arg1, i32 %arg2, i8* %arg3, i32 %arg4, i32* %arg5, i32 %arg6, i32* %arg7) {
"enlarge$0_header":
...
"enlarge$0$0_call_recursive_function":            ; preds = %"enlarge$0$0_initialize_context"
  call void @"enlarge$0$0"(%11* %i, i32 0, i32* %arg5, i32 %arg6, i32* %arg7, i32 %arg, i32 %arg4, i8* %arg3, i32 %sub61)
...
"enlarge$0_latch$0":                              ; preds = %for.inc85.loopexit, %"enlarge$0_header"
  %i10 = phi i32 [ %arg1, %"enlarge$0_header" ], [ %i9, %for.inc85.loopexit ]
...
"enlarge$0_recursively_call_function":            ; preds = %"enlarge$0_increment_depth_counter"
  call void @"enlarge$0"(i32 %inc86, i32 %i10, i32 %i.2.neg, i8* %arg3, i32 %arg4, i32* %arg5, i32 %arg6, i32* %arg7)
  ret void
...
define void @"enlarge$1"(i32 %arg, i32 %arg1, i32 %arg2, i32* %arg3, i32* %arg4, i64 %arg5, i32 %arg6, i32 %arg7, i8* %arg8, i8** %arg9) {
"enlarge$1_latch$0":
  ...
  %i10 = load i8*, i8** %arg9, align 8, !tbaa !1
  %mul20 = mul nsw i32 %i, %arg
  %idx.ext21 = sext i32 %mul20 to i64
  %add.ptr22 = getelementptr inbounds i8, i8* %i10, i64 %idx.ext21
  ...
  %i11 = load i32, i32* %arg4, align 4, !tbaa !5
  %add24 = add i32 %arg, %arg2
  %add25 = add i32 %add24, %i11
  %i12 = load i32, i32* %arg3, align 4, !tbaa !5
  %add27 = add nsw i32 %i12, %arg7
  ...
  %i13 = load i8*, i8** %arg9, align 8, !tbaa !1
  %sub33 = add nsw i32 %arg1, -1
  %sub34 = add i32 %sub33, %i11
  %mul35 = mul nsw i32 %sub34, %i12
  %idx.ext36 = sext i32 %mul35 to i64
  %add.ptr37 = getelementptr inbounds i8, i8* %i13, i64 %idx.ext36
  %conv38 = sext i32 %i12 to i64
...
"enlarge$1_recursively_call_function":            ; preds = %"enlarge$1_increment_depth_counter"
  call void @"enlarge$1"(i32 %inc40, i32 %i.1.neg, i32 %arg2, i32* %arg3, i32* %arg4, i64 %arg5, i32 %arg6, i32 %arg7, i8* %arg8, i8** %arg9)
  ret void
...
define void @"enlarge$2"(i32 %arg, i32* %arg1, i32* %arg2, i32 %arg3, i8* %arg4, i32 %arg5, i64 %arg6, i8** %arg7) {
"enlarge$2_latch$0":
  ...
  %i8 = load i8*, i8** %arg7, align 8, !tbaa !1
  ...
  %i9 = load i32, i32* %arg1, align 4, !tbaa !5
...
"enlarge$2_recursively_call_function":            ; preds = %"enlarge$2_increment_depth_counter"
  call void @"enlarge$2"(i32 %inc, i32* %arg1, i32* %arg2, i32 %arg3, i8* %arg4, i32 %arg5, i64 %arg6, i8** %arg7)
  ret void
...
define void @"susan_smoothing$0"(i32 %arg, i32 %arg1, i8* %arg2, i32* %arg3, i64 %arg4, i32 %arg5, i8* %arg6, i64 %arg7, i32* %arg8, i64 %arg9, i8** %arg10, i32 %arg11, i8* %arg12, i1 %arg13) {
...
"susan_smoothing$0$0_call_recursive_function":    ; preds = %"susan_smoothing$0$0_initialize_context"
  call void @"susan_smoothing$0$0"(%12* %i14, i8* %arg2, i64 %arg9, i32 %i, i32* %arg8, i64 %arg4, i32 %arg11, i32 %arg5, i8* %arg6, i32 %arg1, i8** %arg10, i8* %arg12, i1 %arg13, i32 %sub78, i64 %arg7)
...
"susan_smoothing$0$0_extract_return_values$0":    ; preds = %"susan_smoothing$0$0_call_recursive_function"
  %i15 = getelementptr %12, %12* %i14, i32 0, i32 0
...
"susan_smoothing$0_latch$0":                      ; preds = %for.inc135.loopexit, %"susan_smoothing$0_header"
  %i17 = phi i32 [ %arg, %"susan_smoothing$0_header" ], [ %.pre489, %for.inc135.loopexit ]
  %out.1.lcssa = phi i8* [ %arg2, %"susan_smoothing$0_header" ], [ %i16, %for.inc135.loopexit ]
  %inc136 = add nsw i32 %arg1, 1
  %sub69 = sub nsw i32 %i17, %arg11
...
"susan_smoothing$0_recursively_call_function":    ; preds = %"susan_smoothing$0_increment_depth_counter"
  call void @"susan_smoothing$0"(i32 %i17, i32 %inc136, i8* %out.1.lcssa, i32* %arg3, i64 %arg4, i32 %arg5, i8* %arg6, i64 %arg7, i32* %arg8, i64 %arg9, i8** %arg10, i32 %arg11, i8* %arg12, i1 %arg13)
  ret void
...
define void @"susan_smoothing$1"(i32 %arg, i8* %arg1, i32 %arg2, i32 %arg3, float %arg4) {
...
"susan_smoothing$1$0_call_recursive_function":    ; preds = %"susan_smoothing$1$0_initialize_context"
  call void @"susan_smoothing$1$0"(%13* %i, i32 %arg3, i8* %arg1, i32 %arg2, i32 %mul56, float %arg4)
...
"susan_smoothing$1$0_extract_return_values$0":    ; preds = %"susan_smoothing$1$0_call_recursive_function"
  %i5 = getelementptr %13, %13* %i, i32 0, i32 0
...
"susan_smoothing$1_recursively_call_function":    ; preds = %"susan_smoothing$1_increment_depth_counter"
  call void @"susan_smoothing$1"(i32 %inc66, i8* %i6, i32 %arg2, i32 %arg3, float %arg4)
  ret void
...
define void @"susan_smoothing$2"(i32 %arg, i8* %arg1, i32 %arg2, i32 %arg3, i32* %arg4, i32* %arg5, i8** %arg6, i8* %arg7) {
...
"susan_smoothing$2$0_call_recursive_function":    ; preds = %"susan_smoothing$2$0_initialize_context"
  call void @"susan_smoothing$2$0"(%14* %i, i8* %arg1, i64 1, i32 %arg3, i32* %arg5, i8** %arg6, i8* %arg7, i32 %arg, i32 %sub149)
...
"susan_smoothing$2$0_extract_return_values$0":    ; preds = %"susan_smoothing$2$0_call_recursive_function"
  %i8 = getelementptr %14, %14* %i, i32 0, i32 0
  %i9 = load i8*, i8** %i8, align 8
  %i10 = getelementptr %14, %14* %i, i32 0, i32 1
  %i11 = load i32, i32* %i10, align 4
...
"susan_smoothing$2_latch$0":                      ; preds = %for.inc263.loopexit, %"susan_smoothing$2_header"
  %i12 = phi i32 [ %arg2, %"susan_smoothing$2_header" ], [ %.pre488, %for.inc263.loopexit ]
  %i13 = phi i32 [ %arg3, %"susan_smoothing$2_header" ], [ %i11, %for.inc263.loopexit ]
  %out.4.lcssa = phi i8* [ %arg1, %"susan_smoothing$2_header" ], [ %i9, %for.inc263.loopexit ]
  %inc264 = add nuw nsw i32 %arg, 1
  %sub140 = add nsw i32 %i12, -1
...
"susan_smoothing$2_recursively_call_function":    ; preds = %"susan_smoothing$2_increment_depth_counter"
  call void @"susan_smoothing$2"(i32 %inc264, i8* %out.4.lcssa, i32 %i12, i32 %i13, i32* %arg4, i32* %arg5, i8** %arg6, i8* %arg7)
  ret void
...
define void @"edge_draw$0"(i32 %arg, i8* %arg1, i32 %arg2, i64 %arg3, i8* %arg4) {
"edge_draw$0_header":
...
"edge_draw$0_recursively_call_function":          ; preds = %"edge_draw$0_increment_depth_counter"
  call void @"edge_draw$0"(i32 %inc35.1, i8* %incdec.ptr33.1, i32 %arg2, i64 %arg3, i8* %arg4)
  ret void
...
define void @"edge_draw$1"(i32 %arg, i8* %arg1, i32 %arg2, i64 %arg3, i64 %arg4, i64 %arg5, i8* %arg6) {
"edge_draw$1_header":
  %i = load i8, i8* %arg1, align 1, !tbaa !7
...
"edge_draw$1_recursively_call_function":          ; preds = %"edge_draw$1_increment_depth_counter"
  call void @"edge_draw$1"(i32 %inc, i8* %incdec.ptr17, i32 %arg2, i64 %arg3, i64 %arg4, i64 %arg5, i8* %arg6)
  ret void
...
define void @"susan_thin$0"(i32 %arg, i32 %arg1, i32 %arg2, i32 %arg3, i32 %arg4, i1 %arg5, i64 %arg6, i8* %arg7, i32* %arg8, i32 %arg9) {
"susan_thin$0_header":
...
"susan_thin$0$0_call_recursive_function":         ; preds = %"susan_thin$0$0_initialize_context"
  call void @"susan_thin$0$0"(%15* %i, i32 %arg, i32 %arg2, i32 4, i32 %arg1, i32 %arg9, i64 %arg6, i32* %arg8, i32 %arg4, i8* %arg7)
...
"susan_thin$0$0_extract_return_values$0":         ; preds = %"susan_thin$0$0_call_recursive_function"
  %i10 = getelementptr %15, %15* %i, i32 0, i32 0
  %i11 = load i32, i32* %i10, align 4
  %i12 = getelementptr %15, %15* %i, i32 0, i32 1
  %i13 = load i32, i32* %i12, align 4
  %i14 = getelementptr %15, %15* %i, i32 0, i32 2
  %i15 = load i32, i32* %i14, align 4
...
"susan_thin$0_latch$0":                           ; preds = %for.inc826.loopexit, %"susan_thin$0_header"
  %i.1.lcssa = phi i32 [ %arg1, %"susan_thin$0_header" ], [ %i13, %for.inc826.loopexit ]
  %b.1.lcssa = phi i32 [ %arg2, %"susan_thin$0_header" ], [ %i15, %for.inc826.loopexit ]
  %a.1.lcssa = phi i32 [ %arg, %"susan_thin$0_header" ], [ %i11, %for.inc826.loopexit ]
...
"susan_thin$0_recursively_call_function":         ; preds = %"susan_thin$0_increment_depth_counter"
  call void @"susan_thin$0"(i32 %a.1.lcssa, i32 %inc827, i32 %b.1.lcssa, i32 %arg3, i32 %arg4, i1 %arg5, i64 %arg6, i8* %arg7, i32* %arg8, i32 %arg9)
  ret void
...
define void @"susan_edges$0"(i64 %arg, i32 %arg1, i8* %arg2, i32 %arg3, i32 %arg4, i64 %arg5, i64 %arg6, i64 %arg7, i8* %arg8, i1 %arg9, i32* %arg10, i64 %arg11, i32 %arg12, i8* %arg13) {
...
for.body297.lr.ph:                                ; preds = %"susan_edges$0_header"
  ...
  %i14 = add nsw i64 %arg, -3
  %i15 = mul nsw i64 %i14, %arg11
  %add.ptr323 = getelementptr inbounds i8, i8* %arg8, i64 %i15
  %i16 = trunc i64 %i to i32
  %i17 = trunc i64 %arg to i32
  %i18 = trunc i64 %arg to i32
  br label %"susan_edges$0$0_call_recursive_function"

"susan_edges$0$0_call_recursive_function":        ; preds = %for.body297.lr.ph
  call void @"susan_edges$0$0"(i32 4, i64 4, i8* %arg2, i32 %arg4, i32 %i18, i32 %i17, i64 %arg7, i64 %arg5, i64 %arg6, i32* %arg10, i32 %i16, i32 %arg12, i8* %arg8, i8* %arg13, i32 %arg1, i8* %add.ptr323)
...
"susan_edges$0_recursively_call_function":        ; preds = %"susan_edges$0_increment_depth_counter"
  call void @"susan_edges$0"(i64 %indvars.iv.next2058, i32 %arg1, i8* %arg2, i32 %arg3, i32 %arg4, i64 %arg5, i64 %arg6, i64 %arg7, i8* %arg8, i1 %arg9, i32* %arg10, i64 %arg11, i32 %arg12, i8* %arg13)
  ret void
...
define void @"susan_edges$1"(i64 %arg, i32 %arg1, i32 %arg2, i32* %arg3, i32 %arg4, i64 %arg5, i64 %arg6, i1 %arg7, i64 %arg8, i8* %arg9, i8* %arg10, i64 %arg11) {
...
for.body7.lr.ph:                                  ; preds = %"susan_edges$1_header"
  %i = add nsw i64 %arg, -3
  %i12 = mul nsw i64 %i, %arg6
  %add.ptr = getelementptr inbounds i8, i8* %arg9, i64 %i12
  %i13 = mul nsw i64 %arg, %arg6
  %i14 = trunc i64 %i13 to i32
  br label %"susan_edges$1$0_call_recursive_function"

"susan_edges$1$0_call_recursive_function":        ; preds = %for.body7.lr.ph
  call void @"susan_edges$1$0"(i32 3, i64 3, i32 %arg2, i32 %arg4, i64 %arg5, i64 %arg8, i32* %arg3, i32 %i14, i8* %add.ptr, i64 %arg11, i8* %arg9, i8* %arg10)
  br label %for.inc285.loopexit
...
"susan_edges$1_recursively_call_function":        ; preds = %"susan_edges$1_increment_depth_counter"
  call void @"susan_edges$1"(i64 %indvars.iv.next2071, i32 %arg1, i32 %arg2, i32* %arg3, i32 %arg4, i64 %arg5, i64 %arg6, i1 %arg7, i64 %arg8, i8* %arg9, i8* %arg10, i64 %arg11)
  ret void
...
define void @"susan_edges_small$0"(i64 %arg, i32 %arg1, i8* %arg2, i32 %arg3, i1 %arg4, i32 %arg5, i32* %arg6, i64 %arg7, i8* %arg8, i64 %arg9, i8* %arg10) {
...
for.body93.lr.ph:                                 ; preds = %"susan_edges_small$0_header"
  ...
  %i11 = add nsw i64 %arg, -1
  %i12 = mul nsw i64 %i11, %arg9
  %add.ptr119 = getelementptr inbounds i8, i8* %arg8, i64 %i12
  %i13 = trunc i64 %i to i32
  %i14 = trunc i64 %arg to i32
  %i15 = trunc i64 %arg to i32
  br label %"susan_edges_small$0$0_call_recursive_function"

"susan_edges_small$0$0_call_recursive_function":  ; preds = %for.body93.lr.ph
  call void @"susan_edges_small$0$0"(i32 2, i64 2, i32 %arg1, i32 %i14, i8* %arg2, i32 %arg3, i32* %arg6, i8* %add.ptr119, i32 %i13, i32 %i15, i8* %arg8, i8* %arg10, i64 %arg7)
...
"susan_edges_small$0_recursively_call_function":  ; preds = %"susan_edges_small$0_increment_depth_counter"
  call void @"susan_edges_small$0"(i64 %indvars.iv.next649, i32 %arg1, i8* %arg2, i32 %arg3, i1 %arg4, i32 %arg5, i32* %arg6, i64 %arg7, i8* %arg8, i64 %arg9, i8* %arg10)
  ret void
...
define void @"susan_edges_small$1"(i64 %arg, i32 %arg1, i32 %arg2, i64 %arg3, i1 %arg4, i64 %arg5, i8* %arg6, i8* %arg7, i32* %arg8) {
...
for.body7.lr.ph:                                  ; preds = %"susan_edges_small$1_header"
  %i = add nsw i64 %arg, -1
  %i9 = mul nsw i64 %i, %arg3
  %add.ptr = getelementptr inbounds i8, i8* %arg7, i64 %i9
  %i10 = mul nsw i64 %arg, %arg3
  %i11 = trunc i64 %i10 to i32
  br label %"susan_edges_small$1$0_call_recursive_function"

"susan_edges_small$1$0_call_recursive_function":  ; preds = %for.body7.lr.ph
  call void @"susan_edges_small$1$0"(i32 1, i64 1, i32 %arg2, i32 %i11, i8* %arg7, i8* %add.ptr, i32* %arg8, i8* %arg6, i64 %arg5)
  br label %for.inc81.loopexit
...
"susan_edges_small$1_recursively_call_function":  ; preds = %"susan_edges_small$1_increment_depth_counter"
  call void @"susan_edges_small$1"(i64 %indvars.iv.next662, i32 %arg1, i32 %arg2, i64 %arg3, i1 %arg4, i64 %arg5, i8* %arg6, i8* %arg7, i32* %arg8)
  ret void
...
define void @"corner_draw$0"(%struct.anon* %arg, i64 %arg1, i64 %arg2, i8* %arg3, i32 %arg4, %struct.anon* %arg5, i1 %arg6) {
"corner_draw$0_header":
  %y = getelementptr inbounds %struct.anon, %struct.anon* %arg5, i64 %arg1, i32 1
  %i = load i32, i32* %y, align 4, !tbaa !15
  %i7 = getelementptr inbounds %struct.anon, %struct.anon* %arg, i64 0, i32 0
...
"corner_draw$0_latch$0":                          ; preds = %if.then, %if.else
  ...
  %i9 = load i32, i32* %info, align 4, !tbaa !8
  %cmp = icmp eq i32 %i9, 7
...
"corner_draw$0_recursively_call_function":        ; preds = %"corner_draw$0_increment_depth_counter"
  call void @"corner_draw$0"(%struct.anon* %arrayidx, i64 %indvars.iv.next, i64 %arg2, i8* %arg3, i32 %arg4, %struct.anon* %arg5, i1 %arg6)
  ret void
...
define void @"susan_corners$0"(%4* %arg, i32 %arg1, i64 %arg2, i64 %arg3, i64 %arg4, i8* %arg5, i64 %arg6, i1 %arg7, i32* %arg8, i32* %arg9, %struct.anon* %arg10, i32* %arg11) {
...
"susan_corners$0$0_call_recursive_function":      ; preds = %"susan_corners$0$0_initialize_context"
  call void @"susan_corners$0$0"(%16* %i26, i32 5, i64 5, i32 %arg1, i8* %arg5, i32* %arg9, i32* %arg11, i64 %i23, i64 %arg4, i64 %i21, i32* %arg8, i64 %i15, i32 %i24, i64 %i13, i32 %i25, %struct.anon* %arg10, i64 %i17, i64 %i19)
...
"susan_corners$0$0_branch_to_exit":               ; preds = %"susan_corners$0$0_call_recursive_function"
  %i27 = getelementptr %16, %16* %i26, i32 0, i32 1
  %i28 = load i8, i8* %i27, align 1
  switch i8 %i28, label %"susan_corners$0$0_extract_return_values$0" [
...
"susan_corners$0$0_extract_return_values$0":      ; preds = %"susan_corners$0$0_branch_to_exit", %"susan_corners$0$0_branch_to_exit"
  %i29 = getelementptr %16, %16* %i26, i32 0, i32 0
...
"susan_corners$0_latch$0":                        ; preds = %for.inc1385.loopexit, %for.cond916.preheader.for.inc1385_crit_edge
  %indvars.iv.next2232.pre-phi = phi i64 [ %.pre, %for.cond916.preheader.for.inc1385_crit_edge ], [ %i18, %for.inc1385.loopexit ]
  %n.1.lcssa = phi i32 [ %arg1, %for.cond916.preheader.for.inc1385_crit_edge ], [ %i30, %for.inc1385.loopexit ]
...
"susan_corners$0_recursively_call_function":      ; preds = %"susan_corners$0_increment_depth_counter"
  call void @"susan_corners$0"(%4* %arg, i32 %n.1.lcssa, i64 %indvars.iv.next2232.pre-phi, i64 %arg3, i64 %arg4, i8* %arg5, i64 %arg6, i1 %arg7, i32* %arg8, i32* %arg9, %struct.anon* %arg10, i32* %arg11)
  ret void

"susan_corners$0_return_from_recursive_function$0": ; preds = %"susan_corners$0_latch$0"
  %i31 = getelementptr %4, %4* %arg, i32 0, i32 0
  store i32 %n.1.lcssa, i32* %i31, align 4
  %i32 = getelementptr %4, %4* %arg, i32 0, i32 1
  store i8 1, i8* %i32, align 1
  ret void

"susan_corners$0_return_from_recursive_function$1": ; preds = %"susan_corners$0$0_extract_return_values$1"
  %i33 = getelementptr %4, %4* %arg, i32 0, i32 1
  store i8 0, i8* %i33, align 1
  ret void
}

define void @"susan_corners$1"(i64 %arg, i32 %arg1, i32* %arg2, i32 %arg3, i32 %arg4, i32 %arg5, i64 %arg6, i64 %arg7, i8* %arg8, i32* %arg9, i64 %arg10, i8* %arg11, i32* %arg12, i1 %arg13, i64 %arg14) {
...
for.body14.lr.ph:                                 ; preds = %"susan_corners$1_header"
  %i = add nsw i64 %arg, -3
  %i15 = mul nsw i64 %i, %arg7
  %add.ptr = getelementptr inbounds i8, i8* %arg8, i64 %i15
  %i16 = mul nsw i64 %arg, %arg7
  %i17 = trunc i64 %i16 to i32
  %i18 = trunc i64 %arg to i32
  %i19 = trunc i64 %arg to i32
  br label %"susan_corners$1$0_call_recursive_function"

"susan_corners$1$0_call_recursive_function":      ; preds = %for.body14.lr.ph
  call void @"susan_corners$1$0"(i32 5, i64 5, i32 %arg4, i32* %arg2, i32* %arg9, i32 %arg3, i32 %arg5, i64 %arg6, i64 %arg10, i32* %arg12, i32 %i17, i8* %add.ptr, i32 %i18, i8* %arg8, i32 %i19, i8* %arg11, i64 %arg14)
...
"susan_corners$1_recursively_call_function":      ; preds = %"susan_corners$1_increment_depth_counter"
  call void @"susan_corners$1"(i64 %indvars.iv.next2249, i32 %arg1, i32* %arg2, i32 %arg3, i32 %arg4, i32 %arg5, i64 %arg6, i64 %arg7, i8* %arg8, i32* %arg9, i64 %arg10, i8* %arg11, i32* %arg12, i1 %arg13, i64 %arg14)
  ret void
...
define void @"susan_corners_quick$0"(%5* %arg, i32 %arg1, i64 %arg2, i64 %arg3, i1 %arg4, i8* %arg5, i64 %arg6, i32* %arg7, i64 %arg8, %struct.anon* %arg9) {
...
"susan_corners_quick$0$0_call_recursive_function": ; preds = %"susan_corners_quick$0$0_initialize_context"
  call void @"susan_corners_quick$0$0"(%17* %i24, i32 7, i64 7, i32 %arg1, i8* %arg5, i64 %i21, i64 %i19, i32* %arg7, i64 %i13, i32 %i22, i64 %i11, i32 %i23, %struct.anon* %arg9, i64 %i15, i64 %arg6, i64 %i17)
...
"susan_corners_quick$0$0_branch_to_exit":         ; preds = %"susan_corners_quick$0$0_call_recursive_function"
  %i25 = getelementptr %17, %17* %i24, i32 0, i32 1
  %i26 = load i8, i8* %i25, align 1
  switch i8 %i26, label %"susan_corners_quick$0$0_extract_return_values$0" [
...
"susan_corners_quick$0$0_extract_return_values$0": ; preds = %"susan_corners_quick$0$0_branch_to_exit", %"susan_corners_quick$0$0_branch_to_exit"
  %i27 = getelementptr %17, %17* %i24, i32 0, i32 0
...
"susan_corners_quick$0_latch$0":                  ; preds = %for.inc1323.loopexit, %for.cond365.preheader.for.inc1323_crit_edge
  %indvars.iv.next2100.pre-phi = phi i64 [ %.pre, %for.cond365.preheader.for.inc1323_crit_edge ], [ %i16, %for.inc1323.loopexit ]
  %n.1.lcssa = phi i32 [ %arg1, %for.cond365.preheader.for.inc1323_crit_edge ], [ %i28, %for.inc1323.loopexit ]
...
"susan_corners_quick$0_recursively_call_function": ; preds = %"susan_corners_quick$0_increment_depth_counter"
  call void @"susan_corners_quick$0"(%5* %arg, i32 %n.1.lcssa, i64 %indvars.iv.next2100.pre-phi, i64 %arg3, i1 %arg4, i8* %arg5, i64 %arg6, i32* %arg7, i64 %arg8, %struct.anon* %arg9)
  ret void
...
"susan_corners_quick$0_return_from_recursive_function$1": ; preds = %"susan_corners_quick$0$0_extract_return_values$1"
  %i31 = getelementptr %5, %5* %arg, i32 0, i32 1
  store i8 0, i8* %i31, align 1
  ret void
}

define void @"susan_corners_quick$1"(i64 %arg, i32 %arg1, i32* %arg2, i32 %arg3, i64 %arg4, i64 %arg5, i64 %arg6, i1 %arg7, i8* %arg8, i8* %arg9, i32 %arg10, i64 %arg11) {
...
for.body7.lr.ph:                                  ; preds = %"susan_corners_quick$1_header"
  %i = add nsw i64 %arg, -3
  %i12 = mul nsw i64 %i, %arg5
  %add.ptr = getelementptr inbounds i8, i8* %arg8, i64 %i12
  %i13 = mul nsw i64 %arg, %arg5
  %i14 = trunc i64 %i13 to i32
  br label %"susan_corners_quick$1$0_call_recursive_function"

"susan_corners_quick$1$0_call_recursive_function": ; preds = %for.body7.lr.ph
  call void @"susan_corners_quick$1$0"(i32 7, i64 7, i32 %arg3, i32* %arg2, i32 %arg10, i64 %arg4, i8* %add.ptr, i64 %arg6, i8* %arg8, i32 %i14, i8* %arg9, i64 %arg11)
...
"susan_corners_quick$1_recursively_call_function": ; preds = %"susan_corners_quick$1_increment_depth_counter"
  call void @"susan_corners_quick$1"(i64 %indvars.iv.next2117, i32 %arg1, i32* %arg2, i32 %arg3, i64 %arg4, i64 %arg5, i64 %arg6, i1 %arg7, i8* %arg8, i8* %arg9, i32 %arg10, i64 %arg11)
  ret void
...
define void @"main$0"(i64 %arg, i8* %arg1, float %arg2) {
"main$0_latch$0":
  %i = trunc i64 %arg to i32
...
"main$0_recursively_call_function":               ; preds = %"main$0_increment_depth_counter"
  call void @"main$0"(i64 %indvars.iv.next.i, i8* %arg1, float %arg2)
  ret void
...
define void @"main$1"(i32 %arg, i8* %arg1, i32 %arg2, i64 %arg3, i8* %arg4) {
"main$1_header":
  %i = load i8, i8* %arg1, align 1, !tbaa !7
...
"main$1_recursively_call_function":               ; preds = %"main$1_increment_depth_counter"
  call void @"main$1"(i32 %inc35.i.1, i8* %incdec.ptr33.i.1, i32 %arg2, i64 %arg3, i8* %arg4)
  ret void
...
define void @"main$2"(i32 %arg, i8* %arg1, i64 %arg2, i32 %arg3, i64 %arg4, i64 %arg5, i8* %arg6) {
"main$2_header":
  %i = load i8, i8* %arg1, align 1, !tbaa !7
...
"main$2_recursively_call_function":               ; preds = %"main$2_increment_depth_counter"
  call void @"main$2"(i32 %inc.i, i8* %incdec.ptr17.i, i64 %arg2, i32 %arg3, i64 %arg4, i64 %arg5, i8* %arg6)
  ret void
...
define void @"main$3"(i64 %arg, i32 %arg1, i32 %arg2, i8* %arg3, i32* %arg4, i32 %arg5) {
"main$3_latch$0":
...
"main$3_recursively_call_function":               ; preds = %"main$3_increment_depth_counter"
  call void @"main$3"(i64 %indvars.iv.next.i185.1, i32 %arg1, i32 %arg2, i8* %arg3, i32* %arg4, i32 %arg5)
  ret void
...
define void @"main$4"(%8* %arg, i32 %arg1, i64 %arg2, i32 %arg3, i32 %arg4, i32* %arg5) {
"main$4_latch$0":
...
"main$4_recursively_call_function":               ; preds = %"main$4_increment_depth_counter"
  call void @"main$4"(%8* %arg, i32 %.max_r.0.i, i64 %indvars.iv.next55.i, i32 %min_r.1.i, i32 %arg4, i32* %arg5)
  ret void

"main$4_return_from_recursive_function$0":        ; preds = %"main$4_latch$0"
  %i = getelementptr %8, %8* %arg, i32 0, i32 0
  store i32 %.max_r.0.i, i32* %i, align 4
  %i6 = getelementptr %8, %8* %arg, i32 0, i32 1
  store i32 %min_r.1.i, i32* %i6, align 4
  ret void
}

define void @"main$5"(%7* %arg, i64 %arg1, <4 x i32> %arg2, <4 x i32> %arg3, <4 x i32> %arg4, <4 x i32> %arg5, i64 %arg6, i32* %arg7) {
"main$5_latch$0":
  %offset.idx396 = or i64 %arg1, 1
  %i = getelementptr inbounds i32, i32* %arg7, i64 %offset.idx396
  %i8 = bitcast i32* %i to <4 x i32>*
  %wide.load405 = load <4 x i32>, <4 x i32>* %i8, align 4, !tbaa !5
  %i9 = getelementptr i32, i32* %i, i64 4
  %i10 = bitcast i32* %i9 to <4 x i32>*
  %wide.load406 = load <4 x i32>, <4 x i32>* %i10, align 4, !tbaa !5
  %i11 = icmp sgt <4 x i32> %wide.load405, %arg3
  %i12 = icmp sgt <4 x i32> %wide.load406, %arg2
  %i13 = select <4 x i1> %i11, <4 x i32> %wide.load405, <4 x i32> %arg3
  %i14 = select <4 x i1> %i12, <4 x i32> %wide.load406, <4 x i32> %arg2
  %i15 = icmp slt <4 x i32> %wide.load405, %arg5
  %i16 = icmp slt <4 x i32> %wide.load406, %arg4
  %i17 = select <4 x i1> %i15, <4 x i32> %wide.load405, <4 x i32> %arg5
  %i18 = select <4 x i1> %i16, <4 x i32> %wide.load406, <4 x i32> %arg4
  %index.next392 = add i64 %arg1, 8
  %offset.idx396.1 = or i64 %index.next392, 1
  %i19 = getelementptr inbounds i32, i32* %arg7, i64 %offset.idx396.1
  %i20 = bitcast i32* %i19 to <4 x i32>*
  %wide.load405.1 = load <4 x i32>, <4 x i32>* %i20, align 4, !tbaa !5
  %i21 = getelementptr i32, i32* %i19, i64 4
  %i22 = bitcast i32* %i21 to <4 x i32>*
  %wide.load406.1 = load <4 x i32>, <4 x i32>* %i22, align 4, !tbaa !5
  %i23 = icmp sgt <4 x i32> %wide.load405.1, %i13
  %i24 = icmp sgt <4 x i32> %wide.load406.1, %i14
  %i25 = select <4 x i1> %i23, <4 x i32> %wide.load405.1, <4 x i32> %i13
  %i26 = select <4 x i1> %i24, <4 x i32> %wide.load406.1, <4 x i32> %i14
  %i27 = icmp slt <4 x i32> %wide.load405.1, %i17
  %i28 = icmp slt <4 x i32> %wide.load406.1, %i18
  %i29 = select <4 x i1> %i27, <4 x i32> %wide.load405.1, <4 x i32> %i17
  %i30 = select <4 x i1> %i28, <4 x i32> %wide.load406.1, <4 x i32> %i18
  %index.next392.1 = add i64 %arg1, 16
  %i31 = icmp eq i64 %index.next392.1, %arg6
  br i1 %i31, label %"main$5_return_from_recursive_function$0", label %"main$5_increment_depth_counter", !llvm.loop !17
...
"main$5_recursively_call_function":               ; preds = %"main$5_increment_depth_counter"
  call void @"main$5"(%7* %arg, i64 %index.next392.1, <4 x i32> %i26, <4 x i32> %i25, <4 x i32> %i30, <4 x i32> %i29, i64 %arg6, i32* %arg7)
  ret void

"main$5_return_from_recursive_function$0":        ; preds = %"main$5_latch$0"
  %i32 = getelementptr %7, %7* %arg, i32 0, i32 0
  store <4 x i32> %i26, <4 x i32>* %i32, align 16
  %i33 = getelementptr %7, %7* %arg, i32 0, i32 1
  store <4 x i32> %i25, <4 x i32>* %i33, align 16
  %i34 = getelementptr %7, %7* %arg, i32 0, i32 2
  store <4 x i32> %i30, <4 x i32>* %i34, align 16
  %i35 = getelementptr %7, %7* %arg, i32 0, i32 3
  store <4 x i32> %i29, <4 x i32>* %i35, align 16
  ret void
}

define void @"main$6"(i64 %arg, i8* %arg1, float %arg2) {
"main$6_latch$0":
  %i = trunc i64 %arg to i32
...
"main$6_recursively_call_function":               ; preds = %"main$6_increment_depth_counter"
  call void @"main$6"(i64 %indvars.iv.next.i175, i8* %arg1, float %arg2)
  ret void
...
define void @"main$7"(i64 %arg, i64 %arg1, i32 %arg2, i8* %arg3, [15000 x %struct.anon]* %arg4, i1 %arg5) {
"main$7_header":
  %y.i = getelementptr inbounds [15000 x %struct.anon], [15000 x %struct.anon]* %arg4, i64 0, i64 %arg, i32 1
  %i = load i32, i32* %y.i, align 4, !tbaa !15
  %i6 = getelementptr inbounds [15000 x %struct.anon], [15000 x %struct.anon]* %arg4, i64 0, i64 %arg, i32 0
...
if.else.i:                                        ; preds = %"main$7_header"
  ...
  %add.ptr25.i = getelementptr inbounds i8, i8* %arg3, i64 %idx.ext24.i
  %idx.ext29.i = sext i32 %i7 to i64
...
if.then.i:                                        ; preds = %"main$7_header"
  ...
  %add.ptr.i248 = getelementptr inbounds i8, i8* %arg3, i64 %idx.ext.i247
  %idx.ext6.i = sext i32 %i7 to i64
...
"main$7_latch$0":                                 ; preds = %if.then.i, %if.else.i
  ...
  %info.i = getelementptr inbounds [15000 x %struct.anon], [15000 x %struct.anon]* %arg4, i64 0, i64 %indvars.iv.next.i250, i32 2
  %i8 = load i32, i32* %info.i, align 8, !tbaa !8
  %cmp.i251 = icmp eq i32 %i8, 7
...
"main$7_recursively_call_function":               ; preds = %"main$7_increment_depth_counter"
  call void @"main$7"(i64 %indvars.iv.next.i250, i64 %arg1, i32 %arg2, i8* %arg3, [15000 x %struct.anon]* %arg4, i1 %arg5)
  ret void
...
define void @"main$8"(i64 %arg, i32 %arg1, i8* %arg2, i32 %arg3, i32* %arg4, i32 %arg5) {
"main$8_latch$0":
...
"main$8_recursively_call_function":               ; preds = %"main$8_increment_depth_counter"
  call void @"main$8"(i64 %indvars.iv.next.i236.1, i32 %arg1, i8* %arg2, i32 %arg3, i32* %arg4, i32 %arg5)
  ret void
...
define void @"main$9"(%10* %arg, i32 %arg1, i64 %arg2, i32 %arg3, i32 %arg4, i32* %arg5) {
"main$9_latch$0":
...
"main$9_recursively_call_function":               ; preds = %"main$9_increment_depth_counter"
  call void @"main$9"(%10* %arg, i32 %.max_r.0.i218, i64 %indvars.iv.next55.i221, i32 %min_r.1.i220, i32 %arg4, i32* %arg5)
  ret void

"main$9_return_from_recursive_function$0":        ; preds = %"main$9_latch$0"
  %i = getelementptr %10, %10* %arg, i32 0, i32 0
  store i32 %.max_r.0.i218, i32* %i, align 4
  %i6 = getelementptr %10, %10* %arg, i32 0, i32 1
  store i32 %min_r.1.i220, i32* %i6, align 4
  ret void
}

define void @"main$10"(%9* %arg, <4 x i32> %arg1, <4 x i32> %arg2, <4 x i32> %arg3, i64 %arg4, <4 x i32> %arg5, i64 %arg6, i32* %arg7) {
"main$10_latch$0":
  %offset.idx = or i64 %arg4, 1
  %i = getelementptr inbounds i32, i32* %arg7, i64 %offset.idx
  %i8 = bitcast i32* %i to <4 x i32>*
  ...
  %i9 = getelementptr i32, i32* %i, i64 4
  %i10 = bitcast i32* %i9 to <4 x i32>*
  %wide.load363 = load <4 x i32>, <4 x i32>* %i10, align 4, !tbaa !5
  %i11 = icmp sgt <4 x i32> %wide.load, %arg2
  %i12 = icmp sgt <4 x i32> %wide.load363, %arg1
  %i13 = select <4 x i1> %i11, <4 x i32> %wide.load, <4 x i32> %arg2
  %i14 = select <4 x i1> %i12, <4 x i32> %wide.load363, <4 x i32> %arg1
  %i15 = icmp slt <4 x i32> %wide.load, %arg5
  %i16 = icmp slt <4 x i32> %wide.load363, %arg3
  %i17 = select <4 x i1> %i15, <4 x i32> %wide.load, <4 x i32> %arg5
  %i18 = select <4 x i1> %i16, <4 x i32> %wide.load363, <4 x i32> %arg3
  %index.next = add i64 %arg4, 8
  %offset.idx.1 = or i64 %index.next, 1
  %i19 = getelementptr inbounds i32, i32* %arg7, i64 %offset.idx.1
  %i20 = bitcast i32* %i19 to <4 x i32>*
  ...
  %i23 = icmp sgt <4 x i32> %wide.load.1, %i13
  %i24 = icmp sgt <4 x i32> %wide.load363.1, %i14
  %i25 = select <4 x i1> %i23, <4 x i32> %wide.load.1, <4 x i32> %i13
  %i26 = select <4 x i1> %i24, <4 x i32> %wide.load363.1, <4 x i32> %i14
  %i27 = icmp slt <4 x i32> %wide.load.1, %i17
  %i28 = icmp slt <4 x i32> %wide.load363.1, %i18
  %i29 = select <4 x i1> %i27, <4 x i32> %wide.load.1, <4 x i32> %i17
  %i30 = select <4 x i1> %i28, <4 x i32> %wide.load363.1, <4 x i32> %i18
  %index.next.1 = add i64 %arg4, 16
  %i31 = icmp eq i64 %index.next.1, %arg6
  br i1 %i31, label %"main$10_return_from_recursive_function$0", label %"main$10_increment_depth_counter", !llvm.loop !19
...
"main$10_recursively_call_function":              ; preds = %"main$10_increment_depth_counter"
  call void @"main$10"(%9* %arg, <4 x i32> %i26, <4 x i32> %i25, <4 x i32> %i30, i64 %index.next.1, <4 x i32> %i29, i64 %arg6, i32* %arg7)
  ret void

"main$10_return_from_recursive_function$0":       ; preds = %"main$10_latch$0"
  %i32 = getelementptr %9, %9* %arg, i32 0, i32 0
  store <4 x i32> %i25, <4 x i32>* %i32, align 16
  %i33 = getelementptr %9, %9* %arg, i32 0, i32 1
  store <4 x i32> %i26, <4 x i32>* %i33, align 16
  %i34 = getelementptr %9, %9* %arg, i32 0, i32 2
  store <4 x i32> %i30, <4 x i32>* %i34, align 16
  %i35 = getelementptr %9, %9* %arg, i32 0, i32 3
  store <4 x i32> %i29, <4 x i32>* %i35, align 16
  ret void
}

define void @"main$11"(i64 %arg, i8* %arg1, float %arg2) {
"main$11_latch$0":
  %i = trunc i64 %arg to i32
...
"main$11_recursively_call_function":              ; preds = %"main$11_increment_depth_counter"
  call void @"main$11"(i64 %indvars.iv.next.i208, i8* %arg1, float %arg2)
  ret void
...
define void @"main$12"(%6* %arg, i32 %arg1, i32 %arg2, i32 %arg3, i32 %arg4, i32 %arg5, i32 %arg6, i32 %arg7, float %arg8, i32 %arg9, i32 %arg10, i8** %arg11) {
"main$12_exiting$1":
  ...
  %i12 = load i8, i8* %i, align 1, !tbaa !7
  %cmp3 = icmp eq i8 %i12, 45
...
if.end19:                                         ; preds = %"main$12_exiting$0"
  ...
  %i15 = load i8*, i8** %arrayidx21, align 8, !tbaa !1
  %call.i = tail call double @strtod(i8* nocapture nonnull %i15, i8** null) #6
...
"main$12_recursively_call_function":              ; preds = %"main$12_increment_depth_counter"
  call void @"main$12"(%6* %arg, i32 %principle.1, i32 %mode.1, i32 %bt.1, i32 %susan_quick.1, i32 %inc40, i32 %drawing_mode.1, i32 %three_by_three.1, float %dt.1, i32 %thin_post_proc.1, i32 %arg10, i8** %arg11)
  ret void

"main$12_return_from_recursive_function$0":       ; preds = %"main$12_latch$0"
  %i16 = getelementptr %6, %6* %arg, i32 0, i32 0
  store i32 %principle.1, i32* %i16, align 4
  %i17 = getelementptr %6, %6* %arg, i32 0, i32 1
  store i32 %bt.1, i32* %i17, align 4
  %i18 = getelementptr %6, %6* %arg, i32 0, i32 2
  store float %dt.1, float* %i18, align 4
  %i19 = getelementptr %6, %6* %arg, i32 0, i32 3
  store i32 %thin_post_proc.1, i32* %i19, align 4
  %i20 = getelementptr %6, %6* %arg, i32 0, i32 4
  store i32 %mode.1, i32* %i20, align 4
  %i21 = getelementptr %6, %6* %arg, i32 0, i32 5
  store i32 %susan_quick.1, i32* %i21, align 4
  %i22 = getelementptr %6, %6* %arg, i32 0, i32 6
  store i32 %drawing_mode.1, i32* %i22, align 4
  %i23 = getelementptr %6, %6* %arg, i32 0, i32 7
  store i32 %three_by_three.1, i32* %i23, align 4
  %i24 = getelementptr %6, %6* %arg, i32 0, i32 8
  store i8 3, i8* %i24, align 1
  ret void

"main$12_return_from_recursive_function$1":       ; preds = %"main$12_exiting$0"
  %i25 = getelementptr %6, %6* %arg, i32 0, i32 8
  store i8 2, i8* %i25, align 1
  ret void

"main$12_return_from_recursive_function$2":       ; preds = %"main$12_exiting$1"
  %i26 = getelementptr %6, %6* %arg, i32 0, i32 8
  store i8 0, i8* %i26, align 1
  ret void

"main$12_return_from_recursive_function$3":       ; preds = %"main$12_exiting$3"
  %i27 = getelementptr %6, %6* %arg, i32 0, i32 8
  store i8 1, i8* %i27, align 1
  ret void
}

define void @"susan_principle$0$0"(i32 %arg, i64 %arg1, i32 %arg2, i32* %arg3, i64 %arg4, i32 %arg5, i8* %arg6, i32 %arg7, i8* %arg8, i8* %arg9, i64 %arg10, i64 %arg11) {
...
"susan_principle$0$0_recursively_call_function":  ; preds = %"susan_principle$0$0_increment_depth_counter"
  call void @"susan_principle$0$0"(i32 %inc, i64 %indvars.iv.next, i32 %arg2, i32* %arg3, i64 %arg4, i32 %arg5, i8* %arg6, i32 %arg7, i8* %arg8, i8* %arg9, i64 %arg10, i64 %arg11)
  ret void
...
define void @"susan_principle_small$0$0"(i32 %arg, i64 %arg1, i32 %arg2, i32 %arg3, i32* %arg4, i8* %arg5, i8* %arg6, i8* %arg7, i64 %arg8) {
"susan_principle_small$0$0_header":
  ...
  %i = load i8, i8* %arrayidx, align 1, !tbaa !7
  %idx.ext15 = zext i8 %i to i64
  %add.ptr16 = getelementptr inbounds i8, i8* %arg7, i64 %idx.ext15
  %incdec.ptr = getelementptr inbounds i8, i8* %add.ptr12, i64 1
  %i9 = load i8, i8* %add.ptr12, align 1, !tbaa !7
  %idx.ext18 = zext i8 %i9 to i64
  %idx.neg = sub nsw i64 0, %idx.ext18
  %add.ptr19 = getelementptr inbounds i8, i8* %add.ptr16, i64 %idx.neg
  %i10 = load i8, i8* %add.ptr19, align 1, !tbaa !7
  %conv20 = zext i8 %i10 to i32
  %add21 = add nuw nsw i32 %conv20, 100
  %incdec.ptr22 = getelementptr inbounds i8, i8* %incdec.ptr, i64 1
  %i11 = load i8, i8* %incdec.ptr, align 1, !tbaa !7
  %idx.ext24 = zext i8 %i11 to i64
  %idx.neg25 = sub nsw i64 0, %idx.ext24
  %add.ptr26 = getelementptr inbounds i8, i8* %add.ptr16, i64 %idx.neg25
  %i12 = load i8, i8* %add.ptr26, align 1, !tbaa !7
  %conv27 = zext i8 %i12 to i32
  %add28 = add nuw nsw i32 %add21, %conv27
  %i13 = load i8, i8* %incdec.ptr22, align 1, !tbaa !7
  %idx.ext30 = zext i8 %i13 to i64
  %idx.neg31 = sub nsw i64 0, %idx.ext30
  %add.ptr32 = getelementptr inbounds i8, i8* %add.ptr16, i64 %idx.neg31
  %i14 = load i8, i8* %add.ptr32, align 1, !tbaa !7
  %conv33 = zext i8 %i14 to i32
  %add34 = add nuw nsw i32 %add28, %conv33
  %add.ptr37 = getelementptr inbounds i8, i8* %incdec.ptr22, i64 %arg8
  %i15 = load i8, i8* %add.ptr37, align 1, !tbaa !7
  %idx.ext39 = zext i8 %i15 to i64
  %idx.neg40 = sub nsw i64 0, %idx.ext39
  %add.ptr41 = getelementptr inbounds i8, i8* %add.ptr16, i64 %idx.neg40
  %i16 = load i8, i8* %add.ptr41, align 1, !tbaa !7
  %conv42 = zext i8 %i16 to i32
  %add43 = add nuw nsw i32 %add34, %conv42
  %add.ptr44 = getelementptr inbounds i8, i8* %add.ptr37, i64 2
  %i17 = load i8, i8* %add.ptr44, align 1, !tbaa !7
  %idx.ext46 = zext i8 %i17 to i64
  %idx.neg47 = sub nsw i64 0, %idx.ext46
  %add.ptr48 = getelementptr inbounds i8, i8* %add.ptr16, i64 %idx.neg47
  %i18 = load i8, i8* %add.ptr48, align 1, !tbaa !7
  %conv49 = zext i8 %i18 to i32
  %add50 = add nuw nsw i32 %add43, %conv49
  %add.ptr53 = getelementptr inbounds i8, i8* %add.ptr44, i64 %arg8
...
if.then:                                          ; preds = %"susan_principle_small$0$0_header"
  ...
  %arrayidx80 = getelementptr inbounds i32, i32* %arg4, i64 %idxprom
...
"susan_principle_small$0$0_recursively_call_function": ; preds = %"susan_principle_small$0$0_increment_depth_counter"
  call void @"susan_principle_small$0$0"(i32 %inc, i64 %indvars.iv.next, i32 %arg2, i32 %arg3, i32* %arg4, i8* %arg5, i8* %arg6, i8* %arg7, i64 %arg8)
  ret void
...
define void @"enlarge$0$0"(%11* %arg, i32 %arg1, i32* %arg2, i32 %arg3, i32* %arg4, i32 %arg5, i32 %arg6, i8* %arg7, i32 %arg8) {
"enlarge$0$0_latch$0":
  ...
  %i9 = load i8, i8* %arrayidx, align 1, !tbaa !7
  %sub62 = add i32 %arg8, %add55
  %idxprom63 = sext i32 %sub62 to i64
  %arrayidx64 = getelementptr inbounds i8, i8* %arg7, i64 %idxprom63
  store i8 %i9, i8* %arrayidx64, align 1, !tbaa !7
  %i10 = load i32, i32* %arg4, align 4, !tbaa !5
  %add66 = add nsw i32 %i10, %arg3
  %mul67 = mul nsw i32 %add66, %arg1
  %add68 = add i32 %i10, %arg6
  ...
  %i11 = load i8, i8* %arrayidx73, align 1, !tbaa !7
  %add79 = add nsw i32 %add69, %arg5
  %idxprom80 = sext i32 %add79 to i64
  %arrayidx81 = getelementptr inbounds i8, i8* %arg7, i64 %idxprom80
  store i8 %i11, i8* %arrayidx81, align 1, !tbaa !7
  %inc83 = add nuw nsw i32 %arg1, 1
  %i12 = load i32, i32* %arg2, align 4, !tbaa !5
  %add48 = add nsw i32 %i12, %arg3
...
"enlarge$0$0_recursively_call_function":          ; preds = %"enlarge$0$0_increment_depth_counter"
  call void @"enlarge$0$0"(%11* %arg, i32 %inc83, i32* %arg2, i32 %arg3, i32* %arg4, i32 %arg5, i32 %arg6, i8* %arg7, i32 %arg8)
  ret void

"enlarge$0$0_return_from_recursive_function$0":   ; preds = %"enlarge$0$0_latch$0"
  %i13 = getelementptr %11, %11* %arg, i32 0, i32 0
  store i32 %i12, i32* %i13, align 4
  ret void
}

define void @"susan_smoothing$0$0"(%12* %arg, i8* %arg1, i64 %arg2, i32 %arg3, i32* %arg4, i64 %arg5, i32 %arg6, i32 %arg7, i8* %arg8, i32 %arg9, i8** %arg10, i8* %arg11, i1 %arg12, i32 %arg13, i64 %arg14) {
"susan_smoothing$0$0_header":
  %i = load i8*, i8** %arg10, align 8, !tbaa !1
  %mul84 = mul nsw i32 %arg3, %arg9
  %i15 = trunc i64 %arg2 to i32
  %add85 = add nsw i32 %mul84, %i15
  %idxprom = sext i32 %add85 to i64
  %arrayidx = getelementptr inbounds i8, i8* %i, i64 %idxprom
  %i16 = load i8, i8* %arrayidx, align 1, !tbaa !7
  %conv86 = zext i8 %i16 to i32
  %idx.ext87 = zext i8 %i16 to i64
  %add.ptr88 = getelementptr inbounds i8, i8* %arg11, i64 %idx.ext87
  br i1 %arg12, label %if.else125, label %for.cond95.preheader.preheader

for.cond95.preheader.preheader:                   ; preds = %"susan_smoothing$0$0_header"
  %mul79 = mul nsw i32 %arg3, %arg13
...
"susan_smoothing$0$0$0_call_recursive_function":  ; preds = %"susan_smoothing$0$0$0_initialize_context"
  call void @"susan_smoothing$0$0$0"(%18* %i17, i32 %arg7, i8* %add.ptr83, i32 0, i32 0, i8* %arg8, i64 %arg5, i32 %arg6, i32 %arg7, i8* %add.ptr88)
...
"susan_smoothing$0$0$0_extract_return_values$0":  ; preds = %"susan_smoothing$0$0$0_call_recursive_function"
  %i18 = getelementptr %18, %18* %i17, i32 0, i32 0
  %i19 = load i32, i32* %i18, align 4
  %i20 = getelementptr %18, %18* %i17, i32 0, i32 1
  %i21 = load i32, i32* %i20, align 4
  br label %for.end118

for.end118:                                       ; preds = %"susan_smoothing$0$0$0_extract_return_values$0"
  %sub119 = add nsw i32 %i19, -10000
  %cmp120 = icmp eq i32 %sub119, 0
  br i1 %cmp120, label %if.then122, label %if.else125

if.then122:                                       ; preds = %for.end118
  %call123 = tail call zeroext i8 @median(i8* %i, i32 %arg9, i32 %i15, i32 %arg3)
...
if.else125:                                       ; preds = %for.end118, %"susan_smoothing$0$0_header"
  ...
  %total.0.lcssa492 = phi i32 [ %i21, %for.end118 ], [ 0, %"susan_smoothing$0$0_header" ]
  %i22 = mul nsw i32 %conv86, -10000
  %sub127 = add i32 %total.0.lcssa492, %i22
...
"susan_smoothing$0$0_latch$0":                    ; preds = %if.else125, %if.then122
  ...
  %i23 = load i32, i32* %arg4, align 4, !tbaa !5
  %sub74 = sub nsw i32 %i23, %arg6
  %i24 = sext i32 %sub74 to i64
  %cmp75 = icmp slt i64 %indvars.iv.next, %i24
...
"susan_smoothing$0$0_recursively_call_function":  ; preds = %"susan_smoothing$0$0_increment_depth_counter"
  call void @"susan_smoothing$0$0"(%12* %arg, i8* %out.2, i64 %indvars.iv.next, i32 %i23, i32* %arg4, i64 %arg5, i32 %arg6, i32 %arg7, i8* %arg8, i32 %arg9, i8** %arg10, i8* %arg11, i1 %arg12, i32 %arg13, i64 %arg14)
  ret void

"susan_smoothing$0$0_return_from_recursive_function$0": ; preds = %"susan_smoothing$0$0_latch$0"
  %i25 = getelementptr %12, %12* %arg, i32 0, i32 0
  store i8* %out.2, i8** %i25, align 8
  ret void
}

define void @"susan_smoothing$1$0"(%13* %arg, i32 %arg1, i8* %arg2, i32 %arg3, i32 %arg4, float %arg5) {
...
"susan_smoothing$1$0_recursively_call_function":  ; preds = %"susan_smoothing$1$0_increment_depth_counter"
  call void @"susan_smoothing$1$0"(%13* %arg, i32 %inc, i8* %incdec.ptr, i32 %arg3, i32 %arg4, float %arg5)
  ret void

"susan_smoothing$1$0_return_from_recursive_function$0": ; preds = %"susan_smoothing$1$0_latch$0"
  %i = getelementptr %13, %13* %arg, i32 0, i32 0
  store i8* %incdec.ptr, i8** %i, align 8
  ret void
}

define void @"susan_smoothing$2$0"(%14* %arg, i8* %arg1, i64 %arg2, i32 %arg3, i32* %arg4, i8** %arg5, i8* %arg6, i32 %arg7, i32 %arg8) {
"susan_smoothing$2$0_header":
  %i = load i8*, i8** %arg5, align 8, !tbaa !1
  ...
  %mul156 = mul nsw i32 %arg3, %arg7
  %i9 = trunc i64 %arg2 to i32
  %add157 = add nsw i32 %mul156, %i9
  %idxprom158 = sext i32 %add157 to i64
  %arrayidx159 = getelementptr inbounds i8, i8* %i, i64 %idxprom158
  %i10 = load i8, i8* %arrayidx159, align 1, !tbaa !7
  %idx.ext161 = zext i8 %i10 to i64
  %add.ptr162 = getelementptr inbounds i8, i8* %arg6, i64 %idx.ext161
  %incdec.ptr163 = getelementptr inbounds i8, i8* %add.ptr155, i64 1
  %i11 = load i8, i8* %add.ptr155, align 1, !tbaa !7
  %idx.ext165 = zext i8 %i11 to i64
  %idx.neg166 = sub nsw i64 0, %idx.ext165
  %add.ptr167 = getelementptr inbounds i8, i8* %add.ptr162, i64 %idx.neg166
  %i12 = load i8, i8* %add.ptr167, align 1, !tbaa !7
  %conv168 = zext i8 %i12 to i32
  %incdec.ptr172 = getelementptr inbounds i8, i8* %incdec.ptr163, i64 1
  %i13 = load i8, i8* %incdec.ptr163, align 1, !tbaa !7
  %idx.ext174 = zext i8 %i13 to i64
  %idx.neg175 = sub nsw i64 0, %idx.ext174
  %add.ptr176 = getelementptr inbounds i8, i8* %add.ptr162, i64 %idx.neg175
  %i14 = load i8, i8* %add.ptr176, align 1, !tbaa !7
  %conv177 = zext i8 %i14 to i32
  %i15 = load i8, i8* %incdec.ptr172, align 1, !tbaa !7
  %idx.ext182 = zext i8 %i15 to i64
  %idx.neg183 = sub nsw i64 0, %idx.ext182
  %add.ptr184 = getelementptr inbounds i8, i8* %add.ptr162, i64 %idx.neg183
  %i16 = load i8, i8* %add.ptr184, align 1, !tbaa !7
  %conv185 = zext i8 %i16 to i32
  ...
  %i17 = load i8, i8* %add.ptr191, align 1, !tbaa !7
  %idx.ext194 = zext i8 %i17 to i64
  %idx.neg195 = sub nsw i64 0, %idx.ext194
  %add.ptr196 = getelementptr inbounds i8, i8* %add.ptr162, i64 %idx.neg195
  %i18 = load i8, i8* %add.ptr196, align 1, !tbaa !7
  %conv197 = zext i8 %i18 to i32
  %incdec.ptr201 = getelementptr inbounds i8, i8* %incdec.ptr192, i64 1
  %i19 = load i8, i8* %incdec.ptr192, align 1, !tbaa !7
  %idx.ext203 = zext i8 %i19 to i64
  %idx.neg204 = sub nsw i64 0, %idx.ext203
  %add.ptr205 = getelementptr inbounds i8, i8* %add.ptr162, i64 %idx.neg204
  %i20 = load i8, i8* %add.ptr205, align 1, !tbaa !7
  %conv206 = zext i8 %i20 to i32
  %i21 = load i8, i8* %incdec.ptr201, align 1, !tbaa !7
  %idx.ext211 = zext i8 %i21 to i64
  %idx.neg212 = sub nsw i64 0, %idx.ext211
  %add.ptr213 = getelementptr inbounds i8, i8* %add.ptr162, i64 %idx.neg212
  %i22 = load i8, i8* %add.ptr213, align 1, !tbaa !7
  %conv214 = zext i8 %i22 to i32
  %add.ptr220 = getelementptr inbounds i8, i8* %incdec.ptr201, i64 %idx.ext190
  %incdec.ptr221 = getelementptr inbounds i8, i8* %add.ptr220, i64 1
  %i23 = load i8, i8* %add.ptr220, align 1, !tbaa !7
  %idx.ext223 = zext i8 %i23 to i64
  %idx.neg224 = sub nsw i64 0, %idx.ext223
  %add.ptr225 = getelementptr inbounds i8, i8* %add.ptr162, i64 %idx.neg224
  %i24 = load i8, i8* %add.ptr225, align 1, !tbaa !7
  %conv226 = zext i8 %i24 to i32
  %incdec.ptr230 = getelementptr inbounds i8, i8* %incdec.ptr221, i64 1
  %i25 = load i8, i8* %incdec.ptr221, align 1, !tbaa !7
  %idx.ext232 = zext i8 %i25 to i64
  %idx.neg233 = sub nsw i64 0, %idx.ext232
  %add.ptr234 = getelementptr inbounds i8, i8* %add.ptr162, i64 %idx.neg233
  %i26 = load i8, i8* %add.ptr234, align 1, !tbaa !7
  %conv235 = zext i8 %i26 to i32
  %i27 = load i8, i8* %incdec.ptr230, align 1, !tbaa !7
  %idx.ext240 = zext i8 %i27 to i64
  %idx.neg241 = sub nsw i64 0, %idx.ext240
  %add.ptr242 = getelementptr inbounds i8, i8* %add.ptr162, i64 %idx.neg241
  %i28 = load i8, i8* %add.ptr242, align 1, !tbaa !7
  %conv243 = zext i8 %i28 to i32
...
if.then250:                                       ; preds = %"susan_smoothing$2$0_header"
  %call251 = tail call zeroext i8 @median(i8* %i, i32 %arg7, i32 %i9, i32 %arg3)
  br label %"susan_smoothing$2$0_latch$0"
...
"susan_smoothing$2$0_latch$0":                    ; preds = %if.then250, %if.else253
  ...
  %i30 = load i32, i32* %arg4, align 4, !tbaa !5
...
"susan_smoothing$2$0_recursively_call_function":  ; preds = %"susan_smoothing$2$0_increment_depth_counter"
  call void @"susan_smoothing$2$0"(%14* %arg, i8* %out.5, i64 %indvars.iv.next487, i32 %i30, i32* %arg4, i8** %arg5, i8* %arg6, i32 %arg7, i32 %arg8)
  ret void

"susan_smoothing$2$0_return_from_recursive_function$0": ; preds = %"susan_smoothing$2$0_latch$0"
  %i32 = getelementptr %14, %14* %arg, i32 0, i32 0
  store i8* %out.5, i8** %i32, align 8
  %i33 = getelementptr %14, %14* %arg, i32 0, i32 1
  store i32 %i30, i32* %i33, align 4
  ret void
}

define void @"susan_thin$0$0"(%15* %arg, i32 %arg1, i32 %arg2, i32 %arg3, i32 %arg4, i32 %arg5, i64 %arg6, i32* %arg7, i32 %arg8, i8* %arg9) {
...
if.then:                                          ; preds = %"susan_thin$0$0_header"
  ...
  %i10 = load i32, i32* %arrayidx10, align 4, !tbaa !5
  ...
  %i16 = load i8, i8* %add.ptr45, align 1, !tbaa !7
  %cmp47 = icmp ult i8 %i16, 8
  %conv48 = zext i1 %cmp47 to i32
  %add49 = add nuw nsw i32 %add41, %conv48
  %add.ptr54 = getelementptr inbounds i8, i8* %add.ptr45, i64 1
  %i17 = load i8, i8* %add.ptr54, align 1, !tbaa !7
  %cmp56 = icmp ult i8 %i17, 8
...
if.else:                                          ; preds = %if.then84
  ...
  %i28 = load i8, i8* %arrayidx165, align 1, !tbaa !7
  %cmp167 = icmp ult i8 %i28, 8
...
if.else183:                                       ; preds = %if.else
  ...
  %i29 = load i8, i8* %arrayidx189, align 1, !tbaa !7
  %cmp191 = icmp ult i8 %i29, 8
...
if.else207:                                       ; preds = %if.else183
  ...
  %i30 = load i8, i8* %arrayidx212, align 1, !tbaa !7
  %cmp214 = icmp ult i8 %i30, 8
...
if.else230:                                       ; preds = %if.else207
  ...
  %i31 = load i8, i8* %arrayidx235, align 1, !tbaa !7
  %cmp237 = icmp ult i8 %i31, 8
...
if.else253:                                       ; preds = %if.else230
  ...
  %i32 = load i8, i8* %arrayidx259, align 1, !tbaa !7
  %cmp261 = icmp ult i8 %i32, 8
...
if.else277:                                       ; preds = %if.else253
  ...
  %i33 = load i8, i8* %arrayidx282, align 1, !tbaa !7
  %cmp284 = icmp ult i8 %i33, 8
...
if.else300:                                       ; preds = %if.else277
  ...
  %i34 = load i8, i8* %arrayidx306, align 1, !tbaa !7
  %cmp308 = icmp ult i8 %i34, 8
  br i1 %cmp308, label %if.then310, label %for.cond336.preheader.preheader

if.then310:                                       ; preds = %if.else300
  %mul315 = shl nsw i32 %i24, 1
  %mul317 = shl nsw i32 %i21, 1
  %mul319 = mul nsw i32 %i20, 3
  %mul321 = mul nsw i32 %i22, 3
  %mul323 = shl nsw i32 %i19, 2
  br label %for.cond336.preheader.preheader

if.then286:                                       ; preds = %if.else277
  %mul291 = shl nsw i32 %i22, 1
  %mul293 = shl nsw i32 %i23, 1
  %mul295 = mul nsw i32 %i19, 3
  %mul297 = mul nsw i32 %i21, 3
  %mul299 = shl nsw i32 %i20, 2
  br label %for.cond336.preheader.preheader

if.then263:                                       ; preds = %if.else253
  %mul268 = shl nsw i32 %i19, 1
  %mul270 = shl nsw i32 %i26, 1
  %mul272 = mul nsw i32 %i20, 3
  %mul274 = mul nsw i32 %i23, 3
  %mul276 = shl nsw i32 %i21, 2
  br label %for.cond336.preheader.preheader

if.then239:                                       ; preds = %if.else230
  %mul244 = shl nsw i32 %i20, 1
  %mul246 = shl nsw i32 %i25, 1
  %mul248 = mul nsw i32 %i19, 3
  %mul250 = mul nsw i32 %i24, 3
  %mul252 = shl nsw i32 %i22, 2
  br label %for.cond336.preheader.preheader

if.then216:                                       ; preds = %if.else207
  %mul221 = shl nsw i32 %i20, 1
  %mul223 = shl nsw i32 %i25, 1
  %mul225 = mul nsw i32 %i21, 3
  %mul227 = mul nsw i32 %i26, 3
  %mul229 = shl nsw i32 %i23, 2
  br label %for.cond336.preheader.preheader

if.then193:                                       ; preds = %if.else183
  %mul198 = shl nsw i32 %i19, 1
  %mul200 = shl nsw i32 %i26, 1
  %mul202 = mul nsw i32 %i22, 3
  %mul204 = mul nsw i32 %i25, 3
  %mul206 = shl nsw i32 %i24, 2
  br label %for.cond336.preheader.preheader

if.then169:                                       ; preds = %if.else
  %mul174 = shl nsw i32 %i22, 1
  %mul176 = shl nsw i32 %i23, 1
  %mul178 = mul nsw i32 %i24, 3
  %mul180 = mul nsw i32 %i26, 3
  %mul182 = shl nsw i32 %i25, 2
  br label %for.cond336.preheader.preheader

if.then147:                                       ; preds = %if.then84
  %mul152 = shl nsw i32 %i21, 1
  %mul154 = shl nsw i32 %i24, 1
  %mul156 = mul nsw i32 %i23, 3
  %mul158 = mul nsw i32 %i25, 3
  %mul160 = shl nsw i32 %i26, 2
  br label %for.cond336.preheader.preheader
...
for.cond336.preheader.preheader:                  ; preds = %if.then147, %if.then169, %if.then193, %if.then216, %if.then239, %if.then263, %if.then286, %if.then310, %if.else300
  %i35 = phi i32 [ %mul180, %if.then169 ], [ %mul227, %if.then216 ], [ %mul270, %if.then263 ], [ %i26, %if.else300 ], [ 0, %if.then310 ], [ 0, %if.then286 ], [ 0, %if.then239 ], [ %mul200, %if.then193 ], [ %mul160, %if.then147 ]
  %i36 = phi i32 [ %mul182, %if.then169 ], [ %mul223, %if.then216 ], [ 0, %if.then263 ], [ %i25, %if.else300 ], [ 0, %if.then310 ], [ 0, %if.then286 ], [ %mul246, %if.then239 ], [ %mul204, %if.then193 ], [ %mul158, %if.then147 ]
  %i37 = phi i32 [ %mul178, %if.then169 ], [ 0, %if.then216 ], [ 0, %if.then263 ], [ %i24, %if.else300 ], [ %mul315, %if.then310 ], [ 0, %if.then286 ], [ %mul250, %if.then239 ], [ %mul206, %if.then193 ], [ %mul154, %if.then147 ]
  %i38 = phi i32 [ %mul176, %if.then169 ], [ %mul229, %if.then216 ], [ %mul274, %if.then263 ], [ %i23, %if.else300 ], [ 0, %if.then310 ], [ %mul293, %if.then286 ], [ 0, %if.then239 ], [ 0, %if.then193 ], [ %mul156, %if.then147 ]
  %i39 = phi i32 [ %mul174, %if.then169 ], [ 0, %if.then216 ], [ 0, %if.then263 ], [ %i22, %if.else300 ], [ %mul321, %if.then310 ], [ %mul291, %if.then286 ], [ %mul252, %if.then239 ], [ %mul202, %if.then193 ], [ 0, %if.then147 ]
  %i40 = phi i32 [ 0, %if.then169 ], [ %mul225, %if.then216 ], [ %mul276, %if.then263 ], [ %i21, %if.else300 ], [ %mul317, %if.then310 ], [ %mul297, %if.then286 ], [ 0, %if.then239 ], [ 0, %if.then193 ], [ %mul152, %if.then147 ]
  %i41 = phi i32 [ 0, %if.then169 ], [ %mul221, %if.then216 ], [ %mul272, %if.then263 ], [ %i20, %if.else300 ], [ %mul319, %if.then310 ], [ %mul299, %if.then286 ], [ %mul244, %if.then239 ], [ 0, %if.then193 ], [ 0, %if.then147 ]
  %i42 = phi i32 [ 0, %if.then169 ], [ 0, %if.then216 ], [ %mul268, %if.then263 ], [ %i19, %if.else300 ], [ %mul323, %if.then310 ], [ %mul295, %if.then286 ], [ %mul248, %if.then239 ], [ %mul198, %if.then193 ], [ 0, %if.then147 ]
  %cmp345 = icmp sgt i32 %i42, 0
  %.m.1 = select i1 %cmp345, i32 %i42, i32 0
  %x.0.b.3 = select i1 %cmp345, i32 0, i32 %arg2
  %cmp345.1 = icmp sgt i32 %i41, %.m.1
  %.m.1.1 = select i1 %cmp345.1, i32 %i41, i32 %.m.1
  %i43 = or i1 %cmp345.1, %cmp345
  %x.0.b.3.1 = select i1 %cmp345.1, i32 1, i32 %x.0.b.3
  %cmp345.2 = icmp sgt i32 %i40, %.m.1.1
  %.m.1.2 = select i1 %cmp345.2, i32 %i40, i32 %.m.1.1
  %i44 = or i1 %cmp345.2, %i43
  %y.0.a.3.2 = select i1 %i44, i32 0, i32 %arg1
  %x.0.b.3.2 = select i1 %cmp345.2, i32 2, i32 %x.0.b.3.1
  %cmp345.11219 = icmp sgt i32 %i39, %.m.1.2
  %.m.1.11220 = select i1 %cmp345.11219, i32 %i39, i32 %.m.1.2
  ...
  %i45 = or i1 %cmp345.1.1, %cmp345.11219
  %x.0.b.3.1.1 = select i1 %cmp345.1.1, i32 1, i32 %x.0.b.3.11222
  %cmp345.2.1 = icmp sgt i32 %i38, %.m.1.1.1
  %.m.1.2.1 = select i1 %cmp345.2.1, i32 %i38, i32 %.m.1.1.1
  %i46 = or i1 %cmp345.2.1, %i45
  %y.0.a.3.2.1 = select i1 %i46, i32 1, i32 %y.0.a.3.2
  %x.0.b.3.2.1 = select i1 %cmp345.2.1, i32 2, i32 %x.0.b.3.1.1
  %cmp345.21224 = icmp sgt i32 %i37, %.m.1.2.1
  %.m.1.21225 = select i1 %cmp345.21224, i32 %i37, i32 %.m.1.2.1
  %x.0.b.3.21227 = select i1 %cmp345.21224, i32 0, i32 %x.0.b.3.2.1
  %cmp345.1.2 = icmp sgt i32 %i36, %.m.1.21225
  %.m.1.1.2 = select i1 %cmp345.1.2, i32 %i36, i32 %.m.1.21225
  %i47 = or i1 %cmp345.1.2, %cmp345.21224
  %x.0.b.3.1.2 = select i1 %cmp345.1.2, i32 1, i32 %x.0.b.3.21227
  %cmp345.2.2 = icmp sgt i32 %i35, %.m.1.1.2
  %.m.1.2.2 = select i1 %cmp345.2.2, i32 %i35, i32 %.m.1.1.2
  %i48 = or i1 %cmp345.2.2, %i47
  %y.0.a.3.2.2 = select i1 %i48, i32 2, i32 %y.0.a.3.2.1
...
if.then712:                                       ; preds = %if.end709
  ...
  %i49 = load i8, i8* %arrayidx717, align 1, !tbaa !7
  %cmp719 = icmp ult i8 %i49, 8
  ...
  %i50 = load i8, i8* %arrayidx725, align 1, !tbaa !7
  %cmp727 = icmp ult i8 %i50, 8
  ...
  %i51 = load i8, i8* %arrayidx733, align 1, !tbaa !7
  %cmp735 = icmp ult i8 %i51, 8
  ...
  %i52 = load i8, i8* %arrayidx741, align 1, !tbaa !7
  %cmp743 = icmp ult i8 %i52, 8
...
if.then750:                                       ; preds = %if.then712
  ...
  %i53 = load i8, i8* %arrayidx756, align 1, !tbaa !7
  %cmp758 = icmp ult i8 %i53, 8
  ...
  %i54 = load i8, i8* %arrayidx765, align 1, !tbaa !7
  %cmp767 = icmp ult i8 %i54, 8
  ...
  %i55 = load i8, i8* %arrayidx774, align 1, !tbaa !7
  %cmp776 = icmp ult i8 %i55, 8
  ...
  %i56 = load i8, i8* %arrayidx783, align 1, !tbaa !7
  %cmp785 = icmp ult i8 %i56, 8
...
if.then415:                                       ; preds = %if.end412
  ...
  %i57 = load i8, i8* %arrayidx421, align 1, !tbaa !7
  %cmp423 = icmp ult i8 %i57, 8
  ...
  %i58 = load i8, i8* %arrayidx430, align 1, !tbaa !7
  %cmp432 = icmp ult i8 %i58, 8
  ...
  %i59 = load i8, i8* %arrayidx439, align 1, !tbaa !7
  %cmp441 = icmp ult i8 %i59, 8
  ...
  %i60 = load i8, i8* %arrayidx448, align 1, !tbaa !7
  %cmp450 = icmp ult i8 %i60, 8
...
if.then459:                                       ; preds = %land.lhs.true457
  ...
  %i61 = load i32, i32* %arrayidx477, align 4, !tbaa !5
  %conv478 = sitofp i32 %i61 to float
  %conv479 = sitofp i32 %i10 to float
...
land.lhs.true486:                                 ; preds = %if.then483
  ...
  %i62 = load i8, i8* %arrayidx492, align 1, !tbaa !7
  %cmp494 = icmp ugt i8 %i62, 7
...
land.lhs.true496:                                 ; preds = %land.lhs.true486
  ...
  %i63 = load i8, i8* %arrayidx503, align 1, !tbaa !7
  %cmp505 = icmp ugt i8 %i63, 7
...
land.lhs.true507:                                 ; preds = %land.lhs.true496
  ...
  %i64 = load i8, i8* %arrayidx514, align 1, !tbaa !7
  %cmp516 = icmp ugt i8 %i64, 7
...
land.lhs.true520:                                 ; preds = %lor.lhs.false
  ...
  %i65 = load i8, i8* %arrayidx526, align 1, !tbaa !7
  %cmp528 = icmp ugt i8 %i65, 7
...
land.lhs.true530:                                 ; preds = %land.lhs.true520
  ...
  %i66 = load i8, i8* %arrayidx537, align 1, !tbaa !7
  %cmp539 = icmp ugt i8 %i66, 7
...
land.lhs.true541:                                 ; preds = %land.lhs.true530
  ...
  %i67 = load i8, i8* %arrayidx548, align 1, !tbaa !7
  %cmp550 = icmp ugt i8 %i67, 7
...
if.else565:                                       ; preds = %land.lhs.true457, %if.then415
  ...
  %i68 = load i8, i8* %arrayidx570, align 1, !tbaa !7
  %cmp572 = icmp ult i8 %i68, 8
  ...
  %i69 = load i8, i8* %arrayidx578, align 1, !tbaa !7
  %cmp580 = icmp ult i8 %i69, 8
  ...
  %i70 = load i8, i8* %arrayidx586, align 1, !tbaa !7
  %cmp588 = icmp ult i8 %i70, 8
  ...
  %i71 = load i8, i8* %arrayidx594, align 1, !tbaa !7
  %cmp596 = icmp ult i8 %i71, 8
...
land.lhs.true608:                                 ; preds = %land.lhs.true603
  ...
  %i72 = load i8, i8* %arrayidx614, align 1, !tbaa !7
  %cmp616 = icmp ult i8 %i72, 8
  ...
  %i73 = load i8, i8* %arrayidx623, align 1, !tbaa !7
  %cmp625 = icmp ult i8 %i73, 8
  ...
  %i74 = load i8, i8* %arrayidx634, align 1, !tbaa !7
  %cmp636 = icmp ult i8 %i74, 8
  ...
  %i75 = load i8, i8* %arrayidx643, align 1, !tbaa !7
  %cmp645 = icmp ult i8 %i75, 8
  ...
  %i76 = load i8, i8* %arrayidx655, align 1, !tbaa !7
  %cmp657 = icmp ult i8 %i76, 8
  ...
  %i77 = load i8, i8* %arrayidx664, align 1, !tbaa !7
  %cmp666 = icmp ult i8 %i77, 8
  ...
  %i78 = load i8, i8* %arrayidx676, align 1, !tbaa !7
  %cmp678 = icmp ult i8 %i78, 8
  ...
  %i79 = load i8, i8* %arrayidx685, align 1, !tbaa !7
  %cmp687 = icmp ult i8 %i79, 8
...
"susan_thin$0$0_recursively_call_function":       ; preds = %"susan_thin$0$0_increment_depth_counter"
  call void @"susan_thin$0$0"(%15* %arg, i32 %a.6, i32 %b.6, i32 %inc824, i32 %i.7, i32 %arg5, i64 %arg6, i32* %arg7, i32 %arg8, i8* %arg9)
  ret void

"susan_thin$0$0_return_from_recursive_function$0": ; preds = %"susan_thin$0$0_latch$0"
  %i80 = getelementptr %15, %15* %arg, i32 0, i32 0
  store i32 %a.6, i32* %i80, align 4
  %i81 = getelementptr %15, %15* %arg, i32 0, i32 1
  store i32 %i.7, i32* %i81, align 4
  %i82 = getelementptr %15, %15* %arg, i32 0, i32 2
  store i32 %b.6, i32* %i82, align 4
  ret void
}

define void @"susan_edges$0$0"(i32 %arg, i64 %arg1, i8* %arg2, i32 %arg3, i32 %arg4, i32 %arg5, i64 %arg6, i64 %arg7, i64 %arg8, i32* %arg9, i32 %arg10, i32 %arg11, i8* %arg12, i8* %arg13, i32 %arg14, i8* %arg15) {
"susan_edges$0$0_header":
  %add299 = add nsw i32 %arg, %arg10
...
if.then304:                                       ; preds = %"susan_edges$0$0_header"
  %sub309 = sub nsw i32 %arg11, %i
  %arrayidx313 = getelementptr inbounds i8, i8* %arg12, i64 %idxprom300
  %i16 = load i8, i8* %arrayidx313, align 1, !tbaa !7
  %idx.ext315 = zext i8 %i16 to i64
  %add.ptr316 = getelementptr inbounds i8, i8* %arg13, i64 %idx.ext315
  %cmp317 = icmp sgt i32 %sub309, 600
  %add.ptr325 = getelementptr inbounds i8, i8* %arg15, i64 %arg1
...
if.then304.if.then762_crit_edge:                  ; preds = %if.then304
  ...
  %.pre2085 = getelementptr inbounds i8, i8* %.pre2084, i64 %arg7
  ...
  %.pre2092 = getelementptr inbounds i8, i8* %.pre2091, i64 %arg6
  ...
  %.pre2098 = getelementptr inbounds i8, i8* %.pre2097, i64 %arg6
  ...
  %.pre2105 = getelementptr inbounds i8, i8* %.pre2104, i64 %arg7
...
if.then319:                                       ; preds = %if.then304
  %i17 = load i8, i8* %add.ptr326, align 1, !tbaa !7
  %idx.ext329 = zext i8 %i17 to i64
  %idx.neg330 = sub nsw i64 0, %idx.ext329
  %add.ptr331 = getelementptr inbounds i8, i8* %add.ptr316, i64 %idx.neg330
  %i18 = load i8, i8* %add.ptr331, align 1, !tbaa !7
  %conv332 = zext i8 %i18 to i32
  %incdec.ptr337 = getelementptr inbounds i8, i8* %incdec.ptr327, i64 1
  %i19 = load i8, i8* %incdec.ptr327, align 1, !tbaa !7
  %idx.ext339 = zext i8 %i19 to i64
  %idx.neg340 = sub nsw i64 0, %idx.ext339
  %add.ptr341 = getelementptr inbounds i8, i8* %add.ptr316, i64 %idx.neg340
  %i20 = load i8, i8* %add.ptr341, align 1, !tbaa !7
  %conv342 = zext i8 %i20 to i32
  %i21 = add nuw nsw i32 %conv342, %conv332
  %i22 = load i8, i8* %incdec.ptr337, align 1, !tbaa !7
  %idx.ext346 = zext i8 %i22 to i64
  %idx.neg347 = sub nsw i64 0, %idx.ext346
  %add.ptr348 = getelementptr inbounds i8, i8* %add.ptr316, i64 %idx.neg347
  %i23 = load i8, i8* %add.ptr348, align 1, !tbaa !7
  %conv349 = zext i8 %i23 to i32
  %sub3441973 = add nuw nsw i32 %i21, %conv349
  ...
  %add.ptr408 = getelementptr inbounds i8, i8* %incdec.ptr386, i64 %arg7
  ...
  %i84 = load i8, i8* %add.ptr642, align 1, !tbaa !7
  %idx.ext645 = zext i8 %i84 to i64
  %idx.neg646 = sub nsw i64 0, %idx.ext645
  %add.ptr647 = getelementptr inbounds i8, i8* %add.ptr316, i64 %idx.neg646
  %i85 = load i8, i8* %add.ptr647, align 1, !tbaa !7
  %conv648 = zext i8 %i85 to i32
  %incdec.ptr653 = getelementptr inbounds i8, i8* %incdec.ptr643, i64 1
  %i86 = load i8, i8* %incdec.ptr643, align 1, !tbaa !7
  %idx.ext655 = zext i8 %i86 to i64
  %idx.neg656 = sub nsw i64 0, %idx.ext655
  %add.ptr657 = getelementptr inbounds i8, i8* %add.ptr316, i64 %idx.neg656
  %i87 = load i8, i8* %add.ptr657, align 1, !tbaa !7
  %conv658 = zext i8 %i87 to i32
  %i88 = load i8, i8* %incdec.ptr653, align 1, !tbaa !7
  %idx.ext662 = zext i8 %i88 to i64
  %idx.neg663 = sub nsw i64 0, %idx.ext662
  %add.ptr664 = getelementptr inbounds i8, i8* %add.ptr316, i64 %idx.neg663
  %i89 = load i8, i8* %add.ptr664, align 1, !tbaa !7
  %conv665 = zext i8 %i89 to i32
...
if.then762:                                       ; preds = %if.then319, %if.then304.if.then762_crit_edge
  ...
  %i90 = load i8, i8* %add.ptr326, align 1, !tbaa !7
  %idx.ext772 = zext i8 %i90 to i64
  %idx.neg773 = sub nsw i64 0, %idx.ext772
  %add.ptr774 = getelementptr inbounds i8, i8* %add.ptr316, i64 %idx.neg773
  %i91 = load i8, i8* %add.ptr774, align 1, !tbaa !7
  %conv775 = zext i8 %i91 to i32
  %i92 = load i8, i8* %incdec.ptr327, align 1, !tbaa !7
  %idx.ext785 = zext i8 %i92 to i64
  %idx.neg786 = sub nsw i64 0, %idx.ext785
  %add.ptr787 = getelementptr inbounds i8, i8* %add.ptr316, i64 %idx.neg786
  %i93 = load i8, i8* %add.ptr787, align 1, !tbaa !7
  %conv788 = zext i8 %i93 to i32
  %i94 = load i8, i8* %incdec.ptr783.pre-phi, align 1, !tbaa !7
  %idx.ext792 = zext i8 %i94 to i64
  %idx.neg793 = sub nsw i64 0, %idx.ext792
  %add.ptr794 = getelementptr inbounds i8, i8* %add.ptr316, i64 %idx.neg793
  %i95 = load i8, i8* %add.ptr794, align 1, !tbaa !7
  %conv795 = zext i8 %i95 to i32
  %mul7811972 = sub nsw i32 %conv775, %conv795
  %i96 = load i8, i8* %add.ptr805.pre-phi, align 1, !tbaa !7
  %idx.ext808 = zext i8 %i96 to i64
  %idx.neg809 = sub nsw i64 0, %idx.ext808
  %add.ptr810 = getelementptr inbounds i8, i8* %add.ptr316, i64 %idx.neg809
  %i97 = load i8, i8* %add.ptr810, align 1, !tbaa !7
  %conv811 = zext i8 %i97 to i32
  %mul812 = shl nuw nsw i32 %conv811, 2
  %i98 = load i8, i8* %incdec.ptr806.pre-phi, align 1, !tbaa !7
  %idx.ext822 = zext i8 %i98 to i64
  %idx.neg823 = sub nsw i64 0, %idx.ext822
  %add.ptr824 = getelementptr inbounds i8, i8* %add.ptr316, i64 %idx.neg823
  %i99 = load i8, i8* %add.ptr824, align 1, !tbaa !7
  %conv825 = zext i8 %i99 to i32
  %i100 = load i8, i8* %incdec.ptr820.pre-phi, align 1, !tbaa !7
  %idx.ext835 = zext i8 %i100 to i64
  %idx.neg836 = sub nsw i64 0, %idx.ext835
  %add.ptr837 = getelementptr inbounds i8, i8* %add.ptr316, i64 %idx.neg836
  %i101 = load i8, i8* %add.ptr837, align 1, !tbaa !7
  %conv838 = zext i8 %i101 to i32
  %i102 = load i8, i8* %incdec.ptr833.pre-phi, align 1, !tbaa !7
  %idx.ext843 = zext i8 %i102 to i64
  %idx.neg844 = sub nsw i64 0, %idx.ext843
  %add.ptr845 = getelementptr inbounds i8, i8* %add.ptr316, i64 %idx.neg844
  %i103 = load i8, i8* %add.ptr845, align 1, !tbaa !7
  %conv846 = zext i8 %i103 to i32
  %mul852 = shl nuw nsw i32 %conv846, 1
  %i104 = load i8, i8* %incdec.ptr841.pre-phi, align 1, !tbaa !7
  %idx.ext855 = zext i8 %i104 to i64
  %idx.neg856 = sub nsw i64 0, %idx.ext855
  %add.ptr857 = getelementptr inbounds i8, i8* %add.ptr316, i64 %idx.neg856
  %i105 = load i8, i8* %add.ptr857, align 1, !tbaa !7
  %conv858 = zext i8 %i105 to i32
  %mul859 = shl nuw nsw i32 %conv858, 2
  %i106 = load i8, i8* %add.ptr869.pre-phi, align 1, !tbaa !7
  %idx.ext872 = zext i8 %i106 to i64
  %idx.neg873 = sub nsw i64 0, %idx.ext872
  %add.ptr874 = getelementptr inbounds i8, i8* %add.ptr316, i64 %idx.neg873
  %i107 = load i8, i8* %add.ptr874, align 1, !tbaa !7
  %conv875 = zext i8 %i107 to i32
  %i108 = load i8, i8* %incdec.ptr870.pre-phi, align 1, !tbaa !7
  %idx.ext885 = zext i8 %i108 to i64
  %idx.neg886 = sub nsw i64 0, %idx.ext885
  %add.ptr887 = getelementptr inbounds i8, i8* %add.ptr316, i64 %idx.neg886
  %i109 = load i8, i8* %add.ptr887, align 1, !tbaa !7
  %conv888 = zext i8 %i109 to i32
  %i110 = load i8, i8* %incdec.ptr883.pre-phi, align 1, !tbaa !7
  %idx.ext898 = zext i8 %i110 to i64
  %idx.neg899 = sub nsw i64 0, %idx.ext898
  %add.ptr900 = getelementptr inbounds i8, i8* %add.ptr316, i64 %idx.neg899
  %i111 = load i8, i8* %add.ptr900, align 1, !tbaa !7
  %conv901 = zext i8 %i111 to i32
  %i112 = load i8, i8* %incdec.ptr896.pre-phi, align 1, !tbaa !7
  %idx.ext909 = zext i8 %i112 to i64
  %idx.neg910 = sub nsw i64 0, %idx.ext909
  %add.ptr911 = getelementptr inbounds i8, i8* %add.ptr316, i64 %idx.neg910
  %i113 = load i8, i8* %add.ptr911, align 1, !tbaa !7
  %conv912 = zext i8 %i113 to i32
  %i114 = load i8, i8* %incdec.ptr907.pre-phi, align 1, !tbaa !7
  %idx.ext916 = zext i8 %i114 to i64
  %idx.neg917 = sub nsw i64 0, %idx.ext916
  %add.ptr918 = getelementptr inbounds i8, i8* %add.ptr316, i64 %idx.neg917
  %i115 = load i8, i8* %add.ptr918, align 1, !tbaa !7
  %conv919 = zext i8 %i115 to i32
  %i116 = load i8, i8* %incdec.ptr914.pre-phi, align 1, !tbaa !7
  %idx.ext927 = zext i8 %i116 to i64
  %idx.neg928 = sub nsw i64 0, %idx.ext927
  %add.ptr929 = getelementptr inbounds i8, i8* %add.ptr316, i64 %idx.neg928
  %i117 = load i8, i8* %add.ptr929, align 1, !tbaa !7
  %conv930 = zext i8 %i117 to i32
  %mul936 = shl nuw nsw i32 %conv930, 1
  %i118 = load i8, i8* %incdec.ptr925.pre-phi, align 1, !tbaa !7
  %idx.ext939 = zext i8 %i118 to i64
  %idx.neg940 = sub nsw i64 0, %idx.ext939
  %add.ptr941 = getelementptr inbounds i8, i8* %add.ptr316, i64 %idx.neg940
  %i119 = load i8, i8* %add.ptr941, align 1, !tbaa !7
  %conv942 = zext i8 %i119 to i32
  %i120 = load i8, i8* %add.ptr1000.pre-phi, align 1, !tbaa !7
  %idx.ext1003 = zext i8 %i120 to i64
  %idx.neg1004 = sub nsw i64 0, %idx.ext1003
  %add.ptr1005 = getelementptr inbounds i8, i8* %add.ptr316, i64 %idx.neg1004
  %i121 = load i8, i8* %add.ptr1005, align 1, !tbaa !7
  %conv1006 = zext i8 %i121 to i32
  %i122 = load i8, i8* %incdec.ptr1001.pre-phi, align 1, !tbaa !7
  %idx.ext1016 = zext i8 %i122 to i64
  %idx.neg1017 = sub nsw i64 0, %idx.ext1016
  %add.ptr1018 = getelementptr inbounds i8, i8* %add.ptr316, i64 %idx.neg1017
  %i123 = load i8, i8* %add.ptr1018, align 1, !tbaa !7
  %conv1019 = zext i8 %i123 to i32
  %mul1025 = shl nuw nsw i32 %conv1019, 1
  %i124 = load i8, i8* %incdec.ptr1014.pre-phi, align 1, !tbaa !7
  %idx.ext1029 = zext i8 %i124 to i64
  %idx.neg1030 = sub nsw i64 0, %idx.ext1029
  %add.ptr1031 = getelementptr inbounds i8, i8* %add.ptr316, i64 %idx.neg1030
  %i125 = load i8, i8* %add.ptr1031, align 1, !tbaa !7
  %conv1032 = zext i8 %i125 to i32
  %i126 = load i8, i8* %incdec.ptr1027.pre-phi, align 1, !tbaa !7
  %idx.ext1040 = zext i8 %i126 to i64
  %idx.neg1041 = sub nsw i64 0, %idx.ext1040
  %add.ptr1042 = getelementptr inbounds i8, i8* %add.ptr316, i64 %idx.neg1041
  %i127 = load i8, i8* %add.ptr1042, align 1, !tbaa !7
  %conv1043 = zext i8 %i127 to i32
  %i128 = load i8, i8* %incdec.ptr1038.pre-phi, align 1, !tbaa !7
  %idx.ext1047 = zext i8 %i128 to i64
  %idx.neg1048 = sub nsw i64 0, %idx.ext1047
  %add.ptr1049 = getelementptr inbounds i8, i8* %add.ptr316, i64 %idx.neg1048
  %i129 = load i8, i8* %add.ptr1049, align 1, !tbaa !7
  %conv1050 = zext i8 %i129 to i32
  %i130 = load i8, i8* %incdec.ptr1045.pre-phi, align 1, !tbaa !7
  %idx.ext1058 = zext i8 %i130 to i64
  %idx.neg1059 = sub nsw i64 0, %idx.ext1058
  %add.ptr1060 = getelementptr inbounds i8, i8* %add.ptr316, i64 %idx.neg1059
  %i131 = load i8, i8* %add.ptr1060, align 1, !tbaa !7
  %conv1061 = zext i8 %i131 to i32
  %i132 = load i8, i8* %incdec.ptr1056.pre-phi, align 1, !tbaa !7
  %idx.ext1070 = zext i8 %i132 to i64
  %idx.neg1071 = sub nsw i64 0, %idx.ext1070
  %add.ptr1072 = getelementptr inbounds i8, i8* %add.ptr316, i64 %idx.neg1071
  %i133 = load i8, i8* %add.ptr1072, align 1, !tbaa !7
  %conv1073 = zext i8 %i133 to i32
  %i134 = load i8, i8* %add.ptr1083.pre-phi, align 1, !tbaa !7
  %idx.ext1086 = zext i8 %i134 to i64
  %idx.neg1087 = sub nsw i64 0, %idx.ext1086
  %add.ptr1088 = getelementptr inbounds i8, i8* %add.ptr316, i64 %idx.neg1087
  %i135 = load i8, i8* %add.ptr1088, align 1, !tbaa !7
  %conv1089 = zext i8 %i135 to i32
  %mul1090 = shl nuw nsw i32 %conv1089, 2
  %i136 = load i8, i8* %incdec.ptr1084.pre-phi, align 1, !tbaa !7
  %idx.ext1100 = zext i8 %i136 to i64
  %idx.neg1101 = sub nsw i64 0, %idx.ext1100
  %add.ptr1102 = getelementptr inbounds i8, i8* %add.ptr316, i64 %idx.neg1101
  %i137 = load i8, i8* %add.ptr1102, align 1, !tbaa !7
  %conv1103 = zext i8 %i137 to i32
  %mul1109 = shl nuw nsw i32 %conv1103, 1
  %i138 = load i8, i8* %incdec.ptr1098.pre-phi, align 1, !tbaa !7
  %idx.ext1113 = zext i8 %i138 to i64
  %idx.neg1114 = sub nsw i64 0, %idx.ext1113
  %add.ptr1115 = getelementptr inbounds i8, i8* %add.ptr316, i64 %idx.neg1114
  %i139 = load i8, i8* %add.ptr1115, align 1, !tbaa !7
  %conv1116 = zext i8 %i139 to i32
  %i140 = load i8, i8* %incdec.ptr1111.pre-phi, align 1, !tbaa !7
  %idx.ext1121 = zext i8 %i140 to i64
  %idx.neg1122 = sub nsw i64 0, %idx.ext1121
  %add.ptr1123 = getelementptr inbounds i8, i8* %add.ptr316, i64 %idx.neg1122
  %i141 = load i8, i8* %add.ptr1123, align 1, !tbaa !7
  %conv1124 = zext i8 %i141 to i32
  %i142 = load i8, i8* %incdec.ptr1119.pre-phi, align 1, !tbaa !7
  %idx.ext1133 = zext i8 %i142 to i64
  %idx.neg1134 = sub nsw i64 0, %idx.ext1133
  %add.ptr1135 = getelementptr inbounds i8, i8* %add.ptr316, i64 %idx.neg1134
  %i143 = load i8, i8* %add.ptr1135, align 1, !tbaa !7
  %conv1136 = zext i8 %i143 to i32
  %mul1137 = shl nuw nsw i32 %conv1136, 2
  %i144 = load i8, i8* %add.ptr1147.pre-phi, align 1, !tbaa !7
  %idx.ext1150 = zext i8 %i144 to i64
  %idx.neg1151 = sub nsw i64 0, %idx.ext1150
  %add.ptr1152 = getelementptr inbounds i8, i8* %add.ptr316, i64 %idx.neg1151
  %i145 = load i8, i8* %add.ptr1152, align 1, !tbaa !7
  %conv1153 = zext i8 %i145 to i32
  %i146 = load i8, i8* %incdec.ptr1148.pre-phi, align 1, !tbaa !7
  %idx.ext1163 = zext i8 %i146 to i64
  %idx.neg1164 = sub nsw i64 0, %idx.ext1163
  %add.ptr1165 = getelementptr inbounds i8, i8* %add.ptr316, i64 %idx.neg1164
  %i147 = load i8, i8* %add.ptr1165, align 1, !tbaa !7
  %conv1166 = zext i8 %i147 to i32
  %i148 = load i8, i8* %incdec.ptr1161.pre-phi, align 1, !tbaa !7
  %idx.ext1170 = zext i8 %i148 to i64
  %idx.neg1171 = sub nsw i64 0, %idx.ext1170
  %add.ptr1172 = getelementptr inbounds i8, i8* %add.ptr316, i64 %idx.neg1171
  %i149 = load i8, i8* %add.ptr1172, align 1, !tbaa !7
  %conv1173 = zext i8 %i149 to i32
...
if.end1188:                                       ; preds = %if.then762
  %i150 = load i8, i8* %add.ptr952.pre-phi, align 1, !tbaa !7
  %idx.ext955 = zext i8 %i150 to i64
  %idx.neg956 = sub nsw i64 0, %idx.ext955
  %add.ptr957 = getelementptr inbounds i8, i8* %add.ptr316, i64 %idx.neg956
  %i151 = load i8, i8* %add.ptr957, align 1, !tbaa !7
  %conv958 = zext i8 %i151 to i32
  %i152 = load i8, i8* %incdec.ptr953.pre-phi, align 1, !tbaa !7
  %idx.ext963 = zext i8 %i152 to i64
  %idx.neg964 = sub nsw i64 0, %idx.ext963
  %add.ptr965 = getelementptr inbounds i8, i8* %add.ptr316, i64 %idx.neg964
  %i153 = load i8, i8* %add.ptr965, align 1, !tbaa !7
  %conv966 = zext i8 %i153 to i32
  %i154 = load i8, i8* %incdec.ptr961.pre-phi, align 1, !tbaa !7
  %idx.ext970 = zext i8 %i154 to i64
  %idx.neg971 = sub nsw i64 0, %idx.ext970
  %add.ptr972 = getelementptr inbounds i8, i8* %add.ptr316, i64 %idx.neg971
  %i155 = load i8, i8* %add.ptr972, align 1, !tbaa !7
  %conv973 = zext i8 %i155 to i32
  %i156 = load i8, i8* %add.ptr975.pre-phi, align 1, !tbaa !7
  %idx.ext978 = zext i8 %i156 to i64
  %idx.neg979 = sub nsw i64 0, %idx.ext978
  %add.ptr980 = getelementptr inbounds i8, i8* %add.ptr316, i64 %idx.neg979
  %i157 = load i8, i8* %add.ptr980, align 1, !tbaa !7
  %conv981 = zext i8 %i157 to i32
  %i158 = load i8, i8* %incdec.ptr976.pre-phi, align 1, !tbaa !7
  %idx.ext985 = zext i8 %i158 to i64
  %idx.neg986 = sub nsw i64 0, %idx.ext985
  %add.ptr987 = getelementptr inbounds i8, i8* %add.ptr316, i64 %idx.neg986
  %i159 = load i8, i8* %add.ptr987, align 1, !tbaa !7
  %conv988 = zext i8 %i159 to i32
  %i160 = load i8, i8* %incdec.ptr983.pre-phi, align 1, !tbaa !7
  %idx.ext992 = zext i8 %i160 to i64
  %idx.neg993 = sub nsw i64 0, %idx.ext992
  %add.ptr994 = getelementptr inbounds i8, i8* %add.ptr316, i64 %idx.neg993
  %i161 = load i8, i8* %add.ptr994, align 1, !tbaa !7
  %conv995 = zext i8 %i161 to i32
...
if.end1205:                                       ; preds = %if.else1198, %if.else1193, %if.end1188, %if.then762
  ...
  %add1206 = add nsw i32 %a.1, %arg4
  %mul1207 = mul nsw i32 %add1206, %arg3
  %i162 = trunc i64 %arg1 to i32
  %add1208 = add i32 %b.1, %i162
  ...
  %i163 = load i32, i32* %arrayidx1211, align 4, !tbaa !5
  %cmp1212 = icmp sgt i32 %i, %i163
  br i1 %cmp1212, label %land.lhs.true1214, label %"susan_edges$0$0_latch$0"

land.lhs.true1214:                                ; preds = %if.end1205
  %sub1215 = sub nsw i32 %arg4, %a.1
  %mul1216 = mul nsw i32 %sub1215, %arg3
  %add1217 = sub i32 %i162, %b.1
  ...
  %i164 = load i32, i32* %arrayidx1220, align 4, !tbaa !5
  %cmp1221 = icmp slt i32 %i, %i164
...
land.lhs.true1223:                                ; preds = %land.lhs.true1214
  ...
  %add1225 = add nsw i32 %mul1224, %arg4
  %mul1226 = mul nsw i32 %add1225, %arg3
  %mul1228 = shl nuw nsw i32 %b.1, 1
  %add1227 = add i32 %mul1228, %i162
  ...
  %i165 = load i32, i32* %arrayidx1231, align 4, !tbaa !5
  %cmp1232 = icmp sgt i32 %i, %i165
  br i1 %cmp1232, label %land.lhs.true1234, label %"susan_edges$0$0_latch$0"

land.lhs.true1234:                                ; preds = %land.lhs.true1223
  %sub1236 = sub nsw i32 %arg4, %mul1224
  %mul1237 = mul nsw i32 %sub1236, %arg3
  %add1238 = sub i32 %i162, %mul1228
  ...
  %i166 = load i32, i32* %arrayidx1242, align 4, !tbaa !5
  %cmp1243 = icmp slt i32 %i, %i166
  br i1 %cmp1243, label %"susan_edges$0$0_latch$0", label %if.then1245

if.then1245:                                      ; preds = %land.lhs.true1234
  %arrayidx1249 = getelementptr inbounds i8, i8* %arg2, i64 %idxprom300
...
if.end711:                                        ; preds = %if.else704, %if.else699, %if.end688
  ...
  %add712 = add nsw i32 %a.0, %arg5
  %mul713 = mul nsw i32 %add712, %arg3
  %i167 = trunc i64 %arg1 to i32
  %add714 = add i32 %b.0, %i167
  %add715 = add i32 %add714, %mul713
  %idxprom716 = sext i32 %add715 to i64
  %arrayidx717 = getelementptr inbounds i32, i32* %arg9, i64 %idxprom716
  %i168 = load i32, i32* %arrayidx717, align 4, !tbaa !5
  %cmp718 = icmp sgt i32 %i, %i168
  br i1 %cmp718, label %land.lhs.true, label %"susan_edges$0$0_latch$0"

land.lhs.true:                                    ; preds = %if.end711
  %sub720 = sub nsw i32 %arg5, %a.0
  %mul721 = mul nsw i32 %sub720, %arg3
  %add722 = sub i32 %i167, %b.0
  ...
  %i169 = load i32, i32* %arrayidx725, align 4, !tbaa !5
  %cmp726 = icmp slt i32 %i, %i169
...
land.lhs.true728:                                 ; preds = %land.lhs.true
  ...
  %add730 = add nsw i32 %mul729, %arg5
  %mul731 = mul nsw i32 %add730, %arg3
  %mul733 = shl nuw nsw i32 %b.0, 1
  %add732 = add i32 %mul733, %i167
  ...
  %i170 = load i32, i32* %arrayidx736, align 4, !tbaa !5
  %cmp737 = icmp sgt i32 %i, %i170
  br i1 %cmp737, label %land.lhs.true739, label %"susan_edges$0$0_latch$0"

land.lhs.true739:                                 ; preds = %land.lhs.true728
  %sub741 = sub nsw i32 %arg5, %mul729
  %mul742 = mul nsw i32 %sub741, %arg3
  %add743 = sub i32 %i167, %mul733
  ...
  %i171 = load i32, i32* %arrayidx747, align 4, !tbaa !5
  %cmp748 = icmp slt i32 %i, %i171
  br i1 %cmp748, label %"susan_edges$0$0_latch$0", label %if.then750

if.then750:                                       ; preds = %land.lhs.true739
  %arrayidx754 = getelementptr inbounds i8, i8* %arg2, i64 %idxprom300
...
"susan_edges$0$0_latch$0":                        ; preds = %if.then750, %land.lhs.true739, %land.lhs.true728, %land.lhs.true, %if.end711, %if.then1245, %land.lhs.true1234, %land.lhs.true1223, %land.lhs.true1214, %if.end1205, %"susan_edges$0$0_header"
  ...
  %lftr.wideiv = trunc i64 %indvars.iv.next to i32
  %exitcond = icmp eq i32 %lftr.wideiv, %arg14
...
"susan_edges$0$0_recursively_call_function":      ; preds = %"susan_edges$0$0_increment_depth_counter"
  call void @"susan_edges$0$0"(i32 %inc1254, i64 %indvars.iv.next, i8* %arg2, i32 %arg3, i32 %arg4, i32 %arg5, i64 %arg6, i64 %arg7, i64 %arg8, i32* %arg9, i32 %arg10, i32 %arg11, i8* %arg12, i8* %arg13, i32 %arg14, i8* %arg15)
  ret void
...
define void @"susan_edges$1$0"(i32 %arg, i64 %arg1, i32 %arg2, i32 %arg3, i64 %arg4, i64 %arg5, i32* %arg6, i32 %arg7, i8* %arg8, i64 %arg9, i8* %arg10, i8* %arg11) {
"susan_edges$1$0_header":
  %add.ptr11 = getelementptr inbounds i8, i8* %arg8, i64 %arg1
  %add.ptr12 = getelementptr inbounds i8, i8* %add.ptr11, i64 -1
  %add = add nsw i32 %arg, %arg7
  %idxprom = sext i32 %add to i64
  %arrayidx = getelementptr inbounds i8, i8* %arg10, i64 %idxprom
  %i = load i8, i8* %arrayidx, align 1, !tbaa !7
  %idx.ext15 = zext i8 %i to i64
  %add.ptr16 = getelementptr inbounds i8, i8* %arg11, i64 %idx.ext15
  %incdec.ptr = getelementptr inbounds i8, i8* %add.ptr12, i64 1
  %i12 = load i8, i8* %add.ptr12, align 1, !tbaa !7
  %idx.ext18 = zext i8 %i12 to i64
  %idx.neg = sub nsw i64 0, %idx.ext18
  ...
  %conv33 = zext i8 %i17 to i32
  %add34 = add nuw nsw i32 %add28, %conv33
  %add.ptr37 = getelementptr inbounds i8, i8* %incdec.ptr22, i64 %arg5
  %incdec.ptr38 = getelementptr inbounds i8, i8* %add.ptr37, i64 1
  %i18 = load i8, i8* %add.ptr37, align 1, !tbaa !7
  %idx.ext40 = zext i8 %i18 to i64
  %idx.neg41 = sub nsw i64 0, %idx.ext40
  ...
  %conv70 = zext i8 %i27 to i32
  %add71 = add nsw i32 %add65, %conv70
  %add.ptr74 = getelementptr inbounds i8, i8* %incdec.ptr59, i64 %arg9
  %incdec.ptr75 = getelementptr inbounds i8, i8* %add.ptr74, i64 1
  %i28 = load i8, i8* %add.ptr74, align 1, !tbaa !7
  %idx.ext77 = zext i8 %i28 to i64
  %idx.neg78 = sub nsw i64 0, %idx.ext77
  ...
  %conv216 = zext i8 %i67 to i32
  %add217 = add nsw i32 %add211, %conv216
  %add.ptr220 = getelementptr inbounds i8, i8* %incdec.ptr205, i64 %arg9
  %incdec.ptr221 = getelementptr inbounds i8, i8* %add.ptr220, i64 1
  %i68 = load i8, i8* %add.ptr220, align 1, !tbaa !7
  %idx.ext223 = zext i8 %i68 to i64
  %idx.neg224 = sub nsw i64 0, %idx.ext223
  ...
  %conv253 = zext i8 %i77 to i32
  %add254 = add nsw i32 %add248, %conv253
  %add.ptr257 = getelementptr inbounds i8, i8* %incdec.ptr242, i64 %arg5
  %incdec.ptr258 = getelementptr inbounds i8, i8* %add.ptr257, i64 1
  %i78 = load i8, i8* %add.ptr257, align 1, !tbaa !7
  %idx.ext260 = zext i8 %i78 to i64
  %idx.neg261 = sub nsw i64 0, %idx.ext260
  ...
  %conv276 = zext i8 %i83 to i32
  %add277 = add nsw i32 %add271, %conv276
  %cmp278 = icmp sgt i32 %add277, %arg3
  br i1 %cmp278, label %"susan_edges$1$0_latch$0", label %if.then

if.then:                                          ; preds = %"susan_edges$1$0_header"
  %sub280 = sub nsw i32 %arg3, %add277
  %arrayidx284 = getelementptr inbounds i32, i32* %arg6, i64 %idxprom
  store i32 %sub280, i32* %arrayidx284, align 4, !tbaa !5
...
"susan_edges$1$0_recursively_call_function":      ; preds = %"susan_edges$1$0_increment_depth_counter"
  call void @"susan_edges$1$0"(i32 %inc, i64 %indvars.iv.next2067, i32 %arg2, i32 %arg3, i64 %arg4, i64 %arg5, i32* %arg6, i32 %arg7, i8* %arg8, i64 %arg9, i8* %arg10, i8* %arg11)
  ret void
...
define void @"susan_edges_small$0$0"(i32 %arg, i64 %arg1, i32 %arg2, i32 %arg3, i8* %arg4, i32 %arg5, i32* %arg6, i8* %arg7, i32 %arg8, i32 %arg9, i8* %arg10, i8* %arg11, i64 %arg12) {
...
if.then100:                                       ; preds = %"susan_edges_small$0$0_header"
  ...
  %arrayidx109 = getelementptr inbounds i8, i8* %arg10, i64 %idxprom96
  %i13 = load i8, i8* %arrayidx109, align 1, !tbaa !7
  %idx.ext111 = zext i8 %i13 to i64
  %add.ptr112 = getelementptr inbounds i8, i8* %arg11, i64 %idx.ext111
  %cmp113 = icmp sgt i32 %sub105, 250
  %add.ptr121 = getelementptr inbounds i8, i8* %arg7, i64 %arg1
...
if.then115:                                       ; preds = %if.then100
  %i14 = load i8, i8* %add.ptr122, align 1, !tbaa !7
  %idx.ext125 = zext i8 %i14 to i64
  %idx.neg126 = sub nsw i64 0, %idx.ext125
  %add.ptr127 = getelementptr inbounds i8, i8* %add.ptr112, i64 %idx.neg126
  %i15 = load i8, i8* %add.ptr127, align 1, !tbaa !7
  %conv128 = zext i8 %i15 to i32
  %incdec.ptr132 = getelementptr inbounds i8, i8* %incdec.ptr123, i64 1
  %i16 = load i8, i8* %incdec.ptr123, align 1, !tbaa !7
  %idx.ext134 = zext i8 %i16 to i64
  %idx.neg135 = sub nsw i64 0, %idx.ext134
  %add.ptr136 = getelementptr inbounds i8, i8* %add.ptr112, i64 %idx.neg135
  %i17 = load i8, i8* %add.ptr136, align 1, !tbaa !7
  %conv137 = zext i8 %i17 to i32
  %sum = add nuw nsw i32 %conv137, %conv128
  %i18 = load i8, i8* %incdec.ptr132, align 1, !tbaa !7
  %idx.ext140 = zext i8 %i18 to i64
  %idx.neg141 = sub nsw i64 0, %idx.ext140
  %add.ptr142 = getelementptr inbounds i8, i8* %add.ptr112, i64 %idx.neg141
  %i19 = load i8, i8* %add.ptr142, align 1, !tbaa !7
  %conv143 = zext i8 %i19 to i32
  ...
  %i24 = load i8, i8* %add.ptr165, align 1, !tbaa !7
  %idx.ext168 = zext i8 %i24 to i64
  %idx.neg169 = sub nsw i64 0, %idx.ext168
  %add.ptr170 = getelementptr inbounds i8, i8* %add.ptr112, i64 %idx.neg169
  %i25 = load i8, i8* %add.ptr170, align 1, !tbaa !7
  %conv171 = zext i8 %i25 to i32
  ...
  %i26 = load i8, i8* %incdec.ptr166, align 1, !tbaa !7
  %idx.ext177 = zext i8 %i26 to i64
  %idx.neg178 = sub nsw i64 0, %idx.ext177
  %add.ptr179 = getelementptr inbounds i8, i8* %add.ptr112, i64 %idx.neg178
  %i27 = load i8, i8* %add.ptr179, align 1, !tbaa !7
  %conv180 = zext i8 %i27 to i32
  %add181 = add nsw i32 %add174, %conv180
  %i28 = load i8, i8* %incdec.ptr175, align 1, !tbaa !7
  %idx.ext183 = zext i8 %i28 to i64
  %idx.neg184 = sub nsw i64 0, %idx.ext183
  %add.ptr185 = getelementptr inbounds i8, i8* %add.ptr112, i64 %idx.neg184
  %i29 = load i8, i8* %add.ptr185, align 1, !tbaa !7
  %conv186 = zext i8 %i29 to i32
...
if.then260:                                       ; preds = %if.then115, %if.then100.if.then260_crit_edge
  ...
  %i30 = load i8, i8* %add.ptr122, align 1, !tbaa !7
  %idx.ext270 = zext i8 %i30 to i64
  %idx.neg271 = sub nsw i64 0, %idx.ext270
  %add.ptr272 = getelementptr inbounds i8, i8* %add.ptr112, i64 %idx.neg271
  %i31 = load i8, i8* %add.ptr272, align 1, !tbaa !7
  %conv273 = zext i8 %i31 to i32
  %i32 = load i8, i8* %incdec.ptr123, align 1, !tbaa !7
  %idx.ext281 = zext i8 %i32 to i64
  %idx.neg282 = sub nsw i64 0, %idx.ext281
  %add.ptr283 = getelementptr inbounds i8, i8* %add.ptr112, i64 %idx.neg282
  %i33 = load i8, i8* %add.ptr283, align 1, !tbaa !7
  %conv284 = zext i8 %i33 to i32
  %add285 = add nuw nsw i32 %conv284, %conv273
  %i34 = load i8, i8* %incdec.ptr279.pre-phi, align 1, !tbaa !7
  %idx.ext287 = zext i8 %i34 to i64
  %idx.neg288 = sub nsw i64 0, %idx.ext287
  %add.ptr289 = getelementptr inbounds i8, i8* %add.ptr112, i64 %idx.neg288
  %i35 = load i8, i8* %add.ptr289, align 1, !tbaa !7
  %conv290 = zext i8 %i35 to i32
  %add293 = add nuw nsw i32 %add285, %conv290
  %sub295 = sub nsw i32 %conv273, %conv290
  %i36 = load i8, i8* %add.ptr314.pre-phi, align 1, !tbaa !7
  %idx.ext317 = zext i8 %i36 to i64
  %idx.neg318 = sub nsw i64 0, %idx.ext317
  %add.ptr319 = getelementptr inbounds i8, i8* %add.ptr112, i64 %idx.neg318
  %i37 = load i8, i8* %add.ptr319, align 1, !tbaa !7
  %conv320 = zext i8 %i37 to i32
  %add323 = add nuw nsw i32 %add293, %conv320
  %sub325 = sub nsw i32 %sub295, %conv320
  %i38 = load i8, i8* %incdec.ptr315.pre-phi, align 1, !tbaa !7
  %idx.ext328 = zext i8 %i38 to i64
  %idx.neg329 = sub nsw i64 0, %idx.ext328
  %add.ptr330 = getelementptr inbounds i8, i8* %add.ptr112, i64 %idx.neg329
  %i39 = load i8, i8* %add.ptr330, align 1, !tbaa !7
  %conv331 = zext i8 %i39 to i32
  %add332 = add nuw nsw i32 %add323, %conv331
  %i40 = load i8, i8* %incdec.ptr326.pre-phi, align 1, !tbaa !7
  %idx.ext334 = zext i8 %i40 to i64
  %idx.neg335 = sub nsw i64 0, %idx.ext334
  %add.ptr336 = getelementptr inbounds i8, i8* %add.ptr112, i64 %idx.neg335
  %i41 = load i8, i8* %add.ptr336, align 1, !tbaa !7
  %conv337 = zext i8 %i41 to i32
...
if.end350:                                        ; preds = %if.then260
  ...
  %i42 = load i8, i8* %add.ptr298.pre-phi, align 1, !tbaa !7
  %idx.ext300 = zext i8 %i42 to i64
  %idx.neg301 = sub nsw i64 0, %idx.ext300
  %add.ptr302 = getelementptr inbounds i8, i8* %add.ptr112, i64 %idx.neg301
  %i43 = load i8, i8* %add.ptr302, align 1, !tbaa !7
  %conv303 = zext i8 %i43 to i32
  %i44 = load i8, i8* %add.ptr305.pre-phi, align 1, !tbaa !7
  %idx.ext307 = zext i8 %i44 to i64
  %idx.neg308 = sub nsw i64 0, %idx.ext307
  %add.ptr309 = getelementptr inbounds i8, i8* %add.ptr112, i64 %idx.neg308
  %i45 = load i8, i8* %add.ptr309, align 1, !tbaa !7
  %conv310 = zext i8 %i45 to i32
...
if.end367:                                        ; preds = %if.else360, %if.else355, %if.end350, %if.then260
  ...
  %add368 = add nsw i32 %a.1, %arg9
  %mul369 = mul nsw i32 %add368, %arg5
  ...
  %i47 = load i32, i32* %arrayidx373, align 4, !tbaa !5
  %cmp374 = icmp sgt i32 %i, %i47
  br i1 %cmp374, label %land.lhs.true376, label %"susan_edges_small$0$0_latch$0"

land.lhs.true376:                                 ; preds = %if.end367
  %sub377 = sub nsw i32 %arg9, %a.1
  %mul378 = mul nsw i32 %sub377, %arg5
  ...
  %i48 = load i32, i32* %arrayidx382, align 4, !tbaa !5
  %cmp383 = icmp slt i32 %i, %i48
  br i1 %cmp383, label %"susan_edges_small$0$0_latch$0", label %if.then385

if.then385:                                       ; preds = %land.lhs.true376
  %arrayidx389 = getelementptr inbounds i8, i8* %arg4, i64 %idxprom96
...
if.end231:                                        ; preds = %if.else224, %if.else219, %if.end208
  ...
  %mul233 = mul nsw i32 %add232, %arg5
  %i49 = trunc i64 %arg1 to i32
  %add234 = add i32 %b.0, %i49
  ...
  %i50 = load i32, i32* %arrayidx237, align 4, !tbaa !5
  %cmp238 = icmp sgt i32 %i, %i50
...
land.lhs.true:                                    ; preds = %if.end231
  ...
  %mul241 = mul nsw i32 %sub240, %arg5
  %add242 = sub i32 %i49, %b.0
  ...
  %i51 = load i32, i32* %arrayidx245, align 4, !tbaa !5
  %cmp246 = icmp slt i32 %i, %i51
  br i1 %cmp246, label %"susan_edges_small$0$0_latch$0", label %if.then248

if.then248:                                       ; preds = %land.lhs.true
  %arrayidx252 = getelementptr inbounds i8, i8* %arg4, i64 %idxprom96
...
"susan_edges_small$0$0_recursively_call_function": ; preds = %"susan_edges_small$0$0_increment_depth_counter"
  call void @"susan_edges_small$0$0"(i32 %inc394, i64 %indvars.iv.next, i32 %arg2, i32 %arg3, i8* %arg4, i32 %arg5, i32* %arg6, i8* %arg7, i32 %arg8, i32 %arg9, i8* %arg10, i8* %arg11, i64 %arg12)
  ret void
...
define void @"susan_edges_small$1$0"(i32 %arg, i64 %arg1, i32 %arg2, i32 %arg3, i8* %arg4, i8* %arg5, i32* %arg6, i8* %arg7, i64 %arg8) {
...
if.then:                                          ; preds = %"susan_edges_small$1$0_header"
  %sub76 = sub nsw i32 730, %add73
  %arrayidx80 = getelementptr inbounds i32, i32* %arg6, i64 %idxprom
  store i32 %sub76, i32* %arrayidx80, align 4, !tbaa !5
...
"susan_edges_small$1$0_recursively_call_function": ; preds = %"susan_edges_small$1$0_increment_depth_counter"
  call void @"susan_edges_small$1$0"(i32 %inc, i64 %indvars.iv.next658, i32 %arg2, i32 %arg3, i8* %arg4, i8* %arg5, i32* %arg6, i8* %arg7, i64 %arg8)
  ret void
...
define void @"susan_corners$0$0"(%16* %arg, i32 %arg1, i64 %arg2, i32 %arg3, i8* %arg4, i32* %arg5, i32* %arg6, i64 %arg7, i64 %arg8, i64 %arg9, i32* %arg10, i64 %arg11, i32 %arg12, i64 %arg13, i32 %arg14, %struct.anon* %arg15, i64 %arg16, i64 %arg17) {
"susan_corners$0$0_header":
  %add922 = add nsw i32 %arg1, %arg12
...
if.then927:                                       ; preds = %"susan_corners$0$0_header"
  %i18 = add nsw i64 %arg2, %arg13
  %i19 = add nsw i64 %i18, -3
  %arrayidx933 = getelementptr inbounds i32, i32* %arg10, i64 %i19
  %i20 = load i32, i32* %arrayidx933, align 4, !tbaa !5
  %cmp934 = icmp sgt i32 %i, %i20
  br i1 %cmp934, label %land.lhs.true, label %"susan_corners$0$0_latch$0"

land.lhs.true:                                    ; preds = %if.then927
  %i21 = add nsw i64 %i18, -2
  %arrayidx941 = getelementptr inbounds i32, i32* %arg10, i64 %i21
  %i22 = load i32, i32* %arrayidx941, align 4, !tbaa !5
  %cmp942 = icmp sgt i32 %i, %i22
...
land.lhs.true944:                                 ; preds = %land.lhs.true
  ...
  %arrayidx950 = getelementptr inbounds i32, i32* %arg10, i64 %i23
  %i24 = load i32, i32* %arrayidx950, align 4, !tbaa !5
  %cmp951 = icmp sgt i32 %i, %i24
  br i1 %cmp951, label %land.lhs.true953, label %"susan_corners$0$0_latch$0"

land.lhs.true953:                                 ; preds = %land.lhs.true944
  %arrayidx958 = getelementptr inbounds i32, i32* %arg10, i64 %i18
  %i25 = load i32, i32* %arrayidx958, align 4, !tbaa !5
  %cmp959 = icmp sgt i32 %i, %i25
...
land.lhs.true961:                                 ; preds = %land.lhs.true953
  ...
  %arrayidx967 = getelementptr inbounds i32, i32* %arg10, i64 %i26
  %i27 = load i32, i32* %arrayidx967, align 4, !tbaa !5
  %cmp968 = icmp sgt i32 %i, %i27
...
land.lhs.true970:                                 ; preds = %land.lhs.true961
  ...
  %arrayidx976 = getelementptr inbounds i32, i32* %arg10, i64 %i28
  %i29 = load i32, i32* %arrayidx976, align 4, !tbaa !5
  %cmp977 = icmp sgt i32 %i, %i29
...
land.lhs.true979:                                 ; preds = %land.lhs.true970
  ...
  %arrayidx985 = getelementptr inbounds i32, i32* %arg10, i64 %i30
  %i31 = load i32, i32* %arrayidx985, align 4, !tbaa !5
  %cmp986 = icmp sgt i32 %i, %i31
  br i1 %cmp986, label %land.lhs.true988, label %"susan_corners$0$0_latch$0"

land.lhs.true988:                                 ; preds = %land.lhs.true979
  %i32 = add nsw i64 %arg2, %arg11
  %i33 = add nsw i64 %i32, -3
  %arrayidx994 = getelementptr inbounds i32, i32* %arg10, i64 %i33
  %i34 = load i32, i32* %arrayidx994, align 4, !tbaa !5
  %cmp995 = icmp sgt i32 %i, %i34
...
land.lhs.true997:                                 ; preds = %land.lhs.true988
  ...
  %arrayidx1003 = getelementptr inbounds i32, i32* %arg10, i64 %i35
  %i36 = load i32, i32* %arrayidx1003, align 4, !tbaa !5
  %cmp1004 = icmp sgt i32 %i, %i36
...
land.lhs.true1023:                                ; preds = %land.lhs.true1015
  ...
  %arrayidx1029 = getelementptr inbounds i32, i32* %arg10, i64 %i40
  %i41 = load i32, i32* %arrayidx1029, align 4, !tbaa !5
  %cmp1030 = icmp sgt i32 %i, %i41
...
land.lhs.true1032:                                ; preds = %land.lhs.true1023
  ...
  %arrayidx1038 = getelementptr inbounds i32, i32* %arg10, i64 %i42
  %i43 = load i32, i32* %arrayidx1038, align 4, !tbaa !5
  %cmp1039 = icmp sgt i32 %i, %i43
...
land.lhs.true1041:                                ; preds = %land.lhs.true1032
  ...
  %arrayidx1047 = getelementptr inbounds i32, i32* %arg10, i64 %i44
  %i45 = load i32, i32* %arrayidx1047, align 4, !tbaa !5
  %cmp1048 = icmp sgt i32 %i, %i45
  br i1 %cmp1048, label %land.lhs.true1050, label %"susan_corners$0$0_latch$0"

land.lhs.true1050:                                ; preds = %land.lhs.true1041
  %i46 = add nsw i64 %arg2, %arg16
  %i47 = add nsw i64 %i46, -3
  %arrayidx1056 = getelementptr inbounds i32, i32* %arg10, i64 %i47
  %i48 = load i32, i32* %arrayidx1056, align 4, !tbaa !5
  %cmp1057 = icmp sgt i32 %i, %i48
...
land.lhs.true1059:                                ; preds = %land.lhs.true1050
  ...
  %arrayidx1065 = getelementptr inbounds i32, i32* %arg10, i64 %i49
  %i50 = load i32, i32* %arrayidx1065, align 4, !tbaa !5
  %cmp1066 = icmp sgt i32 %i, %i50
...
land.lhs.true1068:                                ; preds = %land.lhs.true1059
  ...
  %arrayidx1074 = getelementptr inbounds i32, i32* %arg10, i64 %i51
  %i52 = load i32, i32* %arrayidx1074, align 4, !tbaa !5
  %cmp1075 = icmp sgt i32 %i, %i52
  br i1 %cmp1075, label %land.lhs.true1077, label %"susan_corners$0$0_latch$0"

land.lhs.true1077:                                ; preds = %land.lhs.true1068
  %arrayidx1082 = getelementptr inbounds i32, i32* %arg10, i64 %i46
  %i53 = load i32, i32* %arrayidx1082, align 4, !tbaa !5
  %cmp1083 = icmp sgt i32 %i, %i53
...
land.lhs.true1085:                                ; preds = %land.lhs.true1077
  ...
  %arrayidx1091 = getelementptr inbounds i32, i32* %arg10, i64 %i54
  %i55 = load i32, i32* %arrayidx1091, align 4, !tbaa !5
  %cmp1092 = icmp sgt i32 %i, %i55
...
land.lhs.true1094:                                ; preds = %land.lhs.true1085
  ...
  %arrayidx1100 = getelementptr inbounds i32, i32* %arg10, i64 %i56
  %i57 = load i32, i32* %arrayidx1100, align 4, !tbaa !5
  %cmp1101 = icmp sgt i32 %i, %i57
...
land.lhs.true1103:                                ; preds = %land.lhs.true1094
  ...
  %arrayidx1109 = getelementptr inbounds i32, i32* %arg10, i64 %i58
  %i59 = load i32, i32* %arrayidx1109, align 4, !tbaa !5
  %cmp1110 = icmp sgt i32 %i, %i59
...
land.lhs.true1112:                                ; preds = %land.lhs.true1103
  ...
  %i60 = load i32, i32* %arrayidx1117, align 4, !tbaa !5
  %cmp1118 = icmp sgt i32 %i, %i60
...
land.lhs.true1120:                                ; preds = %land.lhs.true1112
  ...
  %i61 = load i32, i32* %arrayidx1125, align 4, !tbaa !5
  %cmp1126 = icmp sgt i32 %i, %i61
...
land.lhs.true1128:                                ; preds = %land.lhs.true1120
  ...
  %i62 = load i32, i32* %arrayidx1133, align 4, !tbaa !5
  %cmp1134 = icmp sgt i32 %i, %i62
...
land.lhs.true1136:                                ; preds = %land.lhs.true1128
  ...
  %i63 = load i32, i32* %arrayidx1141, align 4, !tbaa !5
  %cmp1142 = icmp slt i32 %i, %i63
...
land.lhs.true1144:                                ; preds = %land.lhs.true1136
  ...
  %i64 = load i32, i32* %arrayidx1149, align 4, !tbaa !5
  %cmp1150 = icmp slt i32 %i, %i64
...
land.lhs.true1152:                                ; preds = %land.lhs.true1144
  ...
  %i65 = load i32, i32* %arrayidx1157, align 4, !tbaa !5
  %cmp1158 = icmp slt i32 %i, %i65
  br i1 %cmp1158, label %"susan_corners$0$0_latch$0", label %land.lhs.true1160

land.lhs.true1160:                                ; preds = %land.lhs.true1152
  %i66 = add nsw i64 %arg2, %arg17
  %i67 = add nsw i64 %i66, -3
  %arrayidx1166 = getelementptr inbounds i32, i32* %arg10, i64 %i67
  %i68 = load i32, i32* %arrayidx1166, align 4, !tbaa !5
  %cmp1167 = icmp slt i32 %i, %i68
...
land.lhs.true1169:                                ; preds = %land.lhs.true1160
  ...
  %arrayidx1175 = getelementptr inbounds i32, i32* %arg10, i64 %i69
  %i70 = load i32, i32* %arrayidx1175, align 4, !tbaa !5
  %cmp1176 = icmp slt i32 %i, %i70
...
land.lhs.true1178:                                ; preds = %land.lhs.true1169
  ...
  %arrayidx1184 = getelementptr inbounds i32, i32* %arg10, i64 %i71
  %i72 = load i32, i32* %arrayidx1184, align 4, !tbaa !5
  %cmp1185 = icmp slt i32 %i, %i72
  br i1 %cmp1185, label %"susan_corners$0$0_latch$0", label %land.lhs.true1187

land.lhs.true1187:                                ; preds = %land.lhs.true1178
  %arrayidx1192 = getelementptr inbounds i32, i32* %arg10, i64 %i66
  %i73 = load i32, i32* %arrayidx1192, align 4, !tbaa !5
  %cmp1193 = icmp slt i32 %i, %i73
...
land.lhs.true1195:                                ; preds = %land.lhs.true1187
  ...
  %arrayidx1201 = getelementptr inbounds i32, i32* %arg10, i64 %i74
  %i75 = load i32, i32* %arrayidx1201, align 4, !tbaa !5
  %cmp1202 = icmp slt i32 %i, %i75
...
land.lhs.true1204:                                ; preds = %land.lhs.true1195
  ...
  %arrayidx1210 = getelementptr inbounds i32, i32* %arg10, i64 %i76
  %i77 = load i32, i32* %arrayidx1210, align 4, !tbaa !5
  %cmp1211 = icmp slt i32 %i, %i77
...
land.lhs.true1213:                                ; preds = %land.lhs.true1204
  ...
  %arrayidx1219 = getelementptr inbounds i32, i32* %arg10, i64 %i78
  %i79 = load i32, i32* %arrayidx1219, align 4, !tbaa !5
  %cmp1220 = icmp slt i32 %i, %i79
  br i1 %cmp1220, label %"susan_corners$0$0_latch$0", label %land.lhs.true1222

land.lhs.true1222:                                ; preds = %land.lhs.true1213
  %i80 = add nsw i64 %arg2, %arg9
  %i81 = add nsw i64 %i80, -3
  %arrayidx1228 = getelementptr inbounds i32, i32* %arg10, i64 %i81
  %i82 = load i32, i32* %arrayidx1228, align 4, !tbaa !5
  %cmp1229 = icmp slt i32 %i, %i82
...
land.lhs.true1231:                                ; preds = %land.lhs.true1222
  ...
  %arrayidx1237 = getelementptr inbounds i32, i32* %arg10, i64 %i83
  %i84 = load i32, i32* %arrayidx1237, align 4, !tbaa !5
  %cmp1238 = icmp slt i32 %i, %i84
...
land.lhs.true1240:                                ; preds = %land.lhs.true1231
  ...
  %arrayidx1246 = getelementptr inbounds i32, i32* %arg10, i64 %i85
  %i86 = load i32, i32* %arrayidx1246, align 4, !tbaa !5
  %cmp1247 = icmp slt i32 %i, %i86
  br i1 %cmp1247, label %"susan_corners$0$0_latch$0", label %land.lhs.true1249

land.lhs.true1249:                                ; preds = %land.lhs.true1240
  %arrayidx1254 = getelementptr inbounds i32, i32* %arg10, i64 %i80
  %i87 = load i32, i32* %arrayidx1254, align 4, !tbaa !5
  %cmp1255 = icmp slt i32 %i, %i87
...
land.lhs.true1257:                                ; preds = %land.lhs.true1249
  ...
  %arrayidx1263 = getelementptr inbounds i32, i32* %arg10, i64 %i88
  %i89 = load i32, i32* %arrayidx1263, align 4, !tbaa !5
  %cmp1264 = icmp slt i32 %i, %i89
...
land.lhs.true1266:                                ; preds = %land.lhs.true1257
  ...
  %arrayidx1272 = getelementptr inbounds i32, i32* %arg10, i64 %i90
  %i91 = load i32, i32* %arrayidx1272, align 4, !tbaa !5
  %cmp1273 = icmp slt i32 %i, %i91
...
land.lhs.true1275:                                ; preds = %land.lhs.true1266
  ...
  %arrayidx1281 = getelementptr inbounds i32, i32* %arg10, i64 %i92
  %i93 = load i32, i32* %arrayidx1281, align 4, !tbaa !5
  %cmp1282 = icmp slt i32 %i, %i93
  br i1 %cmp1282, label %"susan_corners$0$0_latch$0", label %land.lhs.true1284

land.lhs.true1284:                                ; preds = %land.lhs.true1275
  %i94 = add nsw i64 %arg2, %arg7
  %i95 = add nsw i64 %i94, -3
  %arrayidx1290 = getelementptr inbounds i32, i32* %arg10, i64 %i95
  %i96 = load i32, i32* %arrayidx1290, align 4, !tbaa !5
  %cmp1291 = icmp slt i32 %i, %i96
...
land.lhs.true1293:                                ; preds = %land.lhs.true1284
  ...
  %arrayidx1299 = getelementptr inbounds i32, i32* %arg10, i64 %i97
  %i98 = load i32, i32* %arrayidx1299, align 4, !tbaa !5
  %cmp1300 = icmp slt i32 %i, %i98
...
land.lhs.true1302:                                ; preds = %land.lhs.true1293
  ...
  %arrayidx1308 = getelementptr inbounds i32, i32* %arg10, i64 %i99
  %i100 = load i32, i32* %arrayidx1308, align 4, !tbaa !5
  %cmp1309 = icmp slt i32 %i, %i100
  br i1 %cmp1309, label %"susan_corners$0$0_latch$0", label %land.lhs.true1311

land.lhs.true1311:                                ; preds = %land.lhs.true1302
  %arrayidx1316 = getelementptr inbounds i32, i32* %arg10, i64 %i94
  %i101 = load i32, i32* %arrayidx1316, align 4, !tbaa !5
  %cmp1317 = icmp slt i32 %i, %i101
...
land.lhs.true1319:                                ; preds = %land.lhs.true1311
  ...
  %arrayidx1325 = getelementptr inbounds i32, i32* %arg10, i64 %i102
  %i103 = load i32, i32* %arrayidx1325, align 4, !tbaa !5
  %cmp1326 = icmp slt i32 %i, %i103
...
land.lhs.true1328:                                ; preds = %land.lhs.true1319
  ...
  %arrayidx1334 = getelementptr inbounds i32, i32* %arg10, i64 %i104
  %i105 = load i32, i32* %arrayidx1334, align 4, !tbaa !5
  %cmp1335 = icmp slt i32 %i, %i105
...
land.lhs.true1337:                                ; preds = %land.lhs.true1328
  ...
  %arrayidx1343 = getelementptr inbounds i32, i32* %arg10, i64 %i106
  %i107 = load i32, i32* %arrayidx1343, align 4, !tbaa !5
  %cmp1344 = icmp slt i32 %i, %i107
...
"susan_corners$0$0_exiting$1":                    ; preds = %land.lhs.true1337
  ...
  %info = getelementptr inbounds %struct.anon, %struct.anon* %arg15, i64 %idxprom1347, i32 2
  store i32 0, i32* %info, align 4, !tbaa !8
  %x1351 = getelementptr inbounds %struct.anon, %struct.anon* %arg15, i64 %idxprom1347, i32 0
  %i108 = trunc i64 %arg2 to i32
  store i32 %i108, i32* %x1351, align 4, !tbaa !20
  %y1354 = getelementptr inbounds %struct.anon, %struct.anon* %arg15, i64 %idxprom1347, i32 1
  store i32 %arg14, i32* %y1354, align 4, !tbaa !15
  %arrayidx1358 = getelementptr inbounds i32, i32* %arg6, i64 %idxprom923
  %i109 = load i32, i32* %arrayidx1358, align 4, !tbaa !5
  %dx = getelementptr inbounds %struct.anon, %struct.anon* %arg15, i64 %idxprom1347, i32 3
  store i32 %i109, i32* %dx, align 4, !tbaa !21
  %arrayidx1364 = getelementptr inbounds i32, i32* %arg5, i64 %idxprom923
  %i110 = load i32, i32* %arrayidx1364, align 4, !tbaa !5
  %dy = getelementptr inbounds %struct.anon, %struct.anon* %arg15, i64 %idxprom1347, i32 4
  store i32 %i110, i32* %dy, align 4, !tbaa !22
  %arrayidx1370 = getelementptr inbounds i8, i8* %arg4, i64 %idxprom923
  %i111 = load i8, i8* %arrayidx1370, align 1, !tbaa !7
  %conv1371 = zext i8 %i111 to i32
  %I = getelementptr inbounds %struct.anon, %struct.anon* %arg15, i64 %idxprom1347, i32 5
...
"susan_corners$0$0_latch$0":                      ; preds = %"susan_corners$0$0_exiting$1", %land.lhs.true1337, %land.lhs.true1328, %land.lhs.true1319, %land.lhs.true1311, %land.lhs.true1302, %land.lhs.true1293, %land.lhs.true1284, %land.lhs.true1275, %land.lhs.true1266, %land.lhs.true1257, %land.lhs.true1249, %land.lhs.true1240, %land.lhs.true1231, %land.lhs.true1222, %land.lhs.true1213, %land.lhs.true1204, %land.lhs.true1195, %land.lhs.true1187, %land.lhs.true1178, %land.lhs.true1169, %land.lhs.true1160, %land.lhs.true1152, %land.lhs.true1144, %land.lhs.true1136, %land.lhs.true1128, %land.lhs.true1120, %land.lhs.true1112, %land.lhs.true1103, %land.lhs.true1094, %land.lhs.true1085, %land.lhs.true1077, %land.lhs.true1068, %land.lhs.true1059, %land.lhs.true1050, %land.lhs.true1041, %land.lhs.true1032, %land.lhs.true1023, %land.lhs.true1015, %land.lhs.true1006, %land.lhs.true997, %land.lhs.true988, %land.lhs.true979, %land.lhs.true970, %land.lhs.true961, %land.lhs.true953, %land.lhs.true944, %land.lhs.true, %if.then927, %"susan_corners$0$0_header"
  ...
  %cmp918 = icmp slt i64 %indvars.iv.next, %arg8
...
"susan_corners$0$0_recursively_call_function":    ; preds = %"susan_corners$0$0_increment_depth_counter"
  call void @"susan_corners$0$0"(%16* %arg, i32 %inc1383, i64 %indvars.iv.next, i32 %n.2, i8* %arg4, i32* %arg5, i32* %arg6, i64 %arg7, i64 %arg8, i64 %arg9, i32* %arg10, i64 %arg11, i32 %arg12, i64 %arg13, i32 %arg14, %struct.anon* %arg15, i64 %arg16, i64 %arg17)
  ret void

"susan_corners$0$0_return_from_recursive_function$0": ; preds = %"susan_corners$0$0_latch$0"
  %i112 = getelementptr %16, %16* %arg, i32 0, i32 0
  store i32 %n.2, i32* %i112, align 4
  %i113 = getelementptr %16, %16* %arg, i32 0, i32 1
  store i8 1, i8* %i113, align 1
  ret void

"susan_corners$0$0_return_from_recursive_function$1": ; preds = %"susan_corners$0$0_exiting$1"
  %i114 = getelementptr %16, %16* %arg, i32 0, i32 1
  store i8 0, i8* %i114, align 1
  ret void
}

define void @"susan_corners$1$0"(i32 %arg, i64 %arg1, i32 %arg2, i32* %arg3, i32* %arg4, i32 %arg5, i32 %arg6, i64 %arg7, i64 %arg8, i32* %arg9, i32 %arg10, i8* %arg11, i32 %arg12, i8* %arg13, i32 %arg14, i8* %arg15, i64 %arg16) {
"susan_corners$1$0_header":
  %add.ptr18 = getelementptr inbounds i8, i8* %arg11, i64 %arg1
  %add.ptr19 = getelementptr inbounds i8, i8* %add.ptr18, i64 -1
  %add = add nsw i32 %arg, %arg10
  %idxprom = sext i32 %add to i64
  %arrayidx = getelementptr inbounds i8, i8* %arg13, i64 %idxprom
  %i = load i8, i8* %arrayidx, align 1, !tbaa !7
  %idx.ext22 = zext i8 %i to i64
  %add.ptr23 = getelementptr inbounds i8, i8* %arg15, i64 %idx.ext22
  %incdec.ptr = getelementptr inbounds i8, i8* %add.ptr19, i64 1
  %i17 = load i8, i8* %add.ptr19, align 1, !tbaa !7
  %idx.ext25 = zext i8 %i17 to i64
  %idx.neg = sub nsw i64 0, %idx.ext25
  %add.ptr26 = getelementptr inbounds i8, i8* %add.ptr23, i64 %idx.neg
  %i18 = load i8, i8* %add.ptr26, align 1, !tbaa !7
  %conv27 = zext i8 %i18 to i32
  %add28 = add nuw nsw i32 %conv27, 100
  %incdec.ptr29 = getelementptr inbounds i8, i8* %incdec.ptr, i64 1
  %i19 = load i8, i8* %incdec.ptr, align 1, !tbaa !7
  %idx.ext31 = zext i8 %i19 to i64
  %idx.neg32 = sub nsw i64 0, %idx.ext31
  %add.ptr33 = getelementptr inbounds i8, i8* %add.ptr23, i64 %idx.neg32
  %i20 = load i8, i8* %add.ptr33, align 1, !tbaa !7
  %conv34 = zext i8 %i20 to i32
  %add35 = add nuw nsw i32 %add28, %conv34
  %i21 = load i8, i8* %incdec.ptr29, align 1, !tbaa !7
  %idx.ext37 = zext i8 %i21 to i64
  %idx.neg38 = sub nsw i64 0, %idx.ext37
  %add.ptr39 = getelementptr inbounds i8, i8* %add.ptr23, i64 %idx.neg38
  %i22 = load i8, i8* %add.ptr39, align 1, !tbaa !7
  %conv40 = zext i8 %i22 to i32
  %add41 = add nuw nsw i32 %add35, %conv40
  %add.ptr44 = getelementptr inbounds i8, i8* %incdec.ptr29, i64 %arg16
  %incdec.ptr45 = getelementptr inbounds i8, i8* %add.ptr44, i64 1
  %i23 = load i8, i8* %add.ptr44, align 1, !tbaa !7
  %idx.ext47 = zext i8 %i23 to i64
  %idx.neg48 = sub nsw i64 0, %idx.ext47
  %add.ptr49 = getelementptr inbounds i8, i8* %add.ptr23, i64 %idx.neg48
  %i24 = load i8, i8* %add.ptr49, align 1, !tbaa !7
  %conv50 = zext i8 %i24 to i32
  %add51 = add nuw nsw i32 %add41, %conv50
  %incdec.ptr52 = getelementptr inbounds i8, i8* %incdec.ptr45, i64 1
  %i25 = load i8, i8* %incdec.ptr45, align 1, !tbaa !7
  %idx.ext54 = zext i8 %i25 to i64
  %idx.neg55 = sub nsw i64 0, %idx.ext54
  %add.ptr56 = getelementptr inbounds i8, i8* %add.ptr23, i64 %idx.neg55
  %i26 = load i8, i8* %add.ptr56, align 1, !tbaa !7
  %conv57 = zext i8 %i26 to i32
  %add58 = add nuw nsw i32 %add51, %conv57
  %incdec.ptr59 = getelementptr inbounds i8, i8* %incdec.ptr52, i64 1
  %i27 = load i8, i8* %incdec.ptr52, align 1, !tbaa !7
  %idx.ext61 = zext i8 %i27 to i64
  %idx.neg62 = sub nsw i64 0, %idx.ext61
  %add.ptr63 = getelementptr inbounds i8, i8* %add.ptr23, i64 %idx.neg62
  %i28 = load i8, i8* %add.ptr63, align 1, !tbaa !7
  %conv64 = zext i8 %i28 to i32
  %add65 = add nuw nsw i32 %add58, %conv64
  %incdec.ptr66 = getelementptr inbounds i8, i8* %incdec.ptr59, i64 1
  %i29 = load i8, i8* %incdec.ptr59, align 1, !tbaa !7
  %idx.ext68 = zext i8 %i29 to i64
  %idx.neg69 = sub nsw i64 0, %idx.ext68
  %add.ptr70 = getelementptr inbounds i8, i8* %add.ptr23, i64 %idx.neg69
  %i30 = load i8, i8* %add.ptr70, align 1, !tbaa !7
  %conv71 = zext i8 %i30 to i32
  %add72 = add nsw i32 %add65, %conv71
  %i31 = load i8, i8* %incdec.ptr66, align 1, !tbaa !7
  %idx.ext74 = zext i8 %i31 to i64
  %idx.neg75 = sub nsw i64 0, %idx.ext74
  %add.ptr76 = getelementptr inbounds i8, i8* %add.ptr23, i64 %idx.neg75
  %i32 = load i8, i8* %add.ptr76, align 1, !tbaa !7
  %conv77 = zext i8 %i32 to i32
  %add78 = add nsw i32 %add72, %conv77
  %add.ptr81 = getelementptr inbounds i8, i8* %incdec.ptr66, i64 %arg8
  %incdec.ptr82 = getelementptr inbounds i8, i8* %add.ptr81, i64 1
  %i33 = load i8, i8* %add.ptr81, align 1, !tbaa !7
  %idx.ext84 = zext i8 %i33 to i64
  %idx.neg85 = sub nsw i64 0, %idx.ext84
  %add.ptr86 = getelementptr inbounds i8, i8* %add.ptr23, i64 %idx.neg85
  %i34 = load i8, i8* %add.ptr86, align 1, !tbaa !7
  %conv87 = zext i8 %i34 to i32
  %add88 = add nsw i32 %add78, %conv87
  %incdec.ptr89 = getelementptr inbounds i8, i8* %incdec.ptr82, i64 1
  %i35 = load i8, i8* %incdec.ptr82, align 1, !tbaa !7
  %idx.ext91 = zext i8 %i35 to i64
  %idx.neg92 = sub nsw i64 0, %idx.ext91
  %add.ptr93 = getelementptr inbounds i8, i8* %add.ptr23, i64 %idx.neg92
  %i36 = load i8, i8* %add.ptr93, align 1, !tbaa !7
  %conv94 = zext i8 %i36 to i32
  %add95 = add nsw i32 %add88, %conv94
  %incdec.ptr96 = getelementptr inbounds i8, i8* %incdec.ptr89, i64 1
  %i37 = load i8, i8* %incdec.ptr89, align 1, !tbaa !7
  %idx.ext98 = zext i8 %i37 to i64
  %idx.neg99 = sub nsw i64 0, %idx.ext98
  %add.ptr100 = getelementptr inbounds i8, i8* %add.ptr23, i64 %idx.neg99
  %i38 = load i8, i8* %add.ptr100, align 1, !tbaa !7
  %conv101 = zext i8 %i38 to i32
  %add102 = add nsw i32 %add95, %conv101
  %incdec.ptr103 = getelementptr inbounds i8, i8* %incdec.ptr96, i64 1
  %i39 = load i8, i8* %incdec.ptr96, align 1, !tbaa !7
  %idx.ext105 = zext i8 %i39 to i64
  %idx.neg106 = sub nsw i64 0, %idx.ext105
  %add.ptr107 = getelementptr inbounds i8, i8* %add.ptr23, i64 %idx.neg106
  %i40 = load i8, i8* %add.ptr107, align 1, !tbaa !7
  %conv108 = zext i8 %i40 to i32
  %add109 = add nsw i32 %add102, %conv108
  %incdec.ptr110 = getelementptr inbounds i8, i8* %incdec.ptr103, i64 1
  %i41 = load i8, i8* %incdec.ptr103, align 1, !tbaa !7
  %idx.ext112 = zext i8 %i41 to i64
  %idx.neg113 = sub nsw i64 0, %idx.ext112
  %add.ptr114 = getelementptr inbounds i8, i8* %add.ptr23, i64 %idx.neg113
  %i42 = load i8, i8* %add.ptr114, align 1, !tbaa !7
  %conv115 = zext i8 %i42 to i32
  %add116 = add nsw i32 %add109, %conv115
  %incdec.ptr117 = getelementptr inbounds i8, i8* %incdec.ptr110, i64 1
  %i43 = load i8, i8* %incdec.ptr110, align 1, !tbaa !7
  %idx.ext119 = zext i8 %i43 to i64
  %idx.neg120 = sub nsw i64 0, %idx.ext119
  %add.ptr121 = getelementptr inbounds i8, i8* %add.ptr23, i64 %idx.neg120
  %i44 = load i8, i8* %add.ptr121, align 1, !tbaa !7
  %conv122 = zext i8 %i44 to i32
  %add123 = add nsw i32 %add116, %conv122
  %i45 = load i8, i8* %incdec.ptr117, align 1, !tbaa !7
  %idx.ext125 = zext i8 %i45 to i64
  %idx.neg126 = sub nsw i64 0, %idx.ext125
  %add.ptr127 = getelementptr inbounds i8, i8* %add.ptr23, i64 %idx.neg126
  %i46 = load i8, i8* %add.ptr127, align 1, !tbaa !7
  %conv128 = zext i8 %i46 to i32
  %add129 = add nsw i32 %add123, %conv128
  %add.ptr132 = getelementptr inbounds i8, i8* %incdec.ptr117, i64 %arg7
  %incdec.ptr133 = getelementptr inbounds i8, i8* %add.ptr132, i64 1
  %i47 = load i8, i8* %add.ptr132, align 1, !tbaa !7
  %idx.ext135 = zext i8 %i47 to i64
  %idx.neg136 = sub nsw i64 0, %idx.ext135
  %add.ptr137 = getelementptr inbounds i8, i8* %add.ptr23, i64 %idx.neg136
  %i48 = load i8, i8* %add.ptr137, align 1, !tbaa !7
  %conv138 = zext i8 %i48 to i32
  %add139 = add nsw i32 %add129, %conv138
  %incdec.ptr140 = getelementptr inbounds i8, i8* %incdec.ptr133, i64 1
  %i49 = load i8, i8* %incdec.ptr133, align 1, !tbaa !7
  %idx.ext142 = zext i8 %i49 to i64
  %idx.neg143 = sub nsw i64 0, %idx.ext142
  %add.ptr144 = getelementptr inbounds i8, i8* %add.ptr23, i64 %idx.neg143
  %i50 = load i8, i8* %add.ptr144, align 1, !tbaa !7
  %conv145 = zext i8 %i50 to i32
  %add146 = add nsw i32 %add139, %conv145
  %i51 = load i8, i8* %incdec.ptr140, align 1, !tbaa !7
  %idx.ext148 = zext i8 %i51 to i64
  %idx.neg149 = sub nsw i64 0, %idx.ext148
  %add.ptr150 = getelementptr inbounds i8, i8* %add.ptr23, i64 %idx.neg149
  %i52 = load i8, i8* %add.ptr150, align 1, !tbaa !7
  %conv151 = zext i8 %i52 to i32
  %add152 = add nsw i32 %add146, %conv151
  %cmp153 = icmp slt i32 %add152, %arg6
...
if.then:                                          ; preds = %"susan_corners$1$0_header"
  ...
  %i53 = load i8, i8* %add.ptr155, align 1, !tbaa !7
  %idx.ext158 = zext i8 %i53 to i64
  %idx.neg159 = sub nsw i64 0, %idx.ext158
  %add.ptr160 = getelementptr inbounds i8, i8* %add.ptr23, i64 %idx.neg159
  %i54 = load i8, i8* %add.ptr160, align 1, !tbaa !7
  %conv161 = zext i8 %i54 to i32
  %add162 = add nsw i32 %conv161, %add152
  %cmp163 = icmp slt i32 %add162, %arg6
...
if.then165:                                       ; preds = %if.then
  ...
  %i55 = load i8, i8* %incdec.ptr156, align 1, !tbaa !7
  %idx.ext168 = zext i8 %i55 to i64
  %idx.neg169 = sub nsw i64 0, %idx.ext168
  %add.ptr170 = getelementptr inbounds i8, i8* %add.ptr23, i64 %idx.neg169
  %i56 = load i8, i8* %add.ptr170, align 1, !tbaa !7
  %conv171 = zext i8 %i56 to i32
  %add172 = add nsw i32 %conv171, %add162
  %cmp173 = icmp slt i32 %add172, %arg6
  br i1 %cmp173, label %if.then175, label %"susan_corners$1$0_latch$0"

if.then175:                                       ; preds = %if.then165
  %i57 = load i8, i8* %incdec.ptr166, align 1, !tbaa !7
  %idx.ext177 = zext i8 %i57 to i64
  %idx.neg178 = sub nsw i64 0, %idx.ext177
  %add.ptr179 = getelementptr inbounds i8, i8* %add.ptr23, i64 %idx.neg178
  %i58 = load i8, i8* %add.ptr179, align 1, !tbaa !7
  %conv180 = zext i8 %i58 to i32
  %add181 = add nsw i32 %conv180, %add172
  %cmp182 = icmp slt i32 %add181, %arg6
  br i1 %cmp182, label %if.then184, label %"susan_corners$1$0_latch$0"

if.then184:                                       ; preds = %if.then175
  %add.ptr187 = getelementptr inbounds i8, i8* %incdec.ptr166, i64 %arg7
  %incdec.ptr188 = getelementptr inbounds i8, i8* %add.ptr187, i64 1
  %i59 = load i8, i8* %add.ptr187, align 1, !tbaa !7
  %idx.ext190 = zext i8 %i59 to i64
  %idx.neg191 = sub nsw i64 0, %idx.ext190
  %add.ptr192 = getelementptr inbounds i8, i8* %add.ptr23, i64 %idx.neg191
  %i60 = load i8, i8* %add.ptr192, align 1, !tbaa !7
  %conv193 = zext i8 %i60 to i32
  %add194 = add nsw i32 %conv193, %add181
  %cmp195 = icmp slt i32 %add194, %arg6
...
if.then197:                                       ; preds = %if.then184
  ...
  %i61 = load i8, i8* %incdec.ptr188, align 1, !tbaa !7
  ...
  %cmp205 = icmp slt i32 %add204, %arg6
...
if.then207:                                       ; preds = %if.then197
  ...
  %cmp215 = icmp slt i32 %add214, %arg6
...
if.then217:                                       ; preds = %if.then207
  ...
  %cmp225 = icmp slt i32 %add224, %arg6
...
if.then227:                                       ; preds = %if.then217
  ...
  %i67 = load i8, i8* %incdec.ptr218, align 1, !tbaa !7
  %idx.ext230 = zext i8 %i67 to i64
  %idx.neg231 = sub nsw i64 0, %idx.ext230
  %add.ptr232 = getelementptr inbounds i8, i8* %add.ptr23, i64 %idx.neg231
  %i68 = load i8, i8* %add.ptr232, align 1, !tbaa !7
  %conv233 = zext i8 %i68 to i32
  %add234 = add nsw i32 %conv233, %add224
  %cmp235 = icmp slt i32 %add234, %arg6
...
if.then269:                                       ; preds = %if.then256
  ...
  %i75 = load i8, i8* %incdec.ptr260, align 1, !tbaa !7
  %idx.ext272 = zext i8 %i75 to i64
  %idx.neg273 = sub nsw i64 0, %idx.ext272
  %add.ptr274 = getelementptr inbounds i8, i8* %add.ptr23, i64 %idx.neg273
  %i76 = load i8, i8* %add.ptr274, align 1, !tbaa !7
  %conv275 = zext i8 %i76 to i32
  %add276 = add nsw i32 %conv275, %add266
  %cmp277 = icmp slt i32 %add276, %arg6
...
if.then279:                                       ; preds = %if.then269
  ...
  %i77 = load i8, i8* %incdec.ptr270, align 1, !tbaa !7
  %idx.ext282 = zext i8 %i77 to i64
  %idx.neg283 = sub nsw i64 0, %idx.ext282
  %add.ptr284 = getelementptr inbounds i8, i8* %add.ptr23, i64 %idx.neg283
  %i78 = load i8, i8* %add.ptr284, align 1, !tbaa !7
  %conv285 = zext i8 %i78 to i32
  %add286 = add nsw i32 %conv285, %add276
  %cmp287 = icmp slt i32 %add286, %arg6
...
if.then331:                                       ; preds = %if.then321
  ...
  %i87 = load i8, i8* %incdec.ptr322, align 1, !tbaa !7
  %idx.ext333 = zext i8 %i87 to i64
  %idx.neg334 = sub nsw i64 0, %idx.ext333
  %add.ptr335 = getelementptr inbounds i8, i8* %add.ptr23, i64 %idx.neg334
  %i88 = load i8, i8* %add.ptr335, align 1, !tbaa !7
  %conv336 = zext i8 %i88 to i32
  %add337 = add nsw i32 %conv336, %add328
  %cmp338 = icmp slt i32 %add337, %arg6
  br i1 %cmp338, label %if.then340, label %"susan_corners$1$0_latch$0"

if.then340:                                       ; preds = %if.then331
  %i89 = add nuw nsw i32 %conv34, %conv27
  %sub3652141 = add nuw nsw i32 %i89, %conv40
...
if.else:                                          ; preds = %if.then697
  ...
  %i90 = select i1 %ispos, i32 %add690, i32 %neg
  %conv784 = sitofp i32 %i90 to float
  %div785 = fdiv float %conv782, %conv784
  %div787 = sdiv i32 %i90, %add690
  %add788 = add nsw i32 %div787, %arg14
  %mul789 = mul nsw i32 %add788, %arg5
  ...
  %i91 = trunc i64 %arg1 to i32
  %add790 = add i32 %conv796, %i91
  %add803 = add i32 %add790, %mul789
  %idxprom804 = sext i32 %add803 to i64
  %arrayidx805 = getelementptr inbounds i8, i8* %arg13, i64 %idxprom804
  %i92 = load i8, i8* %arrayidx805, align 1, !tbaa !7
  %idx.ext807 = zext i8 %i92 to i64
  %idx.neg808 = sub nsw i64 0, %idx.ext807
  %add.ptr809 = getelementptr inbounds i8, i8* %add.ptr23, i64 %idx.neg808
  %i93 = load i8, i8* %add.ptr809, align 1, !tbaa !7
  %conv810 = zext i8 %i93 to i32
  %mul811 = shl i32 %div787, 1
  %add812 = add nsw i32 %mul811, %arg14
  %mul813 = mul nsw i32 %add812, %arg5
  ...
  %add814 = add i32 %conv822, %i91
  %add830 = add i32 %add814, %mul813
  %idxprom831 = sext i32 %add830 to i64
  %arrayidx832 = getelementptr inbounds i8, i8* %arg13, i64 %idxprom831
  %i94 = load i8, i8* %arrayidx832, align 1, !tbaa !7
  %idx.ext834 = zext i8 %i94 to i64
  %idx.neg835 = sub nsw i64 0, %idx.ext834
  %add.ptr836 = getelementptr inbounds i8, i8* %add.ptr23, i64 %idx.neg835
  %i95 = load i8, i8* %add.ptr836, align 1, !tbaa !7
  %conv837 = zext i8 %i95 to i32
  %add838 = add nuw nsw i32 %conv837, %conv810
  %mul839 = mul nsw i32 %div787, 3
  %add840 = add nsw i32 %mul839, %arg14
  %mul841 = mul nsw i32 %add840, %arg5
  ...
  %add842 = add i32 %conv850, %i91
  %add858 = add i32 %add842, %mul841
  %idxprom859 = sext i32 %add858 to i64
  %arrayidx860 = getelementptr inbounds i8, i8* %arg13, i64 %idxprom859
  %i96 = load i8, i8* %arrayidx860, align 1, !tbaa !7
  %idx.ext862 = zext i8 %i96 to i64
  %idx.neg863 = sub nsw i64 0, %idx.ext862
  %add.ptr864 = getelementptr inbounds i8, i8* %add.ptr23, i64 %idx.neg863
  %i97 = load i8, i8* %add.ptr864, align 1, !tbaa !7
  %conv865 = zext i8 %i97 to i32
...
if.then700:                                       ; preds = %if.then697
  ...
  %i98 = select i1 %ispos2142, i32 %add687, i32 %neg2143
  %conv703 = sitofp i32 %i98 to float
  %div704 = fdiv float %conv701, %conv703
  %div706 = sdiv i32 %i98, %add687
  ...
  %add715 = add nsw i32 %conv711, %arg12
  %mul716 = mul nsw i32 %add715, %arg5
  %i99 = trunc i64 %arg1 to i32
  %add717 = add nsw i32 %mul716, %i99
  %add718 = add nsw i32 %add717, %div706
  %idxprom719 = sext i32 %add718 to i64
  %arrayidx720 = getelementptr inbounds i8, i8* %arg13, i64 %idxprom719
  %i100 = load i8, i8* %arrayidx720, align 1, !tbaa !7
  %idx.ext722 = zext i8 %i100 to i64
  %idx.neg723 = sub nsw i64 0, %idx.ext722
  %add.ptr724 = getelementptr inbounds i8, i8* %add.ptr23, i64 %idx.neg723
  %i101 = load i8, i8* %add.ptr724, align 1, !tbaa !7
  %conv725 = zext i8 %i101 to i32
  ...
  %add741 = add nsw i32 %conv733, %arg12
  %mul742 = mul nsw i32 %add741, %arg5
  %add743 = add nsw i32 %mul742, %i99
  %mul744 = shl i32 %div706, 1
  %add745 = add nsw i32 %add743, %mul744
  %idxprom746 = sext i32 %add745 to i64
  %arrayidx747 = getelementptr inbounds i8, i8* %arg13, i64 %idxprom746
  %i102 = load i8, i8* %arrayidx747, align 1, !tbaa !7
  %idx.ext749 = zext i8 %i102 to i64
  %idx.neg750 = sub nsw i64 0, %idx.ext749
  %add.ptr751 = getelementptr inbounds i8, i8* %add.ptr23, i64 %idx.neg750
  %i103 = load i8, i8* %add.ptr751, align 1, !tbaa !7
  %conv752 = zext i8 %i103 to i32
  ...
  %add769 = add nsw i32 %conv761, %arg12
  %mul770 = mul nsw i32 %add769, %arg5
  %add771 = add nsw i32 %mul770, %i99
  %mul772 = mul nsw i32 %div706, 3
  %add773 = add nsw i32 %add771, %mul772
  %idxprom774 = sext i32 %add773 to i64
  %arrayidx775 = getelementptr inbounds i8, i8* %arg13, i64 %idxprom774
  %i104 = load i8, i8* %arrayidx775, align 1, !tbaa !7
  %idx.ext777 = zext i8 %i104 to i64
  %idx.neg778 = sub nsw i64 0, %idx.ext777
  %add.ptr779 = getelementptr inbounds i8, i8* %add.ptr23, i64 %idx.neg778
  %i105 = load i8, i8* %add.ptr779, align 1, !tbaa !7
  %conv780 = zext i8 %i105 to i32
...
if.then869:                                       ; preds = %if.end
  %sub870 = sub nsw i32 %arg6, %add337
  %arrayidx874 = getelementptr inbounds i32, i32* %arg4, i64 %idxprom
  store i32 %sub870, i32* %arrayidx874, align 4, !tbaa !5
  %mul875 = mul nsw i32 %add687, 51
  %div876 = sdiv i32 %mul875, %add337
  %arrayidx880 = getelementptr inbounds i32, i32* %arg9, i64 %idxprom
...
"susan_corners$1$0_recursively_call_function":    ; preds = %"susan_corners$1$0_increment_depth_counter"
  call void @"susan_corners$1$0"(i32 %inc, i64 %indvars.iv.next2247, i32 %arg2, i32* %arg3, i32* %arg4, i32 %arg5, i32 %arg6, i64 %arg7, i64 %arg8, i32* %arg9, i32 %arg10, i8* %arg11, i32 %arg12, i8* %arg13, i32 %arg14, i8* %arg15, i64 %arg16)
  ret void
...
define void @"susan_corners_quick$0$0"(%17* %arg, i32 %arg1, i64 %arg2, i32 %arg3, i8* %arg4, i64 %arg5, i64 %arg6, i32* %arg7, i64 %arg8, i32 %arg9, i64 %arg10, i32 %arg11, %struct.anon* %arg12, i64 %arg13, i64 %arg14, i64 %arg15) {
"susan_corners_quick$0$0_header":
  %add371 = add nsw i32 %arg1, %arg9
  %idxprom372 = sext i32 %add371 to i64
  %arrayidx373 = getelementptr inbounds i32, i32* %arg7, i64 %idxprom372
...
if.then376:                                       ; preds = %"susan_corners_quick$0$0_header"
  %i16 = add nsw i64 %arg2, %arg10
  %i17 = add nsw i64 %i16, -3
  %arrayidx382 = getelementptr inbounds i32, i32* %arg7, i64 %i17
  %i18 = load i32, i32* %arrayidx382, align 4, !tbaa !5
  %cmp383 = icmp sgt i32 %i, %i18
  br i1 %cmp383, label %land.lhs.true, label %"susan_corners_quick$0$0_latch$0"

land.lhs.true:                                    ; preds = %if.then376
  %i19 = add nsw i64 %i16, -2
  %arrayidx390 = getelementptr inbounds i32, i32* %arg7, i64 %i19
  %i20 = load i32, i32* %arrayidx390, align 4, !tbaa !5
  %cmp391 = icmp sgt i32 %i, %i20
  br i1 %cmp391, label %land.lhs.true393, label %"susan_corners_quick$0$0_latch$0"

land.lhs.true393:                                 ; preds = %land.lhs.true
  %i21 = add nsw i64 %i16, -1
  %arrayidx399 = getelementptr inbounds i32, i32* %arg7, i64 %i21
  %i22 = load i32, i32* %arrayidx399, align 4, !tbaa !5
  %cmp400 = icmp sgt i32 %i, %i22
  br i1 %cmp400, label %land.lhs.true402, label %"susan_corners_quick$0$0_latch$0"

land.lhs.true402:                                 ; preds = %land.lhs.true393
  %arrayidx407 = getelementptr inbounds i32, i32* %arg7, i64 %i16
  %i23 = load i32, i32* %arrayidx407, align 4, !tbaa !5
  %cmp408 = icmp sgt i32 %i, %i23
  br i1 %cmp408, label %land.lhs.true410, label %"susan_corners_quick$0$0_latch$0"

land.lhs.true410:                                 ; preds = %land.lhs.true402
  %i24 = add nsw i64 %i16, 1
  %arrayidx416 = getelementptr inbounds i32, i32* %arg7, i64 %i24
  %i25 = load i32, i32* %arrayidx416, align 4, !tbaa !5
  %cmp417 = icmp sgt i32 %i, %i25
  br i1 %cmp417, label %land.lhs.true419, label %"susan_corners_quick$0$0_latch$0"

land.lhs.true419:                                 ; preds = %land.lhs.true410
  %i26 = add nsw i64 %i16, 2
  %arrayidx425 = getelementptr inbounds i32, i32* %arg7, i64 %i26
  %i27 = load i32, i32* %arrayidx425, align 4, !tbaa !5
  %cmp426 = icmp sgt i32 %i, %i27
  br i1 %cmp426, label %land.lhs.true428, label %"susan_corners_quick$0$0_latch$0"

land.lhs.true428:                                 ; preds = %land.lhs.true419
  %i28 = add nsw i64 %i16, 3
  %arrayidx434 = getelementptr inbounds i32, i32* %arg7, i64 %i28
  %i29 = load i32, i32* %arrayidx434, align 4, !tbaa !5
  %cmp435 = icmp sgt i32 %i, %i29
  br i1 %cmp435, label %land.lhs.true437, label %"susan_corners_quick$0$0_latch$0"

land.lhs.true437:                                 ; preds = %land.lhs.true428
  %i30 = add nsw i64 %arg2, %arg8
  %i31 = add nsw i64 %i30, -3
  %arrayidx443 = getelementptr inbounds i32, i32* %arg7, i64 %i31
  %i32 = load i32, i32* %arrayidx443, align 4, !tbaa !5
  %cmp444 = icmp sgt i32 %i, %i32
  br i1 %cmp444, label %land.lhs.true446, label %"susan_corners_quick$0$0_latch$0"

land.lhs.true446:                                 ; preds = %land.lhs.true437
  %i33 = add nsw i64 %i30, -2
  %arrayidx452 = getelementptr inbounds i32, i32* %arg7, i64 %i33
  %i34 = load i32, i32* %arrayidx452, align 4, !tbaa !5
  %cmp453 = icmp sgt i32 %i, %i34
...
land.lhs.true455:                                 ; preds = %land.lhs.true446
  ...
  %arrayidx461 = getelementptr inbounds i32, i32* %arg7, i64 %i35
  %i36 = load i32, i32* %arrayidx461, align 4, !tbaa !5
  %cmp462 = icmp sgt i32 %i, %i36
  br i1 %cmp462, label %land.lhs.true464, label %"susan_corners_quick$0$0_latch$0"

land.lhs.true464:                                 ; preds = %land.lhs.true455
  %arrayidx469 = getelementptr inbounds i32, i32* %arg7, i64 %i30
  %i37 = load i32, i32* %arrayidx469, align 4, !tbaa !5
  %cmp470 = icmp sgt i32 %i, %i37
  br i1 %cmp470, label %land.lhs.true472, label %"susan_corners_quick$0$0_latch$0"

land.lhs.true472:                                 ; preds = %land.lhs.true464
  %i38 = add nsw i64 %i30, 1
  %arrayidx478 = getelementptr inbounds i32, i32* %arg7, i64 %i38
  %i39 = load i32, i32* %arrayidx478, align 4, !tbaa !5
  %cmp479 = icmp sgt i32 %i, %i39
  br i1 %cmp479, label %land.lhs.true481, label %"susan_corners_quick$0$0_latch$0"

land.lhs.true481:                                 ; preds = %land.lhs.true472
  %i40 = add nsw i64 %i30, 2
  %arrayidx487 = getelementptr inbounds i32, i32* %arg7, i64 %i40
  %i41 = load i32, i32* %arrayidx487, align 4, !tbaa !5
  %cmp488 = icmp sgt i32 %i, %i41
  br i1 %cmp488, label %land.lhs.true490, label %"susan_corners_quick$0$0_latch$0"

land.lhs.true490:                                 ; preds = %land.lhs.true481
  %i42 = add nsw i64 %i30, 3
  %arrayidx496 = getelementptr inbounds i32, i32* %arg7, i64 %i42
  %i43 = load i32, i32* %arrayidx496, align 4, !tbaa !5
  %cmp497 = icmp sgt i32 %i, %i43
  br i1 %cmp497, label %land.lhs.true499, label %"susan_corners_quick$0$0_latch$0"

land.lhs.true499:                                 ; preds = %land.lhs.true490
  %i44 = add nsw i64 %arg2, %arg13
  %i45 = add nsw i64 %i44, -3
  %arrayidx505 = getelementptr inbounds i32, i32* %arg7, i64 %i45
  %i46 = load i32, i32* %arrayidx505, align 4, !tbaa !5
  %cmp506 = icmp sgt i32 %i, %i46
  br i1 %cmp506, label %land.lhs.true508, label %"susan_corners_quick$0$0_latch$0"

land.lhs.true508:                                 ; preds = %land.lhs.true499
  %i47 = add nsw i64 %i44, -2
  %arrayidx514 = getelementptr inbounds i32, i32* %arg7, i64 %i47
  %i48 = load i32, i32* %arrayidx514, align 4, !tbaa !5
  %cmp515 = icmp sgt i32 %i, %i48
  br i1 %cmp515, label %land.lhs.true517, label %"susan_corners_quick$0$0_latch$0"

land.lhs.true517:                                 ; preds = %land.lhs.true508
  %i49 = add nsw i64 %i44, -1
  %arrayidx523 = getelementptr inbounds i32, i32* %arg7, i64 %i49
  %i50 = load i32, i32* %arrayidx523, align 4, !tbaa !5
  %cmp524 = icmp sgt i32 %i, %i50
  br i1 %cmp524, label %land.lhs.true526, label %"susan_corners_quick$0$0_latch$0"

land.lhs.true526:                                 ; preds = %land.lhs.true517
  %arrayidx531 = getelementptr inbounds i32, i32* %arg7, i64 %i44
  %i51 = load i32, i32* %arrayidx531, align 4, !tbaa !5
  %cmp532 = icmp sgt i32 %i, %i51
  br i1 %cmp532, label %land.lhs.true534, label %"susan_corners_quick$0$0_latch$0"

land.lhs.true534:                                 ; preds = %land.lhs.true526
  %i52 = add nsw i64 %i44, 1
  %arrayidx540 = getelementptr inbounds i32, i32* %arg7, i64 %i52
  %i53 = load i32, i32* %arrayidx540, align 4, !tbaa !5
  %cmp541 = icmp sgt i32 %i, %i53
  br i1 %cmp541, label %land.lhs.true543, label %"susan_corners_quick$0$0_latch$0"

land.lhs.true543:                                 ; preds = %land.lhs.true534
  %i54 = add nsw i64 %i44, 2
  %arrayidx549 = getelementptr inbounds i32, i32* %arg7, i64 %i54
  %i55 = load i32, i32* %arrayidx549, align 4, !tbaa !5
  %cmp550 = icmp sgt i32 %i, %i55
...
land.lhs.true552:                                 ; preds = %land.lhs.true543
  ...
  %arrayidx558 = getelementptr inbounds i32, i32* %arg7, i64 %i56
  %i57 = load i32, i32* %arrayidx558, align 4, !tbaa !5
  %cmp559 = icmp sgt i32 %i, %i57
...
land.lhs.true561:                                 ; preds = %land.lhs.true552
  ...
  %arrayidx566 = getelementptr inbounds i32, i32* %arg7, i64 %idxprom565
  %i58 = load i32, i32* %arrayidx566, align 4, !tbaa !5
  %cmp567 = icmp sgt i32 %i, %i58
...
land.lhs.true569:                                 ; preds = %land.lhs.true561
  ...
  %arrayidx574 = getelementptr inbounds i32, i32* %arg7, i64 %idxprom573
  %i59 = load i32, i32* %arrayidx574, align 4, !tbaa !5
  %cmp575 = icmp sgt i32 %i, %i59
...
land.lhs.true577:                                 ; preds = %land.lhs.true569
  ...
  %arrayidx582 = getelementptr inbounds i32, i32* %arg7, i64 %idxprom581
  %i60 = load i32, i32* %arrayidx582, align 4, !tbaa !5
  %cmp583 = icmp sgt i32 %i, %i60
...
land.lhs.true585:                                 ; preds = %land.lhs.true577
  ...
  %arrayidx590 = getelementptr inbounds i32, i32* %arg7, i64 %idxprom589
  %i61 = load i32, i32* %arrayidx590, align 4, !tbaa !5
  %cmp591 = icmp slt i32 %i, %i61
...
land.lhs.true593:                                 ; preds = %land.lhs.true585
  ...
  %arrayidx598 = getelementptr inbounds i32, i32* %arg7, i64 %idxprom597
  %i62 = load i32, i32* %arrayidx598, align 4, !tbaa !5
  %cmp599 = icmp slt i32 %i, %i62
...
land.lhs.true601:                                 ; preds = %land.lhs.true593
  ...
  %arrayidx606 = getelementptr inbounds i32, i32* %arg7, i64 %idxprom605
  %i63 = load i32, i32* %arrayidx606, align 4, !tbaa !5
  %cmp607 = icmp slt i32 %i, %i63
  br i1 %cmp607, label %"susan_corners_quick$0$0_latch$0", label %land.lhs.true609

land.lhs.true609:                                 ; preds = %land.lhs.true601
  %i64 = add nsw i64 %arg2, %arg15
  %i65 = add nsw i64 %i64, -3
  %arrayidx615 = getelementptr inbounds i32, i32* %arg7, i64 %i65
  %i66 = load i32, i32* %arrayidx615, align 4, !tbaa !5
  %cmp616 = icmp slt i32 %i, %i66
  br i1 %cmp616, label %"susan_corners_quick$0$0_latch$0", label %land.lhs.true618

land.lhs.true618:                                 ; preds = %land.lhs.true609
  %i67 = add nsw i64 %i64, -2
  %arrayidx624 = getelementptr inbounds i32, i32* %arg7, i64 %i67
  %i68 = load i32, i32* %arrayidx624, align 4, !tbaa !5
  %cmp625 = icmp slt i32 %i, %i68
  br i1 %cmp625, label %"susan_corners_quick$0$0_latch$0", label %land.lhs.true627

land.lhs.true627:                                 ; preds = %land.lhs.true618
  %i69 = add nsw i64 %i64, -1
  %arrayidx633 = getelementptr inbounds i32, i32* %arg7, i64 %i69
  %i70 = load i32, i32* %arrayidx633, align 4, !tbaa !5
  %cmp634 = icmp slt i32 %i, %i70
  br i1 %cmp634, label %"susan_corners_quick$0$0_latch$0", label %land.lhs.true636

land.lhs.true636:                                 ; preds = %land.lhs.true627
  %arrayidx641 = getelementptr inbounds i32, i32* %arg7, i64 %i64
  %i71 = load i32, i32* %arrayidx641, align 4, !tbaa !5
  %cmp642 = icmp slt i32 %i, %i71
  br i1 %cmp642, label %"susan_corners_quick$0$0_latch$0", label %land.lhs.true644

land.lhs.true644:                                 ; preds = %land.lhs.true636
  %i72 = add nsw i64 %i64, 1
  %arrayidx650 = getelementptr inbounds i32, i32* %arg7, i64 %i72
  %i73 = load i32, i32* %arrayidx650, align 4, !tbaa !5
  %cmp651 = icmp slt i32 %i, %i73
  br i1 %cmp651, label %"susan_corners_quick$0$0_latch$0", label %land.lhs.true653

land.lhs.true653:                                 ; preds = %land.lhs.true644
  %i74 = add nsw i64 %i64, 2
  %arrayidx659 = getelementptr inbounds i32, i32* %arg7, i64 %i74
  %i75 = load i32, i32* %arrayidx659, align 4, !tbaa !5
  %cmp660 = icmp slt i32 %i, %i75
  br i1 %cmp660, label %"susan_corners_quick$0$0_latch$0", label %land.lhs.true662

land.lhs.true662:                                 ; preds = %land.lhs.true653
  %i76 = add nsw i64 %i64, 3
  %arrayidx668 = getelementptr inbounds i32, i32* %arg7, i64 %i76
  %i77 = load i32, i32* %arrayidx668, align 4, !tbaa !5
  %cmp669 = icmp slt i32 %i, %i77
  br i1 %cmp669, label %"susan_corners_quick$0$0_latch$0", label %land.lhs.true671

land.lhs.true671:                                 ; preds = %land.lhs.true662
  %i78 = add nsw i64 %arg2, %arg6
  %i79 = add nsw i64 %i78, -3
  %arrayidx677 = getelementptr inbounds i32, i32* %arg7, i64 %i79
  %i80 = load i32, i32* %arrayidx677, align 4, !tbaa !5
  %cmp678 = icmp slt i32 %i, %i80
  br i1 %cmp678, label %"susan_corners_quick$0$0_latch$0", label %land.lhs.true680

land.lhs.true680:                                 ; preds = %land.lhs.true671
  %i81 = add nsw i64 %i78, -2
  %arrayidx686 = getelementptr inbounds i32, i32* %arg7, i64 %i81
  %i82 = load i32, i32* %arrayidx686, align 4, !tbaa !5
  %cmp687 = icmp slt i32 %i, %i82
  br i1 %cmp687, label %"susan_corners_quick$0$0_latch$0", label %land.lhs.true689

land.lhs.true689:                                 ; preds = %land.lhs.true680
  %i83 = add nsw i64 %i78, -1
  %arrayidx695 = getelementptr inbounds i32, i32* %arg7, i64 %i83
  %i84 = load i32, i32* %arrayidx695, align 4, !tbaa !5
  %cmp696 = icmp slt i32 %i, %i84
  br i1 %cmp696, label %"susan_corners_quick$0$0_latch$0", label %land.lhs.true698

land.lhs.true698:                                 ; preds = %land.lhs.true689
  %arrayidx703 = getelementptr inbounds i32, i32* %arg7, i64 %i78
  %i85 = load i32, i32* %arrayidx703, align 4, !tbaa !5
  %cmp704 = icmp slt i32 %i, %i85
  br i1 %cmp704, label %"susan_corners_quick$0$0_latch$0", label %land.lhs.true706

land.lhs.true706:                                 ; preds = %land.lhs.true698
  %i86 = add nsw i64 %i78, 1
  %arrayidx712 = getelementptr inbounds i32, i32* %arg7, i64 %i86
  %i87 = load i32, i32* %arrayidx712, align 4, !tbaa !5
  %cmp713 = icmp slt i32 %i, %i87
  br i1 %cmp713, label %"susan_corners_quick$0$0_latch$0", label %land.lhs.true715

land.lhs.true715:                                 ; preds = %land.lhs.true706
  %i88 = add nsw i64 %i78, 2
  %arrayidx721 = getelementptr inbounds i32, i32* %arg7, i64 %i88
  %i89 = load i32, i32* %arrayidx721, align 4, !tbaa !5
  %cmp722 = icmp slt i32 %i, %i89
  br i1 %cmp722, label %"susan_corners_quick$0$0_latch$0", label %land.lhs.true724

land.lhs.true724:                                 ; preds = %land.lhs.true715
  %i90 = add nsw i64 %i78, 3
  %arrayidx730 = getelementptr inbounds i32, i32* %arg7, i64 %i90
  %i91 = load i32, i32* %arrayidx730, align 4, !tbaa !5
  %cmp731 = icmp slt i32 %i, %i91
  br i1 %cmp731, label %"susan_corners_quick$0$0_latch$0", label %land.lhs.true733

land.lhs.true733:                                 ; preds = %land.lhs.true724
  %i92 = add nsw i64 %arg2, %arg5
  %i93 = add nsw i64 %i92, -3
  %arrayidx739 = getelementptr inbounds i32, i32* %arg7, i64 %i93
  %i94 = load i32, i32* %arrayidx739, align 4, !tbaa !5
  %cmp740 = icmp slt i32 %i, %i94
  br i1 %cmp740, label %"susan_corners_quick$0$0_latch$0", label %land.lhs.true742

land.lhs.true742:                                 ; preds = %land.lhs.true733
  %i95 = add nsw i64 %i92, -2
  %arrayidx748 = getelementptr inbounds i32, i32* %arg7, i64 %i95
  %i96 = load i32, i32* %arrayidx748, align 4, !tbaa !5
  %cmp749 = icmp slt i32 %i, %i96
  br i1 %cmp749, label %"susan_corners_quick$0$0_latch$0", label %land.lhs.true751

land.lhs.true751:                                 ; preds = %land.lhs.true742
  %i97 = add nsw i64 %i92, -1
  %arrayidx757 = getelementptr inbounds i32, i32* %arg7, i64 %i97
  %i98 = load i32, i32* %arrayidx757, align 4, !tbaa !5
  %cmp758 = icmp slt i32 %i, %i98
  br i1 %cmp758, label %"susan_corners_quick$0$0_latch$0", label %land.lhs.true760

land.lhs.true760:                                 ; preds = %land.lhs.true751
  %arrayidx765 = getelementptr inbounds i32, i32* %arg7, i64 %i92
  %i99 = load i32, i32* %arrayidx765, align 4, !tbaa !5
  %cmp766 = icmp slt i32 %i, %i99
  br i1 %cmp766, label %"susan_corners_quick$0$0_latch$0", label %land.lhs.true768

land.lhs.true768:                                 ; preds = %land.lhs.true760
  %i100 = add nsw i64 %i92, 1
  %arrayidx774 = getelementptr inbounds i32, i32* %arg7, i64 %i100
  %i101 = load i32, i32* %arrayidx774, align 4, !tbaa !5
  %cmp775 = icmp slt i32 %i, %i101
  br i1 %cmp775, label %"susan_corners_quick$0$0_latch$0", label %land.lhs.true777

land.lhs.true777:                                 ; preds = %land.lhs.true768
  %i102 = add nsw i64 %i92, 2
  %arrayidx783 = getelementptr inbounds i32, i32* %arg7, i64 %i102
  %i103 = load i32, i32* %arrayidx783, align 4, !tbaa !5
  %cmp784 = icmp slt i32 %i, %i103
  br i1 %cmp784, label %"susan_corners_quick$0$0_latch$0", label %land.lhs.true786

land.lhs.true786:                                 ; preds = %land.lhs.true777
  %i104 = add nsw i64 %i92, 3
  %arrayidx792 = getelementptr inbounds i32, i32* %arg7, i64 %i104
  %i105 = load i32, i32* %arrayidx792, align 4, !tbaa !5
  %cmp793 = icmp slt i32 %i, %i105
...
"susan_corners_quick$0$0_exiting$1":              ; preds = %land.lhs.true786
  ...
  %info = getelementptr inbounds %struct.anon, %struct.anon* %arg12, i64 %idxprom796, i32 2
  store i32 0, i32* %info, align 4, !tbaa !8
  %x800 = getelementptr inbounds %struct.anon, %struct.anon* %arg12, i64 %idxprom796, i32 0
  %i106 = trunc i64 %arg2 to i32
  store i32 %i106, i32* %x800, align 4, !tbaa !20
  %y803 = getelementptr inbounds %struct.anon, %struct.anon* %arg12, i64 %idxprom796, i32 1
  store i32 %arg11, i32* %y803, align 4, !tbaa !15
  %arrayidx809 = getelementptr inbounds i8, i8* %arg4, i64 %i33
  %i107 = load i8, i8* %arrayidx809, align 1, !tbaa !7
  %conv810 = zext i8 %i107 to i32
  %arrayidx816 = getelementptr inbounds i8, i8* %arg4, i64 %i35
  %i108 = load i8, i8* %arrayidx816, align 1, !tbaa !7
  %conv817 = zext i8 %i108 to i32
  %add818 = add nuw nsw i32 %conv817, %conv810
  %arrayidx823 = getelementptr inbounds i8, i8* %arg4, i64 %i30
  %i109 = load i8, i8* %arrayidx823, align 1, !tbaa !7
  %conv824 = zext i8 %i109 to i32
  %add825 = add nuw nsw i32 %add818, %conv824
  %arrayidx831 = getelementptr inbounds i8, i8* %arg4, i64 %i38
  %i110 = load i8, i8* %arrayidx831, align 1, !tbaa !7
  %conv832 = zext i8 %i110 to i32
  %add833 = add nuw nsw i32 %add825, %conv832
  %arrayidx839 = getelementptr inbounds i8, i8* %arg4, i64 %i40
  %i111 = load i8, i8* %arrayidx839, align 1, !tbaa !7
  %conv840 = zext i8 %i111 to i32
  %add841 = add nuw nsw i32 %add833, %conv840
  %arrayidx847 = getelementptr inbounds i8, i8* %arg4, i64 %i47
  %i112 = load i8, i8* %arrayidx847, align 1, !tbaa !7
  %conv848 = zext i8 %i112 to i32
  %add849 = add nuw nsw i32 %add841, %conv848
  %arrayidx855 = getelementptr inbounds i8, i8* %arg4, i64 %i49
  %i113 = load i8, i8* %arrayidx855, align 1, !tbaa !7
  %conv856 = zext i8 %i113 to i32
  %add857 = add nuw nsw i32 %add849, %conv856
  %arrayidx862 = getelementptr inbounds i8, i8* %arg4, i64 %i44
  %i114 = load i8, i8* %arrayidx862, align 1, !tbaa !7
  %conv863 = zext i8 %i114 to i32
  %add864 = add nsw i32 %add857, %conv863
  %arrayidx870 = getelementptr inbounds i8, i8* %arg4, i64 %i52
  %i115 = load i8, i8* %arrayidx870, align 1, !tbaa !7
  %conv871 = zext i8 %i115 to i32
  %add872 = add nsw i32 %add864, %conv871
  %arrayidx878 = getelementptr inbounds i8, i8* %arg4, i64 %i54
  %i116 = load i8, i8* %arrayidx878, align 1, !tbaa !7
  %conv879 = zext i8 %i116 to i32
  %add880 = add nsw i32 %add872, %conv879
  %arrayidx885 = getelementptr inbounds i8, i8* %arg4, i64 %idxprom573
  %i117 = load i8, i8* %arrayidx885, align 1, !tbaa !7
  %conv886 = zext i8 %i117 to i32
  %add887 = add nsw i32 %add880, %conv886
  %arrayidx892 = getelementptr inbounds i8, i8* %arg4, i64 %idxprom581
  %i118 = load i8, i8* %arrayidx892, align 1, !tbaa !7
  %conv893 = zext i8 %i118 to i32
  %add894 = add nsw i32 %add887, %conv893
  %arrayidx898 = getelementptr inbounds i8, i8* %arg4, i64 %idxprom372
  %i119 = load i8, i8* %arrayidx898, align 1, !tbaa !7
  %conv899 = zext i8 %i119 to i32
  %add900 = add nsw i32 %add894, %conv899
  %arrayidx905 = getelementptr inbounds i8, i8* %arg4, i64 %idxprom589
  %i120 = load i8, i8* %arrayidx905, align 1, !tbaa !7
  %conv906 = zext i8 %i120 to i32
  %add907 = add nsw i32 %add900, %conv906
  %arrayidx912 = getelementptr inbounds i8, i8* %arg4, i64 %idxprom597
  %i121 = load i8, i8* %arrayidx912, align 1, !tbaa !7
  %conv913 = zext i8 %i121 to i32
  %add914 = add nsw i32 %add907, %conv913
  %arrayidx920 = getelementptr inbounds i8, i8* %arg4, i64 %i67
  %i122 = load i8, i8* %arrayidx920, align 1, !tbaa !7
  %conv921 = zext i8 %i122 to i32
  %add922 = add nsw i32 %add914, %conv921
  %arrayidx928 = getelementptr inbounds i8, i8* %arg4, i64 %i69
  %i123 = load i8, i8* %arrayidx928, align 1, !tbaa !7
  %conv929 = zext i8 %i123 to i32
  %add930 = add nsw i32 %add922, %conv929
  %arrayidx935 = getelementptr inbounds i8, i8* %arg4, i64 %i64
  %i124 = load i8, i8* %arrayidx935, align 1, !tbaa !7
  %conv936 = zext i8 %i124 to i32
  %add937 = add nsw i32 %add930, %conv936
  %arrayidx943 = getelementptr inbounds i8, i8* %arg4, i64 %i72
  %i125 = load i8, i8* %arrayidx943, align 1, !tbaa !7
  %conv944 = zext i8 %i125 to i32
  %add945 = add nsw i32 %add937, %conv944
  %arrayidx951 = getelementptr inbounds i8, i8* %arg4, i64 %i74
  %i126 = load i8, i8* %arrayidx951, align 1, !tbaa !7
  %conv952 = zext i8 %i126 to i32
  %add953 = add nsw i32 %add945, %conv952
  %arrayidx959 = getelementptr inbounds i8, i8* %arg4, i64 %i81
  %i127 = load i8, i8* %arrayidx959, align 1, !tbaa !7
  %conv960 = zext i8 %i127 to i32
  %add961 = add nsw i32 %add953, %conv960
  %arrayidx967 = getelementptr inbounds i8, i8* %arg4, i64 %i83
  %i128 = load i8, i8* %arrayidx967, align 1, !tbaa !7
  %conv968 = zext i8 %i128 to i32
  %add969 = add nsw i32 %add961, %conv968
  %arrayidx974 = getelementptr inbounds i8, i8* %arg4, i64 %i78
  %i129 = load i8, i8* %arrayidx974, align 1, !tbaa !7
  %conv975 = zext i8 %i129 to i32
  %add976 = add nsw i32 %add969, %conv975
  %arrayidx982 = getelementptr inbounds i8, i8* %arg4, i64 %i86
  %i130 = load i8, i8* %arrayidx982, align 1, !tbaa !7
  %conv983 = zext i8 %i130 to i32
  %add984 = add nsw i32 %add976, %conv983
  %arrayidx990 = getelementptr inbounds i8, i8* %arg4, i64 %i88
  %i131 = load i8, i8* %arrayidx990, align 1, !tbaa !7
  %conv991 = zext i8 %i131 to i32
  %add992 = add nsw i32 %add984, %conv991
  %div = sdiv i32 %add992, 25
  %I = getelementptr inbounds %struct.anon, %struct.anon* %arg12, i64 %idxprom796, i32 5
  store i32 %div, i32* %I, align 4, !tbaa !23
  %i132 = load i8, i8* %arrayidx839, align 1, !tbaa !7
  %conv1001 = zext i8 %i132 to i32
  %i133 = load i8, i8* %arrayidx878, align 1, !tbaa !7
  %conv1008 = zext i8 %i133 to i32
  %i134 = load i8, i8* %arrayidx912, align 1, !tbaa !7
  %conv1015 = zext i8 %i134 to i32
  %i135 = load i8, i8* %arrayidx951, align 1, !tbaa !7
  %conv1023 = zext i8 %i135 to i32
  %i136 = load i8, i8* %arrayidx990, align 1, !tbaa !7
  %conv1031 = zext i8 %i136 to i32
  %i137 = load i8, i8* %arrayidx809, align 1, !tbaa !7
  %conv1039 = zext i8 %i137 to i32
  %i138 = load i8, i8* %arrayidx847, align 1, !tbaa !7
  %conv1046 = zext i8 %i138 to i32
  %i139 = load i8, i8* %arrayidx885, align 1, !tbaa !7
  %conv1053 = zext i8 %i139 to i32
  %i140 = load i8, i8* %arrayidx920, align 1, !tbaa !7
  %conv1061 = zext i8 %i140 to i32
  %i141 = load i8, i8* %arrayidx959, align 1, !tbaa !7
  %conv1069 = zext i8 %i141 to i32
  ...
  %i142 = load i8, i8* %arrayidx831, align 1, !tbaa !7
  %conv1078 = zext i8 %i142 to i32
  %i143 = load i8, i8* %arrayidx870, align 1, !tbaa !7
  %conv1086 = zext i8 %i143 to i32
  %i144 = load i8, i8* %arrayidx905, align 1, !tbaa !7
  %conv1093 = zext i8 %i144 to i32
  %i145 = load i8, i8* %arrayidx943, align 1, !tbaa !7
  %conv1101 = zext i8 %i145 to i32
  %i146 = load i8, i8* %arrayidx982, align 1, !tbaa !7
  %conv1109 = zext i8 %i146 to i32
  %i147 = load i8, i8* %arrayidx816, align 1, !tbaa !7
  %conv1117 = zext i8 %i147 to i32
  %i148 = load i8, i8* %arrayidx855, align 1, !tbaa !7
  %conv1124 = zext i8 %i148 to i32
  %i149 = load i8, i8* %arrayidx892, align 1, !tbaa !7
  %conv1131 = zext i8 %i149 to i32
  %i150 = load i8, i8* %arrayidx928, align 1, !tbaa !7
  %conv1139 = zext i8 %i150 to i32
  %i151 = load i8, i8* %arrayidx967, align 1, !tbaa !7
  %conv1147 = zext i8 %i151 to i32
  ...
  %i152 = load i8, i8* %arrayidx974, align 1, !tbaa !7
  %conv1171 = zext i8 %i152 to i32
  %i153 = load i8, i8* %arrayidx823, align 1, !tbaa !7
  %conv1209 = zext i8 %i153 to i32
  ...
  %i154 = load i8, i8* %arrayidx935, align 1, !tbaa !7
  %conv1249 = zext i8 %i154 to i32
  %i155 = load i8, i8* %arrayidx862, align 1, !tbaa !7
  %conv1287 = zext i8 %i155 to i32
  ...
  %dx = getelementptr inbounds %struct.anon, %struct.anon* %arg12, i64 %idxprom796, i32 3
  store i32 %div1307, i32* %dx, align 4, !tbaa !21
  %div1310 = sdiv i32 %add1306, 15
  %dy = getelementptr inbounds %struct.anon, %struct.anon* %arg12, i64 %idxprom796, i32 4
...
"susan_corners_quick$0$0_latch$0":                ; preds = %"susan_corners_quick$0$0_exiting$1", %land.lhs.true786, %land.lhs.true777, %land.lhs.true768, %land.lhs.true760, %land.lhs.true751, %land.lhs.true742, %land.lhs.true733, %land.lhs.true724, %land.lhs.true715, %land.lhs.true706, %land.lhs.true698, %land.lhs.true689, %land.lhs.true680, %land.lhs.true671, %land.lhs.true662, %land.lhs.true653, %land.lhs.true644, %land.lhs.true636, %land.lhs.true627, %land.lhs.true618, %land.lhs.true609, %land.lhs.true601, %land.lhs.true593, %land.lhs.true585, %land.lhs.true577, %land.lhs.true569, %land.lhs.true561, %land.lhs.true552, %land.lhs.true543, %land.lhs.true534, %land.lhs.true526, %land.lhs.true517, %land.lhs.true508, %land.lhs.true499, %land.lhs.true490, %land.lhs.true481, %land.lhs.true472, %land.lhs.true464, %land.lhs.true455, %land.lhs.true446, %land.lhs.true437, %land.lhs.true428, %land.lhs.true419, %land.lhs.true410, %land.lhs.true402, %land.lhs.true393, %land.lhs.true, %if.then376, %"susan_corners_quick$0$0_header"
  ...
  %cmp367 = icmp slt i64 %indvars.iv.next, %arg14
...
"susan_corners_quick$0$0_recursively_call_function": ; preds = %"susan_corners_quick$0$0_increment_depth_counter"
  call void @"susan_corners_quick$0$0"(%17* %arg, i32 %inc1321, i64 %indvars.iv.next, i32 %n.2, i8* %arg4, i64 %arg5, i64 %arg6, i32* %arg7, i64 %arg8, i32 %arg9, i64 %arg10, i32 %arg11, %struct.anon* %arg12, i64 %arg13, i64 %arg14, i64 %arg15)
  ret void

"susan_corners_quick$0$0_return_from_recursive_function$0": ; preds = %"susan_corners_quick$0$0_latch$0"
  %i156 = getelementptr %17, %17* %arg, i32 0, i32 0
  store i32 %n.2, i32* %i156, align 4
  %i157 = getelementptr %17, %17* %arg, i32 0, i32 1
  store i8 1, i8* %i157, align 1
  ret void

"susan_corners_quick$0$0_return_from_recursive_function$1": ; preds = %"susan_corners_quick$0$0_exiting$1"
  %i158 = getelementptr %17, %17* %arg, i32 0, i32 1
  store i8 0, i8* %i158, align 1
  ret void
}

define void @"susan_corners_quick$1$0"(i32 %arg, i64 %arg1, i32 %arg2, i32* %arg3, i32 %arg4, i64 %arg5, i8* %arg6, i64 %arg7, i8* %arg8, i32 %arg9, i8* %arg10, i64 %arg11) {
"susan_corners_quick$1$0_header":
  ...
  %i = load i8, i8* %arrayidx, align 1, !tbaa !7
  %idx.ext15 = zext i8 %i to i64
  %add.ptr16 = getelementptr inbounds i8, i8* %arg10, i64 %idx.ext15
  %incdec.ptr = getelementptr inbounds i8, i8* %add.ptr12, i64 1
  %i12 = load i8, i8* %add.ptr12, align 1, !tbaa !7
  %idx.ext18 = zext i8 %i12 to i64
  %idx.neg = sub nsw i64 0, %idx.ext18
  ...
  %conv144 = zext i8 %i47 to i32
  %add145 = add nsw i32 %add139, %conv144
  %cmp146 = icmp slt i32 %add145, %arg4
...
if.then:                                          ; preds = %"susan_corners_quick$1$0_header"
  ...
  %i48 = load i8, i8* %add.ptr148, align 1, !tbaa !7
  %idx.ext151 = zext i8 %i48 to i64
  %idx.neg152 = sub nsw i64 0, %idx.ext151
  %add.ptr153 = getelementptr inbounds i8, i8* %add.ptr16, i64 %idx.neg152
  %i49 = load i8, i8* %add.ptr153, align 1, !tbaa !7
  %conv154 = zext i8 %i49 to i32
  %add155 = add nsw i32 %conv154, %add145
  %cmp156 = icmp slt i32 %add155, %arg4
...
if.then158:                                       ; preds = %if.then
  ...
  %cmp166 = icmp slt i32 %add165, %arg4
...
if.then168:                                       ; preds = %if.then158
  ...
  %cmp175 = icmp slt i32 %add174, %arg4
  br i1 %cmp175, label %if.then177, label %"susan_corners_quick$1$0_latch$0"

if.then177:                                       ; preds = %if.then168
  %add.ptr180 = getelementptr inbounds i8, i8* %incdec.ptr159, i64 %arg5
  %incdec.ptr181 = getelementptr inbounds i8, i8* %add.ptr180, i64 1
  %i54 = load i8, i8* %add.ptr180, align 1, !tbaa !7
  %idx.ext183 = zext i8 %i54 to i64
  %idx.neg184 = sub nsw i64 0, %idx.ext183
  %add.ptr185 = getelementptr inbounds i8, i8* %add.ptr16, i64 %idx.neg184
  %i55 = load i8, i8* %add.ptr185, align 1, !tbaa !7
  %conv186 = zext i8 %i55 to i32
  %add187 = add nsw i32 %conv186, %add174
  %cmp188 = icmp slt i32 %add187, %arg4
...
if.then190:                                       ; preds = %if.then177
  ...
  %i56 = load i8, i8* %incdec.ptr181, align 1, !tbaa !7
  %idx.ext193 = zext i8 %i56 to i64
  %idx.neg194 = sub nsw i64 0, %idx.ext193
  %add.ptr195 = getelementptr inbounds i8, i8* %add.ptr16, i64 %idx.neg194
  %i57 = load i8, i8* %add.ptr195, align 1, !tbaa !7
  %conv196 = zext i8 %i57 to i32
  %add197 = add nsw i32 %conv196, %add187
  %cmp198 = icmp slt i32 %add197, %arg4
...
if.then200:                                       ; preds = %if.then190
  ...
  %i58 = load i8, i8* %incdec.ptr191, align 1, !tbaa !7
  %idx.ext203 = zext i8 %i58 to i64
  %idx.neg204 = sub nsw i64 0, %idx.ext203
  %add.ptr205 = getelementptr inbounds i8, i8* %add.ptr16, i64 %idx.neg204
  %i59 = load i8, i8* %add.ptr205, align 1, !tbaa !7
  %conv206 = zext i8 %i59 to i32
  %add207 = add nsw i32 %conv206, %add197
  %cmp208 = icmp slt i32 %add207, %arg4
...
if.then210:                                       ; preds = %if.then200
  ...
  %i60 = load i8, i8* %incdec.ptr201, align 1, !tbaa !7
  %idx.ext213 = zext i8 %i60 to i64
  %idx.neg214 = sub nsw i64 0, %idx.ext213
  %add.ptr215 = getelementptr inbounds i8, i8* %add.ptr16, i64 %idx.neg214
  %i61 = load i8, i8* %add.ptr215, align 1, !tbaa !7
  %conv216 = zext i8 %i61 to i32
  %add217 = add nsw i32 %conv216, %add207
  %cmp218 = icmp slt i32 %add217, %arg4
...
if.then220:                                       ; preds = %if.then210
  ...
  %i62 = load i8, i8* %incdec.ptr211, align 1, !tbaa !7
  %idx.ext223 = zext i8 %i62 to i64
  %idx.neg224 = sub nsw i64 0, %idx.ext223
  %add.ptr225 = getelementptr inbounds i8, i8* %add.ptr16, i64 %idx.neg224
  %i63 = load i8, i8* %add.ptr225, align 1, !tbaa !7
  %conv226 = zext i8 %i63 to i32
  %add227 = add nsw i32 %conv226, %add217
  %cmp228 = icmp slt i32 %add227, %arg4
...
if.then249:                                       ; preds = %if.then240
  ...
  %i68 = load i8, i8* %add.ptr252, align 1, !tbaa !7
  %idx.ext255 = zext i8 %i68 to i64
  %idx.neg256 = sub nsw i64 0, %idx.ext255
  %add.ptr257 = getelementptr inbounds i8, i8* %add.ptr16, i64 %idx.neg256
  %i69 = load i8, i8* %add.ptr257, align 1, !tbaa !7
  %conv258 = zext i8 %i69 to i32
  %add259 = add nsw i32 %conv258, %add246
  %cmp260 = icmp slt i32 %add259, %arg4
...
if.then262:                                       ; preds = %if.then249
  ...
  %i70 = load i8, i8* %incdec.ptr253, align 1, !tbaa !7
  %idx.ext265 = zext i8 %i70 to i64
  %idx.neg266 = sub nsw i64 0, %idx.ext265
  %add.ptr267 = getelementptr inbounds i8, i8* %add.ptr16, i64 %idx.neg266
  %i71 = load i8, i8* %add.ptr267, align 1, !tbaa !7
  %conv268 = zext i8 %i71 to i32
  %add269 = add nsw i32 %conv268, %add259
  %cmp270 = icmp slt i32 %add269, %arg4
...
if.then272:                                       ; preds = %if.then262
  ...
  %i72 = load i8, i8* %incdec.ptr263, align 1, !tbaa !7
  %idx.ext275 = zext i8 %i72 to i64
  %idx.neg276 = sub nsw i64 0, %idx.ext275
  %add.ptr277 = getelementptr inbounds i8, i8* %add.ptr16, i64 %idx.neg276
  %i73 = load i8, i8* %add.ptr277, align 1, !tbaa !7
  %conv278 = zext i8 %i73 to i32
  %add279 = add nsw i32 %conv278, %add269
  %cmp280 = icmp slt i32 %add279, %arg4
...
if.then324:                                       ; preds = %if.then314
  ...
  %i82 = load i8, i8* %incdec.ptr315, align 1, !tbaa !7
  %idx.ext326 = zext i8 %i82 to i64
  %idx.neg327 = sub nsw i64 0, %idx.ext326
  %add.ptr328 = getelementptr inbounds i8, i8* %add.ptr16, i64 %idx.neg327
  %i83 = load i8, i8* %add.ptr328, align 1, !tbaa !7
  %conv329 = zext i8 %i83 to i32
  %add330 = add nsw i32 %conv329, %add321
  %cmp331 = icmp slt i32 %add330, %arg4
  br i1 %cmp331, label %if.then333, label %"susan_corners_quick$1$0_latch$0"

if.then333:                                       ; preds = %if.then324
  %sub334 = sub nsw i32 %arg4, %add330
  %arrayidx338 = getelementptr inbounds i32, i32* %arg3, i64 %idxprom
...
"susan_corners_quick$1$0_recursively_call_function": ; preds = %"susan_corners_quick$1$0_increment_depth_counter"
  call void @"susan_corners_quick$1$0"(i32 %inc, i64 %indvars.iv.next2115, i32 %arg2, i32* %arg3, i32 %arg4, i64 %arg5, i8* %arg6, i64 %arg7, i8* %arg8, i32 %arg9, i8* %arg10, i64 %arg11)
  ret void
...
define void @"susan_smoothing$0$0$0"(%18* %arg, i32 %arg1, i8* %arg2, i32 %arg3, i32 %arg4, i8* %arg5, i64 %arg6, i32 %arg7, i32 %arg8, i8* %arg9) {
...
"susan_smoothing$0$0$0$0_call_recursive_function": ; preds = %"susan_smoothing$0$0$0$0_initialize_context"
  call void @"susan_smoothing$0$0$0$0"(%19* %i, i32 %arg3, i32 %arg8, i8* %arg2, i32 %arg4, i8* %arg5, i32 %arg7, i8* %arg9)
...
"susan_smoothing$0$0$0$0_extract_return_values$0": ; preds = %"susan_smoothing$0$0$0$0_call_recursive_function"
  %i10 = getelementptr %19, %19* %i, i32 0, i32 0
  %i11 = load i8*, i8** %i10, align 8
  %i12 = getelementptr %19, %19* %i, i32 0, i32 1
  %i13 = load i8*, i8** %i12, align 8
  %i14 = getelementptr %19, %19* %i, i32 0, i32 2
  %i15 = load i32, i32* %i14, align 4
  %i16 = getelementptr %19, %19* %i, i32 0, i32 3
  %i17 = load i32, i32* %i16, align 4
...
"susan_smoothing$0$0$0_latch$0":                  ; preds = %"susan_smoothing$0$0$0$0_extract_return_values$0"
  %add.ptr115 = getelementptr inbounds i8, i8* %i11, i64 %arg6
  %inc117 = add nsw i32 %arg1, 1
  %cmp91 = icmp slt i32 %arg1, %arg7
...
"susan_smoothing$0$0$0_recursively_call_function": ; preds = %"susan_smoothing$0$0$0_increment_depth_counter"
  call void @"susan_smoothing$0$0$0"(%18* %arg, i32 %inc117, i8* %add.ptr115, i32 %i17, i32 %i15, i8* %i13, i64 %arg6, i32 %arg7, i32 %arg8, i8* %arg9)
  ret void

"susan_smoothing$0$0$0_return_from_recursive_function$0": ; preds = %"susan_smoothing$0$0$0_latch$0"
  %i18 = getelementptr %18, %18* %arg, i32 0, i32 0
  store i32 %i17, i32* %i18, align 4
  %i19 = getelementptr %18, %18* %arg, i32 0, i32 1
  store i32 %i15, i32* %i19, align 4
  ret void
}

define void @"susan_smoothing$0$0$0$0"(%19* %arg, i32 %arg1, i32 %arg2, i8* %arg3, i32 %arg4, i8* %arg5, i32 %arg6, i8* %arg7) {
"susan_smoothing$0$0$0$0_latch$0":
  ...
  %i8 = load i8, i8* %arg5, align 1, !tbaa !7
  %conv102 = zext i8 %i8 to i32
  ...
  %i9 = load i8, i8* %add.ptr105, align 1, !tbaa !7
  %conv106 = zext i8 %i9 to i32
...
"susan_smoothing$0$0$0$0_recursively_call_function": ; preds = %"susan_smoothing$0$0$0$0_increment_depth_counter"
  call void @"susan_smoothing$0$0$0$0"(%19* %arg, i32 %add108, i32 %inc112, i8* %incdec.ptr99, i32 %add110, i8* %incdec.ptr101, i32 %arg6, i8* %arg7)
  ret void

"susan_smoothing$0$0$0$0_return_from_recursive_function$0": ; preds = %"susan_smoothing$0$0$0$0_latch$0"
  %i10 = getelementptr %19, %19* %arg, i32 0, i32 0
  store i8* %incdec.ptr99, i8** %i10, align 8
  %i11 = getelementptr %19, %19* %arg, i32 0, i32 1
  store i8* %incdec.ptr101, i8** %i11, align 8
  %i12 = getelementptr %19, %19* %arg, i32 0, i32 2
  store i32 %add110, i32* %i12, align 4
  %i13 = getelementptr %19, %19* %arg, i32 0, i32 3
  store i32 %add108, i32* %i13, align 4
  ret void
}
