; ModuleID = './benchmark_intermediate_representations/unoptimized_loop2recursion/basicmath/isqrt.ll.temp'
...
"usqrt$0_call_recursive_function":                ; preds = %"usqrt$0_initialize_context"
  call void @"usqrt$0"(%0* %i, i64 %x, i64 0, i32 0, i64 0)
...
for.end:                                          ; preds = %"usqrt$0_extract_return_values$0"
  ...
  store i64 %i2, i64* %a.0..sroa_cast16, align 4
  ret void
}

define void @"usqrt$0"(%0* %arg, i64 %arg1, i64 %arg2, i32 %arg3, i64 %arg4) {
"usqrt$0_latch$0":
  %shl = shl i64 %arg4, 2
