; ModuleID = './benchmark_intermediate_representations/unoptimized_loop2recursion/bf/bf_cbc.ll.temp'
...
"BF_cbc_encrypt$1_call_recursive_function":       ; preds = %"BF_cbc_encrypt$1_initialize_context"
  call void @"BF_cbc_encrypt$1"(%0* %i31, <2 x i64> %i26, i8* %out, i64 %l.1636, i8* %in, %struct.bf_key_st* %ks, <2 x i64>* %tin, i64* %arrayidx)
...
"BF_cbc_encrypt$1_extract_return_values$0":       ; preds = %"BF_cbc_encrypt$1_call_recursive_function"
  %i32 = getelementptr %0, %0* %i31, i32 0, i32 0
  %i33 = load i64, i64* %i32, align 8
  %i34 = getelementptr %0, %0* %i31, i32 0, i32 1
...
"BF_cbc_encrypt$0_call_recursive_function":       ; preds = %"BF_cbc_encrypt$0_initialize_context"
  call void @"BF_cbc_encrypt$0"(%1* %i38, i8* %in, i64 %l.1636, i8* %out, i64 %i27, i64 %i28, i64* %arrayidx257, %struct.bf_key_st* %ks, <2 x i64>* %tin, i64* %arrayidx256)
...
"BF_cbc_encrypt$0_extract_return_values$0":       ; preds = %"BF_cbc_encrypt$0_call_recursive_function"
  %i39 = getelementptr %1, %1* %i38, i32 0, i32 0
  %i40 = load i64, i64* %i39, align 8
  %i41 = getelementptr %1, %1* %i38, i32 0, i32 1
...
for.end.loopexit:                                 ; preds = %"BF_cbc_encrypt$1_extract_return_values$0"
  ...
  %i43 = sub i64 %l.1636, %i29
  br label %for.end

for.end:                                          ; preds = %for.end.loopexit, %for.cond.preheader
  %l.0.in.lcssa = phi i64 [ %length, %for.cond.preheader ], [ %i43, %for.end.loopexit ]
  %tout1.0.lcssa = phi i64 [ %i28, %for.cond.preheader ], [ %i35, %for.end.loopexit ]
  %tout0.0.lcssa = phi i64 [ %i27, %for.cond.preheader ], [ %i33, %for.end.loopexit ]
...
sw.bb:                                            ; preds = %if.then89
  ...
  %i44 = load i8, i8* %incdec.ptr92, align 1, !tbaa !1
  %conv93 = zext i8 %i44 to i64
  br label %sw.bb94
...
sw.bb94:                                          ; preds = %sw.bb, %if.then89
  ...
  %i45 = load i8, i8* %incdec.ptr95, align 1, !tbaa !1
  %conv96 = zext i8 %i45 to i64
...
sw.bb99:                                          ; preds = %sw.bb94, %if.then89
  ...
  %i46 = load i8, i8* %incdec.ptr100, align 1, !tbaa !1
  %conv101 = zext i8 %i46 to i64
...
sw.bb104:                                         ; preds = %sw.bb99, %if.then89
  ...
  %i47 = load i8, i8* %incdec.ptr105, align 1, !tbaa !1
  %conv106 = zext i8 %i47 to i64
...
sw.bb109:                                         ; preds = %sw.bb104, %if.then89
  ...
  %i48 = load i8, i8* %incdec.ptr110, align 1, !tbaa !1
  %conv111 = zext i8 %i48 to i64
  br label %sw.bb112
...
sw.bb112:                                         ; preds = %sw.bb109, %if.then89
  ...
  %i49 = load i8, i8* %incdec.ptr113, align 1, !tbaa !1
  %conv114 = zext i8 %i49 to i64
...
sw.bb117:                                         ; preds = %sw.bb112, %if.then89
  ...
  %i50 = load i8, i8* %incdec.ptr118, align 1, !tbaa !1
  %conv119 = zext i8 %i50 to i64
...
sw.bb122:                                         ; preds = %sw.bb117, %if.then89
  ...
  %i51 = load i8, i8* %incdec.ptr123, align 1, !tbaa !1
  %conv124 = zext i8 %i51 to i64
...
sw.epilog:                                        ; preds = %sw.bb122, %if.then89
  ...
  %i52 = load i64, i64* %arrayidx129, align 16, !tbaa !4
  %i53 = load i64, i64* %arrayidx130, align 8, !tbaa !4
  %shr134 = lshr i64 %i52, 24
  ...
  %conv162 = trunc i64 %i53 to i8
  store i8 %conv162, i8* %incdec.ptr160, align 1, !tbaa !1
  br label %if.end407

for.end295.loopexit:                              ; preds = %"BF_cbc_encrypt$0_extract_return_values$0"
  %scevgep = getelementptr i8, i8* %out, i64 %i37
  %i54 = sub i64 %l.1636, %i36
  br label %for.end295

for.end295:                                       ; preds = %for.end295.loopexit, %for.cond224.preheader
  %l.1.in.lcssa = phi i64 [ %length, %for.cond224.preheader ], [ %i54, %for.end295.loopexit ]
  %xor1.0.lcssa = phi i64 [ %i28, %for.cond224.preheader ], [ %i42, %for.end295.loopexit ]
  %xor0.0.lcssa = phi i64 [ %i27, %for.cond224.preheader ], [ %i40, %for.end295.loopexit ]
...
if.then298:                                       ; preds = %for.end295
  ...
  %i55 = load i8, i8* %in.addr.8.lcssa, align 1, !tbaa !1
  %incdec.ptr302 = getelementptr inbounds i8, i8* %in.addr.8.lcssa, i64 2
  %i56 = load i8, i8* %incdec.ptr299, align 1, !tbaa !1
  %incdec.ptr306 = getelementptr inbounds i8, i8* %in.addr.8.lcssa, i64 3
  %i57 = load i8, i8* %incdec.ptr302, align 1, !tbaa !1
  %incdec.ptr310 = getelementptr inbounds i8, i8* %in.addr.8.lcssa, i64 4
  %i58 = load i8, i8* %incdec.ptr306, align 1, !tbaa !1
  %incdec.ptr313 = getelementptr inbounds i8, i8* %in.addr.8.lcssa, i64 5
  %i59 = load i8, i8* %incdec.ptr310, align 1, !tbaa !1
  %i60 = insertelement <2 x i8> undef, i8 %i55, i32 0
  %i61 = insertelement <2 x i8> %i60, i8 %i59, i32 1
  %i62 = zext <2 x i8> %i61 to <2 x i64>
  %i63 = shl nuw nsw <2 x i64> %i62, <i64 24, i64 24>
  %incdec.ptr316 = getelementptr inbounds i8, i8* %in.addr.8.lcssa, i64 6
  %i64 = load i8, i8* %incdec.ptr313, align 1, !tbaa !1
  %i65 = insertelement <2 x i8> undef, i8 %i56, i32 0
  %i66 = insertelement <2 x i8> %i65, i8 %i64, i32 1
  %i67 = zext <2 x i8> %i66 to <2 x i64>
  %i68 = shl nuw nsw <2 x i64> %i67, <i64 16, i64 16>
  %i69 = or <2 x i64> %i68, %i63
  %incdec.ptr320 = getelementptr inbounds i8, i8* %in.addr.8.lcssa, i64 7
  %i70 = load i8, i8* %incdec.ptr316, align 1, !tbaa !1
  %i71 = insertelement <2 x i8> undef, i8 %i57, i32 0
  %i72 = insertelement <2 x i8> %i71, i8 %i70, i32 1
  %i73 = zext <2 x i8> %i72 to <2 x i64>
  %i74 = shl nuw nsw <2 x i64> %i73, <i64 8, i64 8>
  %i75 = or <2 x i64> %i69, %i74
  %i76 = load i8, i8* %incdec.ptr320, align 1, !tbaa !1
  %i77 = insertelement <2 x i8> undef, i8 %i58, i32 0
  %i78 = insertelement <2 x i8> %i77, i8 %i76, i32 1
  %i79 = zext <2 x i8> %i78 to <2 x i64>
  %i80 = or <2 x i64> %i75, %i79
  ...
  store <2 x i64> %i80, <2 x i64>* %tin, align 16, !tbaa !4
  call void @BF_encrypt(i64* %arrayidx327, %struct.bf_key_st* %ks, i32 0) #3
  %i81 = load i64, i64* %arrayidx327, align 16, !tbaa !4
  %xor331 = xor i64 %i81, %xor0.0.lcssa
  %i82 = load i64, i64* %arrayidx328, align 8, !tbaa !4
  %xor333 = xor i64 %i82, %xor1.0.lcssa
  %add.ptr335 = getelementptr inbounds i8, i8* %out.addr.1.lcssa, i64 %l.1.in.lcssa
  %i83 = extractelement <2 x i64> %i80, i32 0
  %i84 = extractelement <2 x i64> %i80, i32 1
...
if.end407:                                        ; preds = %sw.bb370, %if.then298, %for.end295, %sw.epilog, %for.end
  %storemerge635.in.in = phi i64 [ %i52, %sw.epilog ], [ %tout0.0.lcssa, %for.end ], [ %xor0.0.lcssa, %for.end295 ], [ %i83, %sw.bb370 ], [ %i83, %if.then298 ]
  %storemerge631.in.in = phi i64 [ %i53, %sw.epilog ], [ %tout1.0.lcssa, %for.end ], [ %xor1.0.lcssa, %for.end295 ], [ %i84, %sw.bb370 ], [ %i84, %if.then298 ]
...
define void @"BF_cbc_encrypt$0"(%1* %arg, i8* %arg1, i64 %arg2, i8* %arg3, i64 %arg4, i64 %arg5, i64* %arg6, %struct.bf_key_st* %arg7, <2 x i64>* %arg8, i64* %arg9) {
"BF_cbc_encrypt$0_latch$0":
  ...
  %i10 = load i8, i8* %incdec.ptr228, align 1, !tbaa !1
  %incdec.ptr235 = getelementptr inbounds i8, i8* %arg1, i64 3
  %i11 = load i8, i8* %incdec.ptr231, align 1, !tbaa !1
  %incdec.ptr239 = getelementptr inbounds i8, i8* %arg1, i64 4
  %i12 = load i8, i8* %incdec.ptr235, align 1, !tbaa !1
  %incdec.ptr242 = getelementptr inbounds i8, i8* %arg1, i64 5
  %i13 = load i8, i8* %incdec.ptr239, align 1, !tbaa !1
  ...
  %i18 = load i8, i8* %incdec.ptr242, align 1, !tbaa !1
  ...
  %i24 = load i8, i8* %incdec.ptr245, align 1, !tbaa !1
  ...
  %i30 = load i8, i8* %incdec.ptr249, align 1, !tbaa !1
  ...
  store <2 x i64> %i34, <2 x i64>* %arg8, align 16, !tbaa !4
  call void @BF_encrypt(i64* %arg9, %struct.bf_key_st* %arg7, i32 0) #3
  %i35 = load i64, i64* %arg9, align 16, !tbaa !4
  %xor260 = xor i64 %i35, %arg4
  %i36 = load i64, i64* %arg6, align 8, !tbaa !4
  %xor262 = xor i64 %i36, %arg5
  ...
  %i37 = extractelement <2 x i64> %i34, i32 0
  %i38 = extractelement <2 x i64> %i34, i32 1
...
"BF_cbc_encrypt$0_recursively_call_function":     ; preds = %"BF_cbc_encrypt$0_increment_depth_counter"
  call void @"BF_cbc_encrypt$0"(%1* %arg, i8* %incdec.ptr253, i64 %l.1, i8* %incdec.ptr292, i64 %i37, i64 %i38, i64* %arg6, %struct.bf_key_st* %arg7, <2 x i64>* %arg8, i64* %arg9)
  ret void

"BF_cbc_encrypt$0_return_from_recursive_function$0": ; preds = %"BF_cbc_encrypt$0_latch$0"
  %i39 = getelementptr %1, %1* %arg, i32 0, i32 0
  store i64 %i37, i64* %i39, align 8
  %i40 = getelementptr %1, %1* %arg, i32 0, i32 1
  store i64 %i38, i64* %i40, align 8
  ret void
}

define void @"BF_cbc_encrypt$1"(%0* %arg, <2 x i64> %arg1, i8* %arg2, i64 %arg3, i8* %arg4, %struct.bf_key_st* %arg5, <2 x i64>* %arg6, i64* %arg7) {
"BF_cbc_encrypt$1_latch$0":
  ...
  %i8 = load i8, i8* %incdec.ptr26, align 1, !tbaa !1
  %incdec.ptr33 = getelementptr inbounds i8, i8* %arg4, i64 3
  %i9 = load i8, i8* %incdec.ptr29, align 1, !tbaa !1
  %incdec.ptr37 = getelementptr inbounds i8, i8* %arg4, i64 4
  %i10 = load i8, i8* %incdec.ptr33, align 1, !tbaa !1
  %incdec.ptr40 = getelementptr inbounds i8, i8* %arg4, i64 5
  %i11 = load i8, i8* %incdec.ptr37, align 1, !tbaa !1
  %i12 = insertelement <2 x i8> undef, i8 %i, i32 0
  %i13 = insertelement <2 x i8> %i12, i8 %i11, i32 1
  %i14 = zext <2 x i8> %i13 to <2 x i64>
  %i15 = shl nuw nsw <2 x i64> %i14, <i64 24, i64 24>
  %incdec.ptr43 = getelementptr inbounds i8, i8* %arg4, i64 6
  %i16 = load i8, i8* %incdec.ptr40, align 1, !tbaa !1
  %i17 = insertelement <2 x i8> undef, i8 %i8, i32 0
  %i18 = insertelement <2 x i8> %i17, i8 %i16, i32 1
  %i19 = zext <2 x i8> %i18 to <2 x i64>
  %i20 = shl nuw nsw <2 x i64> %i19, <i64 16, i64 16>
  %i21 = or <2 x i64> %i20, %i15
  %incdec.ptr47 = getelementptr inbounds i8, i8* %arg4, i64 7
  %i22 = load i8, i8* %incdec.ptr43, align 1, !tbaa !1
  %i23 = insertelement <2 x i8> undef, i8 %i9, i32 0
  %i24 = insertelement <2 x i8> %i23, i8 %i22, i32 1
  %i25 = zext <2 x i8> %i24 to <2 x i64>
  %i26 = shl nuw nsw <2 x i64> %i25, <i64 8, i64 8>
  %i27 = or <2 x i64> %i21, %i26
  %incdec.ptr51 = getelementptr inbounds i8, i8* %arg4, i64 8
  %i28 = load i8, i8* %incdec.ptr47, align 1, !tbaa !1
  %i29 = insertelement <2 x i8> undef, i8 %i10, i32 0
  %i30 = insertelement <2 x i8> %i29, i8 %i28, i32 1
  %i31 = zext <2 x i8> %i30 to <2 x i64>
  %i32 = or <2 x i64> %i27, %i31
  %i33 = xor <2 x i64> %i32, %arg1
  store <2 x i64> %i33, <2 x i64>* %arg6, align 16, !tbaa !4
  call void @BF_encrypt(i64* %arg7, %struct.bf_key_st* %arg5, i32 1) #3
  %i34 = load <2 x i64>, <2 x i64>* %arg6, align 16, !tbaa !4
...
"BF_cbc_encrypt$1_recursively_call_function":     ; preds = %"BF_cbc_encrypt$1_increment_depth_counter"
  call void @"BF_cbc_encrypt$1"(%0* %arg, <2 x i64> %i34, i8* %incdec.ptr85, i64 %l.0, i8* %incdec.ptr51, %struct.bf_key_st* %arg5, <2 x i64>* %arg6, i64* %arg7)
  ret void

"BF_cbc_encrypt$1_return_from_recursive_function$0": ; preds = %"BF_cbc_encrypt$1_latch$0"
  %i37 = getelementptr %0, %0* %arg, i32 0, i32 0
  store i64 %i35, i64* %i37, align 8
  %i38 = getelementptr %0, %0* %arg, i32 0, i32 1
