; ModuleID = './benchmark_intermediate_representations/unoptimized_loop2recursion/bf/bf.ll.temp'
...
"main$1_call_recursive_function":                 ; preds = %"main$1_initialize_context"
  call void @"main$1"(%0* %i9, i8* %i8, i32 0, i32 0, [8 x i8]* %ukey)
  br label %"main$1_branch_to_exit"

"main$1_branch_to_exit":                          ; preds = %"main$1_call_recursive_function"
  %i10 = getelementptr %0, %0* %i9, i32 0, i32 1
  %i11 = load i8, i8* %i10, align 1
  switch i8 %i11, label %"main$1_extract_return_values$0" [
...
"main$1_extract_return_values$1":                 ; preds = %"main$1_branch_to_exit"
  %i12 = getelementptr %0, %0* %i9, i32 0, i32 0
...
while.end:                                        ; preds = %"main$1_extract_return_values$1"
  ...
  %i14 = load i8, i8* %i13, align 1, !tbaa !5
  %tobool62 = icmp eq i8 %i14, 0
...
if.end65:                                         ; preds = %while.end
  ...
  %i15 = load i8*, i8** %arrayidx66, align 8, !tbaa !1
  %call67 = call %struct._IO_FILE* @fopen(i8* %i15, i8* nonnull getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i64 0, i64 0))
...
if.end72:                                         ; preds = %if.end65
  ...
  %i16 = load i8*, i8** %arrayidx73, align 8, !tbaa !1
  %call74 = call %struct._IO_FILE* @fopen(i8* %i16, i8* nonnull getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4, i64 0, i64 0))
...
"main$0_call_recursive_function":                 ; preds = %while.cond84.preheader.preheader
  call void @"main$0"([40 x i8]* %outdata, [40 x i8]* %indata, i32 %encordec.0, i8* %i2, %struct._IO_FILE* %call67, i8* %i3, %struct.bf_key_st* %key, %struct._IO_FILE* %call74, i8* %i4, i32* %num)
...
define void @"main$0"([40 x i8]* %arg, [40 x i8]* %arg1, i32 %arg2, i8* %arg3, %struct._IO_FILE* %arg4, i8* %arg5, %struct.bf_key_st* %arg6, %struct._IO_FILE* %arg7, i8* %arg8, i32* %arg9) {
"main$0_header":
...
"main$0$0_call_recursive_function":               ; preds = %for.body.preheader
  call void @"main$0$0"(i64 0, i32 %i12, [40 x i8]* %arg, %struct._IO_FILE* %arg7)
...
"main$0_recursively_call_function":               ; preds = %"main$0_increment_depth_counter"
  call void @"main$0"([40 x i8]* %arg, [40 x i8]* %arg1, i32 %arg2, i8* %arg3, %struct._IO_FILE* %arg4, i8* %arg5, %struct.bf_key_st* %arg6, %struct._IO_FILE* %arg7, i8* %arg8, i32* %arg9)
  ret void
...
define void @"main$1"(%0* %arg, i8* %arg1, i32 %arg2, i32 %arg3, [8 x i8]* %arg4) {
"main$1_exiting$1":
...
while.body:                                       ; preds = %"main$1_exiting$1"
  ...
  %i5 = icmp ult i32 %sext.off, 184549375
  br i1 %i5, label %if.then35, label %"main$1_exiting$2"

"main$1_exiting$2":                               ; preds = %while.body
  %sext.off146 = add i32 %sext, -1073741825
  %i6 = icmp ult i32 %sext.off146, 117440511
  br i1 %i6, label %if.then45, label %"main$1_return_from_recursive_function$0"
...
"main$1_recursively_call_function":               ; preds = %"main$1_increment_depth_counter"
  call void @"main$1"(%0* %arg, i8* %incdec.ptr, i32 %sub, i32 %inc, [8 x i8]* %arg4)
  ret void

"main$1_return_from_recursive_function$0":        ; preds = %"main$1_exiting$2"
  %i7 = getelementptr %0, %0* %arg, i32 0, i32 1
  store i8 1, i8* %i7, align 1
  ret void

"main$1_return_from_recursive_function$1":        ; preds = %"main$1_latch$0", %"main$1_exiting$1"
  %i8 = phi i8* [ %arg1, %"main$1_exiting$1" ], [ %incdec.ptr, %"main$1_latch$0" ]
  %i9 = getelementptr %0, %0* %arg, i32 0, i32 0
  store i8* %i8, i8** %i9, align 8
  %i10 = getelementptr %0, %0* %arg, i32 0, i32 1
  store i8 2, i8* %i10, align 1
  ret void
}

define void @"main$0$0"(i64 %arg, i32 %arg1, [40 x i8]* %arg2, %struct._IO_FILE* %arg3) {
"main$0$0_latch$0":
...
"main$0$0_recursively_call_function":             ; preds = %"main$0$0_increment_depth_counter"
  call void @"main$0$0"(i64 %indvars.iv.next159, i32 %arg1, [40 x i8]* %arg2, %struct._IO_FILE* %arg3)
  ret void
...
define void @"main$0$1"(%1* %arg, i64 %arg1, [40 x i8]* %arg2, %struct._IO_FILE* %arg3) {
"main$0$1_latch$0":
...
"main$0$1_recursively_call_function":             ; preds = %"main$0$1_increment_depth_counter"
  call void @"main$0$1"(%1* %arg, i64 %indvars.iv.next, [40 x i8]* %arg2, %struct._IO_FILE* %arg3)
  ret void
