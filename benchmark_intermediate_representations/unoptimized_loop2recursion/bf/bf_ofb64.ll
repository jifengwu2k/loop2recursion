; ModuleID = './benchmark_intermediate_representations/unoptimized_loop2recursion/bf/bf_ofb64.ll.temp'
...
"BF_ofb64_encrypt$0_call_recursive_function":     ; preds = %"BF_ofb64_encrypt$0_initialize_context"
  call void @"BF_ofb64_encrypt$0"(%0* %i29, i8* %out, i8* %in, i32 %i, i64 %length, i32 0, [8 x i8]* %d, i8* %incdec.ptr46, i8* %incdec.ptr38, i64* %arrayidx25, %struct.bf_key_st* %schedule, i8* %i1, i8* %incdec.ptr42, i64* %arrayidx, i8* %incdec.ptr35, i8* %incdec.ptr27, i8* %incdec.ptr50, i8* %incdec.ptr31)
...
define void @"BF_ofb64_encrypt$0"(%0* %arg, i8* %arg1, i8* %arg2, i32 %arg3, i64 %arg4, i32 %arg5, [8 x i8]* %arg6, i8* %arg7, i8* %arg8, i64* %arg9, %struct.bf_key_st* %arg10, i8* %arg11, i8* %arg12, i64* %arg13, i8* %arg14, i8* %arg15, i8* %arg16, i8* %arg17) {
...
if.then:                                          ; preds = %"BF_ofb64_encrypt$0_header"
  call void @BF_encrypt(i64* %arg13, %struct.bf_key_st* %arg10, i32 1) #3
  %i = load i64, i64* %arg13, align 16, !tbaa !6
  %shr58 = lshr i64 %i, 24
  %conv60 = trunc i64 %shr58 to i8
  store i8 %conv60, i8* %arg11, align 1, !tbaa !5
  %shr62 = lshr i64 %i, 16
  ...
  store i8 %conv71, i8* %arg14, align 1, !tbaa !5
  %i18 = load i64, i64* %arg9, align 8, !tbaa !6
  %shr74 = lshr i64 %i18, 24
  %conv76 = trunc i64 %shr74 to i8
  store i8 %conv76, i8* %arg8, align 1, !tbaa !5
  %shr78 = lshr i64 %i18, 16
  %conv80 = trunc i64 %shr78 to i8
  store i8 %conv80, i8* %arg12, align 1, !tbaa !5
  %shr82 = lshr i64 %i18, 8
  %conv84 = trunc i64 %shr82 to i8
  store i8 %conv84, i8* %arg7, align 1, !tbaa !5
  %conv87 = trunc i64 %i18 to i8
...
"BF_ofb64_encrypt$0_latch$0":                     ; preds = %if.then, %"BF_ofb64_encrypt$0_header"
  ...
  %i19 = load i8, i8* %arg2, align 1, !tbaa !5
  %idxprom = sext i32 %arg3 to i64
  %arrayidx91 = getelementptr inbounds [8 x i8], [8 x i8]* %arg6, i64 0, i64 %idxprom
  %i20 = load i8, i8* %arrayidx91, align 1, !tbaa !5
  %xor206 = xor i8 %i20, %i19
...
"BF_ofb64_encrypt$0_recursively_call_function":   ; preds = %"BF_ofb64_encrypt$0_increment_depth_counter"
  call void @"BF_ofb64_encrypt$0"(%0* %arg, i8* %incdec.ptr94, i8* %incdec.ptr89, i32 %and95, i64 %dec213, i32 %save.1, [8 x i8]* %arg6, i8* %arg7, i8* %arg8, i64* %arg9, %struct.bf_key_st* %arg10, i8* %arg11, i8* %arg12, i64* %arg13, i8* %arg14, i8* %arg15, i8* %arg16, i8* %arg17)
  ret void
...
"BF_ofb64_encrypt$0_return_from_recursive_function$0": ; preds = %"BF_ofb64_encrypt$0_latch$0"
  ...
  store i32 %save.1, i32* %i21, align 4
  %i22 = getelementptr %0, %0* %arg, i32 0, i32 1
  store i32 %and95, i32* %i22, align 4
  ret void
}
