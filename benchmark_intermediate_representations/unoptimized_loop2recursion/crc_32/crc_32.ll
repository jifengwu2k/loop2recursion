; ModuleID = './benchmark_intermediate_representations/unoptimized_loop2recursion/crc_32/crc_32.ll.temp'
...
"crc32file$0_call_recursive_function":            ; preds = %"crc32file$0_initialize_context"
  call void @"crc32file$0"(%0* %i, i64 4294967295, i32 %call122, %struct._IO_FILE* %call, i64* %charcnt)
...
"crc32buf$0_call_recursive_function":             ; preds = %"crc32buf$0_initialize_context"
  call void @"crc32buf$0"(%1* %i3, i8* %buf.addr.07.unr, i64 %oldcrc32.09.unr, i64 %len.addr.08.unr)
...
for.end.loopexit:                                 ; preds = %for.end.loopexit.unr-lcssa, %for.body.preheader.split
  %xor1.lcssa = phi i64 [ %xor1.lcssa.unr, %for.body.preheader.split ], [ %i5, %for.end.loopexit.unr-lcssa ]
...
define void @"crc32file$0"(%0* %arg, i64 %arg1, i32 %arg2, %struct._IO_FILE* %arg3, i64* %arg4) {
"crc32file$0_latch$0":
...
"crc32file$0_recursively_call_function":          ; preds = %"crc32file$0_increment_depth_counter"
  call void @"crc32file$0"(%0* %arg, i64 %xor4, i32 %call1, %struct._IO_FILE* %arg3, i64* %arg4)
  ret void

"crc32file$0_return_from_recursive_function$0":   ; preds = %"crc32file$0_latch$0"
  %i6 = getelementptr %0, %0* %arg, i32 0, i32 0
  store i64 %xor4, i64* %i6, align 8
  ret void
}

define void @"crc32buf$0"(%1* %arg, i8* %arg1, i64 %arg2, i64 %arg3) {
"crc32buf$0_latch$0":
...
"crc32buf$0_recursively_call_function":           ; preds = %"crc32buf$0_increment_depth_counter"
  call void @"crc32buf$0"(%1* %arg, i8* %incdec.ptr.1, i64 %xor1.1, i64 %dec.1)
  ret void

"crc32buf$0_return_from_recursive_function$0":    ; preds = %"crc32buf$0_latch$0"
  %i7 = getelementptr %1, %1* %arg, i32 0, i32 0
  store i64 %xor1.1, i64* %i7, align 8
  ret void
}

define void @"main$0"(%2* %arg, i32 %arg1, i32 %arg2, i8** %arg3, i64* %arg4, i64* %arg5) {
"main$0_latch$0":
  ...
  %or = or i32 %call, %arg2
  %i6 = load i64, i64* %arg5, align 8, !tbaa !1
  %i7 = load i64, i64* %arg4, align 8, !tbaa !1
  %i8 = load i8*, i8** %incdec.ptr, align 8, !tbaa !6
  %call1 = tail call i32 (i8*, ...) @printf(i8* nonnull getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1, i64 0, i64 0), i64 %i6, i64 %i7, i8* %i8)
...
"main$0_recursively_call_function":               ; preds = %"main$0_increment_depth_counter"
  call void @"main$0"(%2* %arg, i32 %dec, i32 %or, i8** %incdec.ptr, i64* %arg4, i64* %arg5)
  ret void
