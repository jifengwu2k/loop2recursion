; ModuleID = './benchmark_intermediate_representations/unoptimized_loop2recursion/dijkstra/dijkstra_small.ll.temp'
...
"enqueue$0_call_recursive_function":              ; preds = %"enqueue$0_initialize_context"
  call void @"enqueue$0"(%0* %i6, %struct._QITEM* %i)
...
"enqueue$0_extract_return_values$0":              ; preds = %"enqueue$0_call_recursive_function"
  ...
  %i8 = load %struct._QITEM**, %struct._QITEM*** %i7, align 8
  br label %while.end
...
while.end:                                        ; preds = %"enqueue$0_extract_return_values$0"
  %i9 = bitcast %struct._QITEM** %i8 to i8**
  store i8* %call, i8** %i9, align 8, !tbaa !12
  br label %if.end11

if.end11:                                         ; preds = %while.end, %if.then6
  %i10 = load i32, i32* @g_qCount, align 4, !tbaa !13
...
while.end.i:                                      ; preds = %"dijkstra$1_extract_return_values$0"
  %i9 = bitcast %struct._QITEM** %i8 to i8**
  store i8* %call.i, i8** %i9, align 8, !tbaa !12
  br label %enqueue.exit

enqueue.exit:                                     ; preds = %while.end.i, %if.then6.i
  %i10 = load i32, i32* @g_qCount, align 4, !tbaa !13
  %inc.i = add nsw i32 %i10, 1
  store i32 %inc.i, i32* @g_qCount, align 4, !tbaa !13
  %cmp1178 = icmp sgt i32 %i10, -1
...
while.end:                                        ; preds = %while.end.loopexit, %enqueue.exit
  ...
  %i16 = load i32, i32* %iDist44, align 8, !tbaa !14
  %call45 = tail call i32 (i8*, ...) @printf(i8* nonnull getelementptr inbounds ([30 x i8], [30 x i8]* @.str.3, i64 0, i64 0), i32 %i16)
...
"main$1_call_recursive_function":                 ; preds = %if.end
  call void @"main$1"(i64 0, i32* %k, %struct._IO_FILE* %call2)
...
define void @"enqueue$0"(%0* %arg, %struct._QITEM* %arg1) {
"enqueue$0_latch$0":
...
"enqueue$0_recursively_call_function":            ; preds = %"enqueue$0_increment_depth_counter"
  call void @"enqueue$0"(%0* %arg, %struct._QITEM* %i)
  ret void

"enqueue$0_return_from_recursive_function$0":     ; preds = %"enqueue$0_latch$0"
  %i2 = getelementptr %0, %0* %arg, i32 0, i32 0
  store %struct._QITEM** %qNext7, %struct._QITEM*** %i2, align 8
  ret void
}

define void @"dijkstra$0"(%2* %arg, i32 %arg1) {
"dijkstra$0_header":
  %i = load %struct._QITEM*, %struct._QITEM** @qHead, align 8, !tbaa !6
...
for.cond12.preheader:                             ; preds = %if.then.i58, %"dijkstra$0_header"
  %i8 = phi i32 [ %arg1, %"dijkstra$0_header" ], [ %dec.i, %if.then.i58 ]
...
"dijkstra$0$0_call_recursive_function":           ; preds = %"dijkstra$0$0_initialize_context"
  call void @"dijkstra$0$0"(%3* %i9, i32 0, i32 %i8, i32 %.pre, i64 %idxprom16)
  br label %"dijkstra$0$0_branch_to_exit"

"dijkstra$0$0_branch_to_exit":                    ; preds = %"dijkstra$0$0_call_recursive_function"
  %i10 = getelementptr %3, %3* %i9, i32 0, i32 1
  %i11 = load i8, i8* %i10, align 1
  switch i8 %i11, label %"dijkstra$0$0_extract_return_values$0" [
...
"dijkstra$0$0_extract_return_values$0":           ; preds = %"dijkstra$0$0_branch_to_exit", %"dijkstra$0$0_branch_to_exit"
  %i12 = getelementptr %3, %3* %i9, i32 0, i32 0
...
"dijkstra$0_recursively_call_function":           ; preds = %"dijkstra$0_increment_depth_counter"
  call void @"dijkstra$0"(%2* %arg, i32 %i13)
  ret void

"dijkstra$0_return_from_recursive_function$0":    ; preds = %"dijkstra$0_latch$0"
  %i14 = getelementptr %2, %2* %arg, i32 0, i32 0
  store i8 1, i8* %i14, align 1
  ret void
...
define void @"dijkstra$1"(%1* %arg, %struct._QITEM* %arg1) {
"dijkstra$1_latch$0":
...
"dijkstra$1_recursively_call_function":           ; preds = %"dijkstra$1_increment_depth_counter"
  call void @"dijkstra$1"(%1* %arg, %struct._QITEM* %i)
  ret void

"dijkstra$1_return_from_recursive_function$0":    ; preds = %"dijkstra$1_latch$0"
  %i2 = getelementptr %1, %1* %arg, i32 0, i32 0
  store %struct._QITEM** %qNext7.i, %struct._QITEM*** %i2, align 8
  ret void
}
...
define void @"main$1"(i64 %arg, i32* %arg1, %struct._IO_FILE* %arg2) {
"main$1_header":
  br label %"main$1$0_call_recursive_function"

"main$1$0_call_recursive_function":               ; preds = %"main$1_header"
  call void @"main$1$0"(i64 0, i64 %arg, %struct._IO_FILE* %arg2, i32* %arg1)
...
"main$1_recursively_call_function":               ; preds = %"main$1_increment_depth_counter"
  call void @"main$1"(i64 %indvars.iv.next38, i32* %arg1, %struct._IO_FILE* %arg2)
  ret void
...
define void @"dijkstra$0$0"(%3* %arg, i32 %arg1, i32 %arg2, i32 %arg3, i64 %arg4) {
"dijkstra$0$0_header":
...
if.end.i68:                                       ; preds = %"dijkstra$0$0_exiting$1"
  ...
  store i32 %arg3, i32* %i8, align 8, !tbaa !11
  %qNext.i66 = getelementptr inbounds i8, i8* %call.i60, i64 16
  %i9 = bitcast i8* %qNext.i66 to %struct._QITEM**
  store %struct._QITEM* null, %struct._QITEM** %i9, align 8, !tbaa !12
...
"dijkstra$0$0$0_call_recursive_function":         ; preds = %"dijkstra$0$0$0_initialize_context"
  call void @"dijkstra$0$0$0"(%4* %i10, %struct._QITEM* %i6)
...
"dijkstra$0$0$0_extract_return_values$0":         ; preds = %"dijkstra$0$0$0_call_recursive_function"
  %i11 = getelementptr %4, %4* %i10, i32 0, i32 0
...
while.end.i74:                                    ; preds = %"dijkstra$0$0$0_extract_return_values$0"
  ...
  store i8* %call.i60, i8** %i13, align 8, !tbaa !12
...
"dijkstra$0$0_recursively_call_function":         ; preds = %"dijkstra$0$0_increment_depth_counter"
  call void @"dijkstra$0$0"(%3* %arg, i32 %inc40, i32 %.pr, i32 %arg3, i64 %arg4)
  ret void

"dijkstra$0$0_return_from_recursive_function$0":  ; preds = %"dijkstra$0$0_latch$0"
  %i14 = getelementptr %3, %3* %arg, i32 0, i32 0
  store i32 %.pr, i32* %i14, align 4
  %i15 = getelementptr %3, %3* %arg, i32 0, i32 1
  store i8 1, i8* %i15, align 1
  ret void

"dijkstra$0$0_return_from_recursive_function$1":  ; preds = %"dijkstra$0$0_exiting$1"
  %i16 = getelementptr %3, %3* %arg, i32 0, i32 1
  store i8 0, i8* %i16, align 1
  ret void
}

define void @"main$1$0"(i64 %arg, i64 %arg1, %struct._IO_FILE* %arg2, i32* %arg3) {
"main$1$0_latch$0":
...
"main$1$0_recursively_call_function":             ; preds = %"main$1$0_increment_depth_counter"
  call void @"main$1$0"(i64 %indvars.iv.next, i64 %arg1, %struct._IO_FILE* %arg2, i32* %arg3)
  ret void
...
define void @"dijkstra$0$0$0"(%4* %arg, %struct._QITEM* %arg1) {
...
"dijkstra$0$0$0_recursively_call_function":       ; preds = %"dijkstra$0$0$0_increment_depth_counter"
  call void @"dijkstra$0$0$0"(%4* %arg, %struct._QITEM* %i)
  ret void

"dijkstra$0$0$0_return_from_recursive_function$0": ; preds = %"dijkstra$0$0$0_latch$0"
  %i2 = getelementptr %4, %4* %arg, i32 0, i32 0
  store %struct._QITEM** %qNext7.i71, %struct._QITEM*** %i2, align 8
  ret void
}
