; ModuleID = './benchmark_intermediate_representations/unoptimized_loop2recursion/patricia/patricia_test.ll.temp'
...
"main$0_call_recursive_function":                 ; preds = %"main$0_initialize_context"
  call void @"main$0"(%0* %i14, %struct._IO_FILE* %call2, %struct.ptree* %i6, i32* %i13, i8* %i, float* %time)
  br label %"main$0_branch_to_exit"

"main$0_branch_to_exit":                          ; preds = %"main$0_call_recursive_function"
  %i15 = getelementptr %0, %0* %i14, i32 0, i32 0
  %i16 = load i8, i8* %i15, align 1
  switch i8 %i16, label %while.end.loopexit [
...
if.then66:                                        ; preds = %"main$0_branch_to_exit"
  %i17 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !1
  %i18 = call i64 @fwrite(i8* nonnull getelementptr inbounds ([22 x i8], [22 x i8]* @.str.9, i64 0, i64 0), i64 21, i64 1, %struct._IO_FILE* %i17) #8
  call void @exit(i32 0) #7
  unreachable
...
define void @"main$0"(%0* %arg, %struct._IO_FILE* %arg1, %struct.ptree* %arg2, i32* %arg3, i8* %arg4, float* %arg5) {
"main$0_exiting$3":
  %call27 = call i32 (i8*, i8*, ...) @__isoc99_sscanf(i8* %arg4, i8* nonnull getelementptr inbounds ([6 x i8], [6 x i8]* @.str.6, i64 0, i64 0), float* nonnull %arg5, i32* %arg3) #4
...
"main$0_exiting$4":                               ; preds = %"main$0_exiting$3"
  ...
  %i6 = bitcast i8* %p_m33 to i8**
  store i8* %call32, i8** %i6, align 8, !tbaa !5
...
if.end64.thread:                                  ; preds = %if.end45
  %i13 = load float, float* %arg5, align 4, !tbaa !19
  %conv59 = fpext float %i13 to double
  %call61 = call i32 (i8*, ...) @printf(i8* nonnull getelementptr inbounds ([10 x i8], [10 x i8]* @.str.7, i64 0, i64 0), double %conv59, i32 %i12)
...
"main$0_latch$0":                                 ; preds = %if.end64.thread, %"main$0_exiting$1"
  %call24 = call i8* @fgets(i8* %arg4, i32 128, %struct._IO_FILE* nonnull %arg1)
