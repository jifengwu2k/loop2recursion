; ModuleID = './benchmark_intermediate_representations/unoptimized_loop2recursion/patricia/patricia.ll.temp'
...
"pat_insert$3_call_recursive_function":           ; preds = %"pat_insert$3_initialize_context"
  call void @"pat_insert$3"(%0* %i4, %struct.ptree* %head, i8 %.pre, i64 %and)
...
do.end:                                           ; preds = %"pat_insert$3_extract_return_values$0"
  %p_key13 = getelementptr inbounds %struct.ptree, %struct.ptree* %i6, i64 0, i32 0
  %i7 = load i64, i64* %p_key13, align 8, !tbaa !9
  %cmp14 = icmp eq i64 %and, %i7
...
"pat_insert$2_call_recursive_function":           ; preds = %"pat_insert$2_initialize_context"
  call void @"pat_insert$2"(%1* %i9, i32 1, i64 %i8)
...
"pat_insert$2_extract_return_values$0":           ; preds = %"pat_insert$2_call_recursive_function"
  %i10 = getelementptr %1, %1* %i9, i32 0, i32 0
  %i11 = load i32, i32* %i10, align 4
  br label %for.end83

for.cond.preheader:                               ; preds = %do.end
  %p_mlen = getelementptr inbounds %struct.ptree, %struct.ptree* %i6, i64 0, i32 2
  %i12 = load i8, i8* %p_mlen, align 8, !tbaa !11
  %conv17192 = zext i8 %i12 to i64
  %cmp18193 = icmp eq i8 %i12, 0
  br i1 %cmp18193, label %for.end, label %for.body.lr.ph

for.body.lr.ph:                                   ; preds = %for.cond.preheader
  %i13 = load i64, i64* %pm_mask, align 8
  %p_m22 = getelementptr inbounds %struct.ptree, %struct.ptree* %i6, i64 0, i32 1
  %i14 = load %struct.ptree_mask*, %struct.ptree_mask** %p_m22, align 8
  %i15 = zext i8 %i12 to i64
...
"pat_insert$1_call_recursive_function":           ; preds = %"pat_insert$1_initialize_context"
  call void @"pat_insert$1"(%2* %i16, i64 0, i64 %i15, %struct.ptree_mask* %i14, i64 %i13)
  br label %"pat_insert$1_branch_to_exit"

"pat_insert$1_branch_to_exit":                    ; preds = %"pat_insert$1_call_recursive_function"
  %i17 = getelementptr %2, %2* %i16, i32 0, i32 1
  %i18 = load i8, i8* %i17, align 1
  switch i8 %i18, label %"pat_insert$1_extract_return_values$0" [
...
"pat_insert$1_extract_return_values$1":           ; preds = %"pat_insert$1_branch_to_exit"
  %i19 = getelementptr %2, %2* %i16, i32 0, i32 0
...
if.then26:                                        ; preds = %"pat_insert$1_extract_return_values$1"
  ...
  %i21 = bitcast i8** %pm_data to i64*
  %i22 = load i64, i64* %i21, align 8, !tbaa !12
  %pm_data31 = getelementptr inbounds %struct.ptree_mask, %struct.ptree_mask* %i14, i64 %i20, i32 1
  %i23 = bitcast i8** %pm_data31 to i64*
  store i64 %i22, i64* %i23, align 8, !tbaa !12
  tail call void @free(i8* %i1) #4
  %i24 = bitcast %struct.ptree* %n to i8*
  tail call void @free(i8* %i24) #4
  br label %cleanup
...
for.end:                                          ; preds = %for.end.loopexit, %for.cond.preheader
  ...
  %i25 = bitcast i8* %call37 to %struct.ptree_mask*
  %i26 = load i8, i8* %p_mlen, align 8, !tbaa !11
  %cmp41187 = icmp eq i8 %i26, 0
  br i1 %cmp41187, label %if.then62, label %for.body43.lr.ph

for.body43.lr.ph:                                 ; preds = %for.end
  %p_m47 = getelementptr inbounds %struct.ptree, %struct.ptree* %i6, i64 0, i32 1
...
"pat_insert$0_call_recursive_function":           ; preds = %"pat_insert$0_initialize_context"
  call void @"pat_insert$0"(%3* %i27, %struct.ptree_mask* %i25, i32 0, %struct.ptree_mask* %i, i32 0, %struct.ptree_mask** %p_m47, i8* %p_mlen, %struct.ptree_mask** %p_m)
...
"pat_insert$0_extract_return_values$0":           ; preds = %"pat_insert$0_call_recursive_function"
  %i28 = getelementptr %3, %3* %i27, i32 0, i32 0
  %i29 = load i32, i32* %i28, align 4
  %i30 = getelementptr %3, %3* %i27, i32 0, i32 1
  %i31 = load %struct.ptree_mask*, %struct.ptree_mask** %i30, align 8
  br label %for.end60

for.end60:                                        ; preds = %"pat_insert$0_extract_return_values$0"
  %tobool61 = icmp eq i32 %i29, 0
...
if.then62:                                        ; preds = %for.end60, %for.end
  %pm.0.lcssa203 = phi %struct.ptree_mask* [ %i31, %for.end60 ], [ %i25, %for.end ]
  %i32 = bitcast %struct.ptree_mask** %p_m to i8**
  %i33 = load i8*, i8** %i32, align 8, !tbaa !1
  %i34 = bitcast %struct.ptree_mask* %pm.0.lcssa203 to i8*
  tail call void @bcopy(i8* %i33, i8* %i34, i64 16) #4
  br label %if.end64

if.end64:                                         ; preds = %if.then62, %for.end60.if.end64_crit_edge
  %.pre-phi = phi i8** [ %.pre201, %for.end60.if.end64_crit_edge ], [ %i32, %if.then62 ]
  %i35 = load i8*, i8** %.pre-phi, align 8, !tbaa !1
  tail call void @free(i8* %i35) #4
  %i36 = bitcast %struct.ptree* %n to i8*
  tail call void @free(i8* %i36) #4
  %i37 = load i8, i8* %p_mlen, align 8, !tbaa !11
  %inc67 = add i8 %i37, 1
  store i8 %inc67, i8* %p_mlen, align 8, !tbaa !11
  %p_m68 = getelementptr inbounds %struct.ptree, %struct.ptree* %i6, i64 0, i32 1
  %i38 = bitcast %struct.ptree_mask** %p_m68 to i8**
  %i39 = load i8*, i8** %i38, align 8, !tbaa !1
  tail call void @free(i8* %i39) #4
  store i8* %call37, i8** %i38, align 8, !tbaa !1
  br label %cleanup
...
if.then89:                                        ; preds = %for.end83
  ...
  %i40 = load %struct.ptree*, %struct.ptree** %p_right90, align 8, !tbaa !13
  %call91 = tail call fastcc %struct.ptree* @insertR(%struct.ptree* %i40, %struct.ptree* nonnull %n, i32 %i11, %struct.ptree* nonnull %head)
...
if.else93:                                        ; preds = %for.end83
  ...
  %i41 = load %struct.ptree*, %struct.ptree** %p_left94, align 8, !tbaa !14
  %call95 = tail call fastcc %struct.ptree* @insertR(%struct.ptree* %i41, %struct.ptree* nonnull %n, i32 %i11, %struct.ptree* nonnull %head)
...
cleanup:                                          ; preds = %if.else93, %if.then89, %if.end64, %if.then26, %lor.lhs.false2, %entry
  %retval.0 = phi %struct.ptree* [ %i6, %if.then26 ], [ %i6, %if.end64 ], [ null, %lor.lhs.false2 ], [ null, %entry ], [ %n, %if.else93 ], [ %n, %if.then89 ]
...
"pat_search$0_call_recursive_function":           ; preds = %"pat_search$0_initialize_context"
  call void @"pat_search$0"(%4* %i, %struct.ptree* %head, i8 %.pre, %struct.ptree* null, i64 %key)
...
"pat_search$0_extract_return_values$0":           ; preds = %"pat_search$0_call_recursive_function"
  %i1 = getelementptr %4, %4* %i, i32 0, i32 0
  %i2 = load %struct.ptree*, %struct.ptree** %i1, align 8
  %i3 = getelementptr %4, %4* %i, i32 0, i32 1
  %i4 = load %struct.ptree*, %struct.ptree** %i3, align 8
  br label %do.end

do.end:                                           ; preds = %"pat_search$0_extract_return_values$0"
  %p_key10 = getelementptr inbounds %struct.ptree, %struct.ptree* %i4, i64 0, i32 0
  %i5 = load i64, i64* %p_key10, align 8, !tbaa !9
  %p_m11 = getelementptr inbounds %struct.ptree, %struct.ptree* %i4, i64 0, i32 1
  %i6 = load %struct.ptree_mask*, %struct.ptree_mask** %p_m11, align 8, !tbaa !1
  %pm_mask12 = getelementptr inbounds %struct.ptree_mask, %struct.ptree_mask* %i6, i64 0, i32 0
  %i7 = load i64, i64* %pm_mask12, align 8, !tbaa !7
  %and13 = and i64 %i7, %key
  %cmp14 = icmp eq i64 %i5, %and13
  %cond19 = select i1 %cmp14, %struct.ptree* %i4, %struct.ptree* %i2
  br label %cleanup
...
define void @"pat_insert$0"(%3* %arg, %struct.ptree_mask* %arg1, i32 %arg2, %struct.ptree_mask* %arg3, i32 %arg4, %struct.ptree_mask** %arg5, i8* %arg6, %struct.ptree_mask** %arg7) {
"pat_insert$0_header":
  ...
  %i8 = load %struct.ptree_mask*, %struct.ptree_mask** %arg5, align 8, !tbaa !1
  %arrayidx48 = getelementptr inbounds %struct.ptree_mask, %struct.ptree_mask* %i8, i64 %idxprom46
  %pm_mask49 = getelementptr inbounds %struct.ptree_mask, %struct.ptree_mask* %arrayidx48, i64 0, i32 0
  %i9 = load i64, i64* %pm_mask49, align 8, !tbaa !7
  %cmp50 = icmp ugt i64 %i, %i9
  br i1 %cmp50, label %if.then52, label %if.else

if.else:                                          ; preds = %"pat_insert$0_header"
  %i10 = bitcast %struct.ptree_mask* %arg3 to i8*
  %i11 = bitcast %struct.ptree_mask* %arg1 to i8*
  tail call void @bcopy(i8* %i10, i8* %i11, i64 16) #4
  %i12 = load %struct.ptree_mask*, %struct.ptree_mask** %arg7, align 8, !tbaa !1
  %pm_mask57 = getelementptr inbounds %struct.ptree_mask, %struct.ptree_mask* %i12, i64 0, i32 0
  store i64 4294967295, i64* %pm_mask57, align 8, !tbaa !7
  br label %"pat_insert$0_exiting$0"

if.then52:                                        ; preds = %"pat_insert$0_header"
  %i13 = bitcast %struct.ptree_mask* %arrayidx48 to i8*
  %i14 = bitcast %struct.ptree_mask* %arg1 to i8*
  tail call void @bcopy(i8* %i13, i8* %i14, i64 16) #4
...
"pat_insert$0_exiting$0":                         ; preds = %if.then52, %if.else
  ...
  %i15 = load i8, i8* %arg6, align 8, !tbaa !11
...
"pat_insert$0_recursively_call_function":         ; preds = %"pat_insert$0_increment_depth_counter"
  call void @"pat_insert$0"(%3* %arg, %struct.ptree_mask* %incdec.ptr, i32 %i.2, %struct.ptree_mask* %.pre200, i32 %copied.1, %struct.ptree_mask** %arg5, i8* %arg6, %struct.ptree_mask** %arg7)
  ret void

"pat_insert$0_return_from_recursive_function$0":  ; preds = %"pat_insert$0_exiting$0"
  %i16 = getelementptr %3, %3* %arg, i32 0, i32 0
  store i32 %copied.1, i32* %i16, align 4
  %i17 = getelementptr %3, %3* %arg, i32 0, i32 1
  store %struct.ptree_mask* %incdec.ptr, %struct.ptree_mask** %i17, align 8
  ret void
}

define void @"pat_insert$1"(%2* %arg, i64 %arg1, i64 %arg2, %struct.ptree_mask* %arg3, i64 %arg4) {
...
"pat_insert$1_recursively_call_function":         ; preds = %"pat_insert$1_increment_depth_counter"
  call void @"pat_insert$1"(%2* %arg, i64 %indvars.iv.next, i64 %arg2, %struct.ptree_mask* %arg3, i64 %arg4)
  ret void

"pat_insert$1_return_from_recursive_function$0":  ; preds = %"pat_insert$1_latch$0"
  %i5 = getelementptr %2, %2* %arg, i32 0, i32 1
...
"pat_insert$1_return_from_recursive_function$1":  ; preds = %"pat_insert$1_exiting$1"
  ...
  store i64 %arg1, i64* %i6, align 8
  %i7 = getelementptr %2, %2* %arg, i32 0, i32 1
  store i8 0, i8* %i7, align 1
  ret void
}

define void @"pat_insert$2"(%1* %arg, i32 %arg1, i64 %arg2) {
...
"pat_insert$2_recursively_call_function":         ; preds = %"pat_insert$2_increment_depth_counter"
  call void @"pat_insert$2"(%1* %arg, i32 %inc82, i64 %arg2)
  ret void

"pat_insert$2_return_from_recursive_function$0":  ; preds = %"pat_insert$2_latch$0", %"pat_insert$2_exiting$1"
  %i3 = phi i32 [ %inc82, %"pat_insert$2_latch$0" ], [ %arg1, %"pat_insert$2_exiting$1" ]
  %i4 = getelementptr %1, %1* %arg, i32 0, i32 0
  store i32 %i3, i32* %i4, align 4
  ret void
}

define void @"pat_insert$3"(%0* %arg, %struct.ptree* %arg1, i8 %arg2, i64 %arg3) {
...
"pat_insert$3_recursively_call_function":         ; preds = %"pat_insert$3_increment_depth_counter"
  call void @"pat_insert$3"(%0* %arg, %struct.ptree* %cond, i8 %i, i64 %arg3)
  ret void

"pat_insert$3_return_from_recursive_function$0":  ; preds = %"pat_insert$3_latch$0"
  %i4 = getelementptr %0, %0* %arg, i32 0, i32 0
  store %struct.ptree* %cond, %struct.ptree** %i4, align 8
  ret void
}

define void @"pat_search$0"(%4* %arg, %struct.ptree* %arg1, i8 %arg2, %struct.ptree* %arg3, i64 %arg4) {
"pat_search$0_latch$0":
  ...
  %i5 = load %struct.ptree_mask*, %struct.ptree_mask** %p_m, align 8, !tbaa !1
  %pm_mask = getelementptr inbounds %struct.ptree_mask, %struct.ptree_mask* %i5, i64 0, i32 0
  %i6 = load i64, i64* %pm_mask, align 8, !tbaa !7
  %and = and i64 %i6, %arg4
  ...
  %i7 = load i8, i8* %p_b6, align 1, !tbaa !10
  %cmp8 = icmp slt i8 %arg2, %i7
...
"pat_search$0_recursively_call_function":         ; preds = %"pat_search$0_increment_depth_counter"
  call void @"pat_search$0"(%4* %arg, %struct.ptree* %cond, i8 %i7, %struct.ptree* %t.0.p.0, i64 %arg4)
  ret void

"pat_search$0_return_from_recursive_function$0":  ; preds = %"pat_search$0_latch$0"
  %i8 = getelementptr %4, %4* %arg, i32 0, i32 0
  store %struct.ptree* %t.0.p.0, %struct.ptree** %i8, align 8
  %i9 = getelementptr %4, %4* %arg, i32 0, i32 1
