; ModuleID = './benchmark_intermediate_representations/unoptimized_loop2recursion/fft/main.ll.temp'
...
"main$3_call_recursive_function":                 ; preds = %for.body.preheader
  call void @"main$3"(i64 0, i32 %conv.i171, float* %i7, float* %i8)
...
"main$2_call_recursive_function":                 ; preds = %for.body41.preheader
  call void @"main$2"(i64 0, i32 %conv.i, i1 %cmp28180, float* %i3, float* %i4, float* %i7, float* %i8, i32 %conv.i171)
  br label %for.end90
...
"main$1_call_recursive_function":                 ; preds = %for.body96.preheader
  call void @"main$1"(i64 0, i32 %conv.i, float* %i5)
...
"main$0_call_recursive_function":                 ; preds = %for.body109.preheader
  call void @"main$0"(i64 0, i32 %conv.i, float* %i6)
...
define void @"main$0"(i64 %arg, i32 %arg1, float* %arg2) {
"main$0_latch$0":
...
"main$0_recursively_call_function":               ; preds = %"main$0_increment_depth_counter"
  call void @"main$0"(i64 %indvars.iv.next, i32 %arg1, float* %arg2)
  ret void
...
define void @"main$1"(i64 %arg, i32 %arg1, float* %arg2) {
"main$1_latch$0":
...
"main$1_recursively_call_function":               ; preds = %"main$1_increment_depth_counter"
  call void @"main$1"(i64 %indvars.iv.next183, i32 %arg1, float* %arg2)
  ret void
...
define void @"main$2"(i64 %arg, i32 %arg1, i1 %arg2, float* %arg3, float* %arg4, float* %arg5, float* %arg6, i32 %arg7) {
"main$2_header":
...
"main$2$0_call_recursive_function":               ; preds = %for.body47.lr.ph
  call void @"main$2$0"(i64 0, i32 %arg7, float %conv57, float* %arg5, float* %arrayidx84, float* %arrayidx43, float* %arg6)
...
"main$2_recursively_call_function":               ; preds = %"main$2_increment_depth_counter"
  call void @"main$2"(i64 %indvars.iv.next191, i32 %arg1, i1 %arg2, float* %arg3, float* %arg4, float* %arg5, float* %arg6, i32 %arg7)
  ret void
...
define void @"main$3"(i64 %arg, i32 %arg1, float* %arg2, float* %arg3) {
"main$3_latch$0":
...
"main$3_recursively_call_function":               ; preds = %"main$3_increment_depth_counter"
  call void @"main$3"(i64 %indvars.iv.next195, i32 %arg1, float* %arg2, float* %arg3)
  ret void
...
define void @"main$2$0"(i64 %arg, i32 %arg1, float %arg2, float* %arg3, float* %arg4, float* %arg5, float* %arg6) {
"main$2$0_header":
  %call48 = tail call i32 @rand() #5
  %rem49166 = and i32 %call48, 1
  %tobool50 = icmp eq i32 %rem49166, 0
  %arrayidx53 = getelementptr inbounds float, float* %arg3, i64 %arg
  ...
  %i7 = load float, float* %arrayidx56, align 4, !tbaa !5
  %mul58 = fmul float %arg2, %i7
...
if.then51:                                        ; preds = %"main$2$0_header"
  ...
  %i8 = load float, float* %arg5, align 4, !tbaa !5
  %conv64 = fpext float %i8 to double
...
if.else66:                                        ; preds = %"main$2$0_header"
  ...
  %i9 = load float, float* %arg5, align 4, !tbaa !5
...
"main$2$0_latch$0":                               ; preds = %if.else66, %if.then51
  ...
  store float %storemerge, float* %arg5, align 4, !tbaa !5
  store float 0.000000e+00, float* %arg4, align 4, !tbaa !5
...
"main$2$0_recursively_call_function":             ; preds = %"main$2$0_increment_depth_counter"
  call void @"main$2$0"(i64 %indvars.iv.next187, i32 %arg1, float %arg2, float* %arg3, float* %arg4, float* %arg5, float* %arg6)
  ret void
