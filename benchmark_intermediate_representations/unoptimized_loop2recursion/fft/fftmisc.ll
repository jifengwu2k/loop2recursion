; ModuleID = './benchmark_intermediate_representations/unoptimized_loop2recursion/fft/fftmisc.ll.temp'
...
"NumberOfBitsNeeded$0_call_recursive_function":   ; preds = %"NumberOfBitsNeeded$0_initialize_context"
  call void @"NumberOfBitsNeeded$0"(%0* %i, i32 0, i32 %PowerOfTwo)
...
if.then:                                          ; preds = %entry
  ...
  %call = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %i3, i8* nonnull getelementptr inbounds ([73 x i8], [73 x i8]* @.str, i64 0, i64 0), i32 %PowerOfTwo) #4
...
"ReverseBits$1_call_recursive_function":          ; preds = %"ReverseBits$1_initialize_context"
  call void @"ReverseBits$1"(%1* %i1, i32 %index, i32 0, i32 %xtraiter, i32 0)
...
"ReverseBits$1_extract_return_values$0":          ; preds = %"ReverseBits$1_call_recursive_function"
  %i2 = getelementptr %1, %1* %i1, i32 0, i32 0
  %i3 = load i32, i32* %i2, align 4
  %i4 = getelementptr %1, %1* %i1, i32 0, i32 1
  %i5 = load i32, i32* %i4, align 4
  %i6 = getelementptr %1, %1* %i1, i32 0, i32 2
...
for.body.preheader.split:                         ; preds = %for.body.preheader.split.loopexit, %for.body.preheader
  %or.lcssa.unr = phi i32 [ undef, %for.body.preheader ], [ %i3, %for.body.preheader.split.loopexit ]
  %rev.08.unr = phi i32 [ 0, %for.body.preheader ], [ %i3, %for.body.preheader.split.loopexit ]
  %i.07.unr = phi i32 [ 0, %for.body.preheader ], [ %i5, %for.body.preheader.split.loopexit ]
  %index.addr.06.unr = phi i32 [ %index, %for.body.preheader ], [ %i7, %for.body.preheader.split.loopexit ]
  %i8 = icmp ult i32 %i, 3
  br i1 %i8, label %for.end.loopexit, label %for.body.preheader.split.split
...
"ReverseBits$0_call_recursive_function":          ; preds = %"ReverseBits$0_initialize_context"
  call void @"ReverseBits$0"(%2* %i9, i32 %index.addr.06.unr, i32 %rev.08.unr, i32 %i.07.unr, i32 %NumBits)
...
for.end.loopexit:                                 ; preds = %for.end.loopexit.unr-lcssa, %for.body.preheader.split
  %or.lcssa = phi i32 [ %or.lcssa.unr, %for.body.preheader.split ], [ %i11, %for.end.loopexit.unr-lcssa ]
  br label %for.end
...
define void @"NumberOfBitsNeeded$0"(%0* %arg, i32 %arg1, i32 %arg2) {
...
"NumberOfBitsNeeded$0_recursively_call_function": ; preds = %"NumberOfBitsNeeded$0_increment_depth_counter"
  call void @"NumberOfBitsNeeded$0"(%0* %arg, i32 %inc, i32 %arg2)
  ret void
...
define void @"ReverseBits$0"(%2* %arg, i32 %arg1, i32 %arg2, i32 %arg3, i32 %arg4) {
...
"ReverseBits$0_recursively_call_function":        ; preds = %"ReverseBits$0_increment_depth_counter"
  call void @"ReverseBits$0"(%2* %arg, i32 %shr.3, i32 %or.3, i32 %inc.3, i32 %arg4)
  ret void

"ReverseBits$0_return_from_recursive_function$0": ; preds = %"ReverseBits$0_latch$0"
  %i = getelementptr %2, %2* %arg, i32 0, i32 0
  store i32 %or.3, i32* %i, align 4
  ret void
}

define void @"ReverseBits$1"(%1* %arg, i32 %arg1, i32 %arg2, i32 %arg3, i32 %arg4) {
...
"ReverseBits$1_recursively_call_function":        ; preds = %"ReverseBits$1_increment_depth_counter"
  call void @"ReverseBits$1"(%1* %arg, i32 %shr.prol, i32 %or.prol, i32 %prol.iter.sub, i32 %inc.prol)
  ret void

"ReverseBits$1_return_from_recursive_function$0": ; preds = %"ReverseBits$1_latch$0"
  %i = getelementptr %1, %1* %arg, i32 0, i32 0
  store i32 %or.prol, i32* %i, align 4
  %i5 = getelementptr %1, %1* %arg, i32 0, i32 1
  store i32 %inc.prol, i32* %i5, align 4
  %i6 = getelementptr %1, %1* %arg, i32 0, i32 2
