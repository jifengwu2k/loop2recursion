; ModuleID = './benchmark_intermediate_representations/unoptimized_loop2recursion/bitcnts/bitstrng.ll.temp'
...
"bitstring$0_call_recursive_function":            ; preds = %"bitstring$0_initialize_context"
  call void @"bitstring$0"(%0* %i6, i8* %str.addr.0.lcssa, i64 %i5, i64 %byze)
...
while.end:                                        ; preds = %while.end.loopexit, %while.cond.preheader
  %str.addr.1.lcssa = phi i8* [ %str.addr.0.lcssa, %while.cond.preheader ], [ %i8, %while.end.loopexit ]
...
define void @"bitstring$0"(%0* %arg, i8* %arg1, i64 %arg2, i64 %arg3) {
"bitstring$0_header":
...
"bitstring$0_recursively_call_function":          ; preds = %"bitstring$0_increment_depth_counter"
  call void @"bitstring$0"(%0* %arg, i8* %str.addr.1.be, i64 %indvars.iv.next, i64 %arg3)
  ret void

"bitstring$0_return_from_recursive_function$0":   ; preds = %"bitstring$0_latch$0"
  %i4 = getelementptr %0, %0* %arg, i32 0, i32 0
  store i8* %str.addr.1.be, i8** %i4, align 8
  ret void
}
