; ModuleID = './benchmark_intermediate_representations/unoptimized_loop2recursion/bitcnts/bitcnts.ll.temp'
...
"main$0_call_recursive_function":                 ; preds = %"main$0_initialize_context"
  call void @"main$0"(%0* %i3, double 0.000000e+00, i32 undef, i64 0, i32 undef, double 0x7FEFFFFFFFFFFFFF, i64 %conv7, i1 %cmp861)
...
for.end30:                                        ; preds = %"main$0_extract_return_values$0"
  %idxprom31 = sext i32 %i5 to i64
  %arrayidx32 = getelementptr inbounds [7 x i8*], [7 x i8*]* @main.text, i64 0, i64 %idxprom31
  %i8 = load i8*, i8** %arrayidx32, align 8, !tbaa !1
  %call33 = tail call i32 (i8*, ...) @printf(i8* nonnull getelementptr inbounds ([13 x i8], [13 x i8]* @.str.10, i64 0, i64 0), i8* %i8)
  %idxprom34 = sext i32 %i7 to i64
  %arrayidx35 = getelementptr inbounds [7 x i8*], [7 x i8*]* @main.text, i64 0, i64 %idxprom34
  %i9 = load i8*, i8** %arrayidx35, align 8, !tbaa !1
  %call36 = tail call i32 (i8*, ...) @printf(i8* nonnull getelementptr inbounds ([12 x i8], [12 x i8]* @.str.11, i64 0, i64 0), i8* %i9)
  ret i32 0
}
...
"bit_shifter$0_call_recursive_function":          ; preds = %"bit_shifter$0_initialize_context"
  call void @"bit_shifter$0"(%1* %i, i64 %x, i32 0, i32 0)
...
"bit_shifter$0_extract_return_values$0":          ; preds = %"bit_shifter$0_call_recursive_function"
  %i1 = getelementptr %1, %1* %i, i32 0, i32 0
...
for.end:                                          ; preds = %for.end.loopexit, %entry
  %n.0.lcssa = phi i32 [ 0, %entry ], [ %i2, %for.end.loopexit ]
  ret i32 %n.0.lcssa
}
...
define void @"main$0"(%0* %arg, double %arg1, i32 %arg2, i64 %arg3, i32 %arg4, double %arg5, i64 %arg6, i1 %arg7) {
"main$0_header":
...
"main$0_latch$0":                                 ; preds = %for.end.loopexit, %"main$0_header"
  %n.0.lcssa = phi i64 [ 0, %"main$0_header" ], [ %i10, %for.end.loopexit ]
  ...
  %i11 = trunc i64 %arg3 to i32
  %cminix.1 = select i1 %cmp17, i32 %i11, i32 %arg4
  %cmin.1 = select i1 %cmp17, double %div, double %arg5
  %cmp21 = fcmp ogt double %div, %arg1
  %cmax.1 = select i1 %cmp21, double %div, double %arg1
  %cmaxix.1 = select i1 %cmp21, i32 %i11, i32 %arg2
  %arrayidx26 = getelementptr inbounds [7 x i8*], [7 x i8*]* @main.text, i64 0, i64 %arg3
  %i12 = load i8*, i8** %arrayidx26, align 8, !tbaa !1
  %call27 = tail call i32 (i8*, ...) @printf(i8* nonnull getelementptr inbounds ([36 x i8], [36 x i8]* @.str.9, i64 0, i64 0), i8* %i12, double %div, i64 %n.0.lcssa)
...
"main$0_recursively_call_function":               ; preds = %"main$0_increment_depth_counter"
  call void @"main$0"(%0* %arg, double %cmax.1, i32 %cmaxix.1, i64 %indvars.iv.next, i32 %cminix.1, double %cmin.1, i64 %arg6, i1 %arg7)
  ret void

"main$0_return_from_recursive_function$0":        ; preds = %"main$0_latch$0"
  %i13 = getelementptr %0, %0* %arg, i32 0, i32 0
  store i32 %cminix.1, i32* %i13, align 4
  %i14 = getelementptr %0, %0* %arg, i32 0, i32 1
  store i32 %cmaxix.1, i32* %i14, align 4
  ret void
}

define void @"bit_shifter$0"(%1* %arg, i64 %arg1, i32 %arg2, i32 %arg3) {
...
"bit_shifter$0_recursively_call_function":        ; preds = %"bit_shifter$0_increment_depth_counter"
  call void @"bit_shifter$0"(%1* %arg, i64 %shr, i32 %add, i32 %inc)
  ret void

"bit_shifter$0_return_from_recursive_function$0": ; preds = %"bit_shifter$0_latch$0"
  %i = getelementptr %1, %1* %arg, i32 0, i32 0
  store i32 %add, i32* %i, align 4
  ret void
}

define void @"main$0$0"(%2* %arg, i64 %arg1, i64 %arg2, i64 %arg3, i64 %arg4, i32 (i64)* %arg5) {
"main$0$0_latch$0":
...
"main$0$0_recursively_call_function":             ; preds = %"main$0$0_increment_depth_counter"
  call void @"main$0$0"(%2* %arg, i64 %inc, i64 %add14, i64 %add, i64 %arg4, i32 (i64)* %arg5)
  ret void

"main$0$0_return_from_recursive_function$0":      ; preds = %"main$0$0_latch$0"
  %i = getelementptr %2, %2* %arg, i32 0, i32 0
