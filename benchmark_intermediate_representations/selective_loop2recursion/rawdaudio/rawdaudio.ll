; ModuleID = './benchmark_intermediate_representations/baseline/rawdaudio/rawdaudio.ll'
...
"main$0_call_recursive_function":                 ; preds = %"main$0_extract_next_values", %"main$0_initialize_context"
  %0 = phi i32 [ %call11, %"main$0_initialize_context" ], [ %4, %"main$0_extract_next_values" ]
  call void @"main$0"(i32 %0, i8 0)
  %1 = getelementptr %1, %1* @"main$0_recursion_state_struct", i32 0, i32 1
  %2 = load i1, i1* %1, align 1
  br i1 %2, label %"main$0_branch_to_exit", label %"main$0_extract_next_values"

"main$0_extract_next_values":                     ; preds = %"main$0_call_recursive_function"
  %3 = getelementptr %1, %1* @"main$0_recursion_state_struct", i32 0, i32 0
  %4 = load i32, i32* %3, align 4
  br label %"main$0_call_recursive_function"

"main$0_branch_to_exit":                          ; preds = %"main$0_call_recursive_function"
  %5 = getelementptr %0, %0* @"main$0_return_value_struct", i32 0, i32 0
  %6 = load i8, i8* %5, align 1
  switch i8 %6, label %if.then.loopexit [
...
while.end:                                        ; preds = %"main$0_branch_to_exit"
  ...
  %8 = load i16, i16* getelementptr inbounds (%struct.adpcm_state, %struct.adpcm_state* @state, i64 0, i32 0), align 2, !tbaa !5
  %conv = sext i16 %8 to i32
  %9 = load i8, i8* getelementptr inbounds (%struct.adpcm_state, %struct.adpcm_state* @state, i64 0, i32 1), align 2, !tbaa !8
  %conv6 = sext i8 %9 to i32
  %call7 = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %7, i8* nonnull getelementptr inbounds ([28 x i8], [28 x i8]* @.str.1, i64 0, i64 0), i32 %conv, i32 %conv6) #5
...
"main$0_recursively_call_function":               ; preds = %"main$0_increment_depth_counter"
  call void @"main$0"(i32 %call, i8 %2)
  ret void

"main$0_save_recursive_state_and_return":         ; preds = %"main$0_increment_depth_counter"
  %4 = getelementptr %1, %1* @"main$0_recursion_state_struct", i32 0, i32 0
  store i32 %call, i32* %4, align 4
  %5 = getelementptr %1, %1* @"main$0_recursion_state_struct", i32 0, i32 1
  store i1 false, i1* %5, align 1
  ret void

"main$0_return_from_recursive_function$0":        ; preds = %"main$0_latch$0"
  %6 = getelementptr %0, %0* @"main$0_return_value_struct", i32 0, i32 0
  store i8 1, i8* %6, align 1
  %7 = getelementptr %1, %1* @"main$0_recursion_state_struct", i32 0, i32 1
  store i1 true, i1* %7, align 1
  ret void

"main$0_return_from_recursive_function$1":        ; preds = %"main$0_exiting$1"
  %8 = getelementptr %0, %0* @"main$0_return_value_struct", i32 0, i32 0
  store i8 0, i8* %8, align 1
  %9 = getelementptr %1, %1* @"main$0_recursion_state_struct", i32 0, i32 1
