...
"main$3_initialize_context":                      ; preds = %for.body.preheader
  ...
  store float* %7, float** @"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$1", align 8
  store float* %8, float** @"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$2", align 8
...
"main$3_call_recursive_function":                 ; preds = %"main$3_extract_next_values", %"main$3_initialize_context"
  %9 = phi i64 [ 0, %"main$3_initialize_context" ], [ %13, %"main$3_extract_next_values" ]
  call void @"main$3"(i64 %9, i8 0)
  %10 = getelementptr %0, %0* @"main$3_recursion_state_struct", i32 0, i32 1
  %11 = load i1, i1* %10, align 1
  br i1 %11, label %for.cond38.preheader.loopexit, label %"main$3_extract_next_values"

"main$3_extract_next_values":                     ; preds = %"main$3_call_recursive_function"
  %12 = getelementptr %0, %0* @"main$3_recursion_state_struct", i32 0, i32 0
...
"main$2_initialize_context":                      ; preds = %for.body41.preheader
  ...
  store float* %3, float** @"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$5", align 8
  store float* %4, float** @"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$6", align 8
  store float* %7, float** @"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$1", align 8
  store float* %8, float** @"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$2", align 8
  store i32 %conv.i171, i32* @"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$0", align 4
...
"main$2_call_recursive_function":                 ; preds = %"main$2_extract_next_values", %"main$2_initialize_context"
  %14 = phi i64 [ 0, %"main$2_initialize_context" ], [ %18, %"main$2_extract_next_values" ]
  call void @"main$2"(i64 %14, i8 0)
  %15 = getelementptr %1, %1* @"main$2_recursion_state_struct", i32 0, i32 1
  %16 = load i1, i1* %15, align 1
  br i1 %16, label %for.end90, label %"main$2_extract_next_values"

"main$2_extract_next_values":                     ; preds = %"main$2_call_recursive_function"
  %17 = getelementptr %1, %1* @"main$2_recursion_state_struct", i32 0, i32 0
...
"main$1_initialize_context":                      ; preds = %for.body96.preheader
  store i32 %conv.i, i32* @"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$3", align 4
  store float* %5, float** @"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$7", align 8
...
"main$1_call_recursive_function":                 ; preds = %"main$1_extract_next_values", %"main$1_initialize_context"
  %19 = phi i64 [ 0, %"main$1_initialize_context" ], [ %23, %"main$1_extract_next_values" ]
  call void @"main$1"(i64 %19, i8 0)
  %20 = getelementptr %2, %2* @"main$1_recursion_state_struct", i32 0, i32 1
  %21 = load i1, i1* %20, align 1
  br i1 %21, label %for.end103.loopexit, label %"main$1_extract_next_values"

"main$1_extract_next_values":                     ; preds = %"main$1_call_recursive_function"
  %22 = getelementptr %2, %2* @"main$1_recursion_state_struct", i32 0, i32 0
...
"main$0_initialize_context":                      ; preds = %for.body109.preheader
  store i32 %conv.i, i32* @"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$3", align 4
  store float* %6, float** @"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$8", align 8
...
"main$0_call_recursive_function":                 ; preds = %"main$0_extract_next_values", %"main$0_initialize_context"
  %24 = phi i64 [ 0, %"main$0_initialize_context" ], [ %28, %"main$0_extract_next_values" ]
  call void @"main$0"(i64 %24, i8 0)
  %25 = getelementptr %3, %3* @"main$0_recursion_state_struct", i32 0, i32 1
  %26 = load i1, i1* %25, align 1
  br i1 %26, label %for.end116.loopexit, label %"main$0_extract_next_values"

"main$0_extract_next_values":                     ; preds = %"main$0_call_recursive_function"
  %27 = getelementptr %3, %3* @"main$0_recursion_state_struct", i32 0, i32 0
...
define void @"main$3"(i64 %0, i8 %1) {
"main$3_latch$0":
  %call30 = tail call i32 @rand() #5
  %rem = srem i32 %call30, 1000
  %conv31 = sitofp i32 %rem to float
  %2 = load float*, float** @"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$1", align 8
  ...
  %3 = load float*, float** @"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$2", align 8
  ...
  %4 = load i32, i32* @"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$0", align 4
...
"main$3_increment_depth_counter":                 ; preds = %"main$3_latch$0"
  %5 = add i8 %1, 1
  %6 = icmp ult i8 %5, 64
  br i1 %6, label %"main$3_recursively_call_function", label %"main$3_save_recursive_state_and_return"

"main$3_recursively_call_function":               ; preds = %"main$3_increment_depth_counter"
  call void @"main$3"(i64 %indvars.iv.next195, i8 %5)
  ret void

"main$3_save_recursive_state_and_return":         ; preds = %"main$3_increment_depth_counter"
  %7 = getelementptr %0, %0* @"main$3_recursion_state_struct", i32 0, i32 0
  store i64 %indvars.iv.next195, i64* %7, align 8
  %8 = getelementptr %0, %0* @"main$3_recursion_state_struct", i32 0, i32 1
  store i1 false, i1* %8, align 1
  ret void

"main$3_return_from_recursive_function$0":        ; preds = %"main$3_latch$0"
  %9 = getelementptr %0, %0* @"main$3_recursion_state_struct", i32 0, i32 1
...
"main$2_header":
  %2 = load float*, float** @"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$5", align 8
  %arrayidx43 = getelementptr inbounds float, float* %2, i64 %0
  store float 0.000000e+00, float* %arrayidx43, align 4, !tbaa !5
  %3 = load i1, i1* @"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$4", align 1
  br i1 %3, label %"main$2_latch$0", label %for.body47.lr.ph

for.body47.lr.ph:                                 ; preds = %"main$2_header"
  %4 = trunc i64 %0 to i32
  %conv57 = uitofp i32 %4 to float
  %5 = load float*, float** @"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$6", align 8
  %arrayidx84 = getelementptr inbounds float, float* %5, i64 %0
  br label %for.body47
...
for.body47:                                       ; preds = %if.end82, %for.body47.lr.ph
  ...
  %6 = load float*, float** @"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$1", align 8
  %arrayidx53 = getelementptr inbounds float, float* %6, i64 %indvars.iv186
  %7 = load float, float* %arrayidx53, align 4, !tbaa !5
  %conv54 = fpext float %7 to double
  %8 = load float*, float** @"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$2", align 8
  %arrayidx56 = getelementptr inbounds float, float* %8, i64 %indvars.iv186
  %9 = load float, float* %arrayidx56, align 4, !tbaa !5
  %mul58 = fmul float %conv57, %9
...
if.then51:                                        ; preds = %for.body47
  ...
  %conv64 = fpext float %10 to double
...
if.else66:                                        ; preds = %for.body47
  ...
  %conv79 = fpext float %11 to double
...
if.end82:                                         ; preds = %if.else66, %if.then51
  ...
  %12 = load i32, i32* @"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$0", align 4
  %exitcond189 = icmp eq i32 %lftr.wideiv188, %12
...
"main$2_latch$0":                                 ; preds = %for.inc88.loopexit, %"main$2_header"
  ...
  %13 = load i32, i32* @"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$3", align 4
  %exitcond193 = icmp eq i32 %lftr.wideiv192, %13
...
"main$2_increment_depth_counter":                 ; preds = %"main$2_latch$0"
  ...
  br i1 %15, label %"main$2_recursively_call_function", label %"main$2_save_recursive_state_and_return"

"main$2_recursively_call_function":               ; preds = %"main$2_increment_depth_counter"
  call void @"main$2"(i64 %indvars.iv.next191, i8 %14)
  ret void

"main$2_save_recursive_state_and_return":         ; preds = %"main$2_increment_depth_counter"
  %16 = getelementptr %1, %1* @"main$2_recursion_state_struct", i32 0, i32 0
  store i64 %indvars.iv.next191, i64* %16, align 8
  %17 = getelementptr %1, %1* @"main$2_recursion_state_struct", i32 0, i32 1
  store i1 false, i1* %17, align 1
  ret void

"main$2_return_from_recursive_function$0":        ; preds = %"main$2_latch$0"
  %18 = getelementptr %1, %1* @"main$2_recursion_state_struct", i32 0, i32 1
...
"main$1_latch$0":
  %2 = load float*, float** @"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$7", align 8
  %arrayidx98 = getelementptr inbounds float, float* %2, i64 %0
  %3 = load float, float* %arrayidx98, align 4, !tbaa !5
  %conv99 = fpext float %3 to double
  ...
  %4 = load i32, i32* @"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$3", align 4
  %exitcond185 = icmp eq i32 %lftr.wideiv184, %4
...
"main$1_increment_depth_counter":                 ; preds = %"main$1_latch$0"
  %5 = add i8 %1, 1
  %6 = icmp ult i8 %5, 64
  br i1 %6, label %"main$1_recursively_call_function", label %"main$1_save_recursive_state_and_return"

"main$1_recursively_call_function":               ; preds = %"main$1_increment_depth_counter"
  call void @"main$1"(i64 %indvars.iv.next183, i8 %5)
  ret void

"main$1_save_recursive_state_and_return":         ; preds = %"main$1_increment_depth_counter"
  %7 = getelementptr %2, %2* @"main$1_recursion_state_struct", i32 0, i32 0
  store i64 %indvars.iv.next183, i64* %7, align 8
  %8 = getelementptr %2, %2* @"main$1_recursion_state_struct", i32 0, i32 1
  store i1 false, i1* %8, align 1
  ret void
...
"main$0_latch$0":
  %2 = load float*, float** @"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$8", align 8
  %arrayidx111 = getelementptr inbounds float, float* %2, i64 %0
  %3 = load float, float* %arrayidx111, align 4, !tbaa !5
  %conv112 = fpext float %3 to double
...
"main$0_recursively_call_function":               ; preds = %"main$0_increment_depth_counter"
  call void @"main$0"(i64 %indvars.iv.next, i8 %5)
  ret void
...
"main$0_save_recursive_state_and_return":         ; preds = %"main$0_increment_depth_counter"
  ...
  store i64 %indvars.iv.next, i64* %7, align 8
  %8 = getelementptr %3, %3* @"main$0_recursion_state_struct", i32 0, i32 1
  store i1 false, i1* %8, align 1
  ret void
