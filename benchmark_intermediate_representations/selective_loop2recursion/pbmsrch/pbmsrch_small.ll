; ModuleID = './benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll'
...
@"strsearch$0_return_value_struct" = dso_local global %0 zeroinitializer
@"strsearch$0_recursion_state_struct" = dso_local global %1 zeroinitializer
@"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$0" = dso_local global i8* null
@"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$1" = dso_local global i64 0
...
"strsearch$0_initialize_context":                 ; preds = %while.cond1.preheader.lr.ph
  store i8* %1, i8** @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$0", align 8
  store i64 %0, i64* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$1", align 8
  store i64 %call, i64* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$2", align 8
  store i8* %string, i8** @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$3", align 8
...
"strsearch$0_call_recursive_function":            ; preds = %"strsearch$0_extract_next_values", %"strsearch$0_initialize_context"
  %2 = phi i64 [ %sub, %"strsearch$0_initialize_context" ], [ %7, %"strsearch$0_extract_next_values" ]
  %3 = phi i64 [ undef, %"strsearch$0_initialize_context" ], [ %9, %"strsearch$0_extract_next_values" ]
  call void @"strsearch$0"(i64 %2, i64 %3, i8 0)
  %4 = getelementptr %1, %1* @"strsearch$0_recursion_state_struct", i32 0, i32 2
  %5 = load i1, i1* %4, align 1
  br i1 %5, label %"strsearch$0_extract_return_values$0", label %"strsearch$0_extract_next_values"

"strsearch$0_extract_next_values":                ; preds = %"strsearch$0_call_recursive_function"
  %6 = getelementptr %1, %1* @"strsearch$0_recursion_state_struct", i32 0, i32 0
  %7 = load i64, i64* %6, align 8
  %8 = getelementptr %1, %1* @"strsearch$0_recursion_state_struct", i32 0, i32 1
  %9 = load i64, i64* %8, align 8
  br label %"strsearch$0_call_recursive_function"

"strsearch$0_extract_return_values$0":            ; preds = %"strsearch$0_call_recursive_function"
  %10 = getelementptr %0, %0* @"strsearch$0_return_value_struct", i32 0, i32 0
...
cleanup:                                          ; preds = %cleanup.loopexit, %entry
  %retval.0 = phi i8* [ null, %entry ], [ %11, %cleanup.loopexit ]
  ret i8* %retval.0
}
...
"main$0_call_recursive_function":                 ; preds = %"main$0_extract_next_values", %"main$0_initialize_context"
  %0 = phi i64 [ 0, %"main$0_initialize_context" ], [ %4, %"main$0_extract_next_values" ]
  call void @"main$0"(i64 %0, i8 0)
  %1 = getelementptr %2, %2* @"main$0_recursion_state_struct", i32 0, i32 1
  %2 = load i1, i1* %1, align 1
  br i1 %2, label %for.end, label %"main$0_extract_next_values"

"main$0_extract_next_values":                     ; preds = %"main$0_call_recursive_function"
  %3 = getelementptr %2, %2* @"main$0_recursion_state_struct", i32 0, i32 0
...
define void @"strsearch$0"(i64 %0, i64 %1, i8 %2) {
"strsearch$0_header":
  %3 = load i64, i64* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$2", align 8
  %cmp236 = icmp ult i64 %0, %3
...
land.end:                                         ; preds = %while.cond1, %land.end.preheader
  %pos.137 = phi i64 [ %add, %while.cond1 ], [ %0, %land.end.preheader ]
  %4 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$3", align 8
  %arrayidx = getelementptr inbounds i8, i8* %4, i64 %pos.137
  %5 = load i8, i8* %arrayidx, align 1, !tbaa !8
  %idxprom = zext i8 %5 to i64
  %arrayidx3 = getelementptr inbounds [256 x i64], [256 x i64]* @table, i64 0, i64 %idxprom
  %6 = load i64, i64* %arrayidx3, align 8, !tbaa !1
  %cmp4 = icmp eq i64 %6, 0
  %add = add i64 %6, %pos.137
  br i1 %cmp4, label %if.then.loopexit, label %while.cond1

while.cond1:                                      ; preds = %land.end
  %7 = load i64, i64* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$2", align 8
...
"strsearch$0_exiting$1":                          ; preds = %if.then.loopexit, %while.end
  %pos.134 = phi i64 [ %0, %while.end ], [ %pos.137.lcssa, %if.then.loopexit ]
  %sub7 = add i64 %pos.134, 1
  %8 = load i64, i64* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$1", align 8
  %add8 = sub i64 %sub7, %8
  %9 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$3", align 8
  %arrayidx9 = getelementptr inbounds i8, i8* %9, i64 %add8
  %10 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$0", align 8
  %11 = load i64, i64* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$1", align 8
  %call10 = tail call i32 @strncmp(i8* %10, i8* %arrayidx9, i64 %11) #4
  %cmp11 = icmp eq i32 %call10, 0
  br i1 %cmp11, label %"strsearch$0_return_from_recursive_function$0", label %"strsearch$0_latch$0"

"strsearch$0_latch$0":                            ; preds = %while.cond.backedge.loopexit, %"strsearch$0_exiting$1", %while.end
  %pos.0.be = phi i64 [ %0, %while.end ], [ %sub7, %"strsearch$0_exiting$1" ], [ %add.lcssa59, %while.cond.backedge.loopexit ]
  %shift.0.be = phi i64 [ %1, %while.end ], [ 0, %"strsearch$0_exiting$1" ], [ %.lcssa58, %while.cond.backedge.loopexit ]
  %12 = load i64, i64* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$2", align 8
  %cmp = icmp ult i64 %pos.0.be, %12
...
"strsearch$0_increment_depth_counter":            ; preds = %"strsearch$0_latch$0"
  ...
  br i1 %14, label %"strsearch$0_recursively_call_function", label %"strsearch$0_save_recursive_state_and_return"

"strsearch$0_recursively_call_function":          ; preds = %"strsearch$0_increment_depth_counter"
  call void @"strsearch$0"(i64 %pos.0.be, i64 %shift.0.be, i8 %13)
  ret void

"strsearch$0_save_recursive_state_and_return":    ; preds = %"strsearch$0_increment_depth_counter"
  %15 = getelementptr %1, %1* @"strsearch$0_recursion_state_struct", i32 0, i32 0
  store i64 %pos.0.be, i64* %15, align 8
  %16 = getelementptr %1, %1* @"strsearch$0_recursion_state_struct", i32 0, i32 1
  store i64 %shift.0.be, i64* %16, align 8
  %17 = getelementptr %1, %1* @"strsearch$0_recursion_state_struct", i32 0, i32 2
  store i1 false, i1* %17, align 1
  ret void

"strsearch$0_return_from_recursive_function$0":   ; preds = %"strsearch$0_exiting$1", %"strsearch$0_latch$0"
  %18 = phi i8* [ null, %"strsearch$0_latch$0" ], [ %arrayidx9, %"strsearch$0_exiting$1" ]
  %19 = getelementptr %0, %0* @"strsearch$0_return_value_struct", i32 0, i32 0
  store i8* %18, i8** %19, align 8
  %20 = getelementptr %1, %1* @"strsearch$0_recursion_state_struct", i32 0, i32 2
...
"main$0_header":
  %arrayidx = getelementptr inbounds [58 x i8*], [58 x i8*]* @main.find_strings, i64 0, i64 %0
  %2 = load i8*, i8** %arrayidx, align 8, !tbaa !11
  %call.i = tail call i64 @strlen(i8* %2) #4
...
vector.body:                                      ; preds = %vector.body, %"main$0_header"
  %index = phi i64 [ 0, %"main$0_header" ], [ %index.next.7, %vector.body ]
  %3 = getelementptr inbounds [256 x i64], [256 x i64]* @table, i64 0, i64 %index
  %4 = bitcast i64* %3 to <2 x i64>*
  store <2 x i64> %broadcast.splat48, <2 x i64>* %4, align 16, !tbaa !1
  %5 = getelementptr i64, i64* %3, i64 2
  %6 = bitcast i64* %5 to <2 x i64>*
  store <2 x i64> %broadcast.splat48, <2 x i64>* %6, align 16, !tbaa !1
  %index.next = or i64 %index, 4
  %7 = getelementptr inbounds [256 x i64], [256 x i64]* @table, i64 0, i64 %index.next
  ...
  %index.next.1 = or i64 %index, 8
  %11 = getelementptr inbounds [256 x i64], [256 x i64]* @table, i64 0, i64 %index.next.1
  ...
  %index.next.2 = or i64 %index, 12
  %15 = getelementptr inbounds [256 x i64], [256 x i64]* @table, i64 0, i64 %index.next.2
  ...
  %index.next.3 = or i64 %index, 16
  %19 = getelementptr inbounds [256 x i64], [256 x i64]* @table, i64 0, i64 %index.next.3
  ...
  %index.next.4 = or i64 %index, 20
  %23 = getelementptr inbounds [256 x i64], [256 x i64]* @table, i64 0, i64 %index.next.4
  ...
  %index.next.5 = or i64 %index, 24
  %27 = getelementptr inbounds [256 x i64], [256 x i64]* @table, i64 0, i64 %index.next.5
  ...
  %index.next.6 = or i64 %index, 28
  %31 = getelementptr inbounds [256 x i64], [256 x i64]* @table, i64 0, i64 %index.next.6
  %32 = bitcast i64* %31 to <2 x i64>*
  store <2 x i64> %broadcast.splat48, <2 x i64>* %32, align 16, !tbaa !1
  %33 = getelementptr i64, i64* %31, i64 2
  %34 = bitcast i64* %33 to <2 x i64>*
  store <2 x i64> %broadcast.splat48, <2 x i64>* %34, align 16, !tbaa !1
  %index.next.7 = add nsw i64 %index, 32
  %35 = icmp eq i64 %index.next.7, 256
  br i1 %35, label %for.cond1.preheader.i, label %vector.body, !llvm.loop !13
...
for.body3.i.prol:                                 ; preds = %for.body3.i.prol, %for.body3.i.prol.preheader
  ...
  %arrayidx5.i.prol = getelementptr inbounds i8, i8* %2, i64 %i.120.i.prol
  %37 = load i8, i8* %arrayidx5.i.prol, align 1, !tbaa !8
  %idxprom.i.prol = zext i8 %37 to i64
...
for.body3.i.preheader.split:                      ; preds = %for.body3.i.preheader.split.loopexit, %for.body3.i.preheader
  ...
  br i1 %38, label %init_search.exit.loopexit, label %for.body3.i.preheader.split.split
...
for.body3.i:                                      ; preds = %for.body3.i, %for.body3.i.preheader.split.split
  ...
  %arrayidx5.i = getelementptr inbounds i8, i8* %2, i64 %i.120.i
  %39 = load i8, i8* %arrayidx5.i, align 1, !tbaa !8
  ...
  %arrayidx5.i.1 = getelementptr inbounds i8, i8* %2, i64 %inc8.i
  %40 = load i8, i8* %arrayidx5.i.1, align 1, !tbaa !8
  %idxprom.i.1 = zext i8 %40 to i64
  ...
  %arrayidx5.i.2 = getelementptr inbounds i8, i8* %2, i64 %inc8.i.1
  %41 = load i8, i8* %arrayidx5.i.2, align 1, !tbaa !8
  %idxprom.i.2 = zext i8 %41 to i64
  ...
  %arrayidx5.i.3 = getelementptr inbounds i8, i8* %2, i64 %inc8.i.2
  %42 = load i8, i8* %arrayidx5.i.3, align 1, !tbaa !8
  %idxprom.i.3 = zext i8 %42 to i64
...
init_search.exit:                                 ; preds = %init_search.exit.loopexit, %for.cond1.preheader.i
  store i8* %2, i8** @findme, align 8, !tbaa !11
  %arrayidx4 = getelementptr inbounds [57 x i8*], [57 x i8*]* @main.search_strings, i64 0, i64 %0
  %43 = load i8*, i8** %arrayidx4, align 8, !tbaa !11
  %sub.i23 = add i64 %call.i, -1
  %call.i24 = tail call i64 @strlen(i8* %43) #4
...
while.cond1.preheader.i:                          ; preds = %while.cond.backedge.i, %while.cond1.preheader.i.preheader
...
land.end.i:                                       ; preds = %while.cond1.i, %land.end.i.preheader
  %pos.137.i = phi i64 [ %add.i, %while.cond1.i ], [ %pos.040.i, %land.end.i.preheader ]
  %arrayidx.i26 = getelementptr inbounds i8, i8* %43, i64 %pos.137.i
  %44 = load i8, i8* %arrayidx.i26, align 1, !tbaa !8
  %idxprom.i27 = zext i8 %44 to i64
  %arrayidx3.i = getelementptr inbounds [256 x i64], [256 x i64]* @table, i64 0, i64 %idxprom.i27
  %45 = load i64, i64* %arrayidx3.i, align 8, !tbaa !1
  %cmp4.i = icmp eq i64 %45, 0
  %add.i = add i64 %45, %pos.137.i
...
while.cond.backedge.i.loopexit:                   ; preds = %while.cond1.i
  ...
  %.lcssa53 = phi i64 [ %45, %while.cond1.i ]
...
if.then.i:                                        ; preds = %if.then.i.loopexit, %while.end.i
  ...
  %arrayidx9.i = getelementptr inbounds i8, i8* %43, i64 %add8.i
  %call10.i = tail call i32 @strncmp(i8* %2, i8* %arrayidx9.i, i64 %call.i) #4
...
strsearch.exit.thread:                            ; preds = %strsearch.exit.thread.loopexit, %init_search.exit
  %call1031 = tail call i32 (i8*, ...) @printf(i8* nonnull getelementptr inbounds ([18 x i8], [18 x i8]* @.str.104, i64 0, i64 0), i8* %2, i8* nonnull getelementptr inbounds ([5 x i8], [5 x i8]* @.str.106, i64 0, i64 0), i8* %43)
...
strsearch.exit:                                   ; preds = %if.then.i
  ...
  %call10 = tail call i32 (i8*, ...) @printf(i8* nonnull getelementptr inbounds ([18 x i8], [18 x i8]* @.str.104, i64 0, i64 0), i8* %2, i8* %cond, i8* %43)
...
"main$0_latch$0":                                 ; preds = %if.then, %strsearch.exit, %strsearch.exit.thread
  ...
  %call.i28 = tail call i32 @_IO_putc(i32 10, %struct._IO_FILE* %46) #5
...
"main$0_increment_depth_counter":                 ; preds = %"main$0_latch$0"
  ...
  br i1 %48, label %"main$0_recursively_call_function", label %"main$0_save_recursive_state_and_return"

"main$0_recursively_call_function":               ; preds = %"main$0_increment_depth_counter"
  call void @"main$0"(i64 %indvars.iv.next, i8 %47)
  ret void

"main$0_save_recursive_state_and_return":         ; preds = %"main$0_increment_depth_counter"
  %49 = getelementptr %2, %2* @"main$0_recursion_state_struct", i32 0, i32 0
  store i64 %indvars.iv.next, i64* %49, align 8
  %50 = getelementptr %2, %2* @"main$0_recursion_state_struct", i32 0, i32 1
  store i1 false, i1* %50, align 1
  ret void

"main$0_return_from_recursive_function$0":        ; preds = %"main$0_latch$0"
  %51 = getelementptr %2, %2* @"main$0_recursion_state_struct", i32 0, i32 1
