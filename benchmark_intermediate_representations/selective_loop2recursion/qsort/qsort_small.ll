; ModuleID = './benchmark_intermediate_representations/baseline/qsort/qsort_small.ll'
...
entry:
  ...
  call void @llvm.lifetime.start.p0i8(i64 7680000, i8* %0) #6
...
"main$1_call_recursive_function":                 ; preds = %"main$1_extract_next_values", %"main$1_initialize_context"
  %4 = phi i64 [ 0, %"main$1_initialize_context" ], [ %8, %"main$1_extract_next_values" ]
  call void @"main$1"(i64 %4, i8 0)
  %5 = getelementptr %1, %1* @"main$1_recursion_state_struct", i32 0, i32 1
  %6 = load i1, i1* %5, align 1
  br i1 %6, label %"main$1_extract_return_values$0", label %"main$1_extract_next_values"

"main$1_extract_next_values":                     ; preds = %"main$1_call_recursive_function"
  %7 = getelementptr %1, %1* @"main$1_recursion_state_struct", i32 0, i32 0
  %8 = load i64, i64* %7, align 8
  br label %"main$1_call_recursive_function"

"main$1_extract_return_values$0":                 ; preds = %"main$1_call_recursive_function"
  %9 = getelementptr %0, %0* @"main$1_return_value_struct", i32 0, i32 0
  %10 = load i64, i64* %9, align 8
  br label %if.end

if.end:                                           ; preds = %"main$1_extract_return_values$0"
  %11 = trunc i64 %10 to i32
  %call6 = call i32 (i8*, ...) @printf(i8* nonnull getelementptr inbounds ([24 x i8], [24 x i8]* @.str.3, i64 0, i64 0), i32 %11)
  call void @qsort(i8* %0, i64 %10, i64 128, i32 (i8*, i8*)* nonnull @compare) #6
  %cmp724 = icmp sgt i32 %11, 0
...
"main$0_initialize_context":                      ; preds = %for.body.preheader
  store i32 %11, i32* @"./benchmark_intermediate_representations/baseline/qsort/qsort_small.ll_invariant_variable$2", align 4
  store [60000 x %struct.myStringStruct]* %array, [60000 x %struct.myStringStruct]** @"./benchmark_intermediate_representations/baseline/qsort/qsort_small.ll_invariant_variable$1", align 8
...
"main$0_call_recursive_function":                 ; preds = %"main$0_extract_next_values", %"main$0_initialize_context"
  %12 = phi i64 [ 0, %"main$0_initialize_context" ], [ %16, %"main$0_extract_next_values" ]
  call void @"main$0"(i64 %12, i8 0)
  %13 = getelementptr %2, %2* @"main$0_recursion_state_struct", i32 0, i32 1
  %14 = load i1, i1* %13, align 1
  br i1 %14, label %for.end.loopexit, label %"main$0_extract_next_values"

"main$0_extract_next_values":                     ; preds = %"main$0_call_recursive_function"
  %15 = getelementptr %2, %2* @"main$0_recursion_state_struct", i32 0, i32 0
...
for.end:                                          ; preds = %for.end.loopexit, %if.end
  call void @llvm.lifetime.end.p0i8(i64 7680000, i8* %0) #6
  ret i32 0
}
...
"main$1_latch$0":
  %2 = load [60000 x %struct.myStringStruct]*, [60000 x %struct.myStringStruct]** @"./benchmark_intermediate_representations/baseline/qsort/qsort_small.ll_invariant_variable$1", align 8
  %qstring = getelementptr inbounds [60000 x %struct.myStringStruct], [60000 x %struct.myStringStruct]* %2, i64 0, i64 %0, i32 0
  %3 = load %struct._IO_FILE*, %struct._IO_FILE** @"./benchmark_intermediate_representations/baseline/qsort/qsort_small.ll_invariant_variable$0", align 8
  %call3 = call i32 (%struct._IO_FILE*, i8*, ...) @__isoc99_fscanf(%struct._IO_FILE* %3, i8* nonnull getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), [128 x i8]* %qstring) #6
  %cmp4 = icmp eq i32 %call3, 1
  %cmp5 = icmp slt i64 %0, 60000
  %4 = and i1 %cmp5, %cmp4
  %indvars.iv.next27 = add nuw nsw i64 %0, 1
  br i1 %4, label %"main$1_increment_depth_counter", label %"main$1_return_from_recursive_function$0"
...
"main$1_recursively_call_function":               ; preds = %"main$1_increment_depth_counter"
  call void @"main$1"(i64 %indvars.iv.next27, i8 %5)
  ret void

"main$1_save_recursive_state_and_return":         ; preds = %"main$1_increment_depth_counter"
  %7 = getelementptr %1, %1* @"main$1_recursion_state_struct", i32 0, i32 0
  store i64 %indvars.iv.next27, i64* %7, align 8
  %8 = getelementptr %1, %1* @"main$1_recursion_state_struct", i32 0, i32 1
...
"main$1_return_from_recursive_function$0":        ; preds = %"main$1_latch$0"
  ...
  %10 = getelementptr %1, %1* @"main$1_recursion_state_struct", i32 0, i32 1
...
"main$0_latch$0":
  %2 = load [60000 x %struct.myStringStruct]*, [60000 x %struct.myStringStruct]** @"./benchmark_intermediate_representations/baseline/qsort/qsort_small.ll_invariant_variable$1", align 8
  %arraydecay12 = getelementptr inbounds [60000 x %struct.myStringStruct], [60000 x %struct.myStringStruct]* %2, i64 0, i64 %0, i32 0, i64 0
  %puts = call i32 @puts(i8* %arraydecay12)
  %indvars.iv.next = add nuw nsw i64 %0, 1
  %lftr.wideiv = trunc i64 %indvars.iv.next to i32
  %3 = load i32, i32* @"./benchmark_intermediate_representations/baseline/qsort/qsort_small.ll_invariant_variable$2", align 4
...
"main$0_increment_depth_counter":                 ; preds = %"main$0_latch$0"
  %4 = add i8 %1, 1
  %5 = icmp ult i8 %4, 64
  br i1 %5, label %"main$0_recursively_call_function", label %"main$0_save_recursive_state_and_return"

"main$0_recursively_call_function":               ; preds = %"main$0_increment_depth_counter"
  call void @"main$0"(i64 %indvars.iv.next, i8 %4)
  ret void

"main$0_save_recursive_state_and_return":         ; preds = %"main$0_increment_depth_counter"
  %6 = getelementptr %2, %2* @"main$0_recursion_state_struct", i32 0, i32 0
  store i64 %indvars.iv.next, i64* %6, align 8
  %7 = getelementptr %2, %2* @"main$0_recursion_state_struct", i32 0, i32 1
  store i1 false, i1* %7, align 1
  ret void

"main$0_return_from_recursive_function$0":        ; preds = %"main$0_latch$0"
  %8 = getelementptr %2, %2* @"main$0_recursion_state_struct", i32 0, i32 1
