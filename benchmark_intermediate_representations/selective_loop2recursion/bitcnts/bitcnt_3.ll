; ModuleID = './benchmark_intermediate_representations/baseline/bitcnts/bitcnt_3.ll'
...
entry:
  ...
  %2 = load i8, i8* %arrayidx11, align 1, !tbaa !1
  ...
  %3 = load i8, i8* %arrayidx18, align 1, !tbaa !1
  ...
  %4 = load i8, i8* %arrayidx25, align 1, !tbaa !1
  %conv26 = sext i8 %4 to i32
  ...
  %5 = load i8, i8* %arrayidx32, align 1, !tbaa !1
  %conv33 = sext i8 %5 to i32
  ...
  %6 = load i8, i8* %arrayidx39, align 1, !tbaa !1
  ...
  %7 = load i8, i8* %arrayidx46, align 1, !tbaa !1
  %conv47 = sext i8 %7 to i32
...
entry:
  ...
  %0 = load i8, i8* %arrayidx1, align 1, !tbaa !1
  ...
  %2 = load i8, i8* %arrayidx10, align 1, !tbaa !1
  ...
  %3 = load i8, i8* %arrayidx16, align 1, !tbaa !1
...
entry:
  ...
  %1 = load i8, i8* %arrayidx3, align 1, !tbaa !1
  ...
  %3 = load i8, i8* %arrayidx11, align 1, !tbaa !1
