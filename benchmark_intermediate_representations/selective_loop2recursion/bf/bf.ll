...
@"main$0_recursion_state_struct" = dso_local global %0 zeroinitializer
@"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$0" = dso_local global [40 x i8]* null
@"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$1" = dso_local global [40 x i8]* null
@"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$2" = dso_local global i32 0
@"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$3" = dso_local global i8* null
@"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$4" = dso_local global %struct._IO_FILE* null
@"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$5" = dso_local global i8* null
@"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$6" = dso_local global %struct.bf_key_st* null
@"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$7" = dso_local global %struct._IO_FILE* null
@"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$8" = dso_local global i8* null
@"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$9" = dso_local global i32* null
...
land.rhs:                                         ; preds = %while.cond.backedge, %if.end21
...
while.end:                                        ; preds = %while.cond.backedge, %land.rhs
...
"main$0_initialize_context":                      ; preds = %while.cond84.preheader.preheader
  store [40 x i8]* %outdata, [40 x i8]** @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$0", align 8
  store [40 x i8]* %indata, [40 x i8]** @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$1", align 8
  store i32 %encordec.0, i32* @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$2", align 4
  store i8* %2, i8** @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$3", align 8
  store %struct._IO_FILE* %call67, %struct._IO_FILE** @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$4", align 8
  store i8* %3, i8** @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$5", align 8
  store %struct.bf_key_st* %key, %struct.bf_key_st** @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$6", align 8
  store %struct._IO_FILE* %call74, %struct._IO_FILE** @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$7", align 8
  store i8* %4, i8** @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$8", align 8
  store i32* %num, i32** @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$9", align 8
...
"main$0_call_recursive_function":                 ; preds = %"main$0_extract_next_values", %"main$0_initialize_context"
  ...
  %15 = getelementptr %0, %0* @"main$0_recursion_state_struct", i32 0, i32 0
  %16 = load i1, i1* %15, align 1
  br i1 %16, label %while.end109.loopexit, label %"main$0_extract_next_values"
...
define void @"main$0"(i8 %0) {
"main$0_header":
  %1 = load %struct._IO_FILE*, %struct._IO_FILE** @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$4", align 8
  %call85148 = call i32 @feof(%struct._IO_FILE* nonnull %1) #4
...
while.end97.thread:                               ; preds = %"main$0_header"
  %2 = load i32, i32* @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$2", align 4
  %3 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$3", align 8
  %4 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$5", align 8
  %5 = load %struct.bf_key_st*, %struct.bf_key_st** @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$6", align 8
  %6 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$8", align 8
  %7 = load i32*, i32** @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$9", align 8
  call void @BF_cfb64_encrypt(i8* %3, i8* %4, i64 0, %struct.bf_key_st* nonnull %5, i8* %6, i32* nonnull %7, i32 %2) #4
  br label %"main$0_latch$0"

while.body91.preheader:                           ; preds = %"main$0_header"
  br label %while.body91

while.body91:                                     ; preds = %while.body91, %while.body91.preheader
  %indvars.iv = phi i64 [ %indvars.iv.next, %while.body91 ], [ 0, %while.body91.preheader ]
  %8 = load %struct._IO_FILE*, %struct._IO_FILE** @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$4", align 8
  %call92 = call i32 @_IO_getc(%struct._IO_FILE* nonnull %8)
  %conv93 = trunc i32 %call92 to i8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %9 = load [40 x i8]*, [40 x i8]** @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$1", align 8
  %arrayidx96 = getelementptr inbounds [40 x i8], [40 x i8]* %9, i64 0, i64 %indvars.iv
  store i8 %conv93, i8* %arrayidx96, align 1, !tbaa !5
  %10 = load %struct._IO_FILE*, %struct._IO_FILE** @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$4", align 8
  %call85 = call i32 @feof(%struct._IO_FILE* nonnull %10) #4
  %cmp88 = icmp slt i64 %indvars.iv.next, 40
  %not.tobool86 = icmp eq i32 %call85, 0
  %11 = and i1 %cmp88, %not.tobool86
  br i1 %11, label %while.body91, label %while.end97
...
while.end97:                                      ; preds = %while.body91
  ...
  %13 = load i32, i32* @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$2", align 4
  %14 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$3", align 8
  %15 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$5", align 8
  %16 = load %struct.bf_key_st*, %struct.bf_key_st** @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$6", align 8
  %17 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$8", align 8
  %18 = load i32*, i32** @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$9", align 8
  call void @BF_cfb64_encrypt(i8* nonnull %14, i8* %15, i64 %conv100, %struct.bf_key_st* nonnull %16, i8* %17, i32* nonnull %18, i32 %13) #4
  %cmp102151 = icmp sgt i32 %12, 0
...
for.body:                                         ; preds = %for.body, %for.body.preheader
  ...
  %19 = load [40 x i8]*, [40 x i8]** @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$0", align 8
  %arrayidx105 = getelementptr inbounds [40 x i8], [40 x i8]* %19, i64 0, i64 %indvars.iv158
  %20 = load i8, i8* %arrayidx105, align 1, !tbaa !5
  %conv106 = zext i8 %20 to i32
  %21 = load %struct._IO_FILE*, %struct._IO_FILE** @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$7", align 8
  %call107 = call i32 @fputc(i32 %conv106, %struct._IO_FILE* nonnull %21)
...
"main$0_latch$0":                                 ; preds = %while.end97, %while.end97.thread, %while.cond80.loopexit.loopexit
  %22 = load %struct._IO_FILE*, %struct._IO_FILE** @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$4", align 8
  %call81 = call i32 @feof(%struct._IO_FILE* nonnull %22) #4
...
"main$0_increment_depth_counter":                 ; preds = %"main$0_latch$0"
  ...
  br i1 %24, label %"main$0_recursively_call_function", label %"main$0_save_recursive_state_and_return"

"main$0_recursively_call_function":               ; preds = %"main$0_increment_depth_counter"
  call void @"main$0"(i8 %23)
  ret void

"main$0_save_recursive_state_and_return":         ; preds = %"main$0_increment_depth_counter"
  %25 = getelementptr %0, %0* @"main$0_recursion_state_struct", i32 0, i32 0
  store i1 false, i1* %25, align 1
  ret void

"main$0_return_from_recursive_function$0":        ; preds = %"main$0_latch$0"
  %26 = getelementptr %0, %0* @"main$0_recursion_state_struct", i32 0, i32 0
