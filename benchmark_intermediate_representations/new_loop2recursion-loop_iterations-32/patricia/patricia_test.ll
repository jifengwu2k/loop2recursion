; ModuleID = './benchmark_intermediate_representations/new_loop2recursion-loop_iterations-32/patricia/patricia_test.ll.temp'
...
"main$0_branch_to_exit":                          ; preds = %"main$0_call_recursive_function"
  %i14 = getelementptr %0, %0* @"main$0_return_value_struct", i32 0, i32 0
  %i15 = load i8, i8* %i14, align 1
  switch i8 %i15, label %while.end.loopexit [
...
if.then66:                                        ; preds = %"main$0_branch_to_exit"
  %i16 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !1
  %i17 = call i64 @fwrite(i8* nonnull getelementptr inbounds ([22 x i8], [22 x i8]* @.str.9, i64 0, i64 0), i64 21, i64 1, %struct._IO_FILE* %i16) #8
  call void @exit(i32 0) #7
  unreachable
...
"main$0_preheader_in_recursion":
  br label %"main$0_exiting$3"

"main$0_exiting$3":                               ; preds = %"main$0_increment_loop_counter$0", %"main$0_preheader_in_recursion"
  %loop_counter = phi i8 [ 0, %"main$0_preheader_in_recursion" ], [ %i19, %"main$0_increment_loop_counter$0" ]
...
"main$0_latch$0":                                 ; preds = %if.end64.thread, %"main$0_exiting$1"
  ...
  br i1 %tobool25, label %"main$0_return_from_recursive_function$0", label %"main$0_increment_loop_counter$0", !llvm.loop !21

"main$0_increment_loop_counter$0":                ; preds = %"main$0_latch$0"
  %i19 = add i8 %loop_counter, 1
  %i20 = icmp ult i8 %i19, 32
  br i1 %i20, label %"main$0_exiting$3", label %"main$0_increment_depth_counter"
...
"main$0_return_from_recursive_function$0":        ; preds = %"main$0_latch$0"
  %i21 = getelementptr %0, %0* @"main$0_return_value_struct", i32 0, i32 0
  store i8 4, i8* %i21, align 1
  ret void
...
"main$0_return_from_recursive_function$1":        ; preds = %"main$0_exiting$1"
  ...
  store i8 3, i8* %i22, align 1
  ret void

"main$0_return_from_recursive_function$2":        ; preds = %"main$0_exiting$2"
  %i23 = getelementptr %0, %0* @"main$0_return_value_struct", i32 0, i32 0
...
"main$0_return_from_recursive_function$3":        ; preds = %"main$0_exiting$3"
  ...
  store i8 0, i8* %i24, align 1
  ret void

"main$0_return_from_recursive_function$4":        ; preds = %"main$0_exiting$4"
  %i25 = getelementptr %0, %0* @"main$0_return_value_struct", i32 0, i32 0
