; ModuleID = './benchmark_intermediate_representations/new_loop2recursion-loop_iterations-32/bf/bf_cbc.ll.temp'
...
"BF_cbc_encrypt$1_latch$0":                       ; preds = %"BF_cbc_encrypt$1_increment_loop_counter$0", %"BF_cbc_encrypt$1_preheader_in_recursion"
  %loop_counter = phi i8 [ 0, %"BF_cbc_encrypt$1_preheader_in_recursion" ], [ %i38, %"BF_cbc_encrypt$1_increment_loop_counter$0" ]
  %l.0653 = phi i64 [ %arg2, %"BF_cbc_encrypt$1_preheader_in_recursion" ], [ %l.0, %"BF_cbc_encrypt$1_increment_loop_counter$0" ]
  %in.addr.0650 = phi i8* [ %arg3, %"BF_cbc_encrypt$1_preheader_in_recursion" ], [ %incdec.ptr51, %"BF_cbc_encrypt$1_increment_loop_counter$0" ]
  %out.addr.0649 = phi i8* [ %arg1, %"BF_cbc_encrypt$1_preheader_in_recursion" ], [ %incdec.ptr85, %"BF_cbc_encrypt$1_increment_loop_counter$0" ]
  %i = phi <2 x i64> [ %arg, %"BF_cbc_encrypt$1_preheader_in_recursion" ], [ %i35, %"BF_cbc_encrypt$1_increment_loop_counter$0" ]
  %incdec.ptr26 = getelementptr inbounds i8, i8* %in.addr.0650, i64 1
  %i4 = load i8, i8* %in.addr.0650, align 1, !tbaa !1
  ...
  %i9 = insertelement <2 x i8> undef, i8 %i4, i32 0
...
"BF_cbc_encrypt$1_increment_loop_counter$0":      ; preds = %"BF_cbc_encrypt$1_latch$0"
  %i38 = add i8 %loop_counter, 1
  %i39 = icmp ult i8 %i38, 32
  br i1 %i39, label %"BF_cbc_encrypt$1_latch$0", label %"BF_cbc_encrypt$1_increment_depth_counter"
...
"BF_cbc_encrypt$1_increment_depth_counter":       ; preds = %"BF_cbc_encrypt$1_increment_loop_counter$0"
  ...
  %.lcssa7 = phi <2 x i64> [ %i35, %"BF_cbc_encrypt$1_increment_loop_counter$0" ]
...
"BF_cbc_encrypt$1_return_from_recursive_function$0": ; preds = %"BF_cbc_encrypt$1_latch$0"
  %.lcssa4 = phi i64 [ %i36, %"BF_cbc_encrypt$1_latch$0" ]
  %.lcssa = phi i64 [ %i37, %"BF_cbc_encrypt$1_latch$0" ]
  %i40 = getelementptr %0, %0* @"BF_cbc_encrypt$1_return_value_struct", i32 0, i32 0
  store i64 %.lcssa4, i64* %i40, align 8
  %i41 = getelementptr %0, %0* @"BF_cbc_encrypt$1_return_value_struct", i32 0, i32 1
  store i64 %.lcssa, i64* %i41, align 8
  ret void
}
...
"BF_cbc_encrypt$0_latch$0":                       ; preds = %"BF_cbc_encrypt$0_increment_loop_counter$0", %"BF_cbc_encrypt$0_preheader_in_recursion"
  %loop_counter = phi i8 [ 0, %"BF_cbc_encrypt$0_preheader_in_recursion" ], [ %i39, %"BF_cbc_encrypt$0_increment_loop_counter$0" ]
  %l.1642 = phi i64 [ %arg1, %"BF_cbc_encrypt$0_preheader_in_recursion" ], [ %l.1, %"BF_cbc_encrypt$0_increment_loop_counter$0" ]
  %xor1.0641 = phi i64 [ %arg4, %"BF_cbc_encrypt$0_preheader_in_recursion" ], [ %i38, %"BF_cbc_encrypt$0_increment_loop_counter$0" ]
  %xor0.0640 = phi i64 [ %arg3, %"BF_cbc_encrypt$0_preheader_in_recursion" ], [ %i37, %"BF_cbc_encrypt$0_increment_loop_counter$0" ]
  %in.addr.8639 = phi i8* [ %arg, %"BF_cbc_encrypt$0_preheader_in_recursion" ], [ %incdec.ptr253, %"BF_cbc_encrypt$0_increment_loop_counter$0" ]
  %out.addr.1638 = phi i8* [ %arg2, %"BF_cbc_encrypt$0_preheader_in_recursion" ], [ %incdec.ptr292, %"BF_cbc_encrypt$0_increment_loop_counter$0" ]
  %incdec.ptr228 = getelementptr inbounds i8, i8* %in.addr.8639, i64 1
  %i = load i8, i8* %in.addr.8639, align 1, !tbaa !1
...
"BF_cbc_encrypt$0_increment_loop_counter$0":      ; preds = %"BF_cbc_encrypt$0_latch$0"
  %i39 = add i8 %loop_counter, 1
  %i40 = icmp ult i8 %i39, 32
  br i1 %i40, label %"BF_cbc_encrypt$0_latch$0", label %"BF_cbc_encrypt$0_increment_depth_counter"
...
"BF_cbc_encrypt$0_increment_depth_counter":       ; preds = %"BF_cbc_encrypt$0_increment_loop_counter$0"
  ...
  %.lcssa3 = phi i64 [ %i37, %"BF_cbc_encrypt$0_increment_loop_counter$0" ]
  %.lcssa1 = phi i64 [ %i38, %"BF_cbc_encrypt$0_increment_loop_counter$0" ]
...
"BF_cbc_encrypt$0_return_from_recursive_function$0": ; preds = %"BF_cbc_encrypt$0_latch$0"
  %.lcssa2 = phi i64 [ %i37, %"BF_cbc_encrypt$0_latch$0" ]
  %.lcssa = phi i64 [ %i38, %"BF_cbc_encrypt$0_latch$0" ]
  %i41 = getelementptr %1, %1* @"BF_cbc_encrypt$0_return_value_struct", i32 0, i32 0
  store i64 %.lcssa2, i64* %i41, align 8
  %i42 = getelementptr %1, %1* @"BF_cbc_encrypt$0_return_value_struct", i32 0, i32 1
  store i64 %.lcssa, i64* %i42, align 8
  ret void
}
