; ModuleID = './benchmark_intermediate_representations/new_loop2recursion-loop_iterations-32/bitcnts/bitcnts.ll.temp'
...
"main$0_header":                                  ; preds = %"main$0_increment_loop_counter$0", %"main$0_preheader_in_recursion"
  ...
  %indvars.iv = phi i64 [ %arg2, %"main$0_preheader_in_recursion" ], [ %indvars.iv.next, %"main$0_increment_loop_counter$0" ]
  %cmin.069 = phi double [ %arg4, %"main$0_preheader_in_recursion" ], [ %cmin.1, %"main$0_increment_loop_counter$0" ]
  %cmaxix.068 = phi i32 [ %arg1, %"main$0_preheader_in_recursion" ], [ %cmaxix.1, %"main$0_increment_loop_counter$0" ]
  %cminix.067 = phi i32 [ %arg3, %"main$0_preheader_in_recursion" ], [ %cminix.1, %"main$0_increment_loop_counter$0" ]
  %cmax.065 = phi double [ %arg, %"main$0_preheader_in_recursion" ], [ %cmax.1, %"main$0_increment_loop_counter$0" ]
...
"main$0_latch$0":                                 ; preds = %for.end.loopexit, %"main$0_header"
  ...
  %i8 = trunc i64 %indvars.iv to i32
  %cminix.1 = select i1 %cmp17, i32 %i8, i32 %cminix.067
  ...
  %cmaxix.1 = select i1 %cmp21, i32 %i8, i32 %cmaxix.068
...
"main$0_increment_loop_counter$0":                ; preds = %"main$0_latch$0"
  ...
  br i1 %i11, label %"main$0_header", label %"main$0_increment_depth_counter"

"main$0_increment_depth_counter":                 ; preds = %"main$0_increment_loop_counter$0"
  %cminix.1.lcssa5 = phi i32 [ %cminix.1, %"main$0_increment_loop_counter$0" ]
  %cmin.1.lcssa4 = phi double [ %cmin.1, %"main$0_increment_loop_counter$0" ]
  %cmax.1.lcssa3 = phi double [ %cmax.1, %"main$0_increment_loop_counter$0" ]
  %cmaxix.1.lcssa2 = phi i32 [ %cmaxix.1, %"main$0_increment_loop_counter$0" ]
...
"main$0_recursively_call_function":               ; preds = %"main$0_increment_depth_counter"
  call void @"main$0"(double %cmax.1.lcssa3, i32 %cmaxix.1.lcssa2, i64 %indvars.iv.next.lcssa1, i32 %cminix.1.lcssa5, double %cmin.1.lcssa4)
  ret void

"main$0_return_from_recursive_function$0":        ; preds = %"main$0_latch$0"
  %cminix.1.lcssa = phi i32 [ %cminix.1, %"main$0_latch$0" ]
  %cmaxix.1.lcssa = phi i32 [ %cmaxix.1, %"main$0_latch$0" ]
  %i12 = getelementptr %0, %0* @"main$0_return_value_struct", i32 0, i32 0
  store i32 %cminix.1.lcssa, i32* %i12, align 4
  %i13 = getelementptr %0, %0* @"main$0_return_value_struct", i32 0, i32 1
  store i32 %cmaxix.1.lcssa, i32* %i13, align 4
  ret void
}

define void @"bit_shifter$0"(i64 %arg, i32 %arg1, i32 %arg2) {
"bit_shifter$0_preheader_in_recursion":
  br label %"bit_shifter$0_latch$0"

"bit_shifter$0_latch$0":                          ; preds = %"bit_shifter$0_increment_loop_counter$0", %"bit_shifter$0_preheader_in_recursion"
  %loop_counter = phi i8 [ 0, %"bit_shifter$0_preheader_in_recursion" ], [ %i, %"bit_shifter$0_increment_loop_counter$0" ]
  %n.012 = phi i32 [ %add, %"bit_shifter$0_increment_loop_counter$0" ], [ %arg1, %"bit_shifter$0_preheader_in_recursion" ]
  %i.011 = phi i32 [ %inc, %"bit_shifter$0_increment_loop_counter$0" ], [ %arg2, %"bit_shifter$0_preheader_in_recursion" ]
  %x.addr.010 = phi i64 [ %shr, %"bit_shifter$0_increment_loop_counter$0" ], [ %arg, %"bit_shifter$0_preheader_in_recursion" ]
  ...
  br i1 %or.cond, label %"bit_shifter$0_increment_loop_counter$0", label %"bit_shifter$0_return_from_recursive_function$0"

"bit_shifter$0_increment_loop_counter$0":         ; preds = %"bit_shifter$0_latch$0"
  %i = add i8 %loop_counter, 1
  %i3 = icmp ult i8 %i, 32
  br i1 %i3, label %"bit_shifter$0_latch$0", label %"bit_shifter$0_increment_depth_counter"

"bit_shifter$0_increment_depth_counter":          ; preds = %"bit_shifter$0_increment_loop_counter$0"
  %add.lcssa3 = phi i32 [ %add, %"bit_shifter$0_increment_loop_counter$0" ]
  %inc.lcssa2 = phi i32 [ %inc, %"bit_shifter$0_increment_loop_counter$0" ]
  %shr.lcssa1 = phi i64 [ %shr, %"bit_shifter$0_increment_loop_counter$0" ]
...
"bit_shifter$0_recursively_call_function":        ; preds = %"bit_shifter$0_increment_depth_counter"
  call void @"bit_shifter$0"(i64 %shr.lcssa1, i32 %add.lcssa3, i32 %inc.lcssa2)
  ret void

"bit_shifter$0_return_from_recursive_function$0": ; preds = %"bit_shifter$0_latch$0"
  %add.lcssa = phi i32 [ %add, %"bit_shifter$0_latch$0" ]
  %i4 = getelementptr %1, %1* @"bit_shifter$0_return_value_struct", i32 0, i32 0
  store i32 %add.lcssa, i32* %i4, align 4
  ret void
}
...
"main$0$0_latch$0":                               ; preds = %"main$0$0_increment_loop_counter$0", %"main$0$0_preheader_in_recursion"
  ...
  %seed.064 = phi i64 [ %arg1, %"main$0$0_preheader_in_recursion" ], [ %add14, %"main$0$0_increment_loop_counter$0" ]
  %n.063 = phi i64 [ %arg2, %"main$0$0_preheader_in_recursion" ], [ %add, %"main$0$0_increment_loop_counter$0" ]
  %j.062 = phi i64 [ %arg, %"main$0$0_preheader_in_recursion" ], [ %inc, %"main$0$0_increment_loop_counter$0" ]
  %i = load i32 (i64)*, i32 (i64)** @"./benchmark_intermediate_representations/baseline/bitcnts/bitcnts.ll_invariant_variable$2", align 8
  %call12 = tail call i32 %i(i64 %seed.064) #5
  ...
  br i1 %cmp8, label %"main$0$0_increment_loop_counter$0", label %"main$0$0_return_from_recursive_function$0"
...
"main$0$0_increment_depth_counter":               ; preds = %"main$0$0_increment_loop_counter$0"
  %add.lcssa3 = phi i64 [ %add, %"main$0$0_increment_loop_counter$0" ]
  %inc.lcssa2 = phi i64 [ %inc, %"main$0$0_increment_loop_counter$0" ]
  %add14.lcssa1 = phi i64 [ %add14, %"main$0$0_increment_loop_counter$0" ]
  br label %"main$0$0_recursively_call_function"

"main$0$0_recursively_call_function":             ; preds = %"main$0$0_increment_depth_counter"
  call void @"main$0$0"(i64 %inc.lcssa2, i64 %add14.lcssa1, i64 %add.lcssa3)
  ret void

"main$0$0_return_from_recursive_function$0":      ; preds = %"main$0$0_latch$0"
  %add.lcssa = phi i64 [ %add, %"main$0$0_latch$0" ]
  %i6 = getelementptr %2, %2* @"main$0$0_return_value_struct", i32 0, i32 0
  store i64 %add.lcssa, i64* %i6, align 8
  ret void
}
