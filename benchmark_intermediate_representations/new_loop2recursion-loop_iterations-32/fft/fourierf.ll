; ModuleID = './benchmark_intermediate_representations/new_loop2recursion-loop_iterations-32/fft/fourierf.ll.temp'
...
"fft_float$3_preheader_in_recursion":
  br label %"fft_float$3_header"

"fft_float$3_header":                             ; preds = %"fft_float$3_increment_loop_counter$0", %"fft_float$3_preheader_in_recursion"
  %loop_counter = phi i8 [ 0, %"fft_float$3_preheader_in_recursion" ], [ %i12, %"fft_float$3_increment_loop_counter$0" ]
  %indvars.iv254 = phi i64 [ %arg, %"fft_float$3_preheader_in_recursion" ], [ %indvars.iv.next255, %"fft_float$3_increment_loop_counter$0" ]
  %i = trunc i64 %indvars.iv254 to i32
  ...
  %arrayidx = getelementptr inbounds float, float* %i2, i64 %indvars.iv254
...
cond.false:                                       ; preds = %"fft_float$3_header"
  ...
  %arrayidx11 = getelementptr inbounds float, float* %i8, i64 %indvars.iv254
...
"fft_float$3_latch$0":                            ; preds = %cond.false, %"fft_float$3_header"
  ...
  br i1 %exitcond257, label %"fft_float$3_return_from_recursive_function$0", label %"fft_float$3_increment_loop_counter$0"

"fft_float$3_increment_loop_counter$0":           ; preds = %"fft_float$3_latch$0"
  %i12 = add i8 %loop_counter, 1
  %i13 = icmp ult i8 %i12, 32
  br i1 %i13, label %"fft_float$3_header", label %"fft_float$3_increment_depth_counter"

"fft_float$3_increment_depth_counter":            ; preds = %"fft_float$3_increment_loop_counter$0"
  %indvars.iv.next255.lcssa1 = phi i64 [ %indvars.iv.next255, %"fft_float$3_increment_loop_counter$0" ]
...
"fft_float$3_recursively_call_function":          ; preds = %"fft_float$3_increment_depth_counter"
  call void @"fft_float$3"(i64 %indvars.iv.next255.lcssa1)
  ret void
...
"fft_float$2_preheader_in_recursion":
  br label %"fft_float$2_header"

"fft_float$2_header":                             ; preds = %"fft_float$2_increment_loop_counter$0", %"fft_float$2_preheader_in_recursion"
  %loop_counter = phi i8 [ 0, %"fft_float$2_preheader_in_recursion" ], [ %i4, %"fft_float$2_increment_loop_counter$0" ]
  %BlockSize.0247 = phi i32 [ %shl, %"fft_float$2_increment_loop_counter$0" ], [ %arg1, %"fft_float$2_preheader_in_recursion" ]
  %BlockEnd.0246 = phi i32 [ %BlockSize.0247, %"fft_float$2_increment_loop_counter$0" ], [ %arg, %"fft_float$2_preheader_in_recursion" ]
...
"fft_float$2$0_initialize_context":               ; preds = %for.cond36.preheader.lr.ph
  store i32 %BlockEnd.0246, i32* @"./benchmark_intermediate_representations/baseline/fft/fourierf.ll_invariant_variable$12", align 4
  store i32 %BlockSize.0247, i32* @"./benchmark_intermediate_representations/baseline/fft/fourierf.ll_invariant_variable$13", align 4
...
"fft_float$2$0_call_recursive_function":          ; preds = %"fft_float$2$0_initialize_context"
  call void @"fft_float$2$0"(i32 0, i32 %BlockEnd.0246)
...
"fft_float$2_latch$0":                            ; preds = %for.end110.loopexit, %"fft_float$2_header"
  ...
  br i1 %cmp16, label %"fft_float$2_return_from_recursive_function$0", label %"fft_float$2_increment_loop_counter$0"

"fft_float$2_increment_loop_counter$0":           ; preds = %"fft_float$2_latch$0"
  %i4 = add i8 %loop_counter, 1
  %i5 = icmp ult i8 %i4, 32
  br i1 %i5, label %"fft_float$2_header", label %"fft_float$2_increment_depth_counter"

"fft_float$2_increment_depth_counter":            ; preds = %"fft_float$2_increment_loop_counter$0"
  %shl.lcssa2 = phi i32 [ %shl, %"fft_float$2_increment_loop_counter$0" ]
  %BlockSize.0247.lcssa1 = phi i32 [ %BlockSize.0247, %"fft_float$2_increment_loop_counter$0" ]
...
"fft_float$2_recursively_call_function":          ; preds = %"fft_float$2_increment_depth_counter"
  call void @"fft_float$2"(i32 %BlockSize.0247.lcssa1, i32 %shl.lcssa2)
  ret void
...
"fft_float$1_preheader_in_recursion":
  br label %"fft_float$1_latch$0"

"fft_float$1_latch$0":                            ; preds = %"fft_float$1_increment_loop_counter$0", %"fft_float$1_preheader_in_recursion"
  %loop_counter = phi i8 [ 0, %"fft_float$1_preheader_in_recursion" ], [ %i18, %"fft_float$1_increment_loop_counter$0" ]
  %index = phi i64 [ %arg, %"fft_float$1_preheader_in_recursion" ], [ %index.next, %"fft_float$1_increment_loop_counter$0" ]
  %i = load float*, float** @"./benchmark_intermediate_representations/baseline/fft/fourierf.ll_invariant_variable$3", align 8
  %i1 = getelementptr inbounds float, float* %i, i64 %index
  ...
  %i9 = getelementptr inbounds float, float* %i8, i64 %index
  ...
  br i1 %i17, label %"fft_float$1_return_from_recursive_function$0", label %"fft_float$1_increment_loop_counter$0", !llvm.loop !7

"fft_float$1_increment_loop_counter$0":           ; preds = %"fft_float$1_latch$0"
  %i18 = add i8 %loop_counter, 1
  %i19 = icmp ult i8 %i18, 32
  br i1 %i19, label %"fft_float$1_latch$0", label %"fft_float$1_increment_depth_counter"

"fft_float$1_increment_depth_counter":            ; preds = %"fft_float$1_increment_loop_counter$0"
  %index.next.lcssa1 = phi i64 [ %index.next, %"fft_float$1_increment_loop_counter$0" ]
...
"fft_float$1_recursively_call_function":          ; preds = %"fft_float$1_increment_depth_counter"
  call void @"fft_float$1"(i64 %index.next.lcssa1)
  ret void
...
"fft_float$0_preheader_in_recursion":
  br label %"fft_float$0_latch$0"

"fft_float$0_latch$0":                            ; preds = %"fft_float$0_increment_loop_counter$0", %"fft_float$0_preheader_in_recursion"
  %loop_counter = phi i8 [ 0, %"fft_float$0_preheader_in_recursion" ], [ %i7, %"fft_float$0_increment_loop_counter$0" ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %"fft_float$0_increment_loop_counter$0" ], [ %arg, %"fft_float$0_preheader_in_recursion" ]
  %i = load float*, float** @"./benchmark_intermediate_representations/baseline/fft/fourierf.ll_invariant_variable$3", align 8
  %arrayidx121 = getelementptr inbounds float, float* %i, i64 %indvars.iv
  ...
  %arrayidx126 = getelementptr inbounds float, float* %i3, i64 %indvars.iv
  ...
  br i1 %exitcond, label %"fft_float$0_return_from_recursive_function$0", label %"fft_float$0_increment_loop_counter$0", !llvm.loop !10

"fft_float$0_increment_loop_counter$0":           ; preds = %"fft_float$0_latch$0"
  %i7 = add i8 %loop_counter, 1
  %i8 = icmp ult i8 %i7, 32
  br i1 %i8, label %"fft_float$0_latch$0", label %"fft_float$0_increment_depth_counter"

"fft_float$0_increment_depth_counter":            ; preds = %"fft_float$0_increment_loop_counter$0"
  %indvars.iv.next.lcssa1 = phi i64 [ %indvars.iv.next, %"fft_float$0_increment_loop_counter$0" ]
...
"fft_float$0_recursively_call_function":          ; preds = %"fft_float$0_increment_depth_counter"
  call void @"fft_float$0"(i64 %indvars.iv.next.lcssa1)
  ret void
...
"fft_float$2$0_preheader_in_recursion":
  br label %"fft_float$2$0_header"

"fft_float$2$0_header":                           ; preds = %"fft_float$2$0_increment_loop_counter$0", %"fft_float$2$0_preheader_in_recursion"
  %loop_counter = phi i8 [ 0, %"fft_float$2$0_preheader_in_recursion" ], [ %i9, %"fft_float$2$0_increment_loop_counter$0" ]
  %indvars.iv251 = phi i32 [ %arg1, %"fft_float$2$0_preheader_in_recursion" ], [ %indvars.iv.next252, %"fft_float$2$0_increment_loop_counter$0" ]
  %i.1244 = phi i32 [ %arg, %"fft_float$2$0_preheader_in_recursion" ], [ %add109, %"fft_float$2$0_increment_loop_counter$0" ]
...
"fft_float$2$0$0_initialize_context":             ; preds = %for.body39.preheader
  store i32 %indvars.iv251, i32* @"./benchmark_intermediate_representations/baseline/fft/fourierf.ll_invariant_variable$20", align 4
...
"fft_float$2$0$0_call_recursive_function":        ; preds = %"fft_float$2$0$0_initialize_context"
  call void @"fft_float$2$0$0"(double %i5, double %i4, i32 %i.1244, double %i3, double %i2)
...
"fft_float$2$0_latch$0":                          ; preds = %for.inc108.loopexit, %"fft_float$2$0_header"
  ...
  %indvars.iv.next252 = add i32 %indvars.iv251, %i8
  br i1 %cmp29, label %"fft_float$2$0_increment_loop_counter$0", label %"fft_float$2$0_return_from_recursive_function$0"

"fft_float$2$0_increment_loop_counter$0":         ; preds = %"fft_float$2$0_latch$0"
  %i9 = add i8 %loop_counter, 1
  %i10 = icmp ult i8 %i9, 32
  br i1 %i10, label %"fft_float$2$0_header", label %"fft_float$2$0_increment_depth_counter"

"fft_float$2$0_increment_depth_counter":          ; preds = %"fft_float$2$0_increment_loop_counter$0"
  %add109.lcssa2 = phi i32 [ %add109, %"fft_float$2$0_increment_loop_counter$0" ]
  %indvars.iv.next252.lcssa1 = phi i32 [ %indvars.iv.next252, %"fft_float$2$0_increment_loop_counter$0" ]
...
"fft_float$2$0_recursively_call_function":        ; preds = %"fft_float$2$0_increment_depth_counter"
  call void @"fft_float$2$0"(i32 %add109.lcssa2, i32 %indvars.iv.next252.lcssa1)
  ret void
...
"fft_float$2$0$0_preheader_in_recursion":
  br label %"fft_float$2$0$0_latch$0"

"fft_float$2$0$0_latch$0":                        ; preds = %"fft_float$2$0$0_increment_loop_counter$0", %"fft_float$2$0$0_preheader_in_recursion"
  %loop_counter = phi i8 [ 0, %"fft_float$2$0$0_preheader_in_recursion" ], [ %i18, %"fft_float$2$0$0_increment_loop_counter$0" ]
  %j.0242 = phi i32 [ %inc105, %"fft_float$2$0$0_increment_loop_counter$0" ], [ %arg2, %"fft_float$2$0$0_preheader_in_recursion" ]
  %ai.sroa.6.0240 = phi double [ %sub52, %"fft_float$2$0$0_increment_loop_counter$0" ], [ %arg4, %"fft_float$2$0$0_preheader_in_recursion" ]
  %ai.sroa.10.0239 = phi double [ %ai.sroa.6.0240, %"fft_float$2$0$0_increment_loop_counter$0" ], [ %arg3, %"fft_float$2$0$0_preheader_in_recursion" ]
  %ar.sroa.6.0238 = phi double [ %sub43, %"fft_float$2$0$0_increment_loop_counter$0" ], [ %arg1, %"fft_float$2$0$0_preheader_in_recursion" ]
  %ar.sroa.10.0237 = phi double [ %ar.sroa.6.0238, %"fft_float$2$0$0_increment_loop_counter$0" ], [ %arg, %"fft_float$2$0$0_preheader_in_recursion" ]
  %i = load double, double* @"./benchmark_intermediate_representations/baseline/fft/fourierf.ll_invariant_variable$17", align 8
  %mul41 = fmul double %i, %ar.sroa.6.0238
  ...
  %mul50 = fmul double %i5, %ai.sroa.6.0240
  ...
  br i1 %exitcond253, label %"fft_float$2$0$0_return_from_recursive_function$0", label %"fft_float$2$0$0_increment_loop_counter$0"

"fft_float$2$0$0_increment_loop_counter$0":       ; preds = %"fft_float$2$0$0_latch$0"
  %i18 = add i8 %loop_counter, 1
  %i19 = icmp ult i8 %i18, 32
  br i1 %i19, label %"fft_float$2$0$0_latch$0", label %"fft_float$2$0$0_increment_depth_counter"

"fft_float$2$0$0_increment_depth_counter":        ; preds = %"fft_float$2$0$0_increment_loop_counter$0"
  %ai.sroa.6.0240.lcssa5 = phi double [ %ai.sroa.6.0240, %"fft_float$2$0$0_increment_loop_counter$0" ]
  %ar.sroa.6.0238.lcssa4 = phi double [ %ar.sroa.6.0238, %"fft_float$2$0$0_increment_loop_counter$0" ]
  %sub43.lcssa3 = phi double [ %sub43, %"fft_float$2$0$0_increment_loop_counter$0" ]
  %sub52.lcssa2 = phi double [ %sub52, %"fft_float$2$0$0_increment_loop_counter$0" ]
  %inc105.lcssa1 = phi i32 [ %inc105, %"fft_float$2$0$0_increment_loop_counter$0" ]
...
"fft_float$2$0$0_recursively_call_function":      ; preds = %"fft_float$2$0$0_increment_depth_counter"
  call void @"fft_float$2$0$0"(double %ar.sroa.6.0238.lcssa4, double %sub43.lcssa3, i32 %inc105.lcssa1, double %ai.sroa.6.0240.lcssa5, double %sub52.lcssa2)
  ret void
