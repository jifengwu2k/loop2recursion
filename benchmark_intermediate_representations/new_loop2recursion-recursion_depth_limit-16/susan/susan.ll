; ModuleID = './benchmark_intermediate_representations/new_loop2recursion-recursion_depth_limit-16/susan/susan.ll.temp'
...
"enlarge$2_initialize_context":                   ; preds = %for.body.lr.ph
  ...
  store i64 %idx.ext3, i64* @"./benchmark_intermediate_representations/baseline/susan/susan.ll_invariant_variable$33", align 8
  store i32 %mul, i32* @"./benchmark_intermediate_representations/baseline/susan/susan.ll_invariant_variable$34", align 4
...
"enlarge$1_initialize_context":                   ; preds = %for.body11.lr.ph
  ...
  store i32* %y_size, i32** @"./benchmark_intermediate_representations/baseline/susan/susan.ll_invariant_variable$30", align 8
  store i32* %x_size, i32** @"./benchmark_intermediate_representations/baseline/susan/susan.ll_invariant_variable$31", align 8
  store i32 %mul13, i32* @"./benchmark_intermediate_representations/baseline/susan/susan.ll_invariant_variable$37", align 4
...
"susan_edges_small$0_initialize_context":         ; preds = %for.cond89.preheader.lr.ph
  ...
  store i64 %i7, i64* @"./benchmark_intermediate_representations/baseline/susan/susan.ll_invariant_variable$99", align 8
  store i8* %in, i8** @"./benchmark_intermediate_representations/baseline/susan/susan.ll_invariant_variable$92", align 8
...
"enlarge$2_latch$0":
  ...
  %i4 = load i32, i32* @"./benchmark_intermediate_representations/baseline/susan/susan.ll_invariant_variable$34", align 4
  ...
  %i6 = load i64, i64* @"./benchmark_intermediate_representations/baseline/susan/susan.ll_invariant_variable$33", align 8
...
"enlarge$1_latch$0":
  ...
  %i5 = load i32, i32* @"./benchmark_intermediate_representations/baseline/susan/susan.ll_invariant_variable$37", align 4
  %add14 = add nsw i32 %i4, %i5
  %mul15 = mul nsw i32 %add14, %sub12
  %idx.ext16 = sext i32 %mul15 to i64
  %i6 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/susan/susan.ll_invariant_variable$35", align 8
  ...
  %i15 = load i32, i32* @"./benchmark_intermediate_representations/baseline/susan/susan.ll_invariant_variable$37", align 4
  %add27 = add nsw i32 %i14, %i15
  %mul28 = mul nsw i32 %add25, %add27
  %idx.ext29 = sext i32 %mul28 to i64
  %i16 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/susan/susan.ll_invariant_variable$35", align 8
...
for.body93.lr.ph:                                 ; preds = %"susan_edges_small$0_header"
  %i2 = load i64, i64* @"./benchmark_intermediate_representations/baseline/susan/susan.ll_invariant_variable$99", align 8
  %i3 = mul nsw i64 %arg, %i2
  %i4 = add nsw i64 %arg, -1
  %i5 = load i64, i64* @"./benchmark_intermediate_representations/baseline/susan/susan.ll_invariant_variable$99", align 8
  %i6 = mul nsw i64 %i4, %i5
...
"enlarge$0$0_latch$0":
  ...
  %i9 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/susan/susan.ll_invariant_variable$35", align 8
  ...
  %i18 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/susan/susan.ll_invariant_variable$35", align 8
...
"susan_edges_small$1$0_header":
  ...
  %conv33 = zext i8 %i12 to i32
  %add34 = add nuw nsw i32 %add28, %conv33
  %i13 = load i64, i64* @"./benchmark_intermediate_representations/baseline/susan/susan.ll_invariant_variable$91", align 8
  %add.ptr37 = getelementptr inbounds i8, i8* %incdec.ptr22, i64 %i13
  %i14 = load i8, i8* %add.ptr37, align 1, !tbaa !7
  %idx.ext39 = zext i8 %i14 to i64
  %idx.neg40 = sub nsw i64 0, %idx.ext39
  ...
  %conv49 = zext i8 %i17 to i32
  %add50 = add nuw nsw i32 %add43, %conv49
  %i18 = load i64, i64* @"./benchmark_intermediate_representations/baseline/susan/susan.ll_invariant_variable$91", align 8
  %add.ptr53 = getelementptr inbounds i8, i8* %add.ptr44, i64 %i18
  %incdec.ptr54 = getelementptr inbounds i8, i8* %add.ptr53, i64 1
  %i19 = load i8, i8* %add.ptr53, align 1, !tbaa !7
  %idx.ext56 = zext i8 %i19 to i64
...
if.then100:                                       ; preds = %"susan_edges_small$0$0_header"
  ...
  %i7 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/susan/susan.ll_invariant_variable$89", align 8
...
if.end367:                                        ; preds = %if.else360, %if.else355, %if.end350, %if.then260
  ...
  %i46 = load i32, i32* @"./benchmark_intermediate_representations/baseline/susan/susan.ll_invariant_variable$97", align 4
...
land.lhs.true376:                                 ; preds = %if.end367
  ...
  %i51 = load i32, i32* @"./benchmark_intermediate_representations/baseline/susan/susan.ll_invariant_variable$97", align 4
...
if.end231:                                        ; preds = %if.else224, %if.else219, %if.end208
  ...
  %i56 = load i32, i32* @"./benchmark_intermediate_representations/baseline/susan/susan.ll_invariant_variable$97", align 4
...
land.lhs.true:                                    ; preds = %if.end231
  ...
  %i61 = load i32, i32* @"./benchmark_intermediate_representations/baseline/susan/susan.ll_invariant_variable$97", align 4
