; ModuleID = './benchmark_intermediate_representations/baseline/bitcnts/bitfiles.ll'
...
if.end5:                                          ; preds = %if.end
  %1 = getelementptr inbounds i8, i8* %call, i64 9
  store i8 0, i8* %1, align 1, !tbaa !6
  %2 = getelementptr inbounds i8, i8* %call, i64 11
  store i8 0, i8* %2, align 1, !tbaa !7
  br label %cleanup

cleanup:                                          ; preds = %if.end5, %if.then4, %entry
  %retval.0 = phi %struct.bfile* [ null, %if.then4 ], [ %0, %if.end5 ], [ null, %entry ]
...
entry:
  ...
  %0 = load i8, i8* %rcnt, align 1, !tbaa !6
  %cmp = icmp eq i8 %0, 0
...
if.then:                                          ; preds = %entry
  ...
  %1 = load %struct._IO_FILE*, %struct._IO_FILE** %file, align 8, !tbaa !1
  %call = tail call i32 @fgetc(%struct._IO_FILE* %1)
...
if.end:                                           ; preds = %if.then, %entry.if.end_crit_edge
  ...
  %3 = phi i8 [ 7, %if.then ], [ %phitmp, %entry.if.end_crit_edge ]
  store i8 %3, i8* %rcnt, align 1, !tbaa !6
...
entry:
  ...
  %0 = load i8, i8* %wcnt, align 1, !tbaa !7
  %cmp = icmp eq i8 %0, 8
...
if.then:                                          ; preds = %entry
  %1 = load i8, i8* %wbuf, align 2, !tbaa !9
  %conv2 = sext i8 %1 to i32
  %file = getelementptr inbounds %struct.bfile, %struct.bfile* %bf, i64 0, i32 0
  %2 = load %struct._IO_FILE*, %struct._IO_FILE** %file, align 8, !tbaa !1
  %call = tail call i32 @fputc(i32 %conv2, %struct._IO_FILE* %2)
  store i8 0, i8* %wcnt, align 1, !tbaa !7
  br label %if.end

if.end:                                           ; preds = %if.then, %entry.if.end_crit_edge
  %3 = phi i8 [ %phitmp, %entry.if.end_crit_edge ], [ 1, %if.then ]
  store i8 %3, i8* %wcnt, align 1, !tbaa !7
  %4 = load i8, i8* %wbuf, align 2, !tbaa !9
  %shl = shl i8 %4, 1
  %and = and i32 %bit, 1
...
entry:
  %file = getelementptr inbounds %struct.bfile, %struct.bfile* %bf, i64 0, i32 0
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** %file, align 8, !tbaa !1
  %call = tail call i32 @fclose(%struct._IO_FILE* %0)
  %1 = bitcast %struct.bfile* %bf to i8*
