; ModuleID = './benchmark_intermediate_representations/new_loop2recursion-loop_iterations-64/susan/susan.ll.temp'
...
@"./benchmark_intermediate_representations/baseline/susan/susan.ll_invariant_variable$167" = dso_local global i8* null
@"./benchmark_intermediate_representations/baseline/susan/susan.ll_invariant_variable$168" = dso_local global i32 0
...
"main$7_initialize_context":                      ; preds = %while.body.lr.ph.i
  ...
  store i8* %i126, i8** @"./benchmark_intermediate_representations/baseline/susan/susan.ll_invariant_variable$167", align 8
  store i32 %i78, i32* @"./benchmark_intermediate_representations/baseline/susan/susan.ll_invariant_variable$168", align 4
...
"enlarge$0_latch$0":                              ; preds = %for.inc85.loopexit, %"enlarge$0_header"
  ...
  %i7 = load i32, i32* @"./benchmark_intermediate_representations/baseline/susan/susan.ll_invariant_variable$32", align 4
...
"main$7_header":                                  ; preds = %"main$7_increment_loop_counter$0", %"main$7_preheader_in_recursion"
  ...
  %i2 = load [15000 x %struct.anon]*, [15000 x %struct.anon]** @"./benchmark_intermediate_representations/baseline/susan/susan.ll_invariant_variable$169", align 8
...
if.else.i:                                        ; preds = %"main$7_header"
  %i6 = load i32, i32* @"./benchmark_intermediate_representations/baseline/susan/susan.ll_invariant_variable$168", align 4
  %mul23.i = mul nsw i32 %i1, %i6
  %idx.ext24.i = sext i32 %mul23.i to i64
  %i7 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/susan/susan.ll_invariant_variable$167", align 8
...
if.then.i:                                        ; preds = %"main$7_header"
  ...
  %i8 = load i32, i32* @"./benchmark_intermediate_representations/baseline/susan/susan.ll_invariant_variable$168", align 4
  %mul.i246 = mul nsw i32 %sub.i245, %i8
  %idx.ext.i247 = sext i32 %mul.i246 to i64
  %i9 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/susan/susan.ll_invariant_variable$167", align 8
...
"main$7_latch$0":                                 ; preds = %if.then.i, %if.else.i
  ...
  %i12 = load [15000 x %struct.anon]*, [15000 x %struct.anon]** @"./benchmark_intermediate_representations/baseline/susan/susan.ll_invariant_variable$169", align 8
