; ModuleID = './benchmark_intermediate_representations/unoptimized_loop2recursion-recursion_depth_limit-16/pbmsrch/bmhsrch.ll.temp'
...
"bmh_init$2_call_recursive_function":             ; preds = %"bmh_init$2_extract_next_values", %"bmh_init$2_initialize_context"
  ...
  call void @"bmh_init$2"(%0* %i3, i64 %i5, i64 %i6, i8* %pattern, i32 %conv, %1* %i4, i8 0)
...
"bmh_init$1_call_recursive_function":             ; preds = %"bmh_init$1_extract_next_values", %"bmh_init$1_initialize_context"
  ...
  call void @"bmh_init$1"(i64 %i17, i64 %i, i32 %conv, i8* %pattern, %2* %i16, i8 0)
...
"bmh_init$0_call_recursive_function":             ; preds = %"bmh_init$0_extract_next_values", %"bmh_init$0_initialize_context"
  ...
  call void @"bmh_init$0"(i64 %i24, i64 %idxprom15, i32 %conv, i8* %pattern, i8 %i22, %3* %i23, i8 0)
...
"bmh_search$0_call_recursive_function":           ; preds = %"bmh_search$0_extract_next_values", %"bmh_search$0_initialize_context"
  ...
  call void @"bmh_search$0"(%4* %i4, i32 %i6, i32 %i2, i8* %i1, i64 %i3, i32 %sub10, i8* %add.ptr, i32 %sub5, %5* %i5, i8 0)
...
define void @"bmh_init$0"(i64 %arg, i64 %arg1, i32 %arg2, i8* %arg3, i8 %arg4, %3* %arg5, i8 %arg6) {
"bmh_init$0_header":
...
"bmh_init$0_recursively_call_function":           ; preds = %"bmh_init$0_increment_depth_counter"
  call void @"bmh_init$0"(i64 %indvars.iv.next, i64 %arg1, i32 %arg2, i8* %arg3, i8 %arg4, %3* %arg5, i8 %i9)
  ret void
...
define void @"bmh_init$1"(i64 %arg, i64 %arg1, i32 %arg2, i8* %arg3, %2* %arg4, i8 %arg5) {
"bmh_init$1_latch$0":
...
"bmh_init$1_recursively_call_function":           ; preds = %"bmh_init$1_increment_depth_counter"
  call void @"bmh_init$1"(i64 %indvars.iv.next57.3, i64 %arg1, i32 %arg2, i8* %arg3, %2* %arg4, i8 %i17)
  ret void
...
define void @"bmh_init$2"(%0* %arg, i64 %arg1, i64 %arg2, i8* %arg3, i32 %arg4, %1* %arg5, i8 %arg6) {
"bmh_init$2_latch$0":
...
"bmh_init$2_recursively_call_function":           ; preds = %"bmh_init$2_increment_depth_counter"
  call void @"bmh_init$2"(%0* %arg, i64 %prol.iter.sub, i64 %indvars.iv.next57.prol, i8* %arg3, i32 %arg4, %1* %arg5, i8 %i9)
  ret void
...
define void @"bmh_search$0"(%4* %arg, i32 %arg1, i32 %arg2, i8* %arg3, i64 %arg4, i32 %arg5, i8* %arg6, i32 %arg7, %5* %arg8, i8 %arg9) {
"bmh_search$0_header":
...
"bmh_search$0$0_call_recursive_function":         ; preds = %"bmh_search$0$0_extract_next_values", %"bmh_search$0$0_initialize_context"
  ...
  call void @"bmh_search$0$0"(%6* %i11, i32 %i13, i64 %i14, i8* %arg3, i8* %add.ptr13, %7* %i12, i8 0)
...
"bmh_search$0_recursively_call_function":         ; preds = %"bmh_search$0_increment_depth_counter"
  call void @"bmh_search$0"(%4* %arg, i32 %i.0.be, i32 %arg2, i8* %arg3, i64 %arg4, i32 %arg5, i8* %arg6, i32 %arg7, %5* %arg8, i8 %i23)
  ret void
...
define void @"bmh_search$0$0"(%6* %arg, i32 %arg1, i64 %arg2, i8* %arg3, i8* %arg4, %7* %arg5, i8 %arg6) {
...
"bmh_search$0$0_recursively_call_function":       ; preds = %"bmh_search$0$0_increment_depth_counter"
  call void @"bmh_search$0$0"(%6* %arg, i32 %dec, i64 %indvars.iv.next, i8* %arg3, i8* %arg4, %7* %arg5, i8 %i8)
  ret void
