; ModuleID = './benchmark_intermediate_representations/unoptimized_loop2recursion-recursion_depth_limit-16/pbmsrch/pbmsrch_small.ll.temp'
...
"init_search$2_call_recursive_function":          ; preds = %"init_search$2_extract_next_values", %"init_search$2_initialize_context"
  %i1 = phi i64 [ 0, %"init_search$2_initialize_context" ], [ %i5, %"init_search$2_extract_next_values" ]
  call void @"init_search$2"(i64 %i1, <2 x i64> %broadcast.splat24, %0* %i, i8 0)
  %i2 = getelementptr %0, %0* %i, i32 0, i32 1
  %i3 = load i1, i1* %i2, align 1
  br i1 %i3, label %for.cond1.preheader, label %"init_search$2_extract_next_values"

"init_search$2_extract_next_values":              ; preds = %"init_search$2_call_recursive_function"
  %i4 = getelementptr %0, %0* %i, i32 0, i32 0
...
"init_search$1_call_recursive_function":          ; preds = %"init_search$1_extract_next_values", %"init_search$1_initialize_context"
  %i9 = phi i64 [ %xtraiter, %"init_search$1_initialize_context" ], [ %i14, %"init_search$1_extract_next_values" ]
  %i10 = phi i64 [ 0, %"init_search$1_initialize_context" ], [ %i16, %"init_search$1_extract_next_values" ]
  call void @"init_search$1"(%1* %i7, i64 %i9, i64 %i10, i8* %string, i64 %call, %2* %i8, i8 0)
  %i11 = getelementptr %2, %2* %i8, i32 0, i32 2
  %i12 = load i1, i1* %i11, align 1
  br i1 %i12, label %"init_search$1_extract_return_values$0", label %"init_search$1_extract_next_values"

"init_search$1_extract_next_values":              ; preds = %"init_search$1_call_recursive_function"
  %i13 = getelementptr %2, %2* %i8, i32 0, i32 0
  %i14 = load i64, i64* %i13, align 8
  %i15 = getelementptr %2, %2* %i8, i32 0, i32 1
  %i16 = load i64, i64* %i15, align 8
  br label %"init_search$1_call_recursive_function"

"init_search$1_extract_return_values$0":          ; preds = %"init_search$1_call_recursive_function"
  %i17 = getelementptr %1, %1* %i7, i32 0, i32 0
...
for.body3.preheader.split:                        ; preds = %for.body3.preheader.split.loopexit, %for.body3.preheader
  %i.120.unr = phi i64 [ 0, %for.body3.preheader ], [ %i18, %for.body3.preheader.split.loopexit ]
  %i19 = icmp ult i64 %i6, 3
  br i1 %i19, label %for.end9.loopexit, label %for.body3.preheader.split.split
...
"init_search$0_call_recursive_function":          ; preds = %"init_search$0_extract_next_values", %"init_search$0_initialize_context"
  %i21 = phi i64 [ %i.120.unr, %"init_search$0_initialize_context" ], [ %i25, %"init_search$0_extract_next_values" ]
  call void @"init_search$0"(i64 %i21, i8* %string, i64 %call, %3* %i20, i8 0)
  %i22 = getelementptr %3, %3* %i20, i32 0, i32 1
  %i23 = load i1, i1* %i22, align 1
  br i1 %i23, label %for.end9.loopexit.unr-lcssa, label %"init_search$0_extract_next_values"

"init_search$0_extract_next_values":              ; preds = %"init_search$0_call_recursive_function"
  %i24 = getelementptr %3, %3* %i20, i32 0, i32 0
...
"strsearch$0_call_recursive_function":            ; preds = %"strsearch$0_extract_next_values", %"strsearch$0_initialize_context"
  %i4 = phi i64 [ %sub, %"strsearch$0_initialize_context" ], [ %i9, %"strsearch$0_extract_next_values" ]
  %i5 = phi i64 [ undef, %"strsearch$0_initialize_context" ], [ %i11, %"strsearch$0_extract_next_values" ]
  call void @"strsearch$0"(%4* %i2, i64 %i4, i64 %i5, i8* %i1, i64 %i, i64 %call, i8* %string, %5* %i3, i8 0)
  %i6 = getelementptr %5, %5* %i3, i32 0, i32 2
  %i7 = load i1, i1* %i6, align 1
  br i1 %i7, label %"strsearch$0_extract_return_values$0", label %"strsearch$0_extract_next_values"

"strsearch$0_extract_next_values":                ; preds = %"strsearch$0_call_recursive_function"
  %i8 = getelementptr %5, %5* %i3, i32 0, i32 0
  %i9 = load i64, i64* %i8, align 8
  %i10 = getelementptr %5, %5* %i3, i32 0, i32 1
  %i11 = load i64, i64* %i10, align 8
  br label %"strsearch$0_call_recursive_function"

"strsearch$0_extract_return_values$0":            ; preds = %"strsearch$0_call_recursive_function"
  %i12 = getelementptr %4, %4* %i2, i32 0, i32 0
...
cleanup:                                          ; preds = %cleanup.loopexit, %entry
  %retval.0 = phi i8* [ null, %entry ], [ %i13, %cleanup.loopexit ]
  ret i8* %retval.0
}
...
"main$0_call_recursive_function":                 ; preds = %"main$0_extract_next_values", %"main$0_initialize_context"
  %i1 = phi i64 [ 0, %"main$0_initialize_context" ], [ %i5, %"main$0_extract_next_values" ]
  call void @"main$0"(i64 %i1, %6* %i, i8 0)
  %i2 = getelementptr %6, %6* %i, i32 0, i32 1
  %i3 = load i1, i1* %i2, align 1
  br i1 %i3, label %for.end, label %"main$0_extract_next_values"

"main$0_extract_next_values":                     ; preds = %"main$0_call_recursive_function"
  %i4 = getelementptr %6, %6* %i, i32 0, i32 0
  %i5 = load i64, i64* %i4, align 8
  br label %"main$0_call_recursive_function"
...
define void @"init_search$0"(i64 %arg, i8* %arg1, i64 %arg2, %3* %arg3, i8 %arg4) {
"init_search$0_latch$0":
  ...
  %i5 = load i8, i8* %arrayidx5.1, align 1, !tbaa !7
  ...
  %i6 = load i8, i8* %arrayidx5.2, align 1, !tbaa !7
  %idxprom.2 = zext i8 %i6 to i64
  ...
  %i7 = load i8, i8* %arrayidx5.3, align 1, !tbaa !7
  %idxprom.3 = zext i8 %i7 to i64
...
"init_search$0_increment_depth_counter":          ; preds = %"init_search$0_latch$0"
  ...
  br i1 %i9, label %"init_search$0_recursively_call_function", label %"init_search$0_save_recursive_state_and_return"

"init_search$0_recursively_call_function":        ; preds = %"init_search$0_increment_depth_counter"
  call void @"init_search$0"(i64 %inc8.3, i8* %arg1, i64 %arg2, %3* %arg3, i8 %i8)
  ret void

"init_search$0_save_recursive_state_and_return":  ; preds = %"init_search$0_increment_depth_counter"
  %i10 = getelementptr %3, %3* %arg3, i32 0, i32 0
  store i64 %inc8.3, i64* %i10, align 8
...
"init_search$0_return_from_recursive_function$0": ; preds = %"init_search$0_latch$0"
  %i12 = getelementptr %3, %3* %arg3, i32 0, i32 1
  store i1 true, i1* %i12, align 1
  ret void
}

define void @"init_search$1"(%1* %arg, i64 %arg1, i64 %arg2, i8* %arg3, i64 %arg4, %2* %arg5, i8 %arg6) {
...
"strsearch$0$0_call_recursive_function":          ; preds = %"strsearch$0$0_extract_next_values", %"strsearch$0$0_initialize_context"
  %i10 = phi i64 [ %arg1, %"strsearch$0$0_initialize_context" ], [ %i14, %"strsearch$0$0_extract_next_values" ]
  call void @"strsearch$0$0"(%7* %i, i64 %i10, i64 %arg5, i8* %arg6, %8* %i9, i8 0)
  %i11 = getelementptr %8, %8* %i9, i32 0, i32 1
  %i12 = load i1, i1* %i11, align 1
  br i1 %i12, label %"strsearch$0$0_branch_to_exit", label %"strsearch$0$0_extract_next_values"

"strsearch$0$0_extract_next_values":              ; preds = %"strsearch$0$0_call_recursive_function"
  %i13 = getelementptr %8, %8* %i9, i32 0, i32 0
  %i14 = load i64, i64* %i13, align 8
  br label %"strsearch$0$0_call_recursive_function"

"strsearch$0$0_branch_to_exit":                   ; preds = %"strsearch$0$0_call_recursive_function"
  %i15 = getelementptr %7, %7* %i, i32 0, i32 3
  %i16 = load i8, i8* %i15, align 1
  switch i8 %i16, label %"strsearch$0$0_extract_return_values$0" [
...
"strsearch$0$0_extract_return_values$0":          ; preds = %"strsearch$0$0_branch_to_exit", %"strsearch$0$0_branch_to_exit"
  %i17 = getelementptr %7, %7* %i, i32 0, i32 2
  %i18 = load i64, i64* %i17, align 8
  %i19 = getelementptr %7, %7* %i, i32 0, i32 1
...
"strsearch$0$0_extract_return_values$1":          ; preds = %"strsearch$0$0_branch_to_exit"
  %i21 = getelementptr %7, %7* %i, i32 0, i32 0
...
"strsearch$0_exiting$1":                          ; preds = %if.then.loopexit, %while.end
  %pos.134 = phi i64 [ %arg1, %while.end ], [ %i22, %if.then.loopexit ]
...
"strsearch$0_latch$0":                            ; preds = %"strsearch$0_exiting$1", %while.cond.backedge.loopexit, %while.end
  %pos.0.be = phi i64 [ %arg1, %while.end ], [ %sub7, %"strsearch$0_exiting$1" ], [ %i20, %while.cond.backedge.loopexit ]
  %shift.0.be = phi i64 [ %arg2, %while.end ], [ 0, %"strsearch$0_exiting$1" ], [ %i18, %while.cond.backedge.loopexit ]
...
"strsearch$0_increment_depth_counter":            ; preds = %"strsearch$0_latch$0"
  ...
  br i1 %i24, label %"strsearch$0_recursively_call_function", label %"strsearch$0_save_recursive_state_and_return"

"strsearch$0_recursively_call_function":          ; preds = %"strsearch$0_increment_depth_counter"
  call void @"strsearch$0"(%4* %arg, i64 %pos.0.be, i64 %shift.0.be, i8* %arg3, i64 %arg4, i64 %arg5, i8* %arg6, %5* %arg7, i8 %i23)
  ret void

"strsearch$0_save_recursive_state_and_return":    ; preds = %"strsearch$0_increment_depth_counter"
  %i25 = getelementptr %5, %5* %arg7, i32 0, i32 0
  store i64 %pos.0.be, i64* %i25, align 8
  %i26 = getelementptr %5, %5* %arg7, i32 0, i32 1
  store i64 %shift.0.be, i64* %i26, align 8
  %i27 = getelementptr %5, %5* %arg7, i32 0, i32 2
  store i1 false, i1* %i27, align 1
  ret void

"strsearch$0_return_from_recursive_function$0":   ; preds = %"strsearch$0_latch$0", %"strsearch$0_exiting$1"
  %i28 = phi i8* [ null, %"strsearch$0_latch$0" ], [ %arrayidx9, %"strsearch$0_exiting$1" ]
  %i29 = getelementptr %4, %4* %arg, i32 0, i32 0
  store i8* %i28, i8** %i29, align 8
  %i30 = getelementptr %5, %5* %arg7, i32 0, i32 2
  store i1 true, i1* %i30, align 1
  ret void
}

define void @"main$0"(i64 %arg, %6* %arg1, i8 %arg2) {
"main$0_header":
...
"main$0$3_call_recursive_function":               ; preds = %"main$0$3_extract_next_values", %"main$0$3_initialize_context"
  %i4 = phi i64 [ 0, %"main$0$3_initialize_context" ], [ %i8, %"main$0$3_extract_next_values" ]
  call void @"main$0$3"(i64 %i4, <2 x i64> %broadcast.splat48, %9* %i3, i8 0)
  %i5 = getelementptr %9, %9* %i3, i32 0, i32 1
  %i6 = load i1, i1* %i5, align 1
  br i1 %i6, label %for.cond1.preheader.i, label %"main$0$3_extract_next_values"

"main$0$3_extract_next_values":                   ; preds = %"main$0$3_call_recursive_function"
  %i7 = getelementptr %9, %9* %i3, i32 0, i32 0
...
"main$0$2_initialize_context":                    ; preds = %for.body3.i.prol.preheader
  %i10 = alloca %10, align 8
  %i11 = alloca %11, align 8
...
"main$0$2_call_recursive_function":               ; preds = %"main$0$2_extract_next_values", %"main$0$2_initialize_context"
  %i12 = phi i64 [ %xtraiter, %"main$0$2_initialize_context" ], [ %i17, %"main$0$2_extract_next_values" ]
  %i13 = phi i64 [ 0, %"main$0$2_initialize_context" ], [ %i19, %"main$0$2_extract_next_values" ]
  call void @"main$0$2"(%10* %i10, i64 %i12, i64 %i13, i8* %i, i64 %call.i, %11* %i11, i8 0)
  %i14 = getelementptr %11, %11* %i11, i32 0, i32 2
  %i15 = load i1, i1* %i14, align 1
  br i1 %i15, label %"main$0$2_extract_return_values$0", label %"main$0$2_extract_next_values"

"main$0$2_extract_next_values":                   ; preds = %"main$0$2_call_recursive_function"
  %i16 = getelementptr %11, %11* %i11, i32 0, i32 0
  %i17 = load i64, i64* %i16, align 8
  %i18 = getelementptr %11, %11* %i11, i32 0, i32 1
  %i19 = load i64, i64* %i18, align 8
  br label %"main$0$2_call_recursive_function"

"main$0$2_extract_return_values$0":               ; preds = %"main$0$2_call_recursive_function"
  %i20 = getelementptr %10, %10* %i10, i32 0, i32 0
...
for.body3.i.preheader.split:                      ; preds = %for.body3.i.preheader.split.loopexit, %for.body3.i.preheader
  %i.120.i.unr = phi i64 [ 0, %for.body3.i.preheader ], [ %i21, %for.body3.i.preheader.split.loopexit ]
  %i22 = icmp ult i64 %i9, 3
  br i1 %i22, label %init_search.exit.loopexit, label %for.body3.i.preheader.split.split
...
"main$0$1_call_recursive_function":               ; preds = %"main$0$1_extract_next_values", %"main$0$1_initialize_context"
  %i24 = phi i64 [ %i.120.i.unr, %"main$0$1_initialize_context" ], [ %i28, %"main$0$1_extract_next_values" ]
  call void @"main$0$1"(i64 %i24, i8* %i, i64 %call.i, %12* %i23, i8 0)
  %i25 = getelementptr %12, %12* %i23, i32 0, i32 1
  %i26 = load i1, i1* %i25, align 1
  br i1 %i26, label %init_search.exit.loopexit.unr-lcssa, label %"main$0$1_extract_next_values"

"main$0$1_extract_next_values":                   ; preds = %"main$0$1_call_recursive_function"
  %i27 = getelementptr %12, %12* %i23, i32 0, i32 0
...
init_search.exit:                                 ; preds = %init_search.exit.loopexit, %for.cond1.preheader.i
  ...
  %i29 = load i8*, i8** %arrayidx4, align 8, !tbaa !5
  %sub.i23 = add i64 %call.i, -1
  %call.i24 = tail call i64 @strlen(i8* %i29) #4
...
"main$0$0_initialize_context":                    ; preds = %while.cond1.preheader.i.preheader
  %i30 = alloca %13, align 8
  %i31 = alloca %14, align 8
...
"main$0$0_call_recursive_function":               ; preds = %"main$0$0_extract_next_values", %"main$0$0_initialize_context"
  %i32 = phi i64 [ %sub.i23, %"main$0$0_initialize_context" ], [ %i37, %"main$0$0_extract_next_values" ]
  %i33 = phi i64 [ undef, %"main$0$0_initialize_context" ], [ %i39, %"main$0$0_extract_next_values" ]
  call void @"main$0$0"(%13* %i30, i64 %i32, i64 %i33, i8* %i, i64 %call.i, i64 %call.i24, i8* %i29, %14* %i31, i8 0)
  %i34 = getelementptr %14, %14* %i31, i32 0, i32 2
  %i35 = load i1, i1* %i34, align 1
  br i1 %i35, label %"main$0$0_branch_to_exit", label %"main$0$0_extract_next_values"

"main$0$0_extract_next_values":                   ; preds = %"main$0$0_call_recursive_function"
  %i36 = getelementptr %14, %14* %i31, i32 0, i32 0
  %i37 = load i64, i64* %i36, align 8
  %i38 = getelementptr %14, %14* %i31, i32 0, i32 1
  %i39 = load i64, i64* %i38, align 8
  br label %"main$0$0_call_recursive_function"

"main$0$0_branch_to_exit":                        ; preds = %"main$0$0_call_recursive_function"
  %i40 = getelementptr %13, %13* %i30, i32 0, i32 1
  %i41 = load i8, i8* %i40, align 1
  switch i8 %i41, label %"main$0$0_extract_return_values$0" [
...
"main$0$0_extract_return_values$1":               ; preds = %"main$0$0_branch_to_exit"
  %i42 = getelementptr %13, %13* %i30, i32 0, i32 0
  %i43 = load i8*, i8** %i42, align 8
...
strsearch.exit.thread:                            ; preds = %strsearch.exit.thread.loopexit, %init_search.exit
  %call1031 = tail call i32 (i8*, ...) @printf(i8* nonnull getelementptr inbounds ([18 x i8], [18 x i8]* @.str.104, i64 0, i64 0), i8* %i, i8* nonnull getelementptr inbounds ([5 x i8], [5 x i8]* @.str.106, i64 0, i64 0), i8* %i29)
  br label %"main$0_latch$0"

strsearch.exit:                                   ; preds = %"main$0$0_extract_return_values$1"
  %tobool7 = icmp ne i8* %i43, null
  ...
  %call10 = tail call i32 (i8*, ...) @printf(i8* nonnull getelementptr inbounds ([18 x i8], [18 x i8]* @.str.104, i64 0, i64 0), i8* %i, i8* %cond, i8* %i29)
  br i1 %tobool7, label %if.then, label %"main$0_latch$0"

if.then:                                          ; preds = %strsearch.exit
  %call12 = tail call i32 (i8*, ...) @printf(i8* nonnull getelementptr inbounds ([8 x i8], [8 x i8]* @.str.107, i64 0, i64 0), i8* nonnull %i43)
  br label %"main$0_latch$0"

"main$0_latch$0":                                 ; preds = %if.then, %strsearch.exit, %strsearch.exit.thread
  %i44 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8, !tbaa !5
  %call.i28 = tail call i32 @_IO_putc(i32 10, %struct._IO_FILE* %i44) #5
...
"main$0_increment_depth_counter":                 ; preds = %"main$0_latch$0"
  ...
  br i1 %i46, label %"main$0_recursively_call_function", label %"main$0_save_recursive_state_and_return"

"main$0_recursively_call_function":               ; preds = %"main$0_increment_depth_counter"
  call void @"main$0"(i64 %indvars.iv.next, %6* %arg1, i8 %i45)
  ret void

"main$0_save_recursive_state_and_return":         ; preds = %"main$0_increment_depth_counter"
  %i47 = getelementptr %6, %6* %arg1, i32 0, i32 0
  store i64 %indvars.iv.next, i64* %i47, align 8
  %i48 = getelementptr %6, %6* %arg1, i32 0, i32 1
  store i1 false, i1* %i48, align 1
  ret void

"main$0_return_from_recursive_function$0":        ; preds = %"main$0_latch$0"
  %i49 = getelementptr %6, %6* %arg1, i32 0, i32 1
  store i1 true, i1* %i49, align 1
  ret void
}

define void @"strsearch$0$0"(%7* %arg, i64 %arg1, i64 %arg2, i8* %arg3, %8* %arg4, i8 %arg5) {
"strsearch$0$0_exiting$1":
  ...
  %i6 = load i64, i64* %arrayidx3, align 8, !tbaa !1
  %cmp4 = icmp eq i64 %i6, 0
  %add = add i64 %i6, %arg1
...
"strsearch$0$0_increment_depth_counter":          ; preds = %"strsearch$0$0_latch$0"
  %i7 = add i8 %arg5, 1
  %i8 = icmp ult i8 %i7, 16
  br i1 %i8, label %"strsearch$0$0_recursively_call_function", label %"strsearch$0$0_save_recursive_state_and_return"

"strsearch$0$0_recursively_call_function":        ; preds = %"strsearch$0$0_increment_depth_counter"
  call void @"strsearch$0$0"(%7* %arg, i64 %add, i64 %arg2, i8* %arg3, %8* %arg4, i8 %i7)
  ret void

"strsearch$0$0_save_recursive_state_and_return":  ; preds = %"strsearch$0$0_increment_depth_counter"
  %i9 = getelementptr %8, %8* %arg4, i32 0, i32 0
  store i64 %add, i64* %i9, align 8
  %i10 = getelementptr %8, %8* %arg4, i32 0, i32 1
  store i1 false, i1* %i10, align 1
  ret void

"strsearch$0$0_return_from_recursive_function$0": ; preds = %"strsearch$0$0_latch$0"
  %i11 = getelementptr %7, %7* %arg, i32 0, i32 2
  store i64 %i6, i64* %i11, align 8
  %i12 = getelementptr %7, %7* %arg, i32 0, i32 1
  store i64 %add, i64* %i12, align 8
  %i13 = getelementptr %7, %7* %arg, i32 0, i32 3
  store i8 1, i8* %i13, align 1
  %i14 = getelementptr %8, %8* %arg4, i32 0, i32 1
...
"strsearch$0$0_return_from_recursive_function$1": ; preds = %"strsearch$0$0_exiting$1"
  ...
  %i16 = getelementptr %7, %7* %arg, i32 0, i32 3
  store i8 0, i8* %i16, align 1
  %i17 = getelementptr %8, %8* %arg4, i32 0, i32 1
  store i1 true, i1* %i17, align 1
  ret void
}

define void @"main$0$0"(%13* %arg, i64 %arg1, i64 %arg2, i8* %arg3, i64 %arg4, i64 %arg5, i8* %arg6, %14* %arg7, i8 %arg8) {
"main$0$0_header":
...
"main$0$0$0_call_recursive_function":             ; preds = %"main$0$0$0_extract_next_values", %"main$0$0$0_initialize_context"
  %i10 = phi i64 [ %arg1, %"main$0$0$0_initialize_context" ], [ %i14, %"main$0$0$0_extract_next_values" ]
  call void @"main$0$0$0"(%15* %i, i64 %i10, i64 %arg5, i8* %arg6, %16* %i9, i8 0)
  %i11 = getelementptr %16, %16* %i9, i32 0, i32 1
  %i12 = load i1, i1* %i11, align 1
  br i1 %i12, label %"main$0$0$0_branch_to_exit", label %"main$0$0$0_extract_next_values"

"main$0$0$0_extract_next_values":                 ; preds = %"main$0$0$0_call_recursive_function"
  %i13 = getelementptr %16, %16* %i9, i32 0, i32 0
  %i14 = load i64, i64* %i13, align 8
  br label %"main$0$0$0_call_recursive_function"

"main$0$0$0_branch_to_exit":                      ; preds = %"main$0$0$0_call_recursive_function"
  %i15 = getelementptr %15, %15* %i, i32 0, i32 3
  %i16 = load i8, i8* %i15, align 1
  switch i8 %i16, label %"main$0$0$0_extract_return_values$0" [
...
"main$0$0$0_extract_return_values$0":             ; preds = %"main$0$0$0_branch_to_exit", %"main$0$0$0_branch_to_exit"
  %i17 = getelementptr %15, %15* %i, i32 0, i32 2
  %i18 = load i64, i64* %i17, align 8
  %i19 = getelementptr %15, %15* %i, i32 0, i32 0
  %i20 = load i64, i64* %i19, align 8
  br label %while.cond.backedge.i.loopexit

"main$0$0$0_extract_return_values$1":             ; preds = %"main$0$0$0_branch_to_exit"
  %i21 = getelementptr %15, %15* %i, i32 0, i32 1
  %i22 = load i64, i64* %i21, align 8
...
"main$0$0_exiting$1":                             ; preds = %if.then.i.loopexit, %while.end.i
  %pos.134.i = phi i64 [ %arg1, %while.end.i ], [ %i22, %if.then.i.loopexit ]
...
"main$0$0_latch$0":                               ; preds = %"main$0$0_exiting$1", %while.cond.backedge.i.loopexit, %while.end.i
  %pos.0.be.i = phi i64 [ %arg1, %while.end.i ], [ %sub7.i, %"main$0$0_exiting$1" ], [ %i20, %while.cond.backedge.i.loopexit ]
  %shift.0.be.i = phi i64 [ %arg2, %while.end.i ], [ 0, %"main$0$0_exiting$1" ], [ %i18, %while.cond.backedge.i.loopexit ]
...
"main$0$0_increment_depth_counter":               ; preds = %"main$0$0_latch$0"
  %i23 = add i8 %arg8, 1
  %i24 = icmp ult i8 %i23, 16
  br i1 %i24, label %"main$0$0_recursively_call_function", label %"main$0$0_save_recursive_state_and_return"

"main$0$0_recursively_call_function":             ; preds = %"main$0$0_increment_depth_counter"
  call void @"main$0$0"(%13* %arg, i64 %pos.0.be.i, i64 %shift.0.be.i, i8* %arg3, i64 %arg4, i64 %arg5, i8* %arg6, %14* %arg7, i8 %i23)
  ret void

"main$0$0_save_recursive_state_and_return":       ; preds = %"main$0$0_increment_depth_counter"
  %i25 = getelementptr %14, %14* %arg7, i32 0, i32 0
  store i64 %pos.0.be.i, i64* %i25, align 8
  %i26 = getelementptr %14, %14* %arg7, i32 0, i32 1
  store i64 %shift.0.be.i, i64* %i26, align 8
  %i27 = getelementptr %14, %14* %arg7, i32 0, i32 2
  store i1 false, i1* %i27, align 1
  ret void

"main$0$0_return_from_recursive_function$0":      ; preds = %"main$0$0_latch$0"
  %i28 = getelementptr %13, %13* %arg, i32 0, i32 1
  store i8 1, i8* %i28, align 1
  %i29 = getelementptr %14, %14* %arg7, i32 0, i32 2
  store i1 true, i1* %i29, align 1
  ret void

"main$0$0_return_from_recursive_function$1":      ; preds = %"main$0$0_exiting$1"
  %i30 = getelementptr %13, %13* %arg, i32 0, i32 0
  store i8* %arrayidx9.i, i8** %i30, align 8
  %i31 = getelementptr %13, %13* %arg, i32 0, i32 1
  store i8 0, i8* %i31, align 1
  %i32 = getelementptr %14, %14* %arg7, i32 0, i32 2
  store i1 true, i1* %i32, align 1
  ret void
}

define void @"main$0$1"(i64 %arg, i8* %arg1, i64 %arg2, %12* %arg3, i8 %arg4) {
"main$0$1_latch$0":
  %sub.i = xor i64 %arg, -1
  ...
  %i5 = load i8, i8* %arrayidx5.i.1, align 1, !tbaa !7
  ...
  %i6 = load i8, i8* %arrayidx5.i.2, align 1, !tbaa !7
  %idxprom.i.2 = zext i8 %i6 to i64
  ...
  %i7 = load i8, i8* %arrayidx5.i.3, align 1, !tbaa !7
  %idxprom.i.3 = zext i8 %i7 to i64
...
"main$0$1_increment_depth_counter":               ; preds = %"main$0$1_latch$0"
  %i8 = add i8 %arg4, 1
  %i9 = icmp ult i8 %i8, 16
  br i1 %i9, label %"main$0$1_recursively_call_function", label %"main$0$1_save_recursive_state_and_return"

"main$0$1_recursively_call_function":             ; preds = %"main$0$1_increment_depth_counter"
  call void @"main$0$1"(i64 %inc8.i.3, i8* %arg1, i64 %arg2, %12* %arg3, i8 %i8)
  ret void

"main$0$1_save_recursive_state_and_return":       ; preds = %"main$0$1_increment_depth_counter"
  %i10 = getelementptr %12, %12* %arg3, i32 0, i32 0
  store i64 %inc8.i.3, i64* %i10, align 8
  %i11 = getelementptr %12, %12* %arg3, i32 0, i32 1
  store i1 false, i1* %i11, align 1
  ret void

"main$0$1_return_from_recursive_function$0":      ; preds = %"main$0$1_latch$0"
  %i12 = getelementptr %12, %12* %arg3, i32 0, i32 1
  store i1 true, i1* %i12, align 1
  ret void
}

define void @"main$0$2"(%10* %arg, i64 %arg1, i64 %arg2, i8* %arg3, i64 %arg4, %11* %arg5, i8 %arg6) {
"main$0$2_latch$0":
...
"main$0$2_increment_depth_counter":               ; preds = %"main$0$2_latch$0"
  %i7 = add i8 %arg6, 1
  %i8 = icmp ult i8 %i7, 16
  br i1 %i8, label %"main$0$2_recursively_call_function", label %"main$0$2_save_recursive_state_and_return"

"main$0$2_recursively_call_function":             ; preds = %"main$0$2_increment_depth_counter"
  call void @"main$0$2"(%10* %arg, i64 %prol.iter.sub, i64 %inc8.i.prol, i8* %arg3, i64 %arg4, %11* %arg5, i8 %i7)
  ret void

"main$0$2_save_recursive_state_and_return":       ; preds = %"main$0$2_increment_depth_counter"
  %i9 = getelementptr %11, %11* %arg5, i32 0, i32 0
  store i64 %prol.iter.sub, i64* %i9, align 8
  %i10 = getelementptr %11, %11* %arg5, i32 0, i32 1
  store i64 %inc8.i.prol, i64* %i10, align 8
  %i11 = getelementptr %11, %11* %arg5, i32 0, i32 2
  store i1 false, i1* %i11, align 1
  ret void

"main$0$2_return_from_recursive_function$0":      ; preds = %"main$0$2_latch$0"
  %i12 = getelementptr %10, %10* %arg, i32 0, i32 0
  store i64 %inc8.i.prol, i64* %i12, align 8
  %i13 = getelementptr %11, %11* %arg5, i32 0, i32 2
  store i1 true, i1* %i13, align 1
  ret void
}

define void @"main$0$3"(i64 %arg, <2 x i64> %arg1, %9* %arg2, i8 %arg3) {
"main$0$3_latch$0":
  %i = getelementptr inbounds [256 x i64], [256 x i64]* @table, i64 0, i64 %arg
  %i4 = bitcast i64* %i to <2 x i64>*
  store <2 x i64> %arg1, <2 x i64>* %i4, align 16, !tbaa !1
  ...
  %index.next.7 = add nsw i64 %arg, 32
  %i35 = icmp eq i64 %index.next.7, 256
  br i1 %i35, label %"main$0$3_return_from_recursive_function$0", label %"main$0$3_increment_depth_counter", !llvm.loop !14

"main$0$3_increment_depth_counter":               ; preds = %"main$0$3_latch$0"
  %i36 = add i8 %arg3, 1
  %i37 = icmp ult i8 %i36, 16
  br i1 %i37, label %"main$0$3_recursively_call_function", label %"main$0$3_save_recursive_state_and_return"

"main$0$3_recursively_call_function":             ; preds = %"main$0$3_increment_depth_counter"
  call void @"main$0$3"(i64 %index.next.7, <2 x i64> %arg1, %9* %arg2, i8 %i36)
  ret void

"main$0$3_save_recursive_state_and_return":       ; preds = %"main$0$3_increment_depth_counter"
  %i38 = getelementptr %9, %9* %arg2, i32 0, i32 0
  store i64 %index.next.7, i64* %i38, align 8
  %i39 = getelementptr %9, %9* %arg2, i32 0, i32 1
  store i1 false, i1* %i39, align 1
  ret void

"main$0$3_return_from_recursive_function$0":      ; preds = %"main$0$3_latch$0"
  %i40 = getelementptr %9, %9* %arg2, i32 0, i32 1
  store i1 true, i1* %i40, align 1
  ret void
}

define void @"main$0$0$0"(%15* %arg, i64 %arg1, i64 %arg2, i8* %arg3, %16* %arg4, i8 %arg5) {
"main$0$0$0_exiting$1":
  ...
  %i6 = load i64, i64* %arrayidx3.i, align 8, !tbaa !1
  %cmp4.i = icmp eq i64 %i6, 0
  %add.i = add i64 %i6, %arg1
...
"main$0$0$0_increment_depth_counter":             ; preds = %"main$0$0$0_latch$0"
  %i7 = add i8 %arg5, 1
  %i8 = icmp ult i8 %i7, 16
  br i1 %i8, label %"main$0$0$0_recursively_call_function", label %"main$0$0$0_save_recursive_state_and_return"

"main$0$0$0_recursively_call_function":           ; preds = %"main$0$0$0_increment_depth_counter"
  call void @"main$0$0$0"(%15* %arg, i64 %add.i, i64 %arg2, i8* %arg3, %16* %arg4, i8 %i7)
  ret void

"main$0$0$0_save_recursive_state_and_return":     ; preds = %"main$0$0$0_increment_depth_counter"
  %i9 = getelementptr %16, %16* %arg4, i32 0, i32 0
  store i64 %add.i, i64* %i9, align 8
  %i10 = getelementptr %16, %16* %arg4, i32 0, i32 1
  store i1 false, i1* %i10, align 1
  ret void

"main$0$0$0_return_from_recursive_function$0":    ; preds = %"main$0$0$0_latch$0"
  %i11 = getelementptr %15, %15* %arg, i32 0, i32 2
  store i64 %i6, i64* %i11, align 8
  %i12 = getelementptr %15, %15* %arg, i32 0, i32 0
  store i64 %add.i, i64* %i12, align 8
  %i13 = getelementptr %15, %15* %arg, i32 0, i32 3
  store i8 1, i8* %i13, align 1
  %i14 = getelementptr %16, %16* %arg4, i32 0, i32 1
  store i1 true, i1* %i14, align 1
  ret void

"main$0$0$0_return_from_recursive_function$1":    ; preds = %"main$0$0$0_exiting$1"
  %i15 = getelementptr %15, %15* %arg, i32 0, i32 1
  store i64 %arg1, i64* %i15, align 8
  %i16 = getelementptr %15, %15* %arg, i32 0, i32 3
  store i8 0, i8* %i16, align 1
  %i17 = getelementptr %16, %16* %arg4, i32 0, i32 1
  store i1 true, i1* %i17, align 1
  ret void
}
