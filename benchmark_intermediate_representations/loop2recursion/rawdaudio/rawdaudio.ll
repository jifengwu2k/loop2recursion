; ModuleID = './benchmark_intermediate_representations/loop2recursion/rawdaudio/rawdaudio.ll.temp'
...
"main$0_branch_to_exit":                          ; preds = %"main$0_call_recursive_function"
  %tmp = getelementptr %0, %0* @"main$0_return_value_struct", i32 0, i32 0
  %tmp1 = load i8, i8* %tmp
  switch i8 %tmp1, label %if.then.loopexit [
...
while.end:                                        ; preds = %"main$0_branch_to_exit"
  ...
  %tmp3 = load i16, i16* getelementptr inbounds (%struct.adpcm_state, %struct.adpcm_state* @state, i64 0, i32 0), align 2, !tbaa !5
  %conv = sext i16 %tmp3 to i32
  %tmp4 = load i8, i8* getelementptr inbounds (%struct.adpcm_state, %struct.adpcm_state* @state, i64 0, i32 1), align 2, !tbaa !8
  %conv6 = sext i8 %tmp4 to i32
  %call7 = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %tmp2, i8* nonnull getelementptr inbounds ([28 x i8], [28 x i8]* @.str.1, i64 0, i64 0), i32 %conv, i32 %conv6) #5
...
"main$0_return_from_recursive_function$1":        ; preds = %"main$0_exiting$1"
  %tmp1 = getelementptr %0, %0* @"main$0_return_value_struct", i32 0, i32 0
  store i8 0, i8* %tmp1
  ret void
}
