; ModuleID = './benchmark_intermediate_representations/loop2recursion/fft/main.ll.temp'
...
@"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$4" = dso_local global float* null
@"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$5" = dso_local global i1 false
...
@"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$9" = dso_local global float* null
@"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$10" = dso_local global float* null
@"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$11" = dso_local global float 0.000000e+00
...
if.then5:                                         ; preds = %if.else
  ...
  %tmp = load i8*, i8** %arrayidx, align 8, !tbaa !1
  %call6 = tail call i32 @strncmp(i8* %tmp, i8* nonnull getelementptr inbounds ([3 x i8], [3 x i8]* @.str.4, i64 0, i64 0), i64 2)
...
if.end7:                                          ; preds = %if.then5, %if.else
  ...
  %tmp1 = load i8*, i8** %arrayidx8, align 8, !tbaa !1
  %call.i = tail call i64 @strtol(i8* nocapture nonnull %tmp1, i8** null, i32 10) #5
  %conv.i = trunc i64 %call.i to i32
  %arrayidx10 = getelementptr inbounds i8*, i8** %argv, i64 1
  %tmp2 = load i8*, i8** %arrayidx10, align 8, !tbaa !1
  %call.i170 = tail call i64 @strtol(i8* nocapture nonnull %tmp2, i8** null, i32 10) #5
...
"main$3_initialize_context":                      ; preds = %for.body.preheader
  store i32 %conv.i171, i32* @"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$0"
  store float* %tmp8, float** @"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$1"
  store float* %tmp7, float** @"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$2"
...
"main$2_initialize_context":                      ; preds = %for.body41.preheader
  store i32 %conv.i171, i32* @"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$0"
  store i32 %conv.i, i32* @"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$3"
  store float* %tmp8, float** @"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$1"
  store float* %tmp7, float** @"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$2"
  store float* %tmp4, float** @"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$4"
  store i1 %cmp28180, i1* @"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$5"
  store float* %tmp3, float** @"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$6"
...
for.end90:                                        ; preds = %"main$2_call_recursive_function"
  %call91 = tail call i32 (i32, i32, float*, float*, float*, float*, ...) bitcast (i32 (...)* @fft_float to i32 (i32, i32, float*, float*, float*, float*, ...)*)(i32 %conv.i, i32 %invfft.0, float* %tmp3, float* %tmp4, float* %tmp5, float* %tmp6) #5
...
"main$1_initialize_context":                      ; preds = %for.body96.preheader
  store i32 %conv.i, i32* @"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$3"
  store float* %tmp5, float** @"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$7"
...
for.end103.critedge:                              ; preds = %for.cond38.preheader
  %call91.c = tail call i32 (i32, i32, float*, float*, float*, float*, ...) bitcast (i32 (...)* @fft_float to i32 (i32, i32, float*, float*, float*, float*, ...)*)(i32 %conv.i, i32 %invfft.0, float* %tmp3, float* %tmp4, float* %tmp5, float* %tmp6) #5
...
"main$0_initialize_context":                      ; preds = %for.body109.preheader
  store i32 %conv.i, i32* @"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$3"
  store float* %tmp6, float** @"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$8"
...
"main$3_latch$0":
  ...
  %tmp = load float*, float** @"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$2"
  %arrayidx32 = getelementptr inbounds float, float* %tmp, i64 %arg
  ...
  %tmp1 = load float*, float** @"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$1"
  %arrayidx37 = getelementptr inbounds float, float* %tmp1, i64 %arg
  ...
  %tmp2 = load i32, i32* @"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$0"
  %exitcond197 = icmp eq i32 %lftr.wideiv196, %tmp2
...
"main$3_recursively_call_function":               ; preds = %"main$3_increment_depth_counter"
  call void @"main$3"(i64 %indvars.iv.next195)
  ret void
...
"main$2_header":
  %tmp = load float*, float** @"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$6"
  %arrayidx43 = getelementptr inbounds float, float* %tmp, i64 %arg
  store float 0.000000e+00, float* %arrayidx43, align 4, !tbaa !5
  %tmp1 = load i1, i1* @"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$5"
  br i1 %tmp1, label %"main$2_latch$0", label %for.body47.lr.ph

for.body47.lr.ph:                                 ; preds = %"main$2_header"
  %tmp2 = trunc i64 %arg to i32
  %conv57 = uitofp i32 %tmp2 to float
  %tmp3 = load float*, float** @"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$4"
  %arrayidx84 = getelementptr inbounds float, float* %tmp3, i64 %arg
  br label %"main$2$0_initialize_context"

"main$2$0_initialize_context":                    ; preds = %for.body47.lr.ph
  store float* %arrayidx84, float** @"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$9"
  store float* %arrayidx43, float** @"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$10"
  store float %conv57, float* @"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$11"
...
"main$2_latch$0":                                 ; preds = %for.inc88.loopexit, %"main$2_header"
  ...
  %tmp4 = load i32, i32* @"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$3"
  %exitcond193 = icmp eq i32 %lftr.wideiv192, %tmp4
...
"main$2_recursively_call_function":               ; preds = %"main$2_increment_depth_counter"
  call void @"main$2"(i64 %indvars.iv.next191)
  ret void
...
"main$1_latch$0":
  %tmp = load float*, float** @"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$7"
  %arrayidx98 = getelementptr inbounds float, float* %tmp, i64 %arg
  %tmp1 = load float, float* %arrayidx98, align 4, !tbaa !5
  %conv99 = fpext float %tmp1 to double
  ...
  %tmp2 = load i32, i32* @"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$3"
  %exitcond185 = icmp eq i32 %lftr.wideiv184, %tmp2
...
"main$1_recursively_call_function":               ; preds = %"main$1_increment_depth_counter"
  call void @"main$1"(i64 %indvars.iv.next183)
  ret void
...
"main$0_latch$0":
  %tmp = load float*, float** @"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$8"
  %arrayidx111 = getelementptr inbounds float, float* %tmp, i64 %arg
  %tmp1 = load float, float* %arrayidx111, align 4, !tbaa !5
  %conv112 = fpext float %tmp1 to double
  ...
  %tmp2 = load i32, i32* @"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$3"
  %exitcond = icmp eq i32 %lftr.wideiv, %tmp2
...
"main$2$0_header":
  ...
  %tmp = load float*, float** @"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$2"
  %arrayidx53 = getelementptr inbounds float, float* %tmp, i64 %arg
  %tmp1 = load float, float* %arrayidx53, align 4, !tbaa !5
  %conv54 = fpext float %tmp1 to double
  %tmp2 = load float*, float** @"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$1"
  %arrayidx56 = getelementptr inbounds float, float* %tmp2, i64 %arg
  %tmp3 = load float, float* %arrayidx56, align 4, !tbaa !5
  %tmp4 = load float, float* @"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$11"
  %mul58 = fmul float %tmp4, %tmp3
...
if.then51:                                        ; preds = %"main$2$0_header"
  ...
  %tmp5 = load float*, float** @"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$10"
  %tmp6 = load float, float* %tmp5, align 4, !tbaa !5
  %conv64 = fpext float %tmp6 to double
...
if.else66:                                        ; preds = %"main$2$0_header"
  ...
  %tmp7 = load float*, float** @"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$10"
  %tmp8 = load float, float* %tmp7, align 4, !tbaa !5
  %conv79 = fpext float %tmp8 to double
...
"main$2$0_latch$0":                               ; preds = %if.else66, %if.then51
  ...
  %tmp9 = load float*, float** @"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$10"
  store float %storemerge, float* %tmp9, align 4, !tbaa !5
  %tmp10 = load float*, float** @"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$9"
  store float 0.000000e+00, float* %tmp10, align 4, !tbaa !5
  %indvars.iv.next187 = add nuw nsw i64 %arg, 1
  %lftr.wideiv188 = trunc i64 %indvars.iv.next187 to i32
  %tmp11 = load i32, i32* @"./benchmark_intermediate_representations/baseline/fft/main.ll_invariant_variable$0"
  %exitcond189 = icmp eq i32 %lftr.wideiv188, %tmp11
...
"main$2$0_recursively_call_function":             ; preds = %"main$2$0_increment_depth_counter"
  call void @"main$2$0"(i64 %indvars.iv.next187)
  ret void
