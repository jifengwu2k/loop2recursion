; ModuleID = './benchmark_intermediate_representations/loop2recursion/fft/fourierf.ll.temp'
...
if.then:                                          ; preds = %entry
  ...
  %call1 = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %tmp, i8* nonnull getelementptr inbounds ([52 x i8], [52 x i8]* @.str, i64 0, i64 0), i32 %NumSamples) #5
...
if.then.i:                                        ; preds = %if.end
  ...
  %call.i = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %tmp1, i8* nonnull getelementptr inbounds ([35 x i8], [35 x i8]* @.str.4, i64 0, i64 0), i8* nonnull getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0)) #7
  tail call void @exit(i32 1) #6
  unreachable
...
if.then.i228:                                     ; preds = %CheckPointer.exit
  ...
  %call.i227 = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %tmp2, i8* nonnull getelementptr inbounds ([35 x i8], [35 x i8]* @.str.4, i64 0, i64 0), i8* nonnull getelementptr inbounds ([8 x i8], [8 x i8]* @.str.2, i64 0, i64 0)) #7
  tail call void @exit(i32 1) #6
  unreachable
...
if.then.i232:                                     ; preds = %CheckPointer.exit229
  ...
  %call.i231 = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %tmp3, i8* nonnull getelementptr inbounds ([35 x i8], [35 x i8]* @.str.4, i64 0, i64 0), i8* nonnull getelementptr inbounds ([8 x i8], [8 x i8]* @.str.3, i64 0, i64 0)) #7
  tail call void @exit(i32 1) #6
  unreachable
...
for.body119.preheader:                            ; preds = %if.then114
  %tmp4 = add i32 %NumSamples, -1
  %tmp5 = zext i32 %tmp4 to i64
  %tmp6 = add nuw nsw i64 %tmp5, 1
  %min.iters.check = icmp ult i64 %tmp6, 2
...
min.iters.checked:                                ; preds = %for.body119.preheader
  %n.vec = and i64 %tmp6, 8589934590
  %cmp.zero = icmp eq i64 %n.vec, 0
  br i1 %cmp.zero, label %for.body119.preheader269, label %vector.memcheck

vector.memcheck:                                  ; preds = %min.iters.checked
  %tmp7 = add i32 %NumSamples, -1
  %tmp8 = zext i32 %tmp7 to i64
  %scevgep = getelementptr float, float* %RealOut, i64 %tmp8
  %scevgep262 = getelementptr float, float* %ImagOut, i64 %tmp8
...
"fft_float$3_header":
  ...
  %tmp1 = load i32, i32* @"./benchmark_intermediate_representations/baseline/fft/fourierf.ll_invariant_variable$6"
  %call6 = tail call i32 @ReverseBits(i32 %tmp, i32 %tmp1) #4
  %tmp2 = load float*, float** @"./benchmark_intermediate_representations/baseline/fft/fourierf.ll_invariant_variable$5"
  %arrayidx = getelementptr inbounds float, float* %tmp2, i64 %arg
  %tmp3 = bitcast float* %arrayidx to i32*
  %tmp4 = load i32, i32* %tmp3, align 4, !tbaa !5
  %idxprom7 = zext i32 %call6 to i64
  %tmp5 = load float*, float** @"./benchmark_intermediate_representations/baseline/fft/fourierf.ll_invariant_variable$4"
  %arrayidx8 = getelementptr inbounds float, float* %tmp5, i64 %idxprom7
  %tmp6 = bitcast float* %arrayidx8 to i32*
  store i32 %tmp4, i32* %tmp6, align 4, !tbaa !5
  %tmp7 = load i1, i1* @"./benchmark_intermediate_representations/baseline/fft/fourierf.ll_invariant_variable$3"
  br i1 %tmp7, label %"fft_float$3_latch$0", label %cond.false

cond.false:                                       ; preds = %"fft_float$3_header"
  %tmp8 = load float*, float** @"./benchmark_intermediate_representations/baseline/fft/fourierf.ll_invariant_variable$2"
  %arrayidx11 = getelementptr inbounds float, float* %tmp8, i64 %arg
  %tmp9 = load float, float* %arrayidx11, align 4, !tbaa !5
...
"fft_float$3_latch$0":                            ; preds = %cond.false, %"fft_float$3_header"
  ...
  %tmp10 = load float*, float** @"./benchmark_intermediate_representations/baseline/fft/fourierf.ll_invariant_variable$1"
  %arrayidx14 = getelementptr inbounds float, float* %tmp10, i64 %idxprom7
  ...
  %tmp11 = load i32, i32* @"./benchmark_intermediate_representations/baseline/fft/fourierf.ll_invariant_variable$0"
  %exitcond257 = icmp eq i32 %lftr.wideiv256, %tmp11
...
"fft_float$2_header":
  ...
  %tmp = load double, double* @"./benchmark_intermediate_representations/baseline/fft/fourierf.ll_invariant_variable$8"
  %div = fdiv double %tmp, %conv19
  ...
  %tmp2 = load i1, i1* @"./benchmark_intermediate_representations/baseline/fft/fourierf.ll_invariant_variable$7"
  br i1 %tmp2, label %"fft_float$2_latch$0", label %for.cond36.preheader.lr.ph
...
"fft_float$2$0_initialize_context":               ; preds = %for.cond36.preheader.lr.ph
  store i32 %arg1, i32* @"./benchmark_intermediate_representations/baseline/fft/fourierf.ll_invariant_variable$12"
  store i32 %arg, i32* @"./benchmark_intermediate_representations/baseline/fft/fourierf.ll_invariant_variable$13"
...
"fft_float$2_latch$0":                            ; preds = %for.end110.loopexit, %"fft_float$2_header"
  %shl = shl i32 %arg1, 1
  %tmp3 = load i32, i32* @"./benchmark_intermediate_representations/baseline/fft/fourierf.ll_invariant_variable$0"
  %cmp16 = icmp ugt i32 %shl, %tmp3
...
"fft_float$1_latch$0":
  %tmp = load float*, float** @"./benchmark_intermediate_representations/baseline/fft/fourierf.ll_invariant_variable$4"
  %tmp1 = getelementptr inbounds float, float* %tmp, i64 %arg
  %tmp2 = bitcast float* %tmp1 to <2 x float>*
  %wide.load = load <2 x float>, <2 x float>* %tmp2, align 4, !tbaa !5
  %tmp3 = fpext <2 x float> %wide.load to <2 x double>
  %tmp4 = load <2 x double>, <2 x double>* @"./benchmark_intermediate_representations/baseline/fft/fourierf.ll_invariant_variable$10"
  %tmp5 = fdiv <2 x double> %tmp3, %tmp4
  %tmp6 = fptrunc <2 x double> %tmp5 to <2 x float>
  %tmp7 = bitcast float* %tmp1 to <2 x float>*
  store <2 x float> %tmp6, <2 x float>* %tmp7, align 4, !tbaa !5
  %tmp8 = load float*, float** @"./benchmark_intermediate_representations/baseline/fft/fourierf.ll_invariant_variable$1"
  %tmp9 = getelementptr inbounds float, float* %tmp8, i64 %arg
  %tmp10 = bitcast float* %tmp9 to <2 x float>*
  %wide.load266 = load <2 x float>, <2 x float>* %tmp10, align 4, !tbaa !5
  %tmp11 = fpext <2 x float> %wide.load266 to <2 x double>
  %tmp12 = load <2 x double>, <2 x double>* @"./benchmark_intermediate_representations/baseline/fft/fourierf.ll_invariant_variable$10"
  %tmp13 = fdiv <2 x double> %tmp11, %tmp12
  %tmp14 = fptrunc <2 x double> %tmp13 to <2 x float>
  %tmp15 = bitcast float* %tmp9 to <2 x float>*
  store <2 x float> %tmp14, <2 x float>* %tmp15, align 4, !tbaa !5
  %index.next = add i64 %arg, 2
  %tmp16 = load i64, i64* @"./benchmark_intermediate_representations/baseline/fft/fourierf.ll_invariant_variable$9"
  %tmp17 = icmp eq i64 %index.next, %tmp16
  br i1 %tmp17, label %"fft_float$1_return_from_recursive_function$0", label %"fft_float$1_increment_depth_counter", !llvm.loop !7
...
"fft_float$0_latch$0":
  %tmp = load float*, float** @"./benchmark_intermediate_representations/baseline/fft/fourierf.ll_invariant_variable$4"
  %arrayidx121 = getelementptr inbounds float, float* %tmp, i64 %arg
  %tmp1 = load float, float* %arrayidx121, align 4, !tbaa !5
  %conv122 = fpext float %tmp1 to double
  %tmp2 = load double, double* @"./benchmark_intermediate_representations/baseline/fft/fourierf.ll_invariant_variable$11"
  %div123 = fdiv double %conv122, %tmp2
  %conv124 = fptrunc double %div123 to float
  store float %conv124, float* %arrayidx121, align 4, !tbaa !5
  %tmp3 = load float*, float** @"./benchmark_intermediate_representations/baseline/fft/fourierf.ll_invariant_variable$1"
  %arrayidx126 = getelementptr inbounds float, float* %tmp3, i64 %arg
  %tmp4 = load float, float* %arrayidx126, align 4, !tbaa !5
  %conv127 = fpext float %tmp4 to double
  %tmp5 = load double, double* @"./benchmark_intermediate_representations/baseline/fft/fourierf.ll_invariant_variable$11"
  %div128 = fdiv double %conv127, %tmp5
  ...
  %tmp6 = load i32, i32* @"./benchmark_intermediate_representations/baseline/fft/fourierf.ll_invariant_variable$0"
  %exitcond = icmp eq i32 %lftr.wideiv, %tmp6
...
"fft_float$2$0_header":
  %tmp = load i1, i1* @"./benchmark_intermediate_representations/baseline/fft/fourierf.ll_invariant_variable$19"
  br i1 %tmp, label %"fft_float$2$0_latch$0", label %for.body39.preheader

for.body39.preheader:                             ; preds = %"fft_float$2$0_header"
  %tmp2 = load double, double* @"./benchmark_intermediate_representations/baseline/fft/fourierf.ll_invariant_variable$15"
  %tmp3 = load double, double* @"./benchmark_intermediate_representations/baseline/fft/fourierf.ll_invariant_variable$16"
  %tmp4 = load double, double* @"./benchmark_intermediate_representations/baseline/fft/fourierf.ll_invariant_variable$17"
  %tmp5 = load double, double* @"./benchmark_intermediate_representations/baseline/fft/fourierf.ll_invariant_variable$18"
  br label %"fft_float$2$0$0_initialize_context"

"fft_float$2$0$0_initialize_context":             ; preds = %for.body39.preheader
  store i32 %arg1, i32* @"./benchmark_intermediate_representations/baseline/fft/fourierf.ll_invariant_variable$20"
...
"fft_float$2$0$0_call_recursive_function":        ; preds = %"fft_float$2$0$0_initialize_context"
  call void @"fft_float$2$0$0"(double %tmp2, double %tmp3, double %tmp5, double %tmp4, i32 %arg)
...
"fft_float$2$0_latch$0":                          ; preds = %for.inc108.loopexit, %"fft_float$2$0_header"
  %tmp6 = load i32, i32* @"./benchmark_intermediate_representations/baseline/fft/fourierf.ll_invariant_variable$12"
  %add109 = add i32 %arg, %tmp6
  %tmp7 = load i32, i32* @"./benchmark_intermediate_representations/baseline/fft/fourierf.ll_invariant_variable$0"
  %cmp29 = icmp ult i32 %add109, %tmp7
  %tmp8 = load i32, i32* @"./benchmark_intermediate_representations/baseline/fft/fourierf.ll_invariant_variable$12"
  %indvars.iv.next252 = add i32 %arg1, %tmp8
...
define void @"fft_float$2$0$0"(double %arg, double %arg1, double %arg2, double %arg3, i32 %arg4) {
"fft_float$2$0$0_latch$0":
  %tmp = load double, double* @"./benchmark_intermediate_representations/baseline/fft/fourierf.ll_invariant_variable$14"
  %mul41 = fmul double %tmp, %arg1
  %sub43 = fsub double %mul41, %arg
  %tmp5 = load double, double* @"./benchmark_intermediate_representations/baseline/fft/fourierf.ll_invariant_variable$14"
  %mul50 = fmul double %tmp5, %arg3
  %sub52 = fsub double %mul50, %arg2
  %tmp6 = load i32, i32* @"./benchmark_intermediate_representations/baseline/fft/fourierf.ll_invariant_variable$13"
  %add = add i32 %arg4, %tmp6
  %idxprom59 = zext i32 %add to i64
  %tmp7 = load float*, float** @"./benchmark_intermediate_representations/baseline/fft/fourierf.ll_invariant_variable$4"
  %arrayidx60 = getelementptr inbounds float, float* %tmp7, i64 %idxprom59
  %tmp8 = load float, float* %arrayidx60, align 4, !tbaa !5
  %conv61 = fpext float %tmp8 to double
  %mul62 = fmul double %sub43, %conv61
  %tmp9 = load float*, float** @"./benchmark_intermediate_representations/baseline/fft/fourierf.ll_invariant_variable$1"
  %arrayidx65 = getelementptr inbounds float, float* %tmp9, i64 %idxprom59
  %tmp10 = load float, float* %arrayidx65, align 4, !tbaa !5
  %conv66 = fpext float %tmp10 to double
  ...
  %idxprom80 = zext i32 %arg4 to i64
  %tmp11 = load float*, float** @"./benchmark_intermediate_representations/baseline/fft/fourierf.ll_invariant_variable$4"
  %arrayidx81 = getelementptr inbounds float, float* %tmp11, i64 %idxprom80
  %tmp12 = load float, float* %arrayidx81, align 4, !tbaa !5
  %conv82 = fpext float %tmp12 to double
  %sub83 = fsub double %conv82, %sub68
  %conv84 = fptrunc double %sub83 to float
  store float %conv84, float* %arrayidx60, align 4, !tbaa !5
  %tmp13 = load float*, float** @"./benchmark_intermediate_representations/baseline/fft/fourierf.ll_invariant_variable$1"
  %arrayidx88 = getelementptr inbounds float, float* %tmp13, i64 %idxprom80
  %tmp14 = load float, float* %arrayidx88, align 4, !tbaa !5
  %conv89 = fpext float %tmp14 to double
  %sub90 = fsub double %conv89, %add79
  %conv91 = fptrunc double %sub90 to float
  store float %conv91, float* %arrayidx65, align 4, !tbaa !5
  %tmp15 = load float, float* %arrayidx81, align 4, !tbaa !5
  %conv96 = fpext float %tmp15 to double
  %add97 = fadd double %sub68, %conv96
  %conv98 = fptrunc double %add97 to float
  store float %conv98, float* %arrayidx81, align 4, !tbaa !5
  %tmp16 = load float, float* %arrayidx88, align 4, !tbaa !5
  %conv101 = fpext float %tmp16 to double
  ...
  %inc105 = add i32 %arg4, 1
  %tmp17 = load i32, i32* @"./benchmark_intermediate_representations/baseline/fft/fourierf.ll_invariant_variable$20"
  %exitcond253 = icmp eq i32 %inc105, %tmp17
...
"fft_float$2$0$0_recursively_call_function":      ; preds = %"fft_float$2$0$0_increment_depth_counter"
  call void @"fft_float$2$0$0"(double %arg1, double %sub43, double %arg3, double %sub52, i32 %inc105)
  ret void
