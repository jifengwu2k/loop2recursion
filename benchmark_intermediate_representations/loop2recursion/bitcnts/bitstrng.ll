; ModuleID = './benchmark_intermediate_representations/loop2recursion/bitcnts/bitstrng.ll.temp'
...
for.body.preheader:                               ; preds = %entry
  %tmp = add i32 %cond, %strwid
  %tmp1 = add i32 %tmp, -1
  %tmp2 = sub i32 %tmp1, %sum
  %tmp3 = zext i32 %tmp2 to i64
  %tmp4 = add nuw nsw i64 %tmp3, 1
  call void @llvm.memset.p0i8.i64(i8* align 1 %str, i8 32, i64 %tmp4, i1 false)
  %scevgep = getelementptr i8, i8* %str, i64 %tmp4
...
"bitstring$0_extract_return_values$0":            ; preds = %"bitstring$0_call_recursive_function"
  %tmp6 = getelementptr %0, %0* @"bitstring$0_return_value_struct", i32 0, i32 0
...
while.end:                                        ; preds = %while.end.loopexit, %while.cond.preheader
  %str.addr.1.lcssa = phi i8* [ %str.addr.0.lcssa, %while.cond.preheader ], [ %tmp7, %while.end.loopexit ]
...
"bitstring$0_header":
  ...
  %dec29 = add nsw i32 %tmp, -1
  %sh_prom = zext i32 %dec29 to i64
  %tmp2 = load i64, i64* @"./benchmark_intermediate_representations/baseline/bitcnts/bitstrng.ll_invariant_variable$0"
  %shr324 = lshr i64 %tmp2, %sh_prom
...
"bitstring$0_recursively_call_function":          ; preds = %"bitstring$0_increment_depth_counter"
  call void @"bitstring$0"(i8* %str.addr.1.be, i64 %indvars.iv.next)
  ret void

"bitstring$0_return_from_recursive_function$0":   ; preds = %"bitstring$0_latch$0"
  %tmp3 = getelementptr %0, %0* @"bitstring$0_return_value_struct", i32 0, i32 0
  store i8* %str.addr.1.be, i8** %tmp3
  ret void
}
