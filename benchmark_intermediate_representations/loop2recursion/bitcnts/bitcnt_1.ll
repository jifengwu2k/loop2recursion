; ModuleID = './benchmark_intermediate_representations/loop2recursion/bitcnts/bitcnt_1.ll.temp'
...
"bit_count$0_extract_return_values$0":            ; preds = %"bit_count$0_call_recursive_function"
  %tmp = getelementptr %0, %0* @"bit_count$0_return_value_struct", i32 0, i32 0
...
if.end:                                           ; preds = %if.end.loopexit, %entry
  %n.1 = phi i32 [ 0, %entry ], [ %tmp1, %if.end.loopexit ]
  ret i32 %n.1
}
