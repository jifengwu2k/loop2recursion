; ModuleID = './benchmark_intermediate_representations/loop2recursion/bitcnts/bitcnt_3.ll.temp'
...
entry:
  ...
  %tmp3 = load i8, i8* %arrayidx18, align 1, !tbaa !1
  ...
  %tmp4 = load i8, i8* %arrayidx25, align 1, !tbaa !1
  %conv26 = sext i8 %tmp4 to i32
  ...
  %tmp5 = load i8, i8* %arrayidx32, align 1, !tbaa !1
  %conv33 = sext i8 %tmp5 to i32
  ...
  %tmp6 = load i8, i8* %arrayidx39, align 1, !tbaa !1
  %conv40 = sext i8 %tmp6 to i32
  ...
  %tmp7 = load i8, i8* %arrayidx46, align 1, !tbaa !1
  %conv47 = sext i8 %tmp7 to i32
...
entry:
  ...
  %tmp = load i8, i8* %arrayidx1, align 1, !tbaa !1
  ...
  %tmp2 = load i8, i8* %arrayidx10, align 1, !tbaa !1
  ...
  %tmp3 = load i8, i8* %arrayidx16, align 1, !tbaa !1
  %conv17 = sext i8 %tmp3 to i32
...
entry:
  ...
  %tmp1 = load i8, i8* %arrayidx3, align 1, !tbaa !1
  %conv4 = sext i8 %tmp1 to i32
  ...
  %tmp2 = load i8, i8* %arrayidx7, align 1, !tbaa !1
  %conv8 = sext i8 %tmp2 to i32
  ...
  %tmp3 = load i8, i8* %arrayidx11, align 1, !tbaa !1
  %conv12 = sext i8 %tmp3 to i32
