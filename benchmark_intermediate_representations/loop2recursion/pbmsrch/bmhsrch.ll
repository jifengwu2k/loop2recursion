; ModuleID = './benchmark_intermediate_representations/loop2recursion/pbmsrch/bmhsrch.ll.temp'
...
@"./benchmark_intermediate_representations/baseline/pbmsrch/bmhsrch.ll_invariant_variable$9" = dso_local global i32 0
@"./benchmark_intermediate_representations/baseline/pbmsrch/bmhsrch.ll_invariant_variable$10" = dso_local global i8* null
...
for.body5.lr.ph:                                  ; preds = %vector.body
  ...
  %tmp = ashr exact i64 %sext61, 32
  %sext65 = shl i64 %call, 32
  %tmp1 = ashr exact i64 %sext65, 32
  %tmp2 = add nsw i64 %tmp1, -1
  %xtraiter = and i64 %tmp1, 3
...
"bmh_init$2_initialize_context":                  ; preds = %for.body5.prol.preheader
  store i8* %pattern, i8** @"./benchmark_intermediate_representations/baseline/pbmsrch/bmhsrch.ll_invariant_variable$0"
  store i32 %conv, i32* @"./benchmark_intermediate_representations/baseline/pbmsrch/bmhsrch.ll_invariant_variable$1"
...
"bmh_init$2_extract_return_values$0":             ; preds = %"bmh_init$2_call_recursive_function"
  %tmp3 = getelementptr %0, %0* @"bmh_init$2_return_value_struct", i32 0, i32 0
...
for.body5.lr.ph.split:                            ; preds = %for.body5.lr.ph.split.loopexit, %for.body5.lr.ph
  %indvars.iv56.unr = phi i64 [ 0, %for.body5.lr.ph ], [ %tmp4, %for.body5.lr.ph.split.loopexit ]
  %tmp5 = icmp ult i64 %tmp2, 3
  br i1 %tmp5, label %for.end13.loopexit, label %for.body5.lr.ph.split.split
...
"bmh_init$1_initialize_context":                  ; preds = %for.body5.lr.ph.split.split
  store i8* %pattern, i8** @"./benchmark_intermediate_representations/baseline/pbmsrch/bmhsrch.ll_invariant_variable$0"
  store i64 %tmp, i64* @"./benchmark_intermediate_representations/baseline/pbmsrch/bmhsrch.ll_invariant_variable$2"
  store i32 %conv, i32* @"./benchmark_intermediate_representations/baseline/pbmsrch/bmhsrch.ll_invariant_variable$1"
...
for.end13:                                        ; preds = %for.end13.loopexit, %vector.body
  ...
  %tmp6 = load i8, i8* %arrayidx16, align 1, !tbaa !7
  %idxprom18 = zext i8 %tmp6 to i64
...
"bmh_init$0_initialize_context":                  ; preds = %for.body24.preheader
  store i64 %idxprom15, i64* @"./benchmark_intermediate_representations/baseline/pbmsrch/bmhsrch.ll_invariant_variable$3"
  store i32 %conv, i32* @"./benchmark_intermediate_representations/baseline/pbmsrch/bmhsrch.ll_invariant_variable$1"
  store i8 %tmp6, i8* @"./benchmark_intermediate_representations/baseline/pbmsrch/bmhsrch.ll_invariant_variable$4"
  store i8* %pattern, i8** @"./benchmark_intermediate_representations/baseline/pbmsrch/bmhsrch.ll_invariant_variable$0"
...
"bmh_search$0_initialize_context":                ; preds = %if.end
  store i32 %tmp2, i32* @"./benchmark_intermediate_representations/baseline/pbmsrch/bmhsrch.ll_invariant_variable$5"
  store i8* %tmp1, i8** @"./benchmark_intermediate_representations/baseline/pbmsrch/bmhsrch.ll_invariant_variable$6"
  store i64 %tmp3, i64* @"./benchmark_intermediate_representations/baseline/pbmsrch/bmhsrch.ll_invariant_variable$7"
  store i32 %sub10, i32* @"./benchmark_intermediate_representations/baseline/pbmsrch/bmhsrch.ll_invariant_variable$8"
  store i32 %sub5, i32* @"./benchmark_intermediate_representations/baseline/pbmsrch/bmhsrch.ll_invariant_variable$9"
  store i8* %add.ptr, i8** @"./benchmark_intermediate_representations/baseline/pbmsrch/bmhsrch.ll_invariant_variable$10"
...
"bmh_search$0_branch_to_exit":                    ; preds = %"bmh_search$0_call_recursive_function"
  %tmp4 = getelementptr %1, %1* @"bmh_search$0_return_value_struct", i32 0, i32 1
  %tmp5 = load i8, i8* %tmp4
  switch i8 %tmp5, label %"bmh_search$0_extract_return_values$0" [
...
"bmh_search$0_extract_return_values$0":           ; preds = %"bmh_search$0_branch_to_exit", %"bmh_search$0_branch_to_exit"
  %tmp6 = getelementptr %1, %1* @"bmh_search$0_return_value_struct", i32 0, i32 0
...
cleanup:                                          ; preds = %cleanup.loopexit59, %cleanup.loopexit, %entry
  %retval.0 = phi i8* [ null, %entry ], [ %tmp7, %cleanup.loopexit ], [ null, %cleanup.loopexit59 ]
  ret i8* %retval.0
}

define void @"bmh_init$2"(i64 %arg, i64 %arg1) {
"bmh_init$2_latch$0":
  %tmp = xor i64 %arg1, 4294967295
  %tmp2 = trunc i64 %tmp to i32
  %tmp3 = load i32, i32* @"./benchmark_intermediate_representations/baseline/pbmsrch/bmhsrch.ll_invariant_variable$1"
  %sub6.prol = add i32 %tmp3, %tmp2
  %tmp4 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/pbmsrch/bmhsrch.ll_invariant_variable$0"
  %arrayidx8.prol = getelementptr inbounds i8, i8* %tmp4, i64 %arg1
  %tmp5 = load i8, i8* %arrayidx8.prol, align 1, !tbaa !7
  %idxprom9.prol = zext i8 %tmp5 to i64
...
"bmh_init$2_return_from_recursive_function$0":    ; preds = %"bmh_init$2_latch$0"
  %tmp6 = getelementptr %0, %0* @"bmh_init$2_return_value_struct", i32 0, i32 0
  store i64 %indvars.iv.next57.prol, i64* %tmp6
  ret void
}

define void @"bmh_init$1"(i64 %arg) {
"bmh_init$1_latch$0":
  %tmp = xor i64 %arg, 4294967295
  %tmp1 = trunc i64 %tmp to i32
  %tmp2 = load i32, i32* @"./benchmark_intermediate_representations/baseline/pbmsrch/bmhsrch.ll_invariant_variable$1"
  %sub6 = add i32 %tmp2, %tmp1
  %tmp3 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/pbmsrch/bmhsrch.ll_invariant_variable$0"
  %arrayidx8 = getelementptr inbounds i8, i8* %tmp3, i64 %arg
  %tmp4 = load i8, i8* %arrayidx8, align 1, !tbaa !7
  %idxprom9 = zext i8 %tmp4 to i64
  ...
  %tmp5 = xor i64 %indvars.iv.next57, 4294967295
  %tmp6 = trunc i64 %tmp5 to i32
  %tmp7 = load i32, i32* @"./benchmark_intermediate_representations/baseline/pbmsrch/bmhsrch.ll_invariant_variable$1"
  %sub6.1 = add i32 %tmp7, %tmp6
  %tmp8 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/pbmsrch/bmhsrch.ll_invariant_variable$0"
  %arrayidx8.1 = getelementptr inbounds i8, i8* %tmp8, i64 %indvars.iv.next57
  %tmp9 = load i8, i8* %arrayidx8.1, align 1, !tbaa !7
  %idxprom9.1 = zext i8 %tmp9 to i64
  ...
  %tmp10 = xor i64 %indvars.iv.next57.1, 4294967295
  %tmp11 = trunc i64 %tmp10 to i32
  %tmp12 = load i32, i32* @"./benchmark_intermediate_representations/baseline/pbmsrch/bmhsrch.ll_invariant_variable$1"
  %sub6.2 = add i32 %tmp12, %tmp11
  %tmp13 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/pbmsrch/bmhsrch.ll_invariant_variable$0"
  %arrayidx8.2 = getelementptr inbounds i8, i8* %tmp13, i64 %indvars.iv.next57.1
  %tmp14 = load i8, i8* %arrayidx8.2, align 1, !tbaa !7
  %idxprom9.2 = zext i8 %tmp14 to i64
  ...
  %tmp15 = xor i64 %indvars.iv.next57.2, 4294967295
  %tmp16 = trunc i64 %tmp15 to i32
  %tmp17 = load i32, i32* @"./benchmark_intermediate_representations/baseline/pbmsrch/bmhsrch.ll_invariant_variable$1"
  %sub6.3 = add i32 %tmp17, %tmp16
  %tmp18 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/pbmsrch/bmhsrch.ll_invariant_variable$0"
  %arrayidx8.3 = getelementptr inbounds i8, i8* %tmp18, i64 %indvars.iv.next57.2
  %tmp19 = load i8, i8* %arrayidx8.3, align 1, !tbaa !7
  %idxprom9.3 = zext i8 %tmp19 to i64
  ...
  %tmp20 = load i64, i64* @"./benchmark_intermediate_representations/baseline/pbmsrch/bmhsrch.ll_invariant_variable$2"
  %cmp3.3 = icmp sgt i64 %tmp20, %indvars.iv.next57.3
...
"bmh_init$0_header":
  %tmp = load i8*, i8** @"./benchmark_intermediate_representations/baseline/pbmsrch/bmhsrch.ll_invariant_variable$0"
  %arrayidx26 = getelementptr inbounds i8, i8* %tmp, i64 %arg
  %tmp1 = load i8, i8* %arrayidx26, align 1, !tbaa !7
  %tmp2 = load i8, i8* @"./benchmark_intermediate_representations/baseline/pbmsrch/bmhsrch.ll_invariant_variable$4"
  %cmp28 = icmp eq i8 %tmp1, %tmp2
  br i1 %cmp28, label %if.then, label %"bmh_init$0_latch$0"

if.then:                                          ; preds = %"bmh_init$0_header"
  %tmp3 = xor i64 %arg, 4294967295
  %tmp4 = trunc i64 %tmp3 to i32
  %tmp5 = load i32, i32* @"./benchmark_intermediate_representations/baseline/pbmsrch/bmhsrch.ll_invariant_variable$1"
  %sub31 = add i32 %tmp5, %tmp4
...
"bmh_init$0_latch$0":                             ; preds = %if.then, %"bmh_init$0_header"
  ...
  %tmp6 = load i64, i64* @"./benchmark_intermediate_representations/baseline/pbmsrch/bmhsrch.ll_invariant_variable$3"
  %cmp22 = icmp slt i64 %indvars.iv.next, %tmp6
...
"bmh_search$0_header":
  ...
  %tmp = load i8*, i8** @"./benchmark_intermediate_representations/baseline/pbmsrch/bmhsrch.ll_invariant_variable$10"
  ...
  br i1 %cmp4, label %"bmh_search$0_latch$0", label %"bmh_search$0_exiting$2"

"bmh_search$0_exiting$2":                         ; preds = %"bmh_search$0_header"
  %tmp3 = load i32, i32* @"./benchmark_intermediate_representations/baseline/pbmsrch/bmhsrch.ll_invariant_variable$9"
  %cmp6 = icmp slt i32 %add, %tmp3
  br i1 %cmp6, label %"bmh_search$0_return_from_recursive_function$1", label %if.end8

if.end8:                                          ; preds = %"bmh_search$0_exiting$2"
  %sub9 = add nsw i32 %add, -32767
  %tmp4 = load i32, i32* @"./benchmark_intermediate_representations/baseline/pbmsrch/bmhsrch.ll_invariant_variable$8"
  %sub11 = sub nsw i32 %sub9, %tmp4
  %idx.ext12 = sext i32 %sub11 to i64
  %tmp5 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/pbmsrch/bmhsrch.ll_invariant_variable$10"
  %add.ptr13 = getelementptr inbounds i8, i8* %tmp5, i64 %idx.ext12
  %tmp6 = load i64, i64* @"./benchmark_intermediate_representations/baseline/pbmsrch/bmhsrch.ll_invariant_variable$7"
  %tmp7 = load i32, i32* @"./benchmark_intermediate_representations/baseline/pbmsrch/bmhsrch.ll_invariant_variable$8"
  br label %"bmh_search$0$0_initialize_context"

"bmh_search$0$0_initialize_context":              ; preds = %if.end8
  store i8* %add.ptr13, i8** @"./benchmark_intermediate_representations/baseline/pbmsrch/bmhsrch.ll_invariant_variable$11"
...
"bmh_search$0$0_call_recursive_function":         ; preds = %"bmh_search$0$0_initialize_context"
  call void @"bmh_search$0$0"(i32 %tmp7, i64 %tmp6)
  br label %"bmh_search$0$0_branch_to_exit"

"bmh_search$0$0_branch_to_exit":                  ; preds = %"bmh_search$0$0_call_recursive_function"
  %tmp8 = getelementptr %2, %2* @"bmh_search$0$0_return_value_struct", i32 0, i32 0
  %tmp9 = load i8, i8* %tmp8
  switch i8 %tmp9, label %"bmh_search$0_exiting$0" [
...
"bmh_search$0_exiting$0":                         ; preds = %"bmh_search$0$0_branch_to_exit", %"bmh_search$0$0_branch_to_exit"
  %tmp10 = load i32, i32* @"./benchmark_intermediate_representations/baseline/pbmsrch/bmhsrch.ll_invariant_variable$5"
  %add29 = add nsw i32 %tmp10, %sub9
...
"bmh_search$0_return_from_recursive_function$0":  ; preds = %"bmh_search$0$0_branch_to_exit"
  %tmp11 = getelementptr %1, %1* @"bmh_search$0_return_value_struct", i32 0, i32 0
  store i8* %add.ptr13, i8** %tmp11
  %tmp12 = getelementptr %1, %1* @"bmh_search$0_return_value_struct", i32 0, i32 1
  store i8 1, i8* %tmp12
  ret void

"bmh_search$0_return_from_recursive_function$1":  ; preds = %"bmh_search$0_exiting$0", %"bmh_search$0_exiting$2"
  %tmp13 = getelementptr %1, %1* @"bmh_search$0_return_value_struct", i32 0, i32 1
  store i8 2, i8* %tmp13
  ret void
}
...
"bmh_search$0$0_latch$0":                         ; preds = %"bmh_search$0$0_exiting$1"
  ...
  %tmp = load i8*, i8** @"./benchmark_intermediate_representations/baseline/pbmsrch/bmhsrch.ll_invariant_variable$11"
  ...
  %tmp3 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/pbmsrch/bmhsrch.ll_invariant_variable$6"
  %arrayidx19 = getelementptr inbounds i8, i8* %tmp3, i64 %idxprom16
  %tmp4 = load i8, i8* %arrayidx19, align 1, !tbaa !7
  %conv20 = zext i8 %tmp4 to i32
...
"bmh_search$0$0_return_from_recursive_function$0": ; preds = %"bmh_search$0$0_latch$0"
  %tmp5 = getelementptr %2, %2* @"bmh_search$0$0_return_value_struct", i32 0, i32 0
  store i8 1, i8* %tmp5
  ret void

"bmh_search$0$0_return_from_recursive_function$1": ; preds = %"bmh_search$0$0_exiting$1"
  %tmp6 = getelementptr %2, %2* @"bmh_search$0$0_return_value_struct", i32 0, i32 0
  store i8 0, i8* %tmp6
  ret void
}
