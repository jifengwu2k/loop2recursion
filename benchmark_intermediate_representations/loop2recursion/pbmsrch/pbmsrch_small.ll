; ModuleID = './benchmark_intermediate_representations/loop2recursion/pbmsrch/pbmsrch_small.ll.temp'
...
@"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$5" = dso_local global i8* null
@"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$6" = dso_local global i64 0
...
@"main$0$2_return_value_struct" = dso_local global %3 zeroinitializer
...
@"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$10" = dso_local global i8* null
@"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$11" = dso_local global i64 0
@"main$0$0$0_return_value_struct" = dso_local global %5 zeroinitializer
...
"init_search$2_initialize_context":               ; preds = %entry
  store <2 x i64> %broadcast.splat24, <2 x i64>* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$0"
...
"init_search$1_initialize_context":               ; preds = %for.body3.prol.preheader
  store i8* %string, i8** @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$1"
  store i64 %call, i64* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$2"
...
"init_search$1_extract_return_values$0":          ; preds = %"init_search$1_call_recursive_function"
  %tmp1 = getelementptr %0, %0* @"init_search$1_return_value_struct", i32 0, i32 0
...
for.body3.preheader.split:                        ; preds = %for.body3.preheader.split.loopexit, %for.body3.preheader
  %i.120.unr = phi i64 [ 0, %for.body3.preheader ], [ %tmp2, %for.body3.preheader.split.loopexit ]
  %tmp3 = icmp ult i64 %tmp, 3
  br i1 %tmp3, label %for.end9.loopexit, label %for.body3.preheader.split.split
...
entry:
  %tmp = load i64, i64* @len, align 8, !tbaa !1
  %sub = add i64 %tmp, -1
  %call = tail call i64 @strlen(i8* %string) #4
...
while.cond1.preheader.lr.ph:                      ; preds = %entry
  %tmp1 = load i8*, i8** @findme, align 8
  br label %"strsearch$0_initialize_context"

"strsearch$0_initialize_context":                 ; preds = %while.cond1.preheader.lr.ph
  store i8* %tmp1, i8** @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$3"
  store i64 %tmp, i64* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$4"
  store i8* %string, i8** @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$5"
  store i64 %call, i64* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$6"
...
"strsearch$0_extract_return_values$0":            ; preds = %"strsearch$0_call_recursive_function"
  %tmp2 = getelementptr %1, %1* @"strsearch$0_return_value_struct", i32 0, i32 0
...
cleanup:                                          ; preds = %cleanup.loopexit, %entry
  %retval.0 = phi i8* [ null, %entry ], [ %tmp3, %cleanup.loopexit ]
  ret i8* %retval.0
}
...
"init_search$2_latch$0":
  %tmp = getelementptr inbounds [256 x i64], [256 x i64]* @table, i64 0, i64 %arg
  %tmp1 = bitcast i64* %tmp to <2 x i64>*
  %tmp2 = load <2 x i64>, <2 x i64>* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$0"
  store <2 x i64> %tmp2, <2 x i64>* %tmp1, align 16, !tbaa !1
  %tmp3 = getelementptr i64, i64* %tmp, i64 2
  %tmp4 = bitcast i64* %tmp3 to <2 x i64>*
  %tmp5 = load <2 x i64>, <2 x i64>* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$0"
  store <2 x i64> %tmp5, <2 x i64>* %tmp4, align 16, !tbaa !1
  %index.next = or i64 %arg, 4
  %tmp6 = getelementptr inbounds [256 x i64], [256 x i64]* @table, i64 0, i64 %index.next
  %tmp7 = bitcast i64* %tmp6 to <2 x i64>*
  %tmp8 = load <2 x i64>, <2 x i64>* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$0"
  store <2 x i64> %tmp8, <2 x i64>* %tmp7, align 16, !tbaa !1
  %tmp9 = getelementptr i64, i64* %tmp6, i64 2
  %tmp10 = bitcast i64* %tmp9 to <2 x i64>*
  %tmp11 = load <2 x i64>, <2 x i64>* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$0"
  store <2 x i64> %tmp11, <2 x i64>* %tmp10, align 16, !tbaa !1
  %index.next.1 = or i64 %arg, 8
  %tmp12 = getelementptr inbounds [256 x i64], [256 x i64]* @table, i64 0, i64 %index.next.1
  %tmp13 = bitcast i64* %tmp12 to <2 x i64>*
  %tmp14 = load <2 x i64>, <2 x i64>* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$0"
  store <2 x i64> %tmp14, <2 x i64>* %tmp13, align 16, !tbaa !1
  %tmp15 = getelementptr i64, i64* %tmp12, i64 2
  %tmp16 = bitcast i64* %tmp15 to <2 x i64>*
  %tmp17 = load <2 x i64>, <2 x i64>* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$0"
  store <2 x i64> %tmp17, <2 x i64>* %tmp16, align 16, !tbaa !1
  %index.next.2 = or i64 %arg, 12
  %tmp18 = getelementptr inbounds [256 x i64], [256 x i64]* @table, i64 0, i64 %index.next.2
  %tmp19 = bitcast i64* %tmp18 to <2 x i64>*
  %tmp20 = load <2 x i64>, <2 x i64>* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$0"
  store <2 x i64> %tmp20, <2 x i64>* %tmp19, align 16, !tbaa !1
  %tmp21 = getelementptr i64, i64* %tmp18, i64 2
  %tmp22 = bitcast i64* %tmp21 to <2 x i64>*
  %tmp23 = load <2 x i64>, <2 x i64>* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$0"
  store <2 x i64> %tmp23, <2 x i64>* %tmp22, align 16, !tbaa !1
  %index.next.3 = or i64 %arg, 16
  %tmp24 = getelementptr inbounds [256 x i64], [256 x i64]* @table, i64 0, i64 %index.next.3
  %tmp25 = bitcast i64* %tmp24 to <2 x i64>*
  %tmp26 = load <2 x i64>, <2 x i64>* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$0"
  store <2 x i64> %tmp26, <2 x i64>* %tmp25, align 16, !tbaa !1
  %tmp27 = getelementptr i64, i64* %tmp24, i64 2
  %tmp28 = bitcast i64* %tmp27 to <2 x i64>*
  %tmp29 = load <2 x i64>, <2 x i64>* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$0"
  store <2 x i64> %tmp29, <2 x i64>* %tmp28, align 16, !tbaa !1
  %index.next.4 = or i64 %arg, 20
  %tmp30 = getelementptr inbounds [256 x i64], [256 x i64]* @table, i64 0, i64 %index.next.4
  %tmp31 = bitcast i64* %tmp30 to <2 x i64>*
  %tmp32 = load <2 x i64>, <2 x i64>* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$0"
  store <2 x i64> %tmp32, <2 x i64>* %tmp31, align 16, !tbaa !1
  %tmp33 = getelementptr i64, i64* %tmp30, i64 2
  %tmp34 = bitcast i64* %tmp33 to <2 x i64>*
  %tmp35 = load <2 x i64>, <2 x i64>* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$0"
  store <2 x i64> %tmp35, <2 x i64>* %tmp34, align 16, !tbaa !1
  %index.next.5 = or i64 %arg, 24
  %tmp36 = getelementptr inbounds [256 x i64], [256 x i64]* @table, i64 0, i64 %index.next.5
  %tmp37 = bitcast i64* %tmp36 to <2 x i64>*
  %tmp38 = load <2 x i64>, <2 x i64>* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$0"
  store <2 x i64> %tmp38, <2 x i64>* %tmp37, align 16, !tbaa !1
  %tmp39 = getelementptr i64, i64* %tmp36, i64 2
  %tmp40 = bitcast i64* %tmp39 to <2 x i64>*
  %tmp41 = load <2 x i64>, <2 x i64>* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$0"
  store <2 x i64> %tmp41, <2 x i64>* %tmp40, align 16, !tbaa !1
  %index.next.6 = or i64 %arg, 28
  %tmp42 = getelementptr inbounds [256 x i64], [256 x i64]* @table, i64 0, i64 %index.next.6
  %tmp43 = bitcast i64* %tmp42 to <2 x i64>*
  %tmp44 = load <2 x i64>, <2 x i64>* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$0"
  store <2 x i64> %tmp44, <2 x i64>* %tmp43, align 16, !tbaa !1
  %tmp45 = getelementptr i64, i64* %tmp42, i64 2
  %tmp46 = bitcast i64* %tmp45 to <2 x i64>*
  %tmp47 = load <2 x i64>, <2 x i64>* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$0"
  store <2 x i64> %tmp47, <2 x i64>* %tmp46, align 16, !tbaa !1
  %index.next.7 = add nsw i64 %arg, 32
  %tmp48 = icmp eq i64 %index.next.7, 256
  br i1 %tmp48, label %"init_search$2_return_from_recursive_function$0", label %"init_search$2_increment_depth_counter", !llvm.loop !7
...
"init_search$2_recursively_call_function":        ; preds = %"init_search$2_increment_depth_counter"
  call void @"init_search$2"(i64 %index.next.7)
  ret void
...
"init_search$1_latch$0":
  ...
  %tmp = load i64, i64* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$2"
  %sub4.prol = add i64 %tmp, %sub.prol
  %tmp2 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$1"
  %arrayidx5.prol = getelementptr inbounds i8, i8* %tmp2, i64 %arg1
  %tmp3 = load i8, i8* %arrayidx5.prol, align 1, !tbaa !10
  %idxprom.prol = zext i8 %tmp3 to i64
...
"init_search$1_recursively_call_function":        ; preds = %"init_search$1_increment_depth_counter"
  call void @"init_search$1"(i64 %prol.iter.sub, i64 %inc8.prol)
  ret void

"init_search$1_return_from_recursive_function$0": ; preds = %"init_search$1_latch$0"
  %tmp4 = getelementptr %0, %0* @"init_search$1_return_value_struct", i32 0, i32 0
  store i64 %inc8.prol, i64* %tmp4
  ret void
}
...
"init_search$0_latch$0":
  %sub = xor i64 %arg, -1
  %tmp = load i64, i64* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$2"
  %sub4 = add i64 %tmp, %sub
  %tmp1 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$1"
  %arrayidx5 = getelementptr inbounds i8, i8* %tmp1, i64 %arg
  %tmp2 = load i8, i8* %arrayidx5, align 1, !tbaa !10
  %idxprom = zext i8 %tmp2 to i64
  ...
  %sub.1 = sub i64 -2, %arg
  %tmp3 = load i64, i64* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$2"
  %sub4.1 = add i64 %tmp3, %sub.1
  %tmp4 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$1"
  %arrayidx5.1 = getelementptr inbounds i8, i8* %tmp4, i64 %inc8
  %tmp5 = load i8, i8* %arrayidx5.1, align 1, !tbaa !10
  %idxprom.1 = zext i8 %tmp5 to i64
  ...
  %sub.2 = sub i64 -3, %arg
  %tmp6 = load i64, i64* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$2"
  %sub4.2 = add i64 %tmp6, %sub.2
  %tmp7 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$1"
  %arrayidx5.2 = getelementptr inbounds i8, i8* %tmp7, i64 %inc8.1
  %tmp8 = load i8, i8* %arrayidx5.2, align 1, !tbaa !10
  %idxprom.2 = zext i8 %tmp8 to i64
  ...
  %sub.3 = sub i64 -4, %arg
  %tmp9 = load i64, i64* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$2"
  %sub4.3 = add i64 %tmp9, %sub.3
  %tmp10 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$1"
  %arrayidx5.3 = getelementptr inbounds i8, i8* %tmp10, i64 %inc8.2
  %tmp11 = load i8, i8* %arrayidx5.3, align 1, !tbaa !10
  %idxprom.3 = zext i8 %tmp11 to i64
  ...
  %tmp12 = load i64, i64* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$2"
  %cmp2.3 = icmp ugt i64 %tmp12, %inc8.3
...
"init_search$0_recursively_call_function":        ; preds = %"init_search$0_increment_depth_counter"
  call void @"init_search$0"(i64 %inc8.3)
  ret void
...
"strsearch$0_header":
  %tmp = load i64, i64* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$6"
  %cmp236 = icmp ult i64 %arg, %tmp
...
"strsearch$0$0_call_recursive_function":          ; preds = %"strsearch$0$0_initialize_context"
  call void @"strsearch$0$0"(i64 %arg)
  br label %"strsearch$0$0_branch_to_exit"

"strsearch$0$0_branch_to_exit":                   ; preds = %"strsearch$0$0_call_recursive_function"
  %tmp2 = getelementptr %2, %2* @"strsearch$0$0_return_value_struct", i32 0, i32 3
  %tmp3 = load i8, i8* %tmp2
  switch i8 %tmp3, label %"strsearch$0$0_extract_return_values$0" [
...
"strsearch$0$0_extract_return_values$0":          ; preds = %"strsearch$0$0_branch_to_exit", %"strsearch$0$0_branch_to_exit"
  %tmp4 = getelementptr %2, %2* @"strsearch$0$0_return_value_struct", i32 0, i32 1
  %tmp5 = load i64, i64* %tmp4
  %tmp6 = getelementptr %2, %2* @"strsearch$0$0_return_value_struct", i32 0, i32 2
...
"strsearch$0$0_extract_return_values$1":          ; preds = %"strsearch$0$0_branch_to_exit"
  %tmp8 = getelementptr %2, %2* @"strsearch$0$0_return_value_struct", i32 0, i32 0
...
"strsearch$0_exiting$1":                          ; preds = %if.then.loopexit, %while.end
  %pos.134 = phi i64 [ %arg, %while.end ], [ %tmp9, %if.then.loopexit ]
  %sub7 = add i64 %pos.134, 1
  %tmp10 = load i64, i64* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$4"
  %add8 = sub i64 %sub7, %tmp10
  %tmp11 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$5"
  %arrayidx9 = getelementptr inbounds i8, i8* %tmp11, i64 %add8
  %tmp12 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$3"
  %tmp13 = load i64, i64* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$4"
  %call10 = tail call i32 @strncmp(i8* %tmp12, i8* %arrayidx9, i64 %tmp13) #4
...
"strsearch$0_latch$0":                            ; preds = %"strsearch$0_exiting$1", %while.cond.backedge.loopexit, %while.end
  %pos.0.be = phi i64 [ %arg, %while.end ], [ %sub7, %"strsearch$0_exiting$1" ], [ %tmp7, %while.cond.backedge.loopexit ]
  %shift.0.be = phi i64 [ %arg1, %while.end ], [ 0, %"strsearch$0_exiting$1" ], [ %tmp5, %while.cond.backedge.loopexit ]
  %tmp14 = load i64, i64* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$6"
  %cmp = icmp ult i64 %pos.0.be, %tmp14
...
"strsearch$0_recursively_call_function":          ; preds = %"strsearch$0_increment_depth_counter"
  call void @"strsearch$0"(i64 %pos.0.be, i64 %shift.0.be)
  ret void

"strsearch$0_return_from_recursive_function$0":   ; preds = %"strsearch$0_latch$0", %"strsearch$0_exiting$1"
  %tmp15 = phi i8* [ null, %"strsearch$0_latch$0" ], [ %arrayidx9, %"strsearch$0_exiting$1" ]
  %tmp16 = getelementptr %1, %1* @"strsearch$0_return_value_struct", i32 0, i32 0
...
"main$0_header":
  ...
  %tmp = load i8*, i8** %arrayidx, align 8, !tbaa !5
  %call.i = tail call i64 @strlen(i8* %tmp) #4
...
"main$0$3_initialize_context":                    ; preds = %"main$0_header"
  store <2 x i64> %broadcast.splat48, <2 x i64>* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$7"
  br label %"main$0$3_call_recursive_function"

"main$0$3_call_recursive_function":               ; preds = %"main$0$3_initialize_context"
  call void @"main$0$3"(i64 0)
...
"main$0$2_initialize_context":                    ; preds = %for.body3.i.prol.preheader
  store i8* %tmp, i8** @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$8"
  store i64 %call.i, i64* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$9"
  br label %"main$0$2_call_recursive_function"

"main$0$2_call_recursive_function":               ; preds = %"main$0$2_initialize_context"
  call void @"main$0$2"(i64 %xtraiter, i64 0)
  br label %"main$0$2_extract_return_values$0"

"main$0$2_extract_return_values$0":               ; preds = %"main$0$2_call_recursive_function"
  %tmp2 = getelementptr %3, %3* @"main$0$2_return_value_struct", i32 0, i32 0
...
for.body3.i.preheader.split:                      ; preds = %for.body3.i.preheader.split.loopexit, %for.body3.i.preheader
  %i.120.i.unr = phi i64 [ 0, %for.body3.i.preheader ], [ %tmp3, %for.body3.i.preheader.split.loopexit ]
  %tmp4 = icmp ult i64 %tmp1, 3
  br i1 %tmp4, label %init_search.exit.loopexit, label %for.body3.i.preheader.split.split
...
"main$0$1_call_recursive_function":               ; preds = %"main$0$1_initialize_context"
  call void @"main$0$1"(i64 %i.120.i.unr)
...
init_search.exit:                                 ; preds = %init_search.exit.loopexit, %for.cond1.preheader.i
  store i8* %tmp, i8** @findme, align 8, !tbaa !5
  %arrayidx4 = getelementptr inbounds [57 x i8*], [57 x i8*]* @main.search_strings, i64 0, i64 %arg
  %tmp5 = load i8*, i8** %arrayidx4, align 8, !tbaa !5
  %sub.i23 = add i64 %call.i, -1
  %call.i24 = tail call i64 @strlen(i8* %tmp5) #4
...
"main$0$0_initialize_context":                    ; preds = %while.cond1.preheader.i.preheader
  store i8* %tmp, i8** @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$8"
  store i64 %call.i, i64* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$9"
  store i8* %tmp5, i8** @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$10"
  store i64 %call.i24, i64* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$11"
  br label %"main$0$0_call_recursive_function"

"main$0$0_call_recursive_function":               ; preds = %"main$0$0_initialize_context"
  call void @"main$0$0"(i64 %sub.i23, i64 undef)
  br label %"main$0$0_branch_to_exit"

"main$0$0_branch_to_exit":                        ; preds = %"main$0$0_call_recursive_function"
  %tmp6 = getelementptr %4, %4* @"main$0$0_return_value_struct", i32 0, i32 1
  %tmp7 = load i8, i8* %tmp6
  switch i8 %tmp7, label %"main$0$0_extract_return_values$0" [
...
"main$0$0_extract_return_values$1":               ; preds = %"main$0$0_branch_to_exit"
  %tmp8 = getelementptr %4, %4* @"main$0$0_return_value_struct", i32 0, i32 0
...
strsearch.exit.thread:                            ; preds = %strsearch.exit.thread.loopexit, %init_search.exit
  %call1031 = tail call i32 (i8*, ...) @printf(i8* nonnull getelementptr inbounds ([18 x i8], [18 x i8]* @.str.104, i64 0, i64 0), i8* %tmp, i8* nonnull getelementptr inbounds ([5 x i8], [5 x i8]* @.str.106, i64 0, i64 0), i8* %tmp5)
  br label %"main$0_latch$0"

strsearch.exit:                                   ; preds = %"main$0$0_extract_return_values$1"
  %tobool7 = icmp ne i8* %tmp9, null
  ...
  %call10 = tail call i32 (i8*, ...) @printf(i8* nonnull getelementptr inbounds ([18 x i8], [18 x i8]* @.str.104, i64 0, i64 0), i8* %tmp, i8* %cond, i8* %tmp5)
  br i1 %tobool7, label %if.then, label %"main$0_latch$0"

if.then:                                          ; preds = %strsearch.exit
  %call12 = tail call i32 (i8*, ...) @printf(i8* nonnull getelementptr inbounds ([8 x i8], [8 x i8]* @.str.107, i64 0, i64 0), i8* nonnull %tmp9)
  br label %"main$0_latch$0"

"main$0_latch$0":                                 ; preds = %if.then, %strsearch.exit, %strsearch.exit.thread
  %tmp10 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8, !tbaa !5
  %call.i28 = tail call i32 @_IO_putc(i32 10, %struct._IO_FILE* %tmp10) #5
...
"strsearch$0$0_exiting$1":
  %tmp = load i8*, i8** @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$5"
  %arrayidx = getelementptr inbounds i8, i8* %tmp, i64 %arg
  %tmp1 = load i8, i8* %arrayidx, align 1, !tbaa !10
  %idxprom = zext i8 %tmp1 to i64
  %arrayidx3 = getelementptr inbounds [256 x i64], [256 x i64]* @table, i64 0, i64 %idxprom
  %tmp2 = load i64, i64* %arrayidx3, align 8, !tbaa !1
  %cmp4 = icmp eq i64 %tmp2, 0
  %add = add i64 %tmp2, %arg
...
"strsearch$0$0_latch$0":                          ; preds = %"strsearch$0$0_exiting$1"
  %tmp3 = load i64, i64* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$6"
  %cmp2 = icmp ult i64 %add, %tmp3
...
"strsearch$0$0_recursively_call_function":        ; preds = %"strsearch$0$0_increment_depth_counter"
  call void @"strsearch$0$0"(i64 %add)
  ret void

"strsearch$0$0_return_from_recursive_function$0": ; preds = %"strsearch$0$0_latch$0"
  %tmp4 = getelementptr %2, %2* @"strsearch$0$0_return_value_struct", i32 0, i32 1
  store i64 %tmp2, i64* %tmp4
  %tmp5 = getelementptr %2, %2* @"strsearch$0$0_return_value_struct", i32 0, i32 2
  store i64 %add, i64* %tmp5
  %tmp6 = getelementptr %2, %2* @"strsearch$0$0_return_value_struct", i32 0, i32 3
  store i8 1, i8* %tmp6
  ret void

"strsearch$0$0_return_from_recursive_function$1": ; preds = %"strsearch$0$0_exiting$1"
  %tmp7 = getelementptr %2, %2* @"strsearch$0$0_return_value_struct", i32 0, i32 0
  store i64 %arg, i64* %tmp7
  %tmp8 = getelementptr %2, %2* @"strsearch$0$0_return_value_struct", i32 0, i32 3
  store i8 0, i8* %tmp8
  ret void
}

define void @"main$0$3"(i64 %arg) {
"main$0$3_latch$0":
  %tmp = getelementptr inbounds [256 x i64], [256 x i64]* @table, i64 0, i64 %arg
  %tmp1 = bitcast i64* %tmp to <2 x i64>*
  %tmp2 = load <2 x i64>, <2 x i64>* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$7"
  store <2 x i64> %tmp2, <2 x i64>* %tmp1, align 16, !tbaa !1
  %tmp3 = getelementptr i64, i64* %tmp, i64 2
  %tmp4 = bitcast i64* %tmp3 to <2 x i64>*
  %tmp5 = load <2 x i64>, <2 x i64>* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$7"
  store <2 x i64> %tmp5, <2 x i64>* %tmp4, align 16, !tbaa !1
  %index.next = or i64 %arg, 4
  %tmp6 = getelementptr inbounds [256 x i64], [256 x i64]* @table, i64 0, i64 %index.next
  %tmp7 = bitcast i64* %tmp6 to <2 x i64>*
  %tmp8 = load <2 x i64>, <2 x i64>* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$7"
  store <2 x i64> %tmp8, <2 x i64>* %tmp7, align 16, !tbaa !1
  %tmp9 = getelementptr i64, i64* %tmp6, i64 2
  %tmp10 = bitcast i64* %tmp9 to <2 x i64>*
  %tmp11 = load <2 x i64>, <2 x i64>* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$7"
  store <2 x i64> %tmp11, <2 x i64>* %tmp10, align 16, !tbaa !1
  %index.next.1 = or i64 %arg, 8
  %tmp12 = getelementptr inbounds [256 x i64], [256 x i64]* @table, i64 0, i64 %index.next.1
  %tmp13 = bitcast i64* %tmp12 to <2 x i64>*
  %tmp14 = load <2 x i64>, <2 x i64>* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$7"
  store <2 x i64> %tmp14, <2 x i64>* %tmp13, align 16, !tbaa !1
  %tmp15 = getelementptr i64, i64* %tmp12, i64 2
  %tmp16 = bitcast i64* %tmp15 to <2 x i64>*
  %tmp17 = load <2 x i64>, <2 x i64>* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$7"
  store <2 x i64> %tmp17, <2 x i64>* %tmp16, align 16, !tbaa !1
  %index.next.2 = or i64 %arg, 12
  %tmp18 = getelementptr inbounds [256 x i64], [256 x i64]* @table, i64 0, i64 %index.next.2
  %tmp19 = bitcast i64* %tmp18 to <2 x i64>*
  %tmp20 = load <2 x i64>, <2 x i64>* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$7"
  store <2 x i64> %tmp20, <2 x i64>* %tmp19, align 16, !tbaa !1
  %tmp21 = getelementptr i64, i64* %tmp18, i64 2
  %tmp22 = bitcast i64* %tmp21 to <2 x i64>*
  %tmp23 = load <2 x i64>, <2 x i64>* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$7"
  store <2 x i64> %tmp23, <2 x i64>* %tmp22, align 16, !tbaa !1
  %index.next.3 = or i64 %arg, 16
  %tmp24 = getelementptr inbounds [256 x i64], [256 x i64]* @table, i64 0, i64 %index.next.3
  %tmp25 = bitcast i64* %tmp24 to <2 x i64>*
  %tmp26 = load <2 x i64>, <2 x i64>* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$7"
  store <2 x i64> %tmp26, <2 x i64>* %tmp25, align 16, !tbaa !1
  %tmp27 = getelementptr i64, i64* %tmp24, i64 2
  %tmp28 = bitcast i64* %tmp27 to <2 x i64>*
  %tmp29 = load <2 x i64>, <2 x i64>* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$7"
  store <2 x i64> %tmp29, <2 x i64>* %tmp28, align 16, !tbaa !1
  %index.next.4 = or i64 %arg, 20
  %tmp30 = getelementptr inbounds [256 x i64], [256 x i64]* @table, i64 0, i64 %index.next.4
  %tmp31 = bitcast i64* %tmp30 to <2 x i64>*
  %tmp32 = load <2 x i64>, <2 x i64>* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$7"
  store <2 x i64> %tmp32, <2 x i64>* %tmp31, align 16, !tbaa !1
  %tmp33 = getelementptr i64, i64* %tmp30, i64 2
  %tmp34 = bitcast i64* %tmp33 to <2 x i64>*
  %tmp35 = load <2 x i64>, <2 x i64>* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$7"
  store <2 x i64> %tmp35, <2 x i64>* %tmp34, align 16, !tbaa !1
  %index.next.5 = or i64 %arg, 24
  %tmp36 = getelementptr inbounds [256 x i64], [256 x i64]* @table, i64 0, i64 %index.next.5
  %tmp37 = bitcast i64* %tmp36 to <2 x i64>*
  %tmp38 = load <2 x i64>, <2 x i64>* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$7"
  store <2 x i64> %tmp38, <2 x i64>* %tmp37, align 16, !tbaa !1
  %tmp39 = getelementptr i64, i64* %tmp36, i64 2
  %tmp40 = bitcast i64* %tmp39 to <2 x i64>*
  %tmp41 = load <2 x i64>, <2 x i64>* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$7"
  store <2 x i64> %tmp41, <2 x i64>* %tmp40, align 16, !tbaa !1
  %index.next.6 = or i64 %arg, 28
  %tmp42 = getelementptr inbounds [256 x i64], [256 x i64]* @table, i64 0, i64 %index.next.6
  %tmp43 = bitcast i64* %tmp42 to <2 x i64>*
  %tmp44 = load <2 x i64>, <2 x i64>* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$7"
  store <2 x i64> %tmp44, <2 x i64>* %tmp43, align 16, !tbaa !1
  %tmp45 = getelementptr i64, i64* %tmp42, i64 2
  %tmp46 = bitcast i64* %tmp45 to <2 x i64>*
  %tmp47 = load <2 x i64>, <2 x i64>* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$7"
  store <2 x i64> %tmp47, <2 x i64>* %tmp46, align 16, !tbaa !1
  %index.next.7 = add nsw i64 %arg, 32
  %tmp48 = icmp eq i64 %index.next.7, 256
  br i1 %tmp48, label %"main$0$3_return_from_recursive_function$0", label %"main$0$3_increment_depth_counter", !llvm.loop !13
...
"main$0$3_recursively_call_function":             ; preds = %"main$0$3_increment_depth_counter"
  call void @"main$0$3"(i64 %index.next.7)
  ret void
...
define void @"main$0$2"(i64 %arg, i64 %arg1) {
"main$0$2_latch$0":
  %sub.i.prol = xor i64 %arg1, -1
  %tmp = load i64, i64* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$9"
  %sub4.i.prol = add i64 %tmp, %sub.i.prol
  %tmp2 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$8"
  %arrayidx5.i.prol = getelementptr inbounds i8, i8* %tmp2, i64 %arg1
  %tmp3 = load i8, i8* %arrayidx5.i.prol, align 1, !tbaa !10
  %idxprom.i.prol = zext i8 %tmp3 to i64
...
"main$0$2_recursively_call_function":             ; preds = %"main$0$2_increment_depth_counter"
  call void @"main$0$2"(i64 %prol.iter.sub, i64 %inc8.i.prol)
  ret void

"main$0$2_return_from_recursive_function$0":      ; preds = %"main$0$2_latch$0"
  %tmp4 = getelementptr %3, %3* @"main$0$2_return_value_struct", i32 0, i32 0
  store i64 %inc8.i.prol, i64* %tmp4
  ret void
}
...
"main$0$1_latch$0":
  %sub.i = xor i64 %arg, -1
  %tmp = load i64, i64* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$9"
  %sub4.i = add i64 %tmp, %sub.i
  %tmp1 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$8"
  %arrayidx5.i = getelementptr inbounds i8, i8* %tmp1, i64 %arg
  %tmp2 = load i8, i8* %arrayidx5.i, align 1, !tbaa !10
  %idxprom.i = zext i8 %tmp2 to i64
  ...
  %tmp3 = load i64, i64* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$9"
  %sub4.i.1 = add i64 %tmp3, %sub.i.1
  %tmp4 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$8"
  %arrayidx5.i.1 = getelementptr inbounds i8, i8* %tmp4, i64 %inc8.i
  %tmp5 = load i8, i8* %arrayidx5.i.1, align 1, !tbaa !10
  %idxprom.i.1 = zext i8 %tmp5 to i64
  ...
  %tmp6 = load i64, i64* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$9"
  %sub4.i.2 = add i64 %tmp6, %sub.i.2
  %tmp7 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$8"
  %arrayidx5.i.2 = getelementptr inbounds i8, i8* %tmp7, i64 %inc8.i.1
  %tmp8 = load i8, i8* %arrayidx5.i.2, align 1, !tbaa !10
  %idxprom.i.2 = zext i8 %tmp8 to i64
  ...
  %tmp9 = load i64, i64* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$9"
  %sub4.i.3 = add i64 %tmp9, %sub.i.3
  %tmp10 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$8"
  %arrayidx5.i.3 = getelementptr inbounds i8, i8* %tmp10, i64 %inc8.i.2
  %tmp11 = load i8, i8* %arrayidx5.i.3, align 1, !tbaa !10
  %idxprom.i.3 = zext i8 %tmp11 to i64
  ...
  %tmp12 = load i64, i64* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$9"
  %exitcond.3 = icmp eq i64 %inc8.i.3, %tmp12
...
"main$0$1_recursively_call_function":             ; preds = %"main$0$1_increment_depth_counter"
  call void @"main$0$1"(i64 %inc8.i.3)
  ret void
...
define void @"main$0$0"(i64 %arg, i64 %arg1) {
"main$0$0_header":
  %tmp = load i64, i64* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$11"
  %cmp236.i = icmp ult i64 %arg, %tmp
...
"main$0$0$0_call_recursive_function":             ; preds = %"main$0$0$0_initialize_context"
  call void @"main$0$0$0"(i64 %arg)
  br label %"main$0$0$0_branch_to_exit"

"main$0$0$0_branch_to_exit":                      ; preds = %"main$0$0$0_call_recursive_function"
  %tmp2 = getelementptr %5, %5* @"main$0$0$0_return_value_struct", i32 0, i32 3
  %tmp3 = load i8, i8* %tmp2
  switch i8 %tmp3, label %"main$0$0$0_extract_return_values$0" [
...
"main$0$0$0_extract_return_values$0":             ; preds = %"main$0$0$0_branch_to_exit", %"main$0$0$0_branch_to_exit"
  %tmp4 = getelementptr %5, %5* @"main$0$0$0_return_value_struct", i32 0, i32 1
  %tmp5 = load i64, i64* %tmp4
  %tmp6 = getelementptr %5, %5* @"main$0$0$0_return_value_struct", i32 0, i32 2
  %tmp7 = load i64, i64* %tmp6
  br label %while.cond.backedge.i.loopexit

"main$0$0$0_extract_return_values$1":             ; preds = %"main$0$0$0_branch_to_exit"
  %tmp8 = getelementptr %5, %5* @"main$0$0$0_return_value_struct", i32 0, i32 0
  %tmp9 = load i64, i64* %tmp8
...
"main$0$0_exiting$1":                             ; preds = %if.then.i.loopexit, %while.end.i
  %pos.134.i = phi i64 [ %arg, %while.end.i ], [ %tmp9, %if.then.i.loopexit ]
  %sub7.i = add i64 %pos.134.i, 1
  %tmp10 = load i64, i64* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$9"
  %add8.i = sub i64 %sub7.i, %tmp10
  %tmp11 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$10"
  %arrayidx9.i = getelementptr inbounds i8, i8* %tmp11, i64 %add8.i
  %tmp12 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$8"
  %tmp13 = load i64, i64* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$9"
  %call10.i = tail call i32 @strncmp(i8* %tmp12, i8* %arrayidx9.i, i64 %tmp13) #4
...
"main$0$0_latch$0":                               ; preds = %"main$0$0_exiting$1", %while.cond.backedge.i.loopexit, %while.end.i
  %pos.0.be.i = phi i64 [ %arg, %while.end.i ], [ %sub7.i, %"main$0$0_exiting$1" ], [ %tmp7, %while.cond.backedge.i.loopexit ]
  %shift.0.be.i = phi i64 [ %arg1, %while.end.i ], [ 0, %"main$0$0_exiting$1" ], [ %tmp5, %while.cond.backedge.i.loopexit ]
  %tmp14 = load i64, i64* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$11"
  %cmp.i = icmp ult i64 %pos.0.be.i, %tmp14
...
"main$0$0_recursively_call_function":             ; preds = %"main$0$0_increment_depth_counter"
  call void @"main$0$0"(i64 %pos.0.be.i, i64 %shift.0.be.i)
  ret void

"main$0$0_return_from_recursive_function$0":      ; preds = %"main$0$0_latch$0"
  %tmp15 = getelementptr %4, %4* @"main$0$0_return_value_struct", i32 0, i32 1
  store i8 1, i8* %tmp15
  ret void

"main$0$0_return_from_recursive_function$1":      ; preds = %"main$0$0_exiting$1"
  %tmp16 = getelementptr %4, %4* @"main$0$0_return_value_struct", i32 0, i32 0
  store i8* %arrayidx9.i, i8** %tmp16
  %tmp17 = getelementptr %4, %4* @"main$0$0_return_value_struct", i32 0, i32 1
  store i8 0, i8* %tmp17
  ret void
}

define void @"main$0$0$0"(i64 %arg) {
"main$0$0$0_exiting$1":
  %tmp = load i8*, i8** @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$10"
  %arrayidx.i26 = getelementptr inbounds i8, i8* %tmp, i64 %arg
  %tmp1 = load i8, i8* %arrayidx.i26, align 1, !tbaa !10
  %idxprom.i27 = zext i8 %tmp1 to i64
  %arrayidx3.i = getelementptr inbounds [256 x i64], [256 x i64]* @table, i64 0, i64 %idxprom.i27
  %tmp2 = load i64, i64* %arrayidx3.i, align 8, !tbaa !1
  %cmp4.i = icmp eq i64 %tmp2, 0
  %add.i = add i64 %tmp2, %arg
...
"main$0$0$0_latch$0":                             ; preds = %"main$0$0$0_exiting$1"
  %tmp3 = load i64, i64* @"./benchmark_intermediate_representations/baseline/pbmsrch/pbmsrch_small.ll_invariant_variable$11"
  %cmp2.i25 = icmp ult i64 %add.i, %tmp3
...
"main$0$0$0_recursively_call_function":           ; preds = %"main$0$0$0_increment_depth_counter"
  call void @"main$0$0$0"(i64 %add.i)
  ret void

"main$0$0$0_return_from_recursive_function$0":    ; preds = %"main$0$0$0_latch$0"
  %tmp4 = getelementptr %5, %5* @"main$0$0$0_return_value_struct", i32 0, i32 1
  store i64 %tmp2, i64* %tmp4
  %tmp5 = getelementptr %5, %5* @"main$0$0$0_return_value_struct", i32 0, i32 2
  store i64 %add.i, i64* %tmp5
  %tmp6 = getelementptr %5, %5* @"main$0$0$0_return_value_struct", i32 0, i32 3
  store i8 1, i8* %tmp6
  ret void

"main$0$0$0_return_from_recursive_function$1":    ; preds = %"main$0$0$0_exiting$1"
  %tmp7 = getelementptr %5, %5* @"main$0$0$0_return_value_struct", i32 0, i32 0
  store i64 %arg, i64* %tmp7
  %tmp8 = getelementptr %5, %5* @"main$0$0$0_return_value_struct", i32 0, i32 3
  store i8 0, i8* %tmp8
  ret void
}
