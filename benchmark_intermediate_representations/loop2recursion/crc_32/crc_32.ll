; ModuleID = './benchmark_intermediate_representations/loop2recursion/crc_32/crc_32.ll.temp'
...
"crc32file$0_initialize_context":                 ; preds = %while.body.preheader
  store %struct._IO_FILE* %call, %struct._IO_FILE** @"./benchmark_intermediate_representations/baseline/crc_32/crc_32.ll_invariant_variable$0"
  store i64* %charcnt, i64** @"./benchmark_intermediate_representations/baseline/crc_32/crc_32.ll_invariant_variable$1"
...
"crc32file$0_extract_return_values$0":            ; preds = %"crc32file$0_call_recursive_function"
  %tmp = getelementptr %0, %0* @"crc32file$0_return_value_struct", i32 0, i32 0
...
for.body.prol:                                    ; preds = %for.body.preheader
  %tmp = load i8, i8* %buf, align 1, !tbaa !5
  %conv.prol = zext i8 %tmp to i64
  %and.prol = xor i64 %conv.prol, 255
  %arrayidx.prol = getelementptr inbounds [256 x i64], [256 x i64]* @crc_32_tab, i64 0, i64 %and.prol
  %tmp1 = load i64, i64* %arrayidx.prol, align 8, !tbaa !1
  %xor1.prol = xor i64 %tmp1, 16777215
...
"crc32buf$0_call_recursive_function":             ; preds = %"crc32buf$0_initialize_context"
  call void @"crc32buf$0"(i8* %buf.addr.07.unr, i64 %len.addr.08.unr, i64 %oldcrc32.09.unr)
  br label %"crc32buf$0_extract_return_values$0"

"crc32buf$0_extract_return_values$0":             ; preds = %"crc32buf$0_call_recursive_function"
  %tmp3 = getelementptr %1, %1* @"crc32buf$0_return_value_struct", i32 0, i32 0
...
for.end.loopexit:                                 ; preds = %for.end.loopexit.unr-lcssa, %for.body.preheader.split
  %xor1.lcssa = phi i64 [ %xor1.lcssa.unr, %for.body.preheader.split ], [ %tmp4, %for.end.loopexit.unr-lcssa ]
...
entry:
  ...
  %tmp = bitcast i64* %crc to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* %tmp) #7
  %tmp1 = bitcast i64* %charcnt to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* %tmp1) #7
...
"main$0_initialize_context":                      ; preds = %while.body.preheader
  store i64* %charcnt, i64** @"./benchmark_intermediate_representations/baseline/crc_32/crc_32.ll_invariant_variable$2"
  store i64* %crc, i64** @"./benchmark_intermediate_representations/baseline/crc_32/crc_32.ll_invariant_variable$3"
  br label %"main$0_call_recursive_function"

"main$0_call_recursive_function":                 ; preds = %"main$0_initialize_context"
  call void @"main$0"(i32 %argc, i8** %argv, i32 0)
  br label %"main$0_extract_return_values$0"

"main$0_extract_return_values$0":                 ; preds = %"main$0_call_recursive_function"
  %tmp2 = getelementptr %2, %2* @"main$0_return_value_struct", i32 0, i32 0
  %tmp3 = load i32, i32* %tmp2
  br label %while.end.loopexit

while.end.loopexit:                               ; preds = %"main$0_extract_return_values$0"
  %phitmp = icmp ne i32 %tmp3, 0
  br label %while.end

while.end:                                        ; preds = %while.end.loopexit, %entry
  %errors.0.lcssa = phi i1 [ false, %entry ], [ %phitmp, %while.end.loopexit ]
  %conv = zext i1 %errors.0.lcssa to i32
  call void @llvm.lifetime.end.p0i8(i64 8, i8* %tmp1) #7
  call void @llvm.lifetime.end.p0i8(i64 8, i8* %tmp) #7
  ret i32 %conv
}
...
"crc32file$0_latch$0":
  %tmp = load i64*, i64** @"./benchmark_intermediate_representations/baseline/crc_32/crc_32.ll_invariant_variable$1"
  %tmp2 = load i64, i64* %tmp, align 8, !tbaa !1
  %inc = add nsw i64 %tmp2, 1
  %tmp3 = load i64*, i64** @"./benchmark_intermediate_representations/baseline/crc_32/crc_32.ll_invariant_variable$1"
  store i64 %inc, i64* %tmp3, align 8, !tbaa !1
  %conv = zext i32 %arg1 to i64
  %xor = xor i64 %conv, %arg
  %and = and i64 %xor, 255
  %arrayidx = getelementptr inbounds [256 x i64], [256 x i64]* @crc_32_tab, i64 0, i64 %and
  %tmp4 = load i64, i64* %arrayidx, align 8, !tbaa !1
  %shr = lshr i64 %arg, 8
  %xor4 = xor i64 %tmp4, %shr
  %tmp5 = load %struct._IO_FILE*, %struct._IO_FILE** @"./benchmark_intermediate_representations/baseline/crc_32/crc_32.ll_invariant_variable$0"
  %call1 = tail call i32 @_IO_getc(%struct._IO_FILE* nonnull %tmp5)
...
"crc32file$0_recursively_call_function":          ; preds = %"crc32file$0_increment_depth_counter"
  call void @"crc32file$0"(i64 %xor4, i32 %call1)
  ret void

"crc32file$0_return_from_recursive_function$0":   ; preds = %"crc32file$0_latch$0"
  %tmp6 = getelementptr %0, %0* @"crc32file$0_return_value_struct", i32 0, i32 0
  store i64 %xor4, i64* %tmp6
  ret void
}
...
"crc32buf$0_latch$0":
  ...
  %tmp5 = load i64, i64* %arrayidx.1, align 8, !tbaa !1
  %shr.1 = lshr i64 %xor1, 8
  %xor1.1 = xor i64 %tmp5, %shr.1
  %dec.1 = add i64 %arg1, -2
...
"crc32buf$0_recursively_call_function":           ; preds = %"crc32buf$0_increment_depth_counter"
  call void @"crc32buf$0"(i8* %incdec.ptr.1, i64 %dec.1, i64 %xor1.1)
  ret void

"crc32buf$0_return_from_recursive_function$0":    ; preds = %"crc32buf$0_latch$0"
  %tmp6 = getelementptr %1, %1* @"crc32buf$0_return_value_struct", i32 0, i32 0
  store i64 %xor1.1, i64* %tmp6
  ret void
}

define void @"main$0"(i32 %arg, i8** %arg1, i32 %arg2) {
"main$0_latch$0":
  %dec = add nsw i32 %arg, -1
  %incdec.ptr = getelementptr inbounds i8*, i8** %arg1, i64 1
  %tmp = load i8*, i8** %incdec.ptr, align 8, !tbaa !6
  %tmp3 = load i64*, i64** @"./benchmark_intermediate_representations/baseline/crc_32/crc_32.ll_invariant_variable$2"
  %tmp4 = load i64*, i64** @"./benchmark_intermediate_representations/baseline/crc_32/crc_32.ll_invariant_variable$3"
  %call = call i32 @crc32file(i8* %tmp, i64* nonnull %tmp4, i64* nonnull %tmp3)
  %or = or i32 %call, %arg2
  %tmp5 = load i64*, i64** @"./benchmark_intermediate_representations/baseline/crc_32/crc_32.ll_invariant_variable$3"
  %tmp6 = load i64, i64* %tmp5, align 8, !tbaa !1
  %tmp7 = load i64*, i64** @"./benchmark_intermediate_representations/baseline/crc_32/crc_32.ll_invariant_variable$2"
  %tmp8 = load i64, i64* %tmp7, align 8, !tbaa !1
  %tmp9 = load i8*, i8** %incdec.ptr, align 8, !tbaa !6
  %call1 = tail call i32 (i8*, ...) @printf(i8* nonnull getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1, i64 0, i64 0), i64 %tmp6, i64 %tmp8, i8* %tmp9)
...
"main$0_recursively_call_function":               ; preds = %"main$0_increment_depth_counter"
  call void @"main$0"(i32 %dec, i8** %incdec.ptr, i32 %or)
  ret void

"main$0_return_from_recursive_function$0":        ; preds = %"main$0_latch$0"
  %tmp10 = getelementptr %2, %2* @"main$0_return_value_struct", i32 0, i32 0
