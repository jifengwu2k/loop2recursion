; ModuleID = './benchmark_intermediate_representations/loop2recursion/rawcaudio/adpcm.ll.temp'
source_filename = "./benchmark_intermediate_representations/baseline/rawcaudio/adpcm.ll"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%0 = type { i32, i32, i1, i8*, i32 }
%1 = type { i32, i32 }
...
"adpcm_coder$0_call_recursive_function":          ; preds = %"adpcm_coder$0_initialize_context"
  call void @"adpcm_coder$0"(i8* %outdata, i16* %indata, i32 %len, i32 %tmp2, i32 %conv, i32 undef, i32 %conv2, i32 1)
...
"adpcm_coder$0_extract_return_values$0":          ; preds = %"adpcm_coder$0_call_recursive_function"
  %tmp3 = getelementptr %0, %0* @"adpcm_coder$0_return_value_struct", i32 0, i32 0
  %tmp4 = load i32, i32* %tmp3
  %tmp5 = getelementptr %0, %0* @"adpcm_coder$0_return_value_struct", i32 0, i32 1
  %tmp6 = load i32, i32* %tmp5
  %tmp7 = getelementptr %0, %0* @"adpcm_coder$0_return_value_struct", i32 0, i32 2
  %tmp8 = load i1, i1* %tmp7
  %tmp9 = getelementptr %0, %0* @"adpcm_coder$0_return_value_struct", i32 0, i32 3
  %tmp10 = load i8*, i8** %tmp9
  %tmp11 = getelementptr %0, %0* @"adpcm_coder$0_return_value_struct", i32 0, i32 4
  %tmp12 = load i32, i32* %tmp11
  br label %for.end

for.end:                                          ; preds = %"adpcm_coder$0_extract_return_values$0"
  br i1 %tmp8, label %if.then65, label %if.end68

if.then65:                                        ; preds = %for.end
  %conv66 = trunc i32 %tmp12 to i8
  store i8 %conv66, i8* %tmp10, align 1, !tbaa !9
  br label %if.end68

if.end68:                                         ; preds = %if.then65, %for.end, %entry
  %valpred.0.lcssa141 = phi i32 [ %tmp4, %for.end ], [ %tmp4, %if.then65 ], [ %conv, %entry ]
  %index.0.lcssa140 = phi i32 [ %tmp6, %for.end ], [ %tmp6, %if.then65 ], [ %conv2, %entry ]
...
"adpcm_decoder$0_call_recursive_function":        ; preds = %"adpcm_decoder$0_initialize_context"
  call void @"adpcm_decoder$0"(i8* %indata, i16* %outdata, i32 %len, i32 %tmp2, i32 %conv, i32 undef, i32 %conv2, i32 0)
...
"adpcm_decoder$0_extract_return_values$0":        ; preds = %"adpcm_decoder$0_call_recursive_function"
  %tmp3 = getelementptr %1, %1* @"adpcm_decoder$0_return_value_struct", i32 0, i32 0
  %tmp4 = load i32, i32* %tmp3
  %tmp5 = getelementptr %1, %1* @"adpcm_decoder$0_return_value_struct", i32 0, i32 1
  %tmp6 = load i32, i32* %tmp5
...
for.end:                                          ; preds = %for.end.loopexit, %entry
  %index.0.lcssa = phi i32 [ %conv2, %entry ], [ %tmp4, %for.end.loopexit ]
  %valpred.0.lcssa = phi i32 [ %conv, %entry ], [ %tmp6, %for.end.loopexit ]
...
define void @"adpcm_coder$0"(i8* %arg, i16* %arg1, i32 %arg2, i32 %arg3, i32 %arg4, i32 %arg5, i32 %arg6, i32 %arg7) {
"adpcm_coder$0_header":
  %incdec.ptr = getelementptr inbounds i16, i16* %arg1, i64 1
  %tmp = load i16, i16* %arg1, align 2, !tbaa !10
  %conv4 = sext i16 %tmp to i32
  %sub = sub nsw i32 %conv4, %arg4
  %cmp5 = icmp slt i32 %sub, 0
  %tmp8 = ashr i32 %sub, 31
  %tmp9 = and i32 %tmp8, 8
  %sub7 = sub nsw i32 0, %sub
  %sub7.sub = select i1 %cmp5, i32 %sub7, i32 %sub
  %shr = ashr i32 %arg3, 3
  %cmp8 = icmp slt i32 %sub7.sub, %arg3
  %delta.0 = select i1 %cmp8, i32 0, i32 4
  %sub11 = select i1 %cmp8, i32 0, i32 %arg3
  %diff.1 = sub nsw i32 %sub7.sub, %sub11
  %vpdiff.0 = add nsw i32 %sub11, %shr
  %shr13 = ashr i32 %arg3, 1
...
if.end19:                                         ; preds = %if.then16, %"adpcm_coder$0_header"
  ...
  %shr20 = ashr i32 %arg3, 2
  %cmp21 = icmp slt i32 %diff.2, %shr20
  %tmp10 = zext i1 %cmp21 to i32
  %or24 = xor i32 %tmp10, 1
  %add25 = select i1 %cmp21, i32 0, i32 %shr20
  %vpdiff.2 = add nsw i32 %add25, %vpdiff.1
  %tmp11 = sub i32 0, %vpdiff.2
  %valpred.1.p = select i1 %cmp5, i32 %tmp11, i32 %vpdiff.2
  ...
  %tmp12 = load i32, i32* %arrayidx43, align 4, !tbaa !7
  %add44 = add nsw i32 %tmp12, %arg6
  ...
  %tmp13 = load i32, i32* %arrayidx54, align 4, !tbaa !7
  %tobool55 = icmp ne i32 %arg7, 0
  br i1 %tobool55, label %if.then56, label %if.else57

if.else57:                                        ; preds = %if.end19
  %and58 = and i32 %or41, 15
  %or59 = or i32 %and58, %arg5
  %conv60 = trunc i32 %or59 to i8
  %incdec.ptr61 = getelementptr inbounds i8, i8* %arg, i64 1
  store i8 %conv60, i8* %arg, align 1, !tbaa !9
...
"adpcm_coder$0_latch$0":                          ; preds = %if.then56, %if.else57
  %outp.1 = phi i8* [ %arg, %if.then56 ], [ %incdec.ptr61, %if.else57 ]
  %outputbuffer.1 = phi i32 [ %and, %if.then56 ], [ %arg5, %if.else57 ]
  %tmp14 = zext i1 %tobool55 to i32
  %lnot.ext = xor i32 %tmp14, 1
...
"adpcm_coder$0_recursively_call_function":        ; preds = %"adpcm_coder$0_increment_depth_counter"
  call void @"adpcm_coder$0"(i8* %outp.1, i16* %incdec.ptr, i32 %dec, i32 %tmp13, i32 %valpred.2, i32 %outputbuffer.1, i32 %..add44, i32 %lnot.ext)
  ret void

"adpcm_coder$0_return_from_recursive_function$0": ; preds = %"adpcm_coder$0_latch$0"
  %tmp15 = getelementptr %0, %0* @"adpcm_coder$0_return_value_struct", i32 0, i32 0
  store i32 %valpred.2, i32* %tmp15
  %tmp16 = getelementptr %0, %0* @"adpcm_coder$0_return_value_struct", i32 0, i32 1
  store i32 %..add44, i32* %tmp16
  %tmp17 = getelementptr %0, %0* @"adpcm_coder$0_return_value_struct", i32 0, i32 2
  store i1 %tobool55, i1* %tmp17
  %tmp18 = getelementptr %0, %0* @"adpcm_coder$0_return_value_struct", i32 0, i32 3
  store i8* %outp.1, i8** %tmp18
  %tmp19 = getelementptr %0, %0* @"adpcm_coder$0_return_value_struct", i32 0, i32 4
  store i32 %outputbuffer.1, i32* %tmp19
  ret void
}

define void @"adpcm_decoder$0"(i8* %arg, i16* %arg1, i32 %arg2, i32 %arg3, i32 %arg4, i32 %arg5, i32 %arg6, i32 %arg7) {
"adpcm_decoder$0_header":
  %tobool = icmp ne i32 %arg7, 0
...
if.else:                                          ; preds = %"adpcm_decoder$0_header"
  ...
  %tmp = load i8, i8* %arg, align 1, !tbaa !9
  %conv4 = sext i8 %tmp to i32
...
"adpcm_decoder$0_latch$0":                        ; preds = %if.else, %"adpcm_decoder$0_header"
  ...
  %delta.0.in = phi i32 [ %shr95, %if.else ], [ %arg5, %"adpcm_decoder$0_header" ]
  %inputbuffer.1 = phi i32 [ %conv4, %if.else ], [ %arg5, %"adpcm_decoder$0_header" ]
  %delta.0 = and i32 %delta.0.in, 15
  %tmp8 = zext i1 %tobool to i32
  %lnot.ext = xor i32 %tmp8, 1
  %idxprom796 = zext i32 %delta.0 to i64
  %arrayidx8 = getelementptr inbounds [16 x i32], [16 x i32]* @indexTable, i64 0, i64 %idxprom796
  %tmp9 = load i32, i32* %arrayidx8, align 4, !tbaa !7
  %add = add nsw i32 %tmp9, %arg6
  ...
  %tmp11 = load i32, i32* %arrayidx52, align 4, !tbaa !7
  %conv53 = trunc i32 %valpred.2 to i16
  %incdec.ptr54 = getelementptr inbounds i16, i16* %arg1, i64 1
  store i16 %conv53, i16* %arg1, align 2, !tbaa !10
  %dec = add nsw i32 %arg2, -1
  %cmp = icmp sgt i32 %arg2, 1
...
"adpcm_decoder$0_recursively_call_function":      ; preds = %"adpcm_decoder$0_increment_depth_counter"
  call void @"adpcm_decoder$0"(i8* %inp.1, i16* %incdec.ptr54, i32 %dec, i32 %tmp11, i32 %valpred.2, i32 %inputbuffer.1, i32 %..add, i32 %lnot.ext)
  ret void

"adpcm_decoder$0_return_from_recursive_function$0": ; preds = %"adpcm_decoder$0_latch$0"
  %tmp12 = getelementptr %1, %1* @"adpcm_decoder$0_return_value_struct", i32 0, i32 0
  store i32 %..add, i32* %tmp12
  %tmp13 = getelementptr %1, %1* @"adpcm_decoder$0_return_value_struct", i32 0, i32 1
  store i32 %valpred.2, i32* %tmp13
  ret void
}
