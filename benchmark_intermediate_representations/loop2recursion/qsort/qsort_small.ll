; ModuleID = './benchmark_intermediate_representations/loop2recursion/qsort/qsort_small.ll.temp'
...
entry:
  ...
  %tmp = getelementptr inbounds [60000 x %struct.myStringStruct], [60000 x %struct.myStringStruct]* %array, i64 0, i64 0, i32 0, i64 0
  call void @llvm.lifetime.start.p0i8(i64 7680000, i8* %tmp) #6
  %cmp = icmp slt i32 %argc, 2
  br i1 %cmp, label %if.then, label %if.else

if.then:                                          ; preds = %entry
  %tmp1 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !1
  %tmp2 = tail call i64 @fwrite(i8* nonnull getelementptr inbounds ([27 x i8], [27 x i8]* @.str, i64 0, i64 0), i64 26, i64 1, %struct._IO_FILE* %tmp1) #9
  tail call void @exit(i32 -1) #10
  unreachable

if.else:                                          ; preds = %entry
  %arrayidx = getelementptr inbounds i8*, i8** %argv, i64 1
  %tmp3 = load i8*, i8** %arrayidx, align 8, !tbaa !1
  %call1 = tail call %struct._IO_FILE* @fopen(i8* %tmp3, i8* nonnull getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0))
  br label %"main$1_initialize_context"

"main$1_initialize_context":                      ; preds = %if.else
  store %struct._IO_FILE* %call1, %struct._IO_FILE** @"./benchmark_intermediate_representations/baseline/qsort/qsort_small.ll_invariant_variable$0"
  store [60000 x %struct.myStringStruct]* %array, [60000 x %struct.myStringStruct]** @"./benchmark_intermediate_representations/baseline/qsort/qsort_small.ll_invariant_variable$1"
...
"main$1_extract_return_values$0":                 ; preds = %"main$1_call_recursive_function"
  %tmp4 = getelementptr %0, %0* @"main$1_return_value_struct", i32 0, i32 0
  %tmp5 = load i64, i64* %tmp4
  br label %if.end

if.end:                                           ; preds = %"main$1_extract_return_values$0"
  %tmp6 = trunc i64 %tmp5 to i32
  %call6 = call i32 (i8*, ...) @printf(i8* nonnull getelementptr inbounds ([24 x i8], [24 x i8]* @.str.3, i64 0, i64 0), i32 %tmp6)
  call void @qsort(i8* %tmp, i64 %tmp5, i64 128, i32 (i8*, i8*)* nonnull @compare) #6
  %cmp724 = icmp sgt i32 %tmp6, 0
...
"main$0_initialize_context":                      ; preds = %for.body.preheader
  store i32 %tmp6, i32* @"./benchmark_intermediate_representations/baseline/qsort/qsort_small.ll_invariant_variable$2"
  store [60000 x %struct.myStringStruct]* %array, [60000 x %struct.myStringStruct]** @"./benchmark_intermediate_representations/baseline/qsort/qsort_small.ll_invariant_variable$1"
...
for.end:                                          ; preds = %for.end.loopexit, %if.end
  call void @llvm.lifetime.end.p0i8(i64 7680000, i8* %tmp) #6
  ret i32 0
}
...
"main$1_latch$0":
  %tmp = load [60000 x %struct.myStringStruct]*, [60000 x %struct.myStringStruct]** @"./benchmark_intermediate_representations/baseline/qsort/qsort_small.ll_invariant_variable$1"
  %qstring = getelementptr inbounds [60000 x %struct.myStringStruct], [60000 x %struct.myStringStruct]* %tmp, i64 0, i64 %arg, i32 0
  %tmp1 = load %struct._IO_FILE*, %struct._IO_FILE** @"./benchmark_intermediate_representations/baseline/qsort/qsort_small.ll_invariant_variable$0"
  %call3 = call i32 (%struct._IO_FILE*, i8*, ...) @__isoc99_fscanf(%struct._IO_FILE* %tmp1, i8* nonnull getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), [128 x i8]* %qstring) #6
  %cmp4 = icmp eq i32 %call3, 1
  %cmp5 = icmp slt i64 %arg, 60000
  %tmp2 = and i1 %cmp5, %cmp4
  %indvars.iv.next27 = add nuw nsw i64 %arg, 1
  br i1 %tmp2, label %"main$1_increment_depth_counter", label %"main$1_return_from_recursive_function$0"
...
"main$1_recursively_call_function":               ; preds = %"main$1_increment_depth_counter"
  call void @"main$1"(i64 %indvars.iv.next27)
  ret void

"main$1_return_from_recursive_function$0":        ; preds = %"main$1_latch$0"
  %tmp3 = getelementptr %0, %0* @"main$1_return_value_struct", i32 0, i32 0
  store i64 %arg, i64* %tmp3
  ret void
}
...
"main$0_latch$0":
  %tmp = load [60000 x %struct.myStringStruct]*, [60000 x %struct.myStringStruct]** @"./benchmark_intermediate_representations/baseline/qsort/qsort_small.ll_invariant_variable$1"
  %arraydecay12 = getelementptr inbounds [60000 x %struct.myStringStruct], [60000 x %struct.myStringStruct]* %tmp, i64 0, i64 %arg, i32 0, i64 0
  %puts = call i32 @puts(i8* %arraydecay12)
  %indvars.iv.next = add nuw nsw i64 %arg, 1
  %lftr.wideiv = trunc i64 %indvars.iv.next to i32
  %tmp1 = load i32, i32* @"./benchmark_intermediate_representations/baseline/qsort/qsort_small.ll_invariant_variable$2"
  %exitcond = icmp eq i32 %lftr.wideiv, %tmp1
