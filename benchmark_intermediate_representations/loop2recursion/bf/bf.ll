; ModuleID = './benchmark_intermediate_representations/loop2recursion/bf/bf.ll.temp'
...
@"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$3" = dso_local global i32* null
...
@"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$6" = dso_local global %struct.bf_key_st* null
@"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$7" = dso_local global i8* null
@"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$8" = dso_local global i8* null
@"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$9" = dso_local global i32 0
@"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$10" = dso_local global %struct._IO_FILE* null
...
entry:
  ...
  %tmp = bitcast %struct.bf_key_st* %key to i8*
  call void @llvm.lifetime.start.p0i8(i64 8336, i8* %tmp) #4
  %tmp1 = getelementptr inbounds [8 x i8], [8 x i8]* %ukey, i64 0, i64 0
  call void @llvm.lifetime.start.p0i8(i64 8, i8* %tmp1) #4
  %tmp2 = getelementptr inbounds [40 x i8], [40 x i8]* %indata, i64 0, i64 0
  call void @llvm.lifetime.start.p0i8(i64 40, i8* %tmp2) #4
  %tmp3 = getelementptr inbounds [40 x i8], [40 x i8]* %outdata, i64 0, i64 0
  call void @llvm.lifetime.start.p0i8(i64 40, i8* %tmp3) #4
  %tmp4 = getelementptr inbounds [8 x i8], [8 x i8]* %ivec, i64 0, i64 0
  call void @llvm.lifetime.start.p0i8(i64 8, i8* %tmp4) #4
  %tmp5 = bitcast i32* %num to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %tmp5) #4
...
if.end:                                           ; preds = %entry
  ...
  %tmp6 = load i8*, i8** %arrayidx, align 8, !tbaa !1
  %tmp7 = load i8, i8* %tmp6, align 1, !tbaa !5
  switch i8 %tmp7, label %if.else18 [
...
if.end21:                                         ; preds = %if.then17, %if.end, %if.end
  ...
  %tmp8 = load i8*, i8** %arrayidx22, align 8, !tbaa !1
  br label %"main$1_initialize_context"

"main$1_initialize_context":                      ; preds = %if.end21
  store [8 x i8]* %ukey, [8 x i8]** @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$0"
  br label %"main$1_call_recursive_function"

"main$1_call_recursive_function":                 ; preds = %"main$1_initialize_context"
  call void @"main$1"(i8* %tmp8, i32 0, i32 0)
  br label %"main$1_branch_to_exit"

"main$1_branch_to_exit":                          ; preds = %"main$1_call_recursive_function"
  %tmp9 = getelementptr %0, %0* @"main$1_return_value_struct", i32 0, i32 1
  %tmp10 = load i8, i8* %tmp9
  switch i8 %tmp10, label %"main$1_extract_return_values$0" [
...
"main$1_extract_return_values$1":                 ; preds = %"main$1_branch_to_exit"
  %tmp11 = getelementptr %0, %0* @"main$1_return_value_struct", i32 0, i32 0
...
while.end:                                        ; preds = %"main$1_extract_return_values$1"
  call void @BF_set_key(%struct.bf_key_st* nonnull %key, i32 8, i8* %tmp1) #4
  %tmp13 = load i8, i8* %tmp12, align 1, !tbaa !5
  %tobool62 = icmp eq i8 %tmp13, 0
...
if.end65:                                         ; preds = %while.end
  ...
  %tmp14 = load i8*, i8** %arrayidx66, align 8, !tbaa !1
  %call67 = call %struct._IO_FILE* @fopen(i8* %tmp14, i8* nonnull getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i64 0, i64 0))
...
if.end72:                                         ; preds = %if.end65
  ...
  %tmp15 = load i8*, i8** %arrayidx73, align 8, !tbaa !1
  %call74 = call %struct._IO_FILE* @fopen(i8* %tmp15, i8* nonnull getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4, i64 0, i64 0))
...
"main$0_initialize_context":                      ; preds = %while.cond84.preheader.preheader
  store [40 x i8]* %outdata, [40 x i8]** @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$1"
  store [40 x i8]* %indata, [40 x i8]** @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$2"
  store i32* %num, i32** @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$3"
  store i8* %tmp4, i8** @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$4"
  store %struct._IO_FILE* %call74, %struct._IO_FILE** @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$5"
  store %struct.bf_key_st* %key, %struct.bf_key_st** @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$6"
  store i8* %tmp3, i8** @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$7"
  store i8* %tmp2, i8** @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$8"
  store i32 %encordec.0, i32* @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$9"
  store %struct._IO_FILE* %call67, %struct._IO_FILE** @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$10"
...
while.body:                                       ; preds = %"main$1_exiting$2"
  ...
  %tmp3 = icmp ult i32 %sext.off, 184549375
  br i1 %tmp3, label %if.then35, label %"main$1_exiting$1"

"main$1_exiting$1":                               ; preds = %while.body
  %sext.off146 = add i32 %sext, -1073741825
  %tmp4 = icmp ult i32 %sext.off146, 117440511
  br i1 %tmp4, label %if.then45, label %"main$1_return_from_recursive_function$0"

if.then45:                                        ; preds = %"main$1_exiting$1"
...
if.then56:                                        ; preds = %if.end54
  ...
  %tmp5 = load [8 x i8]*, [8 x i8]** @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$0"
  %arrayidx60 = getelementptr inbounds [8 x i8], [8 x i8]* %tmp5, i64 0, i64 %idxprom
...
"main$1_recursively_call_function":               ; preds = %"main$1_increment_depth_counter"
  call void @"main$1"(i8* %incdec.ptr, i32 %inc, i32 %sub)
  ret void

"main$1_return_from_recursive_function$0":        ; preds = %"main$1_exiting$1"
  %tmp6 = getelementptr %0, %0* @"main$1_return_value_struct", i32 0, i32 1
  store i8 1, i8* %tmp6
  ret void

"main$1_return_from_recursive_function$1":        ; preds = %"main$1_latch$0", %"main$1_exiting$2"
  %tmp7 = phi i8* [ %arg, %"main$1_exiting$2" ], [ %incdec.ptr, %"main$1_latch$0" ]
  %tmp8 = getelementptr %0, %0* @"main$1_return_value_struct", i32 0, i32 0
...
define void @"main$0"() {
"main$0_header":
  %tmp = load %struct._IO_FILE*, %struct._IO_FILE** @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$10"
  %call85148 = call i32 @feof(%struct._IO_FILE* nonnull %tmp) #4
...
while.end97.thread:                               ; preds = %"main$0_header"
  %tmp1 = load i32*, i32** @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$3"
  %tmp2 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$4"
  %tmp3 = load %struct.bf_key_st*, %struct.bf_key_st** @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$6"
  %tmp4 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$7"
  %tmp5 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$8"
  %tmp6 = load i32, i32* @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$9"
  call void @BF_cfb64_encrypt(i8* %tmp5, i8* %tmp4, i64 0, %struct.bf_key_st* nonnull %tmp3, i8* %tmp2, i32* nonnull %tmp1, i32 %tmp6) #4
...
"main$0$1_extract_return_values$0":               ; preds = %"main$0$1_call_recursive_function"
  %tmp7 = getelementptr %1, %1* @"main$0$1_return_value_struct", i32 0, i32 0
  %tmp8 = load i64, i64* %tmp7
  br label %while.end97

while.end97:                                      ; preds = %"main$0$1_extract_return_values$0"
  %tmp9 = trunc i64 %tmp8 to i32
  %sext162 = shl i64 %tmp8, 32
  %conv100 = ashr exact i64 %sext162, 32
  %tmp10 = load i32*, i32** @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$3"
  %tmp11 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$4"
  %tmp12 = load %struct.bf_key_st*, %struct.bf_key_st** @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$6"
  %tmp13 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$7"
  %tmp14 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$8"
  %tmp15 = load i32, i32* @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$9"
  call void @BF_cfb64_encrypt(i8* nonnull %tmp14, i8* %tmp13, i64 %conv100, %struct.bf_key_st* nonnull %tmp12, i8* %tmp11, i32* nonnull %tmp10, i32 %tmp15) #4
  %cmp102151 = icmp sgt i32 %tmp9, 0
...
"main$0$0_initialize_context":                    ; preds = %for.body.preheader
  store i32 %tmp9, i32* @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$11"
...
"main$0_latch$0":                                 ; preds = %while.cond80.loopexit.loopexit, %while.end97, %while.end97.thread
  %tmp16 = load %struct._IO_FILE*, %struct._IO_FILE** @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$10"
  %call81 = call i32 @feof(%struct._IO_FILE* nonnull %tmp16) #4
...
"main$0$1_latch$0":
  %tmp = load %struct._IO_FILE*, %struct._IO_FILE** @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$10"
  %call92 = call i32 @_IO_getc(%struct._IO_FILE* nonnull %tmp)
  %conv93 = trunc i32 %call92 to i8
  %indvars.iv.next = add nuw nsw i64 %arg, 1
  %tmp1 = load [40 x i8]*, [40 x i8]** @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$2"
  %arrayidx96 = getelementptr inbounds [40 x i8], [40 x i8]* %tmp1, i64 0, i64 %arg
  store i8 %conv93, i8* %arrayidx96, align 1, !tbaa !5
  %tmp2 = load %struct._IO_FILE*, %struct._IO_FILE** @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$10"
  %call85 = call i32 @feof(%struct._IO_FILE* nonnull %tmp2) #4
  %cmp88 = icmp slt i64 %indvars.iv.next, 40
  %not.tobool86 = icmp eq i32 %call85, 0
  %tmp3 = and i1 %cmp88, %not.tobool86
  br i1 %tmp3, label %"main$0$1_increment_depth_counter", label %"main$0$1_return_from_recursive_function$0"
...
"main$0$1_return_from_recursive_function$0":      ; preds = %"main$0$1_latch$0"
  %tmp4 = getelementptr %1, %1* @"main$0$1_return_value_struct", i32 0, i32 0
  store i64 %indvars.iv.next, i64* %tmp4
  ret void
}

define void @"main$0$0"(i64 %arg) {
"main$0$0_latch$0":
  %tmp = load [40 x i8]*, [40 x i8]** @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$1"
  %arrayidx105 = getelementptr inbounds [40 x i8], [40 x i8]* %tmp, i64 0, i64 %arg
  %tmp1 = load i8, i8* %arrayidx105, align 1, !tbaa !5
  %conv106 = zext i8 %tmp1 to i32
  %tmp2 = load %struct._IO_FILE*, %struct._IO_FILE** @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$5"
  %call107 = call i32 @fputc(i32 %conv106, %struct._IO_FILE* nonnull %tmp2)
  %indvars.iv.next159 = add nuw nsw i64 %arg, 1
  %lftr.wideiv = trunc i64 %indvars.iv.next159 to i32
  %tmp3 = load i32, i32* @"./benchmark_intermediate_representations/baseline/bf/bf.ll_invariant_variable$11"
  %exitcond = icmp eq i32 %lftr.wideiv, %tmp3
