; ModuleID = './benchmark_intermediate_representations/loop2recursion/bf/bf_skey.ll.temp'
...
entry:
  ...
  %tmp = bitcast <2 x i64>* %in to i8*
  call void @llvm.lifetime.start.p0i8(i64 16, i8* %tmp) #3
  %tmp1 = bitcast %struct.bf_key_st* %key to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %tmp1, i8* align 1 bitcast (%struct.bf_key_st* @bf_init to i8*), i64 8336, i1 false)
...
"BF_set_key$1_initialize_context":                ; preds = %entry
  store %struct.bf_key_st* %key, %struct.bf_key_st** @"./benchmark_intermediate_representations/baseline/bf/bf_skey.ll_invariant_variable$0"
  store i8* %data, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_skey.ll_invariant_variable$1"
  store i8* %arrayidx, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_skey.ll_invariant_variable$2"
  br label %"BF_set_key$1_call_recursive_function"

"BF_set_key$1_call_recursive_function":           ; preds = %"BF_set_key$1_initialize_context"
  call void @"BF_set_key$1"(i8* %data, i64 0, i64 608135816)
  br label %for.end

for.end:                                          ; preds = %"BF_set_key$1_call_recursive_function"
  %arrayidx30 = getelementptr inbounds <2 x i64>, <2 x i64>* %in, i64 0, i64 0
  %tmp2 = bitcast <2 x i64>* %in to i8*
  call void @llvm.memset.p0i8.i64(i8* align 16 %tmp2, i8 0, i64 16, i1 false)
  call void @BF_encrypt(i64* %arrayidx30, %struct.bf_key_st* nonnull %key, i32 1) #3
  %tmp3 = load <2 x i64>, <2 x i64>* %in, align 16, !tbaa !1
  %tmp4 = bitcast %struct.bf_key_st* %key to <2 x i64>*
  store <2 x i64> %tmp3, <2 x i64>* %tmp4, align 8, !tbaa !1
  call void @BF_encrypt(i64* %arrayidx30, %struct.bf_key_st* nonnull %key, i32 1) #3
  %arrayidx39.1 = getelementptr inbounds %struct.bf_key_st, %struct.bf_key_st* %key, i64 0, i32 0, i64 2
  %tmp5 = load <2 x i64>, <2 x i64>* %in, align 16, !tbaa !1
  %tmp6 = bitcast i64* %arrayidx39.1 to <2 x i64>*
  store <2 x i64> %tmp5, <2 x i64>* %tmp6, align 8, !tbaa !1
  call void @BF_encrypt(i64* %arrayidx30, %struct.bf_key_st* nonnull %key, i32 1) #3
  %arrayidx39.2 = getelementptr inbounds %struct.bf_key_st, %struct.bf_key_st* %key, i64 0, i32 0, i64 4
  %tmp7 = load <2 x i64>, <2 x i64>* %in, align 16, !tbaa !1
  %tmp8 = bitcast i64* %arrayidx39.2 to <2 x i64>*
  store <2 x i64> %tmp7, <2 x i64>* %tmp8, align 8, !tbaa !1
  call void @BF_encrypt(i64* %arrayidx30, %struct.bf_key_st* nonnull %key, i32 1) #3
  %arrayidx39.3 = getelementptr inbounds %struct.bf_key_st, %struct.bf_key_st* %key, i64 0, i32 0, i64 6
  %tmp9 = load <2 x i64>, <2 x i64>* %in, align 16, !tbaa !1
  %tmp10 = bitcast i64* %arrayidx39.3 to <2 x i64>*
  store <2 x i64> %tmp9, <2 x i64>* %tmp10, align 8, !tbaa !1
  call void @BF_encrypt(i64* %arrayidx30, %struct.bf_key_st* nonnull %key, i32 1) #3
  %arrayidx39.4 = getelementptr inbounds %struct.bf_key_st, %struct.bf_key_st* %key, i64 0, i32 0, i64 8
  %tmp11 = load <2 x i64>, <2 x i64>* %in, align 16, !tbaa !1
  %tmp12 = bitcast i64* %arrayidx39.4 to <2 x i64>*
  store <2 x i64> %tmp11, <2 x i64>* %tmp12, align 8, !tbaa !1
  call void @BF_encrypt(i64* %arrayidx30, %struct.bf_key_st* nonnull %key, i32 1) #3
  %arrayidx39.5 = getelementptr inbounds %struct.bf_key_st, %struct.bf_key_st* %key, i64 0, i32 0, i64 10
  %tmp13 = load <2 x i64>, <2 x i64>* %in, align 16, !tbaa !1
  %tmp14 = bitcast i64* %arrayidx39.5 to <2 x i64>*
  store <2 x i64> %tmp13, <2 x i64>* %tmp14, align 8, !tbaa !1
  call void @BF_encrypt(i64* %arrayidx30, %struct.bf_key_st* nonnull %key, i32 1) #3
  %arrayidx39.6 = getelementptr inbounds %struct.bf_key_st, %struct.bf_key_st* %key, i64 0, i32 0, i64 12
  %tmp15 = load <2 x i64>, <2 x i64>* %in, align 16, !tbaa !1
  %tmp16 = bitcast i64* %arrayidx39.6 to <2 x i64>*
  store <2 x i64> %tmp15, <2 x i64>* %tmp16, align 8, !tbaa !1
  call void @BF_encrypt(i64* %arrayidx30, %struct.bf_key_st* nonnull %key, i32 1) #3
  %arrayidx39.7 = getelementptr inbounds %struct.bf_key_st, %struct.bf_key_st* %key, i64 0, i32 0, i64 14
  %tmp17 = load <2 x i64>, <2 x i64>* %in, align 16, !tbaa !1
  %tmp18 = bitcast i64* %arrayidx39.7 to <2 x i64>*
  store <2 x i64> %tmp17, <2 x i64>* %tmp18, align 8, !tbaa !1
  call void @BF_encrypt(i64* %arrayidx30, %struct.bf_key_st* nonnull %key, i32 1) #3
  %arrayidx39.8 = getelementptr inbounds %struct.bf_key_st, %struct.bf_key_st* %key, i64 0, i32 0, i64 16
  %tmp19 = load <2 x i64>, <2 x i64>* %in, align 16, !tbaa !1
  %tmp20 = bitcast i64* %arrayidx39.8 to <2 x i64>*
  store <2 x i64> %tmp19, <2 x i64>* %tmp20, align 8, !tbaa !1
  br label %"BF_set_key$0_initialize_context"

"BF_set_key$0_initialize_context":                ; preds = %for.end
  store <2 x i64>* %in, <2 x i64>** @"./benchmark_intermediate_representations/baseline/bf/bf_skey.ll_invariant_variable$3"
  store %struct.bf_key_st* %key, %struct.bf_key_st** @"./benchmark_intermediate_representations/baseline/bf/bf_skey.ll_invariant_variable$0"
  store i64* %arrayidx30, i64** @"./benchmark_intermediate_representations/baseline/bf/bf_skey.ll_invariant_variable$4"
...
"BF_set_key$1_exiting$0":
  %incdec.ptr = getelementptr inbounds i8, i8* %arg, i64 1
  %tmp = load i8, i8* %arg, align 1, !tbaa !5
  %conv = zext i8 %tmp to i64
  %tmp3 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_skey.ll_invariant_variable$2"
  %cmp2 = icmp ult i8* %incdec.ptr, %tmp3
  %tmp4 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_skey.ll_invariant_variable$1"
  %incdec.ptr.data = select i1 %cmp2, i8* %incdec.ptr, i8* %tmp4
  %shl = shl nuw nsw i64 %conv, 8
  %incdec.ptr6 = getelementptr inbounds i8, i8* %incdec.ptr.data, i64 1
  %tmp5 = load i8, i8* %incdec.ptr.data, align 1, !tbaa !5
  %conv7 = zext i8 %tmp5 to i64
  %or = or i64 %shl, %conv7
  %tmp6 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_skey.ll_invariant_variable$2"
  %cmp8 = icmp ult i8* %incdec.ptr6, %tmp6
  %tmp7 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_skey.ll_invariant_variable$1"
  %d.2 = select i1 %cmp8, i8* %incdec.ptr6, i8* %tmp7
  %shl12 = shl nuw nsw i64 %or, 8
  %incdec.ptr13 = getelementptr inbounds i8, i8* %d.2, i64 1
  %tmp8 = load i8, i8* %d.2, align 1, !tbaa !5
  %conv14 = zext i8 %tmp8 to i64
  %or15 = or i64 %shl12, %conv14
  %tmp9 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_skey.ll_invariant_variable$2"
  %cmp16 = icmp ult i8* %incdec.ptr13, %tmp9
  %tmp10 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_skey.ll_invariant_variable$1"
  %incdec.ptr13.data = select i1 %cmp16, i8* %incdec.ptr13, i8* %tmp10
  %shl20 = shl nuw nsw i64 %or15, 8
  %incdec.ptr21 = getelementptr inbounds i8, i8* %incdec.ptr13.data, i64 1
  %tmp11 = load i8, i8* %incdec.ptr13.data, align 1, !tbaa !5
  %conv22 = zext i8 %tmp11 to i64
  %or23 = or i64 %shl20, %conv22
  %tmp12 = load %struct.bf_key_st*, %struct.bf_key_st** @"./benchmark_intermediate_representations/baseline/bf/bf_skey.ll_invariant_variable$0"
  %arrayidx29 = getelementptr inbounds %struct.bf_key_st, %struct.bf_key_st* %tmp12, i64 0, i32 0, i64 %arg1
  %xor = xor i64 %or23, %arg2
  store i64 %xor, i64* %arrayidx29, align 8, !tbaa !1
  %indvars.iv.next116 = add nuw nsw i64 %arg1, 1
...
"BF_set_key$1_latch$0":                           ; preds = %"BF_set_key$1_exiting$0"
  %tmp13 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_skey.ll_invariant_variable$2"
  %cmp24 = icmp ult i8* %incdec.ptr21, %tmp13
  %tmp14 = load i8*, i8** @"./benchmark_intermediate_representations/baseline/bf/bf_skey.ll_invariant_variable$1"
  %d.4 = select i1 %cmp24, i8* %incdec.ptr21, i8* %tmp14
  %tmp15 = load %struct.bf_key_st*, %struct.bf_key_st** @"./benchmark_intermediate_representations/baseline/bf/bf_skey.ll_invariant_variable$0"
  %arrayidx29.phi.trans.insert = getelementptr inbounds %struct.bf_key_st, %struct.bf_key_st* %tmp15, i64 0, i32 0, i64 %indvars.iv.next116
  %.pre = load i64, i64* %arrayidx29.phi.trans.insert, align 8, !tbaa !1
  br label %"BF_set_key$1_increment_depth_counter"

"BF_set_key$1_increment_depth_counter":           ; preds = %"BF_set_key$1_latch$0"
...
"BF_set_key$1_recursively_call_function":         ; preds = %"BF_set_key$1_increment_depth_counter"
  call void @"BF_set_key$1"(i8* %d.4, i64 %indvars.iv.next116, i64 %.pre)
  ret void
...
"BF_set_key$0_latch$0":
  %tmp = load %struct.bf_key_st*, %struct.bf_key_st** @"./benchmark_intermediate_representations/baseline/bf/bf_skey.ll_invariant_variable$0"
  %tmp1 = load i64*, i64** @"./benchmark_intermediate_representations/baseline/bf/bf_skey.ll_invariant_variable$4"
  call void @BF_encrypt(i64* %tmp1, %struct.bf_key_st* nonnull %tmp, i32 1) #3
  %tmp2 = load %struct.bf_key_st*, %struct.bf_key_st** @"./benchmark_intermediate_representations/baseline/bf/bf_skey.ll_invariant_variable$0"
  %arrayidx54 = getelementptr inbounds %struct.bf_key_st, %struct.bf_key_st* %tmp2, i64 0, i32 1, i64 %arg
  %tmp3 = load <2 x i64>*, <2 x i64>** @"./benchmark_intermediate_representations/baseline/bf/bf_skey.ll_invariant_variable$3"
  %tmp4 = load <2 x i64>, <2 x i64>* %tmp3, align 16, !tbaa !1
  %tmp5 = bitcast i64* %arrayidx54 to <2 x i64>*
  store <2 x i64> %tmp4, <2 x i64>* %tmp5, align 8, !tbaa !1
  %indvars.iv.next = add nuw nsw i64 %arg, 2
  %cmp48 = icmp slt i64 %indvars.iv.next, 1024
  br i1 %cmp48, label %"BF_set_key$0_increment_depth_counter", label %"BF_set_key$0_return_from_recursive_function$0"

"BF_set_key$0_increment_depth_counter":           ; preds = %"BF_set_key$0_latch$0"
...
"BF_set_key$0_recursively_call_function":         ; preds = %"BF_set_key$0_increment_depth_counter"
  call void @"BF_set_key$0"(i64 %indvars.iv.next)
  ret void
