; ModuleID = './benchmark_intermediate_representations/loop2recursion/basicmath/isqrt.ll.temp'
...
"usqrt$0_latch$0":
  ...
  %tmp4 = zext i1 %cmp5 to i64
  %shl2 = or i64 %tmp4, %tmp
  %a.1 = xor i64 %shl2, 1
...
"usqrt$0_recursively_call_function":              ; preds = %"usqrt$0_increment_depth_counter"
  call void @"usqrt$0"(i64 %shl1, i64 %a.1, i64 %r.1, i32 %inc6)
  ret void

"usqrt$0_return_from_recursive_function$0":       ; preds = %"usqrt$0_latch$0"
  %tmp5 = getelementptr %0, %0* @"usqrt$0_return_value_struct", i32 0, i32 0
  store i64 %a.1, i64* %tmp5
  ret void
}
