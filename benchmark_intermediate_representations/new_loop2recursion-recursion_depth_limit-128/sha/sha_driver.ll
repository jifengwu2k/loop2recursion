; ModuleID = './benchmark_intermediate_representations/new_loop2recursion-recursion_depth_limit-128/sha/sha_driver.ll.temp'
...
"main$0_call_recursive_function":                 ; preds = %"main$0_extract_next_values", %"main$0_initialize_context"
  %i1 = phi i8** [ %argv, %"main$0_initialize_context" ], [ %i6, %"main$0_extract_next_values" ]
  %i2 = phi i32 [ %dec13, %"main$0_initialize_context" ], [ %i8, %"main$0_extract_next_values" ]
  call void @"main$0"(i8** %i1, i32 %i2, i8 0)
  %i3 = getelementptr %0, %0* @"main$0_recursion_state_struct", i32 0, i32 2
  %i4 = load i1, i1* %i3, align 1
  br i1 %i4, label %if.end6.loopexit, label %"main$0_extract_next_values"

"main$0_extract_next_values":                     ; preds = %"main$0_call_recursive_function"
  %i5 = getelementptr %0, %0* @"main$0_recursion_state_struct", i32 0, i32 0
  %i6 = load i8**, i8*** %i5, align 8
  %i7 = getelementptr %0, %0* @"main$0_recursion_state_struct", i32 0, i32 1
  %i8 = load i32, i32* %i7, align 4
  br label %"main$0_call_recursive_function"

if.then:                                          ; preds = %entry
  %i9 = load %struct._IO_FILE*, %struct._IO_FILE** @stdin, align 8, !tbaa !1
  call void @sha_stream(%struct.SHA_INFO* nonnull %sha_info, %struct._IO_FILE* %i9) #4
...
define void @"main$0"(i8** %arg, i32 %arg1, i8 %arg2) {
"main$0_header":
...
if.else4:                                         ; preds = %"main$0_header"
  ...
  call void @sha_stream(%struct.SHA_INFO* nonnull %i3, %struct._IO_FILE* nonnull %call) #4
  %i4 = load %struct.SHA_INFO*, %struct.SHA_INFO** @"./benchmark_intermediate_representations/baseline/sha/sha_driver.ll_invariant_variable$0", align 8
  call void @sha_print(%struct.SHA_INFO* nonnull %i4) #4
...
"main$0_recursively_call_function":               ; preds = %"main$0_increment_depth_counter"
  call void @"main$0"(i8** %incdec.ptr, i32 %dec, i8 %i6)
  ret void

"main$0_save_recursive_state_and_return":         ; preds = %"main$0_increment_depth_counter"
  %i8 = getelementptr %0, %0* @"main$0_recursion_state_struct", i32 0, i32 0
  store i8** %incdec.ptr, i8*** %i8, align 8
  %i9 = getelementptr %0, %0* @"main$0_recursion_state_struct", i32 0, i32 1
  store i32 %dec, i32* %i9, align 4
  %i10 = getelementptr %0, %0* @"main$0_recursion_state_struct", i32 0, i32 2
  store i1 false, i1* %i10, align 1
  ret void

"main$0_return_from_recursive_function$0":        ; preds = %"main$0_latch$0"
  %i11 = getelementptr %0, %0* @"main$0_recursion_state_struct", i32 0, i32 2
