; ModuleID = './benchmark_intermediate_representations/new_loop2recursion-recursion_depth_limit-128/bf/bf_cfb64.ll.temp'
...
"BF_cfb64_encrypt$1_call_recursive_function":     ; preds = %"BF_cfb64_encrypt$1_extract_next_values", %"BF_cfb64_encrypt$1_initialize_context"
  ...
  call void @"BF_cfb64_encrypt$1"(i8* %i2, i8* %i3, i64 %i4, i32 %i5, i8 0)
...
"BF_cfb64_encrypt$0_call_recursive_function":     ; preds = %"BF_cfb64_encrypt$0_extract_next_values", %"BF_cfb64_encrypt$0_initialize_context"
  ...
  call void @"BF_cfb64_encrypt$0"(i8* %i18, i64 %i19, i8* %i20, i32 %i21, i8 0)
...
define void @"BF_cfb64_encrypt$1"(i8* %arg, i8* %arg1, i64 %arg2, i32 %arg3, i8 %arg4) {
...
"BF_cfb64_encrypt$1_recursively_call_function":   ; preds = %"BF_cfb64_encrypt$1_increment_depth_counter"
  call void @"BF_cfb64_encrypt$1"(i8* %incdec.ptr63, i8* %incdec.ptr58, i64 %dec, i32 %and66, i8 %i56)
  ret void
...
define void @"BF_cfb64_encrypt$0"(i8* %arg, i64 %arg1, i8* %arg2, i32 %arg3, i8 %arg4) {
...
"BF_cfb64_encrypt$0_recursively_call_function":   ; preds = %"BF_cfb64_encrypt$0_increment_depth_counter"
  call void @"BF_cfb64_encrypt$0"(i8* %incdec.ptr138, i64 %dec68, i8* %incdec.ptr147, i32 %and149, i8 %i56)
  ret void
