; ModuleID = './benchmark_intermediate_representations/new_loop2recursion-recursion_depth_limit-128/bf/bf_skey.ll.temp'
source_filename = "./benchmark_intermediate_representations/baseline/bf/bf_skey.ll"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%0 = type { i8*, i64, i64, i1 }
%1 = type { i64, i1 }
...
@"BF_set_key$1_recursion_state_struct" = dso_local global %0 zeroinitializer
...
@"BF_set_key$0_recursion_state_struct" = dso_local global %1 zeroinitializer
...
"BF_set_key$1_call_recursive_function":           ; preds = %"BF_set_key$1_extract_next_values", %"BF_set_key$1_initialize_context"
  %i2 = phi i8* [ %data, %"BF_set_key$1_initialize_context" ], [ %i8, %"BF_set_key$1_extract_next_values" ]
  %i3 = phi i64 [ 608135816, %"BF_set_key$1_initialize_context" ], [ %i10, %"BF_set_key$1_extract_next_values" ]
  %i4 = phi i64 [ 0, %"BF_set_key$1_initialize_context" ], [ %i12, %"BF_set_key$1_extract_next_values" ]
  call void @"BF_set_key$1"(i8* %i2, i64 %i3, i64 %i4, i8 0)
  %i5 = getelementptr %0, %0* @"BF_set_key$1_recursion_state_struct", i32 0, i32 3
  %i6 = load i1, i1* %i5, align 1
  br i1 %i6, label %for.end, label %"BF_set_key$1_extract_next_values"

"BF_set_key$1_extract_next_values":               ; preds = %"BF_set_key$1_call_recursive_function"
  %i7 = getelementptr %0, %0* @"BF_set_key$1_recursion_state_struct", i32 0, i32 0
  %i8 = load i8*, i8** %i7, align 8
  %i9 = getelementptr %0, %0* @"BF_set_key$1_recursion_state_struct", i32 0, i32 1
  %i10 = load i64, i64* %i9, align 8
  %i11 = getelementptr %0, %0* @"BF_set_key$1_recursion_state_struct", i32 0, i32 2
...
for.end:                                          ; preds = %"BF_set_key$1_call_recursive_function"
  ...
  %i13 = bitcast <2 x i64>* %in to i8*
  call void @llvm.memset.p0i8.i64(i8* align 16 %i13, i8 0, i64 16, i1 false)
  call void @BF_encrypt(i64* %arrayidx30, %struct.bf_key_st* nonnull %key, i32 1) #5
  %i14 = load <2 x i64>, <2 x i64>* %in, align 16, !tbaa !1
  %i15 = bitcast %struct.bf_key_st* %key to <2 x i64>*
  store <2 x i64> %i14, <2 x i64>* %i15, align 8, !tbaa !1
  call void @BF_encrypt(i64* %arrayidx30, %struct.bf_key_st* nonnull %key, i32 1) #5
  %arrayidx39.1 = getelementptr inbounds %struct.bf_key_st, %struct.bf_key_st* %key, i64 0, i32 0, i64 2
  %i16 = load <2 x i64>, <2 x i64>* %in, align 16, !tbaa !1
  %i17 = bitcast i64* %arrayidx39.1 to <2 x i64>*
  store <2 x i64> %i16, <2 x i64>* %i17, align 8, !tbaa !1
  call void @BF_encrypt(i64* %arrayidx30, %struct.bf_key_st* nonnull %key, i32 1) #5
  %arrayidx39.2 = getelementptr inbounds %struct.bf_key_st, %struct.bf_key_st* %key, i64 0, i32 0, i64 4
  %i18 = load <2 x i64>, <2 x i64>* %in, align 16, !tbaa !1
  %i19 = bitcast i64* %arrayidx39.2 to <2 x i64>*
  store <2 x i64> %i18, <2 x i64>* %i19, align 8, !tbaa !1
  call void @BF_encrypt(i64* %arrayidx30, %struct.bf_key_st* nonnull %key, i32 1) #5
  %arrayidx39.3 = getelementptr inbounds %struct.bf_key_st, %struct.bf_key_st* %key, i64 0, i32 0, i64 6
  %i20 = load <2 x i64>, <2 x i64>* %in, align 16, !tbaa !1
  %i21 = bitcast i64* %arrayidx39.3 to <2 x i64>*
  store <2 x i64> %i20, <2 x i64>* %i21, align 8, !tbaa !1
  call void @BF_encrypt(i64* %arrayidx30, %struct.bf_key_st* nonnull %key, i32 1) #5
  %arrayidx39.4 = getelementptr inbounds %struct.bf_key_st, %struct.bf_key_st* %key, i64 0, i32 0, i64 8
  %i22 = load <2 x i64>, <2 x i64>* %in, align 16, !tbaa !1
  %i23 = bitcast i64* %arrayidx39.4 to <2 x i64>*
  store <2 x i64> %i22, <2 x i64>* %i23, align 8, !tbaa !1
  call void @BF_encrypt(i64* %arrayidx30, %struct.bf_key_st* nonnull %key, i32 1) #5
  %arrayidx39.5 = getelementptr inbounds %struct.bf_key_st, %struct.bf_key_st* %key, i64 0, i32 0, i64 10
  %i24 = load <2 x i64>, <2 x i64>* %in, align 16, !tbaa !1
  %i25 = bitcast i64* %arrayidx39.5 to <2 x i64>*
  store <2 x i64> %i24, <2 x i64>* %i25, align 8, !tbaa !1
  call void @BF_encrypt(i64* %arrayidx30, %struct.bf_key_st* nonnull %key, i32 1) #5
  %arrayidx39.6 = getelementptr inbounds %struct.bf_key_st, %struct.bf_key_st* %key, i64 0, i32 0, i64 12
  %i26 = load <2 x i64>, <2 x i64>* %in, align 16, !tbaa !1
  %i27 = bitcast i64* %arrayidx39.6 to <2 x i64>*
  store <2 x i64> %i26, <2 x i64>* %i27, align 8, !tbaa !1
  call void @BF_encrypt(i64* %arrayidx30, %struct.bf_key_st* nonnull %key, i32 1) #5
  %arrayidx39.7 = getelementptr inbounds %struct.bf_key_st, %struct.bf_key_st* %key, i64 0, i32 0, i64 14
  %i28 = load <2 x i64>, <2 x i64>* %in, align 16, !tbaa !1
  %i29 = bitcast i64* %arrayidx39.7 to <2 x i64>*
  store <2 x i64> %i28, <2 x i64>* %i29, align 8, !tbaa !1
  call void @BF_encrypt(i64* %arrayidx30, %struct.bf_key_st* nonnull %key, i32 1) #5
  %arrayidx39.8 = getelementptr inbounds %struct.bf_key_st, %struct.bf_key_st* %key, i64 0, i32 0, i64 16
  %i30 = load <2 x i64>, <2 x i64>* %in, align 16, !tbaa !1
  %i31 = bitcast i64* %arrayidx39.8 to <2 x i64>*
  store <2 x i64> %i30, <2 x i64>* %i31, align 8, !tbaa !1
...
"BF_set_key$0_call_recursive_function":           ; preds = %"BF_set_key$0_extract_next_values", %"BF_set_key$0_initialize_context"
  %i32 = phi i64 [ 0, %"BF_set_key$0_initialize_context" ], [ %i36, %"BF_set_key$0_extract_next_values" ]
  call void @"BF_set_key$0"(i64 %i32, i8 0)
  %i33 = getelementptr %1, %1* @"BF_set_key$0_recursion_state_struct", i32 0, i32 1
  %i34 = load i1, i1* %i33, align 1
  br i1 %i34, label %for.end61, label %"BF_set_key$0_extract_next_values"

"BF_set_key$0_extract_next_values":               ; preds = %"BF_set_key$0_call_recursive_function"
  %i35 = getelementptr %1, %1* @"BF_set_key$0_recursion_state_struct", i32 0, i32 0
...
define void @"BF_set_key$1"(i8* %arg, i64 %arg1, i64 %arg2, i8 %arg3) {
"BF_set_key$1_exiting$0":
  ...
  %arrayidx29 = getelementptr inbounds %struct.bf_key_st, %struct.bf_key_st* %i13, i64 0, i32 0, i64 %arg2
  %xor = xor i64 %or23, %arg1
  store i64 %xor, i64* %arrayidx29, align 8, !tbaa !1
  %indvars.iv.next116 = add nuw nsw i64 %arg2, 1
...
"BF_set_key$1_increment_depth_counter":           ; preds = %"BF_set_key$1_latch$0"
  %i17 = add i8 %arg3, 1
  %i18 = icmp ult i8 %i17, -128
  br i1 %i18, label %"BF_set_key$1_recursively_call_function", label %"BF_set_key$1_save_recursive_state_and_return"

"BF_set_key$1_recursively_call_function":         ; preds = %"BF_set_key$1_increment_depth_counter"
  call void @"BF_set_key$1"(i8* %d.4, i64 %.pre, i64 %indvars.iv.next116, i8 %i17)
  ret void

"BF_set_key$1_save_recursive_state_and_return":   ; preds = %"BF_set_key$1_increment_depth_counter"
  %i19 = getelementptr %0, %0* @"BF_set_key$1_recursion_state_struct", i32 0, i32 0
  store i8* %d.4, i8** %i19, align 8
  %i20 = getelementptr %0, %0* @"BF_set_key$1_recursion_state_struct", i32 0, i32 1
  store i64 %.pre, i64* %i20, align 8
  %i21 = getelementptr %0, %0* @"BF_set_key$1_recursion_state_struct", i32 0, i32 2
  store i64 %indvars.iv.next116, i64* %i21, align 8
  %i22 = getelementptr %0, %0* @"BF_set_key$1_recursion_state_struct", i32 0, i32 3
  store i1 false, i1* %i22, align 1
  ret void

"BF_set_key$1_return_from_recursive_function$0":  ; preds = %"BF_set_key$1_exiting$0"
  %i23 = getelementptr %0, %0* @"BF_set_key$1_recursion_state_struct", i32 0, i32 3
  store i1 true, i1* %i23, align 1
  ret void
}

define void @"BF_set_key$0"(i64 %arg, i8 %arg1) {
"BF_set_key$0_latch$0":
  ...
  call void @BF_encrypt(i64* %i, %struct.bf_key_st* nonnull %i2, i32 1) #5
  %i3 = load %struct.bf_key_st*, %struct.bf_key_st** @"./benchmark_intermediate_representations/baseline/bf/bf_skey.ll_invariant_variable$0", align 8
  %arrayidx54 = getelementptr inbounds %struct.bf_key_st, %struct.bf_key_st* %i3, i64 0, i32 1, i64 %arg
  %i4 = load <2 x i64>*, <2 x i64>** @"./benchmark_intermediate_representations/baseline/bf/bf_skey.ll_invariant_variable$3", align 8
  %i5 = load <2 x i64>, <2 x i64>* %i4, align 16, !tbaa !1
  %i6 = bitcast i64* %arrayidx54 to <2 x i64>*
...
"BF_set_key$0_increment_depth_counter":           ; preds = %"BF_set_key$0_latch$0"
  ...
  br i1 %i8, label %"BF_set_key$0_recursively_call_function", label %"BF_set_key$0_save_recursive_state_and_return"

"BF_set_key$0_recursively_call_function":         ; preds = %"BF_set_key$0_increment_depth_counter"
  call void @"BF_set_key$0"(i64 %indvars.iv.next, i8 %i7)
  ret void

"BF_set_key$0_save_recursive_state_and_return":   ; preds = %"BF_set_key$0_increment_depth_counter"
  %i9 = getelementptr %1, %1* @"BF_set_key$0_recursion_state_struct", i32 0, i32 0
  store i64 %indvars.iv.next, i64* %i9, align 8
  %i10 = getelementptr %1, %1* @"BF_set_key$0_recursion_state_struct", i32 0, i32 1
  store i1 false, i1* %i10, align 1
  ret void

"BF_set_key$0_return_from_recursive_function$0":  ; preds = %"BF_set_key$0_latch$0"
  %i11 = getelementptr %1, %1* @"BF_set_key$0_recursion_state_struct", i32 0, i32 1
