; ModuleID = './benchmark_intermediate_representations/new_loop2recursion-recursion_depth_limit-128/bitcnts/bstr_i.ll.temp'
...
"bstr_i$0_call_recursive_function":               ; preds = %"bstr_i$0_extract_next_values", %"bstr_i$0_initialize_context"
  ...
  call void @"bstr_i$0"(i32 %i1, i8 %i2, i8* %i3, i8 0)
...
define void @"bstr_i$0"(i32 %arg, i8 %arg1, i8* %arg2, i8 %arg3) {
"bstr_i$0_exiting$1":
...
"bstr_i$0_recursively_call_function":             ; preds = %"bstr_i$0_increment_depth_counter"
  call void @"bstr_i$0"(i32 %or, i8 %i6, i8* %incdec.ptr, i8 %i7)
  ret void
