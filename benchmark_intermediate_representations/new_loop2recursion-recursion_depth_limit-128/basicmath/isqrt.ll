; ModuleID = './benchmark_intermediate_representations/new_loop2recursion-recursion_depth_limit-128/basicmath/isqrt.ll.temp'
...
"usqrt$0_call_recursive_function":                ; preds = %"usqrt$0_extract_next_values", %"usqrt$0_initialize_context"
  ...
  call void @"usqrt$0"(i64 %i, i64 %i1, i32 %i2, i64 %i3, i8 0)
...
define void @"usqrt$0"(i64 %arg, i64 %arg1, i32 %arg2, i64 %arg3, i8 %arg4) {
"usqrt$0_latch$0":
  %shl = shl i64 %arg3, 2
  %and = lshr i64 %arg, 30
  %shr = and i64 %and, 3
...
"usqrt$0_recursively_call_function":              ; preds = %"usqrt$0_increment_depth_counter"
  call void @"usqrt$0"(i64 %shl1, i64 %a.1, i32 %inc6, i64 %r.1, i8 %i6)
  ret void
