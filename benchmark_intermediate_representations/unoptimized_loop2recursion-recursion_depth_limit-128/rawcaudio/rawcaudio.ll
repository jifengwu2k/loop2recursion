; ModuleID = './benchmark_intermediate_representations/unoptimized_loop2recursion-recursion_depth_limit-128/rawcaudio/rawcaudio.ll.temp'
...
"main$0_call_recursive_function":                 ; preds = %"main$0_extract_next_values", %"main$0_initialize_context"
  ...
  call void @"main$0"(%0* %i, i32 %i2, %1* %i1, i8 0)
...
define void @"main$0"(%0* %arg, i32 %arg1, %1* %arg2, i8 %arg3) {
"main$0_exiting$1":
...
"main$0_recursively_call_function":               ; preds = %"main$0_increment_depth_counter"
  call void @"main$0"(%0* %arg, i32 %call, %1* %arg2, i8 %i)
  ret void
