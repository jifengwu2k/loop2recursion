; ModuleID = './benchmark_intermediate_representations/unoptimized_loop2recursion-recursion_depth_limit-128/susan/susan.ll.temp'
...
"enlarge$2_call_recursive_function":              ; preds = %"enlarge$2_extract_next_values", %"enlarge$2_initialize_context"
  ...
  call void @"enlarge$2"(i32 %i2, i32* %y_size, i32* %x_size, i32 %mul, i32 %border, i64 %idx.ext3, i8* %tmp_image, i8** %in, %12* %i1, i8 0)
...
"enlarge$1_call_recursive_function":              ; preds = %"enlarge$1_extract_next_values", %"enlarge$1_initialize_context"
  ...
  call void @"enlarge$1"(i32 %i8, i32 %i9, i32 %border, i32* %y_size, i32* %x_size, i64 %idx.ext18, i32 %sub, i32 %mul13, i8* %tmp_image, i8** %in, %13* %i7, i8 0)
...
"susan_corners_quick$1_call_recursive_function":  ; preds = %"susan_corners_quick$1_extract_next_values", %"susan_corners_quick$1_initialize_context"
  ...
  call void @"susan_corners_quick$1"(i64 %i3, i32 %sub, i32* %r, i32 %max_no, i32 %sub4, i64 %idx.ext124, i64 %i1, i8* %bp, i64 %idx.ext36, i1 %cmp52051, i8* %in, i64 %idx.ext73, %29* %i2, i8 0)
...
"susan_corners_quick$0_call_recursive_function":  ; preds = %"susan_corners_quick$0_extract_next_values", %"susan_corners_quick$0_initialize_context"
  ...
  call void @"susan_corners_quick$0"(%30* %i11, i32 %i13, i64 %i14, i64 %i10, i64 %i9, i1 %cmp3672043, i32* %r, i64 %i8, %struct.anon* %corner_list, i8* %in, %31* %i12, i8 0)
...
"main$7_call_recursive_function":                 ; preds = %"main$7_extract_next_values", %"main$7_initialize_context"
  ...
  call void @"main$7"(i64 %i272, i64 %idx.ext11.i, i32 %i177, i8* %i269, [15000 x %struct.anon]* %corner_list, i1 %cmp1.i, %49* %i271, i8 0)
...
"susan_principle$0$0_call_recursive_function":    ; preds = %"susan_principle$0$0_extract_next_values", %"susan_principle$0$0_initialize_context"
  ...
  call void @"susan_principle$0$0"(i32 %i18, i64 %i19, i32 %arg2, i32* %arg3, i32 %arg4, i64 %arg5, i64 %arg11, i8* %add.ptr, i8* %arg7, i8* %arg8, i32 %i16, i64 %arg9, %50* %i17, i8 0)
...
"enlarge$0$0_call_recursive_function":            ; preds = %"enlarge$0$0_extract_next_values", %"enlarge$0$0_initialize_context"
  ...
  call void @"enlarge$0$0"(%52* %i, i32 %i11, i32* %arg5, i32 %arg6, i32* %arg7, i32 %arg, i32 %arg4, i32 %sub61, i8* %arg3, %53* %i10, i8 0)
...
define void @"enlarge$2"(i32 %arg, i32* %arg1, i32* %arg2, i32 %arg3, i32 %arg4, i64 %arg5, i8* %arg6, i8** %arg7, %12* %arg8, i8 %arg9) {
"enlarge$2_latch$0":
  ...
  %add.ptr = getelementptr inbounds i8, i8* %arg6, i64 %idx.ext
  %add.ptr4 = getelementptr inbounds i8, i8* %add.ptr, i64 %arg5
...
"enlarge$2_recursively_call_function":            ; preds = %"enlarge$2_increment_depth_counter"
  call void @"enlarge$2"(i32 %inc, i32* %arg1, i32* %arg2, i32 %arg3, i32 %arg4, i64 %arg5, i8* %arg6, i8** %arg7, %12* %arg8, i8 %i12)
  ret void
...
"susan_smoothing$0$0_call_recursive_function":    ; preds = %"susan_smoothing$0$0_extract_next_values", %"susan_smoothing$0$0_initialize_context"
  ...
  call void @"susan_smoothing$0$0"(%54* %i16, i8* %i18, i64 %i19, i32 %i20, i32* %arg8, i64 %arg4, i32 %arg11, i32 %arg5, i8* %arg6, i32 %arg1, i8** %arg10, i8* %arg12, i1 %arg13, i32 %sub78, i64 %arg7, %55* %i17, i8 0)
...
"susan_edges$0$0_call_recursive_function":        ; preds = %"susan_edges$0$0_extract_next_values", %"susan_edges$0$0_initialize_context"
  ...
  call void @"susan_edges$0$0"(i32 %i22, i64 %i23, i32 %arg1, i32 %i19, i8* %arg2, i32 %arg4, i32 %i20, i64 %arg7, i64 %arg6, i32* %arg10, i32 %i18, i8* %arg13, i32 %arg12, i8* %arg8, i64 %arg5, i8* %add.ptr323, %62* %i21, i8 0)
...
"susan_edges$1$0_call_recursive_function":        ; preds = %"susan_edges$1$0_extract_next_values", %"susan_edges$1$0_initialize_context"
  ...
  call void @"susan_edges$1$0"(i32 %i18, i64 %i19, i32* %arg3, i32 %arg4, i64 %arg5, i32 %arg2, i32 %i16, i8* %add.ptr, i8* %arg9, i8* %arg10, i64 %arg8, i64 %arg11, %63* %i17, i8 0)
...
"susan_edges_small$0$0_call_recursive_function":  ; preds = %"susan_edges_small$0$0_extract_next_values", %"susan_edges_small$0$0_initialize_context"
  ...
  call void @"susan_edges_small$0$0"(i32 %i19, i64 %i20, i32 %arg1, i32 %i16, i8* %arg2, i32 %arg3, i32 %i17, i32* %arg6, i32 %i15, i8* %arg8, i8* %arg10, i8* %add.ptr119, i64 %arg7, %64* %i18, i8 0)
...
"susan_edges_small$1$0_call_recursive_function":  ; preds = %"susan_edges_small$1$0_extract_next_values", %"susan_edges_small$1$0_initialize_context"
  ...
  call void @"susan_edges_small$1$0"(i32 %i15, i64 %i16, i32 %arg2, i32 %i13, i8* %add.ptr, i8* %arg7, i8* %arg6, i64 %arg5, i32* %arg8, %65* %i14, i8 0)
...
"susan_corners$0$0_call_recursive_function":      ; preds = %"susan_corners$0$0_extract_next_values", %"susan_corners$0$0_initialize_context"
  ...
  call void @"susan_corners$0$0"(%66* %i28, i32 %i30, i64 %i31, i32 %i32, i64 %arg4, i8* %arg5, i32* %arg11, %struct.anon* %arg10, i64 %i25, i64 %i23, i32* %arg8, i32 %i26, i64 %i15, i64 %i17, i32* %arg9, i32 %i27, i64 %i19, i64 %i21, %67* %i29, i8 0)
...
"susan_corners$1$0_call_recursive_function":      ; preds = %"susan_corners$1$0_extract_next_values", %"susan_corners$1$0_initialize_context"
  ...
  call void @"susan_corners$1$0"(i32 %i23, i64 %i24, i32* %arg2, i32* %arg12, i32* %arg9, i32 %arg4, i32 %i20, i32 %arg3, i32 %i21, i32 %arg5, i64 %arg6, i32 %i19, i8* %add.ptr, i8* %arg8, i8* %arg11, i64 %arg14, i64 %arg10, %68* %i22, i8 0)
...
define void @"susan_corners_quick$0"(%30* %arg, i32 %arg1, i64 %arg2, i64 %arg3, i64 %arg4, i1 %arg5, i32* %arg6, i64 %arg7, %struct.anon* %arg8, i8* %arg9, %31* %arg10, i8 %arg11) {
...
"susan_corners_quick$0$0_call_recursive_function": ; preds = %"susan_corners_quick$0$0_extract_next_values", %"susan_corners_quick$0$0_initialize_context"
  ...
  call void @"susan_corners_quick$0$0"(%69* %i26, i32 %i28, i64 %i29, i32 %i30, i64 %arg7, i8* %arg9, i64 %i23, i64 %i21, i32* %arg6, i32 %i24, i64 %i13, i64 %i15, i32 %i25, i64 %i17, %struct.anon* %arg8, i64 %i19, %70* %i27, i8 0)
...
"susan_corners_quick$0_recursively_call_function": ; preds = %"susan_corners_quick$0_increment_depth_counter"
  call void @"susan_corners_quick$0"(%30* %arg, i32 %n.1.lcssa, i64 %indvars.iv.next2100.pre-phi, i64 %arg3, i64 %arg4, i1 %arg5, i32* %arg6, i64 %arg7, %struct.anon* %arg8, i8* %arg9, %31* %arg10, i8 %i43)
  ret void
...
define void @"susan_corners_quick$1"(i64 %arg, i32 %arg1, i32* %arg2, i32 %arg3, i32 %arg4, i64 %arg5, i64 %arg6, i8* %arg7, i64 %arg8, i1 %arg9, i8* %arg10, i64 %arg11, %29* %arg12, i8 %arg13) {
...
"susan_corners_quick$1$0_call_recursive_function": ; preds = %"susan_corners_quick$1$0_extract_next_values", %"susan_corners_quick$1$0_initialize_context"
  ...
  call void @"susan_corners_quick$1$0"(i32 %i18, i64 %i19, i32 %arg4, i32* %arg2, i32 %arg3, i64 %arg5, i32 %i16, i8* %arg10, i8* %add.ptr, i64 %arg11, i8* %arg7, i64 %arg8, %71* %i17, i8 0)
...
"susan_corners_quick$1_recursively_call_function": ; preds = %"susan_corners_quick$1_increment_depth_counter"
  call void @"susan_corners_quick$1"(i64 %indvars.iv.next2117, i32 %arg1, i32* %arg2, i32 %arg3, i32 %arg4, i64 %arg5, i64 %arg6, i8* %arg7, i64 %arg8, i1 %arg9, i8* %arg10, i64 %arg11, %29* %arg12, i8 %i26)
  ret void
...
define void @"main$7"(i64 %arg, i64 %arg1, i32 %arg2, i8* %arg3, [15000 x %struct.anon]* %arg4, i1 %arg5, %49* %arg6, i8 %arg7) {
"main$7_header":
...
"main$7_recursively_call_function":               ; preds = %"main$7_increment_depth_counter"
  call void @"main$7"(i64 %indvars.iv.next.i250, i64 %arg1, i32 %arg2, i8* %arg3, [15000 x %struct.anon]* %arg4, i1 %arg5, %49* %arg6, i8 %i11)
  ret void
...
define void @"susan_principle$0$0"(i32 %arg, i64 %arg1, i32 %arg2, i32* %arg3, i32 %arg4, i64 %arg5, i64 %arg6, i8* %arg7, i8* %arg8, i8* %arg9, i32 %arg10, i64 %arg11, %50* %arg12, i8 %arg13) {
...
"susan_principle$0$0_recursively_call_function":  ; preds = %"susan_principle$0$0_increment_depth_counter"
  call void @"susan_principle$0$0"(i32 %inc, i64 %indvars.iv.next, i32 %arg2, i32* %arg3, i32 %arg4, i64 %arg5, i64 %arg6, i8* %arg7, i8* %arg8, i8* %arg9, i32 %arg10, i64 %arg11, %50* %arg12, i8 %i86)
  ret void
...
define void @"susan_smoothing$0$0"(%54* %arg, i8* %arg1, i64 %arg2, i32 %arg3, i32* %arg4, i64 %arg5, i32 %arg6, i32 %arg7, i8* %arg8, i32 %arg9, i8** %arg10, i8* %arg11, i1 %arg12, i32 %arg13, i64 %arg14, %55* %arg15, i8 %arg16) {
...
"susan_smoothing$0$0$0_call_recursive_function":  ; preds = %"susan_smoothing$0$0$0_extract_next_values", %"susan_smoothing$0$0$0_initialize_context"
  ...
  call void @"susan_smoothing$0$0$0"(%72* %i19, i32 %i21, i8* %i22, i32 %i23, i32 %i24, i8* %i25, i64 %arg5, i32 %arg6, i32 %arg7, i8* %add.ptr88, %73* %i20, i8 0)
...
"susan_smoothing$0$0_recursively_call_function":  ; preds = %"susan_smoothing$0$0_increment_depth_counter"
  call void @"susan_smoothing$0$0"(%54* %arg, i8* %out.2, i64 %indvars.iv.next, i32 %i43, i32* %arg4, i64 %arg5, i32 %arg6, i32 %arg7, i8* %arg8, i32 %arg9, i8** %arg10, i8* %arg11, i1 %arg12, i32 %arg13, i64 %arg14, %55* %arg15, i8 %i45)
  ret void
...
define void @"susan_edges$0$0"(i32 %arg, i64 %arg1, i32 %arg2, i32 %arg3, i8* %arg4, i32 %arg5, i32 %arg6, i64 %arg7, i64 %arg8, i32* %arg9, i32 %arg10, i8* %arg11, i32 %arg12, i8* %arg13, i64 %arg14, i8* %arg15, %62* %arg16, i8 %arg17) {
...
if.then304:                                       ; preds = %"susan_edges$0$0_header"
  ...
  %arrayidx313 = getelementptr inbounds i8, i8* %arg13, i64 %idxprom300
  %i18 = load i8, i8* %arrayidx313, align 1, !tbaa !7
  %idx.ext315 = zext i8 %i18 to i64
  %add.ptr316 = getelementptr inbounds i8, i8* %arg11, i64 %idx.ext315
...
if.then304.if.then762_crit_edge:                  ; preds = %if.then304
  ...
  %.pre2085 = getelementptr inbounds i8, i8* %.pre2084, i64 %arg14
  ...
  %.pre2105 = getelementptr inbounds i8, i8* %.pre2104, i64 %arg14
...
if.then319:                                       ; preds = %if.then304
  ...
  %add.ptr408 = getelementptr inbounds i8, i8* %incdec.ptr386, i64 %arg14
  ...
  %add.ptr590 = getelementptr inbounds i8, i8* %incdec.ptr569, i64 %arg14
...
"susan_edges$0$0_recursively_call_function":      ; preds = %"susan_edges$0$0_increment_depth_counter"
  call void @"susan_edges$0$0"(i32 %inc1254, i64 %indvars.iv.next, i32 %arg2, i32 %arg3, i8* %arg4, i32 %arg5, i32 %arg6, i64 %arg7, i64 %arg8, i32* %arg9, i32 %arg10, i8* %arg11, i32 %arg12, i8* %arg13, i64 %arg14, i8* %arg15, %62* %arg16, i8 %i174)
  ret void
...
define void @"susan_edges$1$0"(i32 %arg, i64 %arg1, i32* %arg2, i32 %arg3, i64 %arg4, i32 %arg5, i32 %arg6, i8* %arg7, i8* %arg8, i8* %arg9, i64 %arg10, i64 %arg11, %63* %arg12, i8 %arg13) {
...
if.then:                                          ; preds = %"susan_edges$1$0_header"
  ...
  %arrayidx284 = getelementptr inbounds i32, i32* %arg2, i64 %idxprom
  store i32 %sub280, i32* %arrayidx284, align 4, !tbaa !5
...
"susan_edges$1$0_latch$0":                        ; preds = %if.then, %"susan_edges$1$0_header"
  ...
  %exitcond2069 = icmp eq i32 %lftr.wideiv2068, %arg5
...
"susan_edges$1$0_recursively_call_function":      ; preds = %"susan_edges$1$0_increment_depth_counter"
  call void @"susan_edges$1$0"(i32 %inc, i64 %indvars.iv.next2067, i32* %arg2, i32 %arg3, i64 %arg4, i32 %arg5, i32 %arg6, i8* %arg7, i8* %arg8, i8* %arg9, i64 %arg10, i64 %arg11, %63* %arg12, i8 %i86)
  ret void
...
define void @"susan_edges_small$0$0"(i32 %arg, i64 %arg1, i32 %arg2, i32 %arg3, i8* %arg4, i32 %arg5, i32 %arg6, i32* %arg7, i32 %arg8, i8* %arg9, i8* %arg10, i8* %arg11, i64 %arg12, %64* %arg13, i8 %arg14) {
...
"susan_edges_small$0$0_recursively_call_function": ; preds = %"susan_edges_small$0$0_increment_depth_counter"
  call void @"susan_edges_small$0$0"(i32 %inc394, i64 %indvars.iv.next, i32 %arg2, i32 %arg3, i8* %arg4, i32 %arg5, i32 %arg6, i32* %arg7, i32 %arg8, i8* %arg9, i8* %arg10, i8* %arg11, i64 %arg12, %64* %arg13, i8 %i54)
  ret void
...
"susan_edges_small$1$0_header":
  %add.ptr11 = getelementptr inbounds i8, i8* %arg4, i64 %arg1
  %add.ptr12 = getelementptr inbounds i8, i8* %add.ptr11, i64 -1
  %add = add nsw i32 %arg, %arg3
  %idxprom = sext i32 %add to i64
...
define void @"susan_corners$0$0"(%66* %arg, i32 %arg1, i64 %arg2, i32 %arg3, i64 %arg4, i8* %arg5, i32* %arg6, %struct.anon* %arg7, i64 %arg8, i64 %arg9, i32* %arg10, i32 %arg11, i64 %arg12, i64 %arg13, i32* %arg14, i32 %arg15, i64 %arg16, i64 %arg17, %67* %arg18, i8 %arg19) {
...
"susan_corners$0$0_exiting$1":                    ; preds = %land.lhs.true1337
  ...
  %info = getelementptr inbounds %struct.anon, %struct.anon* %arg7, i64 %idxprom1347, i32 2
  store i32 0, i32* %info, align 4, !tbaa !8
  %x1351 = getelementptr inbounds %struct.anon, %struct.anon* %arg7, i64 %idxprom1347, i32 0
  %i110 = trunc i64 %arg2 to i32
  store i32 %i110, i32* %x1351, align 4, !tbaa !20
  %y1354 = getelementptr inbounds %struct.anon, %struct.anon* %arg7, i64 %idxprom1347, i32 1
  ...
  %dx = getelementptr inbounds %struct.anon, %struct.anon* %arg7, i64 %idxprom1347, i32 3
  store i32 %i111, i32* %dx, align 4, !tbaa !21
  %arrayidx1364 = getelementptr inbounds i32, i32* %arg14, i64 %idxprom923
  %i112 = load i32, i32* %arrayidx1364, align 4, !tbaa !5
  %dy = getelementptr inbounds %struct.anon, %struct.anon* %arg7, i64 %idxprom1347, i32 4
  ...
  %I = getelementptr inbounds %struct.anon, %struct.anon* %arg7, i64 %idxprom1347, i32 5
...
"susan_corners$0$0_recursively_call_function":    ; preds = %"susan_corners$0$0_increment_depth_counter"
  call void @"susan_corners$0$0"(%66* %arg, i32 %inc1383, i64 %indvars.iv.next, i32 %n.2, i64 %arg4, i8* %arg5, i32* %arg6, %struct.anon* %arg7, i64 %arg8, i64 %arg9, i32* %arg10, i32 %arg11, i64 %arg12, i64 %arg13, i32* %arg14, i32 %arg15, i64 %arg16, i64 %arg17, %67* %arg18, i8 %i114)
  ret void
...
define void @"susan_corners$1$0"(i32 %arg, i64 %arg1, i32* %arg2, i32* %arg3, i32* %arg4, i32 %arg5, i32 %arg6, i32 %arg7, i32 %arg8, i32 %arg9, i64 %arg10, i32 %arg11, i8* %arg12, i8* %arg13, i8* %arg14, i64 %arg15, i64 %arg16, %68* %arg17, i8 %arg18) {
"susan_corners$1$0_header":
  ...
  %add.ptr23 = getelementptr inbounds i8, i8* %arg14, i64 %idx.ext22
  ...
  %add.ptr44 = getelementptr inbounds i8, i8* %incdec.ptr29, i64 %arg15
  ...
  %add.ptr132 = getelementptr inbounds i8, i8* %incdec.ptr117, i64 %arg10
  ...
  %cmp153 = icmp slt i32 %add152, %arg9
...
if.then:                                          ; preds = %"susan_corners$1$0_header"
  ...
  %cmp163 = icmp slt i32 %add162, %arg9
...
if.then165:                                       ; preds = %if.then
  ...
  %cmp173 = icmp slt i32 %add172, %arg9
...
if.then175:                                       ; preds = %if.then165
  ...
  %cmp182 = icmp slt i32 %add181, %arg9
  br i1 %cmp182, label %if.then184, label %"susan_corners$1$0_latch$0"

if.then184:                                       ; preds = %if.then175
  %add.ptr187 = getelementptr inbounds i8, i8* %incdec.ptr166, i64 %arg10
  ...
  %cmp195 = icmp slt i32 %add194, %arg9
...
if.then197:                                       ; preds = %if.then184
  ...
  %cmp205 = icmp slt i32 %add204, %arg9
...
if.then207:                                       ; preds = %if.then197
  ...
  %cmp215 = icmp slt i32 %add214, %arg9
...
if.then217:                                       ; preds = %if.then207
  ...
  %cmp225 = icmp slt i32 %add224, %arg9
...
if.then227:                                       ; preds = %if.then217
  ...
  %cmp235 = icmp slt i32 %add234, %arg9
...
if.then237:                                       ; preds = %if.then227
  ...
  %cmp245 = icmp slt i32 %add244, %arg9
...
if.then247:                                       ; preds = %if.then237
  ...
  %cmp254 = icmp slt i32 %add253, %arg9
...
if.then256:                                       ; preds = %if.then247
  ...
  %cmp267 = icmp slt i32 %add266, %arg9
...
if.then269:                                       ; preds = %if.then256
  ...
  %cmp277 = icmp slt i32 %add276, %arg9
...
if.then279:                                       ; preds = %if.then269
  ...
  %cmp287 = icmp slt i32 %add286, %arg9
...
if.then289:                                       ; preds = %if.then279
  ...
  %cmp297 = icmp slt i32 %add296, %arg9
...
if.then299:                                       ; preds = %if.then289
  ...
  %cmp306 = icmp slt i32 %add305, %arg9
  br i1 %cmp306, label %if.then308, label %"susan_corners$1$0_latch$0"

if.then308:                                       ; preds = %if.then299
  %add.ptr311 = getelementptr inbounds i8, i8* %incdec.ptr290, i64 %arg15
  ...
  %cmp319 = icmp slt i32 %add318, %arg9
...
if.then321:                                       ; preds = %if.then308
  ...
  %cmp329 = icmp slt i32 %add328, %arg9
...
if.then331:                                       ; preds = %if.then321
  ...
  %cmp338 = icmp slt i32 %add337, %arg9
...
if.else:                                          ; preds = %if.then697
  ...
  %add788 = add nsw i32 %div787, %arg8
  %mul789 = mul nsw i32 %add788, %arg7
  ...
  %add812 = add nsw i32 %mul811, %arg8
  %mul813 = mul nsw i32 %add812, %arg7
  ...
  %add840 = add nsw i32 %mul839, %arg8
  %mul841 = mul nsw i32 %add840, %arg7
...
if.then700:                                       ; preds = %if.then697
  ...
  %add715 = add nsw i32 %conv711, %arg6
  %mul716 = mul nsw i32 %add715, %arg7
  ...
  %add741 = add nsw i32 %conv733, %arg6
  %mul742 = mul nsw i32 %add741, %arg7
  ...
  %add769 = add nsw i32 %conv761, %arg6
  %mul770 = mul nsw i32 %add769, %arg7
...
if.then869:                                       ; preds = %if.end
  %sub870 = sub nsw i32 %arg9, %add337
  ...
  %arrayidx880 = getelementptr inbounds i32, i32* %arg3, i64 %idxprom
  store i32 %div876, i32* %arrayidx880, align 4, !tbaa !5
  %mul881 = mul nsw i32 %add690, 51
  %div882 = sdiv i32 %mul881, %add337
  %arrayidx886 = getelementptr inbounds i32, i32* %arg2, i64 %idxprom
...
"susan_corners$1$0_latch$0":                      ; preds = %if.then869, %if.end, %if.then340, %if.then331, %if.then321, %if.then308, %if.then299, %if.then289, %if.then279, %if.then269, %if.then256, %if.then247, %if.then237, %if.then227, %if.then217, %if.then207, %if.then197, %if.then184, %if.then175, %if.then165, %if.then, %"susan_corners$1$0_header"
  ...
  %exitcond = icmp eq i32 %lftr.wideiv, %arg5
...
"susan_corners$1$0_recursively_call_function":    ; preds = %"susan_corners$1$0_increment_depth_counter"
  call void @"susan_corners$1$0"(i32 %inc, i64 %indvars.iv.next2247, i32* %arg2, i32* %arg3, i32* %arg4, i32 %arg5, i32 %arg6, i32 %arg7, i32 %arg8, i32 %arg9, i64 %arg10, i32 %arg11, i8* %arg12, i8* %arg13, i8* %arg14, i64 %arg15, i64 %arg16, %68* %arg17, i8 %i108)
  ret void
...
define void @"susan_corners_quick$0$0"(%69* %arg, i32 %arg1, i64 %arg2, i32 %arg3, i64 %arg4, i8* %arg5, i64 %arg6, i64 %arg7, i32* %arg8, i32 %arg9, i64 %arg10, i64 %arg11, i32 %arg12, i64 %arg13, %struct.anon* %arg14, i64 %arg15, %70* %arg16, i8 %arg17) {
"susan_corners_quick$0$0_header":
  %add371 = add nsw i32 %arg1, %arg9
  %idxprom372 = sext i32 %add371 to i64
  %arrayidx373 = getelementptr inbounds i32, i32* %arg8, i64 %idxprom372
...
if.then376:                                       ; preds = %"susan_corners_quick$0$0_header"
  %i18 = add nsw i64 %arg2, %arg10
  %i19 = add nsw i64 %i18, -3
  %arrayidx382 = getelementptr inbounds i32, i32* %arg8, i64 %i19
...
land.lhs.true:                                    ; preds = %if.then376
  ...
  %arrayidx390 = getelementptr inbounds i32, i32* %arg8, i64 %i21
...
land.lhs.true393:                                 ; preds = %land.lhs.true
  ...
  %arrayidx399 = getelementptr inbounds i32, i32* %arg8, i64 %i23
...
land.lhs.true402:                                 ; preds = %land.lhs.true393
  %arrayidx407 = getelementptr inbounds i32, i32* %arg8, i64 %i18
...
land.lhs.true410:                                 ; preds = %land.lhs.true402
  ...
  %arrayidx416 = getelementptr inbounds i32, i32* %arg8, i64 %i26
...
land.lhs.true419:                                 ; preds = %land.lhs.true410
  ...
  %arrayidx425 = getelementptr inbounds i32, i32* %arg8, i64 %i28
...
land.lhs.true428:                                 ; preds = %land.lhs.true419
  ...
  %arrayidx434 = getelementptr inbounds i32, i32* %arg8, i64 %i30
...
land.lhs.true437:                                 ; preds = %land.lhs.true428
  ...
  %arrayidx443 = getelementptr inbounds i32, i32* %arg8, i64 %i33
...
land.lhs.true446:                                 ; preds = %land.lhs.true437
  ...
  %arrayidx452 = getelementptr inbounds i32, i32* %arg8, i64 %i35
...
land.lhs.true455:                                 ; preds = %land.lhs.true446
  ...
  %arrayidx461 = getelementptr inbounds i32, i32* %arg8, i64 %i37
...
land.lhs.true464:                                 ; preds = %land.lhs.true455
  %arrayidx469 = getelementptr inbounds i32, i32* %arg8, i64 %i32
...
land.lhs.true472:                                 ; preds = %land.lhs.true464
  ...
  %arrayidx478 = getelementptr inbounds i32, i32* %arg8, i64 %i40
...
land.lhs.true481:                                 ; preds = %land.lhs.true472
  ...
  %arrayidx487 = getelementptr inbounds i32, i32* %arg8, i64 %i42
...
land.lhs.true490:                                 ; preds = %land.lhs.true481
  ...
  %arrayidx496 = getelementptr inbounds i32, i32* %arg8, i64 %i44
...
land.lhs.true499:                                 ; preds = %land.lhs.true490
  %i46 = add nsw i64 %arg2, %arg13
  %i47 = add nsw i64 %i46, -3
  %arrayidx505 = getelementptr inbounds i32, i32* %arg8, i64 %i47
...
land.lhs.true508:                                 ; preds = %land.lhs.true499
  ...
  %arrayidx514 = getelementptr inbounds i32, i32* %arg8, i64 %i49
...
land.lhs.true517:                                 ; preds = %land.lhs.true508
  ...
  %arrayidx523 = getelementptr inbounds i32, i32* %arg8, i64 %i51
...
land.lhs.true526:                                 ; preds = %land.lhs.true517
  %arrayidx531 = getelementptr inbounds i32, i32* %arg8, i64 %i46
...
land.lhs.true534:                                 ; preds = %land.lhs.true526
  ...
  %arrayidx540 = getelementptr inbounds i32, i32* %arg8, i64 %i54
...
land.lhs.true543:                                 ; preds = %land.lhs.true534
  ...
  %arrayidx549 = getelementptr inbounds i32, i32* %arg8, i64 %i56
...
land.lhs.true552:                                 ; preds = %land.lhs.true543
  ...
  %arrayidx558 = getelementptr inbounds i32, i32* %arg8, i64 %i58
...
land.lhs.true561:                                 ; preds = %land.lhs.true552
  ...
  %arrayidx566 = getelementptr inbounds i32, i32* %arg8, i64 %idxprom565
...
land.lhs.true569:                                 ; preds = %land.lhs.true561
  ...
  %arrayidx574 = getelementptr inbounds i32, i32* %arg8, i64 %idxprom573
...
land.lhs.true577:                                 ; preds = %land.lhs.true569
  ...
  %arrayidx582 = getelementptr inbounds i32, i32* %arg8, i64 %idxprom581
...
land.lhs.true585:                                 ; preds = %land.lhs.true577
  ...
  %arrayidx590 = getelementptr inbounds i32, i32* %arg8, i64 %idxprom589
...
land.lhs.true593:                                 ; preds = %land.lhs.true585
  ...
  %arrayidx598 = getelementptr inbounds i32, i32* %arg8, i64 %idxprom597
...
land.lhs.true601:                                 ; preds = %land.lhs.true593
  ...
  %arrayidx606 = getelementptr inbounds i32, i32* %arg8, i64 %idxprom605
...
land.lhs.true609:                                 ; preds = %land.lhs.true601
  ...
  %arrayidx615 = getelementptr inbounds i32, i32* %arg8, i64 %i67
...
land.lhs.true618:                                 ; preds = %land.lhs.true609
  ...
  %arrayidx624 = getelementptr inbounds i32, i32* %arg8, i64 %i69
...
land.lhs.true627:                                 ; preds = %land.lhs.true618
  ...
  %arrayidx633 = getelementptr inbounds i32, i32* %arg8, i64 %i71
...
land.lhs.true636:                                 ; preds = %land.lhs.true627
  %arrayidx641 = getelementptr inbounds i32, i32* %arg8, i64 %i66
...
land.lhs.true644:                                 ; preds = %land.lhs.true636
  ...
  %arrayidx650 = getelementptr inbounds i32, i32* %arg8, i64 %i74
...
land.lhs.true653:                                 ; preds = %land.lhs.true644
  ...
  %arrayidx659 = getelementptr inbounds i32, i32* %arg8, i64 %i76
...
land.lhs.true662:                                 ; preds = %land.lhs.true653
  ...
  %arrayidx668 = getelementptr inbounds i32, i32* %arg8, i64 %i78
...
land.lhs.true671:                                 ; preds = %land.lhs.true662
  %i80 = add nsw i64 %arg2, %arg7
  %i81 = add nsw i64 %i80, -3
  %arrayidx677 = getelementptr inbounds i32, i32* %arg8, i64 %i81
...
land.lhs.true680:                                 ; preds = %land.lhs.true671
  ...
  %arrayidx686 = getelementptr inbounds i32, i32* %arg8, i64 %i83
...
land.lhs.true689:                                 ; preds = %land.lhs.true680
  ...
  %arrayidx695 = getelementptr inbounds i32, i32* %arg8, i64 %i85
...
land.lhs.true698:                                 ; preds = %land.lhs.true689
  %arrayidx703 = getelementptr inbounds i32, i32* %arg8, i64 %i80
...
land.lhs.true706:                                 ; preds = %land.lhs.true698
  ...
  %arrayidx712 = getelementptr inbounds i32, i32* %arg8, i64 %i88
...
land.lhs.true715:                                 ; preds = %land.lhs.true706
  ...
  %arrayidx721 = getelementptr inbounds i32, i32* %arg8, i64 %i90
...
land.lhs.true724:                                 ; preds = %land.lhs.true715
  ...
  %arrayidx730 = getelementptr inbounds i32, i32* %arg8, i64 %i92
...
land.lhs.true733:                                 ; preds = %land.lhs.true724
  ...
  %arrayidx739 = getelementptr inbounds i32, i32* %arg8, i64 %i95
...
land.lhs.true742:                                 ; preds = %land.lhs.true733
  ...
  %arrayidx748 = getelementptr inbounds i32, i32* %arg8, i64 %i97
...
land.lhs.true751:                                 ; preds = %land.lhs.true742
  ...
  %arrayidx757 = getelementptr inbounds i32, i32* %arg8, i64 %i99
...
land.lhs.true760:                                 ; preds = %land.lhs.true751
  %arrayidx765 = getelementptr inbounds i32, i32* %arg8, i64 %i94
...
land.lhs.true768:                                 ; preds = %land.lhs.true760
  ...
  %arrayidx774 = getelementptr inbounds i32, i32* %arg8, i64 %i102
...
land.lhs.true777:                                 ; preds = %land.lhs.true768
  ...
  %arrayidx783 = getelementptr inbounds i32, i32* %arg8, i64 %i104
...
land.lhs.true786:                                 ; preds = %land.lhs.true777
  ...
  %arrayidx792 = getelementptr inbounds i32, i32* %arg8, i64 %i106
...
"susan_corners_quick$0$0_exiting$1":              ; preds = %land.lhs.true786
  ...
  %info = getelementptr inbounds %struct.anon, %struct.anon* %arg14, i64 %idxprom796, i32 2
  store i32 0, i32* %info, align 4, !tbaa !8
  %x800 = getelementptr inbounds %struct.anon, %struct.anon* %arg14, i64 %idxprom796, i32 0
  %i108 = trunc i64 %arg2 to i32
  store i32 %i108, i32* %x800, align 4, !tbaa !20
  %y803 = getelementptr inbounds %struct.anon, %struct.anon* %arg14, i64 %idxprom796, i32 1
  store i32 %arg12, i32* %y803, align 4, !tbaa !15
  ...
  %I = getelementptr inbounds %struct.anon, %struct.anon* %arg14, i64 %idxprom796, i32 5
  ...
  %dx = getelementptr inbounds %struct.anon, %struct.anon* %arg14, i64 %idxprom796, i32 3
  store i32 %div1307, i32* %dx, align 4, !tbaa !21
  %div1310 = sdiv i32 %add1306, 15
  %dy = getelementptr inbounds %struct.anon, %struct.anon* %arg14, i64 %idxprom796, i32 4
...
"susan_corners_quick$0$0_recursively_call_function": ; preds = %"susan_corners_quick$0$0_increment_depth_counter"
  call void @"susan_corners_quick$0$0"(%69* %arg, i32 %inc1321, i64 %indvars.iv.next, i32 %n.2, i64 %arg4, i8* %arg5, i64 %arg6, i64 %arg7, i32* %arg8, i32 %arg9, i64 %arg10, i64 %arg11, i32 %arg12, i64 %arg13, %struct.anon* %arg14, i64 %arg15, %70* %arg16, i8 %i158)
  ret void
...
define void @"susan_corners_quick$1$0"(i32 %arg, i64 %arg1, i32 %arg2, i32* %arg3, i32 %arg4, i64 %arg5, i32 %arg6, i8* %arg7, i8* %arg8, i64 %arg9, i8* %arg10, i64 %arg11, %71* %arg12, i8 %arg13) {
...
if.then249:                                       ; preds = %if.then240
  %add.ptr252 = getelementptr inbounds i8, i8* %incdec.ptr231, i64 %arg9
...
"susan_corners_quick$1$0_recursively_call_function": ; preds = %"susan_corners_quick$1$0_increment_depth_counter"
  call void @"susan_corners_quick$1$0"(i32 %inc, i64 %indvars.iv.next2115, i32 %arg2, i32* %arg3, i32 %arg4, i64 %arg5, i32 %arg6, i8* %arg7, i8* %arg8, i64 %arg9, i8* %arg10, i64 %arg11, %71* %arg12, i8 %i86)
  ret void
...
"susan_smoothing$0$0$0$0_call_recursive_function": ; preds = %"susan_smoothing$0$0$0$0_extract_next_values", %"susan_smoothing$0$0$0$0_initialize_context"
  ...
  call void @"susan_smoothing$0$0$0$0"(%74* %i, i32 %i13, i32 %i14, i8* %i15, i32 %i16, i8* %i17, i32 %arg7, i8* %arg9, %75* %i12, i8 0)
