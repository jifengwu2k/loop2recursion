; ModuleID = './benchmark_intermediate_representations/unoptimized_loop2recursion-recursion_depth_limit-128/pbmsrch/bmhisrch.ll.temp'
...
"bmhi_init$3_call_recursive_function":            ; preds = %"bmhi_init$3_extract_next_values", %"bmhi_init$3_initialize_context"
  ...
  call void @"bmhi_init$3"(%0* %i7, i64 %i9, i64 %i10, i8* %i3, i8* %pattern, i32** %call7, %1* %i8, i8 0)
...
"bmhi_init$2_call_recursive_function":            ; preds = %"bmhi_init$2_extract_next_values", %"bmhi_init$2_initialize_context"
  ...
  call void @"bmhi_init$2"(i64 %i21, i64 %i4, i8* %i3, i8* %pattern, i32** %call7, %2* %i20, i8 0)
...
"bmhi_init$1_call_recursive_function":            ; preds = %"bmhi_init$1_extract_next_values", %"bmhi_init$1_initialize_context"
  ...
  call void @"bmhi_init$1"(i32 %i29, i64 %i30, i32 %i31, i64 %i27, i32* %i26, i32 %i1, i8* %i2, %3* %i28, i8 0)
...
"bmhi_init$0_call_recursive_function":            ; preds = %"bmhi_init$0_extract_next_values", %"bmhi_init$0_initialize_context"
  ...
  call void @"bmhi_init$0"(i64 %i45, i64 %idxprom48.pre-phi, i32 %i1, i8* %i2, i8 %i40, %4* %i44, i8 0)
...
"bmhi_search$0_call_recursive_function":          ; preds = %"bmhi_search$0_extract_next_values", %"bmhi_search$0_initialize_context"
  ...
  call void @"bmhi_search$0"(%5* %i4, i32 %i6, i32 %i2, i8* %i1, i64 %i3, i32 %sub10, i8* %add.ptr, i32 %sub5, %6* %i5, i8 0)
...
define void @"bmhi_init$0"(i64 %arg, i64 %arg1, i32 %arg2, i8* %arg3, i8 %arg4, %4* %arg5, i8 %arg6) {
"bmhi_init$0_header":
...
"bmhi_init$0_recursively_call_function":          ; preds = %"bmhi_init$0_increment_depth_counter"
  call void @"bmhi_init$0"(i64 %indvars.iv.next, i64 %arg1, i32 %arg2, i8* %arg3, i8 %arg4, %4* %arg5, i8 %i9)
  ret void
...
define void @"bmhi_init$1"(i32 %arg, i64 %arg1, i32 %arg2, i64 %arg3, i32* %arg4, i32 %arg5, i8* %arg6, %3* %arg7, i8 %arg8) {
"bmhi_init$1_latch$0":
...
"bmhi_init$1_recursively_call_function":          ; preds = %"bmhi_init$1_increment_depth_counter"
  call void @"bmhi_init$1"(i32 %inc45, i64 %indvars.iv.next112, i32 %i.2.neg, i64 %arg3, i32* %arg4, i32 %arg5, i8* %arg6, %3* %arg7, i8 %i10)
  ret void
...
define void @"bmhi_init$2"(i64 %arg, i64 %arg1, i8* %arg2, i8* %arg3, i32** %arg4, %2* %arg5, i8 %arg6) {
"bmhi_init$2_latch$0":
...
"bmhi_init$2_recursively_call_function":          ; preds = %"bmhi_init$2_increment_depth_counter"
  call void @"bmhi_init$2"(i64 %indvars.iv.next117.3, i64 %arg1, i8* %arg2, i8* %arg3, i32** %arg4, %2* %arg5, i8 %i18)
  ret void
...
define void @"bmhi_init$3"(%0* %arg, i64 %arg1, i64 %arg2, i8* %arg3, i8* %arg4, i32** %arg5, %1* %arg6, i8 %arg7) {
"bmhi_init$3_latch$0":
...
"bmhi_init$3_recursively_call_function":          ; preds = %"bmhi_init$3_increment_depth_counter"
  call void @"bmhi_init$3"(%0* %arg, i64 %prol.iter.sub, i64 %indvars.iv.next117.prol, i8* %arg3, i8* %arg4, i32** %arg5, %1* %arg6, i8 %i10)
  ret void
...
define void @"bmhi_search$0"(%5* %arg, i32 %arg1, i32 %arg2, i8* %arg3, i64 %arg4, i32 %arg5, i8* %arg6, i32 %arg7, %6* %arg8, i8 %arg9) {
...
"bmhi_search$0$0_call_recursive_function":        ; preds = %"bmhi_search$0$0_extract_next_values", %"bmhi_search$0$0_initialize_context"
  ...
  call void @"bmhi_search$0$0"(%7* %i11, i32 %i13, i64 %i14, i8* %arg3, i8* %add.ptr13, %8* %i12, i8 0)
...
"bmhi_search$0_recursively_call_function":        ; preds = %"bmhi_search$0_increment_depth_counter"
  call void @"bmhi_search$0"(%5* %arg, i32 %i.0.be, i32 %arg2, i8* %arg3, i64 %arg4, i32 %arg5, i8* %arg6, i32 %arg7, %6* %arg8, i8 %i23)
  ret void
...
define void @"bmhi_search$0$0"(%7* %arg, i32 %arg1, i64 %arg2, i8* %arg3, i8* %arg4, %8* %arg5, i8 %arg6) {
...
"bmhi_search$0$0_recursively_call_function":      ; preds = %"bmhi_search$0$0_increment_depth_counter"
  call void @"bmhi_search$0$0"(%7* %arg, i32 %dec, i64 %indvars.iv.next, i8* %arg3, i8* %arg4, %8* %arg5, i8 %i10)
  ret void
