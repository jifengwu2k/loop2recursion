; ModuleID = './benchmark_intermediate_representations/unoptimized_loop2recursion-recursion_depth_limit-128/pbmsrch/bmhasrch.ll.temp'
...
"bmha_init$1_call_recursive_function":            ; preds = %"bmha_init$1_extract_next_values", %"bmha_init$1_initialize_context"
  ...
  call void @"bmha_init$1"(i64 %i2, i8* %pattern, i32 %conv, i64 %i, %0* %i1, i8 0)
...
"bmha_init$0_call_recursive_function":            ; preds = %"bmha_init$0_extract_next_values", %"bmha_init$0_initialize_context"
  ...
  call void @"bmha_init$0"(i64 %i9, i64 %i7, i32 %conv, i8* %pattern, i8 %.pre91, %1* %i8, i8 0)
...
"bmha_search$0_call_recursive_function":          ; preds = %"bmha_search$0_extract_next_values", %"bmha_search$0_initialize_context"
  ...
  call void @"bmha_search$0"(%2* %i4, i32 %i6, i32 %i2, i8* %i1, i64 %i3, i32 %sub10, i8* %add.ptr, i32 %sub5, %3* %i5, i8 0)
...
define void @"bmha_init$0"(i64 %arg, i64 %arg1, i32 %arg2, i8* %arg3, i8 %arg4, %1* %arg5, i8 %arg6) {
"bmha_init$0_header":
...
"bmha_init$0_recursively_call_function":          ; preds = %"bmha_init$0_increment_depth_counter"
  call void @"bmha_init$0"(i64 %indvars.iv.next, i64 %arg1, i32 %arg2, i8* %arg3, i8 %arg4, %1* %arg5, i8 %i10)
  ret void
...
define void @"bmha_init$1"(i64 %arg, i8* %arg1, i32 %arg2, i64 %arg3, %0* %arg4, i8 %arg5) {
"bmha_init$1_header":
...
"bmha_init$1$0_call_recursive_function":          ; preds = %"bmha_init$1$0_extract_next_values", %"bmha_init$1$0_initialize_context"
  ...
  call void @"bmha_init$1$0"(%4* %i, i32 %i7, i64 %i8, i8* %arg1, i8* %arrayidx8, %5* %i6, i8 0)
...
"bmha_init$1_recursively_call_function":          ; preds = %"bmha_init$1_increment_depth_counter"
  call void @"bmha_init$1"(i64 %indvars.iv.next90, i8* %arg1, i32 %arg2, i64 %arg3, %0* %arg4, i8 %i23)
  ret void
...
define void @"bmha_search$0"(%2* %arg, i32 %arg1, i32 %arg2, i8* %arg3, i64 %arg4, i32 %arg5, i8* %arg6, i32 %arg7, %3* %arg8, i8 %arg9) {
...
"bmha_search$0$0_call_recursive_function":        ; preds = %"bmha_search$0$0_extract_next_values", %"bmha_search$0$0_initialize_context"
  ...
  call void @"bmha_search$0$0"(%6* %i11, i32 %i13, i64 %i14, i8* %arg3, i8* %add.ptr13, %7* %i12, i8 0)
...
"bmha_search$0_recursively_call_function":        ; preds = %"bmha_search$0_increment_depth_counter"
  call void @"bmha_search$0"(%2* %arg, i32 %i.0.be, i32 %arg2, i8* %arg3, i64 %arg4, i32 %arg5, i8* %arg6, i32 %arg7, %3* %arg8, i8 %i23)
  ret void
...
define void @"bmha_init$1$0"(%4* %arg, i32 %arg1, i64 %arg2, i8* %arg3, i8* %arg4, %5* %arg5, i8 %arg6) {
...
"bmha_init$1$0_recursively_call_function":        ; preds = %"bmha_init$1$0_increment_depth_counter"
  call void @"bmha_init$1$0"(%4* %arg, i32 %j.0, i64 %indvars.iv.next88, i8* %arg3, i8* %arg4, %5* %arg5, i8 %i9)
  ret void
...
define void @"bmha_search$0$0"(%6* %arg, i32 %arg1, i64 %arg2, i8* %arg3, i8* %arg4, %7* %arg5, i8 %arg6) {
...
"bmha_search$0$0_recursively_call_function":      ; preds = %"bmha_search$0$0_increment_depth_counter"
  call void @"bmha_search$0$0"(%6* %arg, i32 %dec, i64 %indvars.iv.next, i8* %arg3, i8* %arg4, %7* %arg5, i8 %i10)
  ret void
