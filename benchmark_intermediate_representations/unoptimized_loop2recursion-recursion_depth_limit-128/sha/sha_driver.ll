; ModuleID = './benchmark_intermediate_representations/unoptimized_loop2recursion-recursion_depth_limit-128/sha/sha_driver.ll.temp'
...
"main$0_call_recursive_function":                 ; preds = %"main$0_extract_next_values", %"main$0_initialize_context"
  ...
  call void @"main$0"(i8** %i2, i32 %i3, %struct.SHA_INFO* %sha_info, %0* %i1, i8 0)
...
define void @"main$0"(i8** %arg, i32 %arg1, %struct.SHA_INFO* %arg2, %0* %arg3, i8 %arg4) {
"main$0_header":
...
"main$0_recursively_call_function":               ; preds = %"main$0_increment_depth_counter"
  call void @"main$0"(i8** %incdec.ptr, i32 %dec, %struct.SHA_INFO* %arg2, %0* %arg3, i8 %i6)
  ret void
