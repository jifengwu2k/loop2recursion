; ModuleID = './benchmark_intermediate_representations/unoptimized_loop2recursion-recursion_depth_limit-128/bitcnts/bitstrng.ll.temp'
...
"bitstring$0_call_recursive_function":            ; preds = %"bitstring$0_extract_next_values", %"bitstring$0_initialize_context"
  %i8 = phi i8* [ %str.addr.0.lcssa, %"bitstring$0_initialize_context" ], [ %i13, %"bitstring$0_extract_next_values" ]
  %i9 = phi i64 [ %i5, %"bitstring$0_initialize_context" ], [ %i15, %"bitstring$0_extract_next_values" ]
  call void @"bitstring$0"(%0* %i6, i8* %i8, i64 %i9, i64 %byze, %1* %i7, i8 0)
  %i10 = getelementptr %1, %1* %i7, i32 0, i32 2
  %i11 = load i1, i1* %i10, align 1
  br i1 %i11, label %"bitstring$0_extract_return_values$0", label %"bitstring$0_extract_next_values"

"bitstring$0_extract_next_values":                ; preds = %"bitstring$0_call_recursive_function"
  %i12 = getelementptr %1, %1* %i7, i32 0, i32 0
  %i13 = load i8*, i8** %i12, align 8
  %i14 = getelementptr %1, %1* %i7, i32 0, i32 1
  %i15 = load i64, i64* %i14, align 8
  br label %"bitstring$0_call_recursive_function"

"bitstring$0_extract_return_values$0":            ; preds = %"bitstring$0_call_recursive_function"
  %i16 = getelementptr %0, %0* %i6, i32 0, i32 0
...
while.end:                                        ; preds = %while.end.loopexit, %while.cond.preheader
  %str.addr.1.lcssa = phi i8* [ %str.addr.0.lcssa, %while.cond.preheader ], [ %i17, %while.end.loopexit ]
...
define void @"bitstring$0"(%0* %arg, i8* %arg1, i64 %arg2, i64 %arg3, %1* %arg4, i8 %arg5) {
"bitstring$0_header":
  %i = trunc i64 %arg2 to i32
  %dec29 = add nsw i32 %i, -1
  %sh_prom = zext i32 %dec29 to i64
  %shr324 = lshr i64 %arg3, %sh_prom
  %and = and i64 %shr324, 1
  %add4 = or i64 %and, 48
  %conv = trunc i64 %add4 to i8
  %incdec.ptr5 = getelementptr inbounds i8, i8* %arg1, i64 1
  store i8 %conv, i8* %arg1, align 1, !tbaa !1
...
if.then:                                          ; preds = %"bitstring$0_header"
  %incdec.ptr9 = getelementptr inbounds i8, i8* %arg1, i64 2
...
"bitstring$0_increment_depth_counter":            ; preds = %"bitstring$0_latch$0"
  ...
  br i1 %i7, label %"bitstring$0_recursively_call_function", label %"bitstring$0_save_recursive_state_and_return"

"bitstring$0_recursively_call_function":          ; preds = %"bitstring$0_increment_depth_counter"
  call void @"bitstring$0"(%0* %arg, i8* %str.addr.1.be, i64 %indvars.iv.next, i64 %arg3, %1* %arg4, i8 %i6)
  ret void
...
"bitstring$0_save_recursive_state_and_return":    ; preds = %"bitstring$0_increment_depth_counter"
  ...
  store i8* %str.addr.1.be, i8** %i8, align 8
...
"bitstring$0_return_from_recursive_function$0":   ; preds = %"bitstring$0_latch$0"
  ...
  store i8* %str.addr.1.be, i8** %i11, align 8
