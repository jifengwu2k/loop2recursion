; ModuleID = './benchmark_intermediate_representations/unoptimized_loop2recursion-recursion_depth_limit-128/basicmath/basicmath_small.ll.temp'
...
"main$3$0$0_call_recursive_function":             ; preds = %"main$3$0$0_extract_next_values", %"main$3$0$0_initialize_context"
  ...
  call void @"main$3$0$0"(double %i7, double* %arg2, i32* %arg4, double %arg3, [3 x double]* %arg1, double %indvar.conv203, %9* %i, i8 0)
...
define void @"main$3$0$0"(double %arg, double* %arg1, i32* %arg2, double %arg3, [3 x double]* %arg4, double %arg5, %9* %arg6, i8 %arg7) {
"main$3$0$0_header":
...
"main$3$0$0$0_call_recursive_function":           ; preds = %"main$3$0$0$0_extract_next_values", %"main$3$0$0$0_initialize_context"
  ...
  call void @"main$3$0$0$0"(i32 %i8, [3 x double]* %arg4, double* %arg1, i32* %arg2, double %arg, double %arg3, double %arg5, %10* %i, i8 0)
...
"main$3$0$0_recursively_call_function":           ; preds = %"main$3$0$0_increment_depth_counter"
  call void @"main$3$0$0"(double %add, double* %arg1, i32* %arg2, double %arg3, [3 x double]* %arg4, double %arg5, %9* %arg6, i8 %i13)
  ret void
