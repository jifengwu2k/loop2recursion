; ModuleID = './benchmark_intermediate_representations/unoptimized_loop2recursion-recursion_depth_limit-128/qsort/qsort_small.ll.temp'
...
"main$1_call_recursive_function":                 ; preds = %"main$1_extract_next_values", %"main$1_initialize_context"
  ...
  call void @"main$1"(%0* %i4, i64 %i6, %struct._IO_FILE* %call1, [60000 x %struct.myStringStruct]* %array, %1* %i5, i8 0)
...
"main$0_call_recursive_function":                 ; preds = %"main$0_extract_next_values", %"main$0_initialize_context"
  ...
  call void @"main$0"(i64 %i15, i32 %i13, [60000 x %struct.myStringStruct]* %array, %2* %i14, i8 0)
...
define void @"main$0"(i64 %arg, i32 %arg1, [60000 x %struct.myStringStruct]* %arg2, %2* %arg3, i8 %arg4) {
"main$0_latch$0":
...
"main$0_recursively_call_function":               ; preds = %"main$0_increment_depth_counter"
  call void @"main$0"(i64 %indvars.iv.next, i32 %arg1, [60000 x %struct.myStringStruct]* %arg2, %2* %arg3, i8 %i)
  ret void
...
define void @"main$1"(%0* %arg, i64 %arg1, %struct._IO_FILE* %arg2, [60000 x %struct.myStringStruct]* %arg3, %1* %arg4, i8 %arg5) {
"main$1_latch$0":
...
"main$1_recursively_call_function":               ; preds = %"main$1_increment_depth_counter"
  call void @"main$1"(%0* %arg, i64 %indvars.iv.next27, %struct._IO_FILE* %arg2, [60000 x %struct.myStringStruct]* %arg3, %1* %arg4, i8 %i6)
  ret void
