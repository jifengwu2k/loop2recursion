; ModuleID = './benchmark_intermediate_representations/unoptimized_loop2recursion-recursion_depth_limit-128/dijkstra/dijkstra_small.ll.temp'
...
"enqueue$0_call_recursive_function":              ; preds = %"enqueue$0_extract_next_values", %"enqueue$0_initialize_context"
  ...
  call void @"enqueue$0"(%0* %i6, %struct._QITEM* %i8, %1* %i7, i8 0)
...
"dijkstra$2_call_recursive_function":             ; preds = %"dijkstra$2_extract_next_values", %"dijkstra$2_initialize_context"
  ...
  call void @"dijkstra$2"(i64 %i1, %2* %i, i8 0)
...
"dijkstra$1_call_recursive_function":             ; preds = %"dijkstra$1_extract_next_values", %"dijkstra$1_initialize_context"
  ...
  call void @"dijkstra$1"(%3* %i12, %struct._QITEM* %i14, %4* %i13, i8 0)
...
"dijkstra$0_call_recursive_function":             ; preds = %"dijkstra$0_extract_next_values", %"dijkstra$0_initialize_context"
  ...
  call void @"dijkstra$0"(%5* %i23, i32 %i25, %6* %i24, i8 0)
...
"main$1_call_recursive_function":                 ; preds = %"main$1_extract_next_values", %"main$1_initialize_context"
  ...
  call void @"main$1"(i64 %i7, i32* %k, %struct._IO_FILE* %call2, %7* %i6, i8 0)
...
"main$0_call_recursive_function":                 ; preds = %"main$0_extract_next_values", %"main$0_initialize_context"
  ...
  call void @"main$0"(i32 %i13, i32 %i14, %8* %i12, i8 0)
...
define void @"enqueue$0"(%0* %arg, %struct._QITEM* %arg1, %1* %arg2, i8 %arg3) {
"enqueue$0_latch$0":
...
"enqueue$0_recursively_call_function":            ; preds = %"enqueue$0_increment_depth_counter"
  call void @"enqueue$0"(%0* %arg, %struct._QITEM* %i, %1* %arg2, i8 %i4)
  ret void
...
define void @"dijkstra$0"(%5* %arg, i32 %arg1, %6* %arg2, i8 %arg3) {
"dijkstra$0_header":
  %i = load %struct._QITEM*, %struct._QITEM** @qHead, align 8, !tbaa !6
...
"dijkstra$0$0_call_recursive_function":           ; preds = %"dijkstra$0$0_extract_next_values", %"dijkstra$0$0_initialize_context"
  ...
  call void @"dijkstra$0$0"(%9* %i11, i32 %i13, i32 %i14, i32 %.pre, i64 %idxprom16, %10* %i12, i8 0)
...
"dijkstra$0_recursively_call_function":           ; preds = %"dijkstra$0_increment_depth_counter"
  call void @"dijkstra$0"(%5* %arg, i32 %i24, %6* %arg2, i8 %i25)
  ret void
...
define void @"dijkstra$1"(%3* %arg, %struct._QITEM* %arg1, %4* %arg2, i8 %arg3) {
"dijkstra$1_latch$0":
...
"dijkstra$1_recursively_call_function":           ; preds = %"dijkstra$1_increment_depth_counter"
  call void @"dijkstra$1"(%3* %arg, %struct._QITEM* %i, %4* %arg2, i8 %i4)
  ret void
...
define void @"dijkstra$2"(i64 %arg, %2* %arg1, i8 %arg2) {
"dijkstra$2_latch$0":
...
"dijkstra$2_recursively_call_function":           ; preds = %"dijkstra$2_increment_depth_counter"
  call void @"dijkstra$2"(i64 %indvars.iv.next.4, %2* %arg1, i8 %i)
  ret void
...
define void @"main$0"(i32 %arg, i32 %arg1, %8* %arg2, i8 %arg3) {
"main$0_latch$0":
...
"main$0_recursively_call_function":               ; preds = %"main$0_increment_depth_counter"
  call void @"main$0"(i32 %inc20, i32 %inc19, %8* %arg2, i8 %i)
  ret void
...
define void @"main$1"(i64 %arg, i32* %arg1, %struct._IO_FILE* %arg2, %7* %arg3, i8 %arg4) {
"main$1_header":
...
"main$1$0_call_recursive_function":               ; preds = %"main$1$0_extract_next_values", %"main$1$0_initialize_context"
  ...
  call void @"main$1$0"(i64 %i5, i64 %arg, %struct._IO_FILE* %arg2, i32* %arg1, %11* %i, i8 0)
...
"main$1_recursively_call_function":               ; preds = %"main$1_increment_depth_counter"
  call void @"main$1"(i64 %indvars.iv.next38, i32* %arg1, %struct._IO_FILE* %arg2, %7* %arg3, i8 %i10)
  ret void
...
define void @"dijkstra$0$0"(%9* %arg, i32 %arg1, i32 %arg2, i32 %arg3, i64 %arg4, %10* %arg5, i8 %arg6) {
"dijkstra$0$0_header":
...
"dijkstra$0$0$0_call_recursive_function":         ; preds = %"dijkstra$0$0$0_extract_next_values", %"dijkstra$0$0$0_initialize_context"
  ...
  call void @"dijkstra$0$0$0"(%12* %i12, %struct._QITEM* %i14, %13* %i13, i8 0)
...
"dijkstra$0$0_recursively_call_function":         ; preds = %"dijkstra$0$0_increment_depth_counter"
  call void @"dijkstra$0$0"(%9* %arg, i32 %inc40, i32 %.pr, i32 %arg3, i64 %arg4, %10* %arg5, i8 %i22)
  ret void
...
define void @"main$1$0"(i64 %arg, i64 %arg1, %struct._IO_FILE* %arg2, i32* %arg3, %11* %arg4, i8 %arg5) {
"main$1$0_latch$0":
...
"main$1$0_recursively_call_function":             ; preds = %"main$1$0_increment_depth_counter"
  call void @"main$1$0"(i64 %indvars.iv.next, i64 %arg1, %struct._IO_FILE* %arg2, i32* %arg3, %11* %arg4, i8 %i6)
  ret void
...
define void @"dijkstra$0$0$0"(%12* %arg, %struct._QITEM* %arg1, %13* %arg2, i8 %arg3) {
...
"dijkstra$0$0$0_recursively_call_function":       ; preds = %"dijkstra$0$0$0_increment_depth_counter"
  call void @"dijkstra$0$0$0"(%12* %arg, %struct._QITEM* %i, %13* %arg2, i8 %i4)
  ret void
