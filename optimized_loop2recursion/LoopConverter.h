...
struct LoopConverter {
    ...
    llvm::GlobalVariable* global_return_value_struct;
    llvm::GlobalVariable* global_recursion_state_struct;

    // initialized in synthesize_parameter_list
    size_t number_of_parameters;
    std::vector<llvm::Type *> types_in_parameter_list;
    std::unordered_map<llvm::Value *, size_t> indices_of_loop_variables_in_parameter_list;
